...
public val RemixIcons.SpotifyFill: ImageVector
    get() {
        if (_spotifyFill != null) {
            return _spotifyFill!!
        }
        _spotifyFill = Builder(name = "SpotifyFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(17.55f, 2.0f, 12.0f, 2.0f)
                close()
