...
public val RemixIcons.CustomerService2Line: ImageVector
    get() {
        if (_customerService2Line != null) {
            return _customerService2Line!!
        }
        _customerService2Line = Builder(name = "CustomerService2Line", defaultWidth = 24.0.dp,
