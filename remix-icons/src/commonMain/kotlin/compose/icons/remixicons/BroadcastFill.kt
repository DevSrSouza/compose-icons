...
public val RemixIcons.BroadcastFill: ImageVector
    get() {
        ...
        _broadcastFill = Builder(name = "BroadcastFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 14.0f)
                curveToRelative(0.58f, 0.0f, 1.077f, 0.413f, 1.184f, 0.983f)
                lineTo(14.5f, 22.0f)
                horizontalLineToRelative(-5.0f)
                lineToRelative(1.316f, -7.017f)
                curveToRelative(0.107f, -0.57f, 0.604f, -0.983f, 1.184f, -0.983f)
                close()
            }
        }
        .build()
