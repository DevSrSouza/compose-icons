...
public val RemixIcons.DoorOpenLine: ImageVector
    get() {
        if (_doorOpenLine != null) {
            return _doorOpenLine!!
        }
        _doorOpenLine = Builder(name = "DoorOpenLine", defaultWidth = 24.0.dp, defaultHeight =
