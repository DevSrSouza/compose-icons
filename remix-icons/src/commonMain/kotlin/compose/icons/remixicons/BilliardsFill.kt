...
public val RemixIcons.BilliardsFill: ImageVector
    get() {
        ...
        _billiardsFill = Builder(name = "BilliardsFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 7.75f)
                arcToRelative(2.5f, 2.5f, 0.0f, false, true, 1.88f, 4.148f)
                curveToRelative(0.565f, 0.456f, 0.92f, 1.117f, 0.92f, 1.852f)
                curveToRelative(0.0f, 1.38f, -1.254f, 2.5f, -2.8f, 2.5f)
                curveToRelative(-1.546f, 0.0f, -2.8f, -1.12f, -2.8f, -2.5f)
                curveToRelative(0.0f, -0.735f, 0.355f, -1.396f, 0.92f, -1.853f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 12.0f, 7.75f)
                close()
                moveTo(12.0f, 12.75f)
