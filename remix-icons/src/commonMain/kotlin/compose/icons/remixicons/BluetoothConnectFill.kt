...
public val RemixIcons.BluetoothConnectFill: ImageVector
    get() {
        if (_bluetoothConnectFill != null) {
            return _bluetoothConnectFill!!
        }
        _bluetoothConnectFill = Builder(name = "BluetoothConnectFill", defaultWidth = 24.0.dp,
