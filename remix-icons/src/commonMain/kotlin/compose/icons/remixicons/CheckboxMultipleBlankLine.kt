...
public val RemixIcons.CheckboxMultipleBlankLine: ImageVector
    get() {
        if (_checkboxMultipleBlankLine != null) {
            return _checkboxMultipleBlankLine!!
        }
        _checkboxMultipleBlankLine = Builder(name = "CheckboxMultipleBlankLine", defaultWidth =
