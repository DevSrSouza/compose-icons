...
public val RemixIcons.TrainWifiLine: ImageVector
    get() {
        ...
        _trainWifiLine = Builder(name = "TrainWifiLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.498f, 3.0f)
                arcToRelative(6.464f, 6.464f, 0.0f, false, false, -0.479f, 2.0f)
                lineTo(7.0f, 5.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -1.995f, 1.85f)
                lineTo(5.0f, 7.0f)
                verticalLineToRelative(11.0f)
                horizontalLineToRelative(14.0f)
                verticalLineToRelative(-6.019f)
                arcToRelative(6.463f, 6.463f, 0.0f, false, false, 2.0f, -0.48f)
                lineTo(21.0f, 18.0f)
                ...
                close()
                moveTo(12.174f, 7.0f)
                arcToRelative(6.51f, 6.51f, 0.0f, false, false, 2.862f, 4.001f)
                lineTo(6.0f, 11.0f)
                lineTo(6.0f, 7.0f)
