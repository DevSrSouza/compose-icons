...
public val RemixIcons.GitRepositoryPrivateLine: ImageVector
    get() {
        if (_gitRepositoryPrivateLine != null) {
            return _gitRepositoryPrivateLine!!
        }
        _gitRepositoryPrivateLine = Builder(name = "GitRepositoryPrivateLine", defaultWidth =
