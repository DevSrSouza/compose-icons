...
public val RemixIcons.FilmFill: ImageVector
    get() {
        if (_filmFill != null) {
            return _filmFill!!
        }
        _filmFill = Builder(name = "FilmFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _filmFill: ImageVector? = null
