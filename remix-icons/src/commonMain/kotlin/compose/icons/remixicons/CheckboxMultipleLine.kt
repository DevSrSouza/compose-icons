...
public val RemixIcons.CheckboxMultipleLine: ImageVector
    get() {
        if (_checkboxMultipleLine != null) {
            return _checkboxMultipleLine!!
        }
        _checkboxMultipleLine = Builder(name = "CheckboxMultipleLine", defaultWidth = 24.0.dp,
...
private var _checkboxMultipleLine: ImageVector? = null
