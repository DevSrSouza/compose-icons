...
public val RemixIcons.CheckDoubleFill: ImageVector
    get() {
        if (_checkDoubleFill != null) {
            return _checkDoubleFill!!
        }
        _checkDoubleFill = Builder(name = "CheckDoubleFill", defaultWidth = 24.0.dp, defaultHeight =
