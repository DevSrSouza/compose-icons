...
public val RemixIcons.FolderMusicLine: ImageVector
    get() {
        if (_folderMusicLine != null) {
            return _folderMusicLine!!
        }
        _folderMusicLine = Builder(name = "FolderMusicLine", defaultWidth = 24.0.dp, defaultHeight =
