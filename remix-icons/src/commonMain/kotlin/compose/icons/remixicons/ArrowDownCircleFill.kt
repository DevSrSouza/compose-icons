...
public val RemixIcons.ArrowDownCircleFill: ImageVector
    get() {
        if (_arrowDownCircleFill != null) {
            return _arrowDownCircleFill!!
        }
        _arrowDownCircleFill = Builder(name = "ArrowDownCircleFill", defaultWidth = 24.0.dp,
