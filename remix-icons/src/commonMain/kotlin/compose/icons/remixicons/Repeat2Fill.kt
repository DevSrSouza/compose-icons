...
public val RemixIcons.Repeat2Fill: ImageVector
    get() {
        if (_repeat2Fill != null) {
            return _repeat2Fill!!
        }
        _repeat2Fill = Builder(name = "Repeat2Fill", defaultWidth = 24.0.dp, defaultHeight =
...
private var _repeat2Fill: ImageVector? = null
