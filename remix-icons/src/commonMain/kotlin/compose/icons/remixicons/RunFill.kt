...
public val RemixIcons.RunFill: ImageVector
    get() {
        if (_runFill != null) {
            return _runFill!!
        }
        _runFill = Builder(name = "RunFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.581f, 3.297f)
                lineTo(15.0f, 15.67f)
                verticalLineTo(23.0f)
                horizontalLineToRelative(-2.0f)
                verticalLineToRelative(-5.986f)
                lineToRelative(-2.05f, -1.987f)
                lineToRelative(-0.947f, 4.298f)
