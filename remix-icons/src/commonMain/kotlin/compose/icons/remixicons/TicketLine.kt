...
public val RemixIcons.TicketLine: ImageVector
    get() {
        if (_ticketLine != null) {
            return _ticketLine!!
        }
        _ticketLine = Builder(name = "TicketLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ticketLine: ImageVector? = null
