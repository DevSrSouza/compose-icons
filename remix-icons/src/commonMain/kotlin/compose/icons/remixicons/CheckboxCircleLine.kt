...
public val RemixIcons.CheckboxCircleLine: ImageVector
    get() {
        if (_checkboxCircleLine != null) {
            return _checkboxCircleLine!!
        }
        _checkboxCircleLine = Builder(name = "CheckboxCircleLine", defaultWidth = 24.0.dp,
