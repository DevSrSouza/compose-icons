...
public val RemixIcons.FolderShieldFill: ImageVector
    get() {
        ...
        _folderShieldFill = Builder(name = "FolderShieldFill", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(2.667f, 2.667f, 0.0f, false, false, 16.0f, 13.904f)
                lineTo(16.0f, 9.0f)
                lineTo(8.0f, 9.0f)
                close()
                ...
                arcToRelative(0.667f, 0.667f, 0.0f, false, true, -0.297f, 0.555f)
