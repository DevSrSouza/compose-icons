...
public val RemixIcons.DeviceRecoverLine: ImageVector
    get() {
        ...
        _deviceRecoverLine = Builder(name = "DeviceRecoverLine", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 7.0f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 2.628f, 9.254f)
                lineTo(12.5f, 12.0f)
                lineTo(15.0f, 12.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, true, false, -3.0f, 3.0f)
                lineToRelative(0.955f, 1.909f)
                arcTo(5.0f, 5.0f, 0.0f, true, true, 12.0f, 7.0f)
                close()
            }
        }
        .build()
