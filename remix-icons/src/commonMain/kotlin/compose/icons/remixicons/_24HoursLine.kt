...
public val RemixIcons._24HoursLine: ImageVector
    get() {
        if (__24HoursLine != null) {
            return __24HoursLine!!
        }
        __24HoursLine = Builder(name = "_24HoursLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(2.0f)
                lineTo(4.0f, 6.0f)
                curveToRelative(1.824f, -2.43f, 4.729f, -4.0f, 8.0f, -4.0f)
                close()
            }
        }
        .build()
