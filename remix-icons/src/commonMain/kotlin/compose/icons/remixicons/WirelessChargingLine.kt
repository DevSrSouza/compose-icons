...
public val RemixIcons.WirelessChargingLine: ImageVector
    get() {
        if (_wirelessChargingLine != null) {
            return _wirelessChargingLine!!
        }
        _wirelessChargingLine = Builder(name = "WirelessChargingLine", defaultWidth = 24.0.dp,
