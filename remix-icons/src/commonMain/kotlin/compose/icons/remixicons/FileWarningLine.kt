...
public val RemixIcons.FileWarningLine: ImageVector
    get() {
        if (_fileWarningLine != null) {
            return _fileWarningLine!!
        }
        _fileWarningLine = Builder(name = "FileWarningLine", defaultWidth = 24.0.dp, defaultHeight =
