...
public val RemixIcons.FootballLine: ImageVector
    get() {
        ...
        _footballLine = Builder(name = "FootballLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-1.291f, -0.938f)
                close()
                moveTo(12.0f, 9.536f)
                lineToRelative(-2.344f, 1.702f)
                lineToRelative(0.896f, 2.762f)
                ...
                arcToRelative(8.014f, 8.014f, 0.0f, false, false, -4.195f, 2.985f)
                lineToRelative(0.554f, 1.702f)
                lineToRelative(2.239f, 0.727f)
                lineTo(11.0f, 7.79f)
                lineTo(11.0f, 5.273f)
                lineToRelative(-1.292f, -0.94f)
                close()
            }
        }
        .build()
