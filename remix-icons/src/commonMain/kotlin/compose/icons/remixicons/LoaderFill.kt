...
public val RemixIcons.LoaderFill: ImageVector
    get() {
        if (_loaderFill != null) {
            return _loaderFill!!
        }
        _loaderFill = Builder(name = "LoaderFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _loaderFill: ImageVector? = null
