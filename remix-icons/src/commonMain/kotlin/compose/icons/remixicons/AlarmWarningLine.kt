...
public val RemixIcons.AlarmWarningLine: ImageVector
    get() {
        if (_alarmWarningLine != null) {
            return _alarmWarningLine!!
        }
        _alarmWarningLine = Builder(name = "AlarmWarningLine", defaultWidth = 24.0.dp, defaultHeight
