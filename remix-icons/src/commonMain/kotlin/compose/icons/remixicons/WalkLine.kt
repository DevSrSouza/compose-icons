...
public val RemixIcons.WalkLine: ImageVector
    get() {
        if (_walkLine != null) {
            return _walkLine!!
        }
        _walkLine = Builder(name = "WalkLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _walkLine: ImageVector? = null
