...
public val RemixIcons.SignalWifi2Line: ImageVector
    get() {
        if (_signalWifi2Line != null) {
            return _signalWifi2Line!!
        }
        _signalWifi2Line = Builder(name = "SignalWifi2Line", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 12.0f)
                curveToRelative(-1.42f, 0.0f, -2.764f, 0.33f, -3.959f, 0.915f)
                lineTo(12.0f, 17.817f)
                lineToRelative(3.958f, -4.902f)
                curveTo(14.764f, 12.329f, 13.42f, 12.0f, 12.0f, 12.0f)
                close()
                moveTo(12.0f, 5.0f)
