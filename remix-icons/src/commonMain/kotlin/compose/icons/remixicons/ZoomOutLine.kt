...
public val RemixIcons.ZoomOutLine: ImageVector
    get() {
        if (_zoomOutLine != null) {
            return _zoomOutLine!!
        }
        _zoomOutLine = Builder(name = "ZoomOutLine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zoomOutLine: ImageVector? = null
