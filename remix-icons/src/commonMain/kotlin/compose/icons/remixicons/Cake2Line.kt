...
public val RemixIcons.Cake2Line: ImageVector
    get() {
        if (_cake2Line != null) {
            return _cake2Line!!
        }
        _cake2Line = Builder(name = "Cake2Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(3.994f, 3.994f, 0.0f, false, true, -2.514f, 1.273f)
                lineToRelative(-0.23f, 0.018f)
                lineTo(6.0f, 18.0f)
                curveToRelative(-0.345f, 0.0f, -0.68f, -0.044f, -1.0f, -0.126f)
                lineTo(5.0f, 20.0f)
                horizontalLineToRelative(14.0f)
                verticalLineToRelative(-2.126f)
                arcToRelative(4.007f, 4.007f, 0.0f, false, true, -3.744f, -0.963f)
                lineToRelative(-0.15f, -0.15f)
                lineToRelative(-0.106f, -0.117f)
                lineToRelative(-0.107f, 0.118f)
                arcToRelative(3.99f, 3.99f, 0.0f, false, true, -2.451f, 1.214f)
                lineToRelative(-0.242f, 0.02f)
                lineTo(12.0f, 18.0f)
                arcToRelative(3.977f, 3.977f, 0.0f, false, true, -2.797f, -1.144f)
