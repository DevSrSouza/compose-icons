...
public val RemixIcons.HandbagLine: ImageVector
    get() {
        if (_handbagLine != null) {
            return _handbagLine!!
        }
        _handbagLine = Builder(name = "HandbagLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(7.0f, 7.0f, 0.0f, false, true, 7.0f, -7.0f)
                close()
                moveTo(19.147f, 11.0f)
                lineTo(4.852f, 11.0f)
                lineToRelative(-0.693f, 9.0f)
                lineTo(19.84f, 20.0f)
                lineToRelative(-0.693f, -9.0f)
                close()
                moveTo(14.0f, 13.0f)
