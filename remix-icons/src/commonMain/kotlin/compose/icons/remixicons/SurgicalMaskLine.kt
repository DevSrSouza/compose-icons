...
public val RemixIcons.SurgicalMaskLine: ImageVector
    get() {
        if (_surgicalMaskLine != null) {
            return _surgicalMaskLine!!
        }
        _surgicalMaskLine = Builder(name = "SurgicalMaskLine", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 5.061f)
                lineToRelative(-7.0f, 1.75f)
                verticalLineToRelative(5.98f)
                curveToRelative(0.0f, 1.516f, 0.856f, 2.9f, 2.211f, 3.579f)
                lineTo(12.0f, 18.764f)
                lineToRelative(4.789f, -2.394f)
                curveTo(18.144f, 15.692f, 19.0f, 14.307f, 19.0f, 12.792f)
                verticalLineToRelative(-5.98f)
                lineToRelative(-7.0f, -1.75f)
                close()
                moveTo(3.0f, 9.0f)
