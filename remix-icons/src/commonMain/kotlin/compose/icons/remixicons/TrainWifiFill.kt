...
public val RemixIcons.TrainWifiFill: ImageVector
    get() {
        ...
        _trainWifiFill = Builder(name = "TrainWifiFill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.498f, 3.0f)
                arcToRelative(6.518f, 6.518f, 0.0f, false, false, -0.324f, 4.0f)
                lineTo(5.0f, 7.0f)
                verticalLineToRelative(4.0f)
                horizontalLineToRelative(10.035f)
                arcToRelative(6.47f, 6.47f, 0.0f, false, false, 3.465f, 1.0f)
                arcToRelative(6.48f, 6.48f, 0.0f, false, false, 2.5f, -0.498f)
                lineTo(21.0f, 18.0f)
