...
public val RemixIcons.FileAddLine: ImageVector
    get() {
        if (_fileAddLine != null) {
            return _fileAddLine!!
        }
        _fileAddLine = Builder(name = "FileAddLine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fileAddLine: ImageVector? = null
