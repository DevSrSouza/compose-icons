...
public val RemixIcons.ShieldCrossLine: ImageVector
    get() {
        if (_shieldCrossLine != null) {
            return _shieldCrossLine!!
        }
        _shieldCrossLine = Builder(name = "ShieldCrossLine", defaultWidth = 24.0.dp, defaultHeight =
