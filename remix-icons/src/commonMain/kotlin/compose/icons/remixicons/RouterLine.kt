...
public val RemixIcons.RouterLine: ImageVector
    get() {
        if (_routerLine != null) {
            return _routerLine!!
        }
        _routerLine = Builder(name = "RouterLine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _routerLine: ImageVector? = null
