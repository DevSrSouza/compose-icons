...
public val RemixIcons.TrafficLightLine: ImageVector
    get() {
        if (_trafficLightLine != null) {
            return _trafficLightLine!!
        }
        _trafficLightLine = Builder(name = "TrafficLightLine", defaultWidth = 24.0.dp, defaultHeight
