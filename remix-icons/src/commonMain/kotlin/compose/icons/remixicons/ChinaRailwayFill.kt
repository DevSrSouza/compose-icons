...
public val RemixIcons.ChinaRailwayFill: ImageVector
    get() {
        if (_chinaRailwayFill != null) {
            return _chinaRailwayFill!!
        }
        _chinaRailwayFill = Builder(name = "ChinaRailwayFill", defaultWidth = 24.0.dp, defaultHeight
