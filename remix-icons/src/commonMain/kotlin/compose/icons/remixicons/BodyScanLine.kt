...
public val RemixIcons.BodyScanLine: ImageVector
    get() {
        if (_bodyScanLine != null) {
            return _bodyScanLine!!
        }
        _bodyScanLine = Builder(name = "BodyScanLine", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.5f, 7.0f)
                arcToRelative(4.502f, 4.502f, 0.0f, false, false, 3.5f, 4.389f)
                lineTo(11.0f, 17.0f)
                horizontalLineToRelative(2.0f)
                lineToRelative(0.001f, -5.612f)
                arcTo(4.502f, 4.502f, 0.0f, false, false, 16.5f, 7.0f)
                horizontalLineToRelative(2.0f)
