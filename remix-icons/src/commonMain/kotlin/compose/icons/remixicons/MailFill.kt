...
public val RemixIcons.MailFill: ImageVector
    get() {
        if (_mailFill != null) {
            return _mailFill!!
        }
        _mailFill = Builder(name = "MailFill", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _mailFill: ImageVector? = null
