...
public val LineAwesomeIcons.LaughSolid: ImageVector
    get() {
        if (_laughSolid != null) {
            return _laughSolid!!
        }
        _laughSolid = Builder(name = "LaughSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _laughSolid: ImageVector? = null
