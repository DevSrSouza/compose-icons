...
public val LineAwesomeIcons.KissSolid: ImageVector
    get() {
        if (_kissSolid != null) {
            return _kissSolid!!
        }
        _kissSolid = Builder(name = "KissSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _kissSolid: ImageVector? = null
