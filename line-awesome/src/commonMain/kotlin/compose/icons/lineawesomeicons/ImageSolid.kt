...
public val LineAwesomeIcons.ImageSolid: ImageVector
    get() {
        if (_imageSolid != null) {
            return _imageSolid!!
        }
        _imageSolid = Builder(name = "ImageSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _imageSolid: ImageVector? = null
