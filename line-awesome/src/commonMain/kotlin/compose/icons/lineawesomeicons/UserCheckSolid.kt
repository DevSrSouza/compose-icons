    ...
    get() {
        ...
        _userCheckSolid = Builder(name = "UserCheckSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(25.281f, 19.281f)
                lineTo(22.0f, 22.563f)
                lineTo(19.719f, 20.281f)
                lineTo(18.281f, 21.719f)
                lineTo(21.281f, 24.719f)
                lineTo(22.0f, 25.406f)
                lineTo(22.719f, 24.719f)
