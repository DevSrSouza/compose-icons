    ...
    get() {
        ...
        _dev = Builder(name = "Dev", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(16.0f, 11.0f)
                close()
                moveTo(19.691f, 11.0f)
                lineTo(21.775f, 20.025f)
                curveTo(21.907f, 20.595f, 22.415f, 21.0f, 23.0f, 21.0f)
                curveTo(23.585f, 21.0f, 24.093f, 20.595f, 24.225f, 20.025f)
                lineTo(26.309f, 11.0f)
                lineTo(24.256f, 11.0f)
                lineTo(23.0f, 16.439f)
                lineTo(21.744f, 11.0f)
                lineTo(19.691f, 11.0f)
                close()
                moveTo(8.0f, 13.0f)
                lineTo(9.0f, 13.0f)
