...
public val LineAwesomeIcons.LightbulbSolid: ImageVector
    get() {
        if (_lightbulbSolid != null) {
            return _lightbulbSolid!!
        }
        _lightbulbSolid = Builder(name = "LightbulbSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _lightbulbSolid: ImageVector? = null
