...
public val LineAwesomeIcons.MobileAltSolid: ImageVector
    get() {
        if (_mobileAltSolid != null) {
            return _mobileAltSolid!!
        }
        _mobileAltSolid = Builder(name = "MobileAltSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _mobileAltSolid: ImageVector? = null
