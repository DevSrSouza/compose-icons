    ...
    get() {
        ...
        _lyft = Builder(name = "Lyft", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(7.063f, 22.0f)
                curveTo(6.41f, 21.363f, 6.0f, 20.478f, 6.0f, 19.5f)
                lineTo(6.0f, 16.0f)
                lineTo(6.0f, 9.5f)
                lineTo(6.0f, 8.0f)
                lineTo(2.0f, 8.0f)
                ...
                lineTo(30.0f, 16.0f)
                lineTo(30.0f, 12.0f)
                lineTo(27.787f, 12.0f)
                curveTo(27.133f, 9.693f, 25.017f, 8.0f, 22.5f, 8.0f)
                close()
                moveTo(7.0f, 12.0f)
                lineTo(7.0f, 19.0f)
                curveTo(7.0f, 20.65f, 8.35f, 22.0f, 10.0f, 22.0f)
                lineTo(10.5f, 22.0f)
                curveTo(11.209f, 22.0f, 11.867f, 21.786f, 12.418f, 21.424f)
                curveTo(12.287f, 21.621f, 12.139f, 21.806f, 11.971f, 21.971f)
                curveTo(11.341f, 22.611f, 10.46f, 23.0f, 9.5f, 23.0f)
                curveTo(8.96f, 23.0f, 8.45f, 22.88f, 8.0f, 22.65f)
                lineTo(8.0f, 25.58f)
                curveTo(8.61f, 25.85f, 9.29f, 26.0f, 10.0f, 26.0f)
                lineTo(11.0f, 26.0f)
