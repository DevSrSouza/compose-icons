...
public val LineAwesomeIcons.HandPointUpSolid: ImageVector
    get() {
        if (_handPointUpSolid != null) {
            return _handPointUpSolid!!
        }
        _handPointUpSolid = Builder(name = "HandPointUpSolid", defaultWidth = 32.0.dp, defaultHeight
...
private var _handPointUpSolid: ImageVector? = null
