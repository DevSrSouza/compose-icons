...
public val LineAwesomeIcons.FastBackwardSolid: ImageVector
    get() {
        if (_fastBackwardSolid != null) {
            return _fastBackwardSolid!!
        }
        _fastBackwardSolid = Builder(name = "FastBackwardSolid", defaultWidth = 32.0.dp,
...
private var _fastBackwardSolid: ImageVector? = null
