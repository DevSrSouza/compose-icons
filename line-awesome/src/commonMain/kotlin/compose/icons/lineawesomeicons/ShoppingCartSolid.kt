    ...
    get() {
        ...
        _shoppingCartSolid = Builder(name = "ShoppingCartSolid", defaultWidth = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(5.0f, 7.0f)
                curveTo(4.449f, 7.0f, 4.0f, 7.449f, 4.0f, 8.0f)
                curveTo(4.0f, 8.551f, 4.449f, 9.0f, 5.0f, 9.0f)
                lineTo(7.219f, 9.0f)
                lineTo(9.844f, 19.5f)
                curveTo(10.066f, 20.391f, 10.863f, 21.0f, 11.781f, 21.0f)
                lineTo(23.25f, 21.0f)
                curveTo(24.152f, 21.0f, 24.918f, 20.402f, 25.156f, 19.531f)
                lineTo(27.75f, 10.0f)
                lineTo(11.0f, 10.0f)
                lineTo(11.5f, 12.0f)
                lineTo(25.156f, 12.0f)
                lineTo(23.25f, 19.0f)
                lineTo(11.781f, 19.0f)
                lineTo(9.156f, 8.5f)
                curveTo(8.934f, 7.609f, 8.137f, 7.0f, 7.219f, 7.0f)
                close()
                moveTo(22.0f, 21.0f)
