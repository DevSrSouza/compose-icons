...
public val LineAwesomeIcons.GrinSolid: ImageVector
    get() {
        if (_grinSolid != null) {
            return _grinSolid!!
        }
        _grinSolid = Builder(name = "GrinSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _grinSolid: ImageVector? = null
