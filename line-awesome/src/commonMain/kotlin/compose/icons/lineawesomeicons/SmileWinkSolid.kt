...
public val LineAwesomeIcons.SmileWinkSolid: ImageVector
    get() {
        if (_smileWinkSolid != null) {
            return _smileWinkSolid!!
        }
        _smileWinkSolid = Builder(name = "SmileWinkSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _smileWinkSolid: ImageVector? = null
