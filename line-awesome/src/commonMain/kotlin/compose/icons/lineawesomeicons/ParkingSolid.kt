    ...
    get() {
        ...
        _parkingSolid = Builder(name = "ParkingSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(14.0f, 19.0f)
                lineTo(17.0f, 19.0f)
                curveTo(18.645f, 19.0f, 20.0f, 17.645f, 20.0f, 16.0f)
                lineTo(20.0f, 13.0f)
                curveTo(20.0f, 11.355f, 18.645f, 10.0f, 17.0f, 10.0f)
                close()
                moveTo(14.0f, 12.0f)
                lineTo(17.0f, 12.0f)
                curveTo(17.566f, 12.0f, 18.0f, 12.434f, 18.0f, 13.0f)
                lineTo(18.0f, 16.0f)
                curveTo(18.0f, 16.566f, 17.566f, 17.0f, 17.0f, 17.0f)
                lineTo(14.0f, 17.0f)
                close()
            }
        }
