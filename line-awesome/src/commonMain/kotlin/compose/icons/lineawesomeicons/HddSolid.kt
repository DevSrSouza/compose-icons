...
public val LineAwesomeIcons.HddSolid: ImageVector
    get() {
        if (_hddSolid != null) {
            return _hddSolid!!
        }
        _hddSolid = Builder(name = "HddSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _hddSolid: ImageVector? = null
