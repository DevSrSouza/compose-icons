    ...
    get() {
        ...
        _photoVideoSolid = Builder(name = "PhotoVideoSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(4.0f, 13.0f)
                lineTo(21.0f, 13.0f)
                lineTo(21.0f, 22.781f)
                lineTo(18.406f, 20.188f)
                lineTo(17.688f, 19.5f)
                lineTo(14.875f, 22.313f)
                lineTo(10.594f, 18.0f)
                lineTo(9.906f, 17.281f)
                lineTo(4.0f, 23.188f)
                lineTo(4.0f, 13.0f)
                close()
                moveTo(15.5f, 15.0f)
                ...
                close()
                moveTo(9.904f, 20.125f)
                lineTo(14.904f, 25.125f)
                lineTo(15.594f, 24.406f)
                lineTo(17.688f, 22.313f)
                lineTo(21.0f, 25.625f)
                lineTo(21.0f, 27.0f)
                lineTo(4.0f, 27.0f)
                lineTo(4.0f, 26.031f)
                lineTo(9.904f, 20.125f)
                close()
            }
        }
        .build()
