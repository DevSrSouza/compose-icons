...
public val LineAwesomeIcons.ClosedCaptioningSolid: ImageVector
    get() {
        if (_closedCaptioningSolid != null) {
            return _closedCaptioningSolid!!
        }
        _closedCaptioningSolid = Builder(name = "ClosedCaptioningSolid", defaultWidth = 32.0.dp,
