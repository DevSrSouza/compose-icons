...
public val LineAwesomeIcons.SmileBeamSolid: ImageVector
    get() {
        if (_smileBeamSolid != null) {
            return _smileBeamSolid!!
        }
        _smileBeamSolid = Builder(name = "SmileBeamSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _smileBeamSolid: ImageVector? = null
