...
public val LineAwesomeIcons.GrimaceSolid: ImageVector
    get() {
        if (_grimaceSolid != null) {
            return _grimaceSolid!!
        }
        _grimaceSolid = Builder(name = "GrimaceSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _grimaceSolid: ImageVector? = null
