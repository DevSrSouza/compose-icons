...
public val LineAwesomeIcons.LaughBeamSolid: ImageVector
    get() {
        if (_laughBeamSolid != null) {
            return _laughBeamSolid!!
        }
        _laughBeamSolid = Builder(name = "LaughBeamSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _laughBeamSolid: ImageVector? = null
