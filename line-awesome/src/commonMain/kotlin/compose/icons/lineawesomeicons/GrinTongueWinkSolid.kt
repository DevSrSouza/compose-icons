...
public val LineAwesomeIcons.GrinTongueWinkSolid: ImageVector
    get() {
        if (_grinTongueWinkSolid != null) {
            return _grinTongueWinkSolid!!
        }
        _grinTongueWinkSolid = Builder(name = "GrinTongueWinkSolid", defaultWidth = 32.0.dp,
...
private var _grinTongueWinkSolid: ImageVector? = null
