...
public val LineAwesomeIcons.ThermometerHalfSolid: ImageVector
    get() {
        if (_thermometerHalfSolid != null) {
            return _thermometerHalfSolid!!
        }
        _thermometerHalfSolid = Builder(name = "ThermometerHalfSolid", defaultWidth = 32.0.dp,
...
private var _thermometerHalfSolid: ImageVector? = null
