    ...
    get() {
        ...
        _goodreadsG = Builder(name = "GoodreadsG", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.39f, 22.0f, 20.533f, 20.743f, 22.0f, 18.764f)
                lineTo(22.0f, 22.0f)
                curveTo(22.0f, 24.757f, 19.309f, 27.0f, 16.0f, 27.0f)
                curveTo(13.545f, 27.0f, 11.433f, 25.764f, 10.506f, 24.0f)
                lineTo(8.338f, 24.0f)
                curveTo(9.324f, 26.887f, 12.383f, 29.0f, 16.0f, 29.0f)
                curveTo(20.411f, 29.0f, 24.0f, 25.859f, 24.0f, 22.0f)
                lineTo(24.0f, 4.0f)
                lineTo(22.0f, 4.0f)
                lineTo(22.0f, 6.236f)
                curveTo(20.533f, 4.257f, 18.39f, 3.0f, 16.0f, 3.0f)
                close()
                moveTo(16.0f, 5.0f)
