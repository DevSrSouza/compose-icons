...
public val LineAwesomeIcons.GrinSquintSolid: ImageVector
    get() {
        if (_grinSquintSolid != null) {
            return _grinSquintSolid!!
        }
        _grinSquintSolid = Builder(name = "GrinSquintSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _grinSquintSolid: ImageVector? = null
