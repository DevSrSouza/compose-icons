...
public val LineAwesomeIcons.ListAltSolid: ImageVector
    get() {
        if (_listAltSolid != null) {
            return _listAltSolid!!
        }
        _listAltSolid = Builder(name = "ListAltSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _listAltSolid: ImageVector? = null
