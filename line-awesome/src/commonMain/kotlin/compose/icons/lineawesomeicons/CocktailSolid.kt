...
public val LineAwesomeIcons.CocktailSolid: ImageVector
    get() {
        if (_cocktailSolid != null) {
            return _cocktailSolid!!
        }
        _cocktailSolid = Builder(name = "CocktailSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _cocktailSolid: ImageVector? = null
