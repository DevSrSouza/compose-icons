...
public val LineAwesomeIcons.LaughWinkSolid: ImageVector
    get() {
        if (_laughWinkSolid != null) {
            return _laughWinkSolid!!
        }
        _laughWinkSolid = Builder(name = "LaughWinkSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _laughWinkSolid: ImageVector? = null
