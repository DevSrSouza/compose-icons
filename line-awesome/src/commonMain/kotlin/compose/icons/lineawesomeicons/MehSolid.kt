...
public val LineAwesomeIcons.MehSolid: ImageVector
    get() {
        if (_mehSolid != null) {
            return _mehSolid!!
        }
        _mehSolid = Builder(name = "MehSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _mehSolid: ImageVector? = null
