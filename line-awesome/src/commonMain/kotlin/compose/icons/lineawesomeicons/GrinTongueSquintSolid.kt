...
public val LineAwesomeIcons.GrinTongueSquintSolid: ImageVector
    get() {
        if (_grinTongueSquintSolid != null) {
            return _grinTongueSquintSolid!!
        }
        _grinTongueSquintSolid = Builder(name = "GrinTongueSquintSolid", defaultWidth = 32.0.dp,
...
private var _grinTongueSquintSolid: ImageVector? = null
