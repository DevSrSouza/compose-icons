    ...
    get() {
        ...
        _goodreads = Builder(name = "Goodreads", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.921f, 19.0f, 18.175f, 18.25f, 19.0f, 17.104f)
                lineTo(19.0f, 18.5f)
                curveTo(19.0f, 20.43f, 17.43f, 22.0f, 15.5f, 22.0f)
                curveTo(14.109f, 22.0f, 12.916f, 21.178f, 12.352f, 20.0f)
                lineTo(11.275f, 20.0f)
                curveTo(11.896f, 21.742f, 13.547f, 23.0f, 15.5f, 23.0f)
                curveTo(17.981f, 23.0f, 20.0f, 20.981f, 20.0f, 18.5f)
                lineTo(20.0f, 10.0f)
                lineTo(19.0f, 10.0f)
                lineTo(19.0f, 10.896f)
                curveTo(18.175f, 9.75f, 16.921f, 9.0f, 15.5f, 9.0f)
                close()
                moveTo(15.5f, 10.0f)
