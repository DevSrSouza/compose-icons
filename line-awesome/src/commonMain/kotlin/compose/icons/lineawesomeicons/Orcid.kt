    ...
    get() {
        ...
        _orcid = Builder(name = "Orcid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(14.0f, 22.0f)
                lineTo(18.5f, 22.0f)
                curveTo(21.526f, 22.0f, 24.0f, 19.526f, 24.0f, 16.5f)
                curveTo(24.0f, 13.474f, 21.526f, 11.0f, 18.5f, 11.0f)
                lineTo(14.0f, 11.0f)
                close()
                moveTo(16.0f, 13.0f)
                lineTo(18.5f, 13.0f)
                curveTo(20.444f, 13.0f, 22.0f, 14.556f, 22.0f, 16.5f)
                curveTo(22.0f, 18.444f, 20.444f, 20.0f, 18.5f, 20.0f)
                lineTo(16.0f, 20.0f)
                lineTo(16.0f, 13.0f)
                close()
            }
