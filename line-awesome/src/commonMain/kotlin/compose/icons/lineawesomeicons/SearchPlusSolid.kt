...
public val LineAwesomeIcons.SearchPlusSolid: ImageVector
    get() {
        if (_searchPlusSolid != null) {
            return _searchPlusSolid!!
        }
        _searchPlusSolid = Builder(name = "SearchPlusSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _searchPlusSolid: ImageVector? = null
