...
public val LineAwesomeIcons.ShareSquareSolid: ImageVector
    get() {
        if (_shareSquareSolid != null) {
            return _shareSquareSolid!!
        }
        _shareSquareSolid = Builder(name = "ShareSquareSolid", defaultWidth = 32.0.dp, defaultHeight
...
private var _shareSquareSolid: ImageVector? = null
