...
public val LineAwesomeIcons.LockOpenSolid: ImageVector
    get() {
        if (_lockOpenSolid != null) {
            return _lockOpenSolid!!
        }
        _lockOpenSolid = Builder(name = "LockOpenSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _lockOpenSolid: ImageVector? = null
