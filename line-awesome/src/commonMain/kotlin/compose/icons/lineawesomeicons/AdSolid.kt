    ...
    get() {
        ...
        _adSolid = Builder(name = "AdSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(4.0f, 9.0f)
                close()
                moveTo(11.719f, 11.0f)
                lineTo(11.5f, 11.688f)
                lineTo(9.031f, 19.406f)
                lineTo(9.0f, 19.563f)
                lineTo(9.0f, 21.0f)
                lineTo(11.0f, 21.0f)
                lineTo(11.0f, 20.0f)
                ...
                lineTo(14.0f, 21.0f)
                lineTo(16.0f, 21.0f)
                lineTo(16.0f, 19.563f)
                lineTo(15.969f, 19.406f)
                lineTo(13.5f, 11.688f)
                lineTo(13.281f, 11.0f)
                lineTo(11.719f, 11.0f)
                close()
                moveTo(21.0f, 11.0f)
                lineTo(21.0f, 15.0f)
                lineTo(19.5f, 15.0f)
                ...
                lineTo(21.0f, 11.0f)
                close()
                moveTo(12.5f, 15.156f)
                lineTo(13.406f, 18.0f)
                lineTo(11.594f, 18.0f)
                lineTo(12.5f, 15.156f)
                close()
                moveTo(19.5f, 17.0f)
                lineTo(21.0f, 17.0f)
                lineTo(21.0f, 19.0f)
