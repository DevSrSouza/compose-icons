...
public val LineAwesomeIcons.CartPlusSolid: ImageVector
    get() {
        if (_cartPlusSolid != null) {
            return _cartPlusSolid!!
        }
        _cartPlusSolid = Builder(name = "CartPlusSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _cartPlusSolid: ImageVector? = null
