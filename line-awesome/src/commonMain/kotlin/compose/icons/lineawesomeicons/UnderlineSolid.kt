    ...
    get() {
        ...
        _underlineSolid = Builder(name = "UnderlineSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.0f, 4.0f)
                lineTo(8.0f, 16.0f)
                curveTo(8.0f, 20.43f, 11.57f, 24.0f, 16.0f, 24.0f)
                curveTo(20.43f, 24.0f, 24.0f, 20.43f, 24.0f, 16.0f)
                lineTo(24.0f, 4.0f)
                lineTo(22.0f, 4.0f)
                lineTo(22.0f, 16.0f)
                curveTo(22.0f, 19.371f, 19.371f, 22.0f, 16.0f, 22.0f)
                curveTo(12.629f, 22.0f, 10.0f, 19.371f, 10.0f, 16.0f)
                lineTo(10.0f, 4.0f)
                close()
                moveTo(6.0f, 26.0f)
                lineTo(6.0f, 28.0f)
