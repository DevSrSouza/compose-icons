    ...
    get() {
        ...
        _scrollSolid = Builder(name = "ScrollSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(21.0f, 28.0f)
                lineTo(21.031f, 28.0f)
                curveTo(22.66f, 27.984f, 24.0f, 26.633f, 24.0f, 25.0f)
                lineTo(24.0f, 11.0f)
                lineTo(28.0f, 11.0f)
                lineTo(28.0f, 7.0f)
                ...
                moveTo(6.0f, 23.0f)
                lineTo(14.0f, 23.0f)
                lineTo(17.969f, 23.0f)
                lineTo(18.0f, 23.0f)
                lineTo(18.0f, 25.0f)
                lineTo(18.0f, 25.031f)
                curveTo(18.004f, 25.375f, 18.074f, 25.691f, 18.188f, 26.0f)
                lineTo(7.0f, 26.0f)
