...
public val LineAwesomeIcons.UserPlusSolid: ImageVector
    get() {
        if (_userPlusSolid != null) {
            return _userPlusSolid!!
        }
        _userPlusSolid = Builder(name = "UserPlusSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _userPlusSolid: ImageVector? = null
