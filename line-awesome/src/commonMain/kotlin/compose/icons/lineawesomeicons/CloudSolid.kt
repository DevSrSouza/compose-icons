...
public val LineAwesomeIcons.CloudSolid: ImageVector
    get() {
        if (_cloudSolid != null) {
            return _cloudSolid!!
        }
        _cloudSolid = Builder(name = "CloudSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _cloudSolid: ImageVector? = null
