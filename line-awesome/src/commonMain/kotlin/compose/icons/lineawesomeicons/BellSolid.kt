...
public val LineAwesomeIcons.BellSolid: ImageVector
    get() {
        if (_bellSolid != null) {
            return _bellSolid!!
        }
        _bellSolid = Builder(name = "BellSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _bellSolid: ImageVector? = null
