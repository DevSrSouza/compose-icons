...
public val LineAwesomeIcons.FirstAidSolid: ImageVector
    get() {
        if (_firstAidSolid != null) {
            return _firstAidSolid!!
        }
        _firstAidSolid = Builder(name = "FirstAidSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _firstAidSolid: ImageVector? = null
