...
public val LineAwesomeIcons.LuggageCartSolid: ImageVector
    get() {
        if (_luggageCartSolid != null) {
            return _luggageCartSolid!!
        }
        _luggageCartSolid = Builder(name = "LuggageCartSolid", defaultWidth = 32.0.dp, defaultHeight
...
private var _luggageCartSolid: ImageVector? = null
