    ...
    get() {
        ...
        _rubleSignSolid = Builder(name = "RubleSignSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(13.0f, 18.0f)
                lineTo(19.0f, 18.0f)
                curveTo(22.301f, 18.0f, 25.0f, 15.301f, 25.0f, 12.0f)
                curveTo(25.0f, 8.699f, 22.301f, 6.0f, 19.0f, 6.0f)
                close()
                moveTo(13.0f, 8.0f)
                lineTo(19.0f, 8.0f)
                curveTo(21.219f, 8.0f, 23.0f, 9.781f, 23.0f, 12.0f)
                curveTo(23.0f, 14.219f, 21.219f, 16.0f, 19.0f, 16.0f)
                lineTo(13.0f, 16.0f)
                close()
            }
        }
