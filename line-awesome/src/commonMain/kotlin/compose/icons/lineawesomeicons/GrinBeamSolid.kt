...
public val LineAwesomeIcons.GrinBeamSolid: ImageVector
    get() {
        if (_grinBeamSolid != null) {
            return _grinBeamSolid!!
        }
        _grinBeamSolid = Builder(name = "GrinBeamSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _grinBeamSolid: ImageVector? = null
