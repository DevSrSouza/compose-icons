    ...
    get() {
        ...
        _commentDollarSolid = Builder(name = "CommentDollarSolid", defaultWidth = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.0f, 10.0f)
                lineTo(15.0f, 11.188f)
                curveTo(13.844f, 11.606f, 13.0f, 12.709f, 13.0f, 14.002f)
                ...
                curveTo(13.0f, 19.295f, 13.844f, 20.396f, 15.0f, 20.814f)
                lineTo(15.0f, 22.0f)
                lineTo(17.0f, 22.0f)
                lineTo(17.0f, 20.813f)
                curveTo(18.156f, 20.395f, 19.0f, 19.291f, 19.0f, 17.998f)
                ...
                curveTo(19.0f, 12.705f, 18.156f, 11.604f, 17.0f, 11.186f)
                lineTo(17.0f, 10.0f)
                lineTo(15.0f, 10.0f)
                close()
            }
