...
public val LineAwesomeIcons.SnowflakeSolid: ImageVector
    get() {
        if (_snowflakeSolid != null) {
            return _snowflakeSolid!!
        }
        _snowflakeSolid = Builder(name = "SnowflakeSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _snowflakeSolid: ImageVector? = null
