...
public val LineAwesomeIcons.HandPointerSolid: ImageVector
    get() {
        if (_handPointerSolid != null) {
            return _handPointerSolid!!
        }
        _handPointerSolid = Builder(name = "HandPointerSolid", defaultWidth = 32.0.dp, defaultHeight
...
private var _handPointerSolid: ImageVector? = null
