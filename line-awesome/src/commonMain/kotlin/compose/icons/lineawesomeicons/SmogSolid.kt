    ...
    get() {
        ...
        _smogSolid = Builder(name = "SmogSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(15.023f, 17.0f)
                curveTo(15.936f, 18.208f, 17.37f, 19.0f, 19.0f, 19.0f)
                curveTo(20.63f, 19.0f, 22.065f, 18.208f, 22.977f, 17.0f)
                lineTo(25.5f, 17.0f)
                curveTo(27.985f, 17.0f, 30.0f, 14.985f, 30.0f, 12.5f)
                curveTo(30.0f, 10.015f, 27.985f, 8.0f, 25.5f, 8.0f)
                curveTo(24.596f, 8.0f, 23.758f, 8.271f, 23.053f, 8.73f)
                curveTo(22.158f, 6.542f, 20.01f, 5.0f, 17.5f, 5.0f)
                curveTo(15.564f, 5.0f, 13.847f, 5.921f, 12.75f, 7.344f)
                curveTo(11.653f, 5.921f, 9.936f, 5.0f, 8.0f, 5.0f)
                close()
                moveTo(5.0f, 21.0f)
                lineTo(5.0f, 23.0f)
                lineTo(30.0f, 23.0f)
