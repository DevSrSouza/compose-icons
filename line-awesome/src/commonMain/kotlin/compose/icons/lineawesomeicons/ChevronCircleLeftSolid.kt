...
public val LineAwesomeIcons.ChevronCircleLeftSolid: ImageVector
    get() {
        if (_chevronCircleLeftSolid != null) {
            return _chevronCircleLeftSolid!!
        }
        _chevronCircleLeftSolid = Builder(name = "ChevronCircleLeftSolid", defaultWidth = 32.0.dp,
...
private var _chevronCircleLeftSolid: ImageVector? = null
