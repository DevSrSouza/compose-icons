    ...
    get() {
        ...
        _mizuni = Builder(name = "Mizuni", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(10.0f, 22.0f)
                curveTo(10.79f, 21.22f, 11.82f, 20.589f, 13.0f, 20.199f)
                lineTo(13.0f, 11.5f)
                ...
                lineTo(14.5f, 19.83f)
                curveTo(14.99f, 19.75f, 15.49f, 19.711f, 16.01f, 19.711f)
                curveTo(16.52f, 19.711f, 17.01f, 19.75f, 17.5f, 19.83f)
                lineTo(17.5f, 11.5f)
                curveTo(17.5f, 10.67f, 16.83f, 10.0f, 16.0f, 10.0f)
                close()
                moveTo(20.5f, 10.0f)
                curveTo(19.67f, 10.0f, 19.0f, 10.67f, 19.0f, 11.5f)
                lineTo(19.0f, 20.189f)
                curveTo(20.18f, 20.589f, 21.21f, 21.21f, 22.0f, 21.99f)
                lineTo(22.0f, 11.5f)
