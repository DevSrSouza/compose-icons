...
public val LineAwesomeIcons.SurpriseSolid: ImageVector
    get() {
        if (_surpriseSolid != null) {
            return _surpriseSolid!!
        }
        _surpriseSolid = Builder(name = "SurpriseSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _surpriseSolid: ImageVector? = null
