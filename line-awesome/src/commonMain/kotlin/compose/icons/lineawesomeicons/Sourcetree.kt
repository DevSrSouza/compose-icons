    ...
    get() {
        ...
        _sourcetree = Builder(name = "Sourcetree", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.0f, 17.983f, 8.383f, 21.577f, 12.0f, 23.156f)
                lineTo(12.0f, 28.0f)
                lineTo(20.0f, 28.0f)
                lineTo(20.0f, 23.156f)
                curveTo(23.617f, 21.577f, 26.0f, 17.983f, 26.0f, 14.0f)
                curveTo(26.0f, 8.486f, 21.514f, 4.0f, 16.0f, 4.0f)
                close()
                moveTo(16.0f, 6.0f)
                curveTo(20.411f, 6.0f, 24.0f, 9.589f, 24.0f, 14.0f)
                curveTo(24.0f, 17.377f, 21.856f, 20.404f, 18.666f, 21.535f)
                lineTo(18.0f, 21.77f)
                lineTo(18.0f, 26.0f)
                lineTo(14.0f, 26.0f)
                lineTo(14.0f, 21.77f)
                lineTo(13.334f, 21.533f)
                curveTo(10.144f, 20.403f, 8.0f, 17.377f, 8.0f, 14.0f)
