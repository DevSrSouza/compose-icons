...
public val LineAwesomeIcons.DiceFiveSolid: ImageVector
    get() {
        if (_diceFiveSolid != null) {
            return _diceFiveSolid!!
        }
        _diceFiveSolid = Builder(name = "DiceFiveSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _diceFiveSolid: ImageVector? = null
