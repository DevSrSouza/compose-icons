    ...
    get() {
        ...
        _creativeCommonsBy = Builder(name = "CreativeCommonsBy", defaultWidth = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.0f, 3.0f)
                curveTo(8.855f, 3.0f, 3.0f, 8.855f, 3.0f, 16.0f)
                curveTo(3.0f, 23.145f, 8.855f, 29.0f, 16.0f, 29.0f)
                curveTo(23.145f, 29.0f, 29.0f, 23.145f, 29.0f, 16.0f)
                curveTo(29.0f, 8.855f, 23.145f, 3.0f, 16.0f, 3.0f)
                close()
                moveTo(16.0f, 5.0f)
                curveTo(22.055f, 5.0f, 27.0f, 9.945f, 27.0f, 16.0f)
                curveTo(27.0f, 22.055f, 22.055f, 27.0f, 16.0f, 27.0f)
                curveTo(9.945f, 27.0f, 5.0f, 22.055f, 5.0f, 16.0f)
                curveTo(5.0f, 9.945f, 9.945f, 5.0f, 16.0f, 5.0f)
                close()
                moveTo(16.0f, 8.0f)
