    ...
    get() {
        ...
        _dochub = Builder(name = "Dochub", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(26.0f, 14.0f)
                lineTo(20.0f, 14.0f)
                lineTo(20.0f, 18.938f)
                curveTo(20.0f, 20.626f, 18.626f, 22.0f, 16.938f, 22.0f)
                lineTo(13.0f, 22.0f)
                lineTo(13.0f, 10.0f)
                lineTo(17.0f, 10.0f)
                lineTo(17.0f, 4.0f)
                ...
                lineTo(11.0f, 8.0f)
                lineTo(11.0f, 24.0f)
                lineTo(16.938f, 24.0f)
                curveTo(19.729f, 24.0f, 22.0f, 21.729f, 22.0f, 18.938f)
                lineTo(22.0f, 16.0f)
                lineTo(24.0f, 16.0f)
                lineTo(24.0f, 20.0f)
