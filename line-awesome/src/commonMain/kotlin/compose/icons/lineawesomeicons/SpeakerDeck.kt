    ...
    get() {
        ...
        _speakerDeck = Builder(name = "SpeakerDeck", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.445f, 8.0f)
                curveTo(18.789f, 8.59f, 19.0f, 9.268f, 19.0f, 10.0f)
                curveTo(19.0f, 10.734f, 18.783f, 11.409f, 18.439f, 12.0f)
                lineTo(24.0f, 12.0f)
                curveTo(24.552f, 12.0f, 25.0f, 12.448f, 25.0f, 13.0f)
                lineTo(25.0f, 19.0f)
                curveTo(25.0f, 19.552f, 24.552f, 20.0f, 24.0f, 20.0f)
                lineTo(20.92f, 20.0f)
                curveTo(20.696f, 21.556f, 19.964f, 22.949f, 18.889f, 24.0f)
                lineTo(25.0f, 24.0f)
