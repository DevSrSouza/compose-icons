    ...
    get() {
        ...
        _thermometerQuarterSolid = Builder(name = "ThermometerQuarterSolid", defaultWidth = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(18.0f, 6.0f)
                lineTo(18.0f, 16.4f)
                lineTo(18.5f, 16.699f)
                curveTo(20.0f, 17.499f, 21.0f, 19.2f, 21.0f, 21.0f)
                curveTo(21.0f, 23.8f, 18.8f, 26.0f, 16.0f, 26.0f)
                curveTo(13.2f, 26.0f, 11.0f, 23.8f, 11.0f, 21.0f)
                curveTo(11.0f, 19.2f, 12.0f, 17.499f, 13.5f, 16.699f)
                lineTo(14.0f, 16.4f)
                lineTo(14.0f, 6.0f)
                close()
                moveTo(13.801f, 19.0f)
                curveTo(13.301f, 19.5f, 13.0f, 20.2f, 13.0f, 21.0f)
                curveTo(13.0f, 22.7f, 14.3f, 24.0f, 16.0f, 24.0f)
                curveTo(17.7f, 24.0f, 19.0f, 22.7f, 19.0f, 21.0f)
                curveTo(19.0f, 20.2f, 18.699f, 19.5f, 18.199f, 19.0f)
                lineTo(13.801f, 19.0f)
                close()
            }
        }
        .build()
