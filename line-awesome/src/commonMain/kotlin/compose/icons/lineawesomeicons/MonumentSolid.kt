    ...
    get() {
        ...
        _monumentSolid = Builder(name = "MonumentSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.0f, 7.105f, 14.895f, 8.0f, 16.0f, 8.0f)
                curveTo(17.105f, 8.0f, 18.0f, 7.105f, 18.0f, 6.0f)
                curveTo(18.0f, 4.895f, 17.105f, 4.0f, 16.0f, 4.0f)
                close()
                moveTo(16.0f, 8.0f)
                lineTo(12.0f, 8.0f)
                lineTo(12.0f, 10.0f)
                lineTo(13.469f, 10.0f)
                lineTo(13.031f, 20.0f)
                lineTo(10.0f, 20.0f)
                lineTo(10.0f, 26.0f)
                lineTo(8.0f, 26.0f)
                lineTo(8.0f, 28.0f)
                ...
                lineTo(22.0f, 26.0f)
                lineTo(22.0f, 20.0f)
                lineTo(18.969f, 20.0f)
                lineTo(18.531f, 10.0f)
                lineTo(20.0f, 10.0f)
                lineTo(20.0f, 8.0f)
                close()
                moveTo(15.469f, 10.0f)
                lineTo(16.531f, 10.0f)
                lineTo(16.969f, 20.0f)
                lineTo(15.031f, 20.0f)
                close()
                moveTo(12.0f, 22.0f)
                lineTo(20.0f, 22.0f)
                lineTo(20.0f, 26.0f)
