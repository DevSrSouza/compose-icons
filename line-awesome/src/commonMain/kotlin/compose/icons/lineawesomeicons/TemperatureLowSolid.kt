...
public val LineAwesomeIcons.TemperatureLowSolid: ImageVector
    get() {
        if (_temperatureLowSolid != null) {
            return _temperatureLowSolid!!
        }
        _temperatureLowSolid = Builder(name = "TemperatureLowSolid", defaultWidth = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(9.0f, 4.0f)
                lineTo(9.0f, 15.469f)
                curveTo(7.25f, 16.738f, 6.0f, 18.676f, 6.0f, 21.0f)
                curveTo(6.0f, 24.855f, 9.145f, 28.0f, 13.0f, 28.0f)
                curveTo(16.855f, 28.0f, 20.0f, 24.855f, 20.0f, 21.0f)
                curveTo(20.0f, 18.676f, 18.75f, 16.738f, 17.0f, 15.469f)
                lineTo(17.0f, 14.0f)
                lineTo(19.0f, 14.0f)
                lineTo(19.0f, 12.0f)
                lineTo(17.0f, 12.0f)
                ...
                lineTo(15.5f, 16.688f)
                curveTo(16.996f, 17.556f, 18.0f, 19.148f, 18.0f, 21.0f)
                curveTo(18.0f, 23.773f, 15.773f, 26.0f, 13.0f, 26.0f)
                curveTo(10.227f, 26.0f, 8.0f, 23.773f, 8.0f, 21.0f)
                curveTo(8.0f, 19.148f, 9.004f, 17.556f, 10.5f, 16.688f)
                lineTo(11.0f, 16.406f)
                lineTo(11.0f, 6.0f)
                close()
                moveTo(24.5f, 6.0f)
                ...
                close()
                moveTo(12.0f, 16.0f)
                lineTo(12.0f, 18.188f)
                curveTo(10.84f, 18.601f, 10.0f, 19.701f, 10.0f, 21.002f)
                curveTo(10.0f, 22.658f, 11.344f, 24.002f, 13.0f, 24.002f)
                curveTo(14.656f, 24.002f, 16.0f, 22.658f, 16.0f, 21.002f)
                curveTo(16.0f, 19.701f, 15.16f, 18.603f, 14.0f, 18.188f)
                lineTo(14.0f, 16.0f)
                lineTo(12.0f, 16.0f)
                close()
            }
...
private var _temperatureLowSolid: ImageVector? = null
