...
public val LineAwesomeIcons.ClockSolid: ImageVector
    get() {
        if (_clockSolid != null) {
            return _clockSolid!!
        }
        _clockSolid = Builder(name = "ClockSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _clockSolid: ImageVector? = null
