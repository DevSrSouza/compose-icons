    ...
    get() {
        ...
        _ellipsisVSolid = Builder(name = "EllipsisVSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.0f, 6.0f)
                curveTo(14.895f, 6.0f, 14.0f, 6.895f, 14.0f, 8.0f)
                curveTo(14.0f, 9.105f, 14.895f, 10.0f, 16.0f, 10.0f)
                ...
                close()
                moveTo(16.0f, 22.0f)
                curveTo(14.895f, 22.0f, 14.0f, 22.895f, 14.0f, 24.0f)
                curveTo(14.0f, 25.105f, 14.895f, 26.0f, 16.0f, 26.0f)
                curveTo(17.105f, 26.0f, 18.0f, 25.105f, 18.0f, 24.0f)
                curveTo(18.0f, 22.895f, 17.105f, 22.0f, 16.0f, 22.0f)
                close()
            }
        }
        .build()
