...
public val LineAwesomeIcons.GrinWinkSolid: ImageVector
    get() {
        if (_grinWinkSolid != null) {
            return _grinWinkSolid!!
        }
        _grinWinkSolid = Builder(name = "GrinWinkSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _grinWinkSolid: ImageVector? = null
