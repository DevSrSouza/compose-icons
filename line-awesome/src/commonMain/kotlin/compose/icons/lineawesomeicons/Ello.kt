    ...
    get() {
        ...
        _ello = Builder(name = "Ello", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.08f, 17.0f)
                curveTo(9.568f, 20.387f, 12.481f, 23.0f, 16.0f, 23.0f)
                curveTo(19.519f, 23.0f, 22.432f, 20.387f, 22.92f, 17.0f)
                lineTo(20.898f, 17.0f)
                curveTo(20.433f, 19.279f, 18.415f, 21.0f, 16.0f, 21.0f)
                curveTo(13.585f, 21.0f, 11.567f, 19.279f, 11.102f, 17.0f)
                lineTo(9.08f, 17.0f)
                close()
            }
        }
