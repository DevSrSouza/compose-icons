    ...
    get() {
        ...
        _proceduresSolid = Builder(name = "ProceduresSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.125f, 0.438f)
                lineTo(14.375f, 6.0f)
                lineTo(9.0f, 6.0f)
                lineTo(9.0f, 8.0f)
                lineTo(15.625f, 8.0f)
                lineTo(16.875f, 5.438f)
                lineTo(19.719f, 13.0f)
                lineTo(23.5f, 8.0f)
                lineTo(28.0f, 8.0f)
                lineTo(28.0f, 6.0f)
                lineTo(22.5f, 6.0f)
                lineTo(20.281f, 8.875f)
                lineTo(17.125f, 0.438f)
                close()
                moveTo(6.5f, 11.0f)
                ...
                lineTo(13.0f, 14.0f)
                lineTo(13.0f, 14.563f)
                curveTo(12.406f, 14.215f, 11.734f, 14.0f, 11.0f, 14.0f)
                curveTo(10.266f, 14.0f, 9.594f, 14.215f, 9.0f, 14.563f)
                lineTo(9.0f, 13.5f)
