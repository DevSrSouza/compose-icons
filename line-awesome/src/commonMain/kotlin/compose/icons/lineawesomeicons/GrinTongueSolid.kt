...
public val LineAwesomeIcons.GrinTongueSolid: ImageVector
    get() {
        if (_grinTongueSolid != null) {
            return _grinTongueSolid!!
        }
        _grinTongueSolid = Builder(name = "GrinTongueSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _grinTongueSolid: ImageVector? = null
