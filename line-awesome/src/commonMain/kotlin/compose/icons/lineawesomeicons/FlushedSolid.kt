...
public val LineAwesomeIcons.FlushedSolid: ImageVector
    get() {
        if (_flushedSolid != null) {
            return _flushedSolid!!
        }
        _flushedSolid = Builder(name = "FlushedSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.361f, 19.0f, 15.004f, 18.068f, 16.0f, 16.65f)
                curveTo(16.996f, 18.068f, 18.639f, 19.0f, 20.5f, 19.0f)
                curveTo(23.533f, 19.0f, 26.0f, 16.533f, 26.0f, 13.5f)
                curveTo(26.0f, 10.467f, 23.533f, 8.0f, 20.5f, 8.0f)
                curveTo(18.639f, 8.0f, 16.996f, 8.932f, 16.0f, 10.35f)
                curveTo(15.004f, 8.932f, 13.361f, 8.0f, 11.5f, 8.0f)
                close()
                moveTo(11.5f, 10.0f)
...
private var _flushedSolid: ImageVector? = null
