    ...
    get() {
        ...
        _quoteLeftSolid = Builder(name = "QuoteLeftSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(10.0f, 8.0f)
                curveTo(6.699f, 8.0f, 4.0f, 10.699f, 4.0f, 14.0f)
                lineTo(4.0f, 24.0f)
                lineTo(14.0f, 24.0f)
                lineTo(14.0f, 14.0f)
                lineTo(6.0f, 14.0f)
                curveTo(6.0f, 11.781f, 7.781f, 10.0f, 10.0f, 10.0f)
                close()
                moveTo(24.0f, 8.0f)
                curveTo(20.699f, 8.0f, 18.0f, 10.699f, 18.0f, 14.0f)
                lineTo(18.0f, 24.0f)
                lineTo(28.0f, 24.0f)
                lineTo(28.0f, 14.0f)
                lineTo(20.0f, 14.0f)
                curveTo(20.0f, 11.781f, 21.781f, 10.0f, 24.0f, 10.0f)
                close()
                moveTo(6.0f, 16.0f)
                lineTo(12.0f, 16.0f)
                lineTo(12.0f, 22.0f)
