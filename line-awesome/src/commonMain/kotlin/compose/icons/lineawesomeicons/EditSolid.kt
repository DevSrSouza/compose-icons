...
public val LineAwesomeIcons.EditSolid: ImageVector
    get() {
        if (_editSolid != null) {
            return _editSolid!!
        }
        _editSolid = Builder(name = "EditSolid", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _editSolid: ImageVector? = null
