...
public val LineAwesomeIcons.AdjustSolid: ImageVector
    get() {
        if (_adjustSolid != null) {
            return _adjustSolid!!
        }
        _adjustSolid = Builder(name = "AdjustSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _adjustSolid: ImageVector? = null
