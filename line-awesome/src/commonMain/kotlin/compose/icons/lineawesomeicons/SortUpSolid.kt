...
public val LineAwesomeIcons.SortUpSolid: ImageVector
    get() {
        if (_sortUpSolid != null) {
            return _sortUpSolid!!
        }
        _sortUpSolid = Builder(name = "SortUpSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _sortUpSolid: ImageVector? = null
