    ...
    get() {
        ...
        _laptopCodeSolid = Builder(name = "LaptopCodeSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(16.0f, 9.0f)
                close()
                moveTo(12.086f, 11.0f)
                lineTo(10.367f, 13.068f)
                lineTo(10.0f, 13.5f)
                lineTo(10.367f, 13.932f)
                lineTo(12.086f, 16.0f)
                lineTo(13.172f, 15.137f)
                lineTo(11.811f, 13.5f)
                lineTo(13.172f, 11.863f)
                lineTo(12.086f, 11.0f)
                close()
                moveTo(19.914f, 11.0f)
                lineTo(18.828f, 11.863f)
                lineTo(20.189f, 13.5f)
                lineTo(18.828f, 15.137f)
                lineTo(19.914f, 16.0f)
                lineTo(21.633f, 13.932f)
                lineTo(22.0f, 13.5f)
                lineTo(21.633f, 13.068f)
                lineTo(19.914f, 11.0f)
                close()
                moveTo(6.438f, 21.0f)
