    ...
    get() {
        ...
        _figma = Builder(name = "Figma", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.0f, 8.158f, 7.741f, 9.643f, 8.904f, 10.652f)
                curveTo(7.177f, 11.581f, 6.0f, 13.405f, 6.0f, 15.5f)
                curveTo(6.0f, 17.361f, 6.932f, 19.004f, 8.35f, 20.0f)
                curveTo(6.932f, 20.996f, 6.0f, 22.639f, 6.0f, 24.5f)
