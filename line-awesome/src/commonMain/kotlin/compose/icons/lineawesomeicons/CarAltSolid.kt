    ...
    get() {
        ...
        _carAltSolid = Builder(name = "CarAltSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 9.895f, 12.105f, 9.0f, 11.0f, 9.0f)
                curveTo(9.895f, 9.0f, 9.0f, 9.895f, 9.0f, 11.0f)
                curveTo(9.0f, 12.105f, 9.895f, 13.0f, 11.0f, 13.0f)
                close()
                moveTo(21.0f, 13.0f)
                curveTo(22.105f, 13.0f, 23.0f, 12.105f, 23.0f, 11.0f)
                curveTo(23.0f, 9.895f, 22.105f, 9.0f, 21.0f, 9.0f)
                curveTo(19.895f, 9.0f, 19.0f, 9.895f, 19.0f, 11.0f)
                curveTo(19.0f, 12.105f, 19.895f, 13.0f, 21.0f, 13.0f)
                close()
                moveTo(16.0f, 9.0f)
                curveTo(15.172f, 9.0f, 14.5f, 9.672f, 14.5f, 10.5f)
                curveTo(14.5f, 11.328f, 15.172f, 12.0f, 16.0f, 12.0f)
                curveTo(16.828f, 12.0f, 17.5f, 11.328f, 17.5f, 10.5f)
                curveTo(17.5f, 9.672f, 16.828f, 9.0f, 16.0f, 9.0f)
                close()
                moveTo(6.656f, 15.0f)
