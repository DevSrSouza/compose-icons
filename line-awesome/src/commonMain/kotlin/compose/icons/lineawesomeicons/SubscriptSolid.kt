    ...
    get() {
        ...
        _subscriptSolid = Builder(name = "SubscriptSolid", defaultWidth = 32.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(24.9688f, 19.0f)
                curveTo(23.3438f, 19.0f, 22.0f, 20.3438f, 22.0f, 21.9688f)
                lineTo(22.0f, 22.0f)
                lineTo(24.0f, 22.0f)
                lineTo(24.0f, 21.9688f)
                curveTo(24.0f, 21.4219f, 24.4219f, 21.0f, 24.9688f, 21.0f)
                lineTo(25.0313f, 21.0f)
                curveTo(25.5781f, 21.0f, 26.0f, 21.4219f, 26.0f, 21.9688f)
                curveTo(26.0f, 22.2852f, 25.8555f, 22.5703f, 25.5938f, 22.75f)
                lineTo(23.4688f, 24.2188f)
                curveTo(22.5547f, 24.8477f, 22.0f, 25.8906f, 22.0f, 27.0f)
                lineTo(22.0f, 28.0f)
                lineTo(28.0f, 28.0f)
                lineTo(28.0f, 26.0f)
                lineTo(24.5313f, 26.0f)
                curveTo(24.5703f, 25.9688f, 24.5508f, 25.9023f, 24.5938f, 25.875f)
                lineTo(26.7188f, 24.4063f)
                curveTo(27.5234f, 23.8516f, 28.0f, 22.9453f, 28.0f, 21.9688f)
                curveTo(28.0f, 20.3438f, 26.6563f, 19.0f, 25.0313f, 19.0f)
                close()
            }
        }
        .build()
