...
public val LineAwesomeIcons.MarkerSolid: ImageVector
    get() {
        if (_markerSolid != null) {
            return _markerSolid!!
        }
        _markerSolid = Builder(name = "MarkerSolid", defaultWidth = 32.0.dp, defaultHeight =
...
private var _markerSolid: ImageVector? = null
