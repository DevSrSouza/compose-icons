...
public val CssGgIcons.CalendarDates: ImageVector
    get() {
        if (_calendarDates != null) {
            return _calendarDates!!
        }
        _calendarDates = Builder(name = "CalendarDates", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 15.448f, 12.552f, 15.0f, 12.0f, 15.0f)
                curveTo(11.448f, 15.0f, 11.0f, 15.448f, 11.0f, 16.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var _calendarDates: ImageVector? = null
