    ...
    get() {
        ...
        _shoppingBag = Builder(name = "ShoppingBag", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 12.0f)
                curveTo(9.2386f, 12.0f, 7.0f, 9.3137f, 7.0f, 6.0f)
                horizontalLineTo(9.0f)
                curveTo(9.0f, 8.5661f, 10.6691f, 10.0f, 12.0f, 10.0f)
                curveTo(13.3309f, 10.0f, 15.0f, 8.5661f, 15.0f, 6.0f)
                horizontalLineTo(17.0f)
                curveTo(17.0f, 9.3137f, 14.7614f, 12.0f, 12.0f, 12.0f)
                close()
            }
        }
        .build()
