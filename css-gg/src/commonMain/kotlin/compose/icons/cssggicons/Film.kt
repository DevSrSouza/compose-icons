...
public val CssGgIcons.Film: ImageVector
    get() {
        if (_film != null) {
            return _film!!
        }
        _film = Builder(name = "Film", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 8.552f, 5.448f, 9.0f, 6.0f, 9.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(17.0f, 8.0f)
                curveTo(17.0f, 7.448f, 17.448f, 7.0f, 18.0f, 7.0f)
                curveTo(18.552f, 7.0f, 19.0f, 7.448f, 19.0f, 8.0f)
                curveTo(19.0f, 8.552f, 18.552f, 9.0f, 18.0f, 9.0f)
                curveTo(17.448f, 9.0f, 17.0f, 8.552f, 17.0f, 8.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(6.552f, 13.0f, 7.0f, 12.552f, 7.0f, 12.0f)
                curveTo(7.0f, 11.448f, 6.552f, 11.0f, 6.0f, 11.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.552f, 17.0f, 7.0f, 16.552f, 7.0f, 16.0f)
                curveTo(7.0f, 15.448f, 6.552f, 15.0f, 6.0f, 15.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.0f, 16.0f)
                curveTo(17.0f, 15.448f, 17.448f, 15.0f, 18.0f, 15.0f)
                curveTo(18.552f, 15.0f, 19.0f, 15.448f, 19.0f, 16.0f)
                curveTo(19.0f, 16.552f, 18.552f, 17.0f, 18.0f, 17.0f)
                curveTo(17.448f, 17.0f, 17.0f, 16.552f, 17.0f, 16.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
