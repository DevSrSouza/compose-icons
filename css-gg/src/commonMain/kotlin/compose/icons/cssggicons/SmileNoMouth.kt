...
public val CssGgIcons.SmileNoMouth: ImageVector
    get() {
        if (_smileNoMouth != null) {
            return _smileNoMouth!!
        }
        _smileNoMouth = Builder(name = "SmileNoMouth", defaultWidth = 24.0.dp, defaultHeight =
...
private var _smileNoMouth: ImageVector? = null
