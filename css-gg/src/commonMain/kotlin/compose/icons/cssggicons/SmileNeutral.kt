...
public val CssGgIcons.SmileNeutral: ImageVector
    get() {
        if (_smileNeutral != null) {
            return _smileNeutral!!
        }
        _smileNeutral = Builder(name = "SmileNeutral", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(16.0f, 10.0f)
                curveTo(16.0f, 10.552f, 15.552f, 11.0f, 15.0f, 11.0f)
                curveTo(14.448f, 11.0f, 14.0f, 10.552f, 14.0f, 10.0f)
                curveTo(14.0f, 9.448f, 14.448f, 9.0f, 15.0f, 9.0f)
                curveTo(15.552f, 9.0f, 16.0f, 9.448f, 16.0f, 10.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var _smileNeutral: ImageVector? = null
