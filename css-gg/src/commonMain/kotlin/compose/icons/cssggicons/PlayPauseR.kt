...
public val CssGgIcons.PlayPauseR: ImageVector
    get() {
        if (_playPauseR != null) {
            return _playPauseR!!
        }
        _playPauseR = Builder(name = "PlayPauseR", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _playPauseR: ImageVector? = null
