    ...
    get() {
        ...
        _dice2 = Builder(name = "Dice2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.2f, 14.943f)
                curveTo(16.095f, 14.943f, 15.2f, 15.839f, 15.2f, 16.943f)
                curveTo(15.2f, 18.048f, 16.095f, 18.943f, 17.2f, 18.943f)
                curveTo(18.305f, 18.943f, 19.2f, 18.048f, 19.2f, 16.943f)
                curveTo(19.2f, 15.839f, 18.305f, 14.943f, 17.2f, 14.943f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
