...
public val CssGgIcons.MoreVerticalR: ImageVector
    get() {
        if (_moreVerticalR != null) {
            return _moreVerticalR!!
        }
        _moreVerticalR = Builder(name = "MoreVerticalR", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(2.0f, 3.0f)
                curveTo(2.0f, 1.3432f, 3.3431f, 0.0f, 5.0f, 0.0f)
                horizontalLineTo(19.0f)
                curveTo(20.6569f, 0.0f, 22.0f, 1.3432f, 22.0f, 3.0f)
                verticalLineTo(21.0f)
                curveTo(22.0f, 22.6569f, 20.6569f, 24.0f, 19.0f, 24.0f)
                horizontalLineTo(5.0f)
                curveTo(3.3431f, 24.0f, 2.0f, 22.6569f, 2.0f, 21.0f)
                verticalLineTo(3.0f)
                close()
                moveTo(5.0f, 2.0f)
                horizontalLineTo(19.0f)
...
private var _moreVerticalR: ImageVector? = null
