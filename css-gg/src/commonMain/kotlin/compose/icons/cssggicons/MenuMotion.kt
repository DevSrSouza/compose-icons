...
public val CssGgIcons.MenuMotion: ImageVector
    get() {
        if (_menuMotion != null) {
            return _menuMotion!!
        }
        _menuMotion = Builder(name = "MenuMotion", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(3.0f, 18.0f)
                curveTo(3.0f, 17.448f, 3.448f, 17.0f, 4.0f, 17.0f)
                horizontalLineTo(12.0f)
...
private var _menuMotion: ImageVector? = null
