    ...
    get() {
        ...
        _ratio = Builder(name = "Ratio", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(18.0f)
                curveTo(0.0f, 20.209f, 1.791f, 22.0f, 4.0f, 22.0f)
                horizontalLineTo(20.0f)
                curveTo(22.209f, 22.0f, 24.0f, 20.209f, 24.0f, 18.0f)
                verticalLineTo(6.0f)
                curveTo(24.0f, 3.791f, 22.209f, 2.0f, 20.0f, 2.0f)
                horizontalLineTo(4.0f)
                close()
                moveTo(20.0f, 4.0f)
                horizontalLineTo(4.0f)
                ...
                verticalLineTo(18.0f)
                curveTo(2.0f, 19.105f, 2.895f, 20.0f, 4.0f, 20.0f)
                horizontalLineTo(20.0f)
