...
public val CssGgIcons.RemoveR: ImageVector
    get() {
        if (_removeR != null) {
            return _removeR!!
        }
        _removeR = Builder(name = "RemoveR", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _removeR: ImageVector? = null
