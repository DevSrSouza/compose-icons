...
public val CssGgIcons.FormatJustify: ImageVector
    get() {
        if (_formatJustify != null) {
            return _formatJustify!!
        }
        _formatJustify = Builder(name = "FormatJustify", defaultWidth = 24.0.dp, defaultHeight =
...
private var _formatJustify: ImageVector? = null
