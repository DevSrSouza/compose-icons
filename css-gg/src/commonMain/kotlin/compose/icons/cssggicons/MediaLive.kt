...
public val CssGgIcons.MediaLive: ImageVector
    get() {
        if (_mediaLive != null) {
            return _mediaLive!!
        }
        _mediaLive = Builder(name = "MediaLive", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _mediaLive: ImageVector? = null
