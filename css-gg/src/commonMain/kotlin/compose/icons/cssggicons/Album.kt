    ...
    get() {
        ...
        _album = Builder(name = "Album", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(12.0111f)
                lineTo(12.395f, 12.0112f)
                lineTo(14.0001f, 9.8642f)
                lineTo(15.6051f, 12.0112f)
                ...
                verticalLineTo(9.3358f)
                lineTo(14.0001f, 6.6605f)
                lineTo(16.0f, 9.3357f)
                verticalLineTo(4.0f)
                close()
            }
        }
