    ...
    get() {
        ...
        _smileUpside = Builder(name = "SmileUpside", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 8.791f, 9.791f, 7.0f, 12.0f, 7.0f)
                curveTo(14.209f, 7.0f, 16.0f, 8.791f, 16.0f, 11.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(10.0f, 14.0f)
                curveTo(10.0f, 13.448f, 9.552f, 13.0f, 9.0f, 13.0f)
                curveTo(8.448f, 13.0f, 8.0f, 13.448f, 8.0f, 14.0f)
                curveTo(8.0f, 14.552f, 8.448f, 15.0f, 9.0f, 15.0f)
                curveTo(9.552f, 15.0f, 10.0f, 14.552f, 10.0f, 14.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
