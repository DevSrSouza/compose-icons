    ...
    get() {
        ...
        _arrowUpR = Builder(name = "ArrowUpR", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(14.854f, 11.974f)
                lineTo(16.269f, 10.56f)
                lineTo(12.026f, 6.317f)
                lineTo(7.783f, 10.56f)
                lineTo(9.197f, 11.974f)
                lineTo(11.026f, 10.146f)
                verticalLineTo(17.683f)
                horizontalLineTo(13.026f)
                verticalLineTo(10.146f)
                lineTo(14.854f, 11.974f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
