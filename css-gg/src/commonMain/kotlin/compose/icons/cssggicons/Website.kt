...
public val CssGgIcons.Website: ImageVector
    get() {
        if (_website != null) {
            return _website!!
        }
        _website = Builder(name = "Website", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.5523f, 9.0f, 11.0f, 8.5523f, 11.0f, 8.0f)
