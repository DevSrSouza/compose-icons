...
public val CssGgIcons.ChevronLeftR: ImageVector
    get() {
        if (_chevronLeftR != null) {
            return _chevronLeftR!!
        }
        _chevronLeftR = Builder(name = "ChevronLeftR", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.0f, 7.7574f)
                lineTo(14.4142f, 9.1716f)
                lineTo(11.5858f, 12.0f)
                lineTo(14.4142f, 14.8284f)
                lineTo(13.0f, 16.2426f)
                lineTo(8.7574f, 12.0f)
                lineTo(13.0f, 7.7574f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var _chevronLeftR: ImageVector? = null
