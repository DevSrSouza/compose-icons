...
public val CssGgIcons.InsertAfterR: ImageVector
    get() {
        if (_insertAfterR != null) {
            return _insertAfterR!!
        }
        _insertAfterR = Builder(name = "InsertAfterR", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.0f, 15.6569f, 18.6569f, 17.0f, 17.0f, 17.0f)
                horizontalLineTo(7.0f)
                curveTo(5.3432f, 17.0f, 4.0f, 15.6569f, 4.0f, 14.0f)
                verticalLineTo(4.0f)
                close()
                moveTo(7.0f, 3.0f)
                horizontalLineTo(17.0f)
...
private var _insertAfterR: ImageVector? = null
