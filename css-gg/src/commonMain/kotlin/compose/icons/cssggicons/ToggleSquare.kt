    ...
    get() {
        ...
        _toggleSquare = Builder(name = "ToggleSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.4477f, 15.0f, 4.0f, 14.5523f, 4.0f, 14.0f)
                verticalLineTo(10.0f)
                curveTo(4.0f, 9.4477f, 4.4477f, 9.0f, 5.0f, 9.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(24.0f, 7.0f)
                curveTo(24.0f, 5.8954f, 23.1046f, 5.0f, 22.0f, 5.0f)
                horizontalLineTo(2.0f)
                curveTo(0.8954f, 5.0f, 0.0f, 5.8954f, 0.0f, 7.0f)
                verticalLineTo(17.0f)
                curveTo(0.0f, 18.1046f, 0.8954f, 19.0f, 2.0f, 19.0f)
                horizontalLineTo(22.0f)
                curveTo(23.1046f, 19.0f, 24.0f, 18.1046f, 24.0f, 17.0f)
                verticalLineTo(7.0f)
                close()
                moveTo(22.0f, 7.0f)
                horizontalLineTo(2.0f)
