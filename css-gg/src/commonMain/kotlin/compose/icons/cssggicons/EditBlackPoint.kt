...
public val CssGgIcons.EditBlackPoint: ImageVector
    get() {
        if (_editBlackPoint != null) {
            return _editBlackPoint!!
        }
        _editBlackPoint = Builder(name = "EditBlackPoint", defaultWidth = 24.0.dp, defaultHeight =
...
private var _editBlackPoint: ImageVector? = null
