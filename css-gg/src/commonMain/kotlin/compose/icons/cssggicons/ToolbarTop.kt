...
public val CssGgIcons.ToolbarTop: ImageVector
    get() {
        if (_toolbarTop != null) {
            return _toolbarTop!!
        }
        _toolbarTop = Builder(name = "ToolbarTop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _toolbarTop: ImageVector? = null
