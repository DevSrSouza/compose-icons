    ...
    get() {
        ...
        _more = Builder(name = "More", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(5.0f, 15.0f)
                curveTo(6.657f, 15.0f, 8.0f, 13.657f, 8.0f, 12.0f)
                curveTo(8.0f, 10.343f, 6.657f, 9.0f, 5.0f, 9.0f)
                curveTo(3.343f, 9.0f, 2.0f, 10.343f, 2.0f, 12.0f)
                curveTo(2.0f, 13.657f, 3.343f, 15.0f, 5.0f, 15.0f)
                close()
                moveTo(5.0f, 13.0f)
                curveTo(5.552f, 13.0f, 6.0f, 12.552f, 6.0f, 12.0f)
                curveTo(6.0f, 11.448f, 5.552f, 11.0f, 5.0f, 11.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = EvenOdd) {
                moveTo(22.0f, 12.0f)
                curveTo(22.0f, 13.657f, 20.657f, 15.0f, 19.0f, 15.0f)
                curveTo(17.343f, 15.0f, 16.0f, 13.657f, 16.0f, 12.0f)
                curveTo(16.0f, 10.343f, 17.343f, 9.0f, 19.0f, 9.0f)
                curveTo(20.657f, 9.0f, 22.0f, 10.343f, 22.0f, 12.0f)
                close()
                moveTo(20.0f, 12.0f)
                curveTo(20.0f, 12.552f, 19.552f, 13.0f, 19.0f, 13.0f)
                curveTo(18.448f, 13.0f, 18.0f, 12.552f, 18.0f, 12.0f)
                curveTo(18.0f, 11.448f, 18.448f, 11.0f, 19.0f, 11.0f)
                curveTo(19.552f, 11.0f, 20.0f, 11.448f, 20.0f, 12.0f)
                close()
            }
        }
        .build()
