...
public val CssGgIcons.ToolbarBottom: ImageVector
    get() {
        if (_toolbarBottom != null) {
            return _toolbarBottom!!
        }
        _toolbarBottom = Builder(name = "ToolbarBottom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _toolbarBottom: ImageVector? = null
