...
public val CssGgIcons.MenuRightAlt: ImageVector
    get() {
        if (_menuRightAlt != null) {
            return _menuRightAlt!!
        }
        _menuRightAlt = Builder(name = "MenuRightAlt", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(11.0f, 11.0f)
                curveTo(10.448f, 11.0f, 10.0f, 11.448f, 10.0f, 12.0f)
...
private var _menuRightAlt: ImageVector? = null
