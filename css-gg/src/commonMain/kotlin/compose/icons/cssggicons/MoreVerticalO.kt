...
public val CssGgIcons.MoreVerticalO: ImageVector
    get() {
        if (_moreVerticalO != null) {
            return _moreVerticalO!!
        }
        _moreVerticalO = Builder(name = "MoreVerticalO", defaultWidth = 24.0.dp, defaultHeight =
...
private var _moreVerticalO: ImageVector? = null
