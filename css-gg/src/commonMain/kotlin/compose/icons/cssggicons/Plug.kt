    ...
    get() {
        ...
        _plug = Builder(name = "Plug", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(9.0f, 2.0f)
                curveTo(8.448f, 2.0f, 8.0f, 2.448f, 8.0f, 3.0f)
                verticalLineTo(5.0f)
                curveTo(8.0f, 5.552f, 8.448f, 6.0f, 9.0f, 6.0f)
                curveTo(9.552f, 6.0f, 10.0f, 5.552f, 10.0f, 5.0f)
                verticalLineTo(3.0f)
                curveTo(10.0f, 2.448f, 9.552f, 2.0f, 9.0f, 2.0f)
                close()
                moveTo(8.0f, 9.0f)
                horizontalLineTo(16.0f)
                verticalLineTo(11.0f)
                curveTo(16.0f, 13.209f, 14.209f, 15.0f, 12.0f, 15.0f)
                curveTo(9.791f, 15.0f, 8.0f, 13.209f, 8.0f, 11.0f)
                verticalLineTo(9.0f)
                close()
                moveTo(13.0f, 16.917f)
                curveTo(15.838f, 16.441f, 18.0f, 13.973f, 18.0f, 11.0f)
                verticalLineTo(7.0f)
                horizontalLineTo(6.0f)
                verticalLineTo(11.0f)
                curveTo(6.0f, 13.973f, 8.162f, 16.441f, 11.0f, 16.917f)
                ...
                curveTo(14.448f, 6.0f, 14.0f, 5.552f, 14.0f, 5.0f)
                verticalLineTo(3.0f)
                close()
            }
        }
