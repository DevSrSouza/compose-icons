...
public val CssGgIcons.FormatRight: ImageVector
    get() {
        if (_formatRight != null) {
            return _formatRight!!
        }
        _formatRight = Builder(name = "FormatRight", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.0f, 6.552f, 20.552f, 7.0f, 20.0f, 7.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(20.0f, 17.0f)
                curveTo(20.552f, 17.0f, 21.0f, 17.448f, 21.0f, 18.0f)
...
private var _formatRight: ImageVector? = null
