...
public class PositionXmlParser {
     ...
     *                                      a string.
     */
    public static Document parse(InputStream input, boolean checkDtd)
     ...
     *                                      a string.
     */
    public static Document parse(byte[] data, boolean checkDtd)
            throws ParserConfigurationException, SAXException, IOException {
    ...
    private static Document parse(String xml, InputSource input, boolean checkBom,
                                  boolean checkDtd)
            throws ParserConfigurationException, SAXException, IOException {
        try {
