    ...
    get() {
        ...
        _beaker16 = Builder(name = "Beaker16", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(6.5f, 6.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.117f, 0.403f)
                lineTo(4.73f, 9.0f)
                horizontalLineToRelative(6.54f)
                lineTo(9.617f, 6.403f)
                arcTo(0.75f, 0.75f, 0.0f, false, true, 9.5f, 6.0f)
                lineTo(9.5f, 2.5f)
                close()
                moveTo(2.6f, 12.347f)
                lineTo(3.775f, 10.5f)
                horizontalLineToRelative(8.45f)
                lineToRelative(1.175f, 1.847f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.633f, 1.153f)
                lineTo(3.233f, 13.5f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.633f, -1.153f)
                close()
            }
