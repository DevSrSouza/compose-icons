    ...
    get() {
        ...
        _number24 = Builder(name = "Number24", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(2.75f, 9.0f)
                arcTo(0.75f, 0.75f, 0.0f, false, true, 2.0f, 8.25f)
                close()
                moveTo(1.995f, 15.75f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.75f, -0.75f)
                verticalLineToRelative(1.5f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.75f, -0.75f)
                close()
                moveTo(2.745f, 15.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = EvenOdd) {
                moveTo(9.62f, 2.01f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.62f, 0.86f)
                lineToRelative(-3.0f, 18.5f)
