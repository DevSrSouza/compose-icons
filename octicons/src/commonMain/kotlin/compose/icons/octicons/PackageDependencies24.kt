...
public val Octicons.PackageDependencies24: ImageVector
    get() {
        if (_packageDependencies24 != null) {
            return _packageDependencies24!!
        }
        _packageDependencies24 = Builder(name = "PackageDependencies24", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(9.126f, 0.64f)
                arcToRelative(1.75f, 1.75f, 0.0f, false, true, 1.75f, 0.0f)
                lineToRelative(8.25f, 4.762f)
                curveToRelative(0.103f, 0.06f, 0.199f, 0.128f, 0.286f, 0.206f)
                arcToRelative(0.748f, 0.748f, 0.0f, false, true, 0.554f, 0.96f)
                ...
                arcToRelative(0.748f, 0.748f, 0.0f, false, true, 0.554f, -0.96f)
                arcToRelative(1.75f, 1.75f, 0.0f, false, true, 0.286f, -0.205f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.617f, 17.5f)
                lineToRelative(2.895f, -2.702f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -1.024f, -1.096f)
                lineToRelative(-4.285f, 4.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.0f, 1.096f)
                lineToRelative(4.285f, 4.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, true, false, 1.024f, -1.096f)
                lineTo(16.617f, 19.0f)
...
private var _packageDependencies24: ImageVector? = null
