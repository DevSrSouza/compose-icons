    ...
    get() {
        ...
        _mention24 = Builder(name = "Mention24", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(9.498f, 9.498f, 0.0f, true, false, -3.477f, 12.976f)
                ...
                arcToRelative(10.956f, 10.956f, 0.0f, false, true, 1.455f, 4.826f)
                ...
                arcToRelative(0.76f, 0.76f, 0.0f, false, true, 0.011f, 0.129f)
                verticalLineToRelative(1.972f)
                arcToRelative(2.0f, 2.0f, 0.0f, true, false, 4.0f, 0.0f)
                verticalLineToRelative(-1.766f)
                arcToRelative(9.452f, 9.452f, 0.0f, false, false, -1.274f, -4.733f)
                close()
                moveTo(16.0f, 12.0f)
