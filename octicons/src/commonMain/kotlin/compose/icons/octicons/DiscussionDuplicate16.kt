...
public val Octicons.DiscussionDuplicate16: ImageVector
    get() {
        if (_discussionDuplicate16 != null) {
            return _discussionDuplicate16!!
        }
        _discussionDuplicate16 = Builder(name = "DiscussionDuplicate16", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.968f, 4.53f)
                lineTo(5.03f, 7.468f)
                arcToRelative(0.749f, 0.749f, 0.0f, true, true, -1.06f, -1.061f)
                lineTo(6.907f, 3.47f)
...
private var _discussionDuplicate16: ImageVector? = null
