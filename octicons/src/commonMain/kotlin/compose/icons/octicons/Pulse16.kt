    ...
    get() {
        ...
        _pulse16 = Builder(name = "Pulse16", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(6.0f, 2.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.696f, 0.471f)
                ...
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -1.392f, 0.0f)
                lineTo(6.0f, 4.77f)
                lineTo(4.696f, 8.03f)
                ...
                arcTo(0.75f, 0.75f, 0.0f, false, true, 6.0f, 2.0f)
                close()
            }
        }
        .build()
