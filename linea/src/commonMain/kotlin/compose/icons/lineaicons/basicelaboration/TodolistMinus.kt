...
public val BasicElaborationGroup.TodolistMinus: ImageVector
    get() {
        if (_todolistMinus != null) {
            return _todolistMinus!!
        }
        _todolistMinus = Builder(name = "TodolistMinus", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistMinus: ImageVector? = null
