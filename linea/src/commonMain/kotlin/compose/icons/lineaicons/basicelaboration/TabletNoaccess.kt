...
public val BasicElaborationGroup.TabletNoaccess: ImageVector
    get() {
        if (_tabletNoaccess != null) {
            return _tabletNoaccess!!
        }
        _tabletNoaccess = Builder(name = "TabletNoaccess", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletNoaccess: ImageVector? = null
