...
public val BasicElaborationGroup.TodolistCheck: ImageVector
    get() {
        if (_todolistCheck != null) {
            return _todolistCheck!!
        }
        _todolistCheck = Builder(name = "TodolistCheck", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistCheck: ImageVector? = null
