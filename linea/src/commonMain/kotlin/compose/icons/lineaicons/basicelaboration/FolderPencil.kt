...
public val BasicElaborationGroup.FolderPencil: ImageVector
    get() {
        if (_folderPencil != null) {
            return _folderPencil!!
        }
        _folderPencil = Builder(name = "FolderPencil", defaultWidth = 64.0.dp, defaultHeight =
...
private var _folderPencil: ImageVector? = null
