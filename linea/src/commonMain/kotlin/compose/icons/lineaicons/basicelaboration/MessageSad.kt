...
public val BasicElaborationGroup.MessageSad: ImageVector
    get() {
        if (_messageSad != null) {
            return _messageSad!!
        }
        _messageSad = Builder(name = "MessageSad", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _messageSad: ImageVector? = null
