...
public val BasicElaborationGroup.MailFlagged: ImageVector
    get() {
        if (_mailFlagged != null) {
            return _mailFlagged!!
        }
        _mailFlagged = Builder(name = "MailFlagged", defaultWidth = 64.0.dp, defaultHeight =
...
private var _mailFlagged: ImageVector? = null
