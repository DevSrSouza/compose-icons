...
public val BasicElaborationGroup.FolderGraph: ImageVector
    get() {
        if (_folderGraph != null) {
            return _folderGraph!!
        }
        _folderGraph = Builder(name = "FolderGraph", defaultWidth = 64.0.dp, defaultHeight =
...
private var _folderGraph: ImageVector? = null
