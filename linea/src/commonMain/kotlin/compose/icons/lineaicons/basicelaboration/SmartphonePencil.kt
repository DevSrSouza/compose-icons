...
public val BasicElaborationGroup.SmartphonePencil: ImageVector
    get() {
        if (_smartphonePencil != null) {
            return _smartphonePencil!!
        }
        _smartphonePencil = Builder(name = "SmartphonePencil", defaultWidth = 64.0.dp, defaultHeight
...
private var _smartphonePencil: ImageVector? = null
