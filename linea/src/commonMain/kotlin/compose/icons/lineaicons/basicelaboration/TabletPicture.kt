...
public val BasicElaborationGroup.TabletPicture: ImageVector
    get() {
        if (_tabletPicture != null) {
            return _tabletPicture!!
        }
        _tabletPicture = Builder(name = "TabletPicture", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletPicture: ImageVector? = null
