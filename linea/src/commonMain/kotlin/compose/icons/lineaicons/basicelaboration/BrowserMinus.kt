...
public val BasicElaborationGroup.BrowserMinus: ImageVector
    get() {
        if (_browserMinus != null) {
            return _browserMinus!!
        }
        _browserMinus = Builder(name = "BrowserMinus", defaultWidth = 64.0.dp, defaultHeight =
