...
public val BasicElaborationGroup.MailNext: ImageVector
    get() {
        if (_mailNext != null) {
            return _mailNext!!
        }
        _mailNext = Builder(name = "MailNext", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _mailNext: ImageVector? = null
