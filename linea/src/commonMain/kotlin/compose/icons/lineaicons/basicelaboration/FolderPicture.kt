...
public val BasicElaborationGroup.FolderPicture: ImageVector
    get() {
        if (_folderPicture != null) {
            return _folderPicture!!
        }
        _folderPicture = Builder(name = "FolderPicture", defaultWidth = 64.0.dp, defaultHeight =
...
private var _folderPicture: ImageVector? = null
