...
public val BasicElaborationGroup.MessageRefresh: ImageVector
    get() {
        if (_messageRefresh != null) {
            return _messageRefresh!!
        }
        _messageRefresh = Builder(name = "MessageRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _messageRefresh: ImageVector? = null
