...
public val BasicElaborationGroup.FolderNote: ImageVector
    get() {
        if (_folderNote != null) {
            return _folderNote!!
        }
        _folderNote = Builder(name = "FolderNote", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _folderNote: ImageVector? = null
