...
public val BasicElaborationGroup.SmartphoneSearch: ImageVector
    get() {
        if (_smartphoneSearch != null) {
            return _smartphoneSearch!!
        }
        _smartphoneSearch = Builder(name = "SmartphoneSearch", defaultWidth = 64.0.dp, defaultHeight
...
private var _smartphoneSearch: ImageVector? = null
