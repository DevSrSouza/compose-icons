...
public val BasicElaborationGroup.CalendarRefresh: ImageVector
    get() {
        if (_calendarRefresh != null) {
            return _calendarRefresh!!
        }
        _calendarRefresh = Builder(name = "CalendarRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _calendarRefresh: ImageVector? = null
