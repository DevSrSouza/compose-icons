...
public val BasicElaborationGroup.TabletNote: ImageVector
    get() {
        if (_tabletNote != null) {
            return _tabletNote!!
        }
        _tabletNote = Builder(name = "TabletNote", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _tabletNote: ImageVector? = null
