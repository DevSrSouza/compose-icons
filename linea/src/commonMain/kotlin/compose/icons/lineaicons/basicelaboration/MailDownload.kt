...
public val BasicElaborationGroup.MailDownload: ImageVector
    get() {
        if (_mailDownload != null) {
            return _mailDownload!!
        }
        _mailDownload = Builder(name = "MailDownload", defaultWidth = 64.0.dp, defaultHeight =
...
private var _mailDownload: ImageVector? = null
