...
public val BasicElaborationGroup.SmartphoneNote: ImageVector
    get() {
        if (_smartphoneNote != null) {
            return _smartphoneNote!!
        }
        _smartphoneNote = Builder(name = "SmartphoneNote", defaultWidth = 64.0.dp, defaultHeight =
...
private var _smartphoneNote: ImageVector? = null
