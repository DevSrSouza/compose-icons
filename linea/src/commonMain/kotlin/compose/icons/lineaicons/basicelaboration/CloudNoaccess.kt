...
public val BasicElaborationGroup.CloudNoaccess: ImageVector
    get() {
        if (_cloudNoaccess != null) {
            return _cloudNoaccess!!
        }
        _cloudNoaccess = Builder(name = "CloudNoaccess", defaultWidth = 64.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(25.834f, 27.834f)
                lineTo(38.166f, 40.166f)
            }
        }
        .build()
        return _cloudNoaccess!!
...
private var _cloudNoaccess: ImageVector? = null
