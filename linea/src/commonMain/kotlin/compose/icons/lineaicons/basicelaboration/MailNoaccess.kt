...
public val BasicElaborationGroup.MailNoaccess: ImageVector
    get() {
        if (_mailNoaccess != null) {
            return _mailNoaccess!!
        }
        _mailNoaccess = Builder(name = "MailNoaccess", defaultWidth = 64.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(25.834f, 15.834f)
                lineTo(38.166f, 28.166f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _mailNoaccess: ImageVector? = null
