...
public val BasicElaborationGroup.FolderFlagged: ImageVector
    get() {
        if (_folderFlagged != null) {
            return _folderFlagged!!
        }
        _folderFlagged = Builder(name = "FolderFlagged", defaultWidth = 64.0.dp, defaultHeight =
...
private var _folderFlagged: ImageVector? = null
