...
public val BasicElaborationGroup.Todolist2: ImageVector
    get() {
        if (_todolist2 != null) {
            return _todolist2!!
        }
        _todolist2 = Builder(name = "Todolist2", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _todolist2: ImageVector? = null
