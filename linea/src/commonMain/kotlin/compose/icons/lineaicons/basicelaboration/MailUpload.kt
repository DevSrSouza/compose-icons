...
public val BasicElaborationGroup.MailUpload: ImageVector
    get() {
        if (_mailUpload != null) {
            return _mailUpload!!
        }
        _mailUpload = Builder(name = "MailUpload", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _mailUpload: ImageVector? = null
