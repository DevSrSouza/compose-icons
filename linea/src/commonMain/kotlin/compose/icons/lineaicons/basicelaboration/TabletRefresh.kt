...
public val BasicElaborationGroup.TabletRefresh: ImageVector
    get() {
        if (_tabletRefresh != null) {
            return _tabletRefresh!!
        }
        _tabletRefresh = Builder(name = "TabletRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletRefresh: ImageVector? = null
