...
public val BasicElaborationGroup.DocumentRefresh: ImageVector
    get() {
        if (_documentRefresh != null) {
            return _documentRefresh!!
        }
        _documentRefresh = Builder(name = "DocumentRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentRefresh: ImageVector? = null
