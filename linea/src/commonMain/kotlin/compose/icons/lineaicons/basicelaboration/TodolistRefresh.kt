...
public val BasicElaborationGroup.TodolistRefresh: ImageVector
    get() {
        if (_todolistRefresh != null) {
            return _todolistRefresh!!
        }
        _todolistRefresh = Builder(name = "TodolistRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistRefresh: ImageVector? = null
