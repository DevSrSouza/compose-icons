...
public val BasicElaborationGroup.CalendarDownload: ImageVector
    get() {
        if (_calendarDownload != null) {
            return _calendarDownload!!
        }
        _calendarDownload = Builder(name = "CalendarDownload", defaultWidth = 64.0.dp, defaultHeight
...
private var _calendarDownload: ImageVector? = null
