...
public val BasicElaborationGroup.DocumentNote: ImageVector
    get() {
        if (_documentNote != null) {
            return _documentNote!!
        }
        _documentNote = Builder(name = "DocumentNote", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentNote: ImageVector? = null
