...
public val BasicElaborationGroup.SmartphoneNoaccess: ImageVector
    get() {
        if (_smartphoneNoaccess != null) {
            return _smartphoneNoaccess!!
        }
        _smartphoneNoaccess = Builder(name = "SmartphoneNoaccess", defaultWidth = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(25.834f, 23.834f)
                lineTo(38.166f, 36.166f)
            }
        }
        .build()
        return _smartphoneNoaccess!!
...
private var _smartphoneNoaccess: ImageVector? = null
