...
public val BasicElaborationGroup.TodolistSearch: ImageVector
    get() {
        if (_todolistSearch != null) {
            return _todolistSearch!!
        }
        _todolistSearch = Builder(name = "TodolistSearch", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistSearch: ImageVector? = null
