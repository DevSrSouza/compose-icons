...
public val BasicElaborationGroup.CalendarCloud: ImageVector
    get() {
        if (_calendarCloud != null) {
            return _calendarCloud!!
        }
        _calendarCloud = Builder(name = "CalendarCloud", defaultWidth = 64.0.dp, defaultHeight =
...
private var _calendarCloud: ImageVector? = null
