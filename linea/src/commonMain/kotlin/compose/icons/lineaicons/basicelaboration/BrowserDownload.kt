...
public val BasicElaborationGroup.BrowserDownload: ImageVector
    get() {
        if (_browserDownload != null) {
            return _browserDownload!!
        }
        _browserDownload = Builder(name = "BrowserDownload", defaultWidth = 64.0.dp, defaultHeight =
...
private var _browserDownload: ImageVector? = null
