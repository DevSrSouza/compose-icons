...
public val BasicElaborationGroup.DocumentFlagged: ImageVector
    get() {
        if (_documentFlagged != null) {
            return _documentFlagged!!
        }
        _documentFlagged = Builder(name = "DocumentFlagged", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentFlagged: ImageVector? = null
