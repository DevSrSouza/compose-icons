...
public val BasicElaborationGroup.FolderPrevious: ImageVector
    get() {
        if (_folderPrevious != null) {
            return _folderPrevious!!
        }
        _folderPrevious = Builder(name = "FolderPrevious", defaultWidth = 64.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(22.001f, 36.0f)
                lineTo(42.001f, 36.0f)
            }
        }
        .build()
        return _folderPrevious!!
...
private var _folderPrevious: ImageVector? = null
