...
public val BasicElaborationGroup.SmartphoneCloud: ImageVector
    get() {
        if (_smartphoneCloud != null) {
            return _smartphoneCloud!!
        }
        _smartphoneCloud = Builder(name = "SmartphoneCloud", defaultWidth = 64.0.dp, defaultHeight =
...
private var _smartphoneCloud: ImageVector? = null
