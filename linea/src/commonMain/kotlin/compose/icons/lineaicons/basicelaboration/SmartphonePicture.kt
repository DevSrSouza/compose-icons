...
public val BasicElaborationGroup.SmartphonePicture: ImageVector
    get() {
        if (_smartphonePicture != null) {
            return _smartphonePicture!!
        }
        _smartphonePicture = Builder(name = "SmartphonePicture", defaultWidth = 64.0.dp,
...
private var _smartphonePicture: ImageVector? = null
