...
public val BasicElaborationGroup.TabletHeart: ImageVector
    get() {
        if (_tabletHeart != null) {
            return _tabletHeart!!
        }
        _tabletHeart = Builder(name = "TabletHeart", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletHeart: ImageVector? = null
