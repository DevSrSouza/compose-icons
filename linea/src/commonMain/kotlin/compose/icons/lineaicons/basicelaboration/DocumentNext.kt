...
public val BasicElaborationGroup.DocumentNext: ImageVector
    get() {
        if (_documentNext != null) {
            return _documentNext!!
        }
        _documentNext = Builder(name = "DocumentNext", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentNext: ImageVector? = null
