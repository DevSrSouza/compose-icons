...
public val BasicElaborationGroup.TodolistPlus: ImageVector
    get() {
        if (_todolistPlus != null) {
            return _todolistPlus!!
        }
        _todolistPlus = Builder(name = "TodolistPlus", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistPlus: ImageVector? = null
