...
public val BasicElaborationGroup.DocumentPencil: ImageVector
    get() {
        if (_documentPencil != null) {
            return _documentPencil!!
        }
        _documentPencil = Builder(name = "DocumentPencil", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentPencil: ImageVector? = null
