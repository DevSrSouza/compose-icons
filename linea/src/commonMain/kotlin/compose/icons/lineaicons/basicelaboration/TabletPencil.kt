...
public val BasicElaborationGroup.TabletPencil: ImageVector
    get() {
        if (_tabletPencil != null) {
            return _tabletPencil!!
        }
        _tabletPencil = Builder(name = "TabletPencil", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletPencil: ImageVector? = null
