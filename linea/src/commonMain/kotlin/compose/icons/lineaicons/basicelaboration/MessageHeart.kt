...
public val BasicElaborationGroup.MessageHeart: ImageVector
    get() {
        if (_messageHeart != null) {
            return _messageHeart!!
        }
        _messageHeart = Builder(name = "MessageHeart", defaultWidth = 64.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(24.0f, 18.0f, 22.0f, 20.238f, 22.0f, 23.0f)
                close()
            }
        }
        .build()
