...
public val BasicElaborationGroup.DocumentPicture: ImageVector
    get() {
        if (_documentPicture != null) {
            return _documentPicture!!
        }
        _documentPicture = Builder(name = "DocumentPicture", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentPicture: ImageVector? = null
