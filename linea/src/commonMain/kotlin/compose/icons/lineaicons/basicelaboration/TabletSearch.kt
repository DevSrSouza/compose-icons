...
public val BasicElaborationGroup.TabletSearch: ImageVector
    get() {
        if (_tabletSearch != null) {
            return _tabletSearch!!
        }
        _tabletSearch = Builder(name = "TabletSearch", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tabletSearch: ImageVector? = null
