...
public val BasicElaborationGroup.MailCloud: ImageVector
    get() {
        if (_mailCloud != null) {
            return _mailCloud!!
        }
        _mailCloud = Builder(name = "MailCloud", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
                viewportWidth = 64.0f, viewportHeight = 64.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(34.887f, 28.0f)
...
private var _mailCloud: ImageVector? = null
