...
public val BasicElaborationGroup.DocumentGraph: ImageVector
    get() {
        if (_documentGraph != null) {
            return _documentGraph!!
        }
        _documentGraph = Builder(name = "DocumentGraph", defaultWidth = 64.0.dp, defaultHeight =
...
private var _documentGraph: ImageVector? = null
