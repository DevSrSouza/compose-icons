...
public val BasicElaborationGroup.SmartphoneRefresh: ImageVector
    get() {
        if (_smartphoneRefresh != null) {
            return _smartphoneRefresh!!
        }
        _smartphoneRefresh = Builder(name = "SmartphoneRefresh", defaultWidth = 64.0.dp,
...
private var _smartphoneRefresh: ImageVector? = null
