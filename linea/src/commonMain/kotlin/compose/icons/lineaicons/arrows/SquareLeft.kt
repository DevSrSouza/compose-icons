...
public val ArrowsGroup.SquareLeft: ImageVector
    get() {
        if (_squareLeft != null) {
            return _squareLeft!!
        }
        _squareLeft = Builder(name = "SquareLeft", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _squareLeft: ImageVector? = null
