...
public val ArrowsGroup.StretchDiagonal3: ImageVector
    get() {
        if (_stretchDiagonal3 != null) {
            return _stretchDiagonal3!!
        }
        _stretchDiagonal3 = Builder(name = "StretchDiagonal3", defaultWidth = 64.0.dp, defaultHeight
...
private var _stretchDiagonal3: ImageVector? = null
