...
public val ArrowsGroup.DragDown: ImageVector
    get() {
        if (_dragDown != null) {
            return _dragDown!!
        }
        _dragDown = Builder(name = "DragDown", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _dragDown: ImageVector? = null
