...
public val ArrowsGroup.SlideRight1: ImageVector
    get() {
        if (_slideRight1 != null) {
            return _slideRight1!!
        }
        _slideRight1 = Builder(name = "SlideRight1", defaultWidth = 64.0.dp, defaultHeight =
...
private var _slideRight1: ImageVector? = null
