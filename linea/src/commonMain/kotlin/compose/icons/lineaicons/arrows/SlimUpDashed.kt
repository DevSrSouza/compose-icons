...
public val ArrowsGroup.SlimUpDashed: ImageVector
    get() {
        if (_slimUpDashed != null) {
            return _slimUpDashed!!
        }
        _slimUpDashed = Builder(name = "SlimUpDashed", defaultWidth = 64.0.dp, defaultHeight =
...
private var _slimUpDashed: ImageVector? = null
