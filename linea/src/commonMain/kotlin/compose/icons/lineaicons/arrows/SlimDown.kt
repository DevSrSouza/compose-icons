...
public val ArrowsGroup.SlimDown: ImageVector
    get() {
        if (_slimDown != null) {
            return _slimDown!!
        }
        _slimDown = Builder(name = "SlimDown", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _slimDown: ImageVector? = null
