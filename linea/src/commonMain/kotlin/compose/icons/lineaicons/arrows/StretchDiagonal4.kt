...
public val ArrowsGroup.StretchDiagonal4: ImageVector
    get() {
        if (_stretchDiagonal4 != null) {
            return _stretchDiagonal4!!
        }
        _stretchDiagonal4 = Builder(name = "StretchDiagonal4", defaultWidth = 64.0.dp, defaultHeight
...
private var _stretchDiagonal4: ImageVector? = null
