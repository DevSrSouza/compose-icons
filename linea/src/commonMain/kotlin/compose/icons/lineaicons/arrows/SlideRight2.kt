...
public val ArrowsGroup.SlideRight2: ImageVector
    get() {
        if (_slideRight2 != null) {
            return _slideRight2!!
        }
        _slideRight2 = Builder(name = "SlideRight2", defaultWidth = 64.0.dp, defaultHeight =
...
private var _slideRight2: ImageVector? = null
