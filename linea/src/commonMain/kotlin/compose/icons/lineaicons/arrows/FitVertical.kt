...
public val ArrowsGroup.FitVertical: ImageVector
    get() {
        if (_fitVertical != null) {
            return _fitVertical!!
        }
        _fitVertical = Builder(name = "FitVertical", defaultWidth = 64.0.dp, defaultHeight =
...
private var _fitVertical: ImageVector? = null
