...
public val ArrowsGroup.KeyboardRight: ImageVector
    get() {
        if (_keyboardRight != null) {
            return _keyboardRight!!
        }
        _keyboardRight = Builder(name = "KeyboardRight", defaultWidth = 64.0.dp, defaultHeight =
...
private var _keyboardRight: ImageVector? = null
