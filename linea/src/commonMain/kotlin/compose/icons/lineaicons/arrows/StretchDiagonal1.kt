...
public val ArrowsGroup.StretchDiagonal1: ImageVector
    get() {
        if (_stretchDiagonal1 != null) {
            return _stretchDiagonal1!!
        }
        _stretchDiagonal1 = Builder(name = "StretchDiagonal1", defaultWidth = 64.0.dp, defaultHeight
...
private var _stretchDiagonal1: ImageVector? = null
