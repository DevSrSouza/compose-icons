...
public val ArrowsGroup.SquareDownright: ImageVector
    get() {
        if (_squareDownright != null) {
            return _squareDownright!!
        }
        _squareDownright = Builder(name = "SquareDownright", defaultWidth = 64.0.dp, defaultHeight =
...
private var _squareDownright: ImageVector? = null
