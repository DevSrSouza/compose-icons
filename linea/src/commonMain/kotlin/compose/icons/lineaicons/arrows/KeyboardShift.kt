...
public val ArrowsGroup.KeyboardShift: ImageVector
    get() {
        if (_keyboardShift != null) {
            return _keyboardShift!!
        }
        _keyboardShift = Builder(name = "KeyboardShift", defaultWidth = 64.0.dp, defaultHeight =
