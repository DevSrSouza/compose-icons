...
public val ArrowsGroup.CircleDownleft: ImageVector
    get() {
        if (_circleDownleft != null) {
            return _circleDownleft!!
        }
        _circleDownleft = Builder(name = "CircleDownleft", defaultWidth = 64.0.dp, defaultHeight =
...
private var _circleDownleft: ImageVector? = null
