...
public val ArrowsGroup.SquareDown: ImageVector
    get() {
        if (_squareDown != null) {
            return _squareDown!!
        }
        _squareDown = Builder(name = "SquareDown", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _squareDown: ImageVector? = null
