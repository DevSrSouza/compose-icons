...
public val ArrowsGroup.SquareRight: ImageVector
    get() {
        if (_squareRight != null) {
            return _squareRight!!
        }
        _squareRight = Builder(name = "SquareRight", defaultWidth = 64.0.dp, defaultHeight =
...
private var _squareRight: ImageVector? = null
