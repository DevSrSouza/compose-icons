...
public val ArrowsGroup.DragRightDashed: ImageVector
    get() {
        if (_dragRightDashed != null) {
            return _dragRightDashed!!
        }
        _dragRightDashed = Builder(name = "DragRightDashed", defaultWidth = 64.0.dp, defaultHeight =
...
private var _dragRightDashed: ImageVector? = null
