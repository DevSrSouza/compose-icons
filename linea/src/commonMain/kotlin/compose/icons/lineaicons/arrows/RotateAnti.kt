...
public val ArrowsGroup.RotateAnti: ImageVector
    get() {
        if (_rotateAnti != null) {
            return _rotateAnti!!
        }
        _rotateAnti = Builder(name = "RotateAnti", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
                viewportWidth = 64.0f, viewportHeight = 64.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(31.0f, 1.0f)
                curveTo(23.322f, 1.0f, 15.646f, 3.929f, 9.788f, 9.787f)
...
private var _rotateAnti: ImageVector? = null
