...
public val ArrowsGroup.Diagonal: ImageVector
    get() {
        if (_diagonal != null) {
            return _diagonal!!
        }
        _diagonal = Builder(name = "Diagonal", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _diagonal: ImageVector? = null
