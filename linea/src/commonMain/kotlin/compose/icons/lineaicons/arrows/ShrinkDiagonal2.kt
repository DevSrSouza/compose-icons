...
public val ArrowsGroup.ShrinkDiagonal2: ImageVector
    get() {
        if (_shrinkDiagonal2 != null) {
            return _shrinkDiagonal2!!
        }
        _shrinkDiagonal2 = Builder(name = "ShrinkDiagonal2", defaultWidth = 64.0.dp, defaultHeight =
...
private var _shrinkDiagonal2: ImageVector? = null
