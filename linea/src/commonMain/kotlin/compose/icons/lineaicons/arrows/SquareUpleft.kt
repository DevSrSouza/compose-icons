...
public val ArrowsGroup.SquareUpleft: ImageVector
    get() {
        if (_squareUpleft != null) {
            return _squareUpleft!!
        }
        _squareUpleft = Builder(name = "SquareUpleft", defaultWidth = 64.0.dp, defaultHeight =
...
private var _squareUpleft: ImageVector? = null
