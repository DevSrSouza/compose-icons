...
public val ArrowsGroup.CircleDownright: ImageVector
    get() {
        if (_circleDownright != null) {
            return _circleDownright!!
        }
        _circleDownright = Builder(name = "CircleDownright", defaultWidth = 64.0.dp, defaultHeight =
...
private var _circleDownright: ImageVector? = null
