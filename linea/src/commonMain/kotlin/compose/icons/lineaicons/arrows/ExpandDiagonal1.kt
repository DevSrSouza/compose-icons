...
public val ArrowsGroup.ExpandDiagonal1: ImageVector
    get() {
        if (_expandDiagonal1 != null) {
            return _expandDiagonal1!!
        }
        _expandDiagonal1 = Builder(name = "ExpandDiagonal1", defaultWidth = 64.0.dp, defaultHeight =
...
private var _expandDiagonal1: ImageVector? = null
