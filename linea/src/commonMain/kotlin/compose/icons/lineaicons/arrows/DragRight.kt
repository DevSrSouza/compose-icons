...
public val ArrowsGroup.DragRight: ImageVector
    get() {
        if (_dragRight != null) {
            return _dragRight!!
        }
        _dragRight = Builder(name = "DragRight", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _dragRight: ImageVector? = null
