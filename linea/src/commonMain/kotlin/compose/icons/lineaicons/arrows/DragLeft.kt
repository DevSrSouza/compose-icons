...
public val ArrowsGroup.DragLeft: ImageVector
    get() {
        if (_dragLeft != null) {
            return _dragLeft!!
        }
        _dragLeft = Builder(name = "DragLeft", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _dragLeft: ImageVector? = null
