...
public val ArrowsGroup.FitHorizontal: ImageVector
    get() {
        if (_fitHorizontal != null) {
            return _fitHorizontal!!
        }
        _fitHorizontal = Builder(name = "FitHorizontal", defaultWidth = 64.0.dp, defaultHeight =
...
private var _fitHorizontal: ImageVector? = null
