...
public val ArrowsGroup.KeyboardUp: ImageVector
    get() {
        if (_keyboardUp != null) {
            return _keyboardUp!!
        }
        _keyboardUp = Builder(name = "KeyboardUp", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _keyboardUp: ImageVector? = null
