...
public val ArrowsGroup.SquareUp: ImageVector
    get() {
        if (_squareUp != null) {
            return _squareUp!!
        }
        _squareUp = Builder(name = "SquareUp", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _squareUp: ImageVector? = null
