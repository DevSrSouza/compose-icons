...
public val MusicGroup.Loudspeaker: ImageVector
    get() {
        if (_loudspeaker != null) {
            return _loudspeaker!!
        }
        _loudspeaker = Builder(name = "Loudspeaker", defaultWidth = 64.0.dp, defaultHeight =
...
private var _loudspeaker: ImageVector? = null
