...
public val MusicGroup.BeginningButton: ImageVector
    get() {
        if (_beginningButton != null) {
            return _beginningButton!!
        }
        _beginningButton = Builder(name = "BeginningButton", defaultWidth = 64.0.dp, defaultHeight =
...
private var _beginningButton: ImageVector? = null
