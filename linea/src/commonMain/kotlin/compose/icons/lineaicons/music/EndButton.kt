...
public val MusicGroup.EndButton: ImageVector
    get() {
        if (_endButton != null) {
            return _endButton!!
        }
        _endButton = Builder(name = "EndButton", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _endButton: ImageVector? = null
