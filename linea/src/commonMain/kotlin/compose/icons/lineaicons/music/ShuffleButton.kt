...
public val MusicGroup.ShuffleButton: ImageVector
    get() {
        if (_shuffleButton != null) {
            return _shuffleButton!!
        }
        _shuffleButton = Builder(name = "ShuffleButton", defaultWidth = 64.0.dp, defaultHeight =
...
private var _shuffleButton: ImageVector? = null
