...
public val MusicGroup.RewindButton: ImageVector
    get() {
        if (_rewindButton != null) {
            return _rewindButton!!
        }
        _rewindButton = Builder(name = "RewindButton", defaultWidth = 64.0.dp, defaultHeight =
...
private var _rewindButton: ImageVector? = null
