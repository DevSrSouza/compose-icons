...
public val MusicGroup.RepeatButton: ImageVector
    get() {
        if (_repeatButton != null) {
            return _repeatButton!!
        }
        _repeatButton = Builder(name = "RepeatButton", defaultWidth = 64.0.dp, defaultHeight =
...
private var _repeatButton: ImageVector? = null
