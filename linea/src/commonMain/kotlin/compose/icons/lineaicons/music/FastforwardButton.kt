...
public val MusicGroup.FastforwardButton: ImageVector
    get() {
        if (_fastforwardButton != null) {
            return _fastforwardButton!!
        }
        _fastforwardButton = Builder(name = "FastforwardButton", defaultWidth = 64.0.dp,
...
private var _fastforwardButton: ImageVector? = null
