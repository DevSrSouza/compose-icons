...
public val MusicGroup.EjectButton: ImageVector
    get() {
        if (_ejectButton != null) {
            return _ejectButton!!
        }
        _ejectButton = Builder(name = "EjectButton", defaultWidth = 64.0.dp, defaultHeight =
...
private var _ejectButton: ImageVector? = null
