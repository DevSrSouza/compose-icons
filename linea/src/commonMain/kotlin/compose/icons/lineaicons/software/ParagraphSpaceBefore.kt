...
public val SoftwareGroup.ParagraphSpaceBefore: ImageVector
    get() {
        if (_paragraphSpaceBefore != null) {
            return _paragraphSpaceBefore!!
        }
        _paragraphSpaceBefore = Builder(name = "ParagraphSpaceBefore", defaultWidth = 64.0.dp,
...
private var _paragraphSpaceBefore: ImageVector? = null
