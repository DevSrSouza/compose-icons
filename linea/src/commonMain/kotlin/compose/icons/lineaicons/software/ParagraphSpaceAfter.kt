...
public val SoftwareGroup.ParagraphSpaceAfter: ImageVector
    get() {
        if (_paragraphSpaceAfter != null) {
            return _paragraphSpaceAfter!!
        }
        _paragraphSpaceAfter = Builder(name = "ParagraphSpaceAfter", defaultWidth = 64.0.dp,
...
private var _paragraphSpaceAfter: ImageVector? = null
