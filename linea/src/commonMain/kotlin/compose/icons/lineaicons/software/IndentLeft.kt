...
public val SoftwareGroup.IndentLeft: ImageVector
    get() {
        if (_indentLeft != null) {
            return _indentLeft!!
        }
        _indentLeft = Builder(name = "IndentLeft", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _indentLeft: ImageVector? = null
