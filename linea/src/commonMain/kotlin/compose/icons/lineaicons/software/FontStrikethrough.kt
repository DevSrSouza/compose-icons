...
public val SoftwareGroup.FontStrikethrough: ImageVector
    get() {
        if (_fontStrikethrough != null) {
            return _fontStrikethrough!!
        }
        _fontStrikethrough = Builder(name = "FontStrikethrough", defaultWidth = 64.0.dp,
...
private var _fontStrikethrough: ImageVector? = null
