...
public val SoftwareGroup.FontVerticalScale: ImageVector
    get() {
        if (_fontVerticalScale != null) {
            return _fontVerticalScale!!
        }
        _fontVerticalScale = Builder(name = "FontVerticalScale", defaultWidth = 64.0.dp,
...
private var _fontVerticalScale: ImageVector? = null
