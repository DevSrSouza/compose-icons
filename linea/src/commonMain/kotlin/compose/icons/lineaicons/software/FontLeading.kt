...
public val SoftwareGroup.FontLeading: ImageVector
    get() {
        if (_fontLeading != null) {
            return _fontLeading!!
        }
        _fontLeading = Builder(name = "FontLeading", defaultWidth = 64.0.dp, defaultHeight =
...
private var _fontLeading: ImageVector? = null
