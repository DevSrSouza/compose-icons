...
public val SoftwareGroup.FontTracking: ImageVector
    get() {
        if (_fontTracking != null) {
            return _fontTracking!!
        }
        _fontTracking = Builder(name = "FontTracking", defaultWidth = 64.0.dp, defaultHeight =
...
private var _fontTracking: ImageVector? = null
