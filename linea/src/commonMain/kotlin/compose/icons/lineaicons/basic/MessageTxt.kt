...
public val BasicGroup.MessageTxt: ImageVector
    get() {
        if (_messageTxt != null) {
            return _messageTxt!!
        }
        _messageTxt = Builder(name = "MessageTxt", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _messageTxt: ImageVector? = null
