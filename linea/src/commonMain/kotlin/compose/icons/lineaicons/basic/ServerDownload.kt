...
public val BasicGroup.ServerDownload: ImageVector
    get() {
        if (_serverDownload != null) {
            return _serverDownload!!
        }
        _serverDownload = Builder(name = "ServerDownload", defaultWidth = 64.0.dp, defaultHeight =
...
private var _serverDownload: ImageVector? = null
