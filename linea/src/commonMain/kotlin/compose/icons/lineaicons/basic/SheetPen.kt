...
public val BasicGroup.SheetPen: ImageVector
    get() {
        if (_sheetPen != null) {
            return _sheetPen!!
        }
        _sheetPen = Builder(name = "SheetPen", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _sheetPen: ImageVector? = null
