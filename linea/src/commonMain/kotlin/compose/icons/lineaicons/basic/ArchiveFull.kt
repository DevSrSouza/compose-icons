...
public val BasicGroup.ArchiveFull: ImageVector
    get() {
        if (_archiveFull != null) {
            return _archiveFull!!
        }
        _archiveFull = Builder(name = "ArchiveFull", defaultWidth = 64.0.dp, defaultHeight =
...
private var _archiveFull: ImageVector? = null
