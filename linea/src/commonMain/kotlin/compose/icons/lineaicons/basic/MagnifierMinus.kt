...
public val BasicGroup.MagnifierMinus: ImageVector
    get() {
        if (_magnifierMinus != null) {
            return _magnifierMinus!!
        }
        _magnifierMinus = Builder(name = "MagnifierMinus", defaultWidth = 64.0.dp, defaultHeight =
...
private var _magnifierMinus: ImageVector? = null
