...
public val BasicGroup.Clockwise: ImageVector
    get() {
        if (_clockwise != null) {
            return _clockwise!!
        }
        _clockwise = Builder(name = "Clockwise", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                reflectiveCurveTo(49.121f, 1.0f, 32.0f, 1.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(32.0f, 63.0f)
                curveTo(14.879f, 63.0f, 1.0f, 49.121f, 1.0f, 32.0f)
...
private var _clockwise: ImageVector? = null
