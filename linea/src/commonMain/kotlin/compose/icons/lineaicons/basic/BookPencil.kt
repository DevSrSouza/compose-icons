...
public val BasicGroup.BookPencil: ImageVector
    get() {
        if (_bookPencil != null) {
            return _bookPencil!!
        }
        _bookPencil = Builder(name = "BookPencil", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _bookPencil: ImageVector? = null
