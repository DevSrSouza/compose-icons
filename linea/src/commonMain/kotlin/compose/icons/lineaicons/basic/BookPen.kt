...
public val BasicGroup.BookPen: ImageVector
    get() {
        if (_bookPen != null) {
            return _bookPen!!
        }
        _bookPen = Builder(name = "BookPen", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _bookPen: ImageVector? = null
