...
public val BasicGroup.MailOpenText: ImageVector
    get() {
        if (_mailOpenText != null) {
            return _mailOpenText!!
        }
        _mailOpenText = Builder(name = "MailOpenText", defaultWidth = 64.0.dp, defaultHeight =
...
private var _mailOpenText: ImageVector? = null
