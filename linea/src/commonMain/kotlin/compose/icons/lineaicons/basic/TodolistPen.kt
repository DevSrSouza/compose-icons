...
public val BasicGroup.TodolistPen: ImageVector
    get() {
        if (_todolistPen != null) {
            return _todolistPen!!
        }
        _todolistPen = Builder(name = "TodolistPen", defaultWidth = 64.0.dp, defaultHeight =
...
private var _todolistPen: ImageVector? = null
