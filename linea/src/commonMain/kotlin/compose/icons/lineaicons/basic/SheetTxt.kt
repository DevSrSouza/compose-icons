...
public val BasicGroup.SheetTxt: ImageVector
    get() {
        if (_sheetTxt != null) {
            return _sheetTxt!!
        }
        _sheetTxt = Builder(name = "SheetTxt", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _sheetTxt: ImageVector? = null
