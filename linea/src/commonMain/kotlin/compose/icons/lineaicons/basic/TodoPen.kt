...
public val BasicGroup.TodoPen: ImageVector
    get() {
        if (_todoPen != null) {
            return _todoPen!!
        }
        _todoPen = Builder(name = "TodoPen", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _todoPen: ImageVector? = null
