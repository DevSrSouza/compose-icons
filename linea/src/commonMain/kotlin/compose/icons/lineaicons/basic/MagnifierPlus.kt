...
public val BasicGroup.MagnifierPlus: ImageVector
    get() {
        if (_magnifierPlus != null) {
            return _magnifierPlus!!
        }
        _magnifierPlus = Builder(name = "MagnifierPlus", defaultWidth = 64.0.dp, defaultHeight =
...
private var _magnifierPlus: ImageVector? = null
