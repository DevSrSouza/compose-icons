...
public val BasicGroup.Alarm: ImageVector
    get() {
        if (_alarm != null) {
            return _alarm!!
        }
        _alarm = Builder(name = "Alarm", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
