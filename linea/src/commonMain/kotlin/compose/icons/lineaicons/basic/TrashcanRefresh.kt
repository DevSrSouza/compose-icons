...
public val BasicGroup.TrashcanRefresh: ImageVector
    get() {
        if (_trashcanRefresh != null) {
            return _trashcanRefresh!!
        }
        _trashcanRefresh = Builder(name = "TrashcanRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _trashcanRefresh: ImageVector? = null
