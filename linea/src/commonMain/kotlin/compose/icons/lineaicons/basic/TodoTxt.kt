...
public val BasicGroup.TodoTxt: ImageVector
    get() {
        if (_todoTxt != null) {
            return _todoTxt!!
        }
        _todoTxt = Builder(name = "TodoTxt", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _todoTxt: ImageVector? = null
