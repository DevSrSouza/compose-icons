...
public val WeatherGroup.StormHalfmoon: ImageVector
    get() {
        if (_stormHalfmoon != null) {
            return _stormHalfmoon!!
        }
        _stormHalfmoon = Builder(name = "StormHalfmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _stormHalfmoon: ImageVector? = null
