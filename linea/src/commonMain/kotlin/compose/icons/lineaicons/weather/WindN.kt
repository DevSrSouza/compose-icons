...
public val WeatherGroup.WindN: ImageVector
    get() {
        if (_windN != null) {
            return _windN!!
        }
        _windN = Builder(name = "WindN", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                reflectiveCurveTo(44.0f, 38.628f, 44.0f, 32.0f)
                close()
            }
        }
        .build()
...
private var _windN: ImageVector? = null
