...
public val WeatherGroup.SnowFullmoon: ImageVector
    get() {
        if (_snowFullmoon != null) {
            return _snowFullmoon!!
        }
        _snowFullmoon = Builder(name = "SnowFullmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _snowFullmoon: ImageVector? = null
