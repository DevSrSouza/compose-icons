...
public val WeatherGroup.FogHalfmoon: ImageVector
    get() {
        if (_fogHalfmoon != null) {
            return _fogHalfmoon!!
        }
        _fogHalfmoon = Builder(name = "FogHalfmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _fogHalfmoon: ImageVector? = null
