...
public val WeatherGroup.Sundown: ImageVector
    get() {
        if (_sundown != null) {
            return _sundown!!
        }
        _sundown = Builder(name = "Sundown", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _sundown: ImageVector? = null
