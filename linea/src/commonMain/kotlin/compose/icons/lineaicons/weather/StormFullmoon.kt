...
public val WeatherGroup.StormFullmoon: ImageVector
    get() {
        if (_stormFullmoon != null) {
            return _stormFullmoon!!
        }
        _stormFullmoon = Builder(name = "StormFullmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _stormFullmoon: ImageVector? = null
