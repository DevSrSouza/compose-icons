...
public val WeatherGroup.Newmoon: ImageVector
    get() {
        if (_newmoon != null) {
            return _newmoon!!
        }
        _newmoon = Builder(name = "Newmoon", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _newmoon: ImageVector? = null
