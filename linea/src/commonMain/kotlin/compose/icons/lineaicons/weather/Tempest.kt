...
public val WeatherGroup.Tempest: ImageVector
    get() {
        if (_tempest != null) {
            return _tempest!!
        }
        _tempest = Builder(name = "Tempest", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _tempest: ImageVector? = null
