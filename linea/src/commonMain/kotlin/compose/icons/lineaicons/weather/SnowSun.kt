...
public val WeatherGroup.SnowSun: ImageVector
    get() {
        if (_snowSun != null) {
            return _snowSun!!
        }
        _snowSun = Builder(name = "SnowSun", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _snowSun: ImageVector? = null
