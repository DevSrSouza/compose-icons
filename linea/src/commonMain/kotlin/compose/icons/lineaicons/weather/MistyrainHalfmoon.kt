...
public val WeatherGroup.MistyrainHalfmoon: ImageVector
    get() {
        if (_mistyrainHalfmoon != null) {
            return _mistyrainHalfmoon!!
        }
        _mistyrainHalfmoon = Builder(name = "MistyrainHalfmoon", defaultWidth = 64.0.dp,
...
private var _mistyrainHalfmoon: ImageVector? = null
