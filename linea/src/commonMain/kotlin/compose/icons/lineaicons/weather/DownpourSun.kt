...
public val WeatherGroup.DownpourSun: ImageVector
    get() {
        if (_downpourSun != null) {
            return _downpourSun!!
        }
        _downpourSun = Builder(name = "DownpourSun", defaultWidth = 64.0.dp, defaultHeight =
...
private var _downpourSun: ImageVector? = null
