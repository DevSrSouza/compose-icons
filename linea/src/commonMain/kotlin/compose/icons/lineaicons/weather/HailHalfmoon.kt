...
public val WeatherGroup.HailHalfmoon: ImageVector
    get() {
        if (_hailHalfmoon != null) {
            return _hailHalfmoon!!
        }
        _hailHalfmoon = Builder(name = "HailHalfmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _hailHalfmoon: ImageVector? = null
