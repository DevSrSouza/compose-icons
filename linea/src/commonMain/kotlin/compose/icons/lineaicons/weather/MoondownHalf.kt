...
public val WeatherGroup.MoondownHalf: ImageVector
    get() {
        if (_moondownHalf != null) {
            return _moondownHalf!!
        }
        _moondownHalf = Builder(name = "MoondownHalf", defaultWidth = 64.0.dp, defaultHeight =
...
private var _moondownHalf: ImageVector? = null
