...
public val WeatherGroup.DownpourFullmoon: ImageVector
    get() {
        if (_downpourFullmoon != null) {
            return _downpourFullmoon!!
        }
        _downpourFullmoon = Builder(name = "DownpourFullmoon", defaultWidth = 64.0.dp, defaultHeight
...
private var _downpourFullmoon: ImageVector? = null
