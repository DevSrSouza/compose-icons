...
public val WeatherGroup.TempestSun: ImageVector
    get() {
        if (_tempestSun != null) {
            return _tempestSun!!
        }
        _tempestSun = Builder(name = "TempestSun", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _tempestSun: ImageVector? = null
