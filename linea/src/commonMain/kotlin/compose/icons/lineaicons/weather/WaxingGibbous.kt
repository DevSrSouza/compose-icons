...
public val WeatherGroup.WaxingGibbous: ImageVector
    get() {
        if (_waxingGibbous != null) {
            return _waxingGibbous!!
        }
        _waxingGibbous = Builder(name = "WaxingGibbous", defaultWidth = 64.0.dp, defaultHeight =
...
private var _waxingGibbous: ImageVector? = null
