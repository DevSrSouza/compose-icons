...
public val WeatherGroup.RainHalfmoon: ImageVector
    get() {
        if (_rainHalfmoon != null) {
            return _rainHalfmoon!!
        }
        _rainHalfmoon = Builder(name = "RainHalfmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _rainHalfmoon: ImageVector? = null
