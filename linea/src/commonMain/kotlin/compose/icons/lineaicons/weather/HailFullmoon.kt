...
public val WeatherGroup.HailFullmoon: ImageVector
    get() {
        if (_hailFullmoon != null) {
            return _hailFullmoon!!
        }
        _hailFullmoon = Builder(name = "HailFullmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _hailFullmoon: ImageVector? = null
