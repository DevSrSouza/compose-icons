...
public val WeatherGroup.SnowHalfmoon: ImageVector
    get() {
        if (_snowHalfmoon != null) {
            return _snowHalfmoon!!
        }
        _snowHalfmoon = Builder(name = "SnowHalfmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _snowHalfmoon: ImageVector? = null
