...
public val WeatherGroup.HailSun: ImageVector
    get() {
        if (_hailSun != null) {
            return _hailSun!!
        }
        _hailSun = Builder(name = "HailSun", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _hailSun: ImageVector? = null
