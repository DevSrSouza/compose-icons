...
public val WeatherGroup.MistyrainSun: ImageVector
    get() {
        if (_mistyrainSun != null) {
            return _mistyrainSun!!
        }
        _mistyrainSun = Builder(name = "MistyrainSun", defaultWidth = 64.0.dp, defaultHeight =
...
private var _mistyrainSun: ImageVector? = null
