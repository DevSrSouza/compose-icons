...
public val WeatherGroup.RainFullmoon: ImageVector
    get() {
        if (_rainFullmoon != null) {
            return _rainFullmoon!!
        }
        _rainFullmoon = Builder(name = "RainFullmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _rainFullmoon: ImageVector? = null
