...
public val WeatherGroup.MistyrainFullmoon: ImageVector
    get() {
        if (_mistyrainFullmoon != null) {
            return _mistyrainFullmoon!!
        }
        _mistyrainFullmoon = Builder(name = "MistyrainFullmoon", defaultWidth = 64.0.dp,
...
private var _mistyrainFullmoon: ImageVector? = null
