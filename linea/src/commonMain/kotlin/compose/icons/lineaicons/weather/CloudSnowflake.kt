...
public val WeatherGroup.CloudSnowflake: ImageVector
    get() {
        if (_cloudSnowflake != null) {
            return _cloudSnowflake!!
        }
        _cloudSnowflake = Builder(name = "CloudSnowflake", defaultWidth = 64.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(30.0f, 38.0f)
                lineTo(25.636f, 33.636f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(38.364f, 46.364f)
                lineTo(34.0f, 42.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(22.101f, 45.657f)
                lineToRelative(3.535f, 0.707f)
                lineToRelative(0.707f, 3.535f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(30.0f, 42.0f)
                lineTo(25.636f, 46.364f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(38.364f, 33.636f)
                lineTo(34.0f, 38.0f)
            }
        }
        .build()
...
private var _cloudSnowflake: ImageVector? = null
