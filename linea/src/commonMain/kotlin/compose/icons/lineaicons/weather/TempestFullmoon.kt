...
public val WeatherGroup.TempestFullmoon: ImageVector
    get() {
        if (_tempestFullmoon != null) {
            return _tempestFullmoon!!
        }
        _tempestFullmoon = Builder(name = "TempestFullmoon", defaultWidth = 64.0.dp, defaultHeight =
...
private var _tempestFullmoon: ImageVector? = null
