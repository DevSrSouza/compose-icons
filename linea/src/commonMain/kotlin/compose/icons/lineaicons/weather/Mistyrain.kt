...
public val WeatherGroup.Mistyrain: ImageVector
    get() {
        if (_mistyrain != null) {
            return _mistyrain!!
        }
        _mistyrain = Builder(name = "Mistyrain", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _mistyrain: ImageVector? = null
