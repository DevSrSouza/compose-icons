...
public val WeatherGroup.DownpourHalfmoon: ImageVector
    get() {
        if (_downpourHalfmoon != null) {
            return _downpourHalfmoon!!
        }
        _downpourHalfmoon = Builder(name = "DownpourHalfmoon", defaultWidth = 64.0.dp, defaultHeight
...
private var _downpourHalfmoon: ImageVector? = null
