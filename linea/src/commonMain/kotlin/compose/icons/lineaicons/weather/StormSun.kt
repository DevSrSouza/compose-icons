...
public val WeatherGroup.StormSun: ImageVector
    get() {
        if (_stormSun != null) {
            return _stormSun!!
        }
        _stormSun = Builder(name = "StormSun", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _stormSun: ImageVector? = null
