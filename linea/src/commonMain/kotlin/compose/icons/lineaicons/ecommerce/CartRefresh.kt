...
public val EcommerceGroup.CartRefresh: ImageVector
    get() {
        if (_cartRefresh != null) {
            return _cartRefresh!!
        }
        _cartRefresh = Builder(name = "CartRefresh", defaultWidth = 64.0.dp, defaultHeight =
...
private var _cartRefresh: ImageVector? = null
