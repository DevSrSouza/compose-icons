...
public val EcommerceGroup.BasketCloud: ImageVector
    get() {
        if (_basketCloud != null) {
            return _basketCloud!!
        }
        _basketCloud = Builder(name = "BasketCloud", defaultWidth = 64.0.dp, defaultHeight =
...
private var _basketCloud: ImageVector? = null
