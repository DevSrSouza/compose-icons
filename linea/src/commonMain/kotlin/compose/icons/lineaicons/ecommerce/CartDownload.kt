...
public val EcommerceGroup.CartDownload: ImageVector
    get() {
        if (_cartDownload != null) {
            return _cartDownload!!
        }
        _cartDownload = Builder(name = "CartDownload", defaultWidth = 64.0.dp, defaultHeight =
...
private var _cartDownload: ImageVector? = null
