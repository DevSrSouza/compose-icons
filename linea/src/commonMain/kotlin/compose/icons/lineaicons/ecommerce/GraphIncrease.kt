...
public val EcommerceGroup.GraphIncrease: ImageVector
    get() {
        if (_graphIncrease != null) {
            return _graphIncrease!!
        }
        _graphIncrease = Builder(name = "GraphIncrease", defaultWidth = 64.0.dp, defaultHeight =
...
private var _graphIncrease: ImageVector? = null
