...
public val EcommerceGroup.CartUpload: ImageVector
    get() {
        if (_cartUpload != null) {
            return _cartUpload!!
        }
        _cartUpload = Builder(name = "CartUpload", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(35.998f, 16.0f)
                lineTo(35.998f, 36.0f)
            }
        }
        .build()
        return _cartUpload!!
...
private var _cartUpload: ImageVector? = null
