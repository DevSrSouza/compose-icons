...
public val EcommerceGroup.GraphDecrease: ImageVector
    get() {
        if (_graphDecrease != null) {
            return _graphDecrease!!
        }
        _graphDecrease = Builder(name = "GraphDecrease", defaultWidth = 64.0.dp, defaultHeight =
...
private var _graphDecrease: ImageVector? = null
