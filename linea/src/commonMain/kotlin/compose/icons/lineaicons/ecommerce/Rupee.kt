...
public val EcommerceGroup.Rupee: ImageVector
    get() {
        if (_rupee != null) {
            return _rupee!!
        }
        _rupee = Builder(name = "Rupee", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, -9.0f, -11.0f, -9.0f, -11.0f, -9.0f)
