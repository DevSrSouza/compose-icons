...
public val EcommerceGroup.Naira: ImageVector
    get() {
        if (_naira != null) {
            return _naira!!
        }
        _naira = Builder(name = "Naira", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _naira: ImageVector? = null
