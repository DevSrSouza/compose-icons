...
public val EcommerceGroup.BagMinus: ImageVector
    get() {
        if (_bagMinus != null) {
            return _bagMinus!!
        }
        _bagMinus = Builder(name = "BagMinus", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _bagMinus: ImageVector? = null
