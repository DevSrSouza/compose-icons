...
public val EcommerceGroup.Guarani: ImageVector
    get() {
        if (_guarani != null) {
            return _guarani!!
        }
        _guarani = Builder(name = "Guarani", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _guarani: ImageVector? = null
