...
public val EcommerceGroup.ReceiptWon: ImageVector
    get() {
        if (_receiptWon != null) {
            return _receiptWon!!
        }
        _receiptWon = Builder(name = "ReceiptWon", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _receiptWon: ImageVector? = null
