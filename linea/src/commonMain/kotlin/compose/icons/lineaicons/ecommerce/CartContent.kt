...
public val EcommerceGroup.CartContent: ImageVector
    get() {
        if (_cartContent != null) {
            return _cartContent!!
        }
        _cartContent = Builder(name = "CartContent", defaultWidth = 64.0.dp, defaultHeight =
...
private var _cartContent: ImageVector? = null
