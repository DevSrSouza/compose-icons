...
public val EcommerceGroup.Pound: ImageVector
    get() {
        if (_pound != null) {
            return _pound!!
        }
        _pound = Builder(name = "Pound", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(-4.941f, 0.0f, -9.0f, 2.0f, -9.0f, 7.0f)
