...
public val EcommerceGroup.BasketDownload: ImageVector
    get() {
        if (_basketDownload != null) {
            return _basketDownload!!
        }
        _basketDownload = Builder(name = "BasketDownload", defaultWidth = 64.0.dp, defaultHeight =
...
private var _basketDownload: ImageVector? = null
