...
public val EcommerceGroup.BagSearch: ImageVector
    get() {
        if (_bagSearch != null) {
            return _bagSearch!!
        }
        _bagSearch = Builder(name = "BagSearch", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _bagSearch: ImageVector? = null
