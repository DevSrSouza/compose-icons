...
public val EcommerceGroup.Tugriks: ImageVector
    get() {
        if (_tugriks != null) {
            return _tugriks!!
        }
        _tugriks = Builder(name = "Tugriks", defaultWidth = 64.0.dp, defaultHeight = 64.0.dp,
...
private var _tugriks: ImageVector? = null
