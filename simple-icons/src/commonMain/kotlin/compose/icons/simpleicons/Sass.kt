...
public val SimpleIcons.Sass: VectorAsset
    get() {
        if (_sass != null) {
            return _sass!!
        }
        _sass = VectorAssetBuilder(name = "Sass", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sass: VectorAsset? = null
