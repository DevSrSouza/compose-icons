...
public val SimpleIcons.Houdini: VectorAsset
    get() {
        if (_houdini != null) {
            return _houdini!!
        }
        _houdini = VectorAssetBuilder(name = "Houdini", defaultWidth = 24.0.dp, defaultHeight =
...
private var _houdini: VectorAsset? = null
