...
public val SimpleIcons.Quantopian: VectorAsset
    get() {
        if (_quantopian != null) {
            return _quantopian!!
        }
        _quantopian = VectorAssetBuilder(name = "Quantopian", defaultWidth = 24.0.dp, defaultHeight
...
private var _quantopian: VectorAsset? = null
