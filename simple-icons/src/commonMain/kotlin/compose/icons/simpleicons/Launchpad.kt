...
public val SimpleIcons.Launchpad: VectorAsset
    get() {
        if (_launchpad != null) {
            return _launchpad!!
        }
        _launchpad = VectorAssetBuilder(name = "Launchpad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _launchpad: VectorAsset? = null
