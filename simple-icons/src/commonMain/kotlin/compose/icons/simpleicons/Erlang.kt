...
public val SimpleIcons.Erlang: VectorAsset
    get() {
        if (_erlang != null) {
            return _erlang!!
        }
        _erlang = VectorAssetBuilder(name = "Erlang", defaultWidth = 24.0.dp, defaultHeight =
...
private var _erlang: VectorAsset? = null
