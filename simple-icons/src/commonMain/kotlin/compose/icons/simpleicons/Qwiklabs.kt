...
public val SimpleIcons.Qwiklabs: VectorAsset
    get() {
        if (_qwiklabs != null) {
            return _qwiklabs!!
        }
        _qwiklabs = VectorAssetBuilder(name = "Qwiklabs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qwiklabs: VectorAsset? = null
