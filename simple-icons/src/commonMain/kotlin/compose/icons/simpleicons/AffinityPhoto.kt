...
public val SimpleIcons.AffinityPhoto: VectorAsset
    get() {
        if (_affinityPhoto != null) {
            return _affinityPhoto!!
        }
        _affinityPhoto = VectorAssetBuilder(name = "AffinityPhoto", defaultWidth = 24.0.dp,
...
private var _affinityPhoto: VectorAsset? = null
