...
public val SimpleIcons.Tableau: VectorAsset
    get() {
        if (_tableau != null) {
            return _tableau!!
        }
        _tableau = VectorAssetBuilder(name = "Tableau", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tableau: VectorAsset? = null
