...
public val SimpleIcons.MicrosoftWord: VectorAsset
    get() {
        if (_microsoftWord != null) {
            return _microsoftWord!!
        }
        _microsoftWord = VectorAssetBuilder(name = "MicrosoftWord", defaultWidth = 24.0.dp,
...
private var _microsoftWord: VectorAsset? = null
