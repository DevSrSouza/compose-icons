...
public val SimpleIcons.Appsignal: VectorAsset
    get() {
        if (_appsignal != null) {
            return _appsignal!!
        }
        _appsignal = VectorAssetBuilder(name = "Appsignal", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.005f, 7.326f)
                curveToRelative(-1.781f, 0.0f, -3.055f, 1.57f, -4.368f, 3.318f)
                curveToRelative(-0.815f, -3.714f, -1.72f, -7.424f, -4.601f, -7.424f)
                reflectiveCurveToRelative(-3.789f, 3.71f, -4.617f, 7.427f)
                curveToRelative(-1.31f, -1.752f, -2.584f, -3.32f, -4.365f, -3.32f)
                curveToRelative(-1.134f, 0.0f, -3.052f, 0.769f, -3.052f, 3.657f)
                ...
                reflectiveCurveToRelative(-2.292f, -0.998f, -3.3f, -2.236f)
                curveToRelative(0.857f, -3.822f, 1.519f, -7.493f, 3.3f, -7.493f)
                moveTo(1.666f, 16.24f)
                ...
                reflectiveCurveToRelative(2.718f, -0.832f, 3.773f, -1.935f)
...
private var _appsignal: VectorAsset? = null
