...
public val SimpleIcons.Squarespace: VectorAsset
    get() {
        if (_squarespace != null) {
            return _squarespace!!
        }
        _squarespace = VectorAssetBuilder(name = "Squarespace", defaultWidth = 24.0.dp,
...
private var _squarespace: VectorAsset? = null
