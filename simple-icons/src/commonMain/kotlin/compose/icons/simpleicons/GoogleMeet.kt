...
public val SimpleIcons.GoogleMeet: VectorAsset
    get() {
        if (_googleMeet != null) {
            return _googleMeet!!
        }
        _googleMeet = VectorAssetBuilder(name = "GoogleMeet", defaultWidth = 24.0.dp, defaultHeight
...
private var _googleMeet: VectorAsset? = null
