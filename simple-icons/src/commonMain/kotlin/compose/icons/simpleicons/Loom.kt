...
public val SimpleIcons.Loom: VectorAsset
    get() {
        if (_loom != null) {
            return _loom!!
        }
        _loom = VectorAssetBuilder(name = "Loom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _loom: VectorAsset? = null
