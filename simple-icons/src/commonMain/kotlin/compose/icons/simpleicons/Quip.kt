...
public val SimpleIcons.Quip: VectorAsset
    get() {
        if (_quip != null) {
            return _quip!!
        }
        _quip = VectorAssetBuilder(name = "Quip", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _quip: VectorAsset? = null
