...
public val SimpleIcons.Spinrilla: VectorAsset
    get() {
        if (_spinrilla != null) {
            return _spinrilla!!
        }
        _spinrilla = VectorAssetBuilder(name = "Spinrilla", defaultWidth = 24.0.dp, defaultHeight =
...
private var _spinrilla: VectorAsset? = null
