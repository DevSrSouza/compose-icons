...
public val SimpleIcons.ApacheEcharts: VectorAsset
    get() {
        if (_apacheEcharts != null) {
            return _apacheEcharts!!
        }
        _apacheEcharts = VectorAssetBuilder(name = "ApacheEcharts", defaultWidth = 24.0.dp,
...
private var _apacheEcharts: VectorAsset? = null
