...
public val SimpleIcons.Razer: VectorAsset
    get() {
        if (_razer != null) {
            return _razer!!
        }
        _razer = VectorAssetBuilder(name = "Razer", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _razer: VectorAsset? = null
