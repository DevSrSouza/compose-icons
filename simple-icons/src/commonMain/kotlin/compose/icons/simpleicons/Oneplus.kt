...
public val SimpleIcons.Oneplus: VectorAsset
    get() {
        if (_oneplus != null) {
            return _oneplus!!
        }
        _oneplus = VectorAssetBuilder(name = "Oneplus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _oneplus: VectorAsset? = null
