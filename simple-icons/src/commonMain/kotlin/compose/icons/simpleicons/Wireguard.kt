...
public val SimpleIcons.Wireguard: VectorAsset
    get() {
        if (_wireguard != null) {
            return _wireguard!!
        }
        _wireguard = VectorAssetBuilder(name = "Wireguard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wireguard: VectorAsset? = null
