...
public val SimpleIcons.Cloudflare: VectorAsset
    get() {
        if (_cloudflare != null) {
            return _cloudflare!!
        }
        _cloudflare = VectorAssetBuilder(name = "Cloudflare", defaultWidth = 24.0.dp, defaultHeight
...
private var _cloudflare: VectorAsset? = null
