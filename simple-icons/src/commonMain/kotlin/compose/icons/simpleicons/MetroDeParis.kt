...
public val SimpleIcons.MetroDeParis: VectorAsset
    get() {
        if (_metroDeParis != null) {
            return _metroDeParis!!
        }
        _metroDeParis = VectorAssetBuilder(name = "MetroDeParis", defaultWidth = 24.0.dp,
...
private var _metroDeParis: VectorAsset? = null
