...
public val SimpleIcons.Redis: VectorAsset
    get() {
        if (_redis != null) {
            return _redis!!
        }
        _redis = VectorAssetBuilder(name = "Redis", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _redis: VectorAsset? = null
