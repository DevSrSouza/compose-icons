...
public val SimpleIcons.DerSpiegel: VectorAsset
    get() {
        if (_derSpiegel != null) {
            return _derSpiegel!!
        }
        _derSpiegel = VectorAssetBuilder(name = "DerSpiegel", defaultWidth = 24.0.dp, defaultHeight
...
private var _derSpiegel: VectorAsset? = null
