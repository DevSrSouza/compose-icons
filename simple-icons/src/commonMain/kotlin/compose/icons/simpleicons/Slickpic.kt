...
public val SimpleIcons.Slickpic: VectorAsset
    get() {
        if (_slickpic != null) {
            return _slickpic!!
        }
        _slickpic = VectorAssetBuilder(name = "Slickpic", defaultWidth = 24.0.dp, defaultHeight =
...
private var _slickpic: VectorAsset? = null
