...
public val SimpleIcons.Ghostery: VectorAsset
    get() {
        if (_ghostery != null) {
            return _ghostery!!
        }
        _ghostery = VectorAssetBuilder(name = "Ghostery", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ghostery: VectorAsset? = null
