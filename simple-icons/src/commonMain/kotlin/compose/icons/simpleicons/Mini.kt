...
public val SimpleIcons.Mini: VectorAsset
    get() {
        if (_mini != null) {
            return _mini!!
        }
        _mini = VectorAssetBuilder(name = "Mini", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _mini: VectorAsset? = null
