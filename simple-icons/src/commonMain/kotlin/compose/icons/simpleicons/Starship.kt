...
public val SimpleIcons.Starship: VectorAsset
    get() {
        if (_starship != null) {
            return _starship!!
        }
        _starship = VectorAssetBuilder(name = "Starship", defaultWidth = 24.0.dp, defaultHeight =
...
private var _starship: VectorAsset? = null
