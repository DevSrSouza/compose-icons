...
public val SimpleIcons.Mega: VectorAsset
    get() {
        if (_mega != null) {
            return _mega!!
        }
        _mega = VectorAssetBuilder(name = "Mega", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _mega: VectorAsset? = null
