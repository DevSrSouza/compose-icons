...
public val SimpleIcons.LaravelNova: VectorAsset
    get() {
        if (_laravelNova != null) {
            return _laravelNova!!
        }
        _laravelNova = VectorAssetBuilder(name = "LaravelNova", defaultWidth = 24.0.dp,
...
private var _laravelNova: VectorAsset? = null
