...
public val SimpleIcons.WearOs: VectorAsset
    get() {
        if (_wearOs != null) {
            return _wearOs!!
        }
        _wearOs = VectorAssetBuilder(name = "WearOs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wearOs: VectorAsset? = null
