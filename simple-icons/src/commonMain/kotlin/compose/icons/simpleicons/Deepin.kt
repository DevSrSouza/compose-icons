...
public val SimpleIcons.Deepin: VectorAsset
    get() {
        if (_deepin != null) {
            return _deepin!!
        }
        _deepin = VectorAssetBuilder(name = "Deepin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deepin: VectorAsset? = null
