...
public val SimpleIcons.GoogleHangoutsMeet: VectorAsset
    get() {
        if (_googleHangoutsMeet != null) {
            return _googleHangoutsMeet!!
        }
        _googleHangoutsMeet = VectorAssetBuilder(name = "GoogleHangoutsMeet", defaultWidth =
...
private var _googleHangoutsMeet: VectorAsset? = null
