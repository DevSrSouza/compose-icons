...
public val SimpleIcons.Grav: VectorAsset
    get() {
        if (_grav != null) {
            return _grav!!
        }
        _grav = VectorAssetBuilder(name = "Grav", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _grav: VectorAsset? = null
