...
public val SimpleIcons.Openstack: VectorAsset
    get() {
        if (_openstack != null) {
            return _openstack!!
        }
        _openstack = VectorAssetBuilder(name = "Openstack", defaultWidth = 24.0.dp, defaultHeight =
...
private var _openstack: VectorAsset? = null
