...
public val SimpleIcons.Probot: VectorAsset
    get() {
        if (_probot != null) {
            return _probot!!
        }
        _probot = VectorAssetBuilder(name = "Probot", defaultWidth = 24.0.dp, defaultHeight =
...
private var _probot: VectorAsset? = null
