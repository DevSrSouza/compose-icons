...
public val SimpleIcons.Seat: VectorAsset
    get() {
        if (_seat != null) {
            return _seat!!
        }
        _seat = VectorAssetBuilder(name = "Seat", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _seat: VectorAsset? = null
