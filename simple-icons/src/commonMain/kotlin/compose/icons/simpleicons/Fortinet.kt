...
public val SimpleIcons.Fortinet: VectorAsset
    get() {
        if (_fortinet != null) {
            return _fortinet!!
        }
        _fortinet = VectorAssetBuilder(name = "Fortinet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fortinet: VectorAsset? = null
