...
public val SimpleIcons.Trakt: VectorAsset
    get() {
        if (_trakt != null) {
            return _trakt!!
        }
        _trakt = VectorAssetBuilder(name = "Trakt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _trakt: VectorAsset? = null
