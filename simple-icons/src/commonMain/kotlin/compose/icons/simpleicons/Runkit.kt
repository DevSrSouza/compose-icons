...
public val SimpleIcons.Runkit: VectorAsset
    get() {
        if (_runkit != null) {
            return _runkit!!
        }
        _runkit = VectorAssetBuilder(name = "Runkit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _runkit: VectorAsset? = null
