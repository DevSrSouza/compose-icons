...
public val SimpleIcons.Duckduckgo: VectorAsset
    get() {
        if (_duckduckgo != null) {
            return _duckduckgo!!
        }
        _duckduckgo = VectorAssetBuilder(name = "Duckduckgo", defaultWidth = 24.0.dp, defaultHeight
...
private var _duckduckgo: VectorAsset? = null
