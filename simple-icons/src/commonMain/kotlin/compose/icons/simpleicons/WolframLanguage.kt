...
public val SimpleIcons.WolframLanguage: VectorAsset
    get() {
        if (_wolframLanguage != null) {
            return _wolframLanguage!!
        }
        _wolframLanguage = VectorAssetBuilder(name = "WolframLanguage", defaultWidth = 24.0.dp,
...
private var _wolframLanguage: VectorAsset? = null
