...
public val SimpleIcons.Abstract: VectorAsset
    get() {
        if (_abstract != null) {
            return _abstract!!
        }
        _abstract = VectorAssetBuilder(name = "Abstract", defaultWidth = 24.0.dp, defaultHeight =
...
private var _abstract: VectorAsset? = null
