...
public val SimpleIcons.Basecamp: VectorAsset
    get() {
        if (_basecamp != null) {
            return _basecamp!!
        }
        _basecamp = VectorAssetBuilder(name = "Basecamp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _basecamp: VectorAsset? = null
