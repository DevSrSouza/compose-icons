...
public val SimpleIcons.Monero: VectorAsset
    get() {
        if (_monero != null) {
            return _monero!!
        }
        _monero = VectorAssetBuilder(name = "Monero", defaultWidth = 24.0.dp, defaultHeight =
...
private var _monero: VectorAsset? = null
