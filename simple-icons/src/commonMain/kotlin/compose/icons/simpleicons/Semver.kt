...
public val SimpleIcons.Semver: VectorAsset
    get() {
        if (_semver != null) {
            return _semver!!
        }
        _semver = VectorAssetBuilder(name = "Semver", defaultWidth = 24.0.dp, defaultHeight =
...
private var _semver: VectorAsset? = null
