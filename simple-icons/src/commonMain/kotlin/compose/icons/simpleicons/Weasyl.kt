...
public val SimpleIcons.Weasyl: VectorAsset
    get() {
        if (_weasyl != null) {
            return _weasyl!!
        }
        _weasyl = VectorAssetBuilder(name = "Weasyl", defaultWidth = 24.0.dp, defaultHeight =
...
private var _weasyl: VectorAsset? = null
