...
public val SimpleIcons.Gauges: VectorAsset
    get() {
        if (_gauges != null) {
            return _gauges!!
        }
        _gauges = VectorAssetBuilder(name = "Gauges", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gauges: VectorAsset? = null
