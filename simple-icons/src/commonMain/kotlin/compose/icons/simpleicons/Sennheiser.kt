...
public val SimpleIcons.Sennheiser: VectorAsset
    get() {
        if (_sennheiser != null) {
            return _sennheiser!!
        }
        _sennheiser = VectorAssetBuilder(name = "Sennheiser", defaultWidth = 24.0.dp, defaultHeight
...
private var _sennheiser: VectorAsset? = null
