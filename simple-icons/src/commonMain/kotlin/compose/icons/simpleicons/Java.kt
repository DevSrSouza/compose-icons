...
public val SimpleIcons.Java: VectorAsset
    get() {
        if (_java != null) {
            return _java!!
        }
        _java = VectorAssetBuilder(name = "Java", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _java: VectorAsset? = null
