...
public val SimpleIcons.Hipchat: VectorAsset
    get() {
        if (_hipchat != null) {
            return _hipchat!!
        }
        _hipchat = VectorAssetBuilder(name = "Hipchat", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hipchat: VectorAsset? = null
