...
public val SimpleIcons.Tesla: VectorAsset
    get() {
        if (_tesla != null) {
            return _tesla!!
        }
        _tesla = VectorAssetBuilder(name = "Tesla", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tesla: VectorAsset? = null
