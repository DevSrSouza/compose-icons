...
public val SimpleIcons.Atari: VectorAsset
    get() {
        if (_atari != null) {
            return _atari!!
        }
        _atari = VectorAssetBuilder(name = "Atari", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _atari: VectorAsset? = null
