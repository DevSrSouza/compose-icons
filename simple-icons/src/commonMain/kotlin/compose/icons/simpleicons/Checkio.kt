...
public val SimpleIcons.Checkio: VectorAsset
    get() {
        if (_checkio != null) {
            return _checkio!!
        }
        _checkio = VectorAssetBuilder(name = "Checkio", defaultWidth = 24.0.dp, defaultHeight =
...
private var _checkio: VectorAsset? = null
