...
public val SimpleIcons.Allocine: VectorAsset
    get() {
        if (_allocine != null) {
            return _allocine!!
        }
        _allocine = VectorAssetBuilder(name = "Allocine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _allocine: VectorAsset? = null
