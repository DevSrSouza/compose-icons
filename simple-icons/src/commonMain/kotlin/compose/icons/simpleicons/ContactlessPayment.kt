...
public val SimpleIcons.ContactlessPayment: VectorAsset
    get() {
        if (_contactlessPayment != null) {
            return _contactlessPayment!!
        }
        _contactlessPayment = VectorAssetBuilder(name = "ContactlessPayment", defaultWidth =
...
private var _contactlessPayment: VectorAsset? = null
