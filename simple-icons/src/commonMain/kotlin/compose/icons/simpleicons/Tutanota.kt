...
public val SimpleIcons.Tutanota: VectorAsset
    get() {
        if (_tutanota != null) {
            return _tutanota!!
        }
        _tutanota = VectorAssetBuilder(name = "Tutanota", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tutanota: VectorAsset? = null
