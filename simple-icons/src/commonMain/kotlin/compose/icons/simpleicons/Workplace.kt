...
public val SimpleIcons.Workplace: VectorAsset
    get() {
        if (_workplace != null) {
            return _workplace!!
        }
        _workplace = VectorAssetBuilder(name = "Workplace", defaultWidth = 24.0.dp, defaultHeight =
...
private var _workplace: VectorAsset? = null
