...
public val SimpleIcons.Fandango: VectorAsset
    get() {
        if (_fandango != null) {
            return _fandango!!
        }
        _fandango = VectorAssetBuilder(name = "Fandango", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fandango: VectorAsset? = null
