...
public val SimpleIcons.Shopware: VectorAsset
    get() {
        if (_shopware != null) {
            return _shopware!!
        }
        _shopware = VectorAssetBuilder(name = "Shopware", defaultWidth = 24.0.dp, defaultHeight =
...
private var _shopware: VectorAsset? = null
