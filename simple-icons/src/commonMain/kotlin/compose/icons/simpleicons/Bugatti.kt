...
public val SimpleIcons.Bugatti: VectorAsset
    get() {
        if (_bugatti != null) {
            return _bugatti!!
        }
        _bugatti = VectorAssetBuilder(name = "Bugatti", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bugatti: VectorAsset? = null
