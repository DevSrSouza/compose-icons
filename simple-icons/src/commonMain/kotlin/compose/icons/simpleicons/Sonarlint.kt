...
public val SimpleIcons.Sonarlint: VectorAsset
    get() {
        if (_sonarlint != null) {
            return _sonarlint!!
        }
        _sonarlint = VectorAssetBuilder(name = "Sonarlint", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sonarlint: VectorAsset? = null
