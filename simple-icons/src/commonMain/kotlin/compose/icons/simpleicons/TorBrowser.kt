...
public val SimpleIcons.TorBrowser: VectorAsset
    get() {
        if (_torBrowser != null) {
            return _torBrowser!!
        }
        _torBrowser = VectorAssetBuilder(name = "TorBrowser", defaultWidth = 24.0.dp, defaultHeight
...
private var _torBrowser: VectorAsset? = null
