...
public val SimpleIcons.AirplayVideo: VectorAsset
    get() {
        if (_airplayVideo != null) {
            return _airplayVideo!!
        }
        _airplayVideo = VectorAssetBuilder(name = "AirplayVideo", defaultWidth = 24.0.dp,
...
private var _airplayVideo: VectorAsset? = null
