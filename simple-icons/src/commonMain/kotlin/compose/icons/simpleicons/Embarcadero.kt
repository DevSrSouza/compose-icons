...
public val SimpleIcons.Embarcadero: VectorAsset
    get() {
        if (_embarcadero != null) {
            return _embarcadero!!
        }
        _embarcadero = VectorAssetBuilder(name = "Embarcadero", defaultWidth = 24.0.dp,
...
private var _embarcadero: VectorAsset? = null
