...
public val SimpleIcons.TheConversation: VectorAsset
    get() {
        if (_theConversation != null) {
            return _theConversation!!
        }
        _theConversation = VectorAssetBuilder(name = "TheConversation", defaultWidth = 24.0.dp,
...
private var _theConversation: VectorAsset? = null
