...
public val SimpleIcons.Taxbuzz: VectorAsset
    get() {
        if (_taxbuzz != null) {
            return _taxbuzz!!
        }
        _taxbuzz = VectorAssetBuilder(name = "Taxbuzz", defaultWidth = 24.0.dp, defaultHeight =
...
private var _taxbuzz: VectorAsset? = null
