...
public val SimpleIcons.Addthis: VectorAsset
    get() {
        if (_addthis != null) {
            return _addthis!!
        }
        _addthis = VectorAssetBuilder(name = "Addthis", defaultWidth = 24.0.dp, defaultHeight =
...
private var _addthis: VectorAsset? = null
