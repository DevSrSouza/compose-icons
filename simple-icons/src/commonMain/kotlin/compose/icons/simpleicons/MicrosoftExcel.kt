...
public val SimpleIcons.MicrosoftExcel: VectorAsset
    get() {
        if (_microsoftExcel != null) {
            return _microsoftExcel!!
        }
        _microsoftExcel = VectorAssetBuilder(name = "MicrosoftExcel", defaultWidth = 24.0.dp,
...
private var _microsoftExcel: VectorAsset? = null
