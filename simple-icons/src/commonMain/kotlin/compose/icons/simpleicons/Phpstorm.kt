...
public val SimpleIcons.Phpstorm: VectorAsset
    get() {
        if (_phpstorm != null) {
            return _phpstorm!!
        }
        _phpstorm = VectorAssetBuilder(name = "Phpstorm", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phpstorm: VectorAsset? = null
