...
public val SimpleIcons.Umbraco: VectorAsset
    get() {
        if (_umbraco != null) {
            return _umbraco!!
        }
        _umbraco = VectorAssetBuilder(name = "Umbraco", defaultWidth = 24.0.dp, defaultHeight =
...
private var _umbraco: VectorAsset? = null
