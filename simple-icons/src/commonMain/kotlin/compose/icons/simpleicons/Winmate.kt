...
public val SimpleIcons.Winmate: ImageVector
    get() {
        if (_winmate != null) {
            return _winmate!!
        }
        _winmate = Builder(name = "Winmate", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _winmate: ImageVector? = null
