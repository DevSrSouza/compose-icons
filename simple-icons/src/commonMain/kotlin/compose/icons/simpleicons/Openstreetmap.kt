...
public val SimpleIcons.Openstreetmap: VectorAsset
    get() {
        if (_openstreetmap != null) {
            return _openstreetmap!!
        }
        _openstreetmap = VectorAssetBuilder(name = "Openstreetmap", defaultWidth = 24.0.dp,
...
private var _openstreetmap: VectorAsset? = null
