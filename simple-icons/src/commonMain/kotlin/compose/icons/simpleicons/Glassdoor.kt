...
public val SimpleIcons.Glassdoor: VectorAsset
    get() {
        if (_glassdoor != null) {
            return _glassdoor!!
        }
        _glassdoor = VectorAssetBuilder(name = "Glassdoor", defaultWidth = 24.0.dp, defaultHeight =
...
private var _glassdoor: VectorAsset? = null
