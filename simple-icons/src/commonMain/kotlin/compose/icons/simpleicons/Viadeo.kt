...
public val SimpleIcons.Viadeo: VectorAsset
    get() {
        if (_viadeo != null) {
            return _viadeo!!
        }
        _viadeo = VectorAssetBuilder(name = "Viadeo", defaultWidth = 24.0.dp, defaultHeight =
...
private var _viadeo: VectorAsset? = null
