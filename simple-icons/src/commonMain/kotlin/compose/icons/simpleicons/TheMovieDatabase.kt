...
public val SimpleIcons.TheMovieDatabase: VectorAsset
    get() {
        if (_theMovieDatabase != null) {
            return _theMovieDatabase!!
        }
        _theMovieDatabase = VectorAssetBuilder(name = "TheMovieDatabase", defaultWidth = 24.0.dp,
...
private var _theMovieDatabase: VectorAsset? = null
