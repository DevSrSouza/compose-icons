...
public val SimpleIcons.Komoot: VectorAsset
    get() {
        if (_komoot != null) {
            return _komoot!!
        }
        _komoot = VectorAssetBuilder(name = "Komoot", defaultWidth = 24.0.dp, defaultHeight =
...
private var _komoot: VectorAsset? = null
