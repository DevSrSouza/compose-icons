...
public val SimpleIcons.Foodpanda: VectorAsset
    get() {
        if (_foodpanda != null) {
            return _foodpanda!!
        }
        _foodpanda = VectorAssetBuilder(name = "Foodpanda", defaultWidth = 24.0.dp, defaultHeight =
...
private var _foodpanda: VectorAsset? = null
