...
public val SimpleIcons.SumoLogic: VectorAsset
    get() {
        if (_sumoLogic != null) {
            return _sumoLogic!!
        }
        _sumoLogic = VectorAssetBuilder(name = "SumoLogic", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sumoLogic: VectorAsset? = null
