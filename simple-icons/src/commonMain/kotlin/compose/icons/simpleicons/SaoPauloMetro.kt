...
public val SimpleIcons.SaoPauloMetro: VectorAsset
    get() {
        if (_saoPauloMetro != null) {
            return _saoPauloMetro!!
        }
        _saoPauloMetro = VectorAssetBuilder(name = "SaoPauloMetro", defaultWidth = 24.0.dp,
...
private var _saoPauloMetro: VectorAsset? = null
