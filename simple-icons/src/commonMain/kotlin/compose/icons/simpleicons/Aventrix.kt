...
public val SimpleIcons.Aventrix: VectorAsset
    get() {
        if (_aventrix != null) {
            return _aventrix!!
        }
        _aventrix = VectorAssetBuilder(name = "Aventrix", defaultWidth = 24.0.dp, defaultHeight =
...
private var _aventrix: VectorAsset? = null
