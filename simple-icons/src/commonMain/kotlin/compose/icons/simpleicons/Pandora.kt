...
public val SimpleIcons.Pandora: VectorAsset
    get() {
        if (_pandora != null) {
            return _pandora!!
        }
        _pandora = VectorAssetBuilder(name = "Pandora", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pandora: VectorAsset? = null
