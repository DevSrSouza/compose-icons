...
public val SimpleIcons.AerLingus: VectorAsset
    get() {
        if (_aerLingus != null) {
            return _aerLingus!!
        }
        _aerLingus = VectorAssetBuilder(name = "AerLingus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _aerLingus: VectorAsset? = null
