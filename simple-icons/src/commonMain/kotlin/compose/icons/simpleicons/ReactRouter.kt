...
public val SimpleIcons.ReactRouter: VectorAsset
    get() {
        if (_reactRouter != null) {
            return _reactRouter!!
        }
        _reactRouter = VectorAssetBuilder(name = "ReactRouter", defaultWidth = 24.0.dp,
...
private var _reactRouter: VectorAsset? = null
