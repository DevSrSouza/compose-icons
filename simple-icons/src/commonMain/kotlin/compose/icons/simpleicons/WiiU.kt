...
public val SimpleIcons.WiiU: VectorAsset
    get() {
        if (_wiiU != null) {
            return _wiiU!!
        }
        _wiiU = VectorAssetBuilder(name = "WiiU", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _wiiU: VectorAsset? = null
