...
public val SimpleIcons.CarThrottle: VectorAsset
    get() {
        if (_carThrottle != null) {
            return _carThrottle!!
        }
        _carThrottle = VectorAssetBuilder(name = "CarThrottle", defaultWidth = 24.0.dp,
...
private var _carThrottle: VectorAsset? = null
