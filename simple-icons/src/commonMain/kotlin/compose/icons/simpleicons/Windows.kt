...
public val SimpleIcons.Windows: VectorAsset
    get() {
        if (_windows != null) {
            return _windows!!
        }
        _windows = VectorAssetBuilder(name = "Windows", defaultWidth = 24.0.dp, defaultHeight =
...
private var _windows: VectorAsset? = null
