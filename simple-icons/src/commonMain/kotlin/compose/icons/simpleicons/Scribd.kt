...
public val SimpleIcons.Scribd: VectorAsset
    get() {
        if (_scribd != null) {
            return _scribd!!
        }
        _scribd = VectorAssetBuilder(name = "Scribd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _scribd: VectorAsset? = null
