...
public val SimpleIcons.Suzuki: VectorAsset
    get() {
        if (_suzuki != null) {
            return _suzuki!!
        }
        _suzuki = VectorAssetBuilder(name = "Suzuki", defaultWidth = 24.0.dp, defaultHeight =
...
private var _suzuki: VectorAsset? = null
