...
public val SimpleIcons.Rubygems: VectorAsset
    get() {
        if (_rubygems != null) {
            return _rubygems!!
        }
        _rubygems = VectorAssetBuilder(name = "Rubygems", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rubygems: VectorAsset? = null
