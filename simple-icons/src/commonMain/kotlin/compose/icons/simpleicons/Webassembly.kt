...
public val SimpleIcons.Webassembly: VectorAsset
    get() {
        if (_webassembly != null) {
            return _webassembly!!
        }
        _webassembly = VectorAssetBuilder(name = "Webassembly", defaultWidth = 24.0.dp,
...
private var _webassembly: VectorAsset? = null
