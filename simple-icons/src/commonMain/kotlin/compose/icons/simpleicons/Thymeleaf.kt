...
public val SimpleIcons.Thymeleaf: VectorAsset
    get() {
        if (_thymeleaf != null) {
            return _thymeleaf!!
        }
        _thymeleaf = VectorAssetBuilder(name = "Thymeleaf", defaultWidth = 24.0.dp, defaultHeight =
...
private var _thymeleaf: VectorAsset? = null
