...
public val SimpleIcons.Sogou: VectorAsset
    get() {
        if (_sogou != null) {
            return _sogou!!
        }
        _sogou = VectorAssetBuilder(name = "Sogou", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sogou: VectorAsset? = null
