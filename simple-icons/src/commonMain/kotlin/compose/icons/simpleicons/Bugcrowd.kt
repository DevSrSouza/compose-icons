...
public val SimpleIcons.Bugcrowd: VectorAsset
    get() {
        if (_bugcrowd != null) {
            return _bugcrowd!!
        }
        _bugcrowd = VectorAssetBuilder(name = "Bugcrowd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bugcrowd: VectorAsset? = null
