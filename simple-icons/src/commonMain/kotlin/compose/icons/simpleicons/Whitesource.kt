...
public val SimpleIcons.Whitesource: VectorAsset
    get() {
        if (_whitesource != null) {
            return _whitesource!!
        }
        _whitesource = VectorAssetBuilder(name = "Whitesource", defaultWidth = 24.0.dp,
...
private var _whitesource: VectorAsset? = null
