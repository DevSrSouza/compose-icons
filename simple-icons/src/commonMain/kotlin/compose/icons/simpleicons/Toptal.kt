...
public val SimpleIcons.Toptal: VectorAsset
    get() {
        if (_toptal != null) {
            return _toptal!!
        }
        _toptal = VectorAssetBuilder(name = "Toptal", defaultWidth = 24.0.dp, defaultHeight =
...
private var _toptal: VectorAsset? = null
