...
public val SimpleIcons.Manageiq: VectorAsset
    get() {
        if (_manageiq != null) {
            return _manageiq!!
        }
        _manageiq = VectorAssetBuilder(name = "Manageiq", defaultWidth = 24.0.dp, defaultHeight =
...
private var _manageiq: VectorAsset? = null
