...
public val SimpleIcons.Marriott: VectorAsset
    get() {
        if (_marriott != null) {
            return _marriott!!
        }
        _marriott = VectorAssetBuilder(name = "Marriott", defaultWidth = 24.0.dp, defaultHeight =
...
private var _marriott: VectorAsset? = null
