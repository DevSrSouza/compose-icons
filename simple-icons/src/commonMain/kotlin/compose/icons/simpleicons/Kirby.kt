...
public val SimpleIcons.Kirby: VectorAsset
    get() {
        if (_kirby != null) {
            return _kirby!!
        }
        _kirby = VectorAssetBuilder(name = "Kirby", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _kirby: VectorAsset? = null
