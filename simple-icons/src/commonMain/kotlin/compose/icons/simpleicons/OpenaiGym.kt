...
public val SimpleIcons.OpenaiGym: VectorAsset
    get() {
        if (_openaiGym != null) {
            return _openaiGym!!
        }
        _openaiGym = VectorAssetBuilder(name = "OpenaiGym", defaultWidth = 24.0.dp, defaultHeight =
...
private var _openaiGym: VectorAsset? = null
