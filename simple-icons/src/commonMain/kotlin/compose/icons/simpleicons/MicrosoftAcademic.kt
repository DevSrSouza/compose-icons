...
public val SimpleIcons.MicrosoftAcademic: VectorAsset
    get() {
        if (_microsoftAcademic != null) {
            return _microsoftAcademic!!
        }
        _microsoftAcademic = VectorAssetBuilder(name = "MicrosoftAcademic", defaultWidth = 24.0.dp,
...
private var _microsoftAcademic: VectorAsset? = null
