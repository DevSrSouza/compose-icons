...
public val SimpleIcons.ApacheCloudstack: VectorAsset
    get() {
        if (_apacheCloudstack != null) {
            return _apacheCloudstack!!
        }
        _apacheCloudstack = VectorAssetBuilder(name = "ApacheCloudstack", defaultWidth = 24.0.dp,
...
private var _apacheCloudstack: VectorAsset? = null
