...
public val SimpleIcons.Anydesk: VectorAsset
    get() {
        if (_anydesk != null) {
            return _anydesk!!
        }
        _anydesk = VectorAssetBuilder(name = "Anydesk", defaultWidth = 24.0.dp, defaultHeight =
...
private var _anydesk: VectorAsset? = null
