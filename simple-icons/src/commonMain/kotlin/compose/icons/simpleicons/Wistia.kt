...
public val SimpleIcons.Wistia: VectorAsset
    get() {
        if (_wistia != null) {
            return _wistia!!
        }
        _wistia = VectorAssetBuilder(name = "Wistia", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wistia: VectorAsset? = null
