...
public val SimpleIcons.WpRocket: VectorAsset
    get() {
        if (_wpRocket != null) {
            return _wpRocket!!
        }
        _wpRocket = VectorAssetBuilder(name = "WpRocket", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wpRocket: VectorAsset? = null
