...
public val SimpleIcons.ApachePulsar: VectorAsset
    get() {
        if (_apachePulsar != null) {
            return _apachePulsar!!
        }
        _apachePulsar = VectorAssetBuilder(name = "ApachePulsar", defaultWidth = 24.0.dp,
...
private var _apachePulsar: VectorAsset? = null
