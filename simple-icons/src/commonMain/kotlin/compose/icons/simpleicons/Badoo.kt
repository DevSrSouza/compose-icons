...
public val SimpleIcons.Badoo: VectorAsset
    get() {
        if (_badoo != null) {
            return _badoo!!
        }
        _badoo = VectorAssetBuilder(name = "Badoo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _badoo: VectorAsset? = null
