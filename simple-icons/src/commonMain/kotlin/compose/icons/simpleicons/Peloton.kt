...
public val SimpleIcons.Peloton: VectorAsset
    get() {
        if (_peloton != null) {
            return _peloton!!
        }
        _peloton = VectorAssetBuilder(name = "Peloton", defaultWidth = 24.0.dp, defaultHeight =
...
private var _peloton: VectorAsset? = null
