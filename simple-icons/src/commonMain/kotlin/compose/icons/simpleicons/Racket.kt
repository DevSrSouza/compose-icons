...
public val SimpleIcons.Racket: VectorAsset
    get() {
        if (_racket != null) {
            return _racket!!
        }
        _racket = VectorAssetBuilder(name = "Racket", defaultWidth = 24.0.dp, defaultHeight =
...
private var _racket: VectorAsset? = null
