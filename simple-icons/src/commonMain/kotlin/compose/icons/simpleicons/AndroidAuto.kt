...
public val SimpleIcons.AndroidAuto: VectorAsset
    get() {
        if (_androidAuto != null) {
            return _androidAuto!!
        }
        _androidAuto = VectorAssetBuilder(name = "AndroidAuto", defaultWidth = 24.0.dp,
...
private var _androidAuto: VectorAsset? = null
