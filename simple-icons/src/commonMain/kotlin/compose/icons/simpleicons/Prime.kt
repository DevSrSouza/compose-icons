...
public val SimpleIcons.Prime: VectorAsset
    get() {
        if (_prime != null) {
            return _prime!!
        }
        _prime = VectorAssetBuilder(name = "Prime", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _prime: VectorAsset? = null
