...
public val SimpleIcons.Sahibinden: VectorAsset
    get() {
        if (_sahibinden != null) {
            return _sahibinden!!
        }
        _sahibinden = VectorAssetBuilder(name = "Sahibinden", defaultWidth = 24.0.dp, defaultHeight
...
private var _sahibinden: VectorAsset? = null
