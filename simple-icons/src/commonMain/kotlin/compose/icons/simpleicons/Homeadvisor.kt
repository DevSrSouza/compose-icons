...
public val SimpleIcons.Homeadvisor: VectorAsset
    get() {
        if (_homeadvisor != null) {
            return _homeadvisor!!
        }
        _homeadvisor = VectorAssetBuilder(name = "Homeadvisor", defaultWidth = 24.0.dp,
...
private var _homeadvisor: VectorAsset? = null
