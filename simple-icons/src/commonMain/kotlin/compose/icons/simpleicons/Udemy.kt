    ...
    get() {
        ...
        _udemy = VectorAssetBuilder(name = "Udemy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(54.794f, 54.794f, 0.0f, false, true, -0.17f, -4.83f)
                ...
                curveToRelative(-0.46f, 0.94f, -1.169f, 2.3f, -2.479f, 4.9f)
                arcToRelative(34.716f, 34.716f, 0.0f, false, true, -3.5f, 5.58f)
                ...
                curveToRelative(0.83f, -3.05f, 0.48f, -5.129f, -1.34f, -5.129f)
                horizontalLineToRelative(-0.03f)
                curveToRelative(-0.41f, 0.0f, -0.75f, 0.16f, -1.08f, 0.42f)
                curveToRelative(-0.33f, 0.25f, -0.65f, 0.81f, -0.96f, 1.56f)
                curveToRelative(-0.34f, 0.84f, -2.419f, 5.03f, -5.739f, 7.2f)
                curveToRelative(-0.04f, 0.809f, 0.42f, 1.629f, 1.37f, 1.729f)
                curveToRelative(0.85f, 0.08f, 1.46f, -0.28f, 2.24f, -0.81f)
                lineToRelative(-0.16f, 0.73f)
                arcToRelative(31.557f, 31.557f, 0.0f, false, false, -0.5f, 2.6f)
                curveToRelative(-0.46f, 4.2f, 1.47f, 6.269f, 3.74f, 6.269f)
                curveToRelative(0.38f, 0.0f, 0.76f, -0.05f, 1.13f, -0.15f)
                curveToRelative(2.5f, -0.63f, 4.9f, -3.51f, 7.749f, -10.129f)
                arcToRelative(18.798f, 18.798f, 0.0f, false, false, -0.01f, 2.02f)
                curveToRelative(0.19f, 3.8f, 1.68f, 4.93f, 3.8f, 4.93f)
                curveToRelative(1.6f, 0.0f, 3.09f, -0.83f, 3.85f, -1.87f)
                arcTo(3.7f, 3.7f, 0.0f, false, false, 24.0f, 14.46f)
