...
public val SimpleIcons.Pokemon: VectorAsset
    get() {
        if (_pokemon != null) {
            return _pokemon!!
        }
        _pokemon = VectorAssetBuilder(name = "Pokemon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pokemon: VectorAsset? = null
