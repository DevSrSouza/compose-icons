...
public val SimpleIcons.KarlsruherVerkehrsverbund: VectorAsset
    get() {
        if (_karlsruherVerkehrsverbund != null) {
            return _karlsruherVerkehrsverbund!!
        }
        _karlsruherVerkehrsverbund = VectorAssetBuilder(name = "KarlsruherVerkehrsverbund",
...
private var _karlsruherVerkehrsverbund: VectorAsset? = null
