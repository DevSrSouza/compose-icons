...
public val SimpleIcons.Lufthansa: VectorAsset
    get() {
        if (_lufthansa != null) {
            return _lufthansa!!
        }
        _lufthansa = VectorAssetBuilder(name = "Lufthansa", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lufthansa: VectorAsset? = null
