...
public val SimpleIcons.Thinkpad: VectorAsset
    get() {
        if (_thinkpad != null) {
            return _thinkpad!!
        }
        _thinkpad = VectorAssetBuilder(name = "Thinkpad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _thinkpad: VectorAsset? = null
