...
public val SimpleIcons.Authy: VectorAsset
    get() {
        if (_authy != null) {
            return _authy!!
        }
        _authy = VectorAssetBuilder(name = "Authy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _authy: VectorAsset? = null
