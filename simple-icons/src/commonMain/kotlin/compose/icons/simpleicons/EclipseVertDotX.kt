...
public val SimpleIcons.EclipseVertDotX: VectorAsset
    get() {
        if (_eclipseVertDotX != null) {
            return _eclipseVertDotX!!
        }
        _eclipseVertDotX = VectorAssetBuilder(name = "EclipseVertDotX", defaultWidth = 24.0.dp,
...
private var _eclipseVertDotX: VectorAsset? = null
