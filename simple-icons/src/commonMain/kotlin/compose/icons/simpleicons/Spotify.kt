...
public val SimpleIcons.Spotify: VectorAsset
    get() {
        if (_spotify != null) {
            return _spotify!!
        }
        _spotify = VectorAssetBuilder(name = "Spotify", defaultWidth = 24.0.dp, defaultHeight =
...
private var _spotify: VectorAsset? = null
