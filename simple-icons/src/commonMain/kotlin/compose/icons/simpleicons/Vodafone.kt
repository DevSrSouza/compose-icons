...
public val SimpleIcons.Vodafone: VectorAsset
    get() {
        if (_vodafone != null) {
            return _vodafone!!
        }
        _vodafone = VectorAssetBuilder(name = "Vodafone", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vodafone: VectorAsset? = null
