...
public val SimpleIcons.Adobe: VectorAsset
    get() {
        if (_adobe != null) {
            return _adobe!!
        }
        _adobe = VectorAssetBuilder(name = "Adobe", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _adobe: VectorAsset? = null
