...
public val SimpleIcons.Bitly: VectorAsset
    get() {
        if (_bitly != null) {
            return _bitly!!
        }
        _bitly = VectorAssetBuilder(name = "Bitly", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bitly: VectorAsset? = null
