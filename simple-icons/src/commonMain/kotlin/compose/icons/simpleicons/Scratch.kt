...
public val SimpleIcons.Scratch: VectorAsset
    get() {
        if (_scratch != null) {
            return _scratch!!
        }
        _scratch = VectorAssetBuilder(name = "Scratch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _scratch: VectorAsset? = null
