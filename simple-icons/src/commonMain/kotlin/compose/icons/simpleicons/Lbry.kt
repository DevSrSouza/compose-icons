...
public val SimpleIcons.Lbry: VectorAsset
    get() {
        if (_lbry != null) {
            return _lbry!!
        }
        _lbry = VectorAssetBuilder(name = "Lbry", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _lbry: VectorAsset? = null
