...
public val SimpleIcons.MicrosoftOnenote: VectorAsset
    get() {
        if (_microsoftOnenote != null) {
            return _microsoftOnenote!!
        }
        _microsoftOnenote = VectorAssetBuilder(name = "MicrosoftOnenote", defaultWidth = 24.0.dp,
...
private var _microsoftOnenote: VectorAsset? = null
