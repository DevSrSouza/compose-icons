...
public val SimpleIcons.Bose: VectorAsset
    get() {
        if (_bose != null) {
            return _bose!!
        }
        _bose = VectorAssetBuilder(name = "Bose", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bose: VectorAsset? = null
