...
public val SimpleIcons.Ifood: VectorAsset
    get() {
        if (_ifood != null) {
            return _ifood!!
        }
        _ifood = VectorAssetBuilder(name = "Ifood", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ifood: VectorAsset? = null
