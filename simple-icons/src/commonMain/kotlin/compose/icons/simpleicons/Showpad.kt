...
public val SimpleIcons.Showpad: VectorAsset
    get() {
        if (_showpad != null) {
            return _showpad!!
        }
        _showpad = VectorAssetBuilder(name = "Showpad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _showpad: VectorAsset? = null
