...
public val SimpleIcons.Ibeacon: VectorAsset
    get() {
        if (_ibeacon != null) {
            return _ibeacon!!
        }
        _ibeacon = VectorAssetBuilder(name = "Ibeacon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ibeacon: VectorAsset? = null
