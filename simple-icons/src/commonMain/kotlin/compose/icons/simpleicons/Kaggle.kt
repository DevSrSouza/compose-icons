...
public val SimpleIcons.Kaggle: VectorAsset
    get() {
        if (_kaggle != null) {
            return _kaggle!!
        }
        _kaggle = VectorAssetBuilder(name = "Kaggle", defaultWidth = 24.0.dp, defaultHeight =
...
private var _kaggle: VectorAsset? = null
