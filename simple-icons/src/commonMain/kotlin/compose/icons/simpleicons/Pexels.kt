...
public val SimpleIcons.Pexels: VectorAsset
    get() {
        if (_pexels != null) {
            return _pexels!!
        }
        _pexels = VectorAssetBuilder(name = "Pexels", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pexels: VectorAsset? = null
