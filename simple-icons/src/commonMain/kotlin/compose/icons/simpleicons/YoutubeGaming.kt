...
public val SimpleIcons.YoutubeGaming: VectorAsset
    get() {
        if (_youtubeGaming != null) {
            return _youtubeGaming!!
        }
        _youtubeGaming = VectorAssetBuilder(name = "YoutubeGaming", defaultWidth = 24.0.dp,
...
private var _youtubeGaming: VectorAsset? = null
