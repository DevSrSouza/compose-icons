...
public val SimpleIcons.Kofax: VectorAsset
    get() {
        if (_kofax != null) {
            return _kofax!!
        }
        _kofax = VectorAssetBuilder(name = "Kofax", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _kofax: VectorAsset? = null
