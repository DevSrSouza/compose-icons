...
public val SimpleIcons.BeijingSubway: VectorAsset
    get() {
        if (_beijingSubway != null) {
            return _beijingSubway!!
        }
        _beijingSubway = VectorAssetBuilder(name = "BeijingSubway", defaultWidth = 24.0.dp,
...
private var _beijingSubway: VectorAsset? = null
