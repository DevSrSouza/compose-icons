...
public val SimpleIcons.Bugsnag: VectorAsset
    get() {
        if (_bugsnag != null) {
            return _bugsnag!!
        }
        _bugsnag = VectorAssetBuilder(name = "Bugsnag", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bugsnag: VectorAsset? = null
