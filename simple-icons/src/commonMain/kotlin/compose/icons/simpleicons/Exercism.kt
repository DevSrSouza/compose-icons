...
public val SimpleIcons.Exercism: VectorAsset
    get() {
        if (_exercism != null) {
            return _exercism!!
        }
        _exercism = VectorAssetBuilder(name = "Exercism", defaultWidth = 24.0.dp, defaultHeight =
...
private var _exercism: VectorAsset? = null
