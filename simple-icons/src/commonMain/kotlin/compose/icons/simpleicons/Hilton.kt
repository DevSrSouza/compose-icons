...
public val SimpleIcons.Hilton: VectorAsset
    get() {
        if (_hilton != null) {
            return _hilton!!
        }
        _hilton = VectorAssetBuilder(name = "Hilton", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hilton: VectorAsset? = null
