...
public val SimpleIcons.Plurk: VectorAsset
    get() {
        if (_plurk != null) {
            return _plurk!!
        }
        _plurk = VectorAssetBuilder(name = "Plurk", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.9017f, 1.9056f)
                arcToRelative(10.0652f, 10.0652f, 0.0f, false, false, -7.8802f, 3.707f)
                arcToRelative(10.1803f, 10.1803f, 0.0f, false, false, -0.283f, 0.357f)
                ...
                curveToRelative(1.4401f, 0.289f, 2.1901f, 2.6091f, 1.6751f, 5.1832f)
                curveToRelative(-0.515f, 2.574f, -2.1f, 4.4271f, -3.54f, 4.139f)
                curveToRelative(-1.0101f, -0.202f, -1.6781f, -1.405f, -1.8121f, -2.992f)
                ...
                arcToRelative(10.0322f, 10.0322f, 0.0f, false, false, 0.961f, 3.4431f)
                ...
                arcToRelative(0.2612f, 0.2612f, 0.0f, true, true, 0.316f, 0.416f)
                lineToRelative(-0.245f, 0.186f)
                lineToRelative(-0.037f, 0.028f)
                lineToRelative(1.177f, 1.4481f)
                ...
                arcToRelative(10.0502f, 10.0502f, 0.0f, false, false, 6.5272f, 2.181f)
                arcToRelative(10.0422f, 10.0422f, 0.0f, false, false, 5.5722f, -1.855f)
                ...
                arcToRelative(10.0602f, 10.0602f, 0.0f, false, false, 1.103f, -6.6712f)
                curveToRelative(0.301f, -0.278f, 0.853f, -0.824f, 1.0691f, -1.292f)
                curveToRelative(0.231f, -0.502f, 0.29f, -1.02f, -0.323f, -0.792f)
                curveToRelative(-0.476f, 0.177f, -0.842f, 0.291f, -1.286f, 0.19f)
                curveToRelative(-1.417f, -3.5932f, -4.8472f, -6.1932f, -8.8513f, -6.4002f)
                arcToRelative(9.7102f, 9.7102f, 0.0f, false, false, -0.473f, -0.014f)
                close()
                moveTo(2.2645f, 6.2466f)
                arcToRelative(1.228f, 1.228f, 0.0f, false, false, -1.082f, 1.7641f)
                ...
                arcToRelative(5.5901f, 5.5901f, 0.0f, false, false, 0.017f, 0.6001f)
                curveToRelative(0.102f, 1.228f, 0.62f, 2.16f, 1.401f, 2.316f)
                curveToRelative(1.114f, 0.223f, 2.34f, -1.21f, 2.738f, -3.2f)
                curveToRelative(0.3991f, -1.99f, -0.181f, -3.7841f, -1.295f, -4.0071f)
...
private var _plurk: VectorAsset? = null
