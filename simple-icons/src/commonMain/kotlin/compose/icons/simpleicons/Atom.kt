    ...
    get() {
        ...
        _atom = VectorAssetBuilder(name = "Atom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.163f, -0.195f, 0.134f, -0.48f, -0.06f, -0.645f)
                curveTo(9.466f, 1.51f, 8.304f, 1.0f, 7.354f, 1.07f)
                curveToRelative(-0.286f, 0.025f, -0.556f, 0.098f, -0.803f, 0.22f)
                curveToRelative(-1.19f, 0.607f, -1.67f, 2.327f, -1.37f, 4.838f)
                curveToRelative(0.07f, 0.52f, 0.16f, 1.062f, 0.29f, 1.62f)
                curveTo(2.19f, 8.404f, 0.1f, 9.718f, 0.01f, 11.372f)
                curveToRelative(-0.06f, 1.17f, 0.865f, 2.284f, 2.68f, 3.222f)
                curveToRelative(0.224f, 0.115f, 0.502f, 0.03f, 0.62f, -0.2f)
                curveToRelative(0.114f, -0.224f, 0.03f, -0.5f, -0.2f, -0.616f)
                curveTo(1.66f, 13.032f, 0.88f, 12.19f, 0.927f, 11.42f)
                ...
                curveToRelative(0.21f, -0.15f, 0.256f, -0.435f, 0.11f, -0.64f)
                curveToRelative(-0.147f, -0.206f, -0.433f, -0.256f, -0.64f, -0.106f)
                ...
                curveToRelative(-0.11f, -0.227f, -0.384f, -0.323f, -0.61f, -0.216f)
                curveToRelative(-0.23f, 0.11f, -0.33f, 0.385f, -0.22f, 0.612f)
                ...
                curveToRelative(-0.234f, 0.096f, -0.352f, 0.36f, -0.26f, 0.596f)
                curveToRelative(0.07f, 0.18f, 0.24f, 0.292f, 0.426f, 0.292f)
                curveToRelative(0.058f, 0.0f, 0.114f, -0.01f, 0.167f, -0.03f)
                ...
                curveToRelative(-0.292f, -0.768f, -0.532f, -1.51f, -0.723f, -2.215f)
                curveToRelative(0.713f, -0.11f, 1.485f, -0.19f, 2.31f, -0.24f)
                curveToRelative(-0.28f, 0.39f, -0.554f, 0.794f, -0.82f, 1.21f)
                verticalLineToRelative(-0.01f)
                close()
                moveTo(12.005f, 10.625f)
                arcTo(1.375f, 1.375f, 0.0f, true, false, 12.005f, 13.375f)
                arcTo(1.375f, 1.375f, 0.0f, true, false, 12.005f, 10.625f)
                close()
            }
        }
        .build()
