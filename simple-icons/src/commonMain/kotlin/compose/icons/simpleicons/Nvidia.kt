...
public val SimpleIcons.Nvidia: VectorAsset
    get() {
        if (_nvidia != null) {
            return _nvidia!!
        }
        _nvidia = VectorAssetBuilder(name = "Nvidia", defaultWidth = 24.0.dp, defaultHeight =
...
private var _nvidia: VectorAsset? = null
