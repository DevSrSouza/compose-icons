...
public val SimpleIcons.Codersrank: VectorAsset
    get() {
        if (_codersrank != null) {
            return _codersrank!!
        }
        _codersrank = VectorAssetBuilder(name = "Codersrank", defaultWidth = 24.0.dp, defaultHeight
...
private var _codersrank: VectorAsset? = null
