...
public val SimpleIcons.OpenBadges: VectorAsset
    get() {
        if (_openBadges != null) {
            return _openBadges!!
        }
        _openBadges = VectorAssetBuilder(name = "OpenBadges", defaultWidth = 24.0.dp, defaultHeight
...
private var _openBadges: VectorAsset? = null
