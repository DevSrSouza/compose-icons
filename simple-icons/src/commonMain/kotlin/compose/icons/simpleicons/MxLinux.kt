...
public val SimpleIcons.MxLinux: VectorAsset
    get() {
        if (_mxLinux != null) {
            return _mxLinux!!
        }
        _mxLinux = VectorAssetBuilder(name = "MxLinux", defaultWidth = 24.0.dp, defaultHeight =
...
private var _mxLinux: VectorAsset? = null
