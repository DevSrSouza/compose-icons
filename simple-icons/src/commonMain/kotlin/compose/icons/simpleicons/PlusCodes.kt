...
public val SimpleIcons.PlusCodes: VectorAsset
    get() {
        if (_plusCodes != null) {
            return _plusCodes!!
        }
        _plusCodes = VectorAssetBuilder(name = "PlusCodes", defaultWidth = 24.0.dp, defaultHeight =
...
private var _plusCodes: VectorAsset? = null
