...
public val SimpleIcons.HumbleBundle: VectorAsset
    get() {
        if (_humbleBundle != null) {
            return _humbleBundle!!
        }
        _humbleBundle = VectorAssetBuilder(name = "HumbleBundle", defaultWidth = 24.0.dp,
...
private var _humbleBundle: VectorAsset? = null
