...
public val SimpleIcons.Rtlzwei: VectorAsset
    get() {
        if (_rtlzwei != null) {
            return _rtlzwei!!
        }
        _rtlzwei = VectorAssetBuilder(name = "Rtlzwei", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rtlzwei: VectorAsset? = null
