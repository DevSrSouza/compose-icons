...
public val SimpleIcons.Nubank: VectorAsset
    get() {
        if (_nubank != null) {
            return _nubank!!
        }
        _nubank = VectorAssetBuilder(name = "Nubank", defaultWidth = 24.0.dp, defaultHeight =
...
private var _nubank: VectorAsset? = null
