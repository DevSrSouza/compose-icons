...
public val SimpleIcons.AirFrance: VectorAsset
    get() {
        if (_airFrance != null) {
            return _airFrance!!
        }
        _airFrance = VectorAssetBuilder(name = "AirFrance", defaultWidth = 24.0.dp, defaultHeight =
...
private var _airFrance: VectorAsset? = null
