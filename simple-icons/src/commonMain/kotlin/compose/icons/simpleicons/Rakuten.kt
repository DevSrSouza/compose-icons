...
public val SimpleIcons.Rakuten: VectorAsset
    get() {
        if (_rakuten != null) {
            return _rakuten!!
        }
        _rakuten = VectorAssetBuilder(name = "Rakuten", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rakuten: VectorAsset? = null
