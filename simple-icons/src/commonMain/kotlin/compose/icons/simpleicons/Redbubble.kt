...
public val SimpleIcons.Redbubble: VectorAsset
    get() {
        if (_redbubble != null) {
            return _redbubble!!
        }
        _redbubble = VectorAssetBuilder(name = "Redbubble", defaultWidth = 24.0.dp, defaultHeight =
...
private var _redbubble: VectorAsset? = null
