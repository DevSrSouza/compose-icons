...
public val SimpleIcons.Freecodecamp: VectorAsset
    get() {
        if (_freecodecamp != null) {
            return _freecodecamp!!
        }
        _freecodecamp = VectorAssetBuilder(name = "Freecodecamp", defaultWidth = 24.0.dp,
...
private var _freecodecamp: VectorAsset? = null
