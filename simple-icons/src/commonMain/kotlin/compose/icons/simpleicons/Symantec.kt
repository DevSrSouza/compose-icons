...
public val SimpleIcons.Symantec: VectorAsset
    get() {
        if (_symantec != null) {
            return _symantec!!
        }
        _symantec = VectorAssetBuilder(name = "Symantec", defaultWidth = 24.0.dp, defaultHeight =
...
private var _symantec: VectorAsset? = null
