...
public val SimpleIcons.Bigcommerce: VectorAsset
    get() {
        if (_bigcommerce != null) {
            return _bigcommerce!!
        }
        _bigcommerce = VectorAssetBuilder(name = "Bigcommerce", defaultWidth = 24.0.dp,
...
private var _bigcommerce: VectorAsset? = null
