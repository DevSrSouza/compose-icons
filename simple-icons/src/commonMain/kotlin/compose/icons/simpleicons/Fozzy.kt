...
public val SimpleIcons.Fozzy: VectorAsset
    get() {
        if (_fozzy != null) {
            return _fozzy!!
        }
        _fozzy = VectorAssetBuilder(name = "Fozzy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fozzy: VectorAsset? = null
