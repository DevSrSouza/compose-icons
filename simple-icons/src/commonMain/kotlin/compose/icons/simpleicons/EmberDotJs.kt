...
public val SimpleIcons.EmberDotJs: VectorAsset
    get() {
        if (_emberDotJs != null) {
            return _emberDotJs!!
        }
        _emberDotJs = VectorAssetBuilder(name = "EmberDotJs", defaultWidth = 24.0.dp, defaultHeight
...
private var _emberDotJs: VectorAsset? = null
