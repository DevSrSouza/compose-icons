...
public val SimpleIcons.Tata: VectorAsset
    get() {
        if (_tata != null) {
            return _tata!!
        }
        _tata = VectorAssetBuilder(name = "Tata", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tata: VectorAsset? = null
