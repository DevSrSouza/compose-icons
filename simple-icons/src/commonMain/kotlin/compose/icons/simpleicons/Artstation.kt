...
public val SimpleIcons.Artstation: VectorAsset
    get() {
        if (_artstation != null) {
            return _artstation!!
        }
        _artstation = VectorAssetBuilder(name = "Artstation", defaultWidth = 24.0.dp, defaultHeight
...
private var _artstation: VectorAsset? = null
