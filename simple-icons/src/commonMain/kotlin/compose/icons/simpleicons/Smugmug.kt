...
public val SimpleIcons.Smugmug: VectorAsset
    get() {
        if (_smugmug != null) {
            return _smugmug!!
        }
        _smugmug = VectorAssetBuilder(name = "Smugmug", defaultWidth = 24.0.dp, defaultHeight =
...
private var _smugmug: VectorAsset? = null
