...
public val SimpleIcons.Minutemailer: VectorAsset
    get() {
        if (_minutemailer != null) {
            return _minutemailer!!
        }
        _minutemailer = VectorAssetBuilder(name = "Minutemailer", defaultWidth = 24.0.dp,
...
private var _minutemailer: VectorAsset? = null
