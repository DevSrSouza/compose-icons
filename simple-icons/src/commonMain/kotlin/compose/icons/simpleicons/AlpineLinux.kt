...
public val SimpleIcons.AlpineLinux: VectorAsset
    get() {
        if (_alpineLinux != null) {
            return _alpineLinux!!
        }
        _alpineLinux = VectorAssetBuilder(name = "AlpineLinux", defaultWidth = 24.0.dp,
...
private var _alpineLinux: VectorAsset? = null
