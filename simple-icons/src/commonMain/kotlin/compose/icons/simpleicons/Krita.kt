...
public val SimpleIcons.Krita: VectorAsset
    get() {
        if (_krita != null) {
            return _krita!!
        }
        _krita = VectorAssetBuilder(name = "Krita", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _krita: VectorAsset? = null
