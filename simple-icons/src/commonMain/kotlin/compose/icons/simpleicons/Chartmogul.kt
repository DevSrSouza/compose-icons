...
public val SimpleIcons.Chartmogul: VectorAsset
    get() {
        if (_chartmogul != null) {
            return _chartmogul!!
        }
        _chartmogul = VectorAssetBuilder(name = "Chartmogul", defaultWidth = 24.0.dp, defaultHeight
...
private var _chartmogul: VectorAsset? = null
