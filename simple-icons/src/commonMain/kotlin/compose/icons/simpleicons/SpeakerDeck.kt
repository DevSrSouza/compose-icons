...
public val SimpleIcons.SpeakerDeck: VectorAsset
    get() {
        if (_speakerDeck != null) {
            return _speakerDeck!!
        }
        _speakerDeck = VectorAssetBuilder(name = "SpeakerDeck", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.875f, 1.875f, 0.0f, true, true, 0.0f, -3.75f)
                ...
                arcToRelative(2.83f, 2.83f, 0.0f, false, false, 0.704f, -1.875f)
                arcToRelative(2.83f, 2.83f, 0.0f, false, false, -0.704f, -1.875f)
...
private var _speakerDeck: VectorAsset? = null
