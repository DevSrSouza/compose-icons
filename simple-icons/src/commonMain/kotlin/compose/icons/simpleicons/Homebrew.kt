...
public val SimpleIcons.Homebrew: VectorAsset
    get() {
        if (_homebrew != null) {
            return _homebrew!!
        }
        _homebrew = VectorAssetBuilder(name = "Homebrew", defaultWidth = 24.0.dp, defaultHeight =
...
private var _homebrew: VectorAsset? = null
