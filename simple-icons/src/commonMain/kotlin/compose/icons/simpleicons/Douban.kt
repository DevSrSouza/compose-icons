...
public val SimpleIcons.Douban: VectorAsset
    get() {
        if (_douban != null) {
            return _douban!!
        }
        _douban = VectorAssetBuilder(name = "Douban", defaultWidth = 24.0.dp, defaultHeight =
...
private var _douban: VectorAsset? = null
