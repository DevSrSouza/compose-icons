...
public val SimpleIcons.Symphony: VectorAsset
    get() {
        if (_symphony != null) {
            return _symphony!!
        }
        _symphony = VectorAssetBuilder(name = "Symphony", defaultWidth = 24.0.dp, defaultHeight =
...
private var _symphony: VectorAsset? = null
