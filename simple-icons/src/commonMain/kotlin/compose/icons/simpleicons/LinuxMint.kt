...
public val SimpleIcons.LinuxMint: VectorAsset
    get() {
        if (_linuxMint != null) {
            return _linuxMint!!
        }
        _linuxMint = VectorAssetBuilder(name = "LinuxMint", defaultWidth = 24.0.dp, defaultHeight =
...
private var _linuxMint: VectorAsset? = null
