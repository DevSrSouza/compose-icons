...
public val SimpleIcons.Progate: VectorAsset
    get() {
        if (_progate != null) {
            return _progate!!
        }
        _progate = VectorAssetBuilder(name = "Progate", defaultWidth = 24.0.dp, defaultHeight =
...
private var _progate: VectorAsset? = null
