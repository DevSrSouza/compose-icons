...
public val SimpleIcons.Flattr: VectorAsset
    get() {
        if (_flattr != null) {
            return _flattr!!
        }
        _flattr = VectorAssetBuilder(name = "Flattr", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flattr: VectorAsset? = null
