...
public val SimpleIcons.Slideshare: VectorAsset
    get() {
        if (_slideshare != null) {
            return _slideshare!!
        }
        _slideshare = VectorAssetBuilder(name = "Slideshare", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(3.222f, 0.058f)
                curveToRelative(-1.46f, 0.0f, -2.162f, 1.127f, -2.162f, 2.287f)
                ...
                curveToRelative(0.63f, -0.691f, 1.417f, -2.007f, 1.417f, -2.517f)
                curveToRelative(0.0f, -0.51f, -0.556f, -0.782f, -1.036f, -0.302f)
                lineTo(22.964f, 2.345f)
                curveToRelative(0.0f, -0.824f, -0.48f, -2.29f, -2.135f, -2.29f)
                close()
                moveTo(3.645f, 1.408f)
                lineTo(20.41f, 1.408f)
                curveToRelative(0.756f, 0.0f, 1.171f, 0.28f, 1.171f, 1.224f)
                verticalLineToRelative(8.904f)
                arcToRelative(8.73f, 8.73f, 0.0f, false, true, -3.556f, 1.534f)
                curveToRelative(-1.606f, 0.352f, -2.94f, 0.087f, -3.666f, 0.148f)
                curveToRelative(-0.718f, 0.06f, -1.428f, 0.529f, -1.296f, 1.791f)
                curveToRelative(-0.491f, -0.155f, -1.236f, -0.684f, -1.682f, -1.118f)
                curveToRelative(-0.438f, -0.428f, -0.87f, -0.711f, -1.534f, -0.692f)
                curveToRelative(-1.013f, 0.03f, -1.663f, 0.102f, -2.57f, 0.011f)
                arcToRelative(9.656f, 9.656f, 0.0f, false, true, -4.838f, -1.787f)
                lineTo(2.439f, 2.628f)
                curveToRelative(0.0f, -0.869f, 0.378f, -1.22f, 1.206f, -1.22f)
                close()
                moveTo(8.142f, 6.396f)
                arcToRelative(2.993f, 2.993f, 0.0f, true, false, 0.0f, 5.987f)
                arcToRelative(2.993f, 2.993f, 0.0f, false, false, 0.0f, -5.983f)
                close()
                moveTo(15.852f, 6.396f)
                arcToRelative(2.993f, 2.993f, 0.0f, true, false, 0.0f, 5.987f)
                arcToRelative(2.993f, 2.993f, 0.0f, false, false, 0.0f, -5.983f)
                close()
            }
...
private var _slideshare: VectorAsset? = null
