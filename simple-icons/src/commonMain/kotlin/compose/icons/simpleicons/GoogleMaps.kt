...
public val SimpleIcons.GoogleMaps: VectorAsset
    get() {
        if (_googleMaps != null) {
            return _googleMaps!!
        }
        _googleMaps = VectorAssetBuilder(name = "GoogleMaps", defaultWidth = 24.0.dp, defaultHeight
...
private var _googleMaps: VectorAsset? = null
