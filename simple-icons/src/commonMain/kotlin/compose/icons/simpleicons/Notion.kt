...
public val SimpleIcons.Notion: VectorAsset
    get() {
        if (_notion != null) {
            return _notion!!
        }
        _notion = VectorAssetBuilder(name = "Notion", defaultWidth = 24.0.dp, defaultHeight =
...
private var _notion: VectorAsset? = null
