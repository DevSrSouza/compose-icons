...
public val SimpleIcons.Coda: VectorAsset
    get() {
        if (_coda != null) {
            return _coda!!
        }
        _coda = VectorAssetBuilder(name = "Coda", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _coda: VectorAsset? = null
