...
public val SimpleIcons.Xamarin: VectorAsset
    get() {
        if (_xamarin != null) {
            return _xamarin!!
        }
        _xamarin = VectorAssetBuilder(name = "Xamarin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _xamarin: VectorAsset? = null
