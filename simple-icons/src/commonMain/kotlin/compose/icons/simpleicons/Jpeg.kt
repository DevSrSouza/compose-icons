...
public val SimpleIcons.Jpeg: VectorAsset
    get() {
        if (_jpeg != null) {
            return _jpeg!!
        }
        _jpeg = VectorAssetBuilder(name = "Jpeg", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _jpeg: VectorAsset? = null
