...
public val SimpleIcons.Json: VectorAsset
    get() {
        if (_json != null) {
            return _json!!
        }
        _json = VectorAssetBuilder(name = "Json", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _json: VectorAsset? = null
