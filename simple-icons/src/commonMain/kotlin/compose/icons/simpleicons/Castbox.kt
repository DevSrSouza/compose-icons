...
public val SimpleIcons.Castbox: VectorAsset
    get() {
        if (_castbox != null) {
            return _castbox!!
        }
        _castbox = VectorAssetBuilder(name = "Castbox", defaultWidth = 24.0.dp, defaultHeight =
...
private var _castbox: VectorAsset? = null
