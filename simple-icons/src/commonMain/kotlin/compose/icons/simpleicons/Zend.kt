...
public val SimpleIcons.Zend: VectorAsset
    get() {
        if (_zend != null) {
            return _zend!!
        }
        _zend = VectorAssetBuilder(name = "Zend", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _zend: VectorAsset? = null
