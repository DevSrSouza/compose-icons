...
public val SimpleIcons.Xero: VectorAsset
    get() {
        if (_xero != null) {
            return _xero!!
        }
        _xero = VectorAssetBuilder(name = "Xero", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _xero: VectorAsset? = null
