...
public val SimpleIcons.Coveralls: VectorAsset
    get() {
        if (_coveralls != null) {
            return _coveralls!!
        }
        _coveralls = VectorAssetBuilder(name = "Coveralls", defaultWidth = 24.0.dp, defaultHeight =
...
private var _coveralls: VectorAsset? = null
