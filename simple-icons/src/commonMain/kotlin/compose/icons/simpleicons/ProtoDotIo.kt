...
public val SimpleIcons.ProtoDotIo: VectorAsset
    get() {
        if (_protoDotIo != null) {
            return _protoDotIo!!
        }
        _protoDotIo = VectorAssetBuilder(name = "ProtoDotIo", defaultWidth = 24.0.dp, defaultHeight
...
private var _protoDotIo: VectorAsset? = null
