...
public val SimpleIcons.Meteor: VectorAsset
    get() {
        if (_meteor != null) {
            return _meteor!!
        }
        _meteor = VectorAssetBuilder(name = "Meteor", defaultWidth = 24.0.dp, defaultHeight =
...
private var _meteor: VectorAsset? = null
