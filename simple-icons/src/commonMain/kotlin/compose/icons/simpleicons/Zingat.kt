...
public val SimpleIcons.Zingat: VectorAsset
    get() {
        if (_zingat != null) {
            return _zingat!!
        }
        _zingat = VectorAssetBuilder(name = "Zingat", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zingat: VectorAsset? = null
