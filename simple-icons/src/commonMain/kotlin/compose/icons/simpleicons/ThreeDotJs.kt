...
public val SimpleIcons.ThreeDotJs: VectorAsset
    get() {
        if (_threeDotJs != null) {
            return _threeDotJs!!
        }
        _threeDotJs = VectorAssetBuilder(name = "ThreeDotJs", defaultWidth = 24.0.dp, defaultHeight
...
private var _threeDotJs: VectorAsset? = null
