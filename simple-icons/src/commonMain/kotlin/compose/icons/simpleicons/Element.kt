...
public val SimpleIcons.Element: VectorAsset
    get() {
        if (_element != null) {
            return _element!!
        }
        _element = VectorAssetBuilder(name = "Element", defaultWidth = 24.0.dp, defaultHeight =
...
private var _element: VectorAsset? = null
