...
public val SimpleIcons.MetroDeLaCiudadDeMexico: VectorAsset
    get() {
        if (_metroDeLaCiudadDeMexico != null) {
            return _metroDeLaCiudadDeMexico!!
        }
        _metroDeLaCiudadDeMexico = VectorAssetBuilder(name = "MetroDeLaCiudadDeMexico", defaultWidth
...
private var _metroDeLaCiudadDeMexico: VectorAsset? = null
