...
public val SimpleIcons.Lumen: VectorAsset
    get() {
        if (_lumen != null) {
            return _lumen!!
        }
        _lumen = VectorAssetBuilder(name = "Lumen", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _lumen: VectorAsset? = null
