...
public val SimpleIcons.Hugo: VectorAsset
    get() {
        if (_hugo != null) {
            return _hugo!!
        }
        _hugo = VectorAssetBuilder(name = "Hugo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _hugo: VectorAsset? = null
