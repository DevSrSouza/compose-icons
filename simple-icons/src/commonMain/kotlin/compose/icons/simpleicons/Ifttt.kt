...
public val SimpleIcons.Ifttt: VectorAsset
    get() {
        if (_ifttt != null) {
            return _ifttt!!
        }
        _ifttt = VectorAssetBuilder(name = "Ifttt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ifttt: VectorAsset? = null
