...
public val SimpleIcons.HatenaBookmark: VectorAsset
    get() {
        if (_hatenaBookmark != null) {
            return _hatenaBookmark!!
        }
        _hatenaBookmark = VectorAssetBuilder(name = "HatenaBookmark", defaultWidth = 24.0.dp,
...
private var _hatenaBookmark: VectorAsset? = null
