...
public val SimpleIcons.AdobeFonts: VectorAsset
    get() {
        if (_adobeFonts != null) {
            return _adobeFonts!!
        }
        _adobeFonts = VectorAssetBuilder(name = "AdobeFonts", defaultWidth = 24.0.dp, defaultHeight
...
private var _adobeFonts: VectorAsset? = null
