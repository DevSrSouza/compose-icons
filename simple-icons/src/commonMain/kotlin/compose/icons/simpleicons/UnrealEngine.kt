...
public val SimpleIcons.UnrealEngine: VectorAsset
    get() {
        if (_unrealEngine != null) {
            return _unrealEngine!!
        }
        _unrealEngine = VectorAssetBuilder(name = "UnrealEngine", defaultWidth = 24.0.dp,
...
private var _unrealEngine: VectorAsset? = null
