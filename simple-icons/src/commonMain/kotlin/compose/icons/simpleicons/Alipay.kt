...
public val SimpleIcons.Alipay: VectorAsset
    get() {
        if (_alipay != null) {
            return _alipay!!
        }
        _alipay = VectorAssetBuilder(name = "Alipay", defaultWidth = 24.0.dp, defaultHeight =
...
private var _alipay: VectorAsset? = null
