...
public val SimpleIcons.Safari: VectorAsset
    get() {
        if (_safari != null) {
            return _safari!!
        }
        _safari = VectorAssetBuilder(name = "Safari", defaultWidth = 24.0.dp, defaultHeight =
...
private var _safari: VectorAsset? = null
