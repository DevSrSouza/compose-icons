...
public val SimpleIcons.Volkswagen: VectorAsset
    get() {
        if (_volkswagen != null) {
            return _volkswagen!!
        }
        _volkswagen = VectorAssetBuilder(name = "Volkswagen", defaultWidth = 24.0.dp, defaultHeight
...
private var _volkswagen: VectorAsset? = null
