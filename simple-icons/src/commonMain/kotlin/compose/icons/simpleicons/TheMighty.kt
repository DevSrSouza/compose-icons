...
public val SimpleIcons.TheMighty: VectorAsset
    get() {
        if (_theMighty != null) {
            return _theMighty!!
        }
        _theMighty = VectorAssetBuilder(name = "TheMighty", defaultWidth = 24.0.dp, defaultHeight =
...
private var _theMighty: VectorAsset? = null
