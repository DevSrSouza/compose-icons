...
public val SimpleIcons.Opengl: VectorAsset
    get() {
        if (_opengl != null) {
            return _opengl!!
        }
        _opengl = VectorAssetBuilder(name = "Opengl", defaultWidth = 24.0.dp, defaultHeight =
...
private var _opengl: VectorAsset? = null
