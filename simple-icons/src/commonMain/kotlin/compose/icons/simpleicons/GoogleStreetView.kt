...
public val SimpleIcons.GoogleStreetView: VectorAsset
    get() {
        if (_googleStreetView != null) {
            return _googleStreetView!!
        }
        _googleStreetView = VectorAssetBuilder(name = "GoogleStreetView", defaultWidth = 24.0.dp,
...
private var _googleStreetView: VectorAsset? = null
