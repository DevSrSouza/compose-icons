...
public val SimpleIcons.Audioboom: VectorAsset
    get() {
        if (_audioboom != null) {
            return _audioboom!!
        }
        _audioboom = VectorAssetBuilder(name = "Audioboom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _audioboom: VectorAsset? = null
