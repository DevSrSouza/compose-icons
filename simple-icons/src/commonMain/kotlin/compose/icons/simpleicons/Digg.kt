...
public val SimpleIcons.Digg: VectorAsset
    get() {
        if (_digg != null) {
            return _digg!!
        }
        _digg = VectorAssetBuilder(name = "Digg", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _digg: VectorAsset? = null
