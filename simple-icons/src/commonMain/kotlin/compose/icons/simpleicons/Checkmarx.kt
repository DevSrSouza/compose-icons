...
public val SimpleIcons.Checkmarx: VectorAsset
    get() {
        if (_checkmarx != null) {
            return _checkmarx!!
        }
        _checkmarx = VectorAssetBuilder(name = "Checkmarx", defaultWidth = 24.0.dp, defaultHeight =
...
private var _checkmarx: VectorAsset? = null
