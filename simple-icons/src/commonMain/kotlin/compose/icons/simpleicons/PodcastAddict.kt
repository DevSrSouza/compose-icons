...
public val SimpleIcons.PodcastAddict: VectorAsset
    get() {
        if (_podcastAddict != null) {
            return _podcastAddict!!
        }
        _podcastAddict = VectorAssetBuilder(name = "PodcastAddict", defaultWidth = 24.0.dp,
...
private var _podcastAddict: VectorAsset? = null
