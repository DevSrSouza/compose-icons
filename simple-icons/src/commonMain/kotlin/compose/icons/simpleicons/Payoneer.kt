...
public val SimpleIcons.Payoneer: VectorAsset
    get() {
        if (_payoneer != null) {
            return _payoneer!!
        }
        _payoneer = VectorAssetBuilder(name = "Payoneer", defaultWidth = 24.0.dp, defaultHeight =
...
private var _payoneer: VectorAsset? = null
