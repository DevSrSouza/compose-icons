...
public val SimpleIcons.Opencv: VectorAsset
    get() {
        if (_opencv != null) {
            return _opencv!!
        }
        _opencv = VectorAssetBuilder(name = "Opencv", defaultWidth = 24.0.dp, defaultHeight =
...
private var _opencv: VectorAsset? = null
