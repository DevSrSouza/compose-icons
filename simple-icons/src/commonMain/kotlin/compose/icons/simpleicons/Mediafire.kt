...
public val SimpleIcons.Mediafire: VectorAsset
    get() {
        if (_mediafire != null) {
            return _mediafire!!
        }
        _mediafire = VectorAssetBuilder(name = "Mediafire", defaultWidth = 24.0.dp, defaultHeight =
...
private var _mediafire: VectorAsset? = null
