...
public val SimpleIcons.SimpleIcons: VectorAsset
    get() {
        if (_simpleIcons != null) {
            return _simpleIcons!!
        }
        _simpleIcons = VectorAssetBuilder(name = "SimpleIcons", defaultWidth = 24.0.dp,
...
private var _simpleIcons: VectorAsset? = null
