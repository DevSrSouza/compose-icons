...
public val SimpleIcons.Whatsapp: VectorAsset
    get() {
        if (_whatsapp != null) {
            return _whatsapp!!
        }
        _whatsapp = VectorAssetBuilder(name = "Whatsapp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _whatsapp: VectorAsset? = null
