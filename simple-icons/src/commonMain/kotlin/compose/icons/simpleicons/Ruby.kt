...
public val SimpleIcons.Ruby: VectorAsset
    get() {
        if (_ruby != null) {
            return _ruby!!
        }
        _ruby = VectorAssetBuilder(name = "Ruby", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ruby: VectorAsset? = null
