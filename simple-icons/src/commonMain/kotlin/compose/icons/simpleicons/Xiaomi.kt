...
public val SimpleIcons.Xiaomi: VectorAsset
    get() {
        if (_xiaomi != null) {
            return _xiaomi!!
        }
        _xiaomi = VectorAssetBuilder(name = "Xiaomi", defaultWidth = 24.0.dp, defaultHeight =
...
private var _xiaomi: VectorAsset? = null
