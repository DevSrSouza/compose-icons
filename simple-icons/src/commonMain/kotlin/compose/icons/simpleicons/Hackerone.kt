...
public val SimpleIcons.Hackerone: VectorAsset
    get() {
        if (_hackerone != null) {
            return _hackerone!!
        }
        _hackerone = VectorAssetBuilder(name = "Hackerone", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hackerone: VectorAsset? = null
