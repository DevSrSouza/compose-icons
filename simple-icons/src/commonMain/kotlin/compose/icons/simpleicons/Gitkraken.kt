...
public val SimpleIcons.Gitkraken: VectorAsset
    get() {
        if (_gitkraken != null) {
            return _gitkraken!!
        }
        _gitkraken = VectorAssetBuilder(name = "Gitkraken", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gitkraken: VectorAsset? = null
