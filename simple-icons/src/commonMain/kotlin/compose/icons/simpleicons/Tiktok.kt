...
public val SimpleIcons.Tiktok: VectorAsset
    get() {
        if (_tiktok != null) {
            return _tiktok!!
        }
        _tiktok = VectorAssetBuilder(name = "Tiktok", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tiktok: VectorAsset? = null
