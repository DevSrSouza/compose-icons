...
public val SimpleIcons.Xilinx: VectorAsset
    get() {
        if (_xilinx != null) {
            return _xilinx!!
        }
        _xilinx = VectorAssetBuilder(name = "Xilinx", defaultWidth = 24.0.dp, defaultHeight =
...
private var _xilinx: VectorAsset? = null
