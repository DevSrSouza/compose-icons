...
public val SimpleIcons.Deezer: VectorAsset
    get() {
        if (_deezer != null) {
            return _deezer!!
        }
        _deezer = VectorAssetBuilder(name = "Deezer", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deezer: VectorAsset? = null
