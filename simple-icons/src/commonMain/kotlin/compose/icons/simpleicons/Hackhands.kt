...
public val SimpleIcons.Hackhands: VectorAsset
    get() {
        if (_hackhands != null) {
            return _hackhands!!
        }
        _hackhands = VectorAssetBuilder(name = "Hackhands", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hackhands: VectorAsset? = null
