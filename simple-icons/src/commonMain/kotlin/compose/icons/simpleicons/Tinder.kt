...
public val SimpleIcons.Tinder: VectorAsset
    get() {
        if (_tinder != null) {
            return _tinder!!
        }
        _tinder = VectorAssetBuilder(name = "Tinder", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tinder: VectorAsset? = null
