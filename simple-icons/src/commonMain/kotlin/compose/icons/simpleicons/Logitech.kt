...
public val SimpleIcons.Logitech: VectorAsset
    get() {
        if (_logitech != null) {
            return _logitech!!
        }
        _logitech = VectorAssetBuilder(name = "Logitech", defaultWidth = 24.0.dp, defaultHeight =
...
private var _logitech: VectorAsset? = null
