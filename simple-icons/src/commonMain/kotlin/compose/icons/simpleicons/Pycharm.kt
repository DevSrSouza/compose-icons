...
public val SimpleIcons.Pycharm: VectorAsset
    get() {
        if (_pycharm != null) {
            return _pycharm!!
        }
        _pycharm = VectorAssetBuilder(name = "Pycharm", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pycharm: VectorAsset? = null
