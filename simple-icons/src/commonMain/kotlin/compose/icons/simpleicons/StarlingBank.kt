...
public val SimpleIcons.StarlingBank: VectorAsset
    get() {
        if (_starlingBank != null) {
            return _starlingBank!!
        }
        _starlingBank = VectorAssetBuilder(name = "StarlingBank", defaultWidth = 24.0.dp,
...
private var _starlingBank: VectorAsset? = null
