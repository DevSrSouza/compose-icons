...
public val SimpleIcons.Uplabs: VectorAsset
    get() {
        if (_uplabs != null) {
            return _uplabs!!
        }
        _uplabs = VectorAssetBuilder(name = "Uplabs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _uplabs: VectorAsset? = null
