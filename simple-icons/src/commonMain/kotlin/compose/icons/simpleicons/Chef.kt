...
public val SimpleIcons.Chef: VectorAsset
    get() {
        if (_chef != null) {
            return _chef!!
        }
        _chef = VectorAssetBuilder(name = "Chef", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _chef: VectorAsset? = null
