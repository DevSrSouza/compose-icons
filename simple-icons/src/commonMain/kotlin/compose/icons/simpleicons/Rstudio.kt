...
public val SimpleIcons.Rstudio: VectorAsset
    get() {
        if (_rstudio != null) {
            return _rstudio!!
        }
        _rstudio = VectorAssetBuilder(name = "Rstudio", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rstudio: VectorAsset? = null
