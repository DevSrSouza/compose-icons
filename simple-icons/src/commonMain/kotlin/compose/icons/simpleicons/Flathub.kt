...
public val SimpleIcons.Flathub: VectorAsset
    get() {
        if (_flathub != null) {
            return _flathub!!
        }
        _flathub = VectorAssetBuilder(name = "Flathub", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flathub: VectorAsset? = null
