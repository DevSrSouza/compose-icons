...
public val SimpleIcons.Nginx: VectorAsset
    get() {
        if (_nginx != null) {
            return _nginx!!
        }
        _nginx = VectorAssetBuilder(name = "Nginx", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _nginx: VectorAsset? = null
