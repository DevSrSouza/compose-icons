...
public val SimpleIcons.Sega: VectorAsset
    get() {
        if (_sega != null) {
            return _sega!!
        }
        _sega = VectorAssetBuilder(name = "Sega", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sega: VectorAsset? = null
