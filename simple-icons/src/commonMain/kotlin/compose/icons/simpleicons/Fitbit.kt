...
public val SimpleIcons.Fitbit: VectorAsset
    get() {
        if (_fitbit != null) {
            return _fitbit!!
        }
        _fitbit = VectorAssetBuilder(name = "Fitbit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fitbit: VectorAsset? = null
