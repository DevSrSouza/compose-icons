...
public val SimpleIcons.TokyoMetro: VectorAsset
    get() {
        if (_tokyoMetro != null) {
            return _tokyoMetro!!
        }
        _tokyoMetro = VectorAssetBuilder(name = "TokyoMetro", defaultWidth = 24.0.dp, defaultHeight
...
private var _tokyoMetro: VectorAsset? = null
