...
public val SimpleIcons.DigiKeyElectronics: VectorAsset
    get() {
        if (_digiKeyElectronics != null) {
            return _digiKeyElectronics!!
        }
        _digiKeyElectronics = VectorAssetBuilder(name = "DigiKeyElectronics", defaultWidth =
...
private var _digiKeyElectronics: VectorAsset? = null
