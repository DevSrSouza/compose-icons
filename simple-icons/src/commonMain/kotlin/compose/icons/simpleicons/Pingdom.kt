...
public val SimpleIcons.Pingdom: VectorAsset
    get() {
        if (_pingdom != null) {
            return _pingdom!!
        }
        _pingdom = VectorAssetBuilder(name = "Pingdom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pingdom: VectorAsset? = null
