...
public val SimpleIcons.Zigbee: VectorAsset
    get() {
        if (_zigbee != null) {
            return _zigbee!!
        }
        _zigbee = VectorAssetBuilder(name = "Zigbee", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zigbee: VectorAsset? = null
