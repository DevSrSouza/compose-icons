...
public val SimpleIcons.Blogger: VectorAsset
    get() {
        if (_blogger != null) {
            return _blogger!!
        }
        _blogger = VectorAssetBuilder(name = "Blogger", defaultWidth = 24.0.dp, defaultHeight =
...
private var _blogger: VectorAsset? = null
