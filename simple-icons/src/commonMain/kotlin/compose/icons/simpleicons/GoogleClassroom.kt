...
public val SimpleIcons.GoogleClassroom: VectorAsset
    get() {
        if (_googleClassroom != null) {
            return _googleClassroom!!
        }
        _googleClassroom = VectorAssetBuilder(name = "GoogleClassroom", defaultWidth = 24.0.dp,
...
private var _googleClassroom: VectorAsset? = null
