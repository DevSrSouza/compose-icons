...
public val SimpleIcons.FontAwesome: VectorAsset
    get() {
        if (_fontAwesome != null) {
            return _fontAwesome!!
        }
        _fontAwesome = VectorAssetBuilder(name = "FontAwesome", defaultWidth = 24.0.dp,
...
private var _fontAwesome: VectorAsset? = null
