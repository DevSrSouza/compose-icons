...
public val SimpleIcons.Gerrit: VectorAsset
    get() {
        if (_gerrit != null) {
            return _gerrit!!
        }
        _gerrit = VectorAssetBuilder(name = "Gerrit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gerrit: VectorAsset? = null
