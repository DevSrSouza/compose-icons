...
public val SimpleIcons.PocketCasts: VectorAsset
    get() {
        if (_pocketCasts != null) {
            return _pocketCasts!!
        }
        _pocketCasts = VectorAssetBuilder(name = "PocketCasts", defaultWidth = 24.0.dp,
...
private var _pocketCasts: VectorAsset? = null
