...
public val SimpleIcons.Directus: VectorAsset
    get() {
        if (_directus != null) {
            return _directus!!
        }
        _directus = VectorAssetBuilder(name = "Directus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _directus: VectorAsset? = null
