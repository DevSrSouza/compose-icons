...
public val SimpleIcons.Pinterest: VectorAsset
    get() {
        if (_pinterest != null) {
            return _pinterest!!
        }
        _pinterest = VectorAssetBuilder(name = "Pinterest", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pinterest: VectorAsset? = null
