...
public val SimpleIcons.Sparkpost: VectorAsset
    get() {
        if (_sparkpost != null) {
            return _sparkpost!!
        }
        _sparkpost = VectorAssetBuilder(name = "Sparkpost", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sparkpost: VectorAsset? = null
