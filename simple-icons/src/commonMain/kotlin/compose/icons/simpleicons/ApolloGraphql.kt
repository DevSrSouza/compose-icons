...
public val SimpleIcons.ApolloGraphql: VectorAsset
    get() {
        if (_apolloGraphql != null) {
            return _apolloGraphql!!
        }
        _apolloGraphql = VectorAssetBuilder(name = "ApolloGraphql", defaultWidth = 24.0.dp,
...
private var _apolloGraphql: VectorAsset? = null
