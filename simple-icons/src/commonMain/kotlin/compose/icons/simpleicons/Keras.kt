...
public val SimpleIcons.Keras: VectorAsset
    get() {
        if (_keras != null) {
            return _keras!!
        }
        _keras = VectorAssetBuilder(name = "Keras", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _keras: VectorAsset? = null
