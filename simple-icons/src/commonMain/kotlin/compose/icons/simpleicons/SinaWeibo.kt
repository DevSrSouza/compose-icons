...
public val SimpleIcons.SinaWeibo: VectorAsset
    get() {
        if (_sinaWeibo != null) {
            return _sinaWeibo!!
        }
        _sinaWeibo = VectorAssetBuilder(name = "SinaWeibo", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.059f, 11.649f)
                curveToRelative(-0.346f, -0.105f, -0.57f, -0.18f, -0.405f, -0.615f)
                curveToRelative(0.375f, -0.977f, 0.42f, -1.804f, 0.0f, -2.404f)
                curveToRelative(-0.781f, -1.112f, -2.915f, -1.053f, -5.364f, -0.03f)
                curveToRelative(0.0f, 0.0f, -0.766f, 0.331f, -0.571f, -0.271f)
                curveToRelative(0.376f, -1.217f, 0.315f, -2.224f, -0.27f, -2.809f)
                curveToRelative(-1.338f, -1.337f, -4.869f, 0.045f, -7.888f, 3.08f)
                curveTo(1.309f, 10.87f, 0.0f, 13.273f, 0.0f, 15.348f)
                curveToRelative(0.0f, 3.981f, 5.099f, 6.395f, 10.086f, 6.395f)
                curveToRelative(6.536f, 0.0f, 10.888f, -3.801f, 10.888f, -6.82f)
                curveToRelative(0.0f, -1.822f, -1.547f, -2.854f, -2.915f, -3.284f)
                verticalLineToRelative(0.01f)
                close()
                moveTo(19.967f, 6.557f)
...
private var _sinaWeibo: VectorAsset? = null
