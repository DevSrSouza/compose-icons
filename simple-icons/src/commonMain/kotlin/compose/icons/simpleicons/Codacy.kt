...
public val SimpleIcons.Codacy: VectorAsset
    get() {
        if (_codacy != null) {
            return _codacy!!
        }
        _codacy = VectorAssetBuilder(name = "Codacy", defaultWidth = 24.0.dp, defaultHeight =
...
private var _codacy: VectorAsset? = null
