...
public val SimpleIcons.Ifixit: VectorAsset
    get() {
        if (_ifixit != null) {
            return _ifixit!!
        }
        _ifixit = VectorAssetBuilder(name = "Ifixit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ifixit: VectorAsset? = null
