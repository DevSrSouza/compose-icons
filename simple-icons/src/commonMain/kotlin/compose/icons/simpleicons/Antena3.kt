...
public val SimpleIcons.Antena3: VectorAsset
    get() {
        if (_antena3 != null) {
            return _antena3!!
        }
        _antena3 = VectorAssetBuilder(name = "Antena3", defaultWidth = 24.0.dp, defaultHeight =
...
private var _antena3: VectorAsset? = null
