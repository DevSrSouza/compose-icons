...
public val SimpleIcons.Powers: VectorAsset
    get() {
        if (_powers != null) {
            return _powers!!
        }
        _powers = VectorAssetBuilder(name = "Powers", defaultWidth = 24.0.dp, defaultHeight =
...
private var _powers: VectorAsset? = null
