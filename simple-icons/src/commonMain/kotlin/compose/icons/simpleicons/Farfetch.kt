...
public val SimpleIcons.Farfetch: VectorAsset
    get() {
        if (_farfetch != null) {
            return _farfetch!!
        }
        _farfetch = VectorAssetBuilder(name = "Farfetch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _farfetch: VectorAsset? = null
