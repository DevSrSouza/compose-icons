...
public val SimpleIcons.Aircall: VectorAsset
    get() {
        if (_aircall != null) {
            return _aircall!!
        }
        _aircall = VectorAssetBuilder(name = "Aircall", defaultWidth = 24.0.dp, defaultHeight =
...
private var _aircall: VectorAsset? = null
