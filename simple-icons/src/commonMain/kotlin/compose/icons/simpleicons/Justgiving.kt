...
public val SimpleIcons.Justgiving: VectorAsset
    get() {
        if (_justgiving != null) {
            return _justgiving!!
        }
        _justgiving = VectorAssetBuilder(name = "Justgiving", defaultWidth = 24.0.dp, defaultHeight
...
private var _justgiving: VectorAsset? = null
