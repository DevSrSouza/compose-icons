...
public val SimpleIcons.AdobeLightroom: VectorAsset
    get() {
        if (_adobeLightroom != null) {
            return _adobeLightroom!!
        }
        _adobeLightroom = VectorAssetBuilder(name = "AdobeLightroom", defaultWidth = 24.0.dp,
...
private var _adobeLightroom: VectorAsset? = null
