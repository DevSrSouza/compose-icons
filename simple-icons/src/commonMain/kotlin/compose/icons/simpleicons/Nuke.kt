...
public val SimpleIcons.Nuke: VectorAsset
    get() {
        if (_nuke != null) {
            return _nuke!!
        }
        _nuke = VectorAssetBuilder(name = "Nuke", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _nuke: VectorAsset? = null
