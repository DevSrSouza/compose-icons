...
public val SimpleIcons.Staffbase: VectorAsset
    get() {
        if (_staffbase != null) {
            return _staffbase!!
        }
        _staffbase = VectorAssetBuilder(name = "Staffbase", defaultWidth = 24.0.dp, defaultHeight =
...
private var _staffbase: VectorAsset? = null
