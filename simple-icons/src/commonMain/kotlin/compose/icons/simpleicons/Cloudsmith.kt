...
public val SimpleIcons.Cloudsmith: VectorAsset
    get() {
        if (_cloudsmith != null) {
            return _cloudsmith!!
        }
        _cloudsmith = VectorAssetBuilder(name = "Cloudsmith", defaultWidth = 24.0.dp, defaultHeight
...
private var _cloudsmith: VectorAsset? = null
