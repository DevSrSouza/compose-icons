...
public val SimpleIcons.Gitbook: VectorAsset
    get() {
        if (_gitbook != null) {
            return _gitbook!!
        }
        _gitbook = VectorAssetBuilder(name = "Gitbook", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gitbook: VectorAsset? = null
