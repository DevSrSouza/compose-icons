...
public val SimpleIcons.Jupyter: VectorAsset
    get() {
        if (_jupyter != null) {
            return _jupyter!!
        }
        _jupyter = VectorAssetBuilder(name = "Jupyter", defaultWidth = 24.0.dp, defaultHeight =
...
private var _jupyter: VectorAsset? = null
