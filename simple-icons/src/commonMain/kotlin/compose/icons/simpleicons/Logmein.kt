...
public val SimpleIcons.Logmein: VectorAsset
    get() {
        if (_logmein != null) {
            return _logmein!!
        }
        _logmein = VectorAssetBuilder(name = "Logmein", defaultWidth = 24.0.dp, defaultHeight =
...
private var _logmein: VectorAsset? = null
