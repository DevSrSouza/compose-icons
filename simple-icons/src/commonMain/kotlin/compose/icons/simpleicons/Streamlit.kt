...
public val SimpleIcons.Streamlit: VectorAsset
    get() {
        if (_streamlit != null) {
            return _streamlit!!
        }
        _streamlit = VectorAssetBuilder(name = "Streamlit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _streamlit: VectorAsset? = null
