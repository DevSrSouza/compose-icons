...
public val SimpleIcons.CreativeCommons: VectorAsset
    get() {
        if (_creativeCommons != null) {
            return _creativeCommons!!
        }
        _creativeCommons = VectorAssetBuilder(name = "CreativeCommons", defaultWidth = 24.0.dp,
...
private var _creativeCommons: VectorAsset? = null
