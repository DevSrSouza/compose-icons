...
public val SimpleIcons.Sonarcloud: VectorAsset
    get() {
        if (_sonarcloud != null) {
            return _sonarcloud!!
        }
        _sonarcloud = VectorAssetBuilder(name = "Sonarcloud", defaultWidth = 24.0.dp, defaultHeight
...
private var _sonarcloud: VectorAsset? = null
