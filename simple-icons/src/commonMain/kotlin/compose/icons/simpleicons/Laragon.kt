...
public val SimpleIcons.Laragon: VectorAsset
    get() {
        if (_laragon != null) {
            return _laragon!!
        }
        _laragon = VectorAssetBuilder(name = "Laragon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _laragon: VectorAsset? = null
