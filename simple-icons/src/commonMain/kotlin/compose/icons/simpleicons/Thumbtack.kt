...
public val SimpleIcons.Thumbtack: VectorAsset
    get() {
        if (_thumbtack != null) {
            return _thumbtack!!
        }
        _thumbtack = VectorAssetBuilder(name = "Thumbtack", defaultWidth = 24.0.dp, defaultHeight =
...
private var _thumbtack: VectorAsset? = null
