...
public val SimpleIcons.Fila: VectorAsset
    get() {
        if (_fila != null) {
            return _fila!!
        }
        _fila = VectorAssetBuilder(name = "Fila", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fila: VectorAsset? = null
