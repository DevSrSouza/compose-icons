...
public val SimpleIcons.TransportForIreland: VectorAsset
    get() {
        if (_transportForIreland != null) {
            return _transportForIreland!!
        }
        _transportForIreland = VectorAssetBuilder(name = "TransportForIreland", defaultWidth =
...
private var _transportForIreland: VectorAsset? = null
