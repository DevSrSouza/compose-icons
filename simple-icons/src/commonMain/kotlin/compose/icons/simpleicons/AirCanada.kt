...
public val SimpleIcons.AirCanada: VectorAsset
    get() {
        if (_airCanada != null) {
            return _airCanada!!
        }
        _airCanada = VectorAssetBuilder(name = "AirCanada", defaultWidth = 24.0.dp, defaultHeight =
...
private var _airCanada: VectorAsset? = null
