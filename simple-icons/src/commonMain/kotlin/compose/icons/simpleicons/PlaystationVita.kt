...
public val SimpleIcons.PlaystationVita: VectorAsset
    get() {
        if (_playstationVita != null) {
            return _playstationVita!!
        }
        _playstationVita = VectorAssetBuilder(name = "PlaystationVita", defaultWidth = 24.0.dp,
...
private var _playstationVita: VectorAsset? = null
