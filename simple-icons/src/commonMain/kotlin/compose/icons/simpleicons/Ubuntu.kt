...
public val SimpleIcons.Ubuntu: VectorAsset
    get() {
        if (_ubuntu != null) {
            return _ubuntu!!
        }
        _ubuntu = VectorAssetBuilder(name = "Ubuntu", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ubuntu: VectorAsset? = null
