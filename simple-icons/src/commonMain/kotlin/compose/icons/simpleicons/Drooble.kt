...
public val SimpleIcons.Drooble: VectorAsset
    get() {
        if (_drooble != null) {
            return _drooble!!
        }
        _drooble = VectorAssetBuilder(name = "Drooble", defaultWidth = 24.0.dp, defaultHeight =
...
private var _drooble: VectorAsset? = null
