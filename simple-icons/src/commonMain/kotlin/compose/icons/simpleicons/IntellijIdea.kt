...
public val SimpleIcons.IntellijIdea: VectorAsset
    get() {
        if (_intellijIdea != null) {
            return _intellijIdea!!
        }
        _intellijIdea = VectorAssetBuilder(name = "IntellijIdea", defaultWidth = 24.0.dp,
...
private var _intellijIdea: VectorAsset? = null
