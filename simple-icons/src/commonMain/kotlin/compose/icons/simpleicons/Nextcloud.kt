...
public val SimpleIcons.Nextcloud: VectorAsset
    get() {
        if (_nextcloud != null) {
            return _nextcloud!!
        }
        _nextcloud = VectorAssetBuilder(name = "Nextcloud", defaultWidth = 24.0.dp, defaultHeight =
...
private var _nextcloud: VectorAsset? = null
