...
public val SimpleIcons.Appveyor: VectorAsset
    get() {
        if (_appveyor != null) {
            return _appveyor!!
        }
        _appveyor = VectorAssetBuilder(name = "Appveyor", defaultWidth = 24.0.dp, defaultHeight =
...
private var _appveyor: VectorAsset? = null
