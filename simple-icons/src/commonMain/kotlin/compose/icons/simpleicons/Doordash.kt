...
public val SimpleIcons.Doordash: VectorAsset
    get() {
        if (_doordash != null) {
            return _doordash!!
        }
        _doordash = VectorAssetBuilder(name = "Doordash", defaultWidth = 24.0.dp, defaultHeight =
...
private var _doordash: VectorAsset? = null
