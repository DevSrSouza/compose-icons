...
public val SimpleIcons.Scopus: VectorAsset
    get() {
        if (_scopus != null) {
            return _scopus!!
        }
        _scopus = VectorAssetBuilder(name = "Scopus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _scopus: VectorAsset? = null
