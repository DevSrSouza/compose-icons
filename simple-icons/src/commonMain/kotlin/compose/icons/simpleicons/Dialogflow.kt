...
public val SimpleIcons.Dialogflow: VectorAsset
    get() {
        if (_dialogflow != null) {
            return _dialogflow!!
        }
        _dialogflow = VectorAssetBuilder(name = "Dialogflow", defaultWidth = 24.0.dp, defaultHeight
...
private var _dialogflow: VectorAsset? = null
