...
public val SimpleIcons.Disqus: VectorAsset
    get() {
        if (_disqus != null) {
            return _disqus!!
        }
        _disqus = VectorAssetBuilder(name = "Disqus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _disqus: VectorAsset? = null
