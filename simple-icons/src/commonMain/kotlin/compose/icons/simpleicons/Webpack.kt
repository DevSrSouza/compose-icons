...
public val SimpleIcons.Webpack: VectorAsset
    get() {
        if (_webpack != null) {
            return _webpack!!
        }
        _webpack = VectorAssetBuilder(name = "Webpack", defaultWidth = 24.0.dp, defaultHeight =
...
private var _webpack: VectorAsset? = null
