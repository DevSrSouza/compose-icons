...
public val SimpleIcons.Treyarch: VectorAsset
    get() {
        if (_treyarch != null) {
            return _treyarch!!
        }
        _treyarch = VectorAssetBuilder(name = "Treyarch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _treyarch: VectorAsset? = null
