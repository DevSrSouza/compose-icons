...
public val SimpleIcons.Cakephp: VectorAsset
    get() {
        if (_cakephp != null) {
            return _cakephp!!
        }
        _cakephp = VectorAssetBuilder(name = "Cakephp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cakephp: VectorAsset? = null
