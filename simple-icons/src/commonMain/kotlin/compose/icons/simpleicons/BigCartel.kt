...
public val SimpleIcons.BigCartel: VectorAsset
    get() {
        if (_bigCartel != null) {
            return _bigCartel!!
        }
        _bigCartel = VectorAssetBuilder(name = "BigCartel", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bigCartel: VectorAsset? = null
