...
public val SimpleIcons.PowerBi: VectorAsset
    get() {
        if (_powerBi != null) {
            return _powerBi!!
        }
        _powerBi = VectorAssetBuilder(name = "PowerBi", defaultWidth = 24.0.dp, defaultHeight =
...
private var _powerBi: VectorAsset? = null
