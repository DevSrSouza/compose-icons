...
public val SimpleIcons.Steamdb: VectorAsset
    get() {
        if (_steamdb != null) {
            return _steamdb!!
        }
        _steamdb = VectorAssetBuilder(name = "Steamdb", defaultWidth = 24.0.dp, defaultHeight =
...
private var _steamdb: VectorAsset? = null
