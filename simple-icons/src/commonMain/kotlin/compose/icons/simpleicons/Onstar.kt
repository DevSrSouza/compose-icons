...
public val SimpleIcons.Onstar: VectorAsset
    get() {
        if (_onstar != null) {
            return _onstar!!
        }
        _onstar = VectorAssetBuilder(name = "Onstar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _onstar: VectorAsset? = null
