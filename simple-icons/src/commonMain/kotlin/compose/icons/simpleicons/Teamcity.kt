...
public val SimpleIcons.Teamcity: VectorAsset
    get() {
        if (_teamcity != null) {
            return _teamcity!!
        }
        _teamcity = VectorAssetBuilder(name = "Teamcity", defaultWidth = 24.0.dp, defaultHeight =
...
private var _teamcity: VectorAsset? = null
