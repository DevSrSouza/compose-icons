...
public val SimpleIcons.Wordpress: VectorAsset
    get() {
        if (_wordpress != null) {
            return _wordpress!!
        }
        _wordpress = VectorAssetBuilder(name = "Wordpress", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wordpress: VectorAsset? = null
