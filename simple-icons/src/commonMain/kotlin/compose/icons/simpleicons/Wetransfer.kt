...
public val SimpleIcons.Wetransfer: VectorAsset
    get() {
        if (_wetransfer != null) {
            return _wetransfer!!
        }
        _wetransfer = VectorAssetBuilder(name = "Wetransfer", defaultWidth = 24.0.dp, defaultHeight
...
private var _wetransfer: VectorAsset? = null
