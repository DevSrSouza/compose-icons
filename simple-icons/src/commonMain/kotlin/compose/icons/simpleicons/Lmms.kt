...
public val SimpleIcons.Lmms: VectorAsset
    get() {
        if (_lmms != null) {
            return _lmms!!
        }
        _lmms = VectorAssetBuilder(name = "Lmms", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _lmms: VectorAsset? = null
