...
public val SimpleIcons.Yammer: VectorAsset
    get() {
        if (_yammer != null) {
            return _yammer!!
        }
        _yammer = VectorAssetBuilder(name = "Yammer", defaultWidth = 24.0.dp, defaultHeight =
...
private var _yammer: VectorAsset? = null
