...
public val SimpleIcons.Python: VectorAsset
    get() {
        if (_python != null) {
            return _python!!
        }
        _python = VectorAssetBuilder(name = "Python", defaultWidth = 24.0.dp, defaultHeight =
...
private var _python: VectorAsset? = null
