...
public val SimpleIcons.Openai: VectorAsset
    get() {
        if (_openai != null) {
            return _openai!!
        }
        _openai = VectorAssetBuilder(name = "Openai", defaultWidth = 24.0.dp, defaultHeight =
...
private var _openai: VectorAsset? = null
