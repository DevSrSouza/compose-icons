...
public val SimpleIcons.Convertio: VectorAsset
    get() {
        if (_convertio != null) {
            return _convertio!!
        }
        _convertio = VectorAssetBuilder(name = "Convertio", defaultWidth = 24.0.dp, defaultHeight =
...
private var _convertio: VectorAsset? = null
