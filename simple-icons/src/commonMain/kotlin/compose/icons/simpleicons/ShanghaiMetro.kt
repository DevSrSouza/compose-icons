...
public val SimpleIcons.ShanghaiMetro: VectorAsset
    get() {
        if (_shanghaiMetro != null) {
            return _shanghaiMetro!!
        }
        _shanghaiMetro = VectorAssetBuilder(name = "ShanghaiMetro", defaultWidth = 24.0.dp,
...
private var _shanghaiMetro: VectorAsset? = null
