...
public val SimpleIcons.Truenas: VectorAsset
    get() {
        if (_truenas != null) {
            return _truenas!!
        }
        _truenas = VectorAssetBuilder(name = "Truenas", defaultWidth = 24.0.dp, defaultHeight =
...
private var _truenas: VectorAsset? = null
