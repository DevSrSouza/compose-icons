...
public val SimpleIcons.Gitee: VectorAsset
    get() {
        if (_gitee != null) {
            return _gitee!!
        }
        _gitee = VectorAssetBuilder(name = "Gitee", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _gitee: VectorAsset? = null
