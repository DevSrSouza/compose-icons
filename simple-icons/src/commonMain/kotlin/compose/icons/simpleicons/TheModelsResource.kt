...
public val SimpleIcons.TheModelsResource: VectorAsset
    get() {
        if (_theModelsResource != null) {
            return _theModelsResource!!
        }
        _theModelsResource = VectorAssetBuilder(name = "TheModelsResource", defaultWidth = 24.0.dp,
...
private var _theModelsResource: VectorAsset? = null
