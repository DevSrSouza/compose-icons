...
public val SimpleIcons.Midi: VectorAsset
    get() {
        if (_midi != null) {
            return _midi!!
        }
        _midi = VectorAssetBuilder(name = "Midi", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _midi: VectorAsset? = null
