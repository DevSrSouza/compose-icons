...
public val SimpleIcons.Hubspot: VectorAsset
    get() {
        if (_hubspot != null) {
            return _hubspot!!
        }
        _hubspot = VectorAssetBuilder(name = "Hubspot", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hubspot: VectorAsset? = null
