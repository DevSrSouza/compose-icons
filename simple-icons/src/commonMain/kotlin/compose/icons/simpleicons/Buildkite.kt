...
public val SimpleIcons.Buildkite: VectorAsset
    get() {
        if (_buildkite != null) {
            return _buildkite!!
        }
        _buildkite = VectorAssetBuilder(name = "Buildkite", defaultWidth = 24.0.dp, defaultHeight =
...
private var _buildkite: VectorAsset? = null
