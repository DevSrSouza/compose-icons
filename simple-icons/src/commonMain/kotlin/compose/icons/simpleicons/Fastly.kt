...
public val SimpleIcons.Fastly: VectorAsset
    get() {
        if (_fastly != null) {
            return _fastly!!
        }
        _fastly = VectorAssetBuilder(name = "Fastly", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fastly: VectorAsset? = null
