...
public val SimpleIcons.Venmo: VectorAsset
    get() {
        if (_venmo != null) {
            return _venmo!!
        }
        _venmo = VectorAssetBuilder(name = "Venmo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _venmo: VectorAsset? = null
