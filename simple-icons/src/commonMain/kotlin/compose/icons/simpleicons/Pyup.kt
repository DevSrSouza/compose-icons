...
public val SimpleIcons.Pyup: VectorAsset
    get() {
        if (_pyup != null) {
            return _pyup!!
        }
        _pyup = VectorAssetBuilder(name = "Pyup", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _pyup: VectorAsset? = null
