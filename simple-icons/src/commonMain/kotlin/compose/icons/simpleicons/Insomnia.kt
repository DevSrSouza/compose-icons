...
public val SimpleIcons.Insomnia: VectorAsset
    get() {
        if (_insomnia != null) {
            return _insomnia!!
        }
        _insomnia = VectorAssetBuilder(name = "Insomnia", defaultWidth = 24.0.dp, defaultHeight =
...
private var _insomnia: VectorAsset? = null
