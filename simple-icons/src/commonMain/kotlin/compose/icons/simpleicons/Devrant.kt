...
public val SimpleIcons.Devrant: VectorAsset
    get() {
        if (_devrant != null) {
            return _devrant!!
        }
        _devrant = VectorAssetBuilder(name = "Devrant", defaultWidth = 24.0.dp, defaultHeight =
...
private var _devrant: VectorAsset? = null
