...
public val SimpleIcons.Shazam: VectorAsset
    get() {
        if (_shazam != null) {
            return _shazam!!
        }
        _shazam = VectorAssetBuilder(name = "Shazam", defaultWidth = 24.0.dp, defaultHeight =
...
private var _shazam: VectorAsset? = null
