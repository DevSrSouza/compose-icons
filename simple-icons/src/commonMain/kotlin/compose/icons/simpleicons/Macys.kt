...
public val SimpleIcons.Macys: VectorAsset
    get() {
        if (_macys != null) {
            return _macys!!
        }
        _macys = VectorAssetBuilder(name = "Macys", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _macys: VectorAsset? = null
