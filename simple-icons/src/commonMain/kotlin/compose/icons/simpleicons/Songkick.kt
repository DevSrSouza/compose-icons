...
public val SimpleIcons.Songkick: VectorAsset
    get() {
        if (_songkick != null) {
            return _songkick!!
        }
        _songkick = VectorAssetBuilder(name = "Songkick", defaultWidth = 24.0.dp, defaultHeight =
...
private var _songkick: VectorAsset? = null
