...
public val SimpleIcons.AppleTv: VectorAsset
    get() {
        if (_appleTv != null) {
            return _appleTv!!
        }
        _appleTv = VectorAssetBuilder(name = "AppleTv", defaultWidth = 24.0.dp, defaultHeight =
...
private var _appleTv: VectorAsset? = null
