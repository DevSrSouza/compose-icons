...
public val SimpleIcons.GoogleColab: VectorAsset
    get() {
        if (_googleColab != null) {
            return _googleColab!!
        }
        _googleColab = VectorAssetBuilder(name = "GoogleColab", defaultWidth = 24.0.dp,
...
private var _googleColab: VectorAsset? = null
