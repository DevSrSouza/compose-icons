...
public val SimpleIcons.MicrosoftAzure: VectorAsset
    get() {
        if (_microsoftAzure != null) {
            return _microsoftAzure!!
        }
        _microsoftAzure = VectorAssetBuilder(name = "MicrosoftAzure", defaultWidth = 24.0.dp,
...
private var _microsoftAzure: VectorAsset? = null
