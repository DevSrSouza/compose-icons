...
public val SimpleIcons.JfrogBintray: ImageVector
    get() {
        if (_jfrogBintray != null) {
            return _jfrogBintray!!
        }
        _jfrogBintray = Builder(name = "JfrogBintray", defaultWidth = 24.0.dp, defaultHeight =
...
private var _jfrogBintray: ImageVector? = null
