...
public val SimpleIcons.Broadcom: VectorAsset
    get() {
        if (_broadcom != null) {
            return _broadcom!!
        }
        _broadcom = VectorAssetBuilder(name = "Broadcom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _broadcom: VectorAsset? = null
