...
public val SimpleIcons.Homebridge: VectorAsset
    get() {
        if (_homebridge != null) {
            return _homebridge!!
        }
        _homebridge = VectorAssetBuilder(name = "Homebridge", defaultWidth = 24.0.dp, defaultHeight
...
private var _homebridge: VectorAsset? = null
