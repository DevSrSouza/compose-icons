...
public val SimpleIcons.GnuEmacs: VectorAsset
    get() {
        if (_gnuEmacs != null) {
            return _gnuEmacs!!
        }
        _gnuEmacs = VectorAssetBuilder(name = "GnuEmacs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gnuEmacs: VectorAsset? = null
