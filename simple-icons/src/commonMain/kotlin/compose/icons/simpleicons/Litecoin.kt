...
public val SimpleIcons.Litecoin: VectorAsset
    get() {
        if (_litecoin != null) {
            return _litecoin!!
        }
        _litecoin = VectorAssetBuilder(name = "Litecoin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _litecoin: VectorAsset? = null
