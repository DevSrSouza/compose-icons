...
public val SimpleIcons.Qantas: VectorAsset
    get() {
        if (_qantas != null) {
            return _qantas!!
        }
        _qantas = VectorAssetBuilder(name = "Qantas", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qantas: VectorAsset? = null
