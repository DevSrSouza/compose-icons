...
public val SimpleIcons.WhenIWork: VectorAsset
    get() {
        if (_whenIWork != null) {
            return _whenIWork!!
        }
        _whenIWork = VectorAssetBuilder(name = "WhenIWork", defaultWidth = 24.0.dp, defaultHeight =
...
private var _whenIWork: VectorAsset? = null
