...
public val SimpleIcons.QubesOs: VectorAsset
    get() {
        if (_qubesOs != null) {
            return _qubesOs!!
        }
        _qubesOs = VectorAssetBuilder(name = "QubesOs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qubesOs: VectorAsset? = null
