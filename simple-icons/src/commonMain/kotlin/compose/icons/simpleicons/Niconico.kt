...
public val SimpleIcons.Niconico: VectorAsset
    get() {
        if (_niconico != null) {
            return _niconico!!
        }
        _niconico = VectorAssetBuilder(name = "Niconico", defaultWidth = 24.0.dp, defaultHeight =
...
private var _niconico: VectorAsset? = null
