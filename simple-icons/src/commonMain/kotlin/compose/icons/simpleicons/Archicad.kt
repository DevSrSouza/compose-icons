...
public val SimpleIcons.Archicad: VectorAsset
    get() {
        if (_archicad != null) {
            return _archicad!!
        }
        _archicad = VectorAssetBuilder(name = "Archicad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _archicad: VectorAsset? = null
