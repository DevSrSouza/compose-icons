...
public val SimpleIcons.SkypeForBusiness: VectorAsset
    get() {
        if (_skypeForBusiness != null) {
            return _skypeForBusiness!!
        }
        _skypeForBusiness = VectorAssetBuilder(name = "SkypeForBusiness", defaultWidth = 24.0.dp,
...
private var _skypeForBusiness: VectorAsset? = null
