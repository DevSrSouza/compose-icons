...
public val SimpleIcons.Livejournal: VectorAsset
    get() {
        if (_livejournal != null) {
            return _livejournal!!
        }
        _livejournal = VectorAssetBuilder(name = "Livejournal", defaultWidth = 24.0.dp,
...
private var _livejournal: VectorAsset? = null
