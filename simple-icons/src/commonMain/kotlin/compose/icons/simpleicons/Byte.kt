...
public val SimpleIcons.Byte: VectorAsset
    get() {
        if (_byte != null) {
            return _byte!!
        }
        _byte = VectorAssetBuilder(name = "Byte", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _byte: VectorAsset? = null
