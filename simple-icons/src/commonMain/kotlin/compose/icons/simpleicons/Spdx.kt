...
public val SimpleIcons.Spdx: VectorAsset
    get() {
        if (_spdx != null) {
            return _spdx!!
        }
        _spdx = VectorAssetBuilder(name = "Spdx", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _spdx: VectorAsset? = null
