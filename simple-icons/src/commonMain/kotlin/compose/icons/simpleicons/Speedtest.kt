...
public val SimpleIcons.Speedtest: VectorAsset
    get() {
        if (_speedtest != null) {
            return _speedtest!!
        }
        _speedtest = VectorAssetBuilder(name = "Speedtest", defaultWidth = 24.0.dp, defaultHeight =
...
private var _speedtest: VectorAsset? = null
