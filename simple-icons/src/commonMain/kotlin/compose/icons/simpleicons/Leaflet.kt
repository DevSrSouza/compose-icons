...
public val SimpleIcons.Leaflet: VectorAsset
    get() {
        if (_leaflet != null) {
            return _leaflet!!
        }
        _leaflet = VectorAssetBuilder(name = "Leaflet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _leaflet: VectorAsset? = null
