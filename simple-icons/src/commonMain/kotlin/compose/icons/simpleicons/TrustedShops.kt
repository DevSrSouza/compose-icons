...
public val SimpleIcons.TrustedShops: VectorAsset
    get() {
        if (_trustedShops != null) {
            return _trustedShops!!
        }
        _trustedShops = VectorAssetBuilder(name = "TrustedShops", defaultWidth = 24.0.dp,
...
private var _trustedShops: VectorAsset? = null
