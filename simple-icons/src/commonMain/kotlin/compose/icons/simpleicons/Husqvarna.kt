...
public val SimpleIcons.Husqvarna: VectorAsset
    get() {
        if (_husqvarna != null) {
            return _husqvarna!!
        }
        _husqvarna = VectorAssetBuilder(name = "Husqvarna", defaultWidth = 24.0.dp, defaultHeight =
...
private var _husqvarna: VectorAsset? = null
