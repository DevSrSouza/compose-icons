...
public val SimpleIcons.Instapaper: VectorAsset
    get() {
        if (_instapaper != null) {
            return _instapaper!!
        }
        _instapaper = VectorAssetBuilder(name = "Instapaper", defaultWidth = 24.0.dp, defaultHeight
...
private var _instapaper: VectorAsset? = null
