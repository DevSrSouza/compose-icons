...
public val SimpleIcons.Xing: VectorAsset
    get() {
        if (_xing != null) {
            return _xing!!
        }
        _xing = VectorAssetBuilder(name = "Xing", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _xing: VectorAsset? = null
