...
public val SimpleIcons.Mapbox: VectorAsset
    get() {
        if (_mapbox != null) {
            return _mapbox!!
        }
        _mapbox = VectorAssetBuilder(name = "Mapbox", defaultWidth = 24.0.dp, defaultHeight =
...
private var _mapbox: VectorAsset? = null
