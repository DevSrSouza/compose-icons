...
public val SimpleIcons.GoogleCloud: VectorAsset
    get() {
        if (_googleCloud != null) {
            return _googleCloud!!
        }
        _googleCloud = VectorAssetBuilder(name = "GoogleCloud", defaultWidth = 24.0.dp,
...
private var _googleCloud: VectorAsset? = null
