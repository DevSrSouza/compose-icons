...
public val SimpleIcons.Jeep: VectorAsset
    get() {
        if (_jeep != null) {
            return _jeep!!
        }
        _jeep = VectorAssetBuilder(name = "Jeep", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _jeep: VectorAsset? = null
