...
public val SimpleIcons.Coursera: VectorAsset
    get() {
        if (_coursera != null) {
            return _coursera!!
        }
        _coursera = VectorAssetBuilder(name = "Coursera", defaultWidth = 24.0.dp, defaultHeight =
...
private var _coursera: VectorAsset? = null
