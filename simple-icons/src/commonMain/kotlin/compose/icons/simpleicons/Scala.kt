...
public val SimpleIcons.Scala: VectorAsset
    get() {
        if (_scala != null) {
            return _scala!!
        }
        _scala = VectorAssetBuilder(name = "Scala", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _scala: VectorAsset? = null
