...
public val SimpleIcons.Bitdefender: VectorAsset
    get() {
        if (_bitdefender != null) {
            return _bitdefender!!
        }
        _bitdefender = VectorAssetBuilder(name = "Bitdefender", defaultWidth = 24.0.dp,
...
private var _bitdefender: VectorAsset? = null
