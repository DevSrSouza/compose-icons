...
public val SimpleIcons.Bitwarden: VectorAsset
    get() {
        if (_bitwarden != null) {
            return _bitwarden!!
        }
        _bitwarden = VectorAssetBuilder(name = "Bitwarden", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bitwarden: VectorAsset? = null
