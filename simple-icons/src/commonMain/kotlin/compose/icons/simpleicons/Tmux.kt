...
public val SimpleIcons.Tmux: VectorAsset
    get() {
        if (_tmux != null) {
            return _tmux!!
        }
        _tmux = VectorAssetBuilder(name = "Tmux", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tmux: VectorAsset? = null
