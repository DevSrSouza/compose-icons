...
public val SimpleIcons.Leanpub: VectorAsset
    get() {
        if (_leanpub != null) {
            return _leanpub!!
        }
        _leanpub = VectorAssetBuilder(name = "Leanpub", defaultWidth = 24.0.dp, defaultHeight =
...
private var _leanpub: VectorAsset? = null
