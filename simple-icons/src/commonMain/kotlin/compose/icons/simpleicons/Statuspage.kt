...
public val SimpleIcons.Statuspage: VectorAsset
    get() {
        if (_statuspage != null) {
            return _statuspage!!
        }
        _statuspage = VectorAssetBuilder(name = "Statuspage", defaultWidth = 24.0.dp, defaultHeight
...
private var _statuspage: VectorAsset? = null
