...
public val SimpleIcons.DiagramsDotNet: VectorAsset
    get() {
        if (_diagramsDotNet != null) {
            return _diagramsDotNet!!
        }
        _diagramsDotNet = VectorAssetBuilder(name = "DiagramsDotNet", defaultWidth = 24.0.dp,
...
private var _diagramsDotNet: VectorAsset? = null
