...
public val SimpleIcons.Anilist: VectorAsset
    get() {
        if (_anilist != null) {
            return _anilist!!
        }
        _anilist = VectorAssetBuilder(name = "Anilist", defaultWidth = 24.0.dp, defaultHeight =
...
private var _anilist: VectorAsset? = null
