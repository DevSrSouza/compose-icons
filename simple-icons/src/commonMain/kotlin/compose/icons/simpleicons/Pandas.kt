...
public val SimpleIcons.Pandas: VectorAsset
    get() {
        if (_pandas != null) {
            return _pandas!!
        }
        _pandas = VectorAssetBuilder(name = "Pandas", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pandas: VectorAsset? = null
