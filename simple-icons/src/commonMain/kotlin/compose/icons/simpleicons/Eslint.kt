...
public val SimpleIcons.Eslint: VectorAsset
    get() {
        if (_eslint != null) {
            return _eslint!!
        }
        _eslint = VectorAssetBuilder(name = "Eslint", defaultWidth = 24.0.dp, defaultHeight =
...
private var _eslint: VectorAsset? = null
