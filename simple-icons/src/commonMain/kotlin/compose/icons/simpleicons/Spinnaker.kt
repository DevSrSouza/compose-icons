...
public val SimpleIcons.Spinnaker: VectorAsset
    get() {
        if (_spinnaker != null) {
            return _spinnaker!!
        }
        _spinnaker = VectorAssetBuilder(name = "Spinnaker", defaultWidth = 24.0.dp, defaultHeight =
...
private var _spinnaker: VectorAsset? = null
