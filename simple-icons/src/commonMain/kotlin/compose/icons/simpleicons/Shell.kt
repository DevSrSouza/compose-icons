...
public val SimpleIcons.Shell: VectorAsset
    get() {
        if (_shell != null) {
            return _shell!!
        }
        _shell = VectorAssetBuilder(name = "Shell", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _shell: VectorAsset? = null
