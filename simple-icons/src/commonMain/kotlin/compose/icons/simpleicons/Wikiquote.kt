...
public val SimpleIcons.Wikiquote: VectorAsset
    get() {
        if (_wikiquote != null) {
            return _wikiquote!!
        }
        _wikiquote = VectorAssetBuilder(name = "Wikiquote", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wikiquote: VectorAsset? = null
