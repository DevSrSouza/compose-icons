...
public val SimpleIcons.Emlakjet: VectorAsset
    get() {
        if (_emlakjet != null) {
            return _emlakjet!!
        }
        _emlakjet = VectorAssetBuilder(name = "Emlakjet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _emlakjet: VectorAsset? = null
