...
public val SimpleIcons.Topcoder: VectorAsset
    get() {
        if (_topcoder != null) {
            return _topcoder!!
        }
        _topcoder = VectorAssetBuilder(name = "Topcoder", defaultWidth = 24.0.dp, defaultHeight =
...
private var _topcoder: VectorAsset? = null
