...
public val SimpleIcons.Picpay: VectorAsset
    get() {
        if (_picpay != null) {
            return _picpay!!
        }
        _picpay = VectorAssetBuilder(name = "Picpay", defaultWidth = 24.0.dp, defaultHeight =
...
private var _picpay: VectorAsset? = null
