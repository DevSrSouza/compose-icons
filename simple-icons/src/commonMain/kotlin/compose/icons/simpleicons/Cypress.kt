...
public val SimpleIcons.Cypress: VectorAsset
    get() {
        if (_cypress != null) {
            return _cypress!!
        }
        _cypress = VectorAssetBuilder(name = "Cypress", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cypress: VectorAsset? = null
