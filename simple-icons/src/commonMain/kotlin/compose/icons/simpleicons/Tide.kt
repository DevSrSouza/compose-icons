...
public val SimpleIcons.Tide: VectorAsset
    get() {
        if (_tide != null) {
            return _tide!!
        }
        _tide = VectorAssetBuilder(name = "Tide", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tide: VectorAsset? = null
