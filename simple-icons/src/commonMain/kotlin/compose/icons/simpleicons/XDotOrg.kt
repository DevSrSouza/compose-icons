...
public val SimpleIcons.XDotOrg: VectorAsset
    get() {
        if (_xDotOrg != null) {
            return _xDotOrg!!
        }
        _xDotOrg = VectorAssetBuilder(name = "XDotOrg", defaultWidth = 24.0.dp, defaultHeight =
...
private var _xDotOrg: VectorAsset? = null
