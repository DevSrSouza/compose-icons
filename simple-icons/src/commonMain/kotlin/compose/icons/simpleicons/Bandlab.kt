...
public val SimpleIcons.Bandlab: VectorAsset
    get() {
        if (_bandlab != null) {
            return _bandlab!!
        }
        _bandlab = VectorAssetBuilder(name = "Bandlab", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bandlab: VectorAsset? = null
