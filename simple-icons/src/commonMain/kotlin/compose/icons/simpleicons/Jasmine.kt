...
public val SimpleIcons.Jasmine: VectorAsset
    get() {
        if (_jasmine != null) {
            return _jasmine!!
        }
        _jasmine = VectorAssetBuilder(name = "Jasmine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _jasmine: VectorAsset? = null
