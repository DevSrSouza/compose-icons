...
public val SimpleIcons.Unicode: VectorAsset
    get() {
        if (_unicode != null) {
            return _unicode!!
        }
        _unicode = VectorAssetBuilder(name = "Unicode", defaultWidth = 24.0.dp, defaultHeight =
...
private var _unicode: VectorAsset? = null
