...
public val SimpleIcons.VisualStudioCode: VectorAsset
    get() {
        if (_visualStudioCode != null) {
            return _visualStudioCode!!
        }
        _visualStudioCode = VectorAssetBuilder(name = "VisualStudioCode", defaultWidth = 24.0.dp,
...
private var _visualStudioCode: VectorAsset? = null
