...
public val SimpleIcons.RedHat: VectorAsset
    get() {
        if (_redHat != null) {
            return _redHat!!
        }
        _redHat = VectorAssetBuilder(name = "RedHat", defaultWidth = 24.0.dp, defaultHeight =
...
private var _redHat: VectorAsset? = null
