...
public val SimpleIcons.RootsBedrock: VectorAsset
    get() {
        if (_rootsBedrock != null) {
            return _rootsBedrock!!
        }
        _rootsBedrock = VectorAssetBuilder(name = "RootsBedrock", defaultWidth = 24.0.dp,
...
private var _rootsBedrock: VectorAsset? = null
