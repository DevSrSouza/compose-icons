...
public val SimpleIcons.Moleculer: VectorAsset
    get() {
        if (_moleculer != null) {
            return _moleculer!!
        }
        _moleculer = VectorAssetBuilder(name = "Moleculer", defaultWidth = 24.0.dp, defaultHeight =
...
private var _moleculer: VectorAsset? = null
