...
public val SimpleIcons.Facepunch: VectorAsset
    get() {
        if (_facepunch != null) {
            return _facepunch!!
        }
        _facepunch = VectorAssetBuilder(name = "Facepunch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _facepunch: VectorAsset? = null
