...
public val SimpleIcons.Line: VectorAsset
    get() {
        if (_line != null) {
            return _line!!
        }
        _line = VectorAssetBuilder(name = "Line", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _line: VectorAsset? = null
