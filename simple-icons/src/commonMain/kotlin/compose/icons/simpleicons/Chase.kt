...
public val SimpleIcons.Chase: VectorAsset
    get() {
        if (_chase != null) {
            return _chase!!
        }
        _chase = VectorAssetBuilder(name = "Chase", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _chase: VectorAsset? = null
