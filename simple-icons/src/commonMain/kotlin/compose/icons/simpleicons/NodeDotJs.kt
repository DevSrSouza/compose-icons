...
public val SimpleIcons.NodeDotJs: VectorAsset
    get() {
        if (_nodeDotJs != null) {
            return _nodeDotJs!!
        }
        _nodeDotJs = VectorAssetBuilder(name = "NodeDotJs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _nodeDotJs: VectorAsset? = null
