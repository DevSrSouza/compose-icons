...
public val SimpleIcons.Cookiecutter: VectorAsset
    get() {
        if (_cookiecutter != null) {
            return _cookiecutter!!
        }
        _cookiecutter = VectorAssetBuilder(name = "Cookiecutter", defaultWidth = 24.0.dp,
...
private var _cookiecutter: VectorAsset? = null
