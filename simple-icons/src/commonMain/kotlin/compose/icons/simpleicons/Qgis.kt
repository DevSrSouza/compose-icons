...
public val SimpleIcons.Qgis: VectorAsset
    get() {
        if (_qgis != null) {
            return _qgis!!
        }
        _qgis = VectorAssetBuilder(name = "Qgis", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _qgis: VectorAsset? = null
