...
public val SimpleIcons.JsonWebTokens: VectorAsset
    get() {
        if (_jsonWebTokens != null) {
            return _jsonWebTokens!!
        }
        _jsonWebTokens = VectorAssetBuilder(name = "JsonWebTokens", defaultWidth = 24.0.dp,
...
private var _jsonWebTokens: VectorAsset? = null
