...
public val SimpleIcons.Zeromq: VectorAsset
    get() {
        if (_zeromq != null) {
            return _zeromq!!
        }
        _zeromq = VectorAssetBuilder(name = "Zeromq", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zeromq: VectorAsset? = null
