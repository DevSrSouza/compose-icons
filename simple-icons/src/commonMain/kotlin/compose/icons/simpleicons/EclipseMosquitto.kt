...
public val SimpleIcons.EclipseMosquitto: VectorAsset
    get() {
        if (_eclipseMosquitto != null) {
            return _eclipseMosquitto!!
        }
        _eclipseMosquitto = VectorAssetBuilder(name = "EclipseMosquitto", defaultWidth = 24.0.dp,
...
private var _eclipseMosquitto: VectorAsset? = null
