...
public val SimpleIcons.KhanAcademy: VectorAsset
    get() {
        if (_khanAcademy != null) {
            return _khanAcademy!!
        }
        _khanAcademy = VectorAssetBuilder(name = "KhanAcademy", defaultWidth = 24.0.dp,
...
private var _khanAcademy: VectorAsset? = null
