...
public val SimpleIcons.Qualcomm: VectorAsset
    get() {
        if (_qualcomm != null) {
            return _qualcomm!!
        }
        _qualcomm = VectorAssetBuilder(name = "Qualcomm", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qualcomm: VectorAsset? = null
