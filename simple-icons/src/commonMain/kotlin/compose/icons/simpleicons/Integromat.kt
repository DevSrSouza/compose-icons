...
public val SimpleIcons.Integromat: VectorAsset
    get() {
        if (_integromat != null) {
            return _integromat!!
        }
        _integromat = VectorAssetBuilder(name = "Integromat", defaultWidth = 24.0.dp, defaultHeight
...
private var _integromat: VectorAsset? = null
