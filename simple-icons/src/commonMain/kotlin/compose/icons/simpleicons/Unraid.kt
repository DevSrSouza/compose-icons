...
public val SimpleIcons.Unraid: VectorAsset
    get() {
        if (_unraid != null) {
            return _unraid!!
        }
        _unraid = VectorAssetBuilder(name = "Unraid", defaultWidth = 24.0.dp, defaultHeight =
...
private var _unraid: VectorAsset? = null
