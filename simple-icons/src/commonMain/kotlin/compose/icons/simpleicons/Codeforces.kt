...
public val SimpleIcons.Codeforces: VectorAsset
    get() {
        if (_codeforces != null) {
            return _codeforces!!
        }
        _codeforces = VectorAssetBuilder(name = "Codeforces", defaultWidth = 24.0.dp, defaultHeight
...
private var _codeforces: VectorAsset? = null
