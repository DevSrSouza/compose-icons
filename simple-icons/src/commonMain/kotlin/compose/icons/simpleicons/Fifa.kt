...
public val SimpleIcons.Fifa: VectorAsset
    get() {
        if (_fifa != null) {
            return _fifa!!
        }
        _fifa = VectorAssetBuilder(name = "Fifa", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fifa: VectorAsset? = null
