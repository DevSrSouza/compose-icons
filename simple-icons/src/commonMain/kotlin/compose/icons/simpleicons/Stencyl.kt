...
public val SimpleIcons.Stencyl: VectorAsset
    get() {
        if (_stencyl != null) {
            return _stencyl!!
        }
        _stencyl = VectorAssetBuilder(name = "Stencyl", defaultWidth = 24.0.dp, defaultHeight =
...
private var _stencyl: VectorAsset? = null
