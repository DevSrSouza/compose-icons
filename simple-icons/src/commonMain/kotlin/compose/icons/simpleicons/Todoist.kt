...
public val SimpleIcons.Todoist: VectorAsset
    get() {
        if (_todoist != null) {
            return _todoist!!
        }
        _todoist = VectorAssetBuilder(name = "Todoist", defaultWidth = 24.0.dp, defaultHeight =
...
private var _todoist: VectorAsset? = null
