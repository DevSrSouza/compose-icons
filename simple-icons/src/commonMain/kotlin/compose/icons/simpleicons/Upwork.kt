...
public val SimpleIcons.Upwork: VectorAsset
    get() {
        if (_upwork != null) {
            return _upwork!!
        }
        _upwork = VectorAssetBuilder(name = "Upwork", defaultWidth = 24.0.dp, defaultHeight =
...
private var _upwork: VectorAsset? = null
