...
public val SimpleIcons.Airtable: VectorAsset
    get() {
        if (_airtable != null) {
            return _airtable!!
        }
        _airtable = VectorAssetBuilder(name = "Airtable", defaultWidth = 24.0.dp, defaultHeight =
...
private var _airtable: VectorAsset? = null
