...
public val SimpleIcons.Gravatar: VectorAsset
    get() {
        if (_gravatar != null) {
            return _gravatar!!
        }
        _gravatar = VectorAssetBuilder(name = "Gravatar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gravatar: VectorAsset? = null
