...
public val SimpleIcons.Xsplit: VectorAsset
    get() {
        if (_xsplit != null) {
            return _xsplit!!
        }
        _xsplit = VectorAssetBuilder(name = "Xsplit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _xsplit: VectorAsset? = null
