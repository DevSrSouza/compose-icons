...
public val SimpleIcons.Couchbase: VectorAsset
    get() {
        if (_couchbase != null) {
            return _couchbase!!
        }
        _couchbase = VectorAssetBuilder(name = "Couchbase", defaultWidth = 24.0.dp, defaultHeight =
...
private var _couchbase: VectorAsset? = null
