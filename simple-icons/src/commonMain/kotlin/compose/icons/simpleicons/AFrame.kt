...
public val SimpleIcons.AFrame: VectorAsset
    get() {
        if (_aFrame != null) {
            return _aFrame!!
        }
        _aFrame = VectorAssetBuilder(name = "AFrame", defaultWidth = 24.0.dp, defaultHeight =
...
private var _aFrame: VectorAsset? = null
