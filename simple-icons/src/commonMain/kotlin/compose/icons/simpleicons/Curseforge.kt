...
public val SimpleIcons.Curseforge: VectorAsset
    get() {
        if (_curseforge != null) {
            return _curseforge!!
        }
        _curseforge = VectorAssetBuilder(name = "Curseforge", defaultWidth = 24.0.dp, defaultHeight
...
private var _curseforge: VectorAsset? = null
