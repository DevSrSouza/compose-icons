...
public val SimpleIcons.Cocoapods: VectorAsset
    get() {
        if (_cocoapods != null) {
            return _cocoapods!!
        }
        _cocoapods = VectorAssetBuilder(name = "Cocoapods", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cocoapods: VectorAsset? = null
