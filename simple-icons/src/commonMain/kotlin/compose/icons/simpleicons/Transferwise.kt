...
public val SimpleIcons.Transferwise: VectorAsset
    get() {
        if (_transferwise != null) {
            return _transferwise!!
        }
        _transferwise = VectorAssetBuilder(name = "Transferwise", defaultWidth = 24.0.dp,
...
private var _transferwise: VectorAsset? = null
