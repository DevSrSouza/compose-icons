...
public val SimpleIcons.Hoppscotch: VectorAsset
    get() {
        if (_hoppscotch != null) {
            return _hoppscotch!!
        }
        _hoppscotch = VectorAssetBuilder(name = "Hoppscotch", defaultWidth = 24.0.dp, defaultHeight
...
private var _hoppscotch: VectorAsset? = null
