...
public val SimpleIcons.Smrt: VectorAsset
    get() {
        if (_smrt != null) {
            return _smrt!!
        }
        _smrt = VectorAssetBuilder(name = "Smrt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _smrt: VectorAsset? = null
