...
public val SimpleIcons.Fastapi: VectorAsset
    get() {
        if (_fastapi != null) {
            return _fastapi!!
        }
        _fastapi = VectorAssetBuilder(name = "Fastapi", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fastapi: VectorAsset? = null
