...
public val SimpleIcons.Webmoney: VectorAsset
    get() {
        if (_webmoney != null) {
            return _webmoney!!
        }
        _webmoney = VectorAssetBuilder(name = "Webmoney", defaultWidth = 24.0.dp, defaultHeight =
...
private var _webmoney: VectorAsset? = null
