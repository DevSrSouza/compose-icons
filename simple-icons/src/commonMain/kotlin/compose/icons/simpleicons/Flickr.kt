...
public val SimpleIcons.Flickr: VectorAsset
    get() {
        if (_flickr != null) {
            return _flickr!!
        }
        _flickr = VectorAssetBuilder(name = "Flickr", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flickr: VectorAsset? = null
