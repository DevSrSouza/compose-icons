...
public val SimpleIcons.GoogleLens: VectorAsset
    get() {
        if (_googleLens != null) {
            return _googleLens!!
        }
        _googleLens = VectorAssetBuilder(name = "GoogleLens", defaultWidth = 24.0.dp, defaultHeight
...
private var _googleLens: VectorAsset? = null
