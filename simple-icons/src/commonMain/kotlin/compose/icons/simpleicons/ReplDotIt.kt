...
public val SimpleIcons.ReplDotIt: VectorAsset
    get() {
        if (_replDotIt != null) {
            return _replDotIt!!
        }
        _replDotIt = VectorAssetBuilder(name = "ReplDotIt", defaultWidth = 24.0.dp, defaultHeight =
...
private var _replDotIt: VectorAsset? = null
