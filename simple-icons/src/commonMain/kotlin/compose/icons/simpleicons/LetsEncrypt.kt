...
public val SimpleIcons.LetsEncrypt: VectorAsset
    get() {
        if (_letsEncrypt != null) {
            return _letsEncrypt!!
        }
        _letsEncrypt = VectorAssetBuilder(name = "LetsEncrypt", defaultWidth = 24.0.dp,
...
private var _letsEncrypt: VectorAsset? = null
