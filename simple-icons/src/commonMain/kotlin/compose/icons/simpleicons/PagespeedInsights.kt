...
public val SimpleIcons.PagespeedInsights: VectorAsset
    get() {
        if (_pagespeedInsights != null) {
            return _pagespeedInsights!!
        }
        _pagespeedInsights = VectorAssetBuilder(name = "PagespeedInsights", defaultWidth = 24.0.dp,
...
private var _pagespeedInsights: VectorAsset? = null
