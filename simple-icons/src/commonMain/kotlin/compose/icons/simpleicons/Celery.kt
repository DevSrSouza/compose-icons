...
public val SimpleIcons.Celery: VectorAsset
    get() {
        if (_celery != null) {
            return _celery!!
        }
        _celery = VectorAssetBuilder(name = "Celery", defaultWidth = 24.0.dp, defaultHeight =
...
private var _celery: VectorAsset? = null
