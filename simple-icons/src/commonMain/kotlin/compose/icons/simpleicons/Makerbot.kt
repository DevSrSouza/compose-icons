...
public val SimpleIcons.Makerbot: VectorAsset
    get() {
        if (_makerbot != null) {
            return _makerbot!!
        }
        _makerbot = VectorAssetBuilder(name = "Makerbot", defaultWidth = 24.0.dp, defaultHeight =
...
private var _makerbot: VectorAsset? = null
