...
public val SimpleIcons.Crunchbase: VectorAsset
    get() {
        if (_crunchbase != null) {
            return _crunchbase!!
        }
        _crunchbase = VectorAssetBuilder(name = "Crunchbase", defaultWidth = 24.0.dp, defaultHeight
...
private var _crunchbase: VectorAsset? = null
