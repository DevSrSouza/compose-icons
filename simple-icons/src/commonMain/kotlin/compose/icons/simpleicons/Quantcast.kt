...
public val SimpleIcons.Quantcast: VectorAsset
    get() {
        if (_quantcast != null) {
            return _quantcast!!
        }
        _quantcast = VectorAssetBuilder(name = "Quantcast", defaultWidth = 24.0.dp, defaultHeight =
...
private var _quantcast: VectorAsset? = null
