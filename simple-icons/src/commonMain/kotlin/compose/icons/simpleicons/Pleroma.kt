...
public val SimpleIcons.Pleroma: VectorAsset
    get() {
        if (_pleroma != null) {
            return _pleroma!!
        }
        _pleroma = VectorAssetBuilder(name = "Pleroma", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pleroma: VectorAsset? = null
