...
public val SimpleIcons.InternetExplorer: VectorAsset
    get() {
        if (_internetExplorer != null) {
            return _internetExplorer!!
        }
        _internetExplorer = VectorAssetBuilder(name = "InternetExplorer", defaultWidth = 24.0.dp,
...
private var _internetExplorer: VectorAsset? = null
