...
public val SimpleIcons.Adonisjs: VectorAsset
    get() {
        if (_adonisjs != null) {
            return _adonisjs!!
        }
        _adonisjs = VectorAssetBuilder(name = "Adonisjs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _adonisjs: VectorAsset? = null
