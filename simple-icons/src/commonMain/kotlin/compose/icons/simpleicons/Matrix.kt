...
public val SimpleIcons.Matrix: VectorAsset
    get() {
        if (_matrix != null) {
            return _matrix!!
        }
        _matrix = VectorAssetBuilder(name = "Matrix", defaultWidth = 24.0.dp, defaultHeight =
...
private var _matrix: VectorAsset? = null
