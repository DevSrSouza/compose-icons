...
public val SimpleIcons.Rabbitmq: VectorAsset
    get() {
        if (_rabbitmq != null) {
            return _rabbitmq!!
        }
        _rabbitmq = VectorAssetBuilder(name = "Rabbitmq", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rabbitmq: VectorAsset? = null
