...
public val SimpleIcons.Sellfy: VectorAsset
    get() {
        if (_sellfy != null) {
            return _sellfy!!
        }
        _sellfy = VectorAssetBuilder(name = "Sellfy", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sellfy: VectorAsset? = null
