...
public val SimpleIcons.Sitepoint: VectorAsset
    get() {
        if (_sitepoint != null) {
            return _sitepoint!!
        }
        _sitepoint = VectorAssetBuilder(name = "Sitepoint", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sitepoint: VectorAsset? = null
