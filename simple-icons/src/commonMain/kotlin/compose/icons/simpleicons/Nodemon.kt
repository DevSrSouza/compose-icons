...
public val SimpleIcons.Nodemon: VectorAsset
    get() {
        if (_nodemon != null) {
            return _nodemon!!
        }
        _nodemon = VectorAssetBuilder(name = "Nodemon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _nodemon: VectorAsset? = null
