...
public val SimpleIcons.Groovy: VectorAsset
    get() {
        if (_groovy != null) {
            return _groovy!!
        }
        _groovy = VectorAssetBuilder(name = "Groovy", defaultWidth = 24.0.dp, defaultHeight =
...
private var _groovy: VectorAsset? = null
