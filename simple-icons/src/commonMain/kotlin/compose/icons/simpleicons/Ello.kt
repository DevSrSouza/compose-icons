...
public val SimpleIcons.Ello: VectorAsset
    get() {
        if (_ello != null) {
            return _ello!!
        }
        _ello = VectorAssetBuilder(name = "Ello", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ello: VectorAsset? = null
