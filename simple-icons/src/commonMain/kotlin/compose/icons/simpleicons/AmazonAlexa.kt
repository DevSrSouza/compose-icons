...
public val SimpleIcons.AmazonAlexa: VectorAsset
    get() {
        if (_amazonAlexa != null) {
            return _amazonAlexa!!
        }
        _amazonAlexa = VectorAssetBuilder(name = "AmazonAlexa", defaultWidth = 24.0.dp,
...
private var _amazonAlexa: VectorAsset? = null
