...
public val SimpleIcons.Qemu: VectorAsset
    get() {
        if (_qemu != null) {
            return _qemu!!
        }
        _qemu = VectorAssetBuilder(name = "Qemu", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _qemu: VectorAsset? = null
