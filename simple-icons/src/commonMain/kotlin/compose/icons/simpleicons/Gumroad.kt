...
public val SimpleIcons.Gumroad: VectorAsset
    get() {
        if (_gumroad != null) {
            return _gumroad!!
        }
        _gumroad = VectorAssetBuilder(name = "Gumroad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gumroad: VectorAsset? = null
