...
public val SimpleIcons.Webgl: VectorAsset
    get() {
        if (_webgl != null) {
            return _webgl!!
        }
        _webgl = VectorAssetBuilder(name = "Webgl", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _webgl: VectorAsset? = null
