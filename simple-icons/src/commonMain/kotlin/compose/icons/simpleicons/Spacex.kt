...
public val SimpleIcons.Spacex: VectorAsset
    get() {
        if (_spacex != null) {
            return _spacex!!
        }
        _spacex = VectorAssetBuilder(name = "Spacex", defaultWidth = 24.0.dp, defaultHeight =
...
private var _spacex: VectorAsset? = null
