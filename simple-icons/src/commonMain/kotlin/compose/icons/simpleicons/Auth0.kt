...
public val SimpleIcons.Auth0: VectorAsset
    get() {
        if (_auth0 != null) {
            return _auth0!!
        }
        _auth0 = VectorAssetBuilder(name = "Auth0", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _auth0: VectorAsset? = null
