...
public val SimpleIcons.JrGroup: VectorAsset
    get() {
        if (_jrGroup != null) {
            return _jrGroup!!
        }
        _jrGroup = VectorAssetBuilder(name = "JrGroup", defaultWidth = 24.0.dp, defaultHeight =
...
private var _jrGroup: VectorAsset? = null
