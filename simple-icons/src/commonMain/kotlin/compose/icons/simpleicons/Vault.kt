...
public val SimpleIcons.Vault: VectorAsset
    get() {
        if (_vault != null) {
            return _vault!!
        }
        _vault = VectorAssetBuilder(name = "Vault", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _vault: VectorAsset? = null
