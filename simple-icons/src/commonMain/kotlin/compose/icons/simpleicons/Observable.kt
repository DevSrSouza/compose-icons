...
public val SimpleIcons.Observable: VectorAsset
    get() {
        if (_observable != null) {
            return _observable!!
        }
        _observable = VectorAssetBuilder(name = "Observable", defaultWidth = 24.0.dp, defaultHeight
...
private var _observable: VectorAsset? = null
