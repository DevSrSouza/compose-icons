    ...
    get() {
        ...
        _tether = Builder(name = "Tether", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.1803f, 0.1803f, 0.0f, false, true, -0.2496f, 0.0f)
                lineTo(0.0562f, 11.0635f)
                arcToRelative(0.1781f, 0.1781f, 0.0f, false, true, -0.0382f, -0.2079f)
                lineToRelative(4.3762f, -9.1921f)
                arcToRelative(0.1767f, 0.1767f, 0.0f, false, true, 0.1626f, -0.1026f)
                horizontalLineToRelative(14.8878f)
                arcToRelative(0.1768f, 0.1768f, 0.0f, false, true, 0.1612f, 0.1032f)
                lineToRelative(4.3762f, 9.1922f)
                arcToRelative(0.1782f, 0.1782f, 0.0f, false, true, -0.0382f, 0.2079f)
                close()
