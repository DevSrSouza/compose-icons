...
public val SimpleIcons.Bilibili: VectorAsset
    get() {
        if (_bilibili != null) {
            return _bilibili!!
        }
        _bilibili = VectorAssetBuilder(name = "Bilibili", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bilibili: VectorAsset? = null
