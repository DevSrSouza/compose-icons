...
public val SimpleIcons.RootsSage: VectorAsset
    get() {
        if (_rootsSage != null) {
            return _rootsSage!!
        }
        _rootsSage = VectorAssetBuilder(name = "RootsSage", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rootsSage: VectorAsset? = null
