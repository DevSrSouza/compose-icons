...
public val SimpleIcons.Blazemeter: VectorAsset
    get() {
        if (_blazemeter != null) {
            return _blazemeter!!
        }
        _blazemeter = VectorAssetBuilder(name = "Blazemeter", defaultWidth = 24.0.dp, defaultHeight
...
private var _blazemeter: VectorAsset? = null
