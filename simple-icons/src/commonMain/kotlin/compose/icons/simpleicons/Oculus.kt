...
public val SimpleIcons.Oculus: VectorAsset
    get() {
        if (_oculus != null) {
            return _oculus!!
        }
        _oculus = VectorAssetBuilder(name = "Oculus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _oculus: VectorAsset? = null
