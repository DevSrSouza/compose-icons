...
public val SimpleIcons.Wakatime: VectorAsset
    get() {
        if (_wakatime != null) {
            return _wakatime!!
        }
        _wakatime = VectorAssetBuilder(name = "Wakatime", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wakatime: VectorAsset? = null
