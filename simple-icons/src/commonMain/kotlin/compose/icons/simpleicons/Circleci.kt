...
public val SimpleIcons.Circleci: VectorAsset
    get() {
        if (_circleci != null) {
            return _circleci!!
        }
        _circleci = VectorAssetBuilder(name = "Circleci", defaultWidth = 24.0.dp, defaultHeight =
...
private var _circleci: VectorAsset? = null
