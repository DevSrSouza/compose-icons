...
public val SimpleIcons.Codio: VectorAsset
    get() {
        if (_codio != null) {
            return _codio!!
        }
        _codio = VectorAssetBuilder(name = "Codio", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _codio: VectorAsset? = null
