...
public val SimpleIcons.Bata: VectorAsset
    get() {
        if (_bata != null) {
            return _bata!!
        }
        _bata = VectorAssetBuilder(name = "Bata", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bata: VectorAsset? = null
