...
public val SimpleIcons.Opsgenie: VectorAsset
    get() {
        if (_opsgenie != null) {
            return _opsgenie!!
        }
        _opsgenie = VectorAssetBuilder(name = "Opsgenie", defaultWidth = 24.0.dp, defaultHeight =
...
private var _opsgenie: VectorAsset? = null
