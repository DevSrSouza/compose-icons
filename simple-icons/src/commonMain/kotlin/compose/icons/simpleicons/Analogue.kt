...
public val SimpleIcons.Analogue: VectorAsset
    get() {
        if (_analogue != null) {
            return _analogue!!
        }
        _analogue = VectorAssetBuilder(name = "Analogue", defaultWidth = 24.0.dp, defaultHeight =
...
private var _analogue: VectorAsset? = null
