...
public val SimpleIcons.Spotlight: VectorAsset
    get() {
        if (_spotlight != null) {
            return _spotlight!!
        }
        _spotlight = VectorAssetBuilder(name = "Spotlight", defaultWidth = 24.0.dp, defaultHeight =
...
private var _spotlight: VectorAsset? = null
