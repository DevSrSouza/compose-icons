...
public val SimpleIcons.GeneralElectric: VectorAsset
    get() {
        if (_generalElectric != null) {
            return _generalElectric!!
        }
        _generalElectric = VectorAssetBuilder(name = "GeneralElectric", defaultWidth = 24.0.dp,
...
private var _generalElectric: VectorAsset? = null
