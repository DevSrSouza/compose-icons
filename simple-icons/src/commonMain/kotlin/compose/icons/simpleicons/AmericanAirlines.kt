...
public val SimpleIcons.AmericanAirlines: VectorAsset
    get() {
        if (_americanAirlines != null) {
            return _americanAirlines!!
        }
        _americanAirlines = VectorAssetBuilder(name = "AmericanAirlines", defaultWidth = 24.0.dp,
...
private var _americanAirlines: VectorAsset? = null
