...
public val SimpleIcons.Xbox: VectorAsset
    get() {
        if (_xbox != null) {
            return _xbox!!
        }
        _xbox = VectorAssetBuilder(name = "Xbox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _xbox: VectorAsset? = null
