...
public val SimpleIcons.Roots: VectorAsset
    get() {
        if (_roots != null) {
            return _roots!!
        }
        _roots = VectorAssetBuilder(name = "Roots", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _roots: VectorAsset? = null
