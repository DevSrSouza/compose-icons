...
public val SimpleIcons.OpenBugBounty: VectorAsset
    get() {
        if (_openBugBounty != null) {
            return _openBugBounty!!
        }
        _openBugBounty = VectorAssetBuilder(name = "OpenBugBounty", defaultWidth = 24.0.dp,
...
private var _openBugBounty: VectorAsset? = null
