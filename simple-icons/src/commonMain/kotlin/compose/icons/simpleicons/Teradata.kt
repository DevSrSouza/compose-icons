...
public val SimpleIcons.Teradata: VectorAsset
    get() {
        if (_teradata != null) {
            return _teradata!!
        }
        _teradata = VectorAssetBuilder(name = "Teradata", defaultWidth = 24.0.dp, defaultHeight =
...
private var _teradata: VectorAsset? = null
