...
public val SimpleIcons.Emby: VectorAsset
    get() {
        if (_emby != null) {
            return _emby!!
        }
        _emby = VectorAssetBuilder(name = "Emby", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _emby: VectorAsset? = null
