...
public val SimpleIcons.Valve: VectorAsset
    get() {
        if (_valve != null) {
            return _valve!!
        }
        _valve = VectorAssetBuilder(name = "Valve", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _valve: VectorAsset? = null
