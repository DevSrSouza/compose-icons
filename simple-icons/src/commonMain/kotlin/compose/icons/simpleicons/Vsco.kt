...
public val SimpleIcons.Vsco: VectorAsset
    get() {
        if (_vsco != null) {
            return _vsco!!
        }
        _vsco = VectorAssetBuilder(name = "Vsco", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _vsco: VectorAsset? = null
