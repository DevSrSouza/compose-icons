...
public val SimpleIcons.Vbulletin: VectorAsset
    get() {
        if (_vbulletin != null) {
            return _vbulletin!!
        }
        _vbulletin = VectorAssetBuilder(name = "Vbulletin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vbulletin: VectorAsset? = null
