...
public val SimpleIcons.Starz: VectorAsset
    get() {
        if (_starz != null) {
            return _starz!!
        }
        _starz = VectorAssetBuilder(name = "Starz", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _starz: VectorAsset? = null
