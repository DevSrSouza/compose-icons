...
public val SimpleIcons.Clickup: VectorAsset
    get() {
        if (_clickup != null) {
            return _clickup!!
        }
        _clickup = VectorAssetBuilder(name = "Clickup", defaultWidth = 24.0.dp, defaultHeight =
...
private var _clickup: VectorAsset? = null
