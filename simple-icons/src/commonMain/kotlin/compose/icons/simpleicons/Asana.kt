...
public val SimpleIcons.Asana: VectorAsset
    get() {
        if (_asana != null) {
            return _asana!!
        }
        _asana = VectorAssetBuilder(name = "Asana", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _asana: VectorAsset? = null
