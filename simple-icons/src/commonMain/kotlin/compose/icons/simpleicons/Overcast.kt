...
public val SimpleIcons.Overcast: VectorAsset
    get() {
        if (_overcast != null) {
            return _overcast!!
        }
        _overcast = VectorAssetBuilder(name = "Overcast", defaultWidth = 24.0.dp, defaultHeight =
...
private var _overcast: VectorAsset? = null
