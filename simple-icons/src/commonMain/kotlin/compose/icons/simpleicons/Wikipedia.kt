...
public val SimpleIcons.Wikipedia: VectorAsset
    get() {
        if (_wikipedia != null) {
            return _wikipedia!!
        }
        _wikipedia = VectorAssetBuilder(name = "Wikipedia", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wikipedia: VectorAsset? = null
