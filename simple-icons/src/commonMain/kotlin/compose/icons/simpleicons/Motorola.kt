...
public val SimpleIcons.Motorola: VectorAsset
    get() {
        if (_motorola != null) {
            return _motorola!!
        }
        _motorola = VectorAssetBuilder(name = "Motorola", defaultWidth = 24.0.dp, defaultHeight =
...
private var _motorola: VectorAsset? = null
