...
public val SimpleIcons.Plangrid: VectorAsset
    get() {
        if (_plangrid != null) {
            return _plangrid!!
        }
        _plangrid = VectorAssetBuilder(name = "Plangrid", defaultWidth = 24.0.dp, defaultHeight =
...
private var _plangrid: VectorAsset? = null
