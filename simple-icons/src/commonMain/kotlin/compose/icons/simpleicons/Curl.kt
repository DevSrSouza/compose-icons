...
public val SimpleIcons.Curl: VectorAsset
    get() {
        if (_curl != null) {
            return _curl!!
        }
        _curl = VectorAssetBuilder(name = "Curl", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _curl: VectorAsset? = null
