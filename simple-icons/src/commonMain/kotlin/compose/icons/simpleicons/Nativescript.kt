...
public val SimpleIcons.Nativescript: VectorAsset
    get() {
        if (_nativescript != null) {
            return _nativescript!!
        }
        _nativescript = VectorAssetBuilder(name = "Nativescript", defaultWidth = 24.0.dp,
...
private var _nativescript: VectorAsset? = null
