...
public val SimpleIcons.Bancontact: VectorAsset
    get() {
        if (_bancontact != null) {
            return _bancontact!!
        }
        _bancontact = VectorAssetBuilder(name = "Bancontact", defaultWidth = 24.0.dp, defaultHeight
...
private var _bancontact: VectorAsset? = null
