...
public val SimpleIcons.Gridsome: VectorAsset
    get() {
        if (_gridsome != null) {
            return _gridsome!!
        }
        _gridsome = VectorAssetBuilder(name = "Gridsome", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gridsome: VectorAsset? = null
