...
public val SimpleIcons.Gatling: VectorAsset
    get() {
        if (_gatling != null) {
            return _gatling!!
        }
        _gatling = VectorAssetBuilder(name = "Gatling", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gatling: VectorAsset? = null
