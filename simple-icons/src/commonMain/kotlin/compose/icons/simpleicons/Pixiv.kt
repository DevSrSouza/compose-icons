...
public val SimpleIcons.Pixiv: VectorAsset
    get() {
        if (_pixiv != null) {
            return _pixiv!!
        }
        _pixiv = VectorAssetBuilder(name = "Pixiv", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _pixiv: VectorAsset? = null
