...
public val SimpleIcons.Vivaldi: VectorAsset
    get() {
        if (_vivaldi != null) {
            return _vivaldi!!
        }
        _vivaldi = VectorAssetBuilder(name = "Vivaldi", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vivaldi: VectorAsset? = null
