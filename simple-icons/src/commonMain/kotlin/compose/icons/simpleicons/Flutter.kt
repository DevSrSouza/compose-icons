...
public val SimpleIcons.Flutter: VectorAsset
    get() {
        if (_flutter != null) {
            return _flutter!!
        }
        _flutter = VectorAssetBuilder(name = "Flutter", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flutter: VectorAsset? = null
