...
public val SimpleIcons.Sonarqube: VectorAsset
    get() {
        if (_sonarqube != null) {
            return _sonarqube!!
        }
        _sonarqube = VectorAssetBuilder(name = "Sonarqube", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sonarqube: VectorAsset? = null
