...
public val SimpleIcons.Lgtm: VectorAsset
    get() {
        if (_lgtm != null) {
            return _lgtm!!
        }
        _lgtm = VectorAssetBuilder(name = "Lgtm", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _lgtm: VectorAsset? = null
