...
public val SimpleIcons.Katana: VectorAsset
    get() {
        if (_katana != null) {
            return _katana!!
        }
        _katana = VectorAssetBuilder(name = "Katana", defaultWidth = 24.0.dp, defaultHeight =
...
private var _katana: VectorAsset? = null
