...
public val SimpleIcons.Datacamp: VectorAsset
    get() {
        if (_datacamp != null) {
            return _datacamp!!
        }
        _datacamp = VectorAssetBuilder(name = "Datacamp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _datacamp: VectorAsset? = null
