...
public val SimpleIcons.Pinboard: VectorAsset
    get() {
        if (_pinboard != null) {
            return _pinboard!!
        }
        _pinboard = VectorAssetBuilder(name = "Pinboard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pinboard: VectorAsset? = null
