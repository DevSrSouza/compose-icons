...
public val SimpleIcons.Microbit: VectorAsset
    get() {
        if (_microbit != null) {
            return _microbit!!
        }
        _microbit = VectorAssetBuilder(name = "Microbit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _microbit: VectorAsset? = null
