...
public val SimpleIcons.Iconify: VectorAsset
    get() {
        if (_iconify != null) {
            return _iconify!!
        }
        _iconify = VectorAssetBuilder(name = "Iconify", defaultWidth = 24.0.dp, defaultHeight =
...
private var _iconify: VectorAsset? = null
