...
public val SimpleIcons.Capacitor: VectorAsset
    get() {
        if (_capacitor != null) {
            return _capacitor!!
        }
        _capacitor = VectorAssetBuilder(name = "Capacitor", defaultWidth = 24.0.dp, defaultHeight =
...
private var _capacitor: VectorAsset? = null
