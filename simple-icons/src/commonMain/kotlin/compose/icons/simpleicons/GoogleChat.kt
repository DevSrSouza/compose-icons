...
public val SimpleIcons.GoogleChat: VectorAsset
    get() {
        if (_googleChat != null) {
            return _googleChat!!
        }
        _googleChat = VectorAssetBuilder(name = "GoogleChat", defaultWidth = 24.0.dp, defaultHeight
...
private var _googleChat: VectorAsset? = null
