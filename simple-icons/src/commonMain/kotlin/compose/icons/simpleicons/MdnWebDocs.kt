...
public val SimpleIcons.MdnWebDocs: VectorAsset
    get() {
        if (_mdnWebDocs != null) {
            return _mdnWebDocs!!
        }
        _mdnWebDocs = VectorAssetBuilder(name = "MdnWebDocs", defaultWidth = 24.0.dp, defaultHeight
...
private var _mdnWebDocs: VectorAsset? = null
