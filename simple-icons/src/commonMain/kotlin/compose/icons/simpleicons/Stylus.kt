...
public val SimpleIcons.Stylus: VectorAsset
    get() {
        if (_stylus != null) {
            return _stylus!!
        }
        _stylus = VectorAssetBuilder(name = "Stylus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _stylus: VectorAsset? = null
