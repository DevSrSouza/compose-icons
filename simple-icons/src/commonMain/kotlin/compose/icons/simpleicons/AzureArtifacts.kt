...
public val SimpleIcons.AzureArtifacts: VectorAsset
    get() {
        if (_azureArtifacts != null) {
            return _azureArtifacts!!
        }
        _azureArtifacts = VectorAssetBuilder(name = "AzureArtifacts", defaultWidth = 24.0.dp,
...
private var _azureArtifacts: VectorAsset? = null
