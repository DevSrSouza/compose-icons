...
public val SimpleIcons.Twilio: VectorAsset
    get() {
        if (_twilio != null) {
            return _twilio!!
        }
        _twilio = VectorAssetBuilder(name = "Twilio", defaultWidth = 24.0.dp, defaultHeight =
...
private var _twilio: VectorAsset? = null
