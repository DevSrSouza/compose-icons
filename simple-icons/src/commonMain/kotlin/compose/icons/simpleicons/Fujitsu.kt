...
public val SimpleIcons.Fujitsu: VectorAsset
    get() {
        if (_fujitsu != null) {
            return _fujitsu!!
        }
        _fujitsu = VectorAssetBuilder(name = "Fujitsu", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fujitsu: VectorAsset? = null
