...
public val SimpleIcons.Buefy: VectorAsset
    get() {
        if (_buefy != null) {
            return _buefy!!
        }
        _buefy = VectorAssetBuilder(name = "Buefy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _buefy: VectorAsset? = null
