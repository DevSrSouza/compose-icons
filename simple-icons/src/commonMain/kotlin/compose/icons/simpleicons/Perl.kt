...
public val SimpleIcons.Perl: VectorAsset
    get() {
        if (_perl != null) {
            return _perl!!
        }
        _perl = VectorAssetBuilder(name = "Perl", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _perl: VectorAsset? = null
