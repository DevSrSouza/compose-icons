...
public val SimpleIcons.ObsStudio: VectorAsset
    get() {
        if (_obsStudio != null) {
            return _obsStudio!!
        }
        _obsStudio = VectorAssetBuilder(name = "ObsStudio", defaultWidth = 24.0.dp, defaultHeight =
...
private var _obsStudio: VectorAsset? = null
