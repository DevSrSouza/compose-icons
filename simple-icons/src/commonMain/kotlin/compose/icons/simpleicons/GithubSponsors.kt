...
public val SimpleIcons.GithubSponsors: VectorAsset
    get() {
        if (_githubSponsors != null) {
            return _githubSponsors!!
        }
        _githubSponsors = VectorAssetBuilder(name = "GithubSponsors", defaultWidth = 24.0.dp,
...
private var _githubSponsors: VectorAsset? = null
