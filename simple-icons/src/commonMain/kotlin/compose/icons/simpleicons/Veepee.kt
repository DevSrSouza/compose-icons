...
public val SimpleIcons.Veepee: VectorAsset
    get() {
        if (_veepee != null) {
            return _veepee!!
        }
        _veepee = VectorAssetBuilder(name = "Veepee", defaultWidth = 24.0.dp, defaultHeight =
...
private var _veepee: VectorAsset? = null
