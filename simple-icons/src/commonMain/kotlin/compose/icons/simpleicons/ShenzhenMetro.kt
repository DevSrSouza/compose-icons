...
public val SimpleIcons.ShenzhenMetro: VectorAsset
    get() {
        if (_shenzhenMetro != null) {
            return _shenzhenMetro!!
        }
        _shenzhenMetro = VectorAssetBuilder(name = "ShenzhenMetro", defaultWidth = 24.0.dp,
...
private var _shenzhenMetro: VectorAsset? = null
