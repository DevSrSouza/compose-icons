...
public val SimpleIcons.Graphcool: ImageVector
    get() {
        if (_graphcool != null) {
            return _graphcool!!
        }
        _graphcool = Builder(name = "Graphcool", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _graphcool: ImageVector? = null
