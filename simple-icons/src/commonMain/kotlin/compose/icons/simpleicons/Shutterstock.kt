...
public val SimpleIcons.Shutterstock: VectorAsset
    get() {
        if (_shutterstock != null) {
            return _shutterstock!!
        }
        _shutterstock = VectorAssetBuilder(name = "Shutterstock", defaultWidth = 24.0.dp,
...
private var _shutterstock: VectorAsset? = null
