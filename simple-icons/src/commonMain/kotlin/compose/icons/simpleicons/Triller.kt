...
public val SimpleIcons.Triller: VectorAsset
    get() {
        if (_triller != null) {
            return _triller!!
        }
        _triller = VectorAssetBuilder(name = "Triller", defaultWidth = 24.0.dp, defaultHeight =
...
private var _triller: VectorAsset? = null
