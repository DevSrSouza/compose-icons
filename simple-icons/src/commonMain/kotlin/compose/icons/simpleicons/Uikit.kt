...
public val SimpleIcons.Uikit: VectorAsset
    get() {
        if (_uikit != null) {
            return _uikit!!
        }
        _uikit = VectorAssetBuilder(name = "Uikit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _uikit: VectorAsset? = null
