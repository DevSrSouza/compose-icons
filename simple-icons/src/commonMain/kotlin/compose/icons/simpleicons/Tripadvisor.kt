...
public val SimpleIcons.Tripadvisor: VectorAsset
    get() {
        if (_tripadvisor != null) {
            return _tripadvisor!!
        }
        _tripadvisor = VectorAssetBuilder(name = "Tripadvisor", defaultWidth = 24.0.dp,
...
private var _tripadvisor: VectorAsset? = null
