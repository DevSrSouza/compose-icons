...
public val SimpleIcons.PicartoDotTv: VectorAsset
    get() {
        if (_picartoDotTv != null) {
            return _picartoDotTv!!
        }
        _picartoDotTv = VectorAssetBuilder(name = "PicartoDotTv", defaultWidth = 24.0.dp,
...
private var _picartoDotTv: VectorAsset? = null
