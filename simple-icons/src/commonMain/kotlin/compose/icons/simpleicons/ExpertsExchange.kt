...
public val SimpleIcons.ExpertsExchange: VectorAsset
    get() {
        if (_expertsExchange != null) {
            return _expertsExchange!!
        }
        _expertsExchange = VectorAssetBuilder(name = "ExpertsExchange", defaultWidth = 24.0.dp,
...
private var _expertsExchange: VectorAsset? = null
