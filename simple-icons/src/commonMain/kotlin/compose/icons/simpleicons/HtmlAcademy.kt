...
public val SimpleIcons.HtmlAcademy: VectorAsset
    get() {
        if (_htmlAcademy != null) {
            return _htmlAcademy!!
        }
        _htmlAcademy = VectorAssetBuilder(name = "HtmlAcademy", defaultWidth = 24.0.dp,
...
private var _htmlAcademy: VectorAsset? = null
