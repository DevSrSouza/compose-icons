...
public val SimpleIcons.Zorin: VectorAsset
    get() {
        if (_zorin != null) {
            return _zorin!!
        }
        _zorin = VectorAssetBuilder(name = "Zorin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _zorin: VectorAsset? = null
