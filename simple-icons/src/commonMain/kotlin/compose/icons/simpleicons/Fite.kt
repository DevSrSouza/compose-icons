...
public val SimpleIcons.Fite: VectorAsset
    get() {
        if (_fite != null) {
            return _fite!!
        }
        _fite = VectorAssetBuilder(name = "Fite", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fite: VectorAsset? = null
