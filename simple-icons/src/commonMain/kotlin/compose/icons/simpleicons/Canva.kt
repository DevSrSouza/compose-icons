...
public val SimpleIcons.Canva: VectorAsset
    get() {
        if (_canva != null) {
            return _canva!!
        }
        _canva = VectorAssetBuilder(name = "Canva", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _canva: VectorAsset? = null
