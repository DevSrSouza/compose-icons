...
public val SimpleIcons.Sencha: VectorAsset
    get() {
        if (_sencha != null) {
            return _sencha!!
        }
        _sencha = VectorAssetBuilder(name = "Sencha", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sencha: VectorAsset? = null
