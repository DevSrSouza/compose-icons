...
public val SimpleIcons.Deviantart: VectorAsset
    get() {
        if (_deviantart != null) {
            return _deviantart!!
        }
        _deviantart = VectorAssetBuilder(name = "Deviantart", defaultWidth = 24.0.dp, defaultHeight
...
private var _deviantart: VectorAsset? = null
