...
public val SimpleIcons.Notist: VectorAsset
    get() {
        if (_notist != null) {
            return _notist!!
        }
        _notist = VectorAssetBuilder(name = "Notist", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(5.934f, 3.801f)
                ...
                curveTo(0.109f, 17.79f, -0.04f, 18.6f, 0.01f, 19.32f)
...
private var _notist: VectorAsset? = null
