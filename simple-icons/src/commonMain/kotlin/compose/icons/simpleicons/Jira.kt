...
public val SimpleIcons.Jira: VectorAsset
    get() {
        if (_jira != null) {
            return _jira!!
        }
        _jira = VectorAssetBuilder(name = "Jira", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _jira: VectorAsset? = null
