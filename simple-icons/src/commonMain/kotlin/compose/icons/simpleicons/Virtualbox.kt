...
public val SimpleIcons.Virtualbox: VectorAsset
    get() {
        if (_virtualbox != null) {
            return _virtualbox!!
        }
        _virtualbox = VectorAssetBuilder(name = "Virtualbox", defaultWidth = 24.0.dp, defaultHeight
...
private var _virtualbox: VectorAsset? = null
