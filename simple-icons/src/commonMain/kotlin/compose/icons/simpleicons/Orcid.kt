...
public val SimpleIcons.Orcid: VectorAsset
    get() {
        if (_orcid != null) {
            return _orcid!!
        }
        _orcid = VectorAssetBuilder(name = "Orcid", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _orcid: VectorAsset? = null
