...
public val SimpleIcons.Invision: VectorAsset
    get() {
        if (_invision != null) {
            return _invision!!
        }
        _invision = VectorAssetBuilder(name = "Invision", defaultWidth = 24.0.dp, defaultHeight =
...
private var _invision: VectorAsset? = null
