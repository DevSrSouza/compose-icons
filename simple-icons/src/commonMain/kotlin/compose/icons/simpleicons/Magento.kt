...
public val SimpleIcons.Magento: VectorAsset
    get() {
        if (_magento != null) {
            return _magento!!
        }
        _magento = VectorAssetBuilder(name = "Magento", defaultWidth = 24.0.dp, defaultHeight =
...
private var _magento: VectorAsset? = null
