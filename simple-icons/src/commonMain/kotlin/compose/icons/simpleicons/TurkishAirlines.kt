...
public val SimpleIcons.TurkishAirlines: VectorAsset
    get() {
        if (_turkishAirlines != null) {
            return _turkishAirlines!!
        }
        _turkishAirlines = VectorAssetBuilder(name = "TurkishAirlines", defaultWidth = 24.0.dp,
...
private var _turkishAirlines: VectorAsset? = null
