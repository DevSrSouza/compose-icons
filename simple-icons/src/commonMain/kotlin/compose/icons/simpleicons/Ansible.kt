...
public val SimpleIcons.Ansible: VectorAsset
    get() {
        if (_ansible != null) {
            return _ansible!!
        }
        _ansible = VectorAssetBuilder(name = "Ansible", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ansible: VectorAsset? = null
