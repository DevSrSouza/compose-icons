...
public val SimpleIcons.Letterboxd: VectorAsset
    get() {
        if (_letterboxd != null) {
            return _letterboxd!!
        }
        _letterboxd = VectorAssetBuilder(name = "Letterboxd", defaultWidth = 24.0.dp, defaultHeight
...
private var _letterboxd: VectorAsset? = null
