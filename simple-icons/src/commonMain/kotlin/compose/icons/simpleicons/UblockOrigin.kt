...
public val SimpleIcons.UblockOrigin: VectorAsset
    get() {
        if (_ublockOrigin != null) {
            return _ublockOrigin!!
        }
        _ublockOrigin = VectorAssetBuilder(name = "UblockOrigin", defaultWidth = 24.0.dp,
...
private var _ublockOrigin: VectorAsset? = null
