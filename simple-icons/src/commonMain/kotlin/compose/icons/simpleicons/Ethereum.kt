...
public val SimpleIcons.Ethereum: VectorAsset
    get() {
        if (_ethereum != null) {
            return _ethereum!!
        }
        _ethereum = VectorAssetBuilder(name = "Ethereum", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ethereum: VectorAsset? = null
