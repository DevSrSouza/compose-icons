...
public val SimpleIcons.HackClub: VectorAsset
    get() {
        if (_hackClub != null) {
            return _hackClub!!
        }
        _hackClub = VectorAssetBuilder(name = "HackClub", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hackClub: VectorAsset? = null
