...
public val SimpleIcons.Jitsi: VectorAsset
    get() {
        if (_jitsi != null) {
            return _jitsi!!
        }
        _jitsi = VectorAssetBuilder(name = "Jitsi", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _jitsi: VectorAsset? = null
