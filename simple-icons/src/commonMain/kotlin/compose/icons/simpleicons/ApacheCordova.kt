...
public val SimpleIcons.ApacheCordova: VectorAsset
    get() {
        if (_apacheCordova != null) {
            return _apacheCordova!!
        }
        _apacheCordova = VectorAssetBuilder(name = "ApacheCordova", defaultWidth = 24.0.dp,
...
private var _apacheCordova: VectorAsset? = null
