...
public val SimpleIcons.NounProject: VectorAsset
    get() {
        if (_nounProject != null) {
            return _nounProject!!
        }
        _nounProject = VectorAssetBuilder(name = "NounProject", defaultWidth = 24.0.dp,
...
private var _nounProject: VectorAsset? = null
