...
public val SimpleIcons.Javascript: VectorAsset
    get() {
        if (_javascript != null) {
            return _javascript!!
        }
        _javascript = VectorAssetBuilder(name = "Javascript", defaultWidth = 24.0.dp, defaultHeight
...
private var _javascript: VectorAsset? = null
