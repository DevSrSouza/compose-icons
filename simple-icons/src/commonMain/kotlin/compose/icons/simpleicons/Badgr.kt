...
public val SimpleIcons.Badgr: VectorAsset
    get() {
        if (_badgr != null) {
            return _badgr!!
        }
        _badgr = VectorAssetBuilder(name = "Badgr", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _badgr: VectorAsset? = null
