...
public val SimpleIcons.Expo: VectorAsset
    get() {
        if (_expo != null) {
            return _expo!!
        }
        _expo = VectorAssetBuilder(name = "Expo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _expo: VectorAsset? = null
