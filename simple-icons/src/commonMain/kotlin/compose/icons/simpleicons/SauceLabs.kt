...
public val SimpleIcons.SauceLabs: VectorAsset
    get() {
        if (_sauceLabs != null) {
            return _sauceLabs!!
        }
        _sauceLabs = VectorAssetBuilder(name = "SauceLabs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sauceLabs: VectorAsset? = null
