...
public val SimpleIcons.Adblock: VectorAsset
    get() {
        if (_adblock != null) {
            return _adblock!!
        }
        _adblock = VectorAssetBuilder(name = "Adblock", defaultWidth = 24.0.dp, defaultHeight =
...
private var _adblock: VectorAsset? = null
