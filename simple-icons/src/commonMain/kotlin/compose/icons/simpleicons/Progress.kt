...
public val SimpleIcons.Progress: VectorAsset
    get() {
        if (_progress != null) {
            return _progress!!
        }
        _progress = VectorAssetBuilder(name = "Progress", defaultWidth = 24.0.dp, defaultHeight =
...
private var _progress: VectorAsset? = null
