...
public val SimpleIcons.Pfsense: VectorAsset
    get() {
        if (_pfsense != null) {
            return _pfsense!!
        }
        _pfsense = VectorAssetBuilder(name = "Pfsense", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pfsense: VectorAsset? = null
