...
public val SimpleIcons.TrendMicro: VectorAsset
    get() {
        if (_trendMicro != null) {
            return _trendMicro!!
        }
        _trendMicro = VectorAssetBuilder(name = "TrendMicro", defaultWidth = 24.0.dp, defaultHeight
...
private var _trendMicro: VectorAsset? = null
