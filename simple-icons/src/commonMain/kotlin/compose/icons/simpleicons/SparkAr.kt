...
public val SimpleIcons.SparkAr: VectorAsset
    get() {
        if (_sparkAr != null) {
            return _sparkAr!!
        }
        _sparkAr = VectorAssetBuilder(name = "SparkAr", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sparkAr: VectorAsset? = null
