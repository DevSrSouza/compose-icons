...
public val SimpleIcons.Buddy: VectorAsset
    get() {
        if (_buddy != null) {
            return _buddy!!
        }
        _buddy = VectorAssetBuilder(name = "Buddy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.7f, 5.307f)
                lineTo(12.947f, 0.253f)
                arcToRelative(1.892f, 1.892f, 0.0f, false, false, -1.891f, 0.0f)
                lineTo(2.3f, 5.306f)
                arcToRelative(1.892f, 1.892f, 0.0f, false, false, -0.945f, 1.638f)
                verticalLineToRelative(10.109f)
...
private var _buddy: VectorAsset? = null
