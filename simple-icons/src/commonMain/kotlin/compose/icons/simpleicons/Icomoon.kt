...
public val SimpleIcons.Icomoon: VectorAsset
    get() {
        if (_icomoon != null) {
            return _icomoon!!
        }
        _icomoon = VectorAssetBuilder(name = "Icomoon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icomoon: VectorAsset? = null
