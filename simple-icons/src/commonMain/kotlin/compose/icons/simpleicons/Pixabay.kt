...
public val SimpleIcons.Pixabay: VectorAsset
    get() {
        if (_pixabay != null) {
            return _pixabay!!
        }
        _pixabay = VectorAssetBuilder(name = "Pixabay", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pixabay: VectorAsset? = null
