...
public val SimpleIcons.AboutDotMe: VectorAsset
    get() {
        if (_aboutDotMe != null) {
            return _aboutDotMe!!
        }
        _aboutDotMe = VectorAssetBuilder(name = "AboutDotMe", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.536f, 9.15f)
                ...
                curveToRelative(0.4f, -0.464f, 1.302f, -1.26f, 2.71f, -1.26f)
                curveToRelative(1.247f, 0.0f, 2.096f, 0.525f, 2.477f, 1.59f)
                curveToRelative(0.524f, -0.762f, 1.5f, -1.59f, 2.91f, -1.59f)
                curveToRelative(1.7f, 0.0f, 2.69f, 1.01f, 2.69f, 2.962f)
                verticalLineToRelative(6.24f)
...
private var _aboutDotMe: VectorAsset? = null
