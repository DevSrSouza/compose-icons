...
public val SimpleIcons.Oracle: VectorAsset
    get() {
        if (_oracle != null) {
            return _oracle!!
        }
        _oracle = VectorAssetBuilder(name = "Oracle", defaultWidth = 24.0.dp, defaultHeight =
...
private var _oracle: VectorAsset? = null
