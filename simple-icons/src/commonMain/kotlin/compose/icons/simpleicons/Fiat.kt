...
public val SimpleIcons.Fiat: VectorAsset
    get() {
        if (_fiat != null) {
            return _fiat!!
        }
        _fiat = VectorAssetBuilder(name = "Fiat", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fiat: VectorAsset? = null
