...
public val SimpleIcons.StackExchange: VectorAsset
    get() {
        if (_stackExchange != null) {
            return _stackExchange!!
        }
        _stackExchange = VectorAssetBuilder(name = "StackExchange", defaultWidth = 24.0.dp,
...
private var _stackExchange: VectorAsset? = null
