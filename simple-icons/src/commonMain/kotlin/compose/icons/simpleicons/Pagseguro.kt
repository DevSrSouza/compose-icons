...
public val SimpleIcons.Pagseguro: VectorAsset
    get() {
        if (_pagseguro != null) {
            return _pagseguro!!
        }
        _pagseguro = VectorAssetBuilder(name = "Pagseguro", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pagseguro: VectorAsset? = null
