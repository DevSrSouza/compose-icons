...
public val SimpleIcons.Metafilter: VectorAsset
    get() {
        if (_metafilter != null) {
            return _metafilter!!
        }
        _metafilter = VectorAssetBuilder(name = "Metafilter", defaultWidth = 24.0.dp, defaultHeight
...
private var _metafilter: VectorAsset? = null
