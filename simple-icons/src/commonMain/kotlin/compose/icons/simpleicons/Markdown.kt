...
public val SimpleIcons.Markdown: VectorAsset
    get() {
        if (_markdown != null) {
            return _markdown!!
        }
        _markdown = VectorAssetBuilder(name = "Markdown", defaultWidth = 24.0.dp, defaultHeight =
...
private var _markdown: VectorAsset? = null
