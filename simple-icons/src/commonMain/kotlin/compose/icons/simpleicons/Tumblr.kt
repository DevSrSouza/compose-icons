...
public val SimpleIcons.Tumblr: VectorAsset
    get() {
        if (_tumblr != null) {
            return _tumblr!!
        }
        _tumblr = VectorAssetBuilder(name = "Tumblr", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tumblr: VectorAsset? = null
