...
public val SimpleIcons.Mattermost: VectorAsset
    get() {
        if (_mattermost != null) {
            return _mattermost!!
        }
        _mattermost = VectorAssetBuilder(name = "Mattermost", defaultWidth = 24.0.dp, defaultHeight
...
private var _mattermost: VectorAsset? = null
