...
public val SimpleIcons.MonkeyTie: VectorAsset
    get() {
        if (_monkeyTie != null) {
            return _monkeyTie!!
        }
        _monkeyTie = VectorAssetBuilder(name = "MonkeyTie", defaultWidth = 24.0.dp, defaultHeight =
...
private var _monkeyTie: VectorAsset? = null
