...
public val SimpleIcons.Tasmota: VectorAsset
    get() {
        if (_tasmota != null) {
            return _tasmota!!
        }
        _tasmota = VectorAssetBuilder(name = "Tasmota", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tasmota: VectorAsset? = null
