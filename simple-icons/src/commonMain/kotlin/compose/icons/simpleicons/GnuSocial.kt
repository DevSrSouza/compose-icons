...
public val SimpleIcons.GnuSocial: VectorAsset
    get() {
        if (_gnuSocial != null) {
            return _gnuSocial!!
        }
        _gnuSocial = VectorAssetBuilder(name = "GnuSocial", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gnuSocial: VectorAsset? = null
