...
public val SimpleIcons.NintendoSwitch: VectorAsset
    get() {
        if (_nintendoSwitch != null) {
            return _nintendoSwitch!!
        }
        _nintendoSwitch = VectorAssetBuilder(name = "NintendoSwitch", defaultWidth = 24.0.dp,
...
private var _nintendoSwitch: VectorAsset? = null
