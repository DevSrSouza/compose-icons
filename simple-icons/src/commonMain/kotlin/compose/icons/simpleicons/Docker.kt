...
public val SimpleIcons.Docker: VectorAsset
    get() {
        if (_docker != null) {
            return _docker!!
        }
        _docker = VectorAssetBuilder(name = "Docker", defaultWidth = 24.0.dp, defaultHeight =
...
private var _docker: VectorAsset? = null
