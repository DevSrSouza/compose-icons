...
public val SimpleIcons.Hackerrank: VectorAsset
    get() {
        if (_hackerrank != null) {
            return _hackerrank!!
        }
        _hackerrank = VectorAssetBuilder(name = "Hackerrank", defaultWidth = 24.0.dp, defaultHeight
...
private var _hackerrank: VectorAsset? = null
