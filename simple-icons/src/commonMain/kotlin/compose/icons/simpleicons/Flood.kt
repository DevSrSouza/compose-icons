...
public val SimpleIcons.Flood: VectorAsset
    get() {
        if (_flood != null) {
            return _flood!!
        }
        _flood = VectorAssetBuilder(name = "Flood", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flood: VectorAsset? = null
