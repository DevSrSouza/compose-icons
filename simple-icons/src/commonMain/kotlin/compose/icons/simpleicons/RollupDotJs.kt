...
public val SimpleIcons.RollupDotJs: VectorAsset
    get() {
        if (_rollupDotJs != null) {
            return _rollupDotJs!!
        }
        _rollupDotJs = VectorAssetBuilder(name = "RollupDotJs", defaultWidth = 24.0.dp,
...
private var _rollupDotJs: VectorAsset? = null
