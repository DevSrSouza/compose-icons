...
public val SimpleIcons.Pluralsight: VectorAsset
    get() {
        if (_pluralsight != null) {
            return _pluralsight!!
        }
        _pluralsight = VectorAssetBuilder(name = "Pluralsight", defaultWidth = 24.0.dp,
...
private var _pluralsight: VectorAsset? = null
