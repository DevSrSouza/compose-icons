...
public val SimpleIcons.Caterpillar: VectorAsset
    get() {
        if (_caterpillar != null) {
            return _caterpillar!!
        }
        _caterpillar = VectorAssetBuilder(name = "Caterpillar", defaultWidth = 24.0.dp,
...
private var _caterpillar: VectorAsset? = null
