...
public val SimpleIcons.Foursquare: VectorAsset
    get() {
        if (_foursquare != null) {
            return _foursquare!!
        }
        _foursquare = VectorAssetBuilder(name = "Foursquare", defaultWidth = 24.0.dp, defaultHeight
...
private var _foursquare: VectorAsset? = null
