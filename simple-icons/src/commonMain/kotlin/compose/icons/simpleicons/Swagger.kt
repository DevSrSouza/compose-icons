...
public val SimpleIcons.Swagger: VectorAsset
    get() {
        if (_swagger != null) {
            return _swagger!!
        }
        _swagger = VectorAssetBuilder(name = "Swagger", defaultWidth = 24.0.dp, defaultHeight =
...
private var _swagger: VectorAsset? = null
