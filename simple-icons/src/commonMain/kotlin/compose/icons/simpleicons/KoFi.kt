...
public val SimpleIcons.KoFi: VectorAsset
    get() {
        if (_koFi != null) {
            return _koFi!!
        }
        _koFi = VectorAssetBuilder(name = "KoFi", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _koFi: VectorAsset? = null
