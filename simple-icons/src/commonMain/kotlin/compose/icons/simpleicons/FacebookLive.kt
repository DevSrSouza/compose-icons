...
public val SimpleIcons.FacebookLive: VectorAsset
    get() {
        if (_facebookLive != null) {
            return _facebookLive!!
        }
        _facebookLive = VectorAssetBuilder(name = "FacebookLive", defaultWidth = 24.0.dp,
...
private var _facebookLive: VectorAsset? = null
