...
public val SimpleIcons.AffinityPublisher: VectorAsset
    get() {
        if (_affinityPublisher != null) {
            return _affinityPublisher!!
        }
        _affinityPublisher = VectorAssetBuilder(name = "AffinityPublisher", defaultWidth = 24.0.dp,
...
private var _affinityPublisher: VectorAsset? = null
