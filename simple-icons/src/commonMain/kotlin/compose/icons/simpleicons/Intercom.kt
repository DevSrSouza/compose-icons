...
public val SimpleIcons.Intercom: VectorAsset
    get() {
        if (_intercom != null) {
            return _intercom!!
        }
        _intercom = VectorAssetBuilder(name = "Intercom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _intercom: VectorAsset? = null
