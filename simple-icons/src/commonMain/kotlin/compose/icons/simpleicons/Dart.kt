...
public val SimpleIcons.Dart: VectorAsset
    get() {
        if (_dart != null) {
            return _dart!!
        }
        _dart = VectorAssetBuilder(name = "Dart", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _dart: VectorAsset? = null
