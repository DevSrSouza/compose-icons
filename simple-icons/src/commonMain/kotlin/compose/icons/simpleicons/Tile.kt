...
public val SimpleIcons.Tile: VectorAsset
    get() {
        if (_tile != null) {
            return _tile!!
        }
        _tile = VectorAssetBuilder(name = "Tile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tile: VectorAsset? = null
