...
public val SimpleIcons.Yelp: VectorAsset
    get() {
        if (_yelp != null) {
            return _yelp!!
        }
        _yelp = VectorAssetBuilder(name = "Yelp", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _yelp: VectorAsset? = null
