...
public val SimpleIcons.Lubuntu: VectorAsset
    get() {
        if (_lubuntu != null) {
            return _lubuntu!!
        }
        _lubuntu = VectorAssetBuilder(name = "Lubuntu", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lubuntu: VectorAsset? = null
