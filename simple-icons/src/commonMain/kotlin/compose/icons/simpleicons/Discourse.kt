...
public val SimpleIcons.Discourse: VectorAsset
    get() {
        if (_discourse != null) {
            return _discourse!!
        }
        _discourse = VectorAssetBuilder(name = "Discourse", defaultWidth = 24.0.dp, defaultHeight =
...
private var _discourse: VectorAsset? = null
