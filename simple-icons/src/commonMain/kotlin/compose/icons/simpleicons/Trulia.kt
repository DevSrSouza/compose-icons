...
public val SimpleIcons.Trulia: VectorAsset
    get() {
        if (_trulia != null) {
            return _trulia!!
        }
        _trulia = VectorAssetBuilder(name = "Trulia", defaultWidth = 24.0.dp, defaultHeight =
...
private var _trulia: VectorAsset? = null
