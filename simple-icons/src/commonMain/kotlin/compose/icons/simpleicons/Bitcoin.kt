...
public val SimpleIcons.Bitcoin: VectorAsset
    get() {
        if (_bitcoin != null) {
            return _bitcoin!!
        }
        _bitcoin = VectorAssetBuilder(name = "Bitcoin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bitcoin: VectorAsset? = null
