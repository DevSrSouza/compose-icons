...
public val SimpleIcons.Vonage: VectorAsset
    get() {
        if (_vonage != null) {
            return _vonage!!
        }
        _vonage = VectorAssetBuilder(name = "Vonage", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vonage: VectorAsset? = null
