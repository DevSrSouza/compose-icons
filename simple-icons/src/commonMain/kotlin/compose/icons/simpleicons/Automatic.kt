...
public val SimpleIcons.Automatic: VectorAsset
    get() {
        if (_automatic != null) {
            return _automatic!!
        }
        _automatic = VectorAssetBuilder(name = "Automatic", defaultWidth = 24.0.dp, defaultHeight =
...
private var _automatic: VectorAsset? = null
