...
public val SimpleIcons.Xaml: VectorAsset
    get() {
        if (_xaml != null) {
            return _xaml!!
        }
        _xaml = VectorAssetBuilder(name = "Xaml", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _xaml: VectorAsset? = null
