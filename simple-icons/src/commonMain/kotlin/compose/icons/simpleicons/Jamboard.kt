...
public val SimpleIcons.Jamboard: VectorAsset
    get() {
        if (_jamboard != null) {
            return _jamboard!!
        }
        _jamboard = VectorAssetBuilder(name = "Jamboard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _jamboard: VectorAsset? = null
