...
public val SimpleIcons.Amazoneks: ImageVector
    get() {
        if (_amazoneks != null) {
            return _amazoneks!!
        }
        _amazoneks = Builder(name = "Amazoneks", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(14.67f, 8.505f)
                lineToRelative(-2.875f, 3.335f)
                lineToRelative(3.128f, 3.648f)
                horizontalLineToRelative(-1.168f)
                lineToRelative(-2.808f, -3.277f)
                verticalLineToRelative(3.368f)
                horizontalLineToRelative(-0.842f)
                lineTo(10.105f, 8.421f)
                horizontalLineToRelative(0.842f)
                verticalLineToRelative(2.947f)
                lineToRelative(2.603f, -2.863f)
                close()
                moveTo(21.895f, 15.256f)
                lineTo(18.526f, 13.235f)
...
private var _amazoneks: ImageVector? = null
