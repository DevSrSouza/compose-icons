...
public val SimpleIcons.Blackberry: VectorAsset
    get() {
        if (_blackberry != null) {
            return _blackberry!!
        }
        _blackberry = VectorAssetBuilder(name = "Blackberry", defaultWidth = 24.0.dp, defaultHeight
...
private var _blackberry: VectorAsset? = null
