...
public val SimpleIcons.Brandfolder: VectorAsset
    get() {
        if (_brandfolder != null) {
            return _brandfolder!!
        }
        _brandfolder = VectorAssetBuilder(name = "Brandfolder", defaultWidth = 24.0.dp,
...
private var _brandfolder: VectorAsset? = null
