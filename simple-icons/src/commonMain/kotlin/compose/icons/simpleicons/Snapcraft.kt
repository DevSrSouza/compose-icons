...
public val SimpleIcons.Snapcraft: VectorAsset
    get() {
        if (_snapcraft != null) {
            return _snapcraft!!
        }
        _snapcraft = VectorAssetBuilder(name = "Snapcraft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _snapcraft: VectorAsset? = null
