...
public val SimpleIcons.Deliveroo: VectorAsset
    get() {
        if (_deliveroo != null) {
            return _deliveroo!!
        }
        _deliveroo = VectorAssetBuilder(name = "Deliveroo", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deliveroo: VectorAsset? = null
