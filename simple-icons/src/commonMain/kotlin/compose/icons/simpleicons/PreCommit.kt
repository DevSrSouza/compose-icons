...
public val SimpleIcons.PreCommit: VectorAsset
    get() {
        if (_preCommit != null) {
            return _preCommit!!
        }
        _preCommit = VectorAssetBuilder(name = "PreCommit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _preCommit: VectorAsset? = null
