...
public val SimpleIcons.Zenn: VectorAsset
    get() {
        if (_zenn != null) {
            return _zenn!!
        }
        _zenn = VectorAssetBuilder(name = "Zenn", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _zenn: VectorAsset? = null
