...
public val SimpleIcons.Tado: VectorAsset
    get() {
        if (_tado != null) {
            return _tado!!
        }
        _tado = VectorAssetBuilder(name = "Tado", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tado: VectorAsset? = null
