...
public val SimpleIcons.Elementary: VectorAsset
    get() {
        if (_elementary != null) {
            return _elementary!!
        }
        _elementary = VectorAssetBuilder(name = "Elementary", defaultWidth = 24.0.dp, defaultHeight
...
private var _elementary: VectorAsset? = null
