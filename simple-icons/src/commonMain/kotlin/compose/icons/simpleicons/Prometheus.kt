...
public val SimpleIcons.Prometheus: VectorAsset
    get() {
        if (_prometheus != null) {
            return _prometheus!!
        }
        _prometheus = VectorAssetBuilder(name = "Prometheus", defaultWidth = 24.0.dp, defaultHeight
...
private var _prometheus: VectorAsset? = null
