...
public val SimpleIcons.ZendFramework: VectorAsset
    get() {
        if (_zendFramework != null) {
            return _zendFramework!!
        }
        _zendFramework = VectorAssetBuilder(name = "ZendFramework", defaultWidth = 24.0.dp,
...
private var _zendFramework: VectorAsset? = null
