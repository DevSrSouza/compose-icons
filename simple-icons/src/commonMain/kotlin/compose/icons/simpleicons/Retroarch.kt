...
public val SimpleIcons.Retroarch: VectorAsset
    get() {
        if (_retroarch != null) {
            return _retroarch!!
        }
        _retroarch = VectorAssetBuilder(name = "Retroarch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _retroarch: VectorAsset? = null
