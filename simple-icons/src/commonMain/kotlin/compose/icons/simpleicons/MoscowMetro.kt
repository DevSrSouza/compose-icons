...
public val SimpleIcons.MoscowMetro: VectorAsset
    get() {
        if (_moscowMetro != null) {
            return _moscowMetro!!
        }
        _moscowMetro = VectorAssetBuilder(name = "MoscowMetro", defaultWidth = 24.0.dp,
...
private var _moscowMetro: VectorAsset? = null
