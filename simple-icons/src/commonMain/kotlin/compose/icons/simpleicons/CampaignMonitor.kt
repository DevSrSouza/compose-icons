...
public val SimpleIcons.CampaignMonitor: VectorAsset
    get() {
        if (_campaignMonitor != null) {
            return _campaignMonitor!!
        }
        _campaignMonitor = VectorAssetBuilder(name = "CampaignMonitor", defaultWidth = 24.0.dp,
...
private var _campaignMonitor: VectorAsset? = null
