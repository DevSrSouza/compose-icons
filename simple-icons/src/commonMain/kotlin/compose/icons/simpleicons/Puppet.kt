...
public val SimpleIcons.Puppet: VectorAsset
    get() {
        if (_puppet != null) {
            return _puppet!!
        }
        _puppet = VectorAssetBuilder(name = "Puppet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _puppet: VectorAsset? = null
