...
public val SimpleIcons.MaterialDesign: VectorAsset
    get() {
        if (_materialDesign != null) {
            return _materialDesign!!
        }
        _materialDesign = VectorAssetBuilder(name = "MaterialDesign", defaultWidth = 24.0.dp,
...
private var _materialDesign: VectorAsset? = null
