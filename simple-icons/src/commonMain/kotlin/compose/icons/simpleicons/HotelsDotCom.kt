...
public val SimpleIcons.HotelsDotCom: VectorAsset
    get() {
        if (_hotelsDotCom != null) {
            return _hotelsDotCom!!
        }
        _hotelsDotCom = VectorAssetBuilder(name = "HotelsDotCom", defaultWidth = 24.0.dp,
...
private var _hotelsDotCom: VectorAsset? = null
