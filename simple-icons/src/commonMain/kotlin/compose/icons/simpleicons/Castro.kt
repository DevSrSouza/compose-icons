...
public val SimpleIcons.Castro: VectorAsset
    get() {
        if (_castro != null) {
            return _castro!!
        }
        _castro = VectorAssetBuilder(name = "Castro", defaultWidth = 24.0.dp, defaultHeight =
...
private var _castro: VectorAsset? = null
