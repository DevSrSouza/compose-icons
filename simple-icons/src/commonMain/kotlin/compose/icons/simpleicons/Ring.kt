...
public val SimpleIcons.Ring: VectorAsset
    get() {
        if (_ring != null) {
            return _ring!!
        }
        _ring = VectorAssetBuilder(name = "Ring", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ring: VectorAsset? = null
