...
public val SimpleIcons.Publons: VectorAsset
    get() {
        if (_publons != null) {
            return _publons!!
        }
        _publons = VectorAssetBuilder(name = "Publons", defaultWidth = 24.0.dp, defaultHeight =
...
private var _publons: VectorAsset? = null
