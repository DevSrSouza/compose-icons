...
public val SimpleIcons.Fortran: VectorAsset
    get() {
        if (_fortran != null) {
            return _fortran!!
        }
        _fortran = VectorAssetBuilder(name = "Fortran", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fortran: VectorAsset? = null
