...
public val SimpleIcons.Ideal: VectorAsset
    get() {
        if (_ideal != null) {
            return _ideal!!
        }
        _ideal = VectorAssetBuilder(name = "Ideal", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ideal: VectorAsset? = null
