...
public val SimpleIcons.Uploaded: VectorAsset
    get() {
        if (_uploaded != null) {
            return _uploaded!!
        }
        _uploaded = VectorAssetBuilder(name = "Uploaded", defaultWidth = 24.0.dp, defaultHeight =
...
private var _uploaded: VectorAsset? = null
