...
public val SimpleIcons.Chocolatey: VectorAsset
    get() {
        if (_chocolatey != null) {
            return _chocolatey!!
        }
        _chocolatey = VectorAssetBuilder(name = "Chocolatey", defaultWidth = 24.0.dp, defaultHeight
...
private var _chocolatey: VectorAsset? = null
