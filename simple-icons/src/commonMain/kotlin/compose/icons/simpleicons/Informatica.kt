...
public val SimpleIcons.Informatica: VectorAsset
    get() {
        if (_informatica != null) {
            return _informatica!!
        }
        _informatica = VectorAssetBuilder(name = "Informatica", defaultWidth = 24.0.dp,
...
private var _informatica: VectorAsset? = null
