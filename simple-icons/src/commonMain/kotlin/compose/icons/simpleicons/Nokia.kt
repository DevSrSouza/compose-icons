...
public val SimpleIcons.Nokia: VectorAsset
    get() {
        if (_nokia != null) {
            return _nokia!!
        }
        _nokia = VectorAssetBuilder(name = "Nokia", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _nokia: VectorAsset? = null
