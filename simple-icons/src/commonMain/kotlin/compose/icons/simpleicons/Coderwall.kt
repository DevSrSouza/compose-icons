...
public val SimpleIcons.Coderwall: VectorAsset
    get() {
        if (_coderwall != null) {
            return _coderwall!!
        }
        _coderwall = VectorAssetBuilder(name = "Coderwall", defaultWidth = 24.0.dp, defaultHeight =
...
private var _coderwall: VectorAsset? = null
