...
public val SimpleIcons.Shopify: VectorAsset
    get() {
        if (_shopify != null) {
            return _shopify!!
        }
        _shopify = VectorAssetBuilder(name = "Shopify", defaultWidth = 24.0.dp, defaultHeight =
...
private var _shopify: VectorAsset? = null
