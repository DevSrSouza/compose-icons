...
public val SimpleIcons.Storybook: VectorAsset
    get() {
        if (_storybook != null) {
            return _storybook!!
        }
        _storybook = VectorAssetBuilder(name = "Storybook", defaultWidth = 24.0.dp, defaultHeight =
...
private var _storybook: VectorAsset? = null
