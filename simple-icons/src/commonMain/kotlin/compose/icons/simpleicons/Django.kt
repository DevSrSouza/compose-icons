...
public val SimpleIcons.Django: VectorAsset
    get() {
        if (_django != null) {
            return _django!!
        }
        _django = VectorAssetBuilder(name = "Django", defaultWidth = 24.0.dp, defaultHeight =
...
private var _django: VectorAsset? = null
