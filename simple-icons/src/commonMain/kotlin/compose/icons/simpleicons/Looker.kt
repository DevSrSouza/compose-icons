...
public val SimpleIcons.Looker: VectorAsset
    get() {
        if (_looker != null) {
            return _looker!!
        }
        _looker = VectorAssetBuilder(name = "Looker", defaultWidth = 24.0.dp, defaultHeight =
...
private var _looker: VectorAsset? = null
