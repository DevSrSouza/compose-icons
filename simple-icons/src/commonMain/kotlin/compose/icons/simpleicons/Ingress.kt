...
public val SimpleIcons.Ingress: VectorAsset
    get() {
        if (_ingress != null) {
            return _ingress!!
        }
        _ingress = VectorAssetBuilder(name = "Ingress", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ingress: VectorAsset? = null
