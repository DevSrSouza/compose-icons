...
public val SimpleIcons.NewYorkTimes: VectorAsset
    get() {
        if (_newYorkTimes != null) {
            return _newYorkTimes!!
        }
        _newYorkTimes = VectorAssetBuilder(name = "NewYorkTimes", defaultWidth = 24.0.dp,
...
private var _newYorkTimes: VectorAsset? = null
