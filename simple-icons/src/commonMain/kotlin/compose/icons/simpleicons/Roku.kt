...
public val SimpleIcons.Roku: VectorAsset
    get() {
        if (_roku != null) {
            return _roku!!
        }
        _roku = VectorAssetBuilder(name = "Roku", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _roku: VectorAsset? = null
