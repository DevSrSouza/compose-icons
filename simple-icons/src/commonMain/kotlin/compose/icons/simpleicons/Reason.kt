...
public val SimpleIcons.Reason: VectorAsset
    get() {
        if (_reason != null) {
            return _reason!!
        }
        _reason = VectorAssetBuilder(name = "Reason", defaultWidth = 24.0.dp, defaultHeight =
...
private var _reason: VectorAsset? = null
