...
public val SimpleIcons.Klout: VectorAsset
    get() {
        if (_klout != null) {
            return _klout!!
        }
        _klout = VectorAssetBuilder(name = "Klout", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _klout: VectorAsset? = null
