...
public val SimpleIcons.Ipfs: VectorAsset
    get() {
        if (_ipfs != null) {
            return _ipfs!!
        }
        _ipfs = VectorAssetBuilder(name = "Ipfs", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ipfs: VectorAsset? = null
