...
public val SimpleIcons.Chevrolet: VectorAsset
    get() {
        if (_chevrolet != null) {
            return _chevrolet!!
        }
        _chevrolet = VectorAssetBuilder(name = "Chevrolet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _chevrolet: VectorAsset? = null
