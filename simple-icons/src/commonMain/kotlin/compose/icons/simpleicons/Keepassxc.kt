...
public val SimpleIcons.Keepassxc: VectorAsset
    get() {
        if (_keepassxc != null) {
            return _keepassxc!!
        }
        _keepassxc = VectorAssetBuilder(name = "Keepassxc", defaultWidth = 24.0.dp, defaultHeight =
...
private var _keepassxc: VectorAsset? = null
