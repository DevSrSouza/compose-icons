...
public val SimpleIcons.AngularUniversal: VectorAsset
    get() {
        if (_angularUniversal != null) {
            return _angularUniversal!!
        }
        _angularUniversal = VectorAssetBuilder(name = "AngularUniversal", defaultWidth = 24.0.dp,
...
private var _angularUniversal: VectorAsset? = null
