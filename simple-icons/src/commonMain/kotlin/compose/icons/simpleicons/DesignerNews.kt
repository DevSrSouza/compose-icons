...
public val SimpleIcons.DesignerNews: VectorAsset
    get() {
        if (_designerNews != null) {
            return _designerNews!!
        }
        _designerNews = VectorAssetBuilder(name = "DesignerNews", defaultWidth = 24.0.dp,
...
private var _designerNews: VectorAsset? = null
