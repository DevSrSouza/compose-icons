...
public val SimpleIcons.GoogleAds: VectorAsset
    get() {
        if (_googleAds != null) {
            return _googleAds!!
        }
        _googleAds = VectorAssetBuilder(name = "GoogleAds", defaultWidth = 24.0.dp, defaultHeight =
...
private var _googleAds: VectorAsset? = null
