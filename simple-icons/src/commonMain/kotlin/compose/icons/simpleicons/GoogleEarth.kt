...
public val SimpleIcons.GoogleEarth: VectorAsset
    get() {
        if (_googleEarth != null) {
            return _googleEarth!!
        }
        _googleEarth = VectorAssetBuilder(name = "GoogleEarth", defaultWidth = 24.0.dp,
...
private var _googleEarth: VectorAsset? = null
