...
public val SimpleIcons.Everplaces: ImageVector
    get() {
        if (_everplaces != null) {
            return _everplaces!!
        }
        _everplaces = Builder(name = "Everplaces", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _everplaces: ImageVector? = null
