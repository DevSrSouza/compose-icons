...
public val SimpleIcons.Mastercard: VectorAsset
    get() {
        if (_mastercard != null) {
            return _mastercard!!
        }
        _mastercard = VectorAssetBuilder(name = "Mastercard", defaultWidth = 24.0.dp, defaultHeight
...
private var _mastercard: VectorAsset? = null
