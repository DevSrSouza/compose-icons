...
public val SimpleIcons.Cmake: VectorAsset
    get() {
        if (_cmake != null) {
            return _cmake!!
        }
        _cmake = VectorAssetBuilder(name = "Cmake", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cmake: VectorAsset? = null
