...
public val SimpleIcons.Express: VectorAsset
    get() {
        if (_express != null) {
            return _express!!
        }
        _express = VectorAssetBuilder(name = "Express", defaultWidth = 24.0.dp, defaultHeight =
...
private var _express: VectorAsset? = null
