...
public val SimpleIcons.GoogleKeep: VectorAsset
    get() {
        if (_googleKeep != null) {
            return _googleKeep!!
        }
        _googleKeep = VectorAssetBuilder(name = "GoogleKeep", defaultWidth = 24.0.dp, defaultHeight
...
private var _googleKeep: VectorAsset? = null
