...
public val SimpleIcons.Swiper: VectorAsset
    get() {
        if (_swiper != null) {
            return _swiper!!
        }
        _swiper = VectorAssetBuilder(name = "Swiper", defaultWidth = 24.0.dp, defaultHeight =
...
private var _swiper: VectorAsset? = null
