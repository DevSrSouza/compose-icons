...
public val SimpleIcons.Kickstarter: VectorAsset
    get() {
        if (_kickstarter != null) {
            return _kickstarter!!
        }
        _kickstarter = VectorAssetBuilder(name = "Kickstarter", defaultWidth = 24.0.dp,
...
private var _kickstarter: VectorAsset? = null
