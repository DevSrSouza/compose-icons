...
public val SimpleIcons.Buzzfeed: VectorAsset
    get() {
        if (_buzzfeed != null) {
            return _buzzfeed!!
        }
        _buzzfeed = VectorAssetBuilder(name = "Buzzfeed", defaultWidth = 24.0.dp, defaultHeight =
...
private var _buzzfeed: VectorAsset? = null
