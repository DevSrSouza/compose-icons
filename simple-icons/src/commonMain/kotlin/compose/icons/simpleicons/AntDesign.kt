...
public val SimpleIcons.AntDesign: VectorAsset
    get() {
        if (_antDesign != null) {
            return _antDesign!!
        }
        _antDesign = VectorAssetBuilder(name = "AntDesign", defaultWidth = 24.0.dp, defaultHeight =
...
private var _antDesign: VectorAsset? = null
