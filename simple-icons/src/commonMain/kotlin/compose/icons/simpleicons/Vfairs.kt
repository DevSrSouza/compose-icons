...
public val SimpleIcons.Vfairs: VectorAsset
    get() {
        if (_vfairs != null) {
            return _vfairs!!
        }
        _vfairs = VectorAssetBuilder(name = "Vfairs", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vfairs: VectorAsset? = null
