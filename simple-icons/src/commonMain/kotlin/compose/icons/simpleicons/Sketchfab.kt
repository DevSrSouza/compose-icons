...
public val SimpleIcons.Sketchfab: VectorAsset
    get() {
        if (_sketchfab != null) {
            return _sketchfab!!
        }
        _sketchfab = VectorAssetBuilder(name = "Sketchfab", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sketchfab: VectorAsset? = null
