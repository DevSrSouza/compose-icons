...
public val SimpleIcons.Pagerduty: VectorAsset
    get() {
        if (_pagerduty != null) {
            return _pagerduty!!
        }
        _pagerduty = VectorAssetBuilder(name = "Pagerduty", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pagerduty: VectorAsset? = null
