...
public val SimpleIcons.Audible: VectorAsset
    get() {
        if (_audible != null) {
            return _audible!!
        }
        _audible = VectorAssetBuilder(name = "Audible", defaultWidth = 24.0.dp, defaultHeight =
...
private var _audible: VectorAsset? = null
