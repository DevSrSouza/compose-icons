...
public val SimpleIcons.Hockeyapp: VectorAsset
    get() {
        if (_hockeyapp != null) {
            return _hockeyapp!!
        }
        _hockeyapp = VectorAssetBuilder(name = "Hockeyapp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hockeyapp: VectorAsset? = null
