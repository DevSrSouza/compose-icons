...
public val SimpleIcons.TheSoundsResource: VectorAsset
    get() {
        if (_theSoundsResource != null) {
            return _theSoundsResource!!
        }
        _theSoundsResource = VectorAssetBuilder(name = "TheSoundsResource", defaultWidth = 24.0.dp,
...
private var _theSoundsResource: VectorAsset? = null
