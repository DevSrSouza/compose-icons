...
public val SimpleIcons.SourceEngine: VectorAsset
    get() {
        if (_sourceEngine != null) {
            return _sourceEngine!!
        }
        _sourceEngine = VectorAssetBuilder(name = "SourceEngine", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.865f, 0.718f)
                horizontalLineToRelative(-0.26f)
                lineTo(7.64f, 0.786f)
                curveTo(5.169f, 0.659f, 2.735f, 1.264f, 0.63f, 2.475f)
                lineToRelative(0.002f, 0.002f)
                arcToRelative(1.211f, 1.211f, 0.0f, false, false, 0.578f, 2.274f)
                ...
                curveToRelative(0.049f, -0.118f, 4.952f, -12.061f, 4.964f, -12.093f)
                arcTo(3.992f, 3.992f, 0.0f, false, false, 21.522f, 0.998f)
                curveToRelative(-0.55f, -0.226f, -1.064f, -0.278f, -1.657f, -0.28f)
                close()
                moveTo(6.067f, 6.853f)
                curveToRelative(-2.635f, 0.0f, -5.342f, 0.807f, -5.342f, 3.941f)
                curveToRelative(0.0f, 2.16f, 1.946f, 2.849f, 3.893f, 3.277f)
                curveToRelative(2.422f, 0.522f, 3.823f, 0.878f, 3.823f, 1.899f)
                curveToRelative(0.0f, 1.188f, -1.235f, 1.568f, -2.208f, 1.568f)
                ...
                curveToRelative(-1.923f, -0.451f, -3.823f, -0.617f, -3.823f, -1.828f)
...
private var _sourceEngine: VectorAsset? = null
