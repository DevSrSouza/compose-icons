...
public val SimpleIcons.TailwindCss: VectorAsset
    get() {
        if (_tailwindCss != null) {
            return _tailwindCss!!
        }
        _tailwindCss = VectorAssetBuilder(name = "TailwindCss", defaultWidth = 24.0.dp,
...
private var _tailwindCss: VectorAsset? = null
