...
public val SimpleIcons.Bloglovin: VectorAsset
    get() {
        if (_bloglovin != null) {
            return _bloglovin!!
        }
        _bloglovin = VectorAssetBuilder(name = "Bloglovin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bloglovin: VectorAsset? = null
