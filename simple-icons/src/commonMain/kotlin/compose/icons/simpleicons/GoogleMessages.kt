...
public val SimpleIcons.GoogleMessages: VectorAsset
    get() {
        if (_googleMessages != null) {
            return _googleMessages!!
        }
        _googleMessages = VectorAssetBuilder(name = "GoogleMessages", defaultWidth = 24.0.dp,
...
private var _googleMessages: VectorAsset? = null
