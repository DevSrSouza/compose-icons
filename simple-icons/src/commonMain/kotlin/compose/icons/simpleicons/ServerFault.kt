...
public val SimpleIcons.ServerFault: VectorAsset
    get() {
        if (_serverFault != null) {
            return _serverFault!!
        }
        _serverFault = VectorAssetBuilder(name = "ServerFault", defaultWidth = 24.0.dp,
...
private var _serverFault: VectorAsset? = null
