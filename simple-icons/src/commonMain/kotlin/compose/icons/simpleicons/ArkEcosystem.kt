...
public val SimpleIcons.ArkEcosystem: VectorAsset
    get() {
        if (_arkEcosystem != null) {
            return _arkEcosystem!!
        }
        _arkEcosystem = VectorAssetBuilder(name = "ArkEcosystem", defaultWidth = 24.0.dp,
...
private var _arkEcosystem: VectorAsset? = null
