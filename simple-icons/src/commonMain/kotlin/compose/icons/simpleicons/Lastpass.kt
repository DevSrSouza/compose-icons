...
public val SimpleIcons.Lastpass: VectorAsset
    get() {
        if (_lastpass != null) {
            return _lastpass!!
        }
        _lastpass = VectorAssetBuilder(name = "Lastpass", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lastpass: VectorAsset? = null
