...
public val SimpleIcons.Claris: VectorAsset
    get() {
        if (_claris != null) {
            return _claris!!
        }
        _claris = VectorAssetBuilder(name = "Claris", defaultWidth = 24.0.dp, defaultHeight =
...
private var _claris: VectorAsset? = null
