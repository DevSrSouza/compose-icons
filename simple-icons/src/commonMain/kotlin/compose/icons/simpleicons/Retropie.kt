...
public val SimpleIcons.Retropie: VectorAsset
    get() {
        if (_retropie != null) {
            return _retropie!!
        }
        _retropie = VectorAssetBuilder(name = "Retropie", defaultWidth = 24.0.dp, defaultHeight =
...
private var _retropie: VectorAsset? = null
