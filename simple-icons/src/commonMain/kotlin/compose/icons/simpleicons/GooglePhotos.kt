...
public val SimpleIcons.GooglePhotos: VectorAsset
    get() {
        if (_googlePhotos != null) {
            return _googlePhotos!!
        }
        _googlePhotos = VectorAssetBuilder(name = "GooglePhotos", defaultWidth = 24.0.dp,
...
private var _googlePhotos: VectorAsset? = null
