...
public val SimpleIcons.SamsungPay: VectorAsset
    get() {
        if (_samsungPay != null) {
            return _samsungPay!!
        }
        _samsungPay = VectorAssetBuilder(name = "SamsungPay", defaultWidth = 24.0.dp, defaultHeight
...
private var _samsungPay: VectorAsset? = null
