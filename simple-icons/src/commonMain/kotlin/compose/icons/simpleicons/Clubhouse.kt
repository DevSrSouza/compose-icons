...
public val SimpleIcons.Clubhouse: VectorAsset
    get() {
        if (_clubhouse != null) {
            return _clubhouse!!
        }
        _clubhouse = VectorAssetBuilder(name = "Clubhouse", defaultWidth = 24.0.dp, defaultHeight =
...
private var _clubhouse: VectorAsset? = null
