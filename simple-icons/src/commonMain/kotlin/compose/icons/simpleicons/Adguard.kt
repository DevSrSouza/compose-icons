...
public val SimpleIcons.Adguard: VectorAsset
    get() {
        if (_adguard != null) {
            return _adguard!!
        }
        _adguard = VectorAssetBuilder(name = "Adguard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _adguard: VectorAsset? = null
