...
public val SimpleIcons.Mastercomfig: VectorAsset
    get() {
        if (_mastercomfig != null) {
            return _mastercomfig!!
        }
        _mastercomfig = VectorAssetBuilder(name = "Mastercomfig", defaultWidth = 24.0.dp,
...
private var _mastercomfig: VectorAsset? = null
