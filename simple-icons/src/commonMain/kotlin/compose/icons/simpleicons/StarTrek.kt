...
public val SimpleIcons.StarTrek: VectorAsset
    get() {
        if (_starTrek != null) {
            return _starTrek!!
        }
        _starTrek = VectorAssetBuilder(name = "StarTrek", defaultWidth = 24.0.dp, defaultHeight =
...
private var _starTrek: VectorAsset? = null
