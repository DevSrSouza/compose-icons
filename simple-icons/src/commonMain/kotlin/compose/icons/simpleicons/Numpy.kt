...
public val SimpleIcons.Numpy: VectorAsset
    get() {
        if (_numpy != null) {
            return _numpy!!
        }
        _numpy = VectorAssetBuilder(name = "Numpy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _numpy: VectorAsset? = null
