...
public val SimpleIcons.GoogleDrive: VectorAsset
    get() {
        if (_googleDrive != null) {
            return _googleDrive!!
        }
        _googleDrive = VectorAssetBuilder(name = "GoogleDrive", defaultWidth = 24.0.dp,
...
private var _googleDrive: VectorAsset? = null
