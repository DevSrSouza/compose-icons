...
public val SimpleIcons.Tinyletter: VectorAsset
    get() {
        if (_tinyletter != null) {
            return _tinyletter!!
        }
        _tinyletter = VectorAssetBuilder(name = "Tinyletter", defaultWidth = 24.0.dp, defaultHeight
...
private var _tinyletter: VectorAsset? = null
