...
public val SimpleIcons.Zelle: VectorAsset
    get() {
        if (_zelle != null) {
            return _zelle!!
        }
        _zelle = VectorAssetBuilder(name = "Zelle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _zelle: VectorAsset? = null
