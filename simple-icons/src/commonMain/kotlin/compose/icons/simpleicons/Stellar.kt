...
public val SimpleIcons.Stellar: VectorAsset
    get() {
        if (_stellar != null) {
            return _stellar!!
        }
        _stellar = VectorAssetBuilder(name = "Stellar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _stellar: VectorAsset? = null
