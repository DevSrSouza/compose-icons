...
public val SimpleIcons.Fedramp: ImageVector
    get() {
        if (_fedramp != null) {
            return _fedramp!!
        }
        _fedramp = Builder(name = "Fedramp", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fedramp: ImageVector? = null
