...
public val SimpleIcons.ProductHunt: VectorAsset
    get() {
        if (_productHunt != null) {
            return _productHunt!!
        }
        _productHunt = VectorAssetBuilder(name = "ProductHunt", defaultWidth = 24.0.dp,
...
private var _productHunt: VectorAsset? = null
