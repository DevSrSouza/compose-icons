...
public val SimpleIcons.Askfm: VectorAsset
    get() {
        if (_askfm != null) {
            return _askfm!!
        }
        _askfm = VectorAssetBuilder(name = "Askfm", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _askfm: VectorAsset? = null
