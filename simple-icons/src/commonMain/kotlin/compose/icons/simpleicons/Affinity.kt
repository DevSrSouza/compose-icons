...
public val SimpleIcons.Affinity: VectorAsset
    get() {
        if (_affinity != null) {
            return _affinity!!
        }
        _affinity = VectorAssetBuilder(name = "Affinity", defaultWidth = 24.0.dp, defaultHeight =
...
private var _affinity: VectorAsset? = null
