...
public val SimpleIcons.Monogames: ImageVector
    get() {
        if (_monogames != null) {
            return _monogames!!
        }
        _monogames = Builder(name = "Monogames", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _monogames: ImageVector? = null
