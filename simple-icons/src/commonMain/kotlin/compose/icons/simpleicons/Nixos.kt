...
public val SimpleIcons.Nixos: VectorAsset
    get() {
        if (_nixos != null) {
            return _nixos!!
        }
        _nixos = VectorAssetBuilder(name = "Nixos", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _nixos: VectorAsset? = null
