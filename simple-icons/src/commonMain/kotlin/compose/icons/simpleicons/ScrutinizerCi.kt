...
public val SimpleIcons.ScrutinizerCi: VectorAsset
    get() {
        if (_scrutinizerCi != null) {
            return _scrutinizerCi!!
        }
        _scrutinizerCi = VectorAssetBuilder(name = "ScrutinizerCi", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.119f, 0.857f)
                curveToRelative(-0.06f, 0.799f, -0.06f, 1.351f, 0.12f, 1.471f)
                ...
                curveTo(22.396f, 0.0f, 21.417f, 0.0f, 14.858f, 0.0f)
                close()
                moveTo(9.192f, 9.007f)
                ...
                curveToRelative(0.18f, 0.24f, 0.181f, 0.307f, 0.181f, 0.979f)
                curveToRelative(0.0f, 0.672f, -0.066f, 0.732f, -0.186f, 1.044f)
                arcToRelative(1.47f, 1.47f, 0.0f, false, true, -0.426f, 0.366f)
                curveToRelative(-0.186f, 0.12f, -0.307f, 0.119f, -4.357f, 0.179f)
                curveToRelative(-4.67f, 0.0f, -5.155f, 0.0f, -6.319f, 0.432f)
                arcToRelative(6.445f, 6.433f, 0.0f, false, false, -2.46f, 1.35f)
                curveToRelative(-1.164f, 1.039f, -1.842f, 2.203f, -1.962f, 3.428f)
                ...
                arcToRelative(8.407f, 8.395f, 0.0f, false, false, -0.373f, -6.061f)
                arcToRelative(8.527f, 8.521f, 0.0f, false, false, -2.328f, -2.88f)
                arcToRelative(6.937f, 6.925f, 0.0f, false, false, -2.394f, -0.984f)
                curveToRelative(-0.246f, -0.06f, -4.051f, -0.106f, -7.81f, -0.121f)
                close()
            }
        }
        .build()
...
private var _scrutinizerCi: VectorAsset? = null
