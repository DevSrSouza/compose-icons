...
public val SimpleIcons.Opera: VectorAsset
    get() {
        if (_opera != null) {
            return _opera!!
        }
        _opera = VectorAssetBuilder(name = "Opera", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _opera: VectorAsset? = null
