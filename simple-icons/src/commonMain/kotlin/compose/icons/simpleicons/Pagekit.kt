...
public val SimpleIcons.Pagekit: VectorAsset
    get() {
        if (_pagekit != null) {
            return _pagekit!!
        }
        _pagekit = VectorAssetBuilder(name = "Pagekit", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pagekit: VectorAsset? = null
