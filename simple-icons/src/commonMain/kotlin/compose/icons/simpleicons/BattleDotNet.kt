...
public val SimpleIcons.BattleDotNet: VectorAsset
    get() {
        if (_battleDotNet != null) {
            return _battleDotNet!!
        }
        _battleDotNet = VectorAssetBuilder(name = "BattleDotNet", defaultWidth = 24.0.dp,
...
private var _battleDotNet: VectorAsset? = null
