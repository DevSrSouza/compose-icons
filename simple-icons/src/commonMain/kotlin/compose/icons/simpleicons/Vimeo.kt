...
public val SimpleIcons.Vimeo: VectorAsset
    get() {
        if (_vimeo != null) {
            return _vimeo!!
        }
        _vimeo = VectorAssetBuilder(name = "Vimeo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _vimeo: VectorAsset? = null
