...
public val SimpleIcons.Infiniti: VectorAsset
    get() {
        if (_infiniti != null) {
            return _infiniti!!
        }
        _infiniti = VectorAssetBuilder(name = "Infiniti", defaultWidth = 24.0.dp, defaultHeight =
...
private var _infiniti: VectorAsset? = null
