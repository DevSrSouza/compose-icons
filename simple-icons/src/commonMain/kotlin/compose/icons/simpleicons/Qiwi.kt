...
public val SimpleIcons.Qiwi: VectorAsset
    get() {
        if (_qiwi != null) {
            return _qiwi!!
        }
        _qiwi = VectorAssetBuilder(name = "Qiwi", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _qiwi: VectorAsset? = null
