...
public val SimpleIcons.Libreoffice: VectorAsset
    get() {
        if (_libreoffice != null) {
            return _libreoffice!!
        }
        _libreoffice = VectorAssetBuilder(name = "Libreoffice", defaultWidth = 24.0.dp,
...
private var _libreoffice: VectorAsset? = null
