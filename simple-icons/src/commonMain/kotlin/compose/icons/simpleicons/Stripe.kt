...
public val SimpleIcons.Stripe: VectorAsset
    get() {
        if (_stripe != null) {
            return _stripe!!
        }
        _stripe = VectorAssetBuilder(name = "Stripe", defaultWidth = 24.0.dp, defaultHeight =
...
private var _stripe: VectorAsset? = null
