...
public val SimpleIcons.Autotask: VectorAsset
    get() {
        if (_autotask != null) {
            return _autotask!!
        }
        _autotask = VectorAssetBuilder(name = "Autotask", defaultWidth = 24.0.dp, defaultHeight =
...
private var _autotask: VectorAsset? = null
