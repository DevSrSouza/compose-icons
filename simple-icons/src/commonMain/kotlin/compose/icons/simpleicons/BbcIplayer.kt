...
public val SimpleIcons.BbcIplayer: VectorAsset
    get() {
        if (_bbcIplayer != null) {
            return _bbcIplayer!!
        }
        _bbcIplayer = VectorAssetBuilder(name = "BbcIplayer", defaultWidth = 24.0.dp, defaultHeight
...
private var _bbcIplayer: VectorAsset? = null
