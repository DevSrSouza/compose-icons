...
public val SimpleIcons.Signal: VectorAsset
    get() {
        if (_signal != null) {
            return _signal!!
        }
        _signal = VectorAssetBuilder(name = "Signal", defaultWidth = 24.0.dp, defaultHeight =
...
private var _signal: VectorAsset? = null
