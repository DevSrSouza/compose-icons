...
public val SimpleIcons.CSharp: VectorAsset
    get() {
        if (_cSharp != null) {
            return _cSharp!!
        }
        _cSharp = VectorAssetBuilder(name = "CSharp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cSharp: VectorAsset? = null
