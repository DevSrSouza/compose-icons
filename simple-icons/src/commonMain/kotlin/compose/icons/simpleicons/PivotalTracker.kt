...
public val SimpleIcons.PivotalTracker: VectorAsset
    get() {
        if (_pivotalTracker != null) {
            return _pivotalTracker!!
        }
        _pivotalTracker = VectorAssetBuilder(name = "PivotalTracker", defaultWidth = 24.0.dp,
...
private var _pivotalTracker: VectorAsset? = null
