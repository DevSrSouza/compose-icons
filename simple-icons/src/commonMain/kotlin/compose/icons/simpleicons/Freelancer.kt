...
public val SimpleIcons.Freelancer: VectorAsset
    get() {
        if (_freelancer != null) {
            return _freelancer!!
        }
        _freelancer = VectorAssetBuilder(name = "Freelancer", defaultWidth = 24.0.dp, defaultHeight
...
private var _freelancer: VectorAsset? = null
