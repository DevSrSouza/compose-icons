...
public val SimpleIcons.Etsy: VectorAsset
    get() {
        if (_etsy != null) {
            return _etsy!!
        }
        _etsy = VectorAssetBuilder(name = "Etsy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _etsy: VectorAsset? = null
