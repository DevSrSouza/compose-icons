...
public val SimpleIcons.Postman: VectorAsset
    get() {
        if (_postman != null) {
            return _postman!!
        }
        _postman = VectorAssetBuilder(name = "Postman", defaultWidth = 24.0.dp, defaultHeight =
...
private var _postman: VectorAsset? = null
