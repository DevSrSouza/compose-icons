...
public val SimpleIcons.PlayerDotMe: VectorAsset
    get() {
        if (_playerDotMe != null) {
            return _playerDotMe!!
        }
        _playerDotMe = VectorAssetBuilder(name = "PlayerDotMe", defaultWidth = 24.0.dp,
...
private var _playerDotMe: VectorAsset? = null
