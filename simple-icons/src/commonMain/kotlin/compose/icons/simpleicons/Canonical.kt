...
public val SimpleIcons.Canonical: VectorAsset
    get() {
        if (_canonical != null) {
            return _canonical!!
        }
        _canonical = VectorAssetBuilder(name = "Canonical", defaultWidth = 24.0.dp, defaultHeight =
...
private var _canonical: VectorAsset? = null
