...
public val SimpleIcons.Heroku: VectorAsset
    get() {
        if (_heroku != null) {
            return _heroku!!
        }
        _heroku = VectorAssetBuilder(name = "Heroku", defaultWidth = 24.0.dp, defaultHeight =
...
private var _heroku: VectorAsset? = null
