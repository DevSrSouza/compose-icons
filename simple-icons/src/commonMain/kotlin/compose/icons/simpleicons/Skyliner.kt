...
public val SimpleIcons.Skyliner: VectorAsset
    get() {
        if (_skyliner != null) {
            return _skyliner!!
        }
        _skyliner = VectorAssetBuilder(name = "Skyliner", defaultWidth = 24.0.dp, defaultHeight =
...
private var _skyliner: VectorAsset? = null
