    ...
    get() {
        ...
        _androidstudio = Builder(name = "Androidstudio", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.3321f, 0.0f, -0.6026f, 0.2705f, -0.6026f, 0.6031f)
                ...
                arcToRelative(2.2862f, 2.2862f, 0.0f, false, false, -1.2893f, -1.6248f)
                ...
                curveToRelative(0.0f, 0.7115f, -0.5791f, 1.2901f, -1.3028f, 1.2901f)
                ...
                arcToRelative(0.9738f, 0.9738f, 0.0f, false, true, -0.3194f, -0.0455f)
                curveToRelative(-0.024f, -0.0078f, -0.046f, -0.0209f, -0.0694f, -0.0305f)
                arcToRelative(0.9701f, 0.9701f, 0.0f, false, true, -0.2277f, -0.1321f)
                ...
                arcToRelative(0.7725f, 0.7725f, 0.0f, false, false, -0.6995f, -0.4443f)
                horizontalLineToRelative(-0.0024f)
                arcToRelative(0.792f, 0.792f, 0.0f, false, false, -0.7083f, 0.4443f)
                lineToRelative(-1.5109f, 3.2452f)
                lineToRelative(-1.2321f, 2.6464f)
                arcToRelative(0.9722f, 0.9722f, 0.0f, false, true, -0.7985f, 0.5795f)
                ...
                arcToRelative(0.9862f, 0.9862f, 0.0f, false, true, -0.1695f, -0.1844f)
                arcToRelative(0.9788f, 0.9788f, 0.0f, false, true, -0.0708f, -0.9852f)
                lineToRelative(0.8469f, -1.8223f)
                lineToRelative(3.2676f, -7.0314f)
                arcToRelative(1.7964f, 1.7964f, 0.0f, false, true, -0.7072f, -1.1637f)
                curveToRelative(-0.1555f, -0.9799f, 0.5129f, -1.9003f, 1.4928f, -2.0559f)
                lineTo(11.6393f, 9.3946f)
                arcToRelative(0.3542f, 0.3542f, 0.0f, false, true, 0.1674f, -0.3155f)
                arcToRelative(0.3468f, 0.3468f, 0.0f, false, true, 0.3541f, 0.0f)
                arcToRelative(0.354f, 0.354f, 0.0f, false, true, 0.1674f, 0.3155f)
                verticalLineToRelative(1.159f)
                lineToRelative(0.0129f, 0.0064f)
                arcToRelative(1.8028f, 1.8028f, 0.0f, false, true, 1.2878f, 1.378f)
                arcToRelative(1.7835f, 1.7835f, 0.0f, false, true, -0.6439f, 1.7836f)
                ...
                arcToRelative(1.1204f, 1.1204f, 0.0f, false, false, -0.7856f, 0.3219f)
                arcToRelative(1.101f, 1.101f, 0.0f, false, false, -0.323f, 0.7716f)
                curveToRelative(-0.0042f, 0.6081f, 0.4854f, 1.1044f, 1.0935f, 1.1085f)
                horizontalLineToRelative(0.0077f)
                curveToRelative(0.6046f, 0.0f, 1.0967f, -0.488f, 1.1009f, -1.0935f)
                close()
                moveTo(11.9571f, 17.5828f)
                curveToRelative(-0.1119f, 5.0E-4f, -0.2121f, 0.0632f, -0.2571f, 0.1553f)
                lineToRelative(-1.4127f, 3.0342f)
                horizontalLineToRelative(3.3733f)
                lineToRelative(-1.4564f, -3.0328f)
                arcToRelative(0.274f, 0.274f, 0.0f, false, false, -0.2471f, -0.1567f)
                close()
                moveTo(20.1003f, 10.8369f)
                lineToRelative(-0.0129f, -1.0E-4f)
                ...
                close()
                moveTo(8.9479f, 2.1184f)
                lineTo(7.9112f, 0.3284f)
                arcToRelative(0.219f, 0.219f, 0.0f, false, true, 0.0f, -0.2189f)
                arcTo(0.2384f, 0.2384f, 0.0f, false, true, 8.098f, 0.0f)
                arcToRelative(0.219f, 0.219f, 0.0f, false, true, 0.1867f, 0.1094f)
                lineToRelative(1.0496f, 1.8158f)
                arcToRelative(6.4907f, 6.4907f, 0.0f, false, true, 5.3186f, 0.0f)
                lineTo(15.696f, 0.1094f)
                arcToRelative(0.2189f, 0.2189f, 0.0f, false, true, 0.3734f, 0.2189f)
                ...
                close()
                moveTo(14.3253f, 4.7386f)
                arcToRelative(0.515f, 0.515f, 0.0f, false, false, 0.5271f, 0.5028f)
                arcToRelative(0.515f, 0.515f, 0.0f, false, false, 0.5151f, -0.5151f)
                arcToRelative(0.5213f, 0.5213f, 0.0f, false, false, -0.8885f, -0.367f)
                arcToRelative(0.5151f, 0.5151f, 0.0f, false, false, -0.1537f, 0.3793f)
                close()
                moveTo(8.6075f, 4.7319f)
                arcToRelative(0.5151f, 0.5151f, 0.0f, false, false, 0.5207f, 0.5095f)
                arcToRelative(0.5086f, 0.5086f, 0.0f, false, false, 0.367f, -0.1481f)
                arcToRelative(0.5215f, 0.5215f, 0.0f, true, false, -0.734f, -0.7341f)
                arcToRelative(0.515f, 0.515f, 0.0f, false, false, -0.1537f, 0.3727f)
                close()
            }
        }
        .build()
