...
public val SimpleIcons.Crehana: VectorAsset
    get() {
        if (_crehana != null) {
            return _crehana!!
        }
        _crehana = VectorAssetBuilder(name = "Crehana", defaultWidth = 24.0.dp, defaultHeight =
...
private var _crehana: VectorAsset? = null
