...
public val SimpleIcons.Lichess: VectorAsset
    get() {
        if (_lichess != null) {
            return _lichess!!
        }
        _lichess = VectorAssetBuilder(name = "Lichess", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lichess: VectorAsset? = null
