...
public val SimpleIcons.Webrtc: VectorAsset
    get() {
        if (_webrtc != null) {
            return _webrtc!!
        }
        _webrtc = VectorAssetBuilder(name = "Webrtc", defaultWidth = 24.0.dp, defaultHeight =
...
private var _webrtc: VectorAsset? = null
