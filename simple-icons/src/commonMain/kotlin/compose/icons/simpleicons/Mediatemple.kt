...
public val SimpleIcons.Mediatemple: VectorAsset
    get() {
        if (_mediatemple != null) {
            return _mediatemple!!
        }
        _mediatemple = VectorAssetBuilder(name = "Mediatemple", defaultWidth = 24.0.dp,
...
private var _mediatemple: VectorAsset? = null
