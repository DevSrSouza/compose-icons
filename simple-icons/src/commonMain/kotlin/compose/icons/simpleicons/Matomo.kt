...
public val SimpleIcons.Matomo: VectorAsset
    get() {
        if (_matomo != null) {
            return _matomo!!
        }
        _matomo = VectorAssetBuilder(name = "Matomo", defaultWidth = 24.0.dp, defaultHeight =
...
private var _matomo: VectorAsset? = null
