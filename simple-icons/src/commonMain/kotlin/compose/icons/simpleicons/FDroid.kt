...
public val SimpleIcons.FDroid: VectorAsset
    get() {
        if (_fDroid != null) {
            return _fDroid!!
        }
        _fDroid = VectorAssetBuilder(name = "FDroid", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fDroid: VectorAsset? = null
