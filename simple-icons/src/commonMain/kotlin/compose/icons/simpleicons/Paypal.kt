...
public val SimpleIcons.Paypal: VectorAsset
    get() {
        if (_paypal != null) {
            return _paypal!!
        }
        _paypal = VectorAssetBuilder(name = "Paypal", defaultWidth = 24.0.dp, defaultHeight =
...
private var _paypal: VectorAsset? = null
