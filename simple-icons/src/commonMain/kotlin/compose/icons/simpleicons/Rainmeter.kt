...
public val SimpleIcons.Rainmeter: VectorAsset
    get() {
        if (_rainmeter != null) {
            return _rainmeter!!
        }
        _rainmeter = VectorAssetBuilder(name = "Rainmeter", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rainmeter: VectorAsset? = null
