...
public val SimpleIcons.Gmail: VectorAsset
    get() {
        if (_gmail != null) {
            return _gmail!!
        }
        _gmail = VectorAssetBuilder(name = "Gmail", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _gmail: VectorAsset? = null
