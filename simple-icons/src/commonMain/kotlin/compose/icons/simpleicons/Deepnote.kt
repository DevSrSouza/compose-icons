...
public val SimpleIcons.Deepnote: VectorAsset
    get() {
        if (_deepnote != null) {
            return _deepnote!!
        }
        _deepnote = VectorAssetBuilder(name = "Deepnote", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deepnote: VectorAsset? = null
