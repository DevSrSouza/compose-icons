...
public val SimpleIcons.Maas: VectorAsset
    get() {
        if (_maas != null) {
            return _maas!!
        }
        _maas = VectorAssetBuilder(name = "Maas", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _maas: VectorAsset? = null
