...
public val SimpleIcons.Pjsip: VectorAsset
    get() {
        if (_pjsip != null) {
            return _pjsip!!
        }
        _pjsip = VectorAssetBuilder(name = "Pjsip", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _pjsip: VectorAsset? = null
