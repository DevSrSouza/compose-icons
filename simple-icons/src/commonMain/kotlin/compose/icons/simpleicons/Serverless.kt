...
public val SimpleIcons.Serverless: VectorAsset
    get() {
        if (_serverless != null) {
            return _serverless!!
        }
        _serverless = VectorAssetBuilder(name = "Serverless", defaultWidth = 24.0.dp, defaultHeight
...
private var _serverless: VectorAsset? = null
