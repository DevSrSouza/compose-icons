...
public val SimpleIcons.Groupon: VectorAsset
    get() {
        if (_groupon != null) {
            return _groupon!!
        }
        _groupon = VectorAssetBuilder(name = "Groupon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _groupon: VectorAsset? = null
