...
public val SimpleIcons.Microgenetics: VectorAsset
    get() {
        if (_microgenetics != null) {
            return _microgenetics!!
        }
        _microgenetics = VectorAssetBuilder(name = "Microgenetics", defaultWidth = 24.0.dp,
...
private var _microgenetics: VectorAsset? = null
