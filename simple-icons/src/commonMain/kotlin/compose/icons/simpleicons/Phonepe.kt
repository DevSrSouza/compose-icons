...
public val SimpleIcons.Phonepe: VectorAsset
    get() {
        if (_phonepe != null) {
            return _phonepe!!
        }
        _phonepe = VectorAssetBuilder(name = "Phonepe", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phonepe: VectorAsset? = null
