...
public val SimpleIcons.CockroachLabs: VectorAsset
    get() {
        if (_cockroachLabs != null) {
            return _cockroachLabs!!
        }
        _cockroachLabs = VectorAssetBuilder(name = "CockroachLabs", defaultWidth = 24.0.dp,
...
private var _cockroachLabs: VectorAsset? = null
