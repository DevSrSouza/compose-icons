...
public val SimpleIcons.Numba: VectorAsset
    get() {
        if (_numba != null) {
            return _numba!!
        }
        _numba = VectorAssetBuilder(name = "Numba", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _numba: VectorAsset? = null
