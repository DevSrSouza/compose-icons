...
public val SimpleIcons.Sensu: VectorAsset
    get() {
        if (_sensu != null) {
            return _sensu!!
        }
        _sensu = VectorAssetBuilder(name = "Sensu", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sensu: VectorAsset? = null
