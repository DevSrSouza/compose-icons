...
public val SimpleIcons.Osmc: VectorAsset
    get() {
        if (_osmc != null) {
            return _osmc!!
        }
        _osmc = VectorAssetBuilder(name = "Osmc", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _osmc: VectorAsset? = null
