...
public val SimpleIcons.Cesium: VectorAsset
    get() {
        if (_cesium != null) {
            return _cesium!!
        }
        _cesium = VectorAssetBuilder(name = "Cesium", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cesium: VectorAsset? = null
