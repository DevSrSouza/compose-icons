...
public val SimpleIcons.RiotGames: VectorAsset
    get() {
        if (_riotGames != null) {
            return _riotGames!!
        }
        _riotGames = VectorAssetBuilder(name = "RiotGames", defaultWidth = 24.0.dp, defaultHeight =
...
private var _riotGames: VectorAsset? = null
