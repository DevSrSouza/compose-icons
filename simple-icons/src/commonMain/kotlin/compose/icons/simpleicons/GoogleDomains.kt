...
public val SimpleIcons.GoogleDomains: VectorAsset
    get() {
        if (_googleDomains != null) {
            return _googleDomains!!
        }
        _googleDomains = VectorAssetBuilder(name = "GoogleDomains", defaultWidth = 24.0.dp,
...
private var _googleDomains: VectorAsset? = null
