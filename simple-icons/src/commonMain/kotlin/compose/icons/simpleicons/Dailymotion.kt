...
public val SimpleIcons.Dailymotion: VectorAsset
    get() {
        if (_dailymotion != null) {
            return _dailymotion!!
        }
        _dailymotion = VectorAssetBuilder(name = "Dailymotion", defaultWidth = 24.0.dp,
...
private var _dailymotion: VectorAsset? = null
