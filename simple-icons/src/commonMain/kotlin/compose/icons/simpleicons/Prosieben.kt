...
public val SimpleIcons.Prosieben: VectorAsset
    get() {
        if (_prosieben != null) {
            return _prosieben!!
        }
        _prosieben = VectorAssetBuilder(name = "Prosieben", defaultWidth = 24.0.dp, defaultHeight =
...
private var _prosieben: VectorAsset? = null
