...
public val SimpleIcons.Epel: VectorAsset
    get() {
        if (_epel != null) {
            return _epel!!
        }
        _epel = VectorAssetBuilder(name = "Epel", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _epel: VectorAsset? = null
