...
public val SimpleIcons.Wireshark: VectorAsset
    get() {
        if (_wireshark != null) {
            return _wireshark!!
        }
        _wireshark = VectorAssetBuilder(name = "Wireshark", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wireshark: VectorAsset? = null
