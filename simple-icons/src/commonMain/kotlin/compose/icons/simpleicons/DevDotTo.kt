...
public val SimpleIcons.DevDotTo: VectorAsset
    get() {
        if (_devDotTo != null) {
            return _devDotTo!!
        }
        _devDotTo = VectorAssetBuilder(name = "DevDotTo", defaultWidth = 24.0.dp, defaultHeight =
...
private var _devDotTo: VectorAsset? = null
