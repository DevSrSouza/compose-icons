...
public val SimpleIcons.AdobeLightroomCc: VectorAsset
    get() {
        if (_adobeLightroomCc != null) {
            return _adobeLightroomCc!!
        }
        _adobeLightroomCc = VectorAssetBuilder(name = "AdobeLightroomCc", defaultWidth = 24.0.dp,
...
private var _adobeLightroomCc: VectorAsset? = null
