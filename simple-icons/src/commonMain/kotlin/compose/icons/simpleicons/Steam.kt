...
public val SimpleIcons.Steam: VectorAsset
    get() {
        if (_steam != null) {
            return _steam!!
        }
        _steam = VectorAssetBuilder(name = "Steam", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _steam: VectorAsset? = null
