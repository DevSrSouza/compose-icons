...
public val SimpleIcons.Yarn: VectorAsset
    get() {
        if (_yarn != null) {
            return _yarn!!
        }
        _yarn = VectorAssetBuilder(name = "Yarn", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _yarn: VectorAsset? = null
