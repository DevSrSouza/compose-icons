...
public val SimpleIcons.Firebase: VectorAsset
    get() {
        if (_firebase != null) {
            return _firebase!!
        }
        _firebase = VectorAssetBuilder(name = "Firebase", defaultWidth = 24.0.dp, defaultHeight =
...
private var _firebase: VectorAsset? = null
