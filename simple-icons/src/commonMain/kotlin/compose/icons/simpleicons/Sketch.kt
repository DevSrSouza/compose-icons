...
public val SimpleIcons.Sketch: VectorAsset
    get() {
        if (_sketch != null) {
            return _sketch!!
        }
        _sketch = VectorAssetBuilder(name = "Sketch", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sketch: VectorAsset? = null
