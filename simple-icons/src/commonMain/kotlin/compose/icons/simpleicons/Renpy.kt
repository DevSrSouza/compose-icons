...
public val SimpleIcons.Renpy: VectorAsset
    get() {
        if (_renpy != null) {
            return _renpy!!
        }
        _renpy = VectorAssetBuilder(name = "Renpy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _renpy: VectorAsset? = null
