...
public val SimpleIcons.Cloudcannon: VectorAsset
    get() {
        if (_cloudcannon != null) {
            return _cloudcannon!!
        }
        _cloudcannon = VectorAssetBuilder(name = "Cloudcannon", defaultWidth = 24.0.dp,
...
private var _cloudcannon: VectorAsset? = null
