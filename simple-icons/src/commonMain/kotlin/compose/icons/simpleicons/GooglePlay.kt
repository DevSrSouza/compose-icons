...
public val SimpleIcons.GooglePlay: VectorAsset
    get() {
        if (_googlePlay != null) {
            return _googlePlay!!
        }
        _googlePlay = VectorAssetBuilder(name = "GooglePlay", defaultWidth = 24.0.dp, defaultHeight
...
private var _googlePlay: VectorAsset? = null
