...
public val SimpleIcons.AwsAmplify: VectorAsset
    get() {
        if (_awsAmplify != null) {
            return _awsAmplify!!
        }
        _awsAmplify = VectorAssetBuilder(name = "AwsAmplify", defaultWidth = 24.0.dp, defaultHeight
...
private var _awsAmplify: VectorAsset? = null
