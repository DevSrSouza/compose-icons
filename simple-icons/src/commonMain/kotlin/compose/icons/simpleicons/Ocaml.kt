...
public val SimpleIcons.Ocaml: VectorAsset
    get() {
        if (_ocaml != null) {
            return _ocaml!!
        }
        _ocaml = VectorAssetBuilder(name = "Ocaml", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ocaml: VectorAsset? = null
