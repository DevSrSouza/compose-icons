...
public val SimpleIcons.Monogram: VectorAsset
    get() {
        if (_monogram != null) {
            return _monogram!!
        }
        _monogram = VectorAssetBuilder(name = "Monogram", defaultWidth = 24.0.dp, defaultHeight =
...
private var _monogram: VectorAsset? = null
