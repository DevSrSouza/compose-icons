...
public val SimpleIcons.Teamviewer: VectorAsset
    get() {
        if (_teamviewer != null) {
            return _teamviewer!!
        }
        _teamviewer = VectorAssetBuilder(name = "Teamviewer", defaultWidth = 24.0.dp, defaultHeight
...
private var _teamviewer: VectorAsset? = null
