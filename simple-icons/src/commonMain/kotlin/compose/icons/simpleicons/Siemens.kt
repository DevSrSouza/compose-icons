...
public val SimpleIcons.Siemens: VectorAsset
    get() {
        if (_siemens != null) {
            return _siemens!!
        }
        _siemens = VectorAssetBuilder(name = "Siemens", defaultWidth = 24.0.dp, defaultHeight =
...
private var _siemens: VectorAsset? = null
