...
public val SimpleIcons.Iobroker: VectorAsset
    get() {
        if (_iobroker != null) {
            return _iobroker!!
        }
        _iobroker = VectorAssetBuilder(name = "Iobroker", defaultWidth = 24.0.dp, defaultHeight =
...
private var _iobroker: VectorAsset? = null
