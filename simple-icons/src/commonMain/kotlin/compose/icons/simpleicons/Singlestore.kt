...
public val SimpleIcons.Singlestore: VectorAsset
    get() {
        if (_singlestore != null) {
            return _singlestore!!
        }
        _singlestore = VectorAssetBuilder(name = "Singlestore", defaultWidth = 24.0.dp,
...
private var _singlestore: VectorAsset? = null
