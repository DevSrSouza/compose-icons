...
public val SimpleIcons.Instacart: VectorAsset
    get() {
        if (_instacart != null) {
            return _instacart!!
        }
        _instacart = VectorAssetBuilder(name = "Instacart", defaultWidth = 24.0.dp, defaultHeight =
...
private var _instacart: VectorAsset? = null
