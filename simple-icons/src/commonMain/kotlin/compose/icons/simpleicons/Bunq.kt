...
public val SimpleIcons.Bunq: VectorAsset
    get() {
        if (_bunq != null) {
            return _bunq!!
        }
        _bunq = VectorAssetBuilder(name = "Bunq", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bunq: VectorAsset? = null
