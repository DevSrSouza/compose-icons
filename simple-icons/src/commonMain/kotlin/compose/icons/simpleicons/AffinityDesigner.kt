...
public val SimpleIcons.AffinityDesigner: VectorAsset
    get() {
        if (_affinityDesigner != null) {
            return _affinityDesigner!!
        }
        _affinityDesigner = VectorAssetBuilder(name = "AffinityDesigner", defaultWidth = 24.0.dp,
...
private var _affinityDesigner: VectorAsset? = null
