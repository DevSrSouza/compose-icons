...
public val SimpleIcons.Zapier: VectorAsset
    get() {
        if (_zapier != null) {
            return _zapier!!
        }
        _zapier = VectorAssetBuilder(name = "Zapier", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zapier: VectorAsset? = null
