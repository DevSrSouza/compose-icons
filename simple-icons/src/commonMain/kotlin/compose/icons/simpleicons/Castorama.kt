...
public val SimpleIcons.Castorama: VectorAsset
    get() {
        if (_castorama != null) {
            return _castorama!!
        }
        _castorama = VectorAssetBuilder(name = "Castorama", defaultWidth = 24.0.dp, defaultHeight =
...
private var _castorama: VectorAsset? = null
