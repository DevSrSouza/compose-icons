...
public val SimpleIcons.Confluence: VectorAsset
    get() {
        if (_confluence != null) {
            return _confluence!!
        }
        _confluence = VectorAssetBuilder(name = "Confluence", defaultWidth = 24.0.dp, defaultHeight
...
private var _confluence: VectorAsset? = null
