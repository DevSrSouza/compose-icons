...
public val SimpleIcons.Liberapay: VectorAsset
    get() {
        if (_liberapay != null) {
            return _liberapay!!
        }
        _liberapay = VectorAssetBuilder(name = "Liberapay", defaultWidth = 24.0.dp, defaultHeight =
...
private var _liberapay: VectorAsset? = null
