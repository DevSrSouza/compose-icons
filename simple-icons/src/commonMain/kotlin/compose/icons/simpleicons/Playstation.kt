...
public val SimpleIcons.Playstation: VectorAsset
    get() {
        if (_playstation != null) {
            return _playstation!!
        }
        _playstation = VectorAssetBuilder(name = "Playstation", defaultWidth = 24.0.dp,
...
private var _playstation: VectorAsset? = null
