...
public val SimpleIcons.OpenNebula: VectorAsset
    get() {
        if (_openNebula != null) {
            return _openNebula!!
        }
        _openNebula = VectorAssetBuilder(name = "OpenNebula", defaultWidth = 24.0.dp, defaultHeight
...
private var _openNebula: VectorAsset? = null
