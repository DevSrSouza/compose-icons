...
public val SimpleIcons.Formstack: VectorAsset
    get() {
        if (_formstack != null) {
            return _formstack!!
        }
        _formstack = VectorAssetBuilder(name = "Formstack", defaultWidth = 24.0.dp, defaultHeight =
...
private var _formstack: VectorAsset? = null
