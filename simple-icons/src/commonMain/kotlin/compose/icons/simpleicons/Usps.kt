...
public val SimpleIcons.Usps: VectorAsset
    get() {
        if (_usps != null) {
            return _usps!!
        }
        _usps = VectorAssetBuilder(name = "Usps", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _usps: VectorAsset? = null
