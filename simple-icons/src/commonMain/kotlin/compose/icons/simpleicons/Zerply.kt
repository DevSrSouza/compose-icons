...
public val SimpleIcons.Zerply: VectorAsset
    get() {
        if (_zerply != null) {
            return _zerply!!
        }
        _zerply = VectorAssetBuilder(name = "Zerply", defaultWidth = 24.0.dp, defaultHeight =
...
private var _zerply: VectorAsset? = null
