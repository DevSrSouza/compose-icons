...
public val SimpleIcons.Qualtrics: VectorAsset
    get() {
        if (_qualtrics != null) {
            return _qualtrics!!
        }
        _qualtrics = VectorAssetBuilder(name = "Qualtrics", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qualtrics: VectorAsset? = null
