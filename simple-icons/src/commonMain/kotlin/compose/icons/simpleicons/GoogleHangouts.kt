...
public val SimpleIcons.GoogleHangouts: VectorAsset
    get() {
        if (_googleHangouts != null) {
            return _googleHangouts!!
        }
        _googleHangouts = VectorAssetBuilder(name = "GoogleHangouts", defaultWidth = 24.0.dp,
...
private var _googleHangouts: VectorAsset? = null
