...
public val SimpleIcons.RaspberryPi: VectorAsset
    get() {
        if (_raspberryPi != null) {
            return _raspberryPi!!
        }
        _raspberryPi = VectorAssetBuilder(name = "RaspberryPi", defaultWidth = 24.0.dp,
...
private var _raspberryPi: VectorAsset? = null
