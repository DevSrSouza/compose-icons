...
public val SimpleIcons.WindowsXp: VectorAsset
    get() {
        if (_windowsXp != null) {
            return _windowsXp!!
        }
        _windowsXp = VectorAssetBuilder(name = "WindowsXp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _windowsXp: VectorAsset? = null
