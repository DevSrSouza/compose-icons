...
public val SimpleIcons.Crunchyroll: VectorAsset
    get() {
        if (_crunchyroll != null) {
            return _crunchyroll!!
        }
        _crunchyroll = VectorAssetBuilder(name = "Crunchyroll", defaultWidth = 24.0.dp,
...
private var _crunchyroll: VectorAsset? = null
