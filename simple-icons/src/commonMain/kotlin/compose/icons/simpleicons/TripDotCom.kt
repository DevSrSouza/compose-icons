...
public val SimpleIcons.TripDotCom: VectorAsset
    get() {
        if (_tripDotCom != null) {
            return _tripDotCom!!
        }
        _tripDotCom = VectorAssetBuilder(name = "TripDotCom", defaultWidth = 24.0.dp, defaultHeight
...
private var _tripDotCom: VectorAsset? = null
