...
public val SimpleIcons.TheWashingtonPost: VectorAsset
    get() {
        if (_theWashingtonPost != null) {
            return _theWashingtonPost!!
        }
        _theWashingtonPost = VectorAssetBuilder(name = "TheWashingtonPost", defaultWidth = 24.0.dp,
...
private var _theWashingtonPost: VectorAsset? = null
