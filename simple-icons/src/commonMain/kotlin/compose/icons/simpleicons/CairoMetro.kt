...
public val SimpleIcons.CairoMetro: VectorAsset
    get() {
        if (_cairoMetro != null) {
            return _cairoMetro!!
        }
        _cairoMetro = VectorAssetBuilder(name = "CairoMetro", defaultWidth = 24.0.dp, defaultHeight
...
private var _cairoMetro: VectorAsset? = null
