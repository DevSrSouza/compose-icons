...
public val MaterialDesignIcons.CogPauseOutline: ImageVector
    get() {
        if (_cogPauseOutline != null) {
            return _cogPauseOutline!!
        }
        _cogPauseOutline = Builder(name = "CogPauseOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.83f, 12.0f, 17.66f, 12.0f, 17.5f, 12.03f)
                curveTo(17.5f, 11.41f, 17.4f, 10.79f, 17.2f, 10.2f)
                lineTo(19.31f, 8.65f)
                lineTo(18.56f, 7.35f)
                lineTo(16.15f, 8.39f)
                ...
                moveTo(12.36f, 15.96f)
                curveTo(12.24f, 16.0f, 12.12f, 16.0f, 12.0f, 16.0f)
                ...
                curveTo(16.0f, 12.12f, 16.0f, 12.24f, 15.96f, 12.36f)
                curveTo(14.29f, 12.97f, 12.97f, 14.29f, 12.36f, 15.96f)
                moveTo(14.0f, 12.0f)
                curveTo(14.0f, 10.9f, 13.11f, 10.0f, 12.0f, 10.0f)
                reflectiveCurveTo(10.0f, 10.9f, 10.0f, 12.0f)
                reflectiveCurveTo(10.9f, 14.0f, 12.0f, 14.0f)
                reflectiveCurveTo(14.0f, 13.11f, 14.0f, 12.0f)
                moveTo(19.0f, 15.0f)
...
private var _cogPauseOutline: ImageVector? = null
