...
public val MaterialDesignIcons.CalendarExpandHorizontalOutline: ImageVector
    get() {
        if (_calendarExpandHorizontalOutline != null) {
            return _calendarExpandHorizontalOutline!!
        }
        _calendarExpandHorizontalOutline = Builder(name = "CalendarExpandHorizontalOutline",
