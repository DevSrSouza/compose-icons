...
public val MaterialDesignIcons.ClipboardMinusOutline: ImageVector
    get() {
        if (_clipboardMinusOutline != null) {
            return _clipboardMinusOutline!!
        }
        _clipboardMinusOutline = Builder(name = "ClipboardMinusOutline", defaultWidth = 24.0.dp,
...
private var _clipboardMinusOutline: ImageVector? = null
