...
public val MaterialDesignIcons.FolderArrowLeftRight: ImageVector
    get() {
        if (_folderArrowLeftRight != null) {
            return _folderArrowLeftRight!!
        }
        _folderArrowLeftRight = Builder(name = "FolderArrowLeftRight", defaultWidth = 24.0.dp,
...
private var _folderArrowLeftRight: ImageVector? = null
