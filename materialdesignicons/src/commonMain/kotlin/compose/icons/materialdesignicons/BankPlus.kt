...
public val MaterialDesignIcons.BankPlus: ImageVector
    get() {
        if (_bankPlus != null) {
            return _bankPlus!!
        }
        _bankPlus = Builder(name = "BankPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bankPlus: ImageVector? = null
