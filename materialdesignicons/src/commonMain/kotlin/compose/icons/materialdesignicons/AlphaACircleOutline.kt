...
public val MaterialDesignIcons.AlphaACircleOutline: ImageVector
    get() {
        if (_alphaACircleOutline != null) {
            return _alphaACircleOutline!!
        }
        _alphaACircleOutline = Builder(name = "AlphaACircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaACircleOutline: ImageVector? = null
