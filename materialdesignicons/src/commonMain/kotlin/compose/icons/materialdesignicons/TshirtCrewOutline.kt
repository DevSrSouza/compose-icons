...
public val MaterialDesignIcons.TshirtCrewOutline: ImageVector
    get() {
        if (_tshirtCrewOutline != null) {
            return _tshirtCrewOutline!!
        }
        _tshirtCrewOutline = Builder(name = "TshirtCrewOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(20.42f, 9.58f)
                lineTo(16.11f, 5.28f)
                curveTo(15.8f, 5.63f, 15.43f, 5.94f, 15.0f, 6.2f)
                curveTo(14.16f, 6.7f, 13.13f, 7.0f, 12.0f, 7.0f)
                curveTo(10.3f, 7.0f, 8.79f, 6.32f, 7.89f, 5.28f)
                lineTo(3.58f, 9.58f)
                lineTo(5.0f, 11.0f)
                lineTo(8.0f, 9.0f)
                horizontalLineTo(9.0f)
