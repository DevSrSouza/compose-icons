...
public val MaterialDesignIcons.BookMinusOutline: ImageVector
    get() {
        if (_bookMinusOutline != null) {
            return _bookMinusOutline!!
        }
        _bookMinusOutline = Builder(name = "BookMinusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _bookMinusOutline: ImageVector? = null
