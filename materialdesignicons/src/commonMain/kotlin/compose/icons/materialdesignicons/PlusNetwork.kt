...
public val MaterialDesignIcons.PlusNetwork: ImageVector
    get() {
        if (_plusNetwork != null) {
            return _plusNetwork!!
        }
        _plusNetwork = Builder(name = "PlusNetwork", defaultWidth = 24.0.dp, defaultHeight =
...
private var _plusNetwork: ImageVector? = null
