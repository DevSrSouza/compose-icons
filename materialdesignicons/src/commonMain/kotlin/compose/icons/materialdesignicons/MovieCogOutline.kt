...
public val MaterialDesignIcons.MovieCogOutline: ImageVector
    get() {
        if (_movieCogOutline != null) {
            return _movieCogOutline!!
        }
        _movieCogOutline = Builder(name = "MovieCogOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.38f, 12.39f, 20.71f, 12.18f, 20.0f, 12.08f)
                verticalLineTo(10.0f)
                horizontalLineTo(5.76f)
                lineTo(4.0f, 6.47f)
                verticalLineTo(18.0f)
                horizontalLineTo(12.08f)
                curveTo(12.03f, 18.33f, 12.0f, 18.66f, 12.0f, 19.0f)
                moveTo(23.8f, 20.4f)
...
private var _movieCogOutline: ImageVector? = null
