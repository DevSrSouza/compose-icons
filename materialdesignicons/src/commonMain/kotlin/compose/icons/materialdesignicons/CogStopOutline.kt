...
public val MaterialDesignIcons.CogStopOutline: ImageVector
    get() {
        if (_cogStopOutline != null) {
            return _cogStopOutline!!
        }
        _cogStopOutline = Builder(name = "CogStopOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cogStopOutline: ImageVector? = null
