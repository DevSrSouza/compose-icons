...
public val MaterialDesignIcons.CogPlay: ImageVector
    get() {
        if (_cogPlay != null) {
            return _cogPlay!!
        }
        _cogPlay = Builder(name = "CogPlay", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cogPlay: ImageVector? = null
