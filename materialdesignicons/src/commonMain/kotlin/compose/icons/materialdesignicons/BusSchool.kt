...
public val MaterialDesignIcons.BusSchool: ImageVector
    get() {
        if (_busSchool != null) {
            return _busSchool!!
        }
        _busSchool = Builder(name = "BusSchool", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(8.0f)
                curveTo(19.0f, 6.89f, 18.11f, 6.0f, 17.0f, 6.0f)
                horizontalLineTo(3.0f)
                moveTo(13.5f, 7.5f)
...
private var _busSchool: ImageVector? = null
