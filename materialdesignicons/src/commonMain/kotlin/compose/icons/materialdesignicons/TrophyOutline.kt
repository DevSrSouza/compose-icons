...
public val MaterialDesignIcons.TrophyOutline: ImageVector
    get() {
        if (_trophyOutline != null) {
            return _trophyOutline!!
        }
        _trophyOutline = Builder(name = "TrophyOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(11.0f)
                moveTo(16.0f, 11.5f)
                curveTo(16.0f, 13.43f, 15.42f, 15.0f, 12.0f, 15.0f)
                curveTo(8.59f, 15.0f, 8.0f, 13.43f, 8.0f, 11.5f)
                verticalLineTo(6.0f)
                horizontalLineTo(16.0f)
