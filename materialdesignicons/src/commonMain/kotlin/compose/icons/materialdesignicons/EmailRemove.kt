...
public val MaterialDesignIcons.EmailRemove: ImageVector
    get() {
        if (_emailRemove != null) {
            return _emailRemove!!
        }
        _emailRemove = Builder(name = "EmailRemove", defaultWidth = 24.0.dp, defaultHeight =
...
private var _emailRemove: ImageVector? = null
