...
public val MaterialDesignIcons.CircleSlice5: ImageVector
    get() {
        if (_circleSlice5 != null) {
            return _circleSlice5!!
        }
        _circleSlice5 = Builder(name = "CircleSlice5", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.07f, 19.0f, 8.32f, 18.22f, 7.05f, 16.95f)
                lineTo(12.0f, 12.0f)
                verticalLineTo(5.0f)
                close()
            }
