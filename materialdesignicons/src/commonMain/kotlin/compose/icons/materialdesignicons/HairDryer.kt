...
public val MaterialDesignIcons.HairDryer: ImageVector
    get() {
        if (_hairDryer != null) {
            return _hairDryer!!
        }
        _hairDryer = Builder(name = "HairDryer", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.5f, 10.0f)
                arcTo(2.5f, 2.5f, 0.0f, true, true, 10.0f, 7.5f)
