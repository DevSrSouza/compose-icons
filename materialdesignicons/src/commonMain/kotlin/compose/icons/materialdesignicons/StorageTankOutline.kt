...
public val MaterialDesignIcons.StorageTankOutline: ImageVector
    get() {
        if (_storageTankOutline != null) {
            return _storageTankOutline!!
        }
        _storageTankOutline = Builder(name = "StorageTankOutline", defaultWidth = 24.0.dp,
...
private var _storageTankOutline: ImageVector? = null
