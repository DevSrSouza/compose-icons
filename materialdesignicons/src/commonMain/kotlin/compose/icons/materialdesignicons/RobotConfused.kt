...
public val MaterialDesignIcons.RobotConfused: ImageVector
    get() {
        if (_robotConfused != null) {
            return _robotConfused!!
        }
        _robotConfused = Builder(name = "RobotConfused", defaultWidth = 24.0.dp, defaultHeight =
...
private var _robotConfused: ImageVector? = null
