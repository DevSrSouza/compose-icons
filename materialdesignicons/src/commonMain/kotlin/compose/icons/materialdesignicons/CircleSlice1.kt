...
public val MaterialDesignIcons.CircleSlice1: ImageVector
    get() {
        if (_circleSlice1 != null) {
            return _circleSlice1!!
        }
        _circleSlice1 = Builder(name = "CircleSlice1", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 5.0f)
                curveTo(13.93f, 5.0f, 15.68f, 5.78f, 16.95f, 7.05f)
                lineTo(12.0f, 12.0f)
                verticalLineTo(5.0f)
                close()
            }
