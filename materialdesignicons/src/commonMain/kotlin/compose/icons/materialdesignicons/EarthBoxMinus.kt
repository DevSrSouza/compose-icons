...
public val MaterialDesignIcons.EarthBoxMinus: ImageVector
    get() {
        if (_earthBoxMinus != null) {
            return _earthBoxMinus!!
        }
        _earthBoxMinus = Builder(name = "EarthBoxMinus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _earthBoxMinus: ImageVector? = null
