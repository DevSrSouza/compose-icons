...
public val MaterialDesignIcons.FolderCancelOutline: ImageVector
    get() {
        if (_folderCancelOutline != null) {
            return _folderCancelOutline!!
        }
        _folderCancelOutline = Builder(name = "FolderCancelOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.39f, 12.65f, 20.72f, 12.36f, 20.0f, 12.18f)
                verticalLineTo(8.0f)
                horizontalLineTo(4.0f)
...
private var _folderCancelOutline: ImageVector? = null
