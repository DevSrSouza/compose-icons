...
public val MaterialDesignIcons.BriefcaseVariantOutline: ImageVector
    get() {
        if (_briefcaseVariantOutline != null) {
            return _briefcaseVariantOutline!!
        }
        _briefcaseVariantOutline = Builder(name = "BriefcaseVariantOutline", defaultWidth = 24.0.dp,
