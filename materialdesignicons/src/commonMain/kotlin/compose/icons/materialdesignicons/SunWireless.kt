...
public val MaterialDesignIcons.SunWireless: ImageVector
    get() {
        if (_sunWireless != null) {
            return _sunWireless!!
        }
        _sunWireless = Builder(name = "SunWireless", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(11.0f, 6.0f)
                curveTo(13.76f, 6.0f, 16.0f, 8.24f, 16.0f, 11.0f)
                reflectiveCurveTo(13.76f, 16.0f, 11.0f, 16.0f)
                reflectiveCurveTo(6.0f, 13.76f, 6.0f, 11.0f)
...
private var _sunWireless: ImageVector? = null
