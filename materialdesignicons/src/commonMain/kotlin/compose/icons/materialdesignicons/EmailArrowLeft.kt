...
public val MaterialDesignIcons.EmailArrowLeft: ImageVector
    get() {
        if (_emailArrowLeft != null) {
            return _emailArrowLeft!!
        }
        _emailArrowLeft = Builder(name = "EmailArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _emailArrowLeft: ImageVector? = null
