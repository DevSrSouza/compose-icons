...
public val MaterialDesignIcons.FileClockOutline: ImageVector
    get() {
        if (_fileClockOutline != null) {
            return _fileClockOutline!!
        }
        _fileClockOutline = Builder(name = "FileClockOutline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(7.0f, 7.0f, 0.0f, false, false, 10.26f, 20.0f)
                horizontalLineTo(4.0f)
                verticalLineTo(4.0f)
                moveTo(16.0f, 11.0f)
