...
public val MaterialDesignIcons.CommentTextOutline: ImageVector
    get() {
        if (_commentTextOutline != null) {
            return _commentTextOutline!!
        }
        _commentTextOutline = Builder(name = "CommentTextOutline", defaultWidth = 24.0.dp,
...
private var _commentTextOutline: ImageVector? = null
