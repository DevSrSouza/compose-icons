...
public val MaterialDesignIcons.SpeakerPlay: ImageVector
    get() {
        if (_speakerPlay != null) {
            return _speakerPlay!!
        }
        _speakerPlay = Builder(name = "SpeakerPlay", defaultWidth = 24.0.dp, defaultHeight =
...
private var _speakerPlay: ImageVector? = null
