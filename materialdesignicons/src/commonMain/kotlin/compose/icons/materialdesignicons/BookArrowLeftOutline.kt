...
public val MaterialDesignIcons.BookArrowLeftOutline: ImageVector
    get() {
        if (_bookArrowLeftOutline != null) {
            return _bookArrowLeftOutline!!
        }
        _bookArrowLeftOutline = Builder(name = "BookArrowLeftOutline", defaultWidth = 24.0.dp,
...
private var _bookArrowLeftOutline: ImageVector? = null
