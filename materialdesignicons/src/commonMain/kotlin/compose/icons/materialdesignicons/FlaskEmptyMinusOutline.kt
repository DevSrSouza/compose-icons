...
public val MaterialDesignIcons.FlaskEmptyMinusOutline: ImageVector
    get() {
        if (_flaskEmptyMinusOutline != null) {
            return _flaskEmptyMinusOutline!!
        }
        _flaskEmptyMinusOutline = Builder(name = "FlaskEmptyMinusOutline", defaultWidth = 24.0.dp,
...
private var _flaskEmptyMinusOutline: ImageVector? = null
