...
public val MaterialDesignIcons.LockAlert: ImageVector
    get() {
        if (_lockAlert != null) {
            return _lockAlert!!
        }
        _lockAlert = Builder(name = "LockAlert", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.0f, 13.9f, 11.1f, 13.0f, 10.0f, 13.0f)
                curveTo(8.9f, 13.0f, 8.0f, 13.9f, 8.0f, 15.0f)
...
private var _lockAlert: ImageVector? = null
