...
public val MaterialDesignIcons.LockOpenRemoveOutline: ImageVector
    get() {
        if (_lockOpenRemoveOutline != null) {
            return _lockOpenRemoveOutline!!
        }
        _lockOpenRemoveOutline = Builder(name = "LockOpenRemoveOutline", defaultWidth = 24.0.dp,
...
private var _lockOpenRemoveOutline: ImageVector? = null
