...
public val MaterialDesignIcons.BellCheckOutline: ImageVector
    get() {
        if (_bellCheckOutline != null) {
            return _bellCheckOutline!!
        }
        _bellCheckOutline = Builder(name = "BellCheckOutline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(17.0f, 12.08f)
                verticalLineTo(11.0f)
                curveTo(17.0f, 8.24f, 14.76f, 6.0f, 12.0f, 6.0f)
                curveTo(9.24f, 6.0f, 7.0f, 8.24f, 7.0f, 11.0f)
