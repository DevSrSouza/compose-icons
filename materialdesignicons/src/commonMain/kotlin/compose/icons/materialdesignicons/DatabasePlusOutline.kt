...
public val MaterialDesignIcons.DatabasePlusOutline: ImageVector
    get() {
        if (_databasePlusOutline != null) {
            return _databasePlusOutline!!
        }
        _databasePlusOutline = Builder(name = "DatabasePlusOutline", defaultWidth = 24.0.dp,
...
private var _databasePlusOutline: ImageVector? = null
