...
public val MaterialDesignIcons.TruckMinusOutline: ImageVector
    get() {
        if (_truckMinusOutline != null) {
            return _truckMinusOutline!!
        }
        _truckMinusOutline = Builder(name = "TruckMinusOutline", defaultWidth = 24.0.dp,
...
private var _truckMinusOutline: ImageVector? = null
