...
public val MaterialDesignIcons.TimelineTextOutline: ImageVector
    get() {
        if (_timelineTextOutline != null) {
            return _timelineTextOutline!!
        }
        _timelineTextOutline = Builder(name = "TimelineTextOutline", defaultWidth = 24.0.dp,
...
private var _timelineTextOutline: ImageVector? = null
