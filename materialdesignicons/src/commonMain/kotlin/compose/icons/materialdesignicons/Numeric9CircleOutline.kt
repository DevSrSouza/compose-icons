...
public val MaterialDesignIcons.Numeric9CircleOutline: ImageVector
    get() {
        if (_numeric9CircleOutline != null) {
            return _numeric9CircleOutline!!
        }
        _numeric9CircleOutline = Builder(name = "Numeric9CircleOutline", defaultWidth = 24.0.dp,
...
private var _numeric9CircleOutline: ImageVector? = null
