...
public val MaterialDesignIcons.PlayBoxLockOutline: ImageVector
    get() {
        if (_playBoxLockOutline != null) {
            return _playBoxLockOutline!!
        }
        _playBoxLockOutline = Builder(name = "PlayBoxLockOutline", defaultWidth = 24.0.dp,
...
private var _playBoxLockOutline: ImageVector? = null
