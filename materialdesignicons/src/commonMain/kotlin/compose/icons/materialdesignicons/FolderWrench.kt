...
public val MaterialDesignIcons.FolderWrench: ImageVector
    get() {
        if (_folderWrench != null) {
            return _folderWrench!!
        }
        _folderWrench = Builder(name = "FolderWrench", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.0f, 17.64f, 11.8f, 19.09f, 13.03f, 20.0f)
