...
public val MaterialDesignIcons.AlphaSCircleOutline: ImageVector
    get() {
        if (_alphaSCircleOutline != null) {
            return _alphaSCircleOutline!!
        }
        _alphaSCircleOutline = Builder(name = "AlphaSCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaSCircleOutline: ImageVector? = null
