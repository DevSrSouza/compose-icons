...
public val MaterialDesignIcons.LockOpenPlus: ImageVector
    get() {
        if (_lockOpenPlus != null) {
            return _lockOpenPlus!!
        }
        _lockOpenPlus = Builder(name = "LockOpenPlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lockOpenPlus: ImageVector? = null
