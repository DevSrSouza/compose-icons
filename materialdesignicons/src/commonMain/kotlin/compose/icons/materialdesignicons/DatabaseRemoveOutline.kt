...
public val MaterialDesignIcons.DatabaseRemoveOutline: ImageVector
    get() {
        if (_databaseRemoveOutline != null) {
            return _databaseRemoveOutline!!
        }
        _databaseRemoveOutline = Builder(name = "DatabaseRemoveOutline", defaultWidth = 24.0.dp,
...
private var _databaseRemoveOutline: ImageVector? = null
