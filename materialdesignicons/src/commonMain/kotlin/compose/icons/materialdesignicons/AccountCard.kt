...
public val MaterialDesignIcons.AccountCard: ImageVector
    get() {
        if (_accountCard != null) {
            return _accountCard!!
        }
        _accountCard = Builder(name = "AccountCard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _accountCard: ImageVector? = null
