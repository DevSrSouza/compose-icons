...
public val MaterialDesignIcons.BookRemove: ImageVector
    get() {
        if (_bookRemove != null) {
            return _bookRemove!!
        }
        _bookRemove = Builder(name = "BookRemove", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bookRemove: ImageVector? = null
