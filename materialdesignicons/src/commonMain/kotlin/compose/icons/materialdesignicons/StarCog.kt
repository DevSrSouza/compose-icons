...
public val MaterialDesignIcons.StarCog: ImageVector
    get() {
        if (_starCog != null) {
            return _starCog!!
        }
        _starCog = Builder(name = "StarCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.8f, 12.0f)
                curveTo(15.59f, 12.1f, 12.91f, 14.37f, 12.19f, 17.39f)
                lineTo(12.0f, 17.27f)
                lineTo(5.82f, 21.0f)
                lineTo(7.45f, 13.97f)
                lineTo(2.0f, 9.24f)
...
private var _starCog: ImageVector? = null
