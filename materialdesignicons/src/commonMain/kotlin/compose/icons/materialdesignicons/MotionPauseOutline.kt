...
public val MaterialDesignIcons.MotionPauseOutline: ImageVector
    get() {
        if (_motionPauseOutline != null) {
            return _motionPauseOutline!!
        }
        _motionPauseOutline = Builder(name = "MotionPauseOutline", defaultWidth = 24.0.dp,
...
private var _motionPauseOutline: ImageVector? = null
