...
public val MaterialDesignIcons.AxisZArrowLock: ImageVector
    get() {
        if (_axisZArrowLock != null) {
            return _axisZArrowLock!!
        }
        _axisZArrowLock = Builder(name = "AxisZArrowLock", defaultWidth = 24.0.dp, defaultHeight =
...
private var _axisZArrowLock: ImageVector? = null
