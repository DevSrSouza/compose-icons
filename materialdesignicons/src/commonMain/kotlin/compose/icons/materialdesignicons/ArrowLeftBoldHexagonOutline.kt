...
public val MaterialDesignIcons.ArrowLeftBoldHexagonOutline: ImageVector
    get() {
        if (_arrowLeftBoldHexagonOutline != null) {
            return _arrowLeftBoldHexagonOutline!!
        }
        _arrowLeftBoldHexagonOutline = Builder(name = "ArrowLeftBoldHexagonOutline", defaultWidth =
...
private var _arrowLeftBoldHexagonOutline: ImageVector? = null
