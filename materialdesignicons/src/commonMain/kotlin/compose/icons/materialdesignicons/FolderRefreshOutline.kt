...
public val MaterialDesignIcons.FolderRefreshOutline: ImageVector
    get() {
        if (_folderRefreshOutline != null) {
            return _folderRefreshOutline!!
        }
        _folderRefreshOutline = Builder(name = "FolderRefreshOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.39f, 12.63f, 20.72f, 12.34f, 20.0f, 12.17f)
                verticalLineTo(8.0f)
                close()
            }
        }
...
private var _folderRefreshOutline: ImageVector? = null
