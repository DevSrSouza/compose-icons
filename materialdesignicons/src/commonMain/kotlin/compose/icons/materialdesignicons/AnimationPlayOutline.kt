...
public val MaterialDesignIcons.AnimationPlayOutline: ImageVector
    get() {
        if (_animationPlayOutline != null) {
            return _animationPlayOutline!!
        }
        _animationPlayOutline = Builder(name = "AnimationPlayOutline", defaultWidth = 24.0.dp,
...
private var _animationPlayOutline: ImageVector? = null
