...
public val MaterialDesignIcons.CalendarCollapseHorizontalOutline: ImageVector
    get() {
        if (_calendarCollapseHorizontalOutline != null) {
            return _calendarCollapseHorizontalOutline!!
        }
        _calendarCollapseHorizontalOutline = Builder(name = "CalendarCollapseHorizontalOutline",
