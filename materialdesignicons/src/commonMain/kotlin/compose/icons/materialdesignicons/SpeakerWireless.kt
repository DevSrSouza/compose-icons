...
public val MaterialDesignIcons.SpeakerWireless: ImageVector
    get() {
        if (_speakerWireless != null) {
            return _speakerWireless!!
        }
        _speakerWireless = Builder(name = "SpeakerWireless", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.11f, 16.22f, 21.0f, 14.21f, 21.0f, 12.0f)
                curveTo(21.0f, 9.78f, 20.11f, 7.78f, 18.66f, 6.34f)
                lineTo(20.07f, 4.93f)
