...
public val MaterialDesignIcons.CameraMeteringCenter: ImageVector
    get() {
        if (_cameraMeteringCenter != null) {
            return _cameraMeteringCenter!!
        }
        _cameraMeteringCenter = Builder(name = "CameraMeteringCenter", defaultWidth = 24.0.dp,
...
private var _cameraMeteringCenter: ImageVector? = null
