...
public val MaterialDesignIcons.PackageVariantPlus: ImageVector
    get() {
        if (_packageVariantPlus != null) {
            return _packageVariantPlus!!
        }
        _packageVariantPlus = Builder(name = "PackageVariantPlus", defaultWidth = 24.0.dp,
...
private var _packageVariantPlus: ImageVector? = null
