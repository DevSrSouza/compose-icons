...
public val MaterialDesignIcons.PackageVariantMinus: ImageVector
    get() {
        if (_packageVariantMinus != null) {
            return _packageVariantMinus!!
        }
        _packageVariantMinus = Builder(name = "PackageVariantMinus", defaultWidth = 24.0.dp,
...
private var _packageVariantMinus: ImageVector? = null
