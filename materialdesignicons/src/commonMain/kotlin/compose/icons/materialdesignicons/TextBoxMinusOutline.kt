...
public val MaterialDesignIcons.TextBoxMinusOutline: ImageVector
    get() {
        if (_textBoxMinusOutline != null) {
            return _textBoxMinusOutline!!
        }
        _textBoxMinusOutline = Builder(name = "TextBoxMinusOutline", defaultWidth = 24.0.dp,
...
private var _textBoxMinusOutline: ImageVector? = null
