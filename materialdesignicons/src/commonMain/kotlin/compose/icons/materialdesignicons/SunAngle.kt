...
public val MaterialDesignIcons.SunAngle: ImageVector
    get() {
        if (_sunAngle != null) {
            return _sunAngle!!
        }
        _sunAngle = Builder(name = "SunAngle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sunAngle: ImageVector? = null
