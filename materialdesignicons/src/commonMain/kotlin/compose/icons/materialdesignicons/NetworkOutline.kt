...
public val MaterialDesignIcons.NetworkOutline: ImageVector
    get() {
        if (_networkOutline != null) {
            return _networkOutline!!
        }
        _networkOutline = Builder(name = "NetworkOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _networkOutline: ImageVector? = null
