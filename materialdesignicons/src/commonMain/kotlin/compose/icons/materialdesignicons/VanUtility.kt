...
public val MaterialDesignIcons.VanUtility: ImageVector
    get() {
        if (_vanUtility != null) {
            return _vanUtility!!
        }
        _vanUtility = Builder(name = "VanUtility", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _vanUtility: ImageVector? = null
