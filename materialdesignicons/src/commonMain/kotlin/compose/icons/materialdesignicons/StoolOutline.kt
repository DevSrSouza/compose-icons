...
public val MaterialDesignIcons.StoolOutline: ImageVector
    get() {
        if (_stoolOutline != null) {
            return _stoolOutline!!
        }
        _stoolOutline = Builder(name = "StoolOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(16.07f, 13.0f)
                moveTo(6.0f, 6.0f)
                curveTo(6.0f, 4.9f, 6.89f, 4.0f, 8.0f, 4.0f)
