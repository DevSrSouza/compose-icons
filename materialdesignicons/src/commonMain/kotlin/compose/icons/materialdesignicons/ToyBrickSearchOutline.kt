...
public val MaterialDesignIcons.ToyBrickSearchOutline: ImageVector
    get() {
        if (_toyBrickSearchOutline != null) {
            return _toyBrickSearchOutline!!
        }
        _toyBrickSearchOutline = Builder(name = "ToyBrickSearchOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(6.59f, 6.59f, 0.0f, false, true, 10.5f, 18.0f)
                horizontalLineTo(5.0f)
                verticalLineTo(8.0f)
                horizontalLineTo(19.0f)
                verticalLineTo(9.5f)
                arcTo(6.59f, 6.59f, 0.0f, false, true, 21.0f, 10.81f)
                verticalLineTo(6.0f)
                moveTo(20.31f, 17.9f)
