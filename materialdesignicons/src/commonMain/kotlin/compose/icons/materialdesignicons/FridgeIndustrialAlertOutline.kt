...
public val MaterialDesignIcons.FridgeIndustrialAlertOutline: ImageVector
    get() {
        if (_fridgeIndustrialAlertOutline != null) {
            return _fridgeIndustrialAlertOutline!!
        }
        _fridgeIndustrialAlertOutline = Builder(name = "FridgeIndustrialAlertOutline", defaultWidth
