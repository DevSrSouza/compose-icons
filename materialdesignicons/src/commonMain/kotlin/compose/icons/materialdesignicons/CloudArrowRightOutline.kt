...
public val MaterialDesignIcons.CloudArrowRightOutline: ImageVector
    get() {
        if (_cloudArrowRightOutline != null) {
            return _cloudArrowRightOutline!!
        }
        _cloudArrowRightOutline = Builder(name = "CloudArrowRightOutline", defaultWidth = 24.0.dp,
...
private var _cloudArrowRightOutline: ImageVector? = null
