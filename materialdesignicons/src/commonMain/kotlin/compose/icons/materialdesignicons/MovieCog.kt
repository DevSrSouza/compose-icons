...
public val MaterialDesignIcons.MovieCog: ImageVector
    get() {
        if (_movieCog != null) {
            return _movieCog!!
        }
        _movieCog = Builder(name = "MovieCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _movieCog: ImageVector? = null
