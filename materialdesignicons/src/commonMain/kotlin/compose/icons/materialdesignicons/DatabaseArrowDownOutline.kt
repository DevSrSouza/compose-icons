...
public val MaterialDesignIcons.DatabaseArrowDownOutline: ImageVector
    get() {
        if (_databaseArrowDownOutline != null) {
            return _databaseArrowDownOutline!!
        }
        _databaseArrowDownOutline = Builder(name = "DatabaseArrowDownOutline", defaultWidth =
...
private var _databaseArrowDownOutline: ImageVector? = null
