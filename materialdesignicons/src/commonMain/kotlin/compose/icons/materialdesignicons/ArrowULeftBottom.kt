...
public val MaterialDesignIcons.ArrowULeftBottom: ImageVector
    get() {
        if (_arrowULeftBottom != null) {
            return _arrowULeftBottom!!
        }
        _arrowULeftBottom = Builder(name = "ArrowULeftBottom", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(16.0f, 6.0f, 13.5f, 6.0f)
                horizontalLineTo(6.0f)
                verticalLineTo(4.0f)
                horizontalLineTo(13.5f)
                curveTo(17.09f, 4.0f, 20.0f, 6.91f, 20.0f, 10.5f)
                close()
            }
        }
        .build()
