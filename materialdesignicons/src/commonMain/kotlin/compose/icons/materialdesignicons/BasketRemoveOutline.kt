...
public val MaterialDesignIcons.BasketRemoveOutline: ImageVector
    get() {
        if (_basketRemoveOutline != null) {
            return _basketRemoveOutline!!
        }
        _basketRemoveOutline = Builder(name = "BasketRemoveOutline", defaultWidth = 24.0.dp,
...
private var _basketRemoveOutline: ImageVector? = null
