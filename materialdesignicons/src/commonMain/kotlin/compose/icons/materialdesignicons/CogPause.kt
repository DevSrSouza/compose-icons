...
public val MaterialDesignIcons.CogPause: ImageVector
    get() {
        if (_cogPause != null) {
            return _cogPause!!
        }
        _cogPause = Builder(name = "CogPause", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cogPause: ImageVector? = null
