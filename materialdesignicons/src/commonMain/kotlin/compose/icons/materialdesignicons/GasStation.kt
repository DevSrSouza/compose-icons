...
public val MaterialDesignIcons.GasStation: ImageVector
    get() {
        if (_gasStation != null) {
            return _gasStation!!
        }
        _gasStation = Builder(name = "GasStation", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(15.0f, 4.56f)
                lineTo(17.11f, 6.67f)
                curveTo(16.17f, 7.0f, 15.5f, 7.93f, 15.5f, 9.0f)
                ...
                verticalLineTo(5.0f)
                curveTo(14.0f, 3.89f, 13.1f, 3.0f, 12.0f, 3.0f)
                horizontalLineTo(6.0f)
                curveTo(4.89f, 3.0f, 4.0f, 3.89f, 4.0f, 5.0f)
