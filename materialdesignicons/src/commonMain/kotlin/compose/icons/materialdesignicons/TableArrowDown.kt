...
public val MaterialDesignIcons.TableArrowDown: ImageVector
    get() {
        if (_tableArrowDown != null) {
            return _tableArrowDown!!
        }
        _tableArrowDown = Builder(name = "TableArrowDown", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tableArrowDown: ImageVector? = null
