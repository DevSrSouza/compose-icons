...
public val MaterialDesignIcons.PhonePlusOutline: ImageVector
    get() {
        if (_phonePlusOutline != null) {
            return _phonePlusOutline!!
        }
        _phonePlusOutline = Builder(name = "PhonePlusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _phonePlusOutline: ImageVector? = null
