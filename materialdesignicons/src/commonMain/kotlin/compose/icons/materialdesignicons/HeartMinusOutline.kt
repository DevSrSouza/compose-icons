...
public val MaterialDesignIcons.HeartMinusOutline: ImageVector
    get() {
        if (_heartMinusOutline != null) {
            return _heartMinusOutline!!
        }
        _heartMinusOutline = Builder(name = "HeartMinusOutline", defaultWidth = 24.0.dp,
...
private var _heartMinusOutline: ImageVector? = null
