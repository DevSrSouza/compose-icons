...
public val MaterialDesignIcons.FolderText: ImageVector
    get() {
        if (_folderText != null) {
            return _folderText!!
        }
        _folderText = Builder(name = "FolderText", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _folderText: ImageVector? = null
