...
public val MaterialDesignIcons.LockMinusOutline: ImageVector
    get() {
        if (_lockMinusOutline != null) {
            return _lockMinusOutline!!
        }
        _lockMinusOutline = Builder(name = "LockMinusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _lockMinusOutline: ImageVector? = null
