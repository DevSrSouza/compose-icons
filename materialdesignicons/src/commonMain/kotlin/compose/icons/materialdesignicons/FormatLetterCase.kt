...
public val MaterialDesignIcons.FormatLetterCase: ImageVector
    get() {
        if (_formatLetterCase != null) {
            return _formatLetterCase!!
        }
        _formatLetterCase = Builder(name = "FormatLetterCase", defaultWidth = 24.0.dp, defaultHeight
...
private var _formatLetterCase: ImageVector? = null
