...
public val MaterialDesignIcons.GamepadRoundUp: ImageVector
    get() {
        if (_gamepadRoundUp != null) {
            return _gamepadRoundUp!!
        }
        _gamepadRoundUp = Builder(name = "GamepadRoundUp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gamepadRoundUp: ImageVector? = null
