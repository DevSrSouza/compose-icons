...
public val MaterialDesignIcons.AccountArrowDown: ImageVector
    get() {
        if (_accountArrowDown != null) {
            return _accountArrowDown!!
        }
        _accountArrowDown = Builder(name = "AccountArrowDown", defaultWidth = 24.0.dp, defaultHeight
...
private var _accountArrowDown: ImageVector? = null
