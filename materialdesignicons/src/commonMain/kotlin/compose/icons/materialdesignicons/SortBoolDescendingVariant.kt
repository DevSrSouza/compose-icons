...
public val MaterialDesignIcons.SortBoolDescendingVariant: ImageVector
    get() {
        if (_sortBoolDescendingVariant != null) {
            return _sortBoolDescendingVariant!!
        }
        _sortBoolDescendingVariant = Builder(name = "SortBoolDescendingVariant", defaultWidth =
...
private var _sortBoolDescendingVariant: ImageVector? = null
