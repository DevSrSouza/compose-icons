...
public val MaterialDesignIcons.ScriptOutline: ImageVector
    get() {
        if (_scriptOutline != null) {
            return _scriptOutline!!
        }
        _scriptOutline = Builder(name = "ScriptOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _scriptOutline: ImageVector? = null
