...
public val MaterialDesignIcons.PropaneTankOutline: ImageVector
    get() {
        if (_propaneTankOutline != null) {
            return _propaneTankOutline!!
        }
        _propaneTankOutline = Builder(name = "PropaneTankOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(10.0f)
                curveTo(6.0f, 8.9f, 6.9f, 8.0f, 8.0f, 8.0f)
                moveTo(16.0f, 20.0f)
