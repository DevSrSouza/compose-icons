...
public val MaterialDesignIcons.FlagVariantMinusOutline: ImageVector
    get() {
        if (_flagVariantMinusOutline != null) {
            return _flagVariantMinusOutline!!
        }
        _flagVariantMinusOutline = Builder(name = "FlagVariantMinusOutline", defaultWidth = 24.0.dp,
...
private var _flagVariantMinusOutline: ImageVector? = null
