...
public val MaterialDesignIcons.FlaskRoundBottomEmptyOutline: ImageVector
    get() {
        if (_flaskRoundBottomEmptyOutline != null) {
            return _flaskRoundBottomEmptyOutline!!
        }
        _flaskRoundBottomEmptyOutline = Builder(name = "FlaskRoundBottomEmptyOutline", defaultWidth
