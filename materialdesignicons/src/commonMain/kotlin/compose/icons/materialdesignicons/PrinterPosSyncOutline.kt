...
public val MaterialDesignIcons.PrinterPosSyncOutline: ImageVector
    get() {
        if (_printerPosSyncOutline != null) {
            return _printerPosSyncOutline!!
        }
        _printerPosSyncOutline = Builder(name = "PrinterPosSyncOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.23f, 11.0f, 17.05f, 11.37f, 16.05f, 12.0f)
                horizontalLineTo(6.0f)
                verticalLineTo(17.0f)
                horizontalLineTo(13.03f)
                curveTo(13.0f, 17.17f, 13.0f, 17.33f, 13.0f, 17.5f)
                moveTo(9.0f, 10.0f)
