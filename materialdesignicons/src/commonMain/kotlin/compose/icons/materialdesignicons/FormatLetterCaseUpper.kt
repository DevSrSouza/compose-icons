...
public val MaterialDesignIcons.FormatLetterCaseUpper: ImageVector
    get() {
        if (_formatLetterCaseUpper != null) {
            return _formatLetterCaseUpper!!
        }
        _formatLetterCaseUpper = Builder(name = "FormatLetterCaseUpper", defaultWidth = 24.0.dp,
...
private var _formatLetterCaseUpper: ImageVector? = null
