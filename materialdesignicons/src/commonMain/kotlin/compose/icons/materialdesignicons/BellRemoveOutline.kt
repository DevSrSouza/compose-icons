...
public val MaterialDesignIcons.BellRemoveOutline: ImageVector
    get() {
        if (_bellRemoveOutline != null) {
            return _bellRemoveOutline!!
        }
        _bellRemoveOutline = Builder(name = "BellRemoveOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.33f, 12.04f, 17.66f, 12.0f, 18.0f, 12.0f)
...
private var _bellRemoveOutline: ImageVector? = null
