...
public val MaterialDesignIcons.ThumbsUpDownOutline: ImageVector
    get() {
        if (_thumbsUpDownOutline != null) {
            return _thumbsUpDownOutline!!
        }
        _thumbsUpDownOutline = Builder(name = "ThumbsUpDownOutline", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 6.0f)
                curveTo(12.0f, 5.45f, 11.55f, 5.0f, 11.0f, 5.0f)
                ...
                curveTo(0.0f, 13.33f, 0.67f, 14.0f, 1.5f, 14.0f)
                ...
                curveTo(12.0f, 18.55f, 12.45f, 19.0f, 13.0f, 19.0f)
                ...
                curveTo(24.0f, 10.67f, 23.33f, 10.0f, 22.5f, 10.0f)
                moveTo(22.0f, 17.79f)
