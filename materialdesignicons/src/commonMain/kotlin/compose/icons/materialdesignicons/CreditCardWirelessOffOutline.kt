...
public val MaterialDesignIcons.CreditCardWirelessOffOutline: ImageVector
    get() {
        if (_creditCardWirelessOffOutline != null) {
            return _creditCardWirelessOffOutline!!
        }
        _creditCardWirelessOffOutline = Builder(name = "CreditCardWirelessOffOutline", defaultWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.47f, 23.0f, 18.92f, 22.84f, 19.27f, 22.54f)
                lineTo(19.73f, 23.0f)
                lineTo(21.0f, 21.72f)
                moveTo(12.0f, 6.0f)
...
private var _creditCardWirelessOffOutline: ImageVector? = null
