...
public val MaterialDesignIcons.TagCheck: ImageVector
    get() {
        if (_tagCheck != null) {
            return _tagCheck!!
        }
        _tagCheck = Builder(name = "TagCheck", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tagCheck: ImageVector? = null
