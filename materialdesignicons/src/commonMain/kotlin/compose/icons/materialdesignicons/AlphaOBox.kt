...
public val MaterialDesignIcons.AlphaOBox: ImageVector
    get() {
        if (_alphaOBox != null) {
            return _alphaOBox!!
        }
        _alphaOBox = Builder(name = "AlphaOBox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _alphaOBox: ImageVector? = null
