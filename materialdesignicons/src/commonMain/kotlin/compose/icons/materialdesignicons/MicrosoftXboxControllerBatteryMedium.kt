...
public val MaterialDesignIcons.MicrosoftXboxControllerBatteryMedium: ImageVector
    get() {
        if (_microsoftXboxControllerBatteryMedium != null) {
            return _microsoftXboxControllerBatteryMedium!!
        }
        _microsoftXboxControllerBatteryMedium = Builder(name =
                "MicrosoftXboxControllerBatteryMedium", defaultWidth = 24.0.dp, defaultHeight =
