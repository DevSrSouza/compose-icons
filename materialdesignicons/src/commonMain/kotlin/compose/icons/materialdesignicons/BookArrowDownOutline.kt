...
public val MaterialDesignIcons.BookArrowDownOutline: ImageVector
    get() {
        if (_bookArrowDownOutline != null) {
            return _bookArrowDownOutline!!
        }
        _bookArrowDownOutline = Builder(name = "BookArrowDownOutline", defaultWidth = 24.0.dp,
...
private var _bookArrowDownOutline: ImageVector? = null
