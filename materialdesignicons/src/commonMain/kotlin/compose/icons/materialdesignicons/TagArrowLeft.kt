...
public val MaterialDesignIcons.TagArrowLeft: ImageVector
    get() {
        if (_tagArrowLeft != null) {
            return _tagArrowLeft!!
        }
        _tagArrowLeft = Builder(name = "TagArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tagArrowLeft: ImageVector? = null
