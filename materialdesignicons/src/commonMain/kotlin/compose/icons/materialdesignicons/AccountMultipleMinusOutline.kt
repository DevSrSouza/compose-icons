...
public val MaterialDesignIcons.AccountMultipleMinusOutline: ImageVector
    get() {
        if (_accountMultipleMinusOutline != null) {
            return _accountMultipleMinusOutline!!
        }
        _accountMultipleMinusOutline = Builder(name = "AccountMultipleMinusOutline", defaultWidth =
