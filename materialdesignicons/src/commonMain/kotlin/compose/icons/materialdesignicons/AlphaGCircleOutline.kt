...
public val MaterialDesignIcons.AlphaGCircleOutline: ImageVector
    get() {
        if (_alphaGCircleOutline != null) {
            return _alphaGCircleOutline!!
        }
        _alphaGCircleOutline = Builder(name = "AlphaGCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaGCircleOutline: ImageVector? = null
