...
public val MaterialDesignIcons.MoviePlay: ImageVector
    get() {
        if (_moviePlay != null) {
            return _moviePlay!!
        }
        _moviePlay = Builder(name = "MoviePlay", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _moviePlay: ImageVector? = null
