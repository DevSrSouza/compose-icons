...
public val MaterialDesignIcons.TagCheckOutline: ImageVector
    get() {
        if (_tagCheckOutline != null) {
            return _tagCheckOutline!!
        }
        _tagCheckOutline = Builder(name = "TagCheckOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tagCheckOutline: ImageVector? = null
