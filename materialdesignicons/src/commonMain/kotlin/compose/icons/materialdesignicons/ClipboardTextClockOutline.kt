...
public val MaterialDesignIcons.ClipboardTextClockOutline: ImageVector
    get() {
        if (_clipboardTextClockOutline != null) {
            return _clipboardTextClockOutline!!
        }
        _clipboardTextClockOutline = Builder(name = "ClipboardTextClockOutline", defaultWidth =
...
private var _clipboardTextClockOutline: ImageVector? = null
