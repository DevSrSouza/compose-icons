...
public val MaterialDesignIcons.EmailSyncOutline: ImageVector
    get() {
        if (_emailSyncOutline != null) {
            return _emailSyncOutline!!
        }
        _emailSyncOutline = Builder(name = "EmailSyncOutline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(6.5f, 6.5f, 0.0f, false, true, 13.0f, 18.0f)
