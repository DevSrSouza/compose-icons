...
public val MaterialDesignIcons.DatabaseMinusOutline: ImageVector
    get() {
        if (_databaseMinusOutline != null) {
            return _databaseMinusOutline!!
        }
        _databaseMinusOutline = Builder(name = "DatabaseMinusOutline", defaultWidth = 24.0.dp,
...
private var _databaseMinusOutline: ImageVector? = null
