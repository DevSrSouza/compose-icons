...
public val MaterialDesignIcons.TimerMinusOutline: ImageVector
    get() {
        if (_timerMinusOutline != null) {
            return _timerMinusOutline!!
        }
        _timerMinusOutline = Builder(name = "TimerMinusOutline", defaultWidth = 24.0.dp,
...
private var _timerMinusOutline: ImageVector? = null
