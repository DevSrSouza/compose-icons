...
public val MaterialDesignIcons.BookPlay: ImageVector
    get() {
        if (_bookPlay != null) {
            return _bookPlay!!
        }
        _bookPlay = Builder(name = "BookPlay", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bookPlay: ImageVector? = null
