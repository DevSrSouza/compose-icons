...
public val MaterialDesignIcons.CookiePlusOutline: ImageVector
    get() {
        if (_cookiePlusOutline != null) {
            return _cookiePlusOutline!!
        }
        _cookiePlusOutline = Builder(name = "CookiePlusOutline", defaultWidth = 24.0.dp,
...
private var _cookiePlusOutline: ImageVector? = null
