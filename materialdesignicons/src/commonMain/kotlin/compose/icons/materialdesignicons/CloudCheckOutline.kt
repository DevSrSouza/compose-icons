...
public val MaterialDesignIcons.CloudCheckOutline: ImageVector
    get() {
        if (_cloudCheckOutline != null) {
            return _cloudCheckOutline!!
        }
        _cloudCheckOutline = Builder(name = "CloudCheckOutline", defaultWidth = 24.0.dp,
...
private var _cloudCheckOutline: ImageVector? = null
