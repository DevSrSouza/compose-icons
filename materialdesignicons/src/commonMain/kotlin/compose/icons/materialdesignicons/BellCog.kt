...
public val MaterialDesignIcons.BellCog: ImageVector
    get() {
        if (_bellCog != null) {
            return _bellCog!!
        }
        _bellCog = Builder(name = "BellCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.39f, 23.0f, 12.75f, 22.88f, 13.06f, 22.69f)
                curveTo(12.74f, 22.17f, 12.5f, 21.6f, 12.3f, 21.0f)
                ...
                curveTo(21.0f, 22.17f, 20.75f, 22.34f, 20.44f, 22.47f)
                lineTo(20.25f, 23.79f)
                curveTo(20.23f, 23.91f, 20.13f, 24.0f, 20.0f, 24.0f)
                horizontalLineTo(18.0f)
                curveTo(17.88f, 24.0f, 17.77f, 23.91f, 17.75f, 23.79f)
                lineTo(17.57f, 22.47f)
                curveTo(17.25f, 22.34f, 17.0f, 22.17f, 16.72f, 21.97f)
                lineTo(15.5f, 22.5f)
                curveTo(15.37f, 22.5f, 15.23f, 22.5f, 15.17f, 22.37f)
                lineTo(14.17f, 20.64f)
                curveTo(14.11f, 20.53f, 14.14f, 20.39f, 14.23f, 20.32f)
                lineTo(15.29f, 19.5f)
                curveTo(15.27f, 19.33f, 15.25f, 19.17f, 15.25f, 19.0f)
                ...
                lineTo(16.72f, 16.0f)
                curveTo(17.0f, 15.83f, 17.25f, 15.66f, 17.57f, 15.54f)
                lineTo(17.75f, 14.21f)
                curveTo(17.77f, 14.09f, 17.88f, 14.0f, 18.0f, 14.0f)
                horizontalLineTo(20.0f)
                curveTo(20.13f, 14.0f, 20.23f, 14.09f, 20.25f, 14.21f)
                lineTo(20.44f, 15.54f)
                curveTo(20.75f, 15.66f, 21.0f, 15.83f, 21.28f, 16.0f)
                ...
                lineTo(22.72f, 18.5f)
                curveTo(22.74f, 18.67f, 22.75f, 18.84f, 22.75f, 19.0f)
                reflectiveCurveTo(22.74f, 19.33f, 22.72f, 19.5f)
                lineTo(23.77f, 20.32f)
                moveTo(20.75f, 19.0f)
                curveTo(20.75f, 18.03f, 19.97f, 17.25f, 19.0f, 17.25f)
                reflectiveCurveTo(17.25f, 18.03f, 17.25f, 19.0f)
                reflectiveCurveTo(18.04f, 20.75f, 19.0f, 20.75f)
                reflectiveCurveTo(20.75f, 19.97f, 20.75f, 19.0f)
                close()
            }
        }
        .build()
