...
public val MaterialDesignIcons.Numeric3CircleOutline: ImageVector
    get() {
        if (_numeric3CircleOutline != null) {
            return _numeric3CircleOutline!!
        }
        _numeric3CircleOutline = Builder(name = "Numeric3CircleOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.5f, 1.5f, 0.0f, false, true, 15.0f, 13.5f)
                verticalLineTo(15.0f)
                moveTo(12.0f, 2.0f)
