...
public val MaterialDesignIcons.FileDocumentMultipleOutline: ImageVector
    get() {
        if (_fileDocumentMultipleOutline != null) {
            return _fileDocumentMultipleOutline!!
        }
        _fileDocumentMultipleOutline = Builder(name = "FileDocumentMultipleOutline", defaultWidth =
