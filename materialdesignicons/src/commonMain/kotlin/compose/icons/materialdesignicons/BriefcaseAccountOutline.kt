...
public val MaterialDesignIcons.BriefcaseAccountOutline: ImageVector
    get() {
        if (_briefcaseAccountOutline != null) {
            return _briefcaseAccountOutline!!
        }
        _briefcaseAccountOutline = Builder(name = "BriefcaseAccountOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(14.0f)
                moveTo(12.0f, 9.0f)
                arcTo(2.25f, 2.25f, 0.0f, false, true, 14.25f, 11.25f)
                curveTo(14.25f, 12.5f, 13.24f, 13.5f, 12.0f, 13.5f)
                arcTo(2.25f, 2.25f, 0.0f, false, true, 9.75f, 11.25f)
                curveTo(9.75f, 10.0f, 10.76f, 9.0f, 12.0f, 9.0f)
                moveTo(16.5f, 18.0f)
