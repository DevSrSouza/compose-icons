...
public val MaterialDesignIcons.AccessPointCheck: ImageVector
    get() {
        if (_accessPointCheck != null) {
            return _accessPointCheck!!
        }
        _accessPointCheck = Builder(name = "AccessPointCheck", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.6f, 12.13f, 17.28f, 12.0f, 18.0f, 12.0f)
                curveTo(18.0f, 10.35f, 17.33f, 8.85f, 16.24f, 7.76f)
                lineTo(14.83f, 9.17f)
                curveTo(15.55f, 9.89f, 16.0f, 10.89f, 16.0f, 12.0f)
                curveTo(16.0f, 12.12f, 15.97f, 12.24f, 15.96f, 12.36f)
                moveTo(12.0f, 10.0f)
