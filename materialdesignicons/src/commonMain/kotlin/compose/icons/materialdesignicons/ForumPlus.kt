...
public val MaterialDesignIcons.ForumPlus: ImageVector
    get() {
        if (_forumPlus != null) {
            return _forumPlus!!
        }
        _forumPlus = Builder(name = "ForumPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _forumPlus: ImageVector? = null
