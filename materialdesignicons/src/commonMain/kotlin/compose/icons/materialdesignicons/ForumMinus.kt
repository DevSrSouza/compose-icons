...
public val MaterialDesignIcons.ForumMinus: ImageVector
    get() {
        if (_forumMinus != null) {
            return _forumMinus!!
        }
        _forumMinus = Builder(name = "ForumMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _forumMinus: ImageVector? = null
