...
public val MaterialDesignIcons.FolderArrowRightOutline: ImageVector
    get() {
        if (_folderArrowRightOutline != null) {
            return _folderArrowRightOutline!!
        }
        _folderArrowRightOutline = Builder(name = "FolderArrowRightOutline", defaultWidth = 24.0.dp,
...
private var _folderArrowRightOutline: ImageVector? = null
