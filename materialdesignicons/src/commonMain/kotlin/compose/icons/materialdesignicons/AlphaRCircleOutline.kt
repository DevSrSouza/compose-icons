...
public val MaterialDesignIcons.AlphaRCircleOutline: ImageVector
    get() {
        if (_alphaRCircleOutline != null) {
            return _alphaRCircleOutline!!
        }
        _alphaRCircleOutline = Builder(name = "AlphaRCircleOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.0f, 11.84f, 14.5f, 12.55f, 13.76f, 12.85f)
                lineTo(15.0f, 17.0f)
                horizontalLineTo(13.0f)
                lineTo(11.8f, 13.0f)
                ...
                curveTo(4.0f, 16.41f, 7.58f, 20.0f, 12.0f, 20.0f)
