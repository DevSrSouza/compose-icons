...
public val MaterialDesignIcons.CircleOutline: ImageVector
    get() {
        if (_circleOutline != null) {
            return _circleOutline!!
        }
        _circleOutline = Builder(name = "CircleOutline", defaultWidth = 24.0.dp, defaultHeight =
