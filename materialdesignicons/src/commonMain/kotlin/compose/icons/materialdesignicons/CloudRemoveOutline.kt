...
public val MaterialDesignIcons.CloudRemoveOutline: ImageVector
    get() {
        if (_cloudRemoveOutline != null) {
            return _cloudRemoveOutline!!
        }
        _cloudRemoveOutline = Builder(name = "CloudRemoveOutline", defaultWidth = 24.0.dp,
...
private var _cloudRemoveOutline: ImageVector? = null
