...
public val MaterialDesignIcons.SelectSearch: ImageVector
    get() {
        if (_selectSearch != null) {
            return _selectSearch!!
        }
        _selectSearch = Builder(name = "SelectSearch", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.46f, 12.21f, 19.79f, 11.54f, 19.0f, 11.03f)
                moveTo(17.0f, 5.0f)
