...
public val MaterialDesignIcons.MotionPlay: ImageVector
    get() {
        if (_motionPlay != null) {
            return _motionPlay!!
        }
        _motionPlay = Builder(name = "MotionPlay", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.67f, 6.0f, 6.0f, 8.67f, 6.0f, 12.0f)
                curveTo(6.0f, 15.33f, 8.67f, 18.0f, 12.0f, 18.0f)
                curveTo(15.33f, 18.0f, 18.0f, 15.33f, 18.0f, 12.0f)
                moveTo(15.0f, 12.0f)
                lineTo(10.0f, 15.0f)
                verticalLineTo(9.0f)
            }
...
private var _motionPlay: ImageVector? = null
