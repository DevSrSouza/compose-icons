...
public val MaterialDesignIcons.SourceBranchRefresh: ImageVector
    get() {
        if (_sourceBranchRefresh != null) {
            return _sourceBranchRefresh!!
        }
        _sourceBranchRefresh = Builder(name = "SourceBranchRefresh", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.0f, 14.0f)
                curveTo(19.1f, 14.0f, 20.1f, 14.4f, 20.8f, 15.2f)
                lineTo(22.0f, 14.0f)
                verticalLineTo(18.0f)
                horizontalLineTo(18.0f)
                lineTo(19.8f, 16.2f)
                curveTo(19.3f, 15.8f, 18.7f, 15.5f, 18.0f, 15.5f)
                curveTo(16.6f, 15.5f, 15.5f, 16.6f, 15.5f, 18.0f)
                reflectiveCurveTo(16.6f, 20.5f, 18.0f, 20.5f)
                curveTo(18.8f, 20.5f, 19.5f, 20.1f, 20.0f, 19.5f)
                horizontalLineTo(21.7f)
                curveTo(21.1f, 21.0f, 19.7f, 22.0f, 18.0f, 22.0f)
                curveTo(15.8f, 22.0f, 14.0f, 20.2f, 14.0f, 18.0f)
                reflectiveCurveTo(15.8f, 14.0f, 18.0f, 14.0f)
                close()
            }
        }
        .build()
...
private var _sourceBranchRefresh: ImageVector? = null
