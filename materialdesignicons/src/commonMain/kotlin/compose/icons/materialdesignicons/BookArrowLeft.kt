...
public val MaterialDesignIcons.BookArrowLeft: ImageVector
    get() {
        if (_bookArrowLeft != null) {
            return _bookArrowLeft!!
        }
        _bookArrowLeft = Builder(name = "BookArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bookArrowLeft: ImageVector? = null
