...
public val MaterialDesignIcons.Dice6Outline: ImageVector
    get() {
        if (_dice6Outline != null) {
            return _dice6Outline!!
        }
        _dice6Outline = Builder(name = "Dice6Outline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.5f, 10.5f)
                curveTo(15.7f, 10.5f, 15.0f, 11.2f, 15.0f, 12.0f)
                reflectiveCurveTo(15.7f, 13.5f, 16.5f, 13.5f)
                curveTo(17.3f, 13.5f, 18.0f, 12.8f, 18.0f, 12.0f)
                ...
                moveTo(7.5f, 10.5f)
                curveTo(6.7f, 10.5f, 6.0f, 11.2f, 6.0f, 12.0f)
                reflectiveCurveTo(6.7f, 13.5f, 7.5f, 13.5f)
                reflectiveCurveTo(9.0f, 12.8f, 9.0f, 12.0f)
