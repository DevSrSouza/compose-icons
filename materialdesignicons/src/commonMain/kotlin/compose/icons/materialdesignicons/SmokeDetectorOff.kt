...
public val MaterialDesignIcons.SmokeDetectorOff: ImageVector
    get() {
        if (_smokeDetectorOff != null) {
            return _smokeDetectorOff!!
        }
        _smokeDetectorOff = Builder(name = "SmokeDetectorOff", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 6.0f)
                curveTo(15.31f, 6.0f, 18.0f, 8.68f, 18.0f, 12.0f)
                curveTo(18.0f, 12.83f, 17.82f, 13.6f, 17.5f, 14.32f)
                lineTo(21.0f, 17.8f)
                verticalLineTo(5.0f)
                curveTo(21.0f, 3.9f, 20.11f, 3.0f, 19.0f, 3.0f)
                horizontalLineTo(6.2f)
                lineTo(9.68f, 6.5f)
                curveTo(10.4f, 6.18f, 11.17f, 6.0f, 12.0f, 6.0f)
                ...
                lineTo(13.71f, 15.6f)
                curveTo(13.19f, 15.85f, 12.62f, 16.0f, 12.0f, 16.0f)
                curveTo(9.79f, 16.0f, 8.0f, 14.21f, 8.0f, 12.0f)
                curveTo(8.0f, 11.39f, 8.15f, 10.81f, 8.4f, 10.29f)
                lineTo(6.92f, 8.81f)
                curveTo(6.34f, 9.74f, 6.0f, 10.83f, 6.0f, 12.0f)
                curveTo(6.0f, 15.31f, 8.69f, 18.0f, 12.0f, 18.0f)
                curveTo(13.17f, 18.0f, 14.26f, 17.66f, 15.19f, 17.08f)
                close()
            }
        }
        .build()
