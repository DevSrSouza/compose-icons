...
public val MaterialDesignIcons.CalendarLock: ImageVector
    get() {
        if (_calendarLock != null) {
            return _calendarLock!!
        }
        _calendarLock = Builder(name = "CalendarLock", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.4f, 11.6f, 19.7f, 11.2f, 19.0f, 11.1f)
                verticalLineTo(8.0f)
                horizontalLineTo(5.0f)
