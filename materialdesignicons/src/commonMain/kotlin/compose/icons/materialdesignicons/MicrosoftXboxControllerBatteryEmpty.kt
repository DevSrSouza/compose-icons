...
public val MaterialDesignIcons.MicrosoftXboxControllerBatteryEmpty: ImageVector
    get() {
        if (_microsoftXboxControllerBatteryEmpty != null) {
            return _microsoftXboxControllerBatteryEmpty!!
        }
        _microsoftXboxControllerBatteryEmpty = Builder(name = "MicrosoftXboxControllerBatteryEmpty",
...
private var _microsoftXboxControllerBatteryEmpty: ImageVector? = null
