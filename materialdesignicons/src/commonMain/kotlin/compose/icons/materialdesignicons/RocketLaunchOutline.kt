...
public val MaterialDesignIcons.RocketLaunchOutline: ImageVector
    get() {
        if (_rocketLaunchOutline != null) {
            return _rocketLaunchOutline!!
        }
        _rocketLaunchOutline = Builder(name = "RocketLaunchOutline", defaultWidth = 24.0.dp,
...
private var _rocketLaunchOutline: ImageVector? = null
