...
public val MaterialDesignIcons.PenMinus: ImageVector
    get() {
        if (_penMinus != null) {
            return _penMinus!!
        }
        _penMinus = Builder(name = "PenMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _penMinus: ImageVector? = null
