...
public val MaterialDesignIcons.HeadPlusOutline: ImageVector
    get() {
        if (_headPlusOutline != null) {
            return _headPlusOutline!!
        }
        _headPlusOutline = Builder(name = "HeadPlusOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _headPlusOutline: ImageVector? = null
