...
public val MaterialDesignIcons.StoreMarkerOutline: ImageVector
    get() {
        if (_storeMarkerOutline != null) {
            return _storeMarkerOutline!!
        }
        _storeMarkerOutline = Builder(name = "StoreMarkerOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(6.0f)
                moveTo(14.3f, 12.0f)
                curveTo(13.5f, 12.96f, 13.0f, 14.18f, 13.0f, 15.5f)
                curveTo(13.0f, 16.64f, 13.43f, 17.86f, 14.0f, 19.0f)
                ...
                horizontalLineTo(20.0f)
                lineTo(20.7f, 10.5f)
                curveTo(20.04f, 10.18f, 19.32f, 10.0f, 18.56f, 10.0f)
                lineTo(18.36f, 9.0f)
