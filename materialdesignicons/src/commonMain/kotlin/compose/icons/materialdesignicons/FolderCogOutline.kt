...
public val MaterialDesignIcons.FolderCogOutline: ImageVector
    get() {
        if (_folderCogOutline != null) {
            return _folderCogOutline!!
        }
        _folderCogOutline = Builder(name = "FolderCogOutline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(10.0f, 4.0f)
                moveTo(18.0f, 14.0f)
                curveTo(17.87f, 14.0f, 17.76f, 14.09f, 17.74f, 14.21f)
                lineTo(17.55f, 15.53f)
                curveTo(17.25f, 15.66f, 16.96f, 15.82f, 16.7f, 16.0f)
                lineTo(15.46f, 15.5f)
                curveTo(15.35f, 15.5f, 15.22f, 15.5f, 15.15f, 15.63f)
                lineTo(14.15f, 17.36f)
                curveTo(14.09f, 17.47f, 14.11f, 17.6f, 14.21f, 17.68f)
                lineTo(15.27f, 18.5f)
                curveTo(15.25f, 18.67f, 15.24f, 18.83f, 15.24f, 19.0f)
                ...
                curveTo(17.76f, 23.91f, 17.86f, 24.0f, 18.0f, 24.0f)
                horizontalLineTo(20.0f)
                curveTo(20.11f, 24.0f, 20.22f, 23.91f, 20.24f, 23.79f)
                lineTo(20.43f, 22.47f)
                curveTo(20.73f, 22.34f, 21.0f, 22.18f, 21.27f, 22.0f)
                lineTo(22.5f, 22.5f)
                curveTo(22.63f, 22.5f, 22.76f, 22.5f, 22.83f, 22.37f)
                lineTo(23.83f, 20.64f)
                curveTo(23.89f, 20.53f, 23.86f, 20.4f, 23.77f, 20.32f)
                lineTo(22.7f, 19.5f)
                curveTo(22.72f, 19.33f, 22.74f, 19.17f, 22.74f, 19.0f)
                ...
                lineTo(21.27f, 16.0f)
                curveTo(21.0f, 15.82f, 20.73f, 15.65f, 20.42f, 15.53f)
                lineTo(20.23f, 14.21f)
                curveTo(20.22f, 14.09f, 20.11f, 14.0f, 20.0f, 14.0f)
                moveTo(19.0f, 17.5f)
                curveTo(19.83f, 17.5f, 20.5f, 18.17f, 20.5f, 19.0f)
                curveTo(20.5f, 19.83f, 19.83f, 20.5f, 19.0f, 20.5f)
                curveTo(18.16f, 20.5f, 17.5f, 19.83f, 17.5f, 19.0f)
                curveTo(17.5f, 18.17f, 18.17f, 17.5f, 19.0f, 17.5f)
                close()
            }
        }
        .build()
...
private var _folderCogOutline: ImageVector? = null
