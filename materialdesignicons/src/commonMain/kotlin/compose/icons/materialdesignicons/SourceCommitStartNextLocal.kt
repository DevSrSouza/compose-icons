...
public val MaterialDesignIcons.SourceCommitStartNextLocal: ImageVector
    get() {
        if (_sourceCommitStartNextLocal != null) {
            return _sourceCommitStartNextLocal!!
        }
        _sourceCommitStartNextLocal = Builder(name = "SourceCommitStartNextLocal", defaultWidth =
...
private var _sourceCommitStartNextLocal: ImageVector? = null
