...
public val MaterialDesignIcons.PhoneOutline: ImageVector
    get() {
        if (_phoneOutline != null) {
            return _phoneOutline!!
        }
        _phoneOutline = Builder(name = "PhoneOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.3f, 14.9f, 16.2f, 14.9f, 16.1f, 14.9f)
...
private var _phoneOutline: ImageVector? = null
