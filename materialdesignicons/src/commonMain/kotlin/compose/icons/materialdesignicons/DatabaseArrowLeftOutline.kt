...
public val MaterialDesignIcons.DatabaseArrowLeftOutline: ImageVector
    get() {
        if (_databaseArrowLeftOutline != null) {
            return _databaseArrowLeftOutline!!
        }
        _databaseArrowLeftOutline = Builder(name = "DatabaseArrowLeftOutline", defaultWidth =
...
private var _databaseArrowLeftOutline: ImageVector? = null
