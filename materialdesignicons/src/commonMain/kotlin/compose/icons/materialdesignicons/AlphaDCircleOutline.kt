...
public val MaterialDesignIcons.AlphaDCircleOutline: ImageVector
    get() {
        if (_alphaDCircleOutline != null) {
            return _alphaDCircleOutline!!
        }
        _alphaDCircleOutline = Builder(name = "AlphaDCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaDCircleOutline: ImageVector? = null
