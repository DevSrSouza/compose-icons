...
public val MaterialDesignIcons.MopedElectricOutline: ImageVector
    get() {
        if (_mopedElectricOutline != null) {
            return _mopedElectricOutline!!
        }
        _mopedElectricOutline = Builder(name = "MopedElectricOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.0f, 9.9f, 4.9f, 9.0f, 6.0f, 9.0f)
...
private var _mopedElectricOutline: ImageVector? = null
