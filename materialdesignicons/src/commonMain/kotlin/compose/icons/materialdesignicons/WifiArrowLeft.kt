...
public val MaterialDesignIcons.WifiArrowLeft: ImageVector
    get() {
        if (_wifiArrowLeft != null) {
            return _wifiArrowLeft!!
        }
        _wifiArrowLeft = Builder(name = "WifiArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wifiArrowLeft: ImageVector? = null
