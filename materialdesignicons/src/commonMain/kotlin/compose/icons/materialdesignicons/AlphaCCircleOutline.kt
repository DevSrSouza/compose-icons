...
public val MaterialDesignIcons.AlphaCCircleOutline: ImageVector
    get() {
        if (_alphaCCircleOutline != null) {
            return _alphaCCircleOutline!!
        }
        _alphaCCircleOutline = Builder(name = "AlphaCCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaCCircleOutline: ImageVector? = null
