...
public val MaterialDesignIcons.PhoneForwardOutline: ImageVector
    get() {
        if (_phoneForwardOutline != null) {
            return _phoneForwardOutline!!
        }
        _phoneForwardOutline = Builder(name = "PhoneForwardOutline", defaultWidth = 24.0.dp,
...
private var _phoneForwardOutline: ImageVector? = null
