...
public val MaterialDesignIcons.MicrosoftXboxControllerBatteryLow: ImageVector
    get() {
        if (_microsoftXboxControllerBatteryLow != null) {
            return _microsoftXboxControllerBatteryLow!!
        }
        _microsoftXboxControllerBatteryLow = Builder(name = "MicrosoftXboxControllerBatteryLow",
...
private var _microsoftXboxControllerBatteryLow: ImageVector? = null
