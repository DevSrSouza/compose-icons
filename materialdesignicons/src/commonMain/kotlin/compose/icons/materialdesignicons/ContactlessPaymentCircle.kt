...
public val MaterialDesignIcons.ContactlessPaymentCircle: ImageVector
    get() {
        if (_contactlessPaymentCircle != null) {
            return _contactlessPaymentCircle!!
        }
        _contactlessPaymentCircle = Builder(name = "ContactlessPaymentCircle", defaultWidth =
...
private var _contactlessPaymentCircle: ImageVector? = null
