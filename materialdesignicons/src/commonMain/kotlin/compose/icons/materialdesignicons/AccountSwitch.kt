...
public val MaterialDesignIcons.AccountSwitch: ImageVector
    get() {
        if (_accountSwitch != null) {
            return _accountSwitch!!
        }
        _accountSwitch = Builder(name = "AccountSwitch", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(2.0f, 13.0f)
                curveTo(2.0f, 13.0f, 2.0f, 9.0f, 8.0f, 9.0f)
                reflectiveCurveTo(14.0f, 13.0f, 14.0f, 13.0f)
                verticalLineTo(15.0f)
