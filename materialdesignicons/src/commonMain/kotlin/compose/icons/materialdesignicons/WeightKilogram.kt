...
public val MaterialDesignIcons.WeightKilogram: ImageVector
    get() {
        if (_weightKilogram != null) {
            return _weightKilogram!!
        }
        _weightKilogram = Builder(name = "WeightKilogram", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(15.0f, 11.0f)
                curveTo(13.89f, 11.0f, 13.0f, 11.89f, 13.0f, 13.0f)
                verticalLineTo(17.0f)
                curveTo(13.0f, 18.11f, 13.89f, 19.0f, 15.0f, 19.0f)
                horizontalLineTo(18.0f)
...
private var _weightKilogram: ImageVector? = null
