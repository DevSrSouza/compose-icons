...
public val MaterialDesignIcons.MovieOpenCogOutline: ImageVector
    get() {
        if (_movieOpenCogOutline != null) {
            return _movieOpenCogOutline!!
        }
        _movieOpenCogOutline = Builder(name = "MovieOpenCogOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.71f, 12.18f, 21.38f, 12.39f, 22.0f, 12.69f)
                verticalLineTo(10.0f)
                horizontalLineTo(2.0f)
                verticalLineTo(20.0f)
                curveTo(2.0f, 21.11f, 2.9f, 22.0f, 4.0f, 22.0f)
                horizontalLineTo(12.68f)
                curveTo(12.39f, 21.38f, 12.18f, 20.71f, 12.08f, 20.0f)
...
private var _movieOpenCogOutline: ImageVector? = null
