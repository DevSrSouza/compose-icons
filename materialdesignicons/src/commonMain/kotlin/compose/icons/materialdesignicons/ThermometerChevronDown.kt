...
public val MaterialDesignIcons.ThermometerChevronDown: ImageVector
    get() {
        if (_thermometerChevronDown != null) {
            return _thermometerChevronDown!!
        }
        _thermometerChevronDown = Builder(name = "ThermometerChevronDown", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.41f, 12.17f)
                lineTo(14.24f, 9.0f)
                lineTo(12.83f, 10.41f)
                lineTo(17.41f, 15.0f)
                lineTo(22.0f, 10.41f)
                lineTo(20.58f, 9.0f)
                moveTo(10.0f, 13.0f)
...
private var _thermometerChevronDown: ImageVector? = null
