...
public val MaterialDesignIcons.TimelineAlertOutline: ImageVector
    get() {
        if (_timelineAlertOutline != null) {
            return _timelineAlertOutline!!
        }
        _timelineAlertOutline = Builder(name = "TimelineAlertOutline", defaultWidth = 24.0.dp,
...
private var _timelineAlertOutline: ImageVector? = null
