...
public val MaterialDesignIcons.BatteryChargingWireless: ImageVector
    get() {
        if (_batteryChargingWireless != null) {
            return _batteryChargingWireless!!
        }
        _batteryChargingWireless = Builder(name = "BatteryChargingWireless", defaultWidth = 24.0.dp,
...
private var _batteryChargingWireless: ImageVector? = null
