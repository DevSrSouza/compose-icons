...
public val MaterialDesignIcons.ArrowUDownRightBold: ImageVector
    get() {
        if (_arrowUDownRightBold != null) {
            return _arrowUDownRightBold!!
        }
        _arrowUDownRightBold = Builder(name = "ArrowUDownRightBold", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(7.0f, 8.57f, 7.0f, 10.5f)
