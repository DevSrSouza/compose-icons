...
public val MaterialDesignIcons.EmoticonAngryOutline: ImageVector
    get() {
        if (_emoticonAngryOutline != null) {
            return _emoticonAngryOutline!!
        }
        _emoticonAngryOutline = Builder(name = "EmoticonAngryOutline", defaultWidth = 24.0.dp,
...
private var _emoticonAngryOutline: ImageVector? = null
