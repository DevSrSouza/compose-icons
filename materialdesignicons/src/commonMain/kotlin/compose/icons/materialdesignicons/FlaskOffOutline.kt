...
public val MaterialDesignIcons.FlaskOffOutline: ImageVector
    get() {
        if (_flaskOffOutline != null) {
            return _flaskOffOutline!!
        }
        _flaskOffOutline = Builder(name = "FlaskOffOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flaskOffOutline: ImageVector? = null
