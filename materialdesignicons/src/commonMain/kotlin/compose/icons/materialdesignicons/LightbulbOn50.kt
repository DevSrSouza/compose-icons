...
public val MaterialDesignIcons.LightbulbOn50: ImageVector
    get() {
        if (_lightbulbOn50 != null) {
            return _lightbulbOn50!!
        }
        _lightbulbOn50 = Builder(name = "LightbulbOn50", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.0f, 12.0f)
                curveTo(8.0f, 12.35f, 8.05f, 12.68f, 8.14f, 13.0f)
                horizontalLineTo(15.86f)
                curveTo(15.95f, 12.68f, 16.0f, 12.35f, 16.0f, 12.0f)
...
private var _lightbulbOn50: ImageVector? = null
