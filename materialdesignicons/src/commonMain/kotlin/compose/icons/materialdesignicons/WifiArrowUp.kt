...
public val MaterialDesignIcons.WifiArrowUp: ImageVector
    get() {
        if (_wifiArrowUp != null) {
            return _wifiArrowUp!!
        }
        _wifiArrowUp = Builder(name = "WifiArrowUp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _wifiArrowUp: ImageVector? = null
