...
public val MaterialDesignIcons.GasStationOff: ImageVector
    get() {
        if (_gasStationOff != null) {
            return _gasStationOff!!
        }
        _gasStationOff = Builder(name = "GasStationOff", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(5.06f, 3.23f)
                curveTo(5.34f, 3.08f, 5.66f, 3.0f, 6.0f, 3.0f)
                horizontalLineTo(12.0f)
                curveTo(13.1f, 3.0f, 14.0f, 3.89f, 14.0f, 5.0f)
                verticalLineTo(12.0f)
                horizontalLineTo(15.0f)
                curveTo(16.1f, 12.0f, 17.0f, 12.89f, 17.0f, 14.0f)
