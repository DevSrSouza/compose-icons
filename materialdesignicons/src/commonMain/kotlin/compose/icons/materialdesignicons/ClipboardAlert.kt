...
public val MaterialDesignIcons.ClipboardAlert: ImageVector
    get() {
        if (_clipboardAlert != null) {
            return _clipboardAlert!!
        }
        _clipboardAlert = Builder(name = "ClipboardAlert", defaultWidth = 24.0.dp, defaultHeight =
...
private var _clipboardAlert: ImageVector? = null
