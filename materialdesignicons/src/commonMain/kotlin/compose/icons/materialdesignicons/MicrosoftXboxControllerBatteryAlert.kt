...
public val MaterialDesignIcons.MicrosoftXboxControllerBatteryAlert: ImageVector
    get() {
        if (_microsoftXboxControllerBatteryAlert != null) {
            return _microsoftXboxControllerBatteryAlert!!
        }
        _microsoftXboxControllerBatteryAlert = Builder(name = "MicrosoftXboxControllerBatteryAlert",
...
private var _microsoftXboxControllerBatteryAlert: ImageVector? = null
