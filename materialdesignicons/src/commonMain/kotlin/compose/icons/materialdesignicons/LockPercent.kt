...
public val MaterialDesignIcons.LockPercent: ImageVector
    get() {
        if (_lockPercent != null) {
            return _lockPercent!!
        }
        _lockPercent = Builder(name = "LockPercent", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lockPercent: ImageVector? = null
