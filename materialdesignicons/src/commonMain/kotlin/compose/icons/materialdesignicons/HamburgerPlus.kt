...
public val MaterialDesignIcons.HamburgerPlus: ImageVector
    get() {
        if (_hamburgerPlus != null) {
            return _hamburgerPlus!!
        }
        _hamburgerPlus = Builder(name = "HamburgerPlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hamburgerPlus: ImageVector? = null
