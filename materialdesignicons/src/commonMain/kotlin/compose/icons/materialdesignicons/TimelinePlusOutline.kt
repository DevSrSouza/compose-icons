...
public val MaterialDesignIcons.TimelinePlusOutline: ImageVector
    get() {
        if (_timelinePlusOutline != null) {
            return _timelinePlusOutline!!
        }
        _timelinePlusOutline = Builder(name = "TimelinePlusOutline", defaultWidth = 24.0.dp,
...
private var _timelinePlusOutline: ImageVector? = null
