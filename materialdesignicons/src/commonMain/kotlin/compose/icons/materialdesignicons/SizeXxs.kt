...
public val MaterialDesignIcons.SizeXxs: ImageVector
    get() {
        if (_sizeXxs != null) {
            return _sizeXxs!!
        }
        _sizeXxs = Builder(name = "SizeXxs", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(18.0f)
                curveTo(16.9f, 13.0f, 16.0f, 12.11f, 16.0f, 11.0f)
                verticalLineTo(9.0f)
