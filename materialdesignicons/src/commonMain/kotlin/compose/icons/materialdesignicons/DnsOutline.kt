...
public val MaterialDesignIcons.DnsOutline: ImageVector
    get() {
        if (_dnsOutline != null) {
            return _dnsOutline!!
        }
        _dnsOutline = Builder(name = "DnsOutline", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.5f, 1.5f, 0.0f, false, true, 8.5f, 17.0f)
