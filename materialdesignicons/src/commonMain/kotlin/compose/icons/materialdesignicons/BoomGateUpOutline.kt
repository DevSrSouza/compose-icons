...
public val MaterialDesignIcons.BoomGateUpOutline: ImageVector
    get() {
        if (_boomGateUpOutline != null) {
            return _boomGateUpOutline!!
        }
        _boomGateUpOutline = Builder(name = "BoomGateUpOutline", defaultWidth = 24.0.dp,
...
private var _boomGateUpOutline: ImageVector? = null
