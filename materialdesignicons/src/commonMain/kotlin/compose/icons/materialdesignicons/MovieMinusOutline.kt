...
public val MaterialDesignIcons.MovieMinusOutline: ImageVector
    get() {
        if (_movieMinusOutline != null) {
            return _movieMinusOutline!!
        }
        _movieMinusOutline = Builder(name = "MovieMinusOutline", defaultWidth = 24.0.dp,
...
private var _movieMinusOutline: ImageVector? = null
