...
public val MaterialDesignIcons.MessageFastOutline: ImageVector
    get() {
        if (_messageFastOutline != null) {
            return _messageFastOutline!!
        }
        _messageFastOutline = Builder(name = "MessageFastOutline", defaultWidth = 24.0.dp,
...
private var _messageFastOutline: ImageVector? = null
