...
public val MaterialDesignIcons.MovieCheckOutline: ImageVector
    get() {
        if (_movieCheckOutline != null) {
            return _movieCheckOutline!!
        }
        _movieCheckOutline = Builder(name = "MovieCheckOutline", defaultWidth = 24.0.dp,
...
private var _movieCheckOutline: ImageVector? = null
