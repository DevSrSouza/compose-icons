...
public val MaterialDesignIcons.CarBrakeParking: ImageVector
    get() {
        if (_carBrakeParking != null) {
            return _carBrakeParking!!
        }
        _carBrakeParking = Builder(name = "CarBrakeParking", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(2.0f, 2.0f, 0.0f, false, false, 15.5f, 11.0f)
                verticalLineTo(9.0f)
                arcTo(2.0f, 2.0f, 0.0f, false, false, 13.5f, 7.0f)
