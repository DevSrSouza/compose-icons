...
public val MaterialDesignIcons.FlaskPlusOutline: ImageVector
    get() {
        if (_flaskPlusOutline != null) {
            return _flaskPlusOutline!!
        }
        _flaskPlusOutline = Builder(name = "FlaskPlusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _flaskPlusOutline: ImageVector? = null
