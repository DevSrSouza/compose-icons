...
public val MaterialDesignIcons.MopedOutline: ImageVector
    get() {
        if (_mopedOutline != null) {
            return _mopedOutline!!
        }
        _mopedOutline = Builder(name = "MopedOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.0f, 11.9f, 4.9f, 11.0f, 6.0f, 11.0f)
                horizontalLineTo(8.0f)
                ...
                reflectiveCurveTo(18.45f, 15.0f, 19.0f, 15.0f)
                reflectiveCurveTo(20.0f, 15.45f, 20.0f, 16.0f)
                reflectiveCurveTo(19.55f, 17.0f, 19.0f, 17.0f)
                moveTo(10.0f, 8.0f)
