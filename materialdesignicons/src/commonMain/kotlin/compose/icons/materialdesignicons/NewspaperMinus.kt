...
public val MaterialDesignIcons.NewspaperMinus: ImageVector
    get() {
        if (_newspaperMinus != null) {
            return _newspaperMinus!!
        }
        _newspaperMinus = Builder(name = "NewspaperMinus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _newspaperMinus: ImageVector? = null
