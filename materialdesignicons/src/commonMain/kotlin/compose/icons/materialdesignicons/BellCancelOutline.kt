...
public val MaterialDesignIcons.BellCancelOutline: ImageVector
    get() {
        if (_bellCancelOutline != null) {
            return _bellCancelOutline!!
        }
        _bellCancelOutline = Builder(name = "BellCancelOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(6.5f, 6.5f, 0.0f, false, true, 11.03f, 18.0f)
...
private var _bellCancelOutline: ImageVector? = null
