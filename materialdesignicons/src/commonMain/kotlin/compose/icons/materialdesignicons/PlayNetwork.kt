...
public val MaterialDesignIcons.PlayNetwork: ImageVector
    get() {
        if (_playNetwork != null) {
            return _playNetwork!!
        }
        _playNetwork = Builder(name = "PlayNetwork", defaultWidth = 24.0.dp, defaultHeight =
...
private var _playNetwork: ImageVector? = null
