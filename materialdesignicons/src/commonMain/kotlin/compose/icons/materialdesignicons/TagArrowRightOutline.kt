...
public val MaterialDesignIcons.TagArrowRightOutline: ImageVector
    get() {
        if (_tagArrowRightOutline != null) {
            return _tagArrowRightOutline!!
        }
        _tagArrowRightOutline = Builder(name = "TagArrowRightOutline", defaultWidth = 24.0.dp,
...
private var _tagArrowRightOutline: ImageVector? = null
