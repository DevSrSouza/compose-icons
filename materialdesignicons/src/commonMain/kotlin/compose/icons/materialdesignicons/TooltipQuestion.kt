...
public val MaterialDesignIcons.TooltipQuestion: ImageVector
    get() {
        if (_tooltipQuestion != null) {
            return _tooltipQuestion!!
        }
        _tooltipQuestion = Builder(name = "TooltipQuestion", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tooltipQuestion: ImageVector? = null
