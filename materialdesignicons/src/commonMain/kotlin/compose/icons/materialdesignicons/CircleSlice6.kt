...
public val MaterialDesignIcons.CircleSlice6: ImageVector
    get() {
        if (_circleSlice6 != null) {
            return _circleSlice6!!
        }
        _circleSlice6 = Builder(name = "CircleSlice6", defaultWidth = 24.0.dp, defaultHeight =
...
private var _circleSlice6: ImageVector? = null
