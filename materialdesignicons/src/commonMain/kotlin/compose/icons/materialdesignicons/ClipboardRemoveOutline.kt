...
public val MaterialDesignIcons.ClipboardRemoveOutline: ImageVector
    get() {
        if (_clipboardRemoveOutline != null) {
            return _clipboardRemoveOutline!!
        }
        _clipboardRemoveOutline = Builder(name = "ClipboardRemoveOutline", defaultWidth = 24.0.dp,
...
private var _clipboardRemoveOutline: ImageVector? = null
