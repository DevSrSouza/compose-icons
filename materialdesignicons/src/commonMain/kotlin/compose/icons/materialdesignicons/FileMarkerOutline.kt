...
public val MaterialDesignIcons.FileMarkerOutline: ImageVector
    get() {
        if (_fileMarkerOutline != null) {
            return _fileMarkerOutline!!
        }
        _fileMarkerOutline = Builder(name = "FileMarkerOutline", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(14.55f, 20.0f)
                curveTo(15.0f, 20.76f, 15.5f, 21.44f, 15.91f, 22.0f)
                ...
                curveTo(18.33f, 10.0f, 18.17f, 10.0f, 18.0f, 10.03f)
                verticalLineTo(9.0f)
