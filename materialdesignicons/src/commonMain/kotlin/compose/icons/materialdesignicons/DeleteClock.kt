...
public val MaterialDesignIcons.DeleteClock: ImageVector
    get() {
        if (_deleteClock != null) {
            return _deleteClock!!
        }
        _deleteClock = Builder(name = "DeleteClock", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deleteClock: ImageVector? = null
