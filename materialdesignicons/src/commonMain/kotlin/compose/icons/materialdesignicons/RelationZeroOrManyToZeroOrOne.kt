...
public val MaterialDesignIcons.RelationZeroOrManyToZeroOrOne: ImageVector
    get() {
        if (_relationZeroOrManyToZeroOrOne != null) {
            return _relationZeroOrManyToZeroOrOne!!
        }
        _relationZeroOrManyToZeroOrOne = Builder(name = "RelationZeroOrManyToZeroOrOne",
...
private var _relationZeroOrManyToZeroOrOne: ImageVector? = null
