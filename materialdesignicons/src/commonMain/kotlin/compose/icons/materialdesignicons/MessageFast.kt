...
public val MaterialDesignIcons.MessageFast: ImageVector
    get() {
        if (_messageFast != null) {
            return _messageFast!!
        }
        _messageFast = Builder(name = "MessageFast", defaultWidth = 24.0.dp, defaultHeight =
...
private var _messageFast: ImageVector? = null
