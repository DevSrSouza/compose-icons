...
public val MaterialDesignIcons.ContrastCircle: ImageVector
    get() {
        if (_contrastCircle != null) {
            return _contrastCircle!!
        }
        _contrastCircle = Builder(name = "ContrastCircle", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 20.0f)
                curveTo(9.79f, 20.0f, 7.79f, 19.1f, 6.34f, 17.66f)
                lineTo(17.66f, 6.34f)
