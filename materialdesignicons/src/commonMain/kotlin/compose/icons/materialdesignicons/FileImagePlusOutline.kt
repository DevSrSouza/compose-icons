...
public val MaterialDesignIcons.FileImagePlusOutline: ImageVector
    get() {
        if (_fileImagePlusOutline != null) {
            return _fileImagePlusOutline!!
        }
        _fileImagePlusOutline = Builder(name = "FileImagePlusOutline", defaultWidth = 24.0.dp,
...
private var _fileImagePlusOutline: ImageVector? = null
