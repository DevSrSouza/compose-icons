...
public val MaterialDesignIcons.ContentSaveCheckOutline: ImageVector
    get() {
        if (_contentSaveCheckOutline != null) {
            return _contentSaveCheckOutline!!
        }
        _contentSaveCheckOutline = Builder(name = "ContentSaveCheckOutline", defaultWidth = 24.0.dp,
...
private var _contentSaveCheckOutline: ImageVector? = null
