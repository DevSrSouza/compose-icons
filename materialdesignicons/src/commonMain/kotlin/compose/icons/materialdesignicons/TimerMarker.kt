...
public val MaterialDesignIcons.TimerMarker: ImageVector
    get() {
        if (_timerMarker != null) {
            return _timerMarker!!
        }
        _timerMarker = Builder(name = "TimerMarker", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(3.0f)
                moveTo(13.0f, 15.5f)
                curveTo(13.0f, 17.5f, 14.28f, 19.73f, 15.42f, 21.33f)
                curveTo(14.37f, 21.76f, 13.21f, 22.0f, 12.0f, 22.0f)
                ...
                curveTo(19.97f, 10.16f, 19.25f, 10.0f, 18.5f, 10.0f)
