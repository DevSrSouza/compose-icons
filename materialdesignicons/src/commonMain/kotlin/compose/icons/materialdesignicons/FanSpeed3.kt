...
public val MaterialDesignIcons.FanSpeed3: ImageVector
    get() {
        if (_fanSpeed3 != null) {
            return _fanSpeed3!!
        }
        _fanSpeed3 = Builder(name = "FanSpeed3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.0f, 19.67f, 20.33f, 19.0f, 19.5f, 19.0f)
                curveTo(20.33f, 19.0f, 21.0f, 18.33f, 21.0f, 17.5f)
                ...
                horizontalLineTo(19.0f)
                curveTo(20.11f, 23.0f, 21.0f, 22.11f, 21.0f, 21.0f)
            }
        }
        .build()
        return _fanSpeed3!!
...
private var _fanSpeed3: ImageVector? = null
