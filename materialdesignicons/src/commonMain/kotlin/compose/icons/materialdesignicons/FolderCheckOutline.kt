...
public val MaterialDesignIcons.FolderCheckOutline: ImageVector
    get() {
        if (_folderCheckOutline != null) {
            return _folderCheckOutline!!
        }
        _folderCheckOutline = Builder(name = "FolderCheckOutline", defaultWidth = 24.0.dp,
...
private var _folderCheckOutline: ImageVector? = null
