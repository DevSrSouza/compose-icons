...
public val MaterialDesignIcons.FileLockOpenOutline: ImageVector
    get() {
        if (_fileLockOpenOutline != null) {
            return _fileLockOpenOutline!!
        }
        _fileLockOpenOutline = Builder(name = "FileLockOpenOutline", defaultWidth = 24.0.dp,
...
private var _fileLockOpenOutline: ImageVector? = null
