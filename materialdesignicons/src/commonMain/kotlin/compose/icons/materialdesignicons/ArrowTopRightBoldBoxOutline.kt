...
public val MaterialDesignIcons.ArrowTopRightBoldBoxOutline: ImageVector
    get() {
        if (_arrowTopRightBoldBoxOutline != null) {
            return _arrowTopRightBoldBoxOutline!!
        }
        _arrowTopRightBoldBoxOutline = Builder(name = "ArrowTopRightBoldBoxOutline", defaultWidth =
