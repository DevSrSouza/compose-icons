...
public val MaterialDesignIcons.MovieOpenCheck: ImageVector
    get() {
        if (_movieOpenCheck != null) {
            return _movieOpenCheck!!
        }
        _movieOpenCheck = Builder(name = "MovieOpenCheck", defaultWidth = 24.0.dp, defaultHeight =
...
private var _movieOpenCheck: ImageVector? = null
