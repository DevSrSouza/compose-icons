...
public val MaterialDesignIcons.LockOpenAlertOutline: ImageVector
    get() {
        if (_lockOpenAlertOutline != null) {
            return _lockOpenAlertOutline!!
        }
        _lockOpenAlertOutline = Builder(name = "LockOpenAlertOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(12.0f, 13.9f, 12.0f, 15.0f)
