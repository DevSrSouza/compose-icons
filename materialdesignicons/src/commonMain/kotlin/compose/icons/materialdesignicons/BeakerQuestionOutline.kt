...
public val MaterialDesignIcons.BeakerQuestionOutline: ImageVector
    get() {
        if (_beakerQuestionOutline != null) {
            return _beakerQuestionOutline!!
        }
        _beakerQuestionOutline = Builder(name = "BeakerQuestionOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.0f, 20.11f, 15.11f, 21.0f, 14.0f, 21.0f)
                horizontalLineTo(4.0f)
                curveTo(2.9f, 21.0f, 2.0f, 20.11f, 2.0f, 19.0f)
                verticalLineTo(7.0f)
                curveTo(2.0f, 5.9f, 1.11f, 5.0f, 0.0f, 5.0f)
                verticalLineTo(3.0f)
                moveTo(4.0f, 5.0f)
                verticalLineTo(7.0f)
