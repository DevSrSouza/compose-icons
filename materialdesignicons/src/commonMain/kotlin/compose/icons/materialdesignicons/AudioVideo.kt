...
public val MaterialDesignIcons.AudioVideo: ImageVector
    get() {
        if (_audioVideo != null) {
            return _audioVideo!!
        }
        _audioVideo = Builder(name = "AudioVideo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.6f, 19.0f, 19.0f, 18.6f, 19.0f, 18.0f)
                verticalLineTo(17.0f)
