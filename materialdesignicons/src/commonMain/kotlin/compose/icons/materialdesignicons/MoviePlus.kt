...
public val MaterialDesignIcons.MoviePlus: ImageVector
    get() {
        if (_moviePlus != null) {
            return _moviePlus!!
        }
        _moviePlus = Builder(name = "MoviePlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _moviePlus: ImageVector? = null
