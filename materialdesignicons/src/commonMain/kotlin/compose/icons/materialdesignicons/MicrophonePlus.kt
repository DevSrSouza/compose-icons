...
public val MaterialDesignIcons.MicrophonePlus: ImageVector
    get() {
        if (_microphonePlus != null) {
            return _microphonePlus!!
        }
        _microphonePlus = Builder(name = "MicrophonePlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _microphonePlus: ImageVector? = null
