...
public val MaterialDesignIcons.TimerStop: ImageVector
    get() {
        if (_timerStop != null) {
            return _timerStop!!
        }
        _timerStop = Builder(name = "TimerStop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _timerStop: ImageVector? = null
