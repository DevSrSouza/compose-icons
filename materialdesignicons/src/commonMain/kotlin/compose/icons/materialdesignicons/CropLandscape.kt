...
public val MaterialDesignIcons.CropLandscape: ImageVector
    get() {
        if (_cropLandscape != null) {
            return _cropLandscape!!
        }
        _cropLandscape = Builder(name = "CropLandscape", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(7.0f)
                curveTo(21.0f, 5.89f, 20.1f, 5.0f, 19.0f, 5.0f)
                close()
            }
        }
        .build()
