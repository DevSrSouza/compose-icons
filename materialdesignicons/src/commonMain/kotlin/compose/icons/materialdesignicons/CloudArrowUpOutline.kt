...
public val MaterialDesignIcons.CloudArrowUpOutline: ImageVector
    get() {
        if (_cloudArrowUpOutline != null) {
            return _cloudArrowUpOutline!!
        }
        _cloudArrowUpOutline = Builder(name = "CloudArrowUpOutline", defaultWidth = 24.0.dp,
...
private var _cloudArrowUpOutline: ImageVector? = null
