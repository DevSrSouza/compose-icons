...
public val MaterialDesignIcons.LockOpenCheck: ImageVector
    get() {
        if (_lockOpenCheck != null) {
            return _lockOpenCheck!!
        }
        _lockOpenCheck = Builder(name = "LockOpenCheck", defaultWidth = 24.0.dp, defaultHeight =
...
private var _lockOpenCheck: ImageVector? = null
