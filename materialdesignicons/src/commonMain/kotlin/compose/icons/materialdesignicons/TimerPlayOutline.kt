...
public val MaterialDesignIcons.TimerPlayOutline: ImageVector
    get() {
        if (_timerPlayOutline != null) {
            return _timerPlayOutline!!
        }
        _timerPlayOutline = Builder(name = "TimerPlayOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _timerPlayOutline: ImageVector? = null
