...
public val MaterialDesignIcons.LightbulbOn40: ImageVector
    get() {
        if (_lightbulbOn40 != null) {
            return _lightbulbOn40!!
        }
        _lightbulbOn40 = Builder(name = "LightbulbOn40", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 12.74f, 8.22f, 13.41f, 8.57f, 14.0f)
                horizontalLineTo(15.43f)
                curveTo(15.78f, 13.41f, 16.0f, 12.74f, 16.0f, 12.0f)
                close()
            }
        }
        .build()
...
private var _lightbulbOn40: ImageVector? = null
