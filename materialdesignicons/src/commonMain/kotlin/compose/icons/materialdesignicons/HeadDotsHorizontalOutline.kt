...
public val MaterialDesignIcons.HeadDotsHorizontalOutline: ImageVector
    get() {
        if (_headDotsHorizontalOutline != null) {
            return _headDotsHorizontalOutline!!
        }
        _headDotsHorizontalOutline = Builder(name = "HeadDotsHorizontalOutline", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(10.0f, 10.0f)
                curveTo(9.4f, 10.0f, 9.0f, 9.6f, 9.0f, 9.0f)
                reflectiveCurveTo(9.4f, 8.0f, 10.0f, 8.0f)
                reflectiveCurveTo(11.0f, 8.4f, 11.0f, 9.0f)
                reflectiveCurveTo(10.6f, 10.0f, 10.0f, 10.0f)
                moveTo(13.0f, 10.0f)
                curveTo(12.4f, 10.0f, 12.0f, 9.6f, 12.0f, 9.0f)
                reflectiveCurveTo(12.4f, 8.0f, 13.0f, 8.0f)
                reflectiveCurveTo(14.0f, 8.4f, 14.0f, 9.0f)
                reflectiveCurveTo(13.6f, 10.0f, 13.0f, 10.0f)
                moveTo(16.0f, 10.0f)
                curveTo(15.5f, 10.0f, 15.0f, 9.6f, 15.0f, 9.0f)
                reflectiveCurveTo(15.5f, 8.0f, 16.0f, 8.0f)
                reflectiveCurveTo(17.0f, 8.4f, 17.0f, 9.0f)
                reflectiveCurveTo(16.5f, 10.0f, 16.0f, 10.0f)
                close()
            }
        }
        .build()
