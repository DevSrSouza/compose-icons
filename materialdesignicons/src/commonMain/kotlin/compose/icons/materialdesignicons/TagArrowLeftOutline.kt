...
public val MaterialDesignIcons.TagArrowLeftOutline: ImageVector
    get() {
        if (_tagArrowLeftOutline != null) {
            return _tagArrowLeftOutline!!
        }
        _tagArrowLeftOutline = Builder(name = "TagArrowLeftOutline", defaultWidth = 24.0.dp,
...
private var _tagArrowLeftOutline: ImageVector? = null
