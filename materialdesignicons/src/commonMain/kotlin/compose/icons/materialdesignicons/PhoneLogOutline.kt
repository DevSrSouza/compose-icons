...
public val MaterialDesignIcons.PhoneLogOutline: ImageVector
    get() {
        if (_phoneLogOutline != null) {
            return _phoneLogOutline!!
        }
        _phoneLogOutline = Builder(name = "PhoneLogOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phoneLogOutline: ImageVector? = null
