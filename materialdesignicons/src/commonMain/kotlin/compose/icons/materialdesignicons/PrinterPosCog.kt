...
public val MaterialDesignIcons.PrinterPosCog: ImageVector
    get() {
        if (_printerPosCog != null) {
            return _printerPosCog!!
        }
        _printerPosCog = Builder(name = "PrinterPosCog", defaultWidth = 24.0.dp, defaultHeight =
...
private var _printerPosCog: ImageVector? = null
