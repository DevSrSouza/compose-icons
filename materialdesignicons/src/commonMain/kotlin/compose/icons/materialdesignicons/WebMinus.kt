...
public val MaterialDesignIcons.WebMinus: ImageVector
    get() {
        if (_webMinus != null) {
            return _webMinus!!
        }
        _webMinus = Builder(name = "WebMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _webMinus: ImageVector? = null
