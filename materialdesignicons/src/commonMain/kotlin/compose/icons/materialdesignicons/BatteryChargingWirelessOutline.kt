...
public val MaterialDesignIcons.BatteryChargingWirelessOutline: ImageVector
    get() {
        if (_batteryChargingWirelessOutline != null) {
            return _batteryChargingWirelessOutline!!
        }
        _batteryChargingWirelessOutline = Builder(name = "BatteryChargingWirelessOutline",
...
private var _batteryChargingWirelessOutline: ImageVector? = null
