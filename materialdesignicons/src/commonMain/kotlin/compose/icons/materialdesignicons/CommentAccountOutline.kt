...
public val MaterialDesignIcons.CommentAccountOutline: ImageVector
    get() {
        if (_commentAccountOutline != null) {
            return _commentAccountOutline!!
        }
        _commentAccountOutline = Builder(name = "CommentAccountOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.33f, 11.0f, 16.0f, 11.67f, 16.0f, 13.0f)
