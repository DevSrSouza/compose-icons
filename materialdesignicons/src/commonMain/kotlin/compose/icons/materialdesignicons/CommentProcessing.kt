...
public val MaterialDesignIcons.CommentProcessing: ImageVector
    get() {
        if (_commentProcessing != null) {
            return _commentProcessing!!
        }
        _commentProcessing = Builder(name = "CommentProcessing", defaultWidth = 24.0.dp,
...
private var _commentProcessing: ImageVector? = null
