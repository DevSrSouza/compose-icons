...
public val MaterialDesignIcons.StoreClockOutline: ImageVector
    get() {
        if (_storeClockOutline != null) {
            return _storeClockOutline!!
        }
        _storeClockOutline = Builder(name = "StoreClockOutline", defaultWidth = 24.0.dp,
...
private var _storeClockOutline: ImageVector? = null
