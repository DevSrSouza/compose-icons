...
public val MaterialDesignIcons.ChiliAlertOutline: ImageVector
    get() {
        if (_chiliAlertOutline != null) {
            return _chiliAlertOutline!!
        }
        _chiliAlertOutline = Builder(name = "ChiliAlertOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.0f, 18.87f)
                curveTo(11.23f, 17.69f, 9.17f, 15.44f, 9.0f, 11.43f)
                lineTo(11.0f, 10.3f)
                lineTo(13.0f, 11.45f)
...
private var _chiliAlertOutline: ImageVector? = null
