...
public val MaterialDesignIcons.TableArrowRight: ImageVector
    get() {
        if (_tableArrowRight != null) {
            return _tableArrowRight!!
        }
        _tableArrowRight = Builder(name = "TableArrowRight", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tableArrowRight: ImageVector? = null
