...
public val MaterialDesignIcons.VectorArrangeAbove: ImageVector
    get() {
        if (_vectorArrangeAbove != null) {
            return _vectorArrangeAbove!!
        }
        _vectorArrangeAbove = Builder(name = "VectorArrangeAbove", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.67f, 16.0f, 10.33f, 16.0f, 14.0f, 16.0f)
                curveTo(15.11f, 16.0f, 16.0f, 15.11f, 16.0f, 14.0f)
                curveTo(16.0f, 10.33f, 16.0f, 6.67f, 16.0f, 3.0f)
