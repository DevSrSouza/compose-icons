...
public val MaterialDesignIcons.PaperclipCheck: ImageVector
    get() {
        if (_paperclipCheck != null) {
            return _paperclipCheck!!
        }
        _paperclipCheck = Builder(name = "PaperclipCheck", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.73f, 22.89f, 13.13f, 23.0f, 12.5f, 23.0f)
                curveTo(9.46f, 23.0f, 7.0f, 20.54f, 7.0f, 17.5f)
                verticalLineTo(5.0f)
                curveTo(7.0f, 2.79f, 8.79f, 1.0f, 11.0f, 1.0f)
                reflectiveCurveTo(15.0f, 2.79f, 15.0f, 5.0f)
                verticalLineTo(14.54f)
                curveTo(14.03f, 15.41f, 13.35f, 16.58f, 13.1f, 17.92f)
                curveTo(12.91f, 17.97f, 12.71f, 18.0f, 12.5f, 18.0f)
                ...
                curveTo(16.97f, 13.34f, 17.47f, 13.18f, 18.0f, 13.09f)
                verticalLineTo(6.0f)
