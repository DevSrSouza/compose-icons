...
public val MaterialDesignIcons.WebPlus: ImageVector
    get() {
        if (_webPlus != null) {
            return _webPlus!!
        }
        _webPlus = Builder(name = "WebPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _webPlus: ImageVector? = null
