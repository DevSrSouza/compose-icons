...
public val MaterialDesignIcons.RelationZeroOrManyToZeroOrMany: ImageVector
    get() {
        if (_relationZeroOrManyToZeroOrMany != null) {
            return _relationZeroOrManyToZeroOrMany!!
        }
        _relationZeroOrManyToZeroOrMany = Builder(name = "RelationZeroOrManyToZeroOrMany",
...
private var _relationZeroOrManyToZeroOrMany: ImageVector? = null
