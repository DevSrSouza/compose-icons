...
public val MaterialDesignIcons.CircleSlice7: ImageVector
    get() {
        if (_circleSlice7 != null) {
            return _circleSlice7!!
        }
        _circleSlice7 = Builder(name = "CircleSlice7", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 10.07f, 5.78f, 8.32f, 7.05f, 7.05f)
                lineTo(12.0f, 12.0f)
                verticalLineTo(5.0f)
                close()
            }
...
private var _circleSlice7: ImageVector? = null
