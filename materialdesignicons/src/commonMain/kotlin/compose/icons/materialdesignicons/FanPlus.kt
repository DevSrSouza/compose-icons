...
public val MaterialDesignIcons.FanPlus: ImageVector
    get() {
        if (_fanPlus != null) {
            return _fanPlus!!
        }
        _fanPlus = Builder(name = "FanPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fanPlus: ImageVector? = null
