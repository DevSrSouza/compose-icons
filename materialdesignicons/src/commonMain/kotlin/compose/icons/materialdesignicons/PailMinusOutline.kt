...
public val MaterialDesignIcons.PailMinusOutline: ImageVector
    get() {
        if (_pailMinusOutline != null) {
            return _pailMinusOutline!!
        }
        _pailMinusOutline = Builder(name = "PailMinusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _pailMinusOutline: ImageVector? = null
