...
public val MaterialDesignIcons.CloudCog: ImageVector
    get() {
        if (_cloudCog != null) {
            return _cloudCog!!
        }
        _cloudCog = Builder(name = "CloudCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.92f, 12.55f, 21.96f, 12.63f, 22.0f, 12.69f)
                curveTo(21.1f, 12.25f, 20.08f, 12.0f, 19.0f, 12.0f)
                ...
                moveTo(20.5f, 19.0f)
                curveTo(20.5f, 18.17f, 19.82f, 17.5f, 19.0f, 17.5f)
                reflectiveCurveTo(17.5f, 18.17f, 17.5f, 19.0f)
                reflectiveCurveTo(18.16f, 20.5f, 19.0f, 20.5f)
                reflectiveCurveTo(20.5f, 19.83f, 20.5f, 19.0f)
                close()
            }
        }
        .build()
