...
public val MaterialDesignIcons.SourceCommitLocal: ImageVector
    get() {
        if (_sourceCommitLocal != null) {
            return _sourceCommitLocal!!
        }
        _sourceCommitLocal = Builder(name = "SourceCommitLocal", defaultWidth = 24.0.dp,
...
private var _sourceCommitLocal: ImageVector? = null
