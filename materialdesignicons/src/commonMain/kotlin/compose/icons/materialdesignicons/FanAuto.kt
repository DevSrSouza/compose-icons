...
public val MaterialDesignIcons.FanAuto: ImageVector
    get() {
        if (_fanAuto != null) {
            return _fanAuto!!
        }
        _fanAuto = Builder(name = "FanAuto", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 12.55f, 12.54f, 13.0f, 12.0f, 13.0f)
                curveTo(11.43f, 13.0f, 11.0f, 12.55f, 11.0f, 12.0f)
                curveTo(11.0f, 11.45f, 11.43f, 11.0f, 12.0f, 11.0f)
                moveTo(18.0f, 15.0f)
                curveTo(16.89f, 15.0f, 16.0f, 15.9f, 16.0f, 17.0f)
                ...
                curveTo(22.0f, 15.9f, 21.1f, 15.0f, 20.0f, 15.0f)
                moveTo(18.0f, 17.0f)
                horizontalLineTo(20.0f)
...
private var _fanAuto: ImageVector? = null
