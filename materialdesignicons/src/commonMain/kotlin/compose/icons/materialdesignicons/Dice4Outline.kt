...
public val MaterialDesignIcons.Dice4Outline: ImageVector
    get() {
        if (_dice4Outline != null) {
            return _dice4Outline!!
        }
        _dice4Outline = Builder(name = "Dice4Outline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.5f, 6.0f)
                curveTo(15.67f, 6.0f, 15.0f, 6.67f, 15.0f, 7.5f)
                reflectiveCurveTo(15.67f, 9.0f, 16.5f, 9.0f)
                curveTo(17.33f, 9.0f, 18.0f, 8.33f, 18.0f, 7.5f)
                reflectiveCurveTo(17.33f, 6.0f, 16.5f, 6.0f)
                moveTo(7.5f, 15.0f)
                curveTo(6.67f, 15.0f, 6.0f, 15.67f, 6.0f, 16.5f)
                curveTo(6.0f, 17.33f, 6.67f, 18.0f, 7.5f, 18.0f)
                reflectiveCurveTo(9.0f, 17.33f, 9.0f, 16.5f)
                curveTo(9.0f, 15.67f, 8.33f, 15.0f, 7.5f, 15.0f)
                close()
            }
        }
        .build()
