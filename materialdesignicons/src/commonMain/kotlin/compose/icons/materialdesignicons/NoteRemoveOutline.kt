...
public val MaterialDesignIcons.NoteRemoveOutline: ImageVector
    get() {
        if (_noteRemoveOutline != null) {
            return _noteRemoveOutline!!
        }
        _noteRemoveOutline = Builder(name = "NoteRemoveOutline", defaultWidth = 24.0.dp,
...
private var _noteRemoveOutline: ImageVector? = null
