...
public val MaterialDesignIcons.TimerRemove: ImageVector
    get() {
        if (_timerRemove != null) {
            return _timerRemove!!
        }
        _timerRemove = Builder(name = "TimerRemove", defaultWidth = 24.0.dp, defaultHeight =
...
private var _timerRemove: ImageVector? = null
