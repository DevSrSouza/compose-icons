...
public val MaterialDesignIcons.RadioboxMarked: ImageVector
    get() {
        if (_radioboxMarked != null) {
            return _radioboxMarked!!
        }
        _radioboxMarked = Builder(name = "RadioboxMarked", defaultWidth = 24.0.dp, defaultHeight =
...
private var _radioboxMarked: ImageVector? = null
