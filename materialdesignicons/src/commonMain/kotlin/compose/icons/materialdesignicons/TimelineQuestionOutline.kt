...
public val MaterialDesignIcons.TimelineQuestionOutline: ImageVector
    get() {
        if (_timelineQuestionOutline != null) {
            return _timelineQuestionOutline!!
        }
        _timelineQuestionOutline = Builder(name = "TimelineQuestionOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 8.34f, 14.34f, 7.0f, 16.0f, 7.0f)
                curveTo(17.66f, 7.0f, 19.0f, 8.34f, 19.0f, 10.0f)
                curveTo(19.0f, 10.97f, 18.5f, 11.88f, 17.71f, 12.41f)
                lineTo(17.41f, 12.6f)
                curveTo(16.84f, 13.0f, 16.5f, 13.62f, 16.5f, 14.3f)
                verticalLineTo(14.5f)
                horizontalLineTo(15.0f)
                verticalLineTo(14.3f)
                curveTo(15.0f, 13.11f, 15.6f, 12.0f, 16.59f, 11.35f)
                lineTo(16.88f, 11.16f)
                curveTo(17.27f, 10.9f, 17.5f, 10.47f, 17.5f, 10.0f)
                curveTo(17.5f, 9.18f, 16.83f, 8.5f, 16.0f, 8.5f)
                curveTo(15.17f, 8.5f, 14.5f, 9.17f, 14.5f, 10.0f)
