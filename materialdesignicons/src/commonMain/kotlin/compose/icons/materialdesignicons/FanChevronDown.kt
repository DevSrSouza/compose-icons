...
public val MaterialDesignIcons.FanChevronDown: ImageVector
    get() {
        if (_fanChevronDown != null) {
            return _fanChevronDown!!
        }
        _fanChevronDown = Builder(name = "FanChevronDown", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(19.0f, 19.17f)
                lineTo(22.17f, 16.0f)
                lineTo(23.59f, 17.41f)
                lineTo(19.0f, 22.0f)
                lineTo(14.41f, 17.41f)
                lineTo(15.83f, 16.0f)
                lineTo(19.0f, 19.17f)
            }
        }
...
private var _fanChevronDown: ImageVector? = null
