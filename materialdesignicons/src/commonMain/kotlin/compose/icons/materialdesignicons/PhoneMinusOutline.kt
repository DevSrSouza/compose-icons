...
public val MaterialDesignIcons.PhoneMinusOutline: ImageVector
    get() {
        if (_phoneMinusOutline != null) {
            return _phoneMinusOutline!!
        }
        _phoneMinusOutline = Builder(name = "PhoneMinusOutline", defaultWidth = 24.0.dp,
...
private var _phoneMinusOutline: ImageVector? = null
