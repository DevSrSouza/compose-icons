...
public val MaterialDesignIcons.BadgeAccountAlertOutline: ImageVector
    get() {
        if (_badgeAccountAlertOutline != null) {
            return _badgeAccountAlertOutline!!
        }
        _badgeAccountAlertOutline = Builder(name = "BadgeAccountAlertOutline", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.0f, 12.67f, 8.67f, 12.0f, 10.0f, 12.0f)
                curveTo(11.33f, 12.0f, 14.0f, 12.67f, 14.0f, 14.0f)
