...
public val MaterialDesignIcons.DownloadNetworkOutline: ImageVector
    get() {
        if (_downloadNetworkOutline != null) {
            return _downloadNetworkOutline!!
        }
        _downloadNetworkOutline = Builder(name = "DownloadNetworkOutline", defaultWidth = 24.0.dp,
...
private var _downloadNetworkOutline: ImageVector? = null
