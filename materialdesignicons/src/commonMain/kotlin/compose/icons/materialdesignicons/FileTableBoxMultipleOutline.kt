...
public val MaterialDesignIcons.FileTableBoxMultipleOutline: ImageVector
    get() {
        if (_fileTableBoxMultipleOutline != null) {
            return _fileTableBoxMultipleOutline!!
        }
        _fileTableBoxMultipleOutline = Builder(name = "FileTableBoxMultipleOutline", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0f, 18.1f, 5.9f, 19.0f, 7.0f, 19.0f)
