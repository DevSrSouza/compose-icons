...
public val MaterialDesignIcons.BoomGateUp: ImageVector
    get() {
        if (_boomGateUp != null) {
            return _boomGateUp!!
        }
        _boomGateUp = Builder(name = "BoomGateUp", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _boomGateUp: ImageVector? = null
