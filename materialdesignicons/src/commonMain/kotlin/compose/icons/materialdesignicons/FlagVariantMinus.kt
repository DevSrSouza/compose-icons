...
public val MaterialDesignIcons.FlagVariantMinus: ImageVector
    get() {
        if (_flagVariantMinus != null) {
            return _flagVariantMinus!!
        }
        _flagVariantMinus = Builder(name = "FlagVariantMinus", defaultWidth = 24.0.dp, defaultHeight
...
private var _flagVariantMinus: ImageVector? = null
