...
public val MaterialDesignIcons.FlaskRemove: ImageVector
    get() {
        if (_flaskRemove != null) {
            return _flaskRemove!!
        }
        _flaskRemove = Builder(name = "FlaskRemove", defaultWidth = 24.0.dp, defaultHeight =
...
private var _flaskRemove: ImageVector? = null
