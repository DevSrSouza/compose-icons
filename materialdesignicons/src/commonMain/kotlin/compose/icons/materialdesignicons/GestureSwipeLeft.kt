...
public val MaterialDesignIcons.GestureSwipeLeft: ImageVector
    get() {
        if (_gestureSwipeLeft != null) {
            return _gestureSwipeLeft!!
        }
        _gestureSwipeLeft = Builder(name = "GestureSwipeLeft", defaultWidth = 24.0.dp, defaultHeight
...
private var _gestureSwipeLeft: ImageVector? = null
