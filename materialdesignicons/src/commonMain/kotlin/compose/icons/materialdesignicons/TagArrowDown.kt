...
public val MaterialDesignIcons.TagArrowDown: ImageVector
    get() {
        if (_tagArrowDown != null) {
            return _tagArrowDown!!
        }
        _tagArrowDown = Builder(name = "TagArrowDown", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tagArrowDown: ImageVector? = null
