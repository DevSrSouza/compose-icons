...
public val MaterialDesignIcons.CloudArrowLeftOutline: ImageVector
    get() {
        if (_cloudArrowLeftOutline != null) {
            return _cloudArrowLeftOutline!!
        }
        _cloudArrowLeftOutline = Builder(name = "CloudArrowLeftOutline", defaultWidth = 24.0.dp,
...
private var _cloudArrowLeftOutline: ImageVector? = null
