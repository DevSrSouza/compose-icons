...
public val MaterialDesignIcons.PhoneForward: ImageVector
    get() {
        if (_phoneForward != null) {
            return _phoneForward!!
        }
        _phoneForward = Builder(name = "PhoneForward", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phoneForward: ImageVector? = null
