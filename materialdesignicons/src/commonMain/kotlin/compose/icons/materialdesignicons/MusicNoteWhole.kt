...
public val MaterialDesignIcons.MusicNoteWhole: ImageVector
    get() {
        if (_musicNoteWhole != null) {
            return _musicNoteWhole!!
        }
        _musicNoteWhole = Builder(name = "MusicNoteWhole", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 15.0f)
                arcTo(2.0f, 2.0f, 0.0f, true, true, 10.0f, 17.0f)
