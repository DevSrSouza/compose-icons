...
public val MaterialDesignIcons.ClipboardMultipleOutline: ImageVector
    get() {
        if (_clipboardMultipleOutline != null) {
            return _clipboardMultipleOutline!!
        }
        _clipboardMultipleOutline = Builder(name = "ClipboardMultipleOutline", defaultWidth =
...
private var _clipboardMultipleOutline: ImageVector? = null
