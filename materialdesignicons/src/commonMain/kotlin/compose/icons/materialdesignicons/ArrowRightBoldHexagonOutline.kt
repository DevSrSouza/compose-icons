...
public val MaterialDesignIcons.ArrowRightBoldHexagonOutline: ImageVector
    get() {
        if (_arrowRightBoldHexagonOutline != null) {
            return _arrowRightBoldHexagonOutline!!
        }
        _arrowRightBoldHexagonOutline = Builder(name = "ArrowRightBoldHexagonOutline", defaultWidth
