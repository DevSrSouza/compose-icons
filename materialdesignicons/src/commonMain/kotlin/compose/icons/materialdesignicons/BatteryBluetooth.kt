...
public val MaterialDesignIcons.BatteryBluetooth: ImageVector
    get() {
        if (_batteryBluetooth != null) {
            return _batteryBluetooth!!
        }
        _batteryBluetooth = Builder(name = "BatteryBluetooth", defaultWidth = 24.0.dp, defaultHeight
...
private var _batteryBluetooth: ImageVector? = null
