...
public val MaterialDesignIcons.SourceCommitEndLocal: ImageVector
    get() {
        if (_sourceCommitEndLocal != null) {
            return _sourceCommitEndLocal!!
        }
        _sourceCommitEndLocal = Builder(name = "SourceCommitEndLocal", defaultWidth = 24.0.dp,
...
private var _sourceCommitEndLocal: ImageVector? = null
