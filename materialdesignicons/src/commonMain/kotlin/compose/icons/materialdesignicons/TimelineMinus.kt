...
public val MaterialDesignIcons.TimelineMinus: ImageVector
    get() {
        if (_timelineMinus != null) {
            return _timelineMinus!!
        }
        _timelineMinus = Builder(name = "TimelineMinus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _timelineMinus: ImageVector? = null
