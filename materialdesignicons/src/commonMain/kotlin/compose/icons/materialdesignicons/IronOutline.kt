...
public val MaterialDesignIcons.IronOutline: ImageVector
    get() {
        if (_ironOutline != null) {
            return _ironOutline!!
        }
        _ironOutline = Builder(name = "IronOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.0f, 13.9f, 4.9f, 13.0f, 6.0f, 13.0f)
