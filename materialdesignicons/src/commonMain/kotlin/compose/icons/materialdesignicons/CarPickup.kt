...
public val MaterialDesignIcons.CarPickup: ImageVector
    get() {
        if (_carPickup != null) {
            return _carPickup!!
        }
        _carPickup = Builder(name = "CarPickup", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _carPickup: ImageVector? = null
