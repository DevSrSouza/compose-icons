...
public val MaterialDesignIcons.BatteryOutline: ImageVector
    get() {
        if (_batteryOutline != null) {
            return _batteryOutline!!
        }
        _batteryOutline = Builder(name = "BatteryOutline", defaultWidth = 24.0.dp, defaultHeight =
