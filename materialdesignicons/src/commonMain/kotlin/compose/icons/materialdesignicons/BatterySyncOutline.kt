...
public val MaterialDesignIcons.BatterySyncOutline: ImageVector
    get() {
        if (_batterySyncOutline != null) {
            return _batterySyncOutline!!
        }
        _batterySyncOutline = Builder(name = "BatterySyncOutline", defaultWidth = 24.0.dp,
...
private var _batterySyncOutline: ImageVector? = null
