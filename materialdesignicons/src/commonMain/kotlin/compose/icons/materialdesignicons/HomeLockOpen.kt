...
public val MaterialDesignIcons.HomeLockOpen: ImageVector
    get() {
        if (_homeLockOpen != null) {
            return _homeLockOpen!!
        }
        _homeLockOpen = Builder(name = "HomeLockOpen", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.0f, 1.0f, 0.0f, false, false, 11.0f, 11.0f)
