...
public val MaterialDesignIcons.CheckboxMultipleBlankCircle: ImageVector
    get() {
        if (_checkboxMultipleBlankCircle != null) {
            return _checkboxMultipleBlankCircle!!
        }
        _checkboxMultipleBlankCircle = Builder(name = "CheckboxMultipleBlankCircle", defaultWidth =
...
private var _checkboxMultipleBlankCircle: ImageVector? = null
