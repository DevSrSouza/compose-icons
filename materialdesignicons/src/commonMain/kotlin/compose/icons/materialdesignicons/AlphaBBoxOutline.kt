...
public val MaterialDesignIcons.AlphaBBoxOutline: ImageVector
    get() {
        if (_alphaBBoxOutline != null) {
            return _alphaBBoxOutline!!
        }
        _alphaBBoxOutline = Builder(name = "AlphaBBoxOutline", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.0f, 10.5f)
                curveTo(15.0f, 11.3f, 14.3f, 12.0f, 13.5f, 12.0f)
                curveTo(14.3f, 12.0f, 15.0f, 12.7f, 15.0f, 13.5f)
