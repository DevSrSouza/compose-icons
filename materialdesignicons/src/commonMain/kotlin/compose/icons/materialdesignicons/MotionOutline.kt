...
public val MaterialDesignIcons.MotionOutline: ImageVector
    get() {
        if (_motionOutline != null) {
            return _motionOutline!!
        }
        _motionOutline = Builder(name = "MotionOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(20.0f, 12.0f)
                curveTo(20.0f, 10.35f, 18.65f, 9.0f, 17.0f, 9.0f)
                reflectiveCurveTo(14.0f, 10.35f, 14.0f, 12.0f)
                curveTo(14.0f, 13.65f, 15.35f, 15.0f, 17.0f, 15.0f)
                reflectiveCurveTo(20.0f, 13.65f, 20.0f, 12.0f)
                close()
            }
        }
        .build()
...
private var _motionOutline: ImageVector? = null
