...
public val MaterialDesignIcons.FridgeVariantOffOutline: ImageVector
    get() {
        if (_fridgeVariantOffOutline != null) {
            return _fridgeVariantOffOutline!!
        }
        _fridgeVariantOffOutline = Builder(name = "FridgeVariantOffOutline", defaultWidth = 24.0.dp,
...
private var _fridgeVariantOffOutline: ImageVector? = null
