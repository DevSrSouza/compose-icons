...
public val MaterialDesignIcons.ChatRemoveOutline: ImageVector
    get() {
        if (_chatRemoveOutline != null) {
            return _chatRemoveOutline!!
        }
        _chatRemoveOutline = Builder(name = "ChatRemoveOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.58f, 5.0f, 4.0f, 7.69f, 4.0f, 11.0f)
                curveTo(4.0f, 14.31f, 7.58f, 17.0f, 12.0f, 17.0f)
...
private var _chatRemoveOutline: ImageVector? = null
