...
public val MaterialDesignIcons.BagPersonalTagOutline: ImageVector
    get() {
        if (_bagPersonalTagOutline != null) {
            return _bagPersonalTagOutline!!
        }
        _bagPersonalTagOutline = Builder(name = "BagPersonalTagOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(4.0f)
                verticalLineTo(9.0f)
                curveTo(4.0f, 7.9f, 4.9f, 7.0f, 6.0f, 7.0f)
