...
public val MaterialDesignIcons.HelpRhombus: ImageVector
    get() {
        if (_helpRhombus != null) {
            return _helpRhombus!!
        }
        _helpRhombus = Builder(name = "HelpRhombus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _helpRhombus: ImageVector? = null
