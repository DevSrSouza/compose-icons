...
public val MaterialDesignIcons.BookSync: ImageVector
    get() {
        if (_bookSync != null) {
            return _bookSync!!
        }
        _bookSync = Builder(name = "BookSync", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.0f, 17.5f)
                curveTo(13.0f, 19.25f, 13.69f, 20.83f, 14.82f, 22.0f)
