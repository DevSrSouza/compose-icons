...
public val MaterialDesignIcons.PhonePausedOutline: ImageVector
    get() {
        if (_phonePausedOutline != null) {
            return _phonePausedOutline!!
        }
        _phonePausedOutline = Builder(name = "PhonePausedOutline", defaultWidth = 24.0.dp,
...
private var _phonePausedOutline: ImageVector? = null
