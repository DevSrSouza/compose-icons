...
public val MaterialDesignIcons.AccountNetworkOffOutline: ImageVector
    get() {
        if (_accountNetworkOffOutline != null) {
            return _accountNetworkOffOutline!!
        }
        _accountNetworkOffOutline = Builder(name = "AccountNetworkOffOutline", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.7f, 13.17f, 19.0f, 14.26f, 19.0f, 15.5f)
                ...
                moveTo(12.0f, 8.0f)
                curveTo(12.83f, 8.0f, 13.5f, 7.33f, 13.5f, 6.5f)
                reflectiveCurveTo(12.83f, 5.0f, 12.0f, 5.0f)
                ...
                moveTo(13.11f, 15.0f)
                lineTo(12.11f, 14.0f)
                curveTo(12.08f, 14.0f, 12.04f, 14.0f, 12.0f, 14.0f)
                curveTo(9.89f, 14.0f, 8.39f, 14.53f, 7.61f, 15.0f)
