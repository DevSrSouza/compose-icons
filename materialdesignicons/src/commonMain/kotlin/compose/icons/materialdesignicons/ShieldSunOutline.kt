...
public val MaterialDesignIcons.ShieldSunOutline: ImageVector
    get() {
        if (_shieldSunOutline != null) {
            return _shieldSunOutline!!
        }
        _shieldSunOutline = Builder(name = "ShieldSunOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _shieldSunOutline: ImageVector? = null
