...
public val MaterialDesignIcons.BookArrowUpOutline: ImageVector
    get() {
        if (_bookArrowUpOutline != null) {
            return _bookArrowUpOutline!!
        }
        _bookArrowUpOutline = Builder(name = "BookArrowUpOutline", defaultWidth = 24.0.dp,
...
private var _bookArrowUpOutline: ImageVector? = null
