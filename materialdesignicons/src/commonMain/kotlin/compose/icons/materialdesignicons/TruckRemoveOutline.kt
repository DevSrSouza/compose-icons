...
public val MaterialDesignIcons.TruckRemoveOutline: ImageVector
    get() {
        if (_truckRemoveOutline != null) {
            return _truckRemoveOutline!!
        }
        _truckRemoveOutline = Builder(name = "TruckRemoveOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.69f, 14.39f, 6.89f, 14.0f, 6.0f, 14.0f)
                reflectiveCurveTo(4.31f, 14.39f, 3.76f, 15.0f)
                horizontalLineTo(3.0f)
                verticalLineTo(6.0f)
                horizontalLineTo(15.0f)
