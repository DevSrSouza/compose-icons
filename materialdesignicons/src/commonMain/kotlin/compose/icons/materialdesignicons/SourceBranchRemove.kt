...
public val MaterialDesignIcons.SourceBranchRemove: ImageVector
    get() {
        if (_sourceBranchRemove != null) {
            return _sourceBranchRemove!!
        }
        _sourceBranchRemove = Builder(name = "SourceBranchRemove", defaultWidth = 24.0.dp,
...
private var _sourceBranchRemove: ImageVector? = null
