...
public val MaterialDesignIcons.UploadNetwork: ImageVector
    get() {
        if (_uploadNetwork != null) {
            return _uploadNetwork!!
        }
        _uploadNetwork = Builder(name = "UploadNetwork", defaultWidth = 24.0.dp, defaultHeight =
...
private var _uploadNetwork: ImageVector? = null
