...
public val MaterialDesignIcons.AccountArrowDownOutline: ImageVector
    get() {
        if (_accountArrowDownOutline != null) {
            return _accountArrowDownOutline!!
        }
        _accountArrowDownOutline = Builder(name = "AccountArrowDownOutline", defaultWidth = 24.0.dp,
...
private var _accountArrowDownOutline: ImageVector? = null
