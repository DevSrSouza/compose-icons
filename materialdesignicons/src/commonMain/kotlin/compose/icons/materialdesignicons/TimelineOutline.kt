...
public val MaterialDesignIcons.TimelineOutline: ImageVector
    get() {
        if (_timelineOutline != null) {
            return _timelineOutline!!
        }
        _timelineOutline = Builder(name = "TimelineOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _timelineOutline: ImageVector? = null
