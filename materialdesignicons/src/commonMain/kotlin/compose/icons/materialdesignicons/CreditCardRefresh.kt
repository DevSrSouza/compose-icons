...
public val MaterialDesignIcons.CreditCardRefresh: ImageVector
    get() {
        if (_creditCardRefresh != null) {
            return _creditCardRefresh!!
        }
        _creditCardRefresh = Builder(name = "CreditCardRefresh", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.5f, 14.91f, 14.41f, 12.0f, 18.0f, 12.0f)
                curveTo(19.5f, 12.0f, 20.9f, 12.53f, 22.0f, 13.4f)
                verticalLineTo(6.0f)
...
private var _creditCardRefresh: ImageVector? = null
