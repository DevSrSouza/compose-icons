...
public val MaterialDesignIcons.CookieCheck: ImageVector
    get() {
        if (_cookieCheck != null) {
            return _cookieCheck!!
        }
        _cookieCheck = Builder(name = "CookieCheck", defaultWidth = 24.0.dp, defaultHeight =
...
private var _cookieCheck: ImageVector? = null
