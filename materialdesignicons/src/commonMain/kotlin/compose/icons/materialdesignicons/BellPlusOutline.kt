...
public val MaterialDesignIcons.BellPlusOutline: ImageVector
    get() {
        if (_bellPlusOutline != null) {
            return _bellPlusOutline!!
        }
        _bellPlusOutline = Builder(name = "BellPlusOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.76f, 6.0f, 17.0f, 8.24f, 17.0f, 11.0f)
