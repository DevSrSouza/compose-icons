...
public val MaterialDesignIcons.PhoneIncomingOutline: ImageVector
    get() {
        if (_phoneIncomingOutline != null) {
            return _phoneIncomingOutline!!
        }
        _phoneIncomingOutline = Builder(name = "PhoneIncomingOutline", defaultWidth = 24.0.dp,
...
private var _phoneIncomingOutline: ImageVector? = null
