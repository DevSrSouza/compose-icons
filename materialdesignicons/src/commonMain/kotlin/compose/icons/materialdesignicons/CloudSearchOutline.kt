...
public val MaterialDesignIcons.CloudSearchOutline: ImageVector
    get() {
        if (_cloudSearchOutline != null) {
            return _cloudSearchOutline!!
        }
        _cloudSearchOutline = Builder(name = "CloudSearchOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.74f, 16.0f, 13.43f, 15.79f, 14.0f, 15.43f)
                lineTo(16.57f, 18.0f)
                lineTo(18.0f, 16.57f)
                lineTo(15.43f, 14.0f)
                curveTo(15.79f, 13.43f, 16.0f, 12.74f, 16.0f, 12.0f)
                moveTo(12.0f, 14.0f)
