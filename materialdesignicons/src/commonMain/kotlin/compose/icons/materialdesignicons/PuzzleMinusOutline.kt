...
public val MaterialDesignIcons.PuzzleMinusOutline: ImageVector
    get() {
        if (_puzzleMinusOutline != null) {
            return _puzzleMinusOutline!!
        }
        _puzzleMinusOutline = Builder(name = "PuzzleMinusOutline", defaultWidth = 24.0.dp,
...
private var _puzzleMinusOutline: ImageVector? = null
