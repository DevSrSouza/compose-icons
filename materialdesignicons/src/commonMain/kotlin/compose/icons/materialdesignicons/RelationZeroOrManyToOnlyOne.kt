...
public val MaterialDesignIcons.RelationZeroOrManyToOnlyOne: ImageVector
    get() {
        if (_relationZeroOrManyToOnlyOne != null) {
            return _relationZeroOrManyToOnlyOne!!
        }
        _relationZeroOrManyToOnlyOne = Builder(name = "RelationZeroOrManyToOnlyOne", defaultWidth =
