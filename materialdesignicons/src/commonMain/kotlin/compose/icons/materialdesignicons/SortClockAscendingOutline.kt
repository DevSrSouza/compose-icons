...
public val MaterialDesignIcons.SortClockAscendingOutline: ImageVector
    get() {
        if (_sortClockAscendingOutline != null) {
            return _sortClockAscendingOutline!!
        }
        _sortClockAscendingOutline = Builder(name = "SortClockAscendingOutline", defaultWidth =
...
private var _sortClockAscendingOutline: ImageVector? = null
