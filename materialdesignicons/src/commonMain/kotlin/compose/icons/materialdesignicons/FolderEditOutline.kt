...
public val MaterialDesignIcons.FolderEditOutline: ImageVector
    get() {
        if (_folderEditOutline != null) {
            return _folderEditOutline!!
        }
        _folderEditOutline = Builder(name = "FolderEditOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.74f, 10.06f, 21.46f, 10.0f, 21.17f, 10.0f)
                curveTo(20.75f, 10.0f, 20.36f, 10.11f, 20.0f, 10.3f)
                verticalLineTo(8.0f)
                horizontalLineTo(4.0f)
