...
public val MaterialDesignIcons.FanMinus: ImageVector
    get() {
        if (_fanMinus != null) {
            return _fanMinus!!
        }
        _fanMinus = Builder(name = "FanMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _fanMinus: ImageVector? = null
