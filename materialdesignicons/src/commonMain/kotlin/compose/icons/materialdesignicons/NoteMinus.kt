...
public val MaterialDesignIcons.NoteMinus: ImageVector
    get() {
        if (_noteMinus != null) {
            return _noteMinus!!
        }
        _noteMinus = Builder(name = "NoteMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _noteMinus: ImageVector? = null
