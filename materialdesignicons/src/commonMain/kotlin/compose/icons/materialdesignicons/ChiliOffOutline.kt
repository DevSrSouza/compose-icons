...
public val MaterialDesignIcons.ChiliOffOutline: ImageVector
    get() {
        if (_chiliOffOutline != null) {
            return _chiliOffOutline!!
        }
        _chiliOffOutline = Builder(name = "ChiliOffOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 9.97f, 8.0f, 9.94f, 8.0f, 9.9f)
                lineTo(1.11f, 3.0f)
                lineTo(2.39f, 1.73f)
                lineTo(22.11f, 21.46f)
                moveTo(14.0f, 15.89f)
                lineTo(10.07f, 11.96f)
                curveTo(10.38f, 15.63f, 12.31f, 17.74f, 14.0f, 18.87f)
