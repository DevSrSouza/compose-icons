...
public val MaterialDesignIcons.FileJpgBox: ImageVector
    get() {
        if (_fileJpgBox != null) {
            return _fileJpgBox!!
        }
        _fileJpgBox = Builder(name = "FileJpgBox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(9.0f, 13.5f)
                curveTo(9.0f, 14.6f, 8.1f, 15.0f, 7.0f, 15.0f)
                reflectiveCurveTo(5.0f, 14.6f, 5.0f, 13.5f)
                ...
                verticalLineTo(13.5f)
                moveTo(14.0f, 11.5f)
                curveTo(14.0f, 12.3f, 13.3f, 13.0f, 12.5f, 13.0f)
                horizontalLineTo(11.5f)
                verticalLineTo(15.0f)
                horizontalLineTo(10.0f)
                verticalLineTo(9.0f)
                horizontalLineTo(12.5f)
                curveTo(13.3f, 9.0f, 14.0f, 9.7f, 14.0f, 10.5f)
