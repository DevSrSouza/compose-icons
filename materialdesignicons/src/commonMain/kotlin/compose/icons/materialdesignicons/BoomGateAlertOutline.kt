...
public val MaterialDesignIcons.BoomGateAlertOutline: ImageVector
    get() {
        if (_boomGateAlertOutline != null) {
            return _boomGateAlertOutline!!
        }
        _boomGateAlertOutline = Builder(name = "BoomGateAlertOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.4f, 14.1f, 6.6f, 14.1f, 7.5f, 13.6f)
                verticalLineTo(20.0f)
                moveTo(6.0f, 12.5f)
...
private var _boomGateAlertOutline: ImageVector? = null
