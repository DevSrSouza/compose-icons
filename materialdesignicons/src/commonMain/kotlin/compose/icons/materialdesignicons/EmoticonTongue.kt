...
public val MaterialDesignIcons.EmoticonTongue: ImageVector
    get() {
        if (_emoticonTongue != null) {
            return _emoticonTongue!!
        }
        _emoticonTongue = Builder(name = "EmoticonTongue", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.0f, 8.89f, 7.89f, 8.0f, 9.0f, 8.0f)
                ...
                curveTo(13.0f, 8.89f, 13.89f, 8.0f, 15.0f, 8.0f)
