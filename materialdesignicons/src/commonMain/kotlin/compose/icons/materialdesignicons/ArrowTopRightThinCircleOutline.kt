...
public val MaterialDesignIcons.ArrowTopRightThinCircleOutline: ImageVector
    get() {
        if (_arrowTopRightThinCircleOutline != null) {
            return _arrowTopRightThinCircleOutline!!
        }
        _arrowTopRightThinCircleOutline = Builder(name = "ArrowTopRightThinCircleOutline",
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.88f, 11.53f)
                lineTo(16.0f, 13.64f)
                verticalLineTo(8.0f)
                horizontalLineTo(10.36f)
                lineTo(12.47f, 10.12f)
                lineTo(7.5f, 15.1f)
                lineTo(8.9f, 16.5f)
            }
        }
...
private var _arrowTopRightThinCircleOutline: ImageVector? = null
