...
public val MaterialDesignIcons.ToyBrickMarker: ImageVector
    get() {
        if (_toyBrickMarker != null) {
            return _toyBrickMarker!!
        }
        _toyBrickMarker = Builder(name = "ToyBrickMarker", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(9.55f, 9.55f, 0.0f, false, true, 13.0f, 15.5f)
                arcTo(5.58f, 5.58f, 0.0f, false, true, 18.5f, 10.0f)
                arcTo(5.3f, 5.3f, 0.0f, false, true, 21.0f, 10.63f)
                verticalLineTo(6.0f)
                moveTo(18.5f, 12.0f)
