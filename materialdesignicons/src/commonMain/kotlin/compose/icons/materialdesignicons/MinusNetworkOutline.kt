...
public val MaterialDesignIcons.MinusNetworkOutline: ImageVector
    get() {
        if (_minusNetworkOutline != null) {
            return _minusNetworkOutline!!
        }
        _minusNetworkOutline = Builder(name = "MinusNetworkOutline", defaultWidth = 24.0.dp,
...
private var _minusNetworkOutline: ImageVector? = null
