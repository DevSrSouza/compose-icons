...
public val MaterialDesignIcons.CameraFlipOutline: ImageVector
    get() {
        if (_cameraFlipOutline != null) {
            return _cameraFlipOutline!!
        }
        _cameraFlipOutline = Builder(name = "CameraFlipOutline", defaultWidth = 24.0.dp,
...
private var _cameraFlipOutline: ImageVector? = null
