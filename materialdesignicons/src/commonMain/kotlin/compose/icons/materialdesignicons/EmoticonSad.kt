...
public val MaterialDesignIcons.EmoticonSad: ImageVector
    get() {
        if (_emoticonSad != null) {
            return _emoticonSad!!
        }
        _emoticonSad = Builder(name = "EmoticonSad", defaultWidth = 24.0.dp, defaultHeight =
...
private var _emoticonSad: ImageVector? = null
