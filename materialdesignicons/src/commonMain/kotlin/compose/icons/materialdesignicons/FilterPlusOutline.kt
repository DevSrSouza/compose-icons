...
public val MaterialDesignIcons.FilterPlusOutline: ImageVector
    get() {
        if (_filterPlusOutline != null) {
            return _filterPlusOutline!!
        }
        _filterPlusOutline = Builder(name = "FilterPlusOutline", defaultWidth = 24.0.dp,
...
private var _filterPlusOutline: ImageVector? = null
