...
public val MaterialDesignIcons.WebCheck: ImageVector
    get() {
        if (_webCheck != null) {
            return _webCheck!!
        }
        _webCheck = Builder(name = "WebCheck", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.0f, 12.37f, 19.97f, 12.73f, 19.92f, 13.08f)
                ...
                curveTo(13.0f, 18.71f, 13.03f, 18.43f, 13.07f, 18.15f)
                curveTo(12.75f, 18.78f, 12.4f, 19.39f, 12.0f, 19.96f)
                curveTo(11.17f, 18.76f, 10.5f, 17.43f, 10.09f, 16.0f)
                horizontalLineTo(13.81f)
                curveTo(14.41f, 14.96f, 15.31f, 14.12f, 16.4f, 13.6f)
                curveTo(16.46f, 13.07f, 16.5f, 12.54f, 16.5f, 12.0f)
                moveTo(12.0f, 4.03f)
                ...
                reflectiveCurveTo(9.56f, 10.65f, 9.66f, 10.0f)
...
private var _webCheck: ImageVector? = null
