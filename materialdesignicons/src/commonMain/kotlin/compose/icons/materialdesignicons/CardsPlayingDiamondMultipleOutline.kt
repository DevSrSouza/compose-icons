...
public val MaterialDesignIcons.CardsPlayingDiamondMultipleOutline: ImageVector
    get() {
        if (_cardsPlayingDiamondMultipleOutline != null) {
            return _cardsPlayingDiamondMultipleOutline!!
        }
        _cardsPlayingDiamondMultipleOutline = Builder(name = "CardsPlayingDiamondMultipleOutline",
