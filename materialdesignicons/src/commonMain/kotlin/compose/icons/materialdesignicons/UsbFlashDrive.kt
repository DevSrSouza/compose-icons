...
public val MaterialDesignIcons.UsbFlashDrive: ImageVector
    get() {
        if (_usbFlashDrive != null) {
            return _usbFlashDrive!!
        }
        _usbFlashDrive = Builder(name = "UsbFlashDrive", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 15.0f)
                curveTo(8.55f, 15.0f, 9.0f, 15.45f, 9.0f, 16.0f)
                ...
                lineTo(17.9f, 7.5f)
                moveTo(8.0f, 13.0f)
                curveTo(6.34f, 13.0f, 5.0f, 14.34f, 5.0f, 16.0f)
                curveTo(5.0f, 17.66f, 6.34f, 19.0f, 8.0f, 19.0f)
                curveTo(9.66f, 19.0f, 11.0f, 17.66f, 11.0f, 16.0f)
                curveTo(11.0f, 14.34f, 9.66f, 13.0f, 8.0f, 13.0f)
                moveTo(9.77f, 4.33f)
                lineTo(10.5f, 5.08f)
                lineTo(14.29f, 1.29f)
