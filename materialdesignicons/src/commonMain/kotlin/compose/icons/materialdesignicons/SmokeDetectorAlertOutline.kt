...
public val MaterialDesignIcons.SmokeDetectorAlertOutline: ImageVector
    get() {
        if (_smokeDetectorAlertOutline != null) {
            return _smokeDetectorAlertOutline!!
        }
        _smokeDetectorAlertOutline = Builder(name = "SmokeDetectorAlertOutline", defaultWidth =
