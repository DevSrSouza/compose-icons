...
public val MaterialDesignIcons.Car3Plus: ImageVector
    get() {
        if (_car3Plus != null) {
            return _car3Plus!!
        }
        _car3Plus = Builder(name = "Car3Plus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(16.9f, 5.0f)
                moveTo(4.5f, 12.0f)
                curveTo(5.3f, 12.0f, 6.0f, 12.7f, 6.0f, 13.5f)
                reflectiveCurveTo(5.3f, 15.0f, 4.5f, 15.0f)
                reflectiveCurveTo(3.0f, 14.3f, 3.0f, 13.5f)
                ...
                verticalLineTo(17.0f)
                moveTo(14.5f, 16.0f)
                curveTo(15.3f, 16.0f, 16.0f, 14.8f, 16.0f, 14.0f)
                ...
                horizontalLineTo(14.0f)
                curveTo(15.1f, 20.0f, 16.0f, 19.1f, 16.0f, 18.0f)
                curveTo(16.0f, 17.2f, 15.3f, 16.0f, 14.5f, 16.0f)
                close()
            }
        }
        .build()
