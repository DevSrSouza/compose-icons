...
public val MaterialDesignIcons.FlaskRemoveOutline: ImageVector
    get() {
        if (_flaskRemoveOutline != null) {
            return _flaskRemoveOutline!!
        }
        _flaskRemoveOutline = Builder(name = "FlaskRemoveOutline", defaultWidth = 24.0.dp,
...
private var _flaskRemoveOutline: ImageVector? = null
