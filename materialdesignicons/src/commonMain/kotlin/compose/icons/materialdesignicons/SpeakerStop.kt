...
public val MaterialDesignIcons.SpeakerStop: ImageVector
    get() {
        if (_speakerStop != null) {
            return _speakerStop!!
        }
        _speakerStop = Builder(name = "SpeakerStop", defaultWidth = 24.0.dp, defaultHeight =
...
private var _speakerStop: ImageVector? = null
