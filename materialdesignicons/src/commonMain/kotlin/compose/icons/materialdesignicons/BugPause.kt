...
public val MaterialDesignIcons.BugPause: ImageVector
    get() {
        if (_bugPause != null) {
            return _bugPause!!
        }
        _bugPause = Builder(name = "BugPause", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 16.46f, 14.61f, 14.2f, 17.0f, 13.35f)
                verticalLineTo(13.0f)
...
private var _bugPause: ImageVector? = null
