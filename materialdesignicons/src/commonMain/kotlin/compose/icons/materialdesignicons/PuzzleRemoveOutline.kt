...
public val MaterialDesignIcons.PuzzleRemoveOutline: ImageVector
    get() {
        if (_puzzleRemoveOutline != null) {
            return _puzzleRemoveOutline!!
        }
        _puzzleRemoveOutline = Builder(name = "PuzzleRemoveOutline", defaultWidth = 24.0.dp,
...
private var _puzzleRemoveOutline: ImageVector? = null
