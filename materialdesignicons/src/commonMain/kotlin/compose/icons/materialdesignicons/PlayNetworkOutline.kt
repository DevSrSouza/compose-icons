...
public val MaterialDesignIcons.PlayNetworkOutline: ImageVector
    get() {
        if (_playNetworkOutline != null) {
            return _playNetworkOutline!!
        }
        _playNetworkOutline = Builder(name = "PlayNetworkOutline", defaultWidth = 24.0.dp,
...
private var _playNetworkOutline: ImageVector? = null
