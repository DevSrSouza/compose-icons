...
public val MaterialDesignIcons.PhoneAlertOutline: ImageVector
    get() {
        if (_phoneAlertOutline != null) {
            return _phoneAlertOutline!!
        }
        _phoneAlertOutline = Builder(name = "PhoneAlertOutline", defaultWidth = 24.0.dp,
...
private var _phoneAlertOutline: ImageVector? = null
