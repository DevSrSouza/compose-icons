...
public val MaterialDesignIcons.BlenderOutline: ImageVector
    get() {
        if (_blenderOutline != null) {
            return _blenderOutline!!
        }
        _blenderOutline = Builder(name = "BlenderOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(19.0f)
                curveTo(8.0f, 17.35f, 9.35f, 16.0f, 11.0f, 16.0f)
                horizontalLineTo(13.0f)
                curveTo(14.65f, 16.0f, 16.0f, 17.35f, 16.0f, 19.0f)
                verticalLineTo(20.0f)
                moveTo(12.0f, 17.0f)
                curveTo(12.55f, 17.0f, 13.0f, 17.45f, 13.0f, 18.0f)
                reflectiveCurveTo(12.55f, 19.0f, 12.0f, 19.0f)
                reflectiveCurveTo(11.0f, 18.55f, 11.0f, 18.0f)
...
private var _blenderOutline: ImageVector? = null
