...
public val MaterialDesignIcons.BugCheck: ImageVector
    get() {
        if (_bugCheck != null) {
            return _bugCheck!!
        }
        _bugCheck = Builder(name = "BugCheck", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bugCheck: ImageVector? = null
