...
public val MaterialDesignIcons.BallotRecountOutline: ImageVector
    get() {
        if (_ballotRecountOutline != null) {
            return _ballotRecountOutline!!
        }
        _ballotRecountOutline = Builder(name = "BallotRecountOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.34f, 19.72f, 13.63f, 20.39f, 14.0f, 21.0f)
                horizontalLineTo(5.0f)
                moveTo(11.0f, 6.0f)
