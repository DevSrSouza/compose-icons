...
public val MaterialDesignIcons.LightbulbQuestion: ImageVector
    get() {
        if (_lightbulbQuestion != null) {
            return _lightbulbQuestion!!
        }
        _lightbulbQuestion = Builder(name = "LightbulbQuestion", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.0f, 2.0f)
                curveTo(4.1f, 2.0f, 1.0f, 5.1f, 1.0f, 9.0f)
                curveTo(1.0f, 11.4f, 2.2f, 13.5f, 4.0f, 14.7f)
                verticalLineTo(17.0f)
                curveTo(4.0f, 17.6f, 4.4f, 18.0f, 5.0f, 18.0f)
                horizontalLineTo(11.0f)
                curveTo(11.6f, 18.0f, 12.0f, 17.6f, 12.0f, 17.0f)
                verticalLineTo(14.7f)
                curveTo(13.8f, 13.4f, 15.0f, 11.3f, 15.0f, 9.0f)
                curveTo(15.0f, 5.1f, 11.9f, 2.0f, 8.0f, 2.0f)
                moveTo(5.0f, 21.0f)
                curveTo(5.0f, 21.6f, 5.4f, 22.0f, 6.0f, 22.0f)
                horizontalLineTo(10.0f)
                curveTo(10.6f, 22.0f, 11.0f, 21.6f, 11.0f, 21.0f)
