...
public val MaterialDesignIcons.CloudPlusOutline: ImageVector
    get() {
        if (_cloudPlusOutline != null) {
            return _cloudPlusOutline!!
        }
        _cloudPlusOutline = Builder(name = "CloudPlusOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _cloudPlusOutline: ImageVector? = null
