...
public val MaterialDesignIcons.AlphaWCircleOutline: ImageVector
    get() {
        if (_alphaWCircleOutline != null) {
            return _alphaWCircleOutline!!
        }
        _alphaWCircleOutline = Builder(name = "AlphaWCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaWCircleOutline: ImageVector? = null
