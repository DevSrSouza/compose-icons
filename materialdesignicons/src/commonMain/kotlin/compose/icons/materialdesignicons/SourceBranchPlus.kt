...
public val MaterialDesignIcons.SourceBranchPlus: ImageVector
    get() {
        if (_sourceBranchPlus != null) {
            return _sourceBranchPlus!!
        }
        _sourceBranchPlus = Builder(name = "SourceBranchPlus", defaultWidth = 24.0.dp, defaultHeight
...
private var _sourceBranchPlus: ImageVector? = null
