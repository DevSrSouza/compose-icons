...
public val MaterialDesignIcons.EmailMinus: ImageVector
    get() {
        if (_emailMinus != null) {
            return _emailMinus!!
        }
        _emailMinus = Builder(name = "EmailMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _emailMinus: ImageVector? = null
