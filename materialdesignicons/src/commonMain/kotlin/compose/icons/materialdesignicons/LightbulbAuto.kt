...
public val MaterialDesignIcons.LightbulbAuto: ImageVector
    get() {
        if (_lightbulbAuto != null) {
            return _lightbulbAuto!!
        }
        _lightbulbAuto = Builder(name = "LightbulbAuto", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.81f, 13.47f, 16.0f, 11.38f, 16.0f, 9.0f)
