...
public val MaterialDesignIcons.CrosshairsGps: ImageVector
    get() {
        if (_crosshairsGps != null) {
            return _crosshairsGps!!
        }
        _crosshairsGps = Builder(name = "CrosshairsGps", defaultWidth = 24.0.dp, defaultHeight =
...
private var _crosshairsGps: ImageVector? = null
