...
public val MaterialDesignIcons.FilterPlus: ImageVector
    get() {
        if (_filterPlus != null) {
            return _filterPlus!!
        }
        _filterPlus = Builder(name = "FilterPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _filterPlus: ImageVector? = null
