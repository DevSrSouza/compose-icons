...
public val MaterialDesignIcons.PhoneRemoveOutline: ImageVector
    get() {
        if (_phoneRemoveOutline != null) {
            return _phoneRemoveOutline!!
        }
        _phoneRemoveOutline = Builder(name = "PhoneRemoveOutline", defaultWidth = 24.0.dp,
...
private var _phoneRemoveOutline: ImageVector? = null
