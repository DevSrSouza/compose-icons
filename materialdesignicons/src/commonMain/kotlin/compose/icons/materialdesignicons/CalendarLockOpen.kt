...
public val MaterialDesignIcons.CalendarLockOpen: ImageVector
    get() {
        if (_calendarLockOpen != null) {
            return _calendarLockOpen!!
        }
        _calendarLockOpen = Builder(name = "CalendarLockOpen", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.4f, 10.6f, 19.7f, 10.2f, 19.0f, 10.1f)
                verticalLineTo(8.0f)
                horizontalLineTo(5.0f)
