...
public val MaterialDesignIcons.PackageVariantClosedPlus: ImageVector
    get() {
        if (_packageVariantClosedPlus != null) {
            return _packageVariantClosedPlus!!
        }
        _packageVariantClosedPlus = Builder(name = "PackageVariantClosedPlus", defaultWidth =
...
private var _packageVariantClosedPlus: ImageVector? = null
