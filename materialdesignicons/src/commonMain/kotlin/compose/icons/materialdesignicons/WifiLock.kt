...
public val MaterialDesignIcons.WifiLock: ImageVector
    get() {
        if (_wifiLock != null) {
            return _wifiLock!!
        }
        _wifiLock = Builder(name = "WifiLock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.4f, 10.29f)
                curveTo(15.77f, 9.47f, 13.94f, 9.0f, 12.0f, 9.0f)
                curveTo(9.3f, 9.0f, 6.81f, 9.89f, 4.8f, 11.4f)
                lineTo(6.6f, 13.8f)
                curveTo(8.1f, 12.67f, 9.97f, 12.0f, 12.0f, 12.0f)
                curveTo(12.97f, 12.0f, 13.9f, 12.16f, 14.78f, 12.44f)
