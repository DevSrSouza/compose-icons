...
public val MaterialDesignIcons.DatabaseArrowRightOutline: ImageVector
    get() {
        if (_databaseArrowRightOutline != null) {
            return _databaseArrowRightOutline!!
        }
        _databaseArrowRightOutline = Builder(name = "DatabaseArrowRightOutline", defaultWidth =
...
private var _databaseArrowRightOutline: ImageVector? = null
