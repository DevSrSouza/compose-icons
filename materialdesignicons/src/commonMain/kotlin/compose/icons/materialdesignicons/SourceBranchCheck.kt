...
public val MaterialDesignIcons.SourceBranchCheck: ImageVector
    get() {
        if (_sourceBranchCheck != null) {
            return _sourceBranchCheck!!
        }
        _sourceBranchCheck = Builder(name = "SourceBranchCheck", defaultWidth = 24.0.dp,
...
private var _sourceBranchCheck: ImageVector? = null
