...
public val MaterialDesignIcons.ArrowUpBoldHexagonOutline: ImageVector
    get() {
        if (_arrowUpBoldHexagonOutline != null) {
            return _arrowUpBoldHexagonOutline!!
        }
        _arrowUpBoldHexagonOutline = Builder(name = "ArrowUpBoldHexagonOutline", defaultWidth =
...
private var _arrowUpBoldHexagonOutline: ImageVector? = null
