...
public val MaterialDesignIcons.UploadNetworkOutline: ImageVector
    get() {
        if (_uploadNetworkOutline != null) {
            return _uploadNetworkOutline!!
        }
        _uploadNetworkOutline = Builder(name = "UploadNetworkOutline", defaultWidth = 24.0.dp,
...
private var _uploadNetworkOutline: ImageVector? = null
