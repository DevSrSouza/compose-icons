...
public val MaterialDesignIcons.FlowerTulip: ImageVector
    get() {
        ...
        _flowerTulip = Builder(name = "FlowerTulip", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.0f, 3.0f)
                verticalLineTo(8.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 12.0f, 14.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 6.0f, 8.0f)
                verticalLineTo(3.0f)
                curveTo(6.74f, 3.0f, 7.47f, 3.12f, 8.16f, 3.39f)
                curveTo(8.71f, 3.62f, 9.2f, 3.96f, 9.61f, 4.39f)
                lineTo(12.0f, 2.0f)
                lineTo(14.39f, 4.39f)
                curveTo(14.8f, 3.96f, 15.29f, 3.62f, 15.84f, 3.39f)
                curveTo(16.53f, 3.12f, 17.26f, 3.0f, 18.0f, 3.0f)
                close()
            }
        }
        .build()
