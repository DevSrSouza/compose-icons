...
public val MaterialDesignIcons.CookiePlus: ImageVector
    get() {
        if (_cookiePlus != null) {
            return _cookiePlus!!
        }
        _cookiePlus = Builder(name = "CookiePlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cookiePlus: ImageVector? = null
