...
public val MaterialDesignIcons.ContentSaveSettings: ImageVector
    get() {
        if (_contentSaveSettings != null) {
            return _contentSaveSettings!!
        }
        _contentSaveSettings = Builder(name = "ContentSaveSettings", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(5.0f)
                curveTo(3.89f, 20.0f, 3.0f, 19.1f, 3.0f, 18.0f)
                verticalLineTo(4.0f)
