...
public val MaterialDesignIcons.StoreCogOutline: ImageVector
    get() {
        if (_storeCogOutline != null) {
            return _storeCogOutline!!
        }
        _storeCogOutline = Builder(name = "StoreCogOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _storeCogOutline: ImageVector? = null
