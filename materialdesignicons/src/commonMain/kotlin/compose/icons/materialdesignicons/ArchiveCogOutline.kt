...
public val MaterialDesignIcons.ArchiveCogOutline: ImageVector
    get() {
        if (_archiveCogOutline != null) {
            return _archiveCogOutline!!
        }
        _archiveCogOutline = Builder(name = "ArchiveCogOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.11f, 20.37f, 12.0f, 19.7f, 12.0f, 19.0f)
...
private var _archiveCogOutline: ImageVector? = null
