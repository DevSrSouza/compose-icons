...
public val MaterialDesignIcons.AlphaSBoxOutline: ImageVector
    get() {
        if (_alphaSBoxOutline != null) {
            return _alphaSBoxOutline!!
        }
        _alphaSBoxOutline = Builder(name = "AlphaSBoxOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _alphaSBoxOutline: ImageVector? = null
