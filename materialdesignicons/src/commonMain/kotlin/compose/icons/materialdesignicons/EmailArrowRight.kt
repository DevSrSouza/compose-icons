...
public val MaterialDesignIcons.EmailArrowRight: ImageVector
    get() {
        if (_emailArrowRight != null) {
            return _emailArrowRight!!
        }
        _emailArrowRight = Builder(name = "EmailArrowRight", defaultWidth = 24.0.dp, defaultHeight =
...
private var _emailArrowRight: ImageVector? = null
