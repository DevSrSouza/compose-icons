...
public val MaterialDesignIcons.AccountPlusOutline: ImageVector
    get() {
        if (_accountPlusOutline != null) {
            return _accountPlusOutline!!
        }
        _accountPlusOutline = Builder(name = "AccountPlusOutline", defaultWidth = 24.0.dp,
...
private var _accountPlusOutline: ImageVector? = null
