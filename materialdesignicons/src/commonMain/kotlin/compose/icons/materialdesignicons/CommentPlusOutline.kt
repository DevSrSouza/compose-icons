...
public val MaterialDesignIcons.CommentPlusOutline: ImageVector
    get() {
        if (_commentPlusOutline != null) {
            return _commentPlusOutline!!
        }
        _commentPlusOutline = Builder(name = "CommentPlusOutline", defaultWidth = 24.0.dp,
...
private var _commentPlusOutline: ImageVector? = null
