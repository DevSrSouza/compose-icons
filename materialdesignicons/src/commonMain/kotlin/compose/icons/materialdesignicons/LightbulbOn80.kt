...
public val MaterialDesignIcons.LightbulbOn80: ImageVector
    get() {
        if (_lightbulbOn80 != null) {
            return _lightbulbOn80!!
        }
        _lightbulbOn80 = Builder(name = "LightbulbOn80", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.75f, 8.81f, 13.5f, 8.0f, 12.0f, 8.0f)
                reflectiveCurveTo(9.25f, 8.81f, 8.56f, 10.0f)
                close()
            }
        }
        .build()
