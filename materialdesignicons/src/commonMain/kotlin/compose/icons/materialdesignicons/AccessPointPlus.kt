...
public val MaterialDesignIcons.AccessPointPlus: ImageVector
    get() {
        if (_accessPointPlus != null) {
            return _accessPointPlus!!
        }
        _accessPointPlus = Builder(name = "AccessPointPlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _accessPointPlus: ImageVector? = null
