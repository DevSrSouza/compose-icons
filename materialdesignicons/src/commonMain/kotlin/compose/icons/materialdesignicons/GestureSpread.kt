...
public val MaterialDesignIcons.GestureSpread: ImageVector
    get() {
        if (_gestureSpread != null) {
            return _gestureSpread!!
        }
        _gestureSpread = Builder(name = "GestureSpread", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gestureSpread: ImageVector? = null
