...
public val MaterialDesignIcons.DotsVerticalCircleOutline: ImageVector
    get() {
        if (_dotsVerticalCircleOutline != null) {
            return _dotsVerticalCircleOutline!!
        }
        _dotsVerticalCircleOutline = Builder(name = "DotsVerticalCircleOutline", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.5f, 1.5f, 0.0f, false, true, 10.5f, 7.5f)
                moveTo(12.0f, 2.0f)
