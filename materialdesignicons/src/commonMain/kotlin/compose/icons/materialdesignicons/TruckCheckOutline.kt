...
public val MaterialDesignIcons.TruckCheckOutline: ImageVector
    get() {
        if (_truckCheckOutline != null) {
            return _truckCheckOutline!!
        }
        _truckCheckOutline = Builder(name = "TruckCheckOutline", defaultWidth = 24.0.dp,
...
private var _truckCheckOutline: ImageVector? = null
