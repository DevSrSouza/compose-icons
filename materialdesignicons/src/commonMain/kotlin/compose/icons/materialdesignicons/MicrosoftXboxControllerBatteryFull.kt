...
public val MaterialDesignIcons.MicrosoftXboxControllerBatteryFull: ImageVector
    get() {
        if (_microsoftXboxControllerBatteryFull != null) {
            return _microsoftXboxControllerBatteryFull!!
        }
        _microsoftXboxControllerBatteryFull = Builder(name = "MicrosoftXboxControllerBatteryFull",
...
private var _microsoftXboxControllerBatteryFull: ImageVector? = null
