...
public val MaterialDesignIcons.LockOpenCheckOutline: ImageVector
    get() {
        if (_lockOpenCheckOutline != null) {
            return _lockOpenCheckOutline!!
        }
        _lockOpenCheckOutline = Builder(name = "LockOpenCheckOutline", defaultWidth = 24.0.dp,
...
private var _lockOpenCheckOutline: ImageVector? = null
