...
public val MaterialDesignIcons.HeadFlashOutline: ImageVector
    get() {
        if (_headFlashOutline != null) {
            return _headFlashOutline!!
        }
        _headFlashOutline = Builder(name = "HeadFlashOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _headFlashOutline: ImageVector? = null
