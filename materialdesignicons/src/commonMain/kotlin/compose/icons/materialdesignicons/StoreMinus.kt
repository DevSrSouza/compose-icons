...
public val MaterialDesignIcons.StoreMinus: ImageVector
    get() {
        if (_storeMinus != null) {
            return _storeMinus!!
        }
        _storeMinus = Builder(name = "StoreMinus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _storeMinus: ImageVector? = null
