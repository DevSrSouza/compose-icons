...
public val MaterialDesignIcons.BasketMinusOutline: ImageVector
    get() {
        if (_basketMinusOutline != null) {
            return _basketMinusOutline!!
        }
        _basketMinusOutline = Builder(name = "BasketMinusOutline", defaultWidth = 24.0.dp,
...
private var _basketMinusOutline: ImageVector? = null
