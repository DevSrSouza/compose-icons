...
public val MaterialDesignIcons.RadiologyBox: ImageVector
    get() {
        if (_radiologyBox != null) {
            return _radiologyBox!!
        }
        _radiologyBox = Builder(name = "RadiologyBox", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(13.0f, 6.45f, 13.0f, 7.0f)
                verticalLineTo(8.0f)
