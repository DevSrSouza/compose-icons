...
public val MaterialDesignIcons.CarArrowLeft: ImageVector
    get() {
        if (_carArrowLeft != null) {
            return _carArrowLeft!!
        }
        _carArrowLeft = Builder(name = "CarArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _carArrowLeft: ImageVector? = null
