...
public val MaterialDesignIcons.FlaskEmptyOffOutline: ImageVector
    get() {
        if (_flaskEmptyOffOutline != null) {
            return _flaskEmptyOffOutline!!
        }
        _flaskEmptyOffOutline = Builder(name = "FlaskEmptyOffOutline", defaultWidth = 24.0.dp,
...
private var _flaskEmptyOffOutline: ImageVector? = null
