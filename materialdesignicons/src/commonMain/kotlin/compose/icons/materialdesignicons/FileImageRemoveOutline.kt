...
public val MaterialDesignIcons.FileImageRemoveOutline: ImageVector
    get() {
        if (_fileImageRemoveOutline != null) {
            return _fileImageRemoveOutline!!
        }
        _fileImageRemoveOutline = Builder(name = "FileImageRemoveOutline", defaultWidth = 24.0.dp,
...
private var _fileImageRemoveOutline: ImageVector? = null
