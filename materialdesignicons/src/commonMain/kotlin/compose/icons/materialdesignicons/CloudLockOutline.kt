...
public val MaterialDesignIcons.CloudLockOutline: ImageVector
    get() {
        if (_cloudLockOutline != null) {
            return _cloudLockOutline!!
        }
        _cloudLockOutline = Builder(name = "CloudLockOutline", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.23f, 10.0f, 17.56f, 10.19f, 16.95f, 10.46f)
