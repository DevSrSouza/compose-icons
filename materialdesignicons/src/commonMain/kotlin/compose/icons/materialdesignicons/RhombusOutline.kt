...
public val MaterialDesignIcons.RhombusOutline: ImageVector
    get() {
        if (_rhombusOutline != null) {
            return _rhombusOutline!!
        }
        _rhombusOutline = Builder(name = "RhombusOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rhombusOutline: ImageVector? = null
