...
public val MaterialDesignIcons.GamepadCircleRight: ImageVector
    get() {
        if (_gamepadCircleRight != null) {
            return _gamepadCircleRight!!
        }
        _gamepadCircleRight = Builder(name = "GamepadCircleRight", defaultWidth = 24.0.dp,
...
private var _gamepadCircleRight: ImageVector? = null
