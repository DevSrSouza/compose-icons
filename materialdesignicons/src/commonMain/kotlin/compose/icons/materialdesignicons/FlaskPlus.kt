...
public val MaterialDesignIcons.FlaskPlus: ImageVector
    get() {
        if (_flaskPlus != null) {
            return _flaskPlus!!
        }
        _flaskPlus = Builder(name = "FlaskPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flaskPlus: ImageVector? = null
