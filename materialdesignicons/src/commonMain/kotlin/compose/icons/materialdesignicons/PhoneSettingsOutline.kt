...
public val MaterialDesignIcons.PhoneSettingsOutline: ImageVector
    get() {
        if (_phoneSettingsOutline != null) {
            return _phoneSettingsOutline!!
        }
        _phoneSettingsOutline = Builder(name = "PhoneSettingsOutline", defaultWidth = 24.0.dp,
...
private var _phoneSettingsOutline: ImageVector? = null
