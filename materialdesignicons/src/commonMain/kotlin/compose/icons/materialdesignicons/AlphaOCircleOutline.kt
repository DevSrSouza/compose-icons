...
public val MaterialDesignIcons.AlphaOCircleOutline: ImageVector
    get() {
        if (_alphaOCircleOutline != null) {
            return _alphaOCircleOutline!!
        }
        _alphaOCircleOutline = Builder(name = "AlphaOCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaOCircleOutline: ImageVector? = null
