...
public val MaterialDesignIcons.Dice1Outline: ImageVector
    get() {
        if (_dice1Outline != null) {
            return _dice1Outline!!
        }
        _dice1Outline = Builder(name = "Dice1Outline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 10.5f)
                curveTo(11.17f, 10.5f, 10.5f, 11.17f, 10.5f, 12.0f)
                reflectiveCurveTo(11.17f, 13.5f, 12.0f, 13.5f)
                reflectiveCurveTo(13.5f, 12.83f, 13.5f, 12.0f)
