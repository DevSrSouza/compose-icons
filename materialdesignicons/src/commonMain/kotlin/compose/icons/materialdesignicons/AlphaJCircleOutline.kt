...
public val MaterialDesignIcons.AlphaJCircleOutline: ImageVector
    get() {
        if (_alphaJCircleOutline != null) {
            return _alphaJCircleOutline!!
        }
        _alphaJCircleOutline = Builder(name = "AlphaJCircleOutline", defaultWidth = 24.0.dp,
...
private var _alphaJCircleOutline: ImageVector? = null
