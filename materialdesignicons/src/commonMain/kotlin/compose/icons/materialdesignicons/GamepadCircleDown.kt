...
public val MaterialDesignIcons.GamepadCircleDown: ImageVector
    get() {
        if (_gamepadCircleDown != null) {
            return _gamepadCircleDown!!
        }
        _gamepadCircleDown = Builder(name = "GamepadCircleDown", defaultWidth = 24.0.dp,
...
private var _gamepadCircleDown: ImageVector? = null
