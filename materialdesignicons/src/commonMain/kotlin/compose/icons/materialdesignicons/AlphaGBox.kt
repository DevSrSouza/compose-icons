...
public val MaterialDesignIcons.AlphaGBox: ImageVector
    get() {
        if (_alphaGBox != null) {
            return _alphaGBox!!
        }
        _alphaGBox = Builder(name = "AlphaGBox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _alphaGBox: ImageVector? = null
