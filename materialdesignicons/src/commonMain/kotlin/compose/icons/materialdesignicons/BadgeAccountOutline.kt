...
public val MaterialDesignIcons.BadgeAccountOutline: ImageVector
    get() {
        if (_badgeAccountOutline != null) {
            return _badgeAccountOutline!!
        }
        _badgeAccountOutline = Builder(name = "BadgeAccountOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 12.67f, 10.67f, 12.0f, 12.0f, 12.0f)
                curveTo(13.33f, 12.0f, 16.0f, 12.67f, 16.0f, 14.0f)
