...
public val MaterialDesignIcons.PackageVariantClosedRemove: ImageVector
    get() {
        if (_packageVariantClosedRemove != null) {
            return _packageVariantClosedRemove!!
        }
        _packageVariantClosedRemove = Builder(name = "PackageVariantClosedRemove", defaultWidth =
...
private var _packageVariantClosedRemove: ImageVector? = null
