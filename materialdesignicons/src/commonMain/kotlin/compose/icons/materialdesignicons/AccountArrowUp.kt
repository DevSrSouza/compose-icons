...
public val MaterialDesignIcons.AccountArrowUp: ImageVector
    get() {
        if (_accountArrowUp != null) {
            return _accountArrowUp!!
        }
        _accountArrowUp = Builder(name = "AccountArrowUp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _accountArrowUp: ImageVector? = null
