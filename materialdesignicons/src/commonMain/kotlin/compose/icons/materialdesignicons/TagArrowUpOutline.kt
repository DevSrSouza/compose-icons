...
public val MaterialDesignIcons.TagArrowUpOutline: ImageVector
    get() {
        if (_tagArrowUpOutline != null) {
            return _tagArrowUpOutline!!
        }
        _tagArrowUpOutline = Builder(name = "TagArrowUpOutline", defaultWidth = 24.0.dp,
...
private var _tagArrowUpOutline: ImageVector? = null
