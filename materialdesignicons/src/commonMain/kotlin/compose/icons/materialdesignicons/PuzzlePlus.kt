...
public val MaterialDesignIcons.PuzzlePlus: ImageVector
    get() {
        if (_puzzlePlus != null) {
            return _puzzlePlus!!
        }
        _puzzlePlus = Builder(name = "PuzzlePlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _puzzlePlus: ImageVector? = null
