...
public val MaterialDesignIcons.BookCog: ImageVector
    get() {
        if (_bookCog != null) {
            return _bookCog!!
        }
        _bookCog = Builder(name = "BookCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 19.0f)
                curveTo(12.0f, 20.08f, 12.25f, 21.09f, 12.68f, 22.0f)
...
private var _bookCog: ImageVector? = null
