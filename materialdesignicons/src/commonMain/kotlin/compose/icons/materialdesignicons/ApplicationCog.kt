...
public val MaterialDesignIcons.ApplicationCog: ImageVector
    get() {
        if (_applicationCog != null) {
            return _applicationCog!!
        }
        _applicationCog = Builder(name = "ApplicationCog", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.0f, 18.0f)
                curveTo(11.0f, 14.1f, 14.1f, 11.0f, 18.0f, 11.0f)
                curveTo(20.0f, 11.0f, 21.7f, 11.8f, 23.0f, 13.1f)
                verticalLineTo(4.0f)
