...
public val MaterialDesignIcons.BoomGateOutline: ImageVector
    get() {
        if (_boomGateOutline != null) {
            return _boomGateOutline!!
        }
        _boomGateOutline = Builder(name = "BoomGateOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.43f, 14.14f, 6.57f, 14.14f, 7.5f, 13.6f)
                verticalLineTo(20.0f)
                moveTo(6.0f, 12.5f)
...
private var _boomGateOutline: ImageVector? = null
