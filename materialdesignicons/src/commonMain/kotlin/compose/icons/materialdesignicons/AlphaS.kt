...
public val MaterialDesignIcons.AlphaS: ImageVector
    get() {
        if (_alphaS != null) {
            return _alphaS!!
        }
        _alphaS = Builder(name = "AlphaS", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _alphaS: ImageVector? = null
