...
public val MaterialDesignIcons.PaperclipPlus: ImageVector
    get() {
        if (_paperclipPlus != null) {
            return _paperclipPlus!!
        }
        _paperclipPlus = Builder(name = "PaperclipPlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _paperclipPlus: ImageVector? = null
