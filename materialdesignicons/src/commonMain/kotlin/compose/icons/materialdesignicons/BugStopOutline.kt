...
public val MaterialDesignIcons.BugStopOutline: ImageVector
    get() {
        if (_bugStopOutline != null) {
            return _bugStopOutline!!
        }
        _bugStopOutline = Builder(name = "BugStopOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bugStopOutline: ImageVector? = null
