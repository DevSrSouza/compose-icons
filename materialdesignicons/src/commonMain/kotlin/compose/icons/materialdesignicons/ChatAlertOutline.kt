...
public val MaterialDesignIcons.ChatAlertOutline: ImageVector
    get() {
        if (_chatAlertOutline != null) {
            return _chatAlertOutline!!
        }
        _chatAlertOutline = Builder(name = "ChatAlertOutline", defaultWidth = 24.0.dp, defaultHeight
...
private var _chatAlertOutline: ImageVector? = null
