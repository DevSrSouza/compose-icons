...
public val MaterialDesignIcons.MicrosoftXboxControllerMenu: ImageVector
    get() {
        if (_microsoftXboxControllerMenu != null) {
            return _microsoftXboxControllerMenu!!
        }
        _microsoftXboxControllerMenu = Builder(name = "MicrosoftXboxControllerMenu", defaultWidth =
