...
public val MaterialDesignIcons.ClipboardCheckMultipleOutline: ImageVector
    get() {
        if (_clipboardCheckMultipleOutline != null) {
            return _clipboardCheckMultipleOutline!!
        }
        _clipboardCheckMultipleOutline = Builder(name = "ClipboardCheckMultipleOutline",
...
private var _clipboardCheckMultipleOutline: ImageVector? = null
