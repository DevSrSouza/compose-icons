...
public val MaterialDesignIcons.FolderMinusOutline: ImageVector
    get() {
        if (_folderMinusOutline != null) {
            return _folderMinusOutline!!
        }
        _folderMinusOutline = Builder(name = "FolderMinusOutline", defaultWidth = 24.0.dp,
...
private var _folderMinusOutline: ImageVector? = null
