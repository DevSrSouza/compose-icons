...
public val MaterialDesignIcons.AlphaO: ImageVector
    get() {
        if (_alphaO != null) {
            return _alphaO!!
        }
        _alphaO = Builder(name = "AlphaO", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _alphaO: ImageVector? = null
