...
public val MaterialDesignIcons.ProgressClock: ImageVector
    get() {
        if (_progressClock != null) {
            return _progressClock!!
        }
        _progressClock = Builder(name = "ProgressClock", defaultWidth = 24.0.dp, defaultHeight =
...
private var _progressClock: ImageVector? = null
