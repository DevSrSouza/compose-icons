...
public val MaterialDesignIcons.HeadLightbulbOutline: ImageVector
    get() {
        if (_headLightbulbOutline != null) {
            return _headLightbulbOutline!!
        }
        _headLightbulbOutline = Builder(name = "HeadLightbulbOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(15.6f, 9.5f)
                curveTo(15.3f, 9.9f, 15.0f, 10.3f, 14.5f, 10.6f)
