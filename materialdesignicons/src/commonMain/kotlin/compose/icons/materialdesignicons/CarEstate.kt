...
public val MaterialDesignIcons.CarEstate: ImageVector
    get() {
        if (_carEstate != null) {
            return _carEstate!!
        }
        _carEstate = Builder(name = "CarEstate", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(8.0f)
                curveTo(1.0f, 6.89f, 1.89f, 6.0f, 3.0f, 6.0f)
                moveTo(2.5f, 7.5f)
