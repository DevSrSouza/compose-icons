...
public val MaterialDesignIcons.TrainCarGondolaFull: ImageVector
    get() {
        if (_trainCarGondolaFull != null) {
            return _trainCarGondolaFull!!
        }
        _trainCarGondolaFull = Builder(name = "TrainCarGondolaFull", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.0f, 10.0f)
                curveTo(19.04f, 8.19f, 15.74f, 7.0f, 12.0f, 7.0f)
                reflectiveCurveTo(4.96f, 8.19f, 3.0f, 10.0f)
