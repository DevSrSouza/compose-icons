...
public val MaterialDesignIcons.FolderArrowUpOutline: ImageVector
    get() {
        if (_folderArrowUpOutline != null) {
            return _folderArrowUpOutline!!
        }
        _folderArrowUpOutline = Builder(name = "FolderArrowUpOutline", defaultWidth = 24.0.dp,
...
private var _folderArrowUpOutline: ImageVector? = null
