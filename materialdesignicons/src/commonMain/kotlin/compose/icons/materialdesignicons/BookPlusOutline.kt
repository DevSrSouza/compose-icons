...
public val MaterialDesignIcons.BookPlusOutline: ImageVector
    get() {
        if (_bookPlusOutline != null) {
            return _bookPlusOutline!!
        }
        _bookPlusOutline = Builder(name = "BookPlusOutline", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bookPlusOutline: ImageVector? = null
