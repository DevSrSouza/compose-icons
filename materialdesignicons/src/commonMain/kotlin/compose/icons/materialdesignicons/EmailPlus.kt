...
public val MaterialDesignIcons.EmailPlus: ImageVector
    get() {
        if (_emailPlus != null) {
            return _emailPlus!!
        }
        _emailPlus = Builder(name = "EmailPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _emailPlus: ImageVector? = null
