...
public val MaterialDesignIcons.DotsGrid: ImageVector
    get() {
        if (_dotsGrid != null) {
            return _dotsGrid!!
        }
        _dotsGrid = Builder(name = "DotsGrid", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _dotsGrid: ImageVector? = null
