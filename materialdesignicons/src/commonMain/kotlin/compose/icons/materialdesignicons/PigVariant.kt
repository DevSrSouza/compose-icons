...
public val MaterialDesignIcons.PigVariant: ImageVector
    get() {
        if (_pigVariant != null) {
            return _pigVariant!!
        }
        _pigVariant = Builder(name = "PigVariant", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _pigVariant: ImageVector? = null
