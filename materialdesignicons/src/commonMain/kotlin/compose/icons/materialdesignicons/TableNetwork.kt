...
public val MaterialDesignIcons.TableNetwork: ImageVector
    get() {
        if (_tableNetwork != null) {
            return _tableNetwork!!
        }
        _tableNetwork = Builder(name = "TableNetwork", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(3.0f)
                curveTo(21.0f, 1.9f, 20.11f, 1.0f, 19.0f, 1.0f)
