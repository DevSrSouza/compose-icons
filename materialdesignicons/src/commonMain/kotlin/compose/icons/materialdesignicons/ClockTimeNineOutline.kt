...
public val MaterialDesignIcons.ClockTimeNineOutline: ImageVector
    get() {
        if (_clockTimeNineOutline != null) {
            return _clockTimeNineOutline!!
        }
        _clockTimeNineOutline = Builder(name = "ClockTimeNineOutline", defaultWidth = 24.0.dp,
...
private var _clockTimeNineOutline: ImageVector? = null
