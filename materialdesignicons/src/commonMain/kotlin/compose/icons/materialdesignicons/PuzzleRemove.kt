...
public val MaterialDesignIcons.PuzzleRemove: ImageVector
    get() {
        if (_puzzleRemove != null) {
            return _puzzleRemove!!
        }
        _puzzleRemove = Builder(name = "PuzzleRemove", defaultWidth = 24.0.dp, defaultHeight =
...
private var _puzzleRemove: ImageVector? = null
