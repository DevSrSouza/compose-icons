...
public val MaterialDesignIcons.FileLockOutline: ImageVector
    get() {
        if (_fileLockOutline != null) {
            return _fileLockOutline!!
        }
        _fileLockOutline = Builder(name = "FileLockOutline", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.7f, 11.0f, 19.4f, 11.2f, 20.0f, 11.4f)
                verticalLineTo(8.0f)
                lineTo(14.0f, 2.0f)
                horizontalLineTo(6.0f)
                close()
...
private var _fileLockOutline: ImageVector? = null
