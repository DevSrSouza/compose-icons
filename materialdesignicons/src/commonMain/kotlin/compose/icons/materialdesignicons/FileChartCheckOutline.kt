...
public val MaterialDesignIcons.FileChartCheckOutline: ImageVector
    get() {
        if (_fileChartCheckOutline != null) {
            return _fileChartCheckOutline!!
        }
        _fileChartCheckOutline = Builder(name = "FileChartCheckOutline", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.4f, 21.4f, 13.2f, 20.7f, 13.1f, 20.0f)
