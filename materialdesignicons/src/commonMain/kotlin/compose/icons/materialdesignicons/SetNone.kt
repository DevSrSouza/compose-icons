...
public val MaterialDesignIcons.SetNone: ImageVector
    get() {
        if (_setNone != null) {
            return _setNone!!
        }
        _setNone = Builder(name = "SetNone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _setNone: ImageVector? = null
