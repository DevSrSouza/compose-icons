...
public val WeatherIcons.Snow: ImageVector
    get() {
        if (_snow != null) {
            return _snow!!
        }
        _snow = Builder(name = "Snow", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.0f, 24.65f)
                curveToRelative(0.0f, -0.24f, 0.08f, -0.44f, 0.24f, -0.6f)
                curveToRelative(0.16f, -0.15f, 0.35f, -0.23f, 0.58f, -0.23f)
                ...
                curveToRelative(-0.23f, 0.0f, -0.43f, -0.08f, -0.59f, -0.23f)
                curveTo(11.08f, 25.08f, 11.0f, 24.88f, 11.0f, 24.65f)
                close()
                moveTo(14.19f, 22.95f)
                ...
                reflectiveCurveTo(14.19f, 23.18f, 14.19f, 22.95f)
                close()
                ...
                curveToRelative(-0.17f, 0.16f, -0.37f, 0.24f, -0.61f, 0.24f)
                curveToRelative(-0.23f, 0.0f, -0.42f, -0.08f, -0.58f, -0.24f)
                curveTo(14.27f, 27.03f, 14.19f, 26.84f, 14.19f, 26.61f)
                close()
                ...
                curveTo(17.5f, 25.07f, 17.41f, 24.88f, 17.41f, 24.65f)
                close()
            }
        }
        .build()
