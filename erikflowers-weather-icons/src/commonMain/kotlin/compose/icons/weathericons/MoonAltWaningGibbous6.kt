...
public val WeatherIcons.MoonAltWaningGibbous6: ImageVector
    get() {
        if (_moonAltWaningGibbous6 != null) {
            return _moonAltWaningGibbous6!!
        }
        _moonAltWaningGibbous6 = Builder(name = "MoonAltWaningGibbous6", defaultWidth = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.67f, -2.49f, 1.01f, -5.84f, 1.01f, -10.06f)
                curveToRelative(0.0f, -3.82f, -0.34f, -7.17f, -1.03f, -10.05f)
...
private var _moonAltWaningGibbous6: ImageVector? = null
