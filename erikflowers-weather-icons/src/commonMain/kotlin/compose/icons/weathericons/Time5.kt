...
public val WeatherIcons.Time5: ImageVector
    get() {
        if (_time5 != null) {
            return _time5!!
        }
        _time5 = Builder(name = "Time5", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(2.15f, 3.84f)
                curveToRelative(0.12f, 0.21f, 0.14f, 0.43f, 0.08f, 0.65f)
                reflectiveCurveToRelative(-0.19f, 0.39f, -0.39f, 0.51f)
                curveToRelative(-0.11f, 0.06f, -0.24f, 0.09f, -0.41f, 0.09f)
                curveToRelative(-0.33f, 0.0f, -0.58f, -0.14f, -0.73f, -0.41f)
                lineToRelative(-2.2f, -3.9f)
                curveTo(14.2f, 14.85f, 14.14f, 14.68f, 14.14f, 14.47f)
                close()
            }
        }
        .build()
...
private var _time5: ImageVector? = null
