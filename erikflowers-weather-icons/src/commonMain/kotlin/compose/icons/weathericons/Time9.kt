...
public val WeatherIcons.Time9: ImageVector
    get() {
        if (_time9 != null) {
            return _time9!!
        }
        _time9 = Builder(name = "Time9", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.23f, -0.08f, 0.43f, -0.24f, 0.59f)
                reflectiveCurveToRelative(-0.36f, 0.24f, -0.59f, 0.24f)
                curveToRelative(-0.1f, 0.0f, -0.16f, 0.0f, -0.19f, -0.01f)
                horizontalLineToRelative(-4.44f)
                curveToRelative(-0.23f, 0.0f, -0.43f, -0.08f, -0.59f, -0.25f)
                curveTo(9.59f, 14.88f, 9.51f, 14.68f, 9.51f, 14.46f)
                close()
            }
        }
        .build()
...
private var _time9: ImageVector? = null
