...
public val WeatherIcons.MoonAltWaningCrescent1: ImageVector
    get() {
        if (_moonAltWaningCrescent1 != null) {
            return _moonAltWaningCrescent1!!
        }
        _moonAltWaningCrescent1 = Builder(name = "MoonAltWaningCrescent1", defaultWidth = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.59f, -2.67f, -0.88f, -6.02f, -0.88f, -10.06f)
                curveToRelative(0.0f, -3.39f, 0.3f, -6.74f, 0.91f, -10.05f)
...
private var _moonAltWaningCrescent1: ImageVector? = null
