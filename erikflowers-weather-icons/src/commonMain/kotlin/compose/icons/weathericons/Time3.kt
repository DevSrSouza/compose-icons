...
public val WeatherIcons.Time3: ImageVector
    get() {
        if (_time3 != null) {
            return _time3!!
        }
        _time3 = Builder(name = "Time3", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.03f, 0.01f, -0.09f, 0.01f, -0.18f, 0.01f)
                curveToRelative(-0.23f, 0.0f, -0.43f, -0.08f, -0.59f, -0.24f)
...
private var _time3: ImageVector? = null
