...
public val WeatherIcons.MoonThirdQuarter: ImageVector
    get() {
        if (_moonThirdQuarter != null) {
            return _moonThirdQuarter!!
        }
        _moonThirdQuarter = Builder(name = "MoonThirdQuarter", defaultWidth = 30.0.dp, defaultHeight
...
private var _moonThirdQuarter: ImageVector? = null
