...
public val WeatherIcons.DaySnowWind: ImageVector
    get() {
        if (_daySnowWind != null) {
            return _daySnowWind!!
        }
        _daySnowWind = Builder(name = "DaySnowWind", defaultWidth = 30.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.14f, 24.17f, 7.06f, 24.37f, 7.06f, 24.61f)
                close()
                moveTo(7.92f, 20.98f)
                ...
                curveTo(9.9f, 26.13f, 9.82f, 26.33f, 9.82f, 26.56f)
                close()
                moveTo(9.97f, 4.68f)
                ...
                curveTo(10.75f, 22.47f, 10.67f, 22.67f, 10.67f, 22.9f)
                close()
                moveTo(11.1f, 19.3f)
                curveToRelative(0.0f, 0.23f, 0.08f, 0.42f, 0.24f, 0.58f)
                ...
                curveToRelative(-0.16f, -0.16f, -0.35f, -0.23f, -0.59f, -0.23f)
                curveToRelative(-0.24f, 0.0f, -0.44f, 0.08f, -0.6f, 0.24f)
                reflectiveCurveTo(13.47f, 24.38f, 13.47f, 24.61f)
                close()
...
private var _daySnowWind: ImageVector? = null
