...
public val WeatherIcons.Time10: ImageVector
    get() {
        if (_time10 != null) {
            return _time10!!
        }
        _time10 = Builder(name = "Time10", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.14f, 12.41f)
                curveToRelative(-0.07f, -0.22f, -0.04f, -0.43f, 0.07f, -0.63f)
                curveToRelative(0.11f, -0.2f, 0.28f, -0.33f, 0.51f, -0.4f)
                reflectiveCurveToRelative(0.44f, -0.04f, 0.64f, 0.07f)
                ...
                curveToRelative(0.0f, 0.23f, -0.08f, 0.43f, -0.24f, 0.59f)
                reflectiveCurveToRelative(-0.36f, 0.24f, -0.59f, 0.24f)
                curveToRelative(-0.21f, 0.0f, -0.39f, -0.07f, -0.56f, -0.22f)
                lineToRelative(-3.88f, -2.17f)
                curveTo(10.34f, 12.8f, 10.21f, 12.63f, 10.14f, 12.41f)
                close()
            }
        }
        .build()
...
private var _time10: ImageVector? = null
