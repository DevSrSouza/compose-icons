...
public val WeatherIcons.Time12: ImageVector
    get() {
        if (_time12 != null) {
            return _time12!!
        }
        _time12 = Builder(name = "Time12", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.22f, 0.08f, 0.42f, 0.24f, 0.59f)
                curveToRelative(0.16f, 0.17f, 0.36f, 0.25f, 0.59f, 0.25f)
                curveToRelative(0.22f, 0.0f, 0.42f, -0.08f, 0.59f, -0.25f)
                curveToRelative(0.17f, -0.17f, 0.25f, -0.36f, 0.25f, -0.59f)
...
private var _time12: ImageVector? = null
