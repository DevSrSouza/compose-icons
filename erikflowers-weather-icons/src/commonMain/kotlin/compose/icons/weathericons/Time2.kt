...
public val WeatherIcons.Time2: ImageVector
    get() {
        if (_time2 != null) {
            return _time2!!
        }
        _time2 = Builder(name = "Time2", defaultWidth = 30.0.dp, defaultHeight = 30.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(2.78f, -1.57f)
                curveToRelative(0.2f, -0.12f, 0.41f, -0.15f, 0.63f, -0.09f)
                reflectiveCurveToRelative(0.39f, 0.2f, 0.5f, 0.41f)
                curveToRelative(0.12f, 0.2f, 0.14f, 0.41f, 0.08f, 0.63f)
                reflectiveCurveToRelative(-0.19f, 0.4f, -0.39f, 0.51f)
                lineToRelative(-3.88f, 2.17f)
                curveToRelative(-0.17f, 0.15f, -0.35f, 0.22f, -0.56f, 0.22f)
...
private var _time2: ImageVector? = null
