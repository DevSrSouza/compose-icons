...
public val WeatherIcons.DaySleetStorm: ImageVector
    get() {
        if (_daySleetStorm != null) {
            return _daySleetStorm!!
        }
        _daySleetStorm = Builder(name = "DaySleetStorm", defaultWidth = 30.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.13f, 0.59f)
                curveTo(9.38f, 26.99f, 9.37f, 27.07f, 9.37f, 27.1f)
                close()
                moveTo(9.9f, 4.59f)
                ...
                curveTo(10.24f, 23.77f, 10.16f, 23.97f, 10.16f, 24.2f)
                close()
                moveTo(10.78f, 21.93f)
                ...
                curveTo(10.79f, 21.74f, 10.78f, 21.83f, 10.78f, 21.93f)
                close()
                moveTo(13.54f, 24.08f)
                ...
                curveTo(13.55f, 24.0f, 13.54f, 24.04f, 13.54f, 24.08f)
                close()
                moveTo(14.28f, 21.12f)
                ...
                curveToRelative(-0.16f, -0.16f, -0.35f, -0.23f, -0.59f, -0.23f)
                curveToRelative(-0.24f, 0.0f, -0.43f, 0.08f, -0.59f, 0.23f)
                curveTo(14.36f, 20.69f, 14.28f, 20.88f, 14.28f, 21.12f)
                close()
                moveTo(15.31f, 9.02f)
...
private var _daySleetStorm: ImageVector? = null
