...
public val SolidGroup.BuildingCircleArrowRight: ImageVector
    get() {
        ...
        _buildingCircleArrowRight = Builder(name = "BuildingCircleArrowRight", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 49.5f, 20.4f, 94.2f, 53.3f, 126.2f)
                curveTo(364.5f, 505.1f, 351.1f, 512.0f, 336.0f, 512.0f)
