...
public val SolidGroup.TemperatureThreeQuarters: ImageVector
    get() {
        if (_temperatureThreeQuarters != null) {
            return _temperatureThreeQuarters!!
        }
        _temperatureThreeQuarters = Builder(name = "TemperatureThreeQuarters", defaultWidth =
                320.0.dp, defaultHeight = 512.0.dp, viewportWidth = 320.0f, viewportHeight =
                512.0f).apply {
...
private var _temperatureThreeQuarters: ImageVector? = null
