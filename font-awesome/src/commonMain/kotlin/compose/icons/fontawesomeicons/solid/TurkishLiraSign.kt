...
public val SolidGroup.TurkishLiraSign: ImageVector
    get() {
        ...
        _turkishLiraSign = Builder(name = "TurkishLiraSign", defaultWidth = 448.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.4f, 8.0f)
                curveTo(410.5f, 399.8f, 326.1f, 480.0f, 223.8f, 480.0f)
