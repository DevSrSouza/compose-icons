...
public val SolidGroup.Sitemap: ImageVector
    get() {
        ...
        _sitemap = Builder(name = "Sitemap", defaultWidth = 640.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -21.17f, -17.23f, -38.41f, -38.41f, -38.41f)
                ...
                horizontalLineToRelative(40.0f)
                verticalLineToRelative(64.0f)
                lineTo(94.41f, 224.0f)
                curveTo(73.23f, 224.0f, 56.0f, 241.23f, 56.0f, 262.41f)
                lineTo(56.0f, 320.0f)
                horizontalLineToRelative(48.0f)
                verticalLineToRelative(-48.0f)
                close()
