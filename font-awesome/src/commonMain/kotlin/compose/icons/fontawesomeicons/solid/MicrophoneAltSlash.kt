...
public val SolidGroup.MicrophoneAltSlash: ImageVector
    get() {
        if (_microphoneAltSlash != null) {
            return _microphoneAltSlash!!
        }
        _microphoneAltSlash = Builder(name = "MicrophoneAltSlash", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(488.74f, 312.21f, 496.0f, 284.98f, 496.0f, 256.0f)
