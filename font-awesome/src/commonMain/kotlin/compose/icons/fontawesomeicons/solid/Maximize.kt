...
public val SolidGroup.Maximize: ImageVector
    get() {
        ...
        _maximize = Builder(name = "Maximize", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(0.0f, 302.3f, 0.0f, 312.0f)
                ...
                lineToRelative(40.0f, -40.0f)
                curveToRelative(6.9f, -6.9f, 8.9f, -17.2f, 5.2f, -26.2f)
                reflectiveCurveTo(177.7f, 32.0f, 168.0f, 32.0f)
                close()
            }
        }
        .build()
