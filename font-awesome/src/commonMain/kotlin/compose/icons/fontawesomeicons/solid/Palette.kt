    ...
    get() {
        ...
        _palette = Builder(name = "Palette", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-37.0f, 187.0f, 131.7f, 326.4f, 258.8f, 306.7f)
                ...
                curveToRelative(35.8f, 0.0f, 64.8f, -29.6f, 64.9f, -65.3f)
                curveTo(511.5f, 97.1f, 368.1f, -26.9f, 204.3f, 5.0f)
                close()
                moveTo(96.0f, 320.0f)
