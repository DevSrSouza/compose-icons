...
public val SolidGroup.PersonBreastfeeding: ImageVector
    get() {
        ...
        _personBreastfeeding = Builder(name = "PersonBreastfeeding", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-35.8f, 80.0f, -80.0f, 80.0f)
                close()
                moveTo(468.8f, 382.8f)
                lineTo(405.5f, 462.0f)
