...
public val SolidGroup.GlobeAsia: ImageVector
    get() {
        if (_globeAsia != null) {
            return _globeAsia!!
        }
        _globeAsia = Builder(name = "GlobeAsia", defaultWidth = 496.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-4.24f, 0.0f, -8.31f, 1.69f, -11.31f, 4.69f)
                lineToRelative(-5.66f, 5.66f)
                curveToRelative(-3.12f, 3.12f, -3.12f, 8.19f, 0.0f, 11.31f)
                lineToRelative(5.66f, 5.66f)
                curveToRelative(3.0f, 3.0f, 4.69f, 7.07f, 4.69f, 11.31f)
                lineTo(216.01f, 304.0f)
                curveToRelative(0.0f, 8.84f, -7.16f, 16.0f, -16.0f, 16.0f)
                horizontalLineToRelative(-6.11f)
                curveToRelative(-6.06f, 0.0f, -11.6f, -3.42f, -14.31f, -8.85f)
                lineToRelative(-22.62f, -45.23f)
                curveToRelative(-2.44f, -4.88f, -8.95f, -5.94f, -12.81f, -2.08f)
                lineToRelative(-19.47f, 19.46f)
                curveToRelative(-3.0f, 3.0f, -7.07f, 4.69f, -11.31f, 4.69f)
                lineTo(50.81f, 287.99f)
                curveTo(49.12f, 277.55f, 48.0f, 266.92f, 48.0f, 256.0f)
                curveToRelative(0.0f, -110.28f, 89.72f, -200.0f, 200.0f, -200.0f)
                curveToRelative(21.51f, 0.0f, 42.2f, 3.51f, 61.63f, 9.82f)
                ...
                arcToRelative(8.008f, 8.008f, 0.0f, false, true, -2.34f, -5.66f)
                verticalLineToRelative(-10.2f)
                curveToRelative(0.0f, -3.27f, 1.99f, -6.21f, 5.03f, -7.43f)
                lineToRelative(39.34f, -15.74f)
                curveToRelative(1.98f, -0.79f, 3.86f, -1.82f, 5.59f, -3.05f)
                lineToRelative(23.71f, -16.89f)
                arcToRelative(7.978f, 7.978f, 0.0f, false, true, 4.64f, -1.48f)
                horizontalLineToRelative(12.09f)
                curveToRelative(3.23f, 0.0f, 6.15f, 1.94f, 7.39f, 4.93f)
                lineToRelative(5.35f, 12.85f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.69f, 2.46f)
                horizontalLineToRelative(3.8f)
                curveToRelative(1.78f, 0.0f, 3.35f, -1.18f, 3.84f, -2.88f)
                ...
                curveToRelative(0.0f, 2.12f, 0.84f, 4.16f, 2.34f, 5.66f)
                lineToRelative(11.91f, 11.91f)
                curveToRelative(3.0f, 3.0f, 4.69f, 7.07f, 4.69f, 11.31f)
