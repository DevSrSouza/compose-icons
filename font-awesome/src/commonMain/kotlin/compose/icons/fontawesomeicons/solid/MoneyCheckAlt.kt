...
public val SolidGroup.MoneyCheckAlt: ImageVector
    get() {
        if (_moneyCheckAlt != null) {
            return _moneyCheckAlt!!
        }
        _moneyCheckAlt = Builder(name = "MoneyCheckAlt", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -17.67f, -14.33f, -32.0f, -32.0f, -32.0f)
                close()
                moveTo(176.0f, 327.88f)
                lineTo(176.0f, 344.0f)
