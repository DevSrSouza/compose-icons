...
public val SolidGroup.Expand: ImageVector
    get() {
        if (_expand != null) {
            return _expand!!
        }
        _expand = Builder(name = "Expand", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
