...
public val SolidGroup.StarAndCrescent: ImageVector
    get() {
        ...
        _starAndCrescent = Builder(name = "StarAndCrescent", defaultWidth = 576.0.dp, defaultHeight
                = 512.0.dp, viewportWidth = 576.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(32.0f, 256.0f)
                curveTo(32.0f, 114.6f, 146.6f, 0.0f, 288.0f, 0.0f)
                ...
                curveTo(352.6f, 505.7f, 321.0f, 512.0f, 288.0f, 512.0f)
                curveTo(146.6f, 512.0f, 32.0f, 397.4f, 32.0f, 256.0f)
                close()
                moveTo(407.4f, 137.4f)
