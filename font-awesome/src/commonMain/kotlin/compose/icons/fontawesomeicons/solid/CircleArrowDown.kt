...
public val SolidGroup.CircleArrowDown: ImageVector
    get() {
        if (_circleArrowDown != null) {
            return _circleArrowDown!!
        }
        _circleArrowDown = Builder(name = "CircleArrowDown", defaultWidth = 512.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(0.0f, 214.1f)
                lineToRelative(71.0f, -71.0f)
                curveToRelative(9.4f, -9.4f, 24.6f, -9.4f, 33.9f, 0.0f)
                reflectiveCurveToRelative(9.4f, 24.6f, 0.0f, 33.9f)
                lineTo(273.0f, 409.0f)
                curveToRelative(-9.4f, 9.4f, -24.6f, 9.4f, -33.9f, 0.0f)
                lineTo(127.0f, 297.0f)
                close()
            }
        }
        .build()
