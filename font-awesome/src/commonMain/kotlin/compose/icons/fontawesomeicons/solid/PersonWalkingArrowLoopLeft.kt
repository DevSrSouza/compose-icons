...
public val SolidGroup.PersonWalkingArrowLoopLeft: ImageVector
    get() {
        if (_personWalkingArrowLoopLeft != null) {
            return _personWalkingArrowLoopLeft!!
        }
        _personWalkingArrowLoopLeft = Builder(name = "PersonWalkingArrowLoopLeft", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(441.4f, 454.6f)
                curveToRelative(12.5f, 12.5f, 32.8f, 12.5f, 45.3f, 0.0f)
                reflectiveCurveToRelative(12.5f, -32.8f, 0.0f, -45.3f)
                lineTo(461.3f, 384.0f)
