    ...
    get() {
        ...
        _userNurse = Builder(name = "UserNurse", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(129.1f, 323.2f)
                lineToRelative(83.2f, 88.4f)
                curveToRelative(6.3f, 6.7f, 17.0f, 6.7f, 23.3f, 0.0f)
                lineToRelative(83.2f, -88.4f)
                curveToRelative(73.7f, 14.9f, 129.1f, 80.0f, 129.1f, 158.1f)
                curveToRelative(0.0f, 17.0f, -13.8f, 30.7f, -30.7f, 30.7f)
                lineTo(30.7f, 512.0f)
                curveTo(13.8f, 512.0f, 0.0f, 498.2f, 0.0f, 481.3f)
                curveToRelative(0.0f, -78.1f, 55.5f, -143.2f, 129.1f, -158.1f)
                close()
                moveTo(208.0f, 48.0f)
                lineTo(208.0f, 64.0f)
                lineTo(192.0f, 64.0f)
