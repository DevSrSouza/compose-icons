...
public val SolidGroup.TabletAlt: ImageVector
    get() {
        if (_tabletAlt != null) {
            return _tabletAlt!!
        }
        _tabletAlt = Builder(name = "TabletAlt", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
