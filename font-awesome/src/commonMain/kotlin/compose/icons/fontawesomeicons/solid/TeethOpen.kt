...
public val SolidGroup.TeethOpen: ImageVector
    get() {
        if (_teethOpen != null) {
            return _teethOpen!!
        }
        _teethOpen = Builder(name = "TeethOpen", defaultWidth = 640.0.dp, defaultHeight = 512.0.dp,
