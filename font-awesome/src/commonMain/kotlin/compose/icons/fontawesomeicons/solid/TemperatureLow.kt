...
public val SolidGroup.TemperatureLow: ImageVector
    get() {
        ...
        _temperatureLow = Builder(name = "TemperatureLow", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(96.0f, 96.0f, 0.0f, true, true, 320.0f, 96.0f)
                close()
                moveTo(144.0f, 64.0f)
                curveToRelative(-26.5f, 0.0f, -48.0f, 21.5f, -48.0f, 48.0f)
                verticalLineTo(276.5f)
                curveToRelative(0.0f, 17.3f, -7.1f, 31.9f, -15.3f, 42.5f)
                curveTo(70.2f, 332.6f, 64.0f, 349.5f, 64.0f, 368.0f)
                ...
                close()
                moveTo(32.0f, 112.0f)
                curveTo(32.0f, 50.2f, 82.1f, 0.0f, 144.0f, 0.0f)
                ...
                reflectiveCurveTo(0.0f, 447.5f, 0.0f, 368.0f)
