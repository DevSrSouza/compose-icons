    ...
    get() {
        ...
        _cookieBite = Builder(name = "CookieBite", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(132.22f, 132.22f, 0.0f, false, false, -57.79f, 57.81f)
                lineToRelative(-35.1f, 68.88f)
                arcToRelative(132.65f, 132.65f, 0.0f, false, false, -12.82f, 80.95f)
                lineToRelative(12.08f, 76.27f)
                arcToRelative(132.52f, 132.52f, 0.0f, false, false, 37.16f, 72.96f)
                lineToRelative(54.77f, 54.76f)
                arcToRelative(132.04f, 132.04f, 0.0f, false, false, 72.71f, 37.06f)
                lineToRelative(76.71f, 12.15f)
                curveToRelative(27.51f, 4.36f, 55.7f, -0.11f, 80.53f, -12.76f)
                lineToRelative(69.13f, -35.21f)
                arcToRelative(132.27f, 132.27f, 0.0f, false, false, 57.79f, -57.81f)
                lineToRelative(35.1f, -68.88f)
