    ...
    get() {
        ...
        _recycle = Builder(name = "Recycle", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(55.606f, 356.273f, 70.96f, 384.0f, 96.012f, 384.0f)
                lineTo(148.0f, 384.0f)
                curveToRelative(6.627f, 0.0f, 12.0f, 5.373f, 12.0f, 12.0f)
                verticalLineToRelative(40.0f)
                curveToRelative(0.0f, 6.627f, -5.373f, 12.0f, -12.0f, 12.0f)
                lineTo(96.115f, 448.0f)
                curveToRelative(-75.334f, 0.0f, -121.302f, -83.048f, -81.408f, -146.88f)
                ...
                close()
                moveTo(283.122f, 78.988f)
                lineToRelative(41.289f, 66.076f)
                lineToRelative(-40.74f, 25.457f)
                curveToRelative(-12.051f, 7.528f, -9.0f, 25.953f, 4.879f, 29.158f)
                lineToRelative(110.237f, 25.45f)
                ...
                curveToRelative(-37.521f, -60.033f, -125.209f, -60.171f, -162.816f, 0.0f)
                ...
                lineTo(320.0f, 384.001f)
                lineTo(320.0f, 336.02f)
                curveToRelative(0.0f, -14.213f, -17.242f, -21.383f, -27.313f, -11.313f)
                lineToRelative(-80.0f, 79.981f)
                curveToRelative(-6.249f, 6.248f, -6.249f, 16.379f, 0.0f, 22.627f)
                lineToRelative(80.0f, 79.989f)
                curveTo(302.689f, 517.308f, 320.0f, 510.3f, 320.0f, 495.989f)
                lineTo(320.0f, 448.0f)
                horizontalLineToRelative(95.88f)
                curveToRelative(75.274f, 0.0f, 121.335f, -82.997f, 81.408f, -146.88f)
                close()
            }
        }
        .build()
