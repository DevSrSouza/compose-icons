...
public val SolidGroup.CloudDownloadAlt: ImageVector
    get() {
        if (_cloudDownloadAlt != null) {
            return _cloudDownloadAlt!!
        }
        _cloudDownloadAlt = Builder(name = "CloudDownloadAlt", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(14.2f, 0.0f, 21.4f, 17.2f, 11.3f, 27.3f)
                close()
            }
        }
        .build()
