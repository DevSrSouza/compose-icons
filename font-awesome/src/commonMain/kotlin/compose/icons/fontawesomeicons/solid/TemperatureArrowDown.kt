...
public val SolidGroup.TemperatureArrowDown: ImageVector
    get() {
        if (_temperatureArrowDown != null) {
            return _temperatureArrowDown!!
        }
        _temperatureArrowDown = Builder(name = "TemperatureArrowDown", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(144.0f, 0.0f)
                curveTo(82.1f, 0.0f, 32.0f, 50.1f, 32.0f, 112.0f)
                lineTo(32.0f, 276.4f)
                ...
                curveToRelative(0.0f, -33.2f, -11.3f, -63.8f, -30.1f, -88.1f)
