...
public val SolidGroup.PersonWalkingArrowRight: ImageVector
    get() {
        if (_personWalkingArrowRight != null) {
            return _personWalkingArrowRight!!
        }
        _personWalkingArrowRight = Builder(name = "PersonWalkingArrowRight", defaultWidth =
