...
public val SolidGroup.ArrowDownWideShort: ImageVector
    get() {
        if (_arrowDownWideShort != null) {
            return _arrowDownWideShort!!
        }
        _arrowDownWideShort = Builder(name = "ArrowDownWideShort", defaultWidth = 576.0.dp,
                defaultHeight = 512.0.dp, viewportWidth = 576.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(151.6f, 469.6f)
                curveTo(145.5f, 476.2f, 137.0f, 480.0f, 128.0f, 480.0f)
