...
public val SolidGroup.BuildingCircleCheck: ImageVector
    get() {
        if (_buildingCircleCheck != null) {
            return _buildingCircleCheck!!
        }
        _buildingCircleCheck = Builder(name = "BuildingCircleCheck", defaultWidth = 640.0.dp,
...
private var _buildingCircleCheck: ImageVector? = null
