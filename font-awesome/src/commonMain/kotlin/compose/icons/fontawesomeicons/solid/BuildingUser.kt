...
public val SolidGroup.BuildingUser: ImageVector
    get() {
        if (_buildingUser != null) {
            return _buildingUser!!
        }
        _buildingUser = Builder(name = "BuildingUser", defaultWidth = 640.0.dp, defaultHeight =
