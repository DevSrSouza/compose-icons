...
public val SolidGroup.MoneyBillWheat: ImageVector
    get() {
        if (_moneyBillWheat != null) {
            return _moneyBillWheat!!
        }
        _moneyBillWheat = Builder(name = "MoneyBillWheat", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(56.0f, 64.0f)
                curveTo(42.7f, 64.0f, 32.0f, 53.3f, 32.0f, 40.0f)
                reflectiveCurveToRelative(10.7f, -24.0f, 24.0f, -24.0f)
                close()
                moveTo(24.0f, 88.0f)
                lineTo(136.0f, 88.0f)
                ...
                lineTo(24.0f, 136.0f)
                curveToRelative(-13.3f, 0.0f, -24.0f, -10.7f, -24.0f, -24.0f)
                reflectiveCurveTo(10.7f, 88.0f, 24.0f, 88.0f)
                close()
                moveTo(32.0f, 184.0f)
...
private var _moneyBillWheat: ImageVector? = null
