...
public val SolidGroup.Drum: ImageVector
    get() {
        ...
        _drum = Builder(name = "Drum", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(402.2f, 104.5f)
                curveTo(367.8f, 98.7f, 329.0f, 96.0f, 288.0f, 96.0f)
                curveTo(146.6f, 96.0f, 32.0f, 128.0f, 32.0f, 208.0f)
