...
public val SolidGroup.BookBible: ImageVector
    get() {
        if (_bookBible != null) {
            return _bookBible!!
        }
        _bookBible = Builder(name = "BookBible", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
...
private var _bookBible: ImageVector? = null
