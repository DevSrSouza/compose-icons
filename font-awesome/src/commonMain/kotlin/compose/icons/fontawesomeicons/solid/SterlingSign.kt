...
public val SolidGroup.SterlingSign: ImageVector
    get() {
        ...
        _sterlingSign = Builder(name = "SterlingSign", defaultWidth = 384.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 384.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(144.0f, 160.4f)
                ...
                curveTo(137.5f, 32.0f, 80.0f, 89.5f, 80.0f, 160.4f)
                ...
                reflectiveCurveTo(52.5f, 480.0f, 64.0f, 480.0f)
                horizontalLineTo(320.0f)
                curveToRelative(17.7f, 0.0f, 32.0f, -14.3f, 32.0f, -32.0f)
                reflectiveCurveToRelative(-14.3f, -32.0f, -32.0f, -32.0f)
                horizontalLineTo(120.5f)
                lineToRelative(0.7f, -1.1f)
                curveTo(136.1f, 390.0f, 144.0f, 361.5f, 144.0f, 332.5f)
