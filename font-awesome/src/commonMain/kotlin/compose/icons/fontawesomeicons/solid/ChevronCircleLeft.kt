...
public val SolidGroup.ChevronCircleLeft: ImageVector
    get() {
        if (_chevronCircleLeft != null) {
            return _chevronCircleLeft!!
        }
        _chevronCircleLeft = Builder(name = "ChevronCircleLeft", defaultWidth = 512.0.dp,
