    ...
    get() {
        ...
        _bookDead = Builder(name = "BookDead", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(240.0f, 56.0f)
                curveToRelative(44.2f, 0.0f, 80.0f, 28.7f, 80.0f, 64.0f)
                curveToRelative(0.0f, 20.9f, -12.7f, 39.2f, -32.0f, 50.9f)
                lineTo(288.0f, 184.0f)
                curveToRelative(0.0f, 8.8f, -7.2f, 16.0f, -16.0f, 16.0f)
                horizontalLineToRelative(-64.0f)
                curveToRelative(-8.8f, 0.0f, -16.0f, -7.2f, -16.0f, -16.0f)
                verticalLineToRelative(-13.1f)
                curveToRelative(-19.3f, -11.7f, -32.0f, -30.0f, -32.0f, -50.9f)
