...
public val SolidGroup.Fax: ImageVector
    get() {
        if (_fax != null) {
            return _fax!!
        }
        _fax = Builder(name = "Fax", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(480.0f, 77.25f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, false, -9.38f, -22.63f)
                lineTo(425.37f, 9.37f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 402.75f, 0.0f)
                lineTo(160.0f, 0.0f)
