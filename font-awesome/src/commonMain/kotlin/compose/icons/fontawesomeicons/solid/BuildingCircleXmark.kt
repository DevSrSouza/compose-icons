...
public val SolidGroup.BuildingCircleXmark: ImageVector
    get() {
        if (_buildingCircleXmark != null) {
            return _buildingCircleXmark!!
        }
        _buildingCircleXmark = Builder(name = "BuildingCircleXmark", defaultWidth = 640.0.dp,
...
private var _buildingCircleXmark: ImageVector? = null
