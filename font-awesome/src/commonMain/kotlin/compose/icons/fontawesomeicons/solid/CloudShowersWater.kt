...
public val SolidGroup.CloudShowersWater: ImageVector
    get() {
        if (_cloudShowersWater != null) {
            return _cloudShowersWater!!
        }
        _cloudShowersWater = Builder(name = "CloudShowersWater", defaultWidth = 576.0.dp,
                defaultHeight = 512.0.dp, viewportWidth = 576.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(224.0f, 0.0f)
                curveToRelative(38.6f, 0.0f, 71.9f, 22.8f, 87.2f, 55.7f)
                curveTo(325.7f, 41.1f, 345.8f, 32.0f, 368.0f, 32.0f)
                ...
                close()
                moveTo(140.6f, 292.3f)
                lineToRelative(-48.0f, 80.0f)
                curveToRelative(-6.8f, 11.4f, -21.6f, 15.0f, -32.9f, 8.2f)
                reflectiveCurveToRelative(-15.1f, -21.6f, -8.2f, -32.9f)
                lineToRelative(48.0f, -80.0f)
                curveToRelative(6.8f, -11.4f, 21.6f, -15.1f, 32.9f, -8.2f)
                reflectiveCurveToRelative(15.1f, 21.6f, 8.2f, 32.9f)
                close()
                moveTo(468.4f, 259.4f)
                curveToRelative(11.4f, 6.8f, 15.0f, 21.6f, 8.2f, 32.9f)
                lineToRelative(-48.0f, 80.0f)
                curveToRelative(-6.8f, 11.4f, -21.6f, 15.0f, -32.9f, 8.2f)
