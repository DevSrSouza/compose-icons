...
public val SolidGroup.CircleChevronRight: ImageVector
    get() {
        if (_circleChevronRight != null) {
            return _circleChevronRight!!
        }
        _circleChevronRight = Builder(name = "CircleChevronRight", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(345.0f, 239.0f)
                curveToRelative(9.4f, 9.4f, 9.4f, 24.6f, 0.0f, 33.9f)
                lineTo(241.0f, 377.0f)
                close()
            }
        }
        .build()
