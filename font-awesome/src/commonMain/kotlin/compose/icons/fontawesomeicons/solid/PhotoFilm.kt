...
public val SolidGroup.PhotoFilm: ImageVector
    get() {
        if (_photoFilm != null) {
            return _photoFilm!!
        }
        _photoFilm = Builder(name = "PhotoFilm", defaultWidth = 640.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -35.3f, 28.7f, -64.0f, 64.0f, -64.0f)
                close()
                moveTo(476.0f, 106.7f)
                curveTo(471.5f, 100.0f, 464.0f, 96.0f, 456.0f, 96.0f)
                reflectiveCurveToRelative(-15.5f, 4.0f, -20.0f, 10.7f)
                lineToRelative(-56.0f, 84.0f)
                lineTo(362.7f, 169.0f)
                ...
                lineTo(72.0f, 400.0f)
                close()
                moveTo(408.0f, 416.0f)
                verticalLineToRelative(16.0f)
                curveToRelative(0.0f, 8.8f, 7.2f, 16.0f, 16.0f, 16.0f)
                horizontalLineToRelative(16.0f)
                curveToRelative(8.8f, 0.0f, 16.0f, -7.2f, 16.0f, -16.0f)
                lineTo(456.0f, 416.0f)
                curveToRelative(0.0f, -8.8f, -7.2f, -16.0f, -16.0f, -16.0f)
                lineTo(424.0f, 400.0f)
                curveToRelative(-8.8f, 0.0f, -16.0f, 7.2f, -16.0f, 16.0f)
                close()
            }
        }
...
private var _photoFilm: ImageVector? = null
