    ...
    get() {
        ...
        _snowflake = Builder(name = "Snowflake", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-4.0f, -14.9f)
                curveToRelative(-2.2f, -8.2f, -10.7f, -13.1f, -18.9f, -10.9f)
                lineToRelative(-70.8f, 19.0f)
                lineToRelative(-63.9f, -37.0f)
                ...
                lineToRelative(33.8f, 19.5f)
                lineToRelative(-26.0f, 7.0f)
                curveToRelative(-8.3f, 2.2f, -13.2f, 10.7f, -11.0f, 19.0f)
                lineToRelative(4.0f, 14.9f)
                curveToRelative(2.2f, 8.2f, 10.7f, 13.1f, 18.9f, 10.9f)
                lineToRelative(70.8f, -19.0f)
                lineToRelative(63.8f, 36.9f)
                ...
                curveToRelative(7.4f, 4.3f, 16.8f, 1.7f, 21.1f, -5.7f)
                lineToRelative(15.5f, -26.8f)
                curveToRelative(4.3f, -7.3f, 1.8f, -16.8f, -5.6f, -21.0f)
                close()
            }
        }
        .build()
