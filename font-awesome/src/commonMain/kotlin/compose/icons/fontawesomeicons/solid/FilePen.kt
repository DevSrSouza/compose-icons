    ...
    get() {
        ...
        _filePen = Builder(name = "FilePen", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(384.0f, 285.7f)
                lineToRelative(-86.8f, 86.8f)
                curveToRelative(-10.3f, 10.3f, -17.5f, 23.1f, -21.0f, 37.2f)
                lineToRelative(-18.7f, 74.9f)
                curveToRelative(-2.3f, 9.2f, -1.8f, 18.8f, 1.3f, 27.5f)
                lineTo(64.0f, 512.1f)
