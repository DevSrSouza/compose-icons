...
public val SolidGroup.CircleArrowUp: ImageVector
    get() {
        if (_circleArrowUp != null) {
            return _circleArrowUp!!
        }
        _circleArrowUp = Builder(name = "CircleArrowUp", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(177.9f)
                lineToRelative(-71.0f, 71.0f)
                curveToRelative(-9.4f, 9.4f, -24.6f, 9.4f, -33.9f, 0.0f)
                reflectiveCurveToRelative(-9.4f, -24.6f, 0.0f, -33.9f)
                lineTo(239.0f, 103.0f)
                curveToRelative(9.4f, -9.4f, 24.6f, -9.4f, 33.9f, 0.0f)
                lineTo(385.0f, 215.0f)
                close()
            }
        }
        .build()
