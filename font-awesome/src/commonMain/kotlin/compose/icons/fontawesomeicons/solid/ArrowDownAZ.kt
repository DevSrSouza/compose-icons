...
public val SolidGroup.ArrowDownAZ: ImageVector
    get() {
        if (_arrowDownAZ != null) {
            return _arrowDownAZ!!
        }
        _arrowDownAZ = Builder(name = "ArrowDownAZ", defaultWidth = 576.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 576.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(183.6f, 469.6f)
                curveTo(177.5f, 476.2f, 169.0f, 480.0f, 160.0f, 480.0f)
                ...
                lineTo(460.2f, 224.0f)
                horizontalLineTo(371.8f)
                ...
                lineToRelative(16.0f, -32.0f)
                lineToRelative(64.0f, -128.0f)
                curveTo(392.8f, 38.8f, 403.9f, 32.0f, 416.0f, 32.0f)
                close()
                moveTo(395.8f, 176.0f)
                horizontalLineToRelative(40.4f)
                lineTo(416.0f, 135.6f)
                lineTo(395.8f, 176.0f)
                close()
            }
        }
        .build()
