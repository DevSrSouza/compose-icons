...
public val SolidGroup.ArrowUpFromGroundWater: ImageVector
    get() {
        if (_arrowUpFromGroundWater != null) {
            return _arrowUpFromGroundWater!!
        }
        _arrowUpFromGroundWater = Builder(name = "ArrowUpFromGroundWater", defaultWidth = 576.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(256.0f, 109.3f)
                lineTo(256.0f, 320.0f)
                curveToRelative(0.0f, 17.7f, 14.3f, 32.0f, 32.0f, 32.0f)
                close()
                moveTo(269.5f, 421.9f)
                ...
                curveToRelative(6.3f, 1.5f, 12.1f, 3.8f, 17.5f, 6.9f)
                lineTo(576.1f, 240.0f)
                close()
            }
        }
        .build()
