...
public val SolidGroup.HouseMedicalCircleXmark: ImageVector
    get() {
        if (_houseMedicalCircleXmark != null) {
            return _houseMedicalCircleXmark!!
        }
        _houseMedicalCircleXmark = Builder(name = "HouseMedicalCircleXmark", defaultWidth =
...
private var _houseMedicalCircleXmark: ImageVector? = null
