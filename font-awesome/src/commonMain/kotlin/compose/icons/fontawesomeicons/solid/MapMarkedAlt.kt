...
public val SolidGroup.MapMarkedAlt: ImageVector
    get() {
        if (_mapMarkedAlt != null) {
            return _mapMarkedAlt!!
        }
        _mapMarkedAlt = Builder(name = "MapMarkedAlt", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(32.01f, 32.01f, 0.0f, false, false, 0.0f, 245.66f)
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, false, 576.0f, 426.34f)
