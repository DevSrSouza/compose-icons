...
public val SolidGroup.UsersViewfinder: ImageVector
    get() {
        if (_usersViewfinder != null) {
            return _usersViewfinder!!
        }
        _usersViewfinder = Builder(name = "UsersViewfinder", defaultWidth = 640.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(48.0f, 464.0f)
                close()
                moveTo(504.0f, 464.0f)
                curveToRelative(-13.3f, 0.0f, -24.0f, 10.7f, -24.0f, 24.0f)
                reflectiveCurveToRelative(10.7f, 24.0f, 24.0f, 24.0f)
                lineTo(608.0f, 512.0f)
                curveToRelative(17.7f, 0.0f, 32.0f, -14.3f, 32.0f, -32.0f)
                lineTo(640.0f, 376.0f)
                curveToRelative(0.0f, -13.3f, -10.7f, -24.0f, -24.0f, -24.0f)
                reflectiveCurveToRelative(-24.0f, 10.7f, -24.0f, 24.0f)
                verticalLineToRelative(88.0f)
                lineTo(504.0f, 464.0f)
                close()
            }
        }
        .build()
...
private var _usersViewfinder: ImageVector? = null
