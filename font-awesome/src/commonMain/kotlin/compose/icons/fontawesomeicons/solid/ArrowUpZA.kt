...
public val SolidGroup.ArrowUpZA: ImageVector
    get() {
        if (_arrowUpZA != null) {
            return _arrowUpZA!!
        }
        _arrowUpZA = Builder(name = "ArrowUpZA", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(480.0f, 224.1f)
                curveToRelative(17.7f, 0.0f, 32.0f, -14.3f, 32.0f, -32.0f)
                reflectiveCurveToRelative(-14.3f, -32.0f, -32.0f, -32.0f)
                lineTo(429.3f, 160.1f)
                lineToRelative(73.4f, -73.4f)
                curveToRelative(9.2f, -9.2f, 11.9f, -22.9f, 6.9f, -34.9f)
                reflectiveCurveToRelative(-16.6f, -19.8f, -29.6f, -19.8f)
                lineTo(352.0f, 32.0f)
                ...
                lineToRelative(-16.0f, -32.0f)
                lineToRelative(-64.0f, -128.0f)
                curveTo(439.2f, 262.8f, 428.1f, 256.0f, 416.0f, 256.0f)
                close()
                moveTo(395.8f, 400.0f)
                lineTo(416.0f, 359.6f)
                lineTo(436.2f, 400.0f)
                lineTo(395.8f, 400.0f)
                close()
            }
        }
        .build()
