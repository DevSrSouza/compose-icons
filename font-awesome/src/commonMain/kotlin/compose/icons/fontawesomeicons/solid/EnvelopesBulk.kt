...
public val SolidGroup.EnvelopesBulk: ImageVector
    get() {
        ...
        _envelopesBulk = Builder(name = "EnvelopesBulk", defaultWidth = 576.0.dp, defaultHeight =
