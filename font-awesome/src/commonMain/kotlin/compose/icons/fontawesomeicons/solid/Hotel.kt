...
public val SolidGroup.Hotel: ImageVector
    get() {
        if (_hotel != null) {
            return _hotel!!
        }
        _hotel = Builder(name = "Hotel", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(349.0f, 360.2f)
                curveToRelative(3.3f, 12.8f, -7.8f, 23.8f, -21.0f, 23.8f)
                lineTo(184.0f, 384.0f)
                curveToRelative(-13.3f, 0.0f, -24.3f, -10.9f, -21.0f, -23.8f)
                curveToRelative(10.6f, -41.5f, 48.2f, -72.2f, 93.0f, -72.2f)
                reflectiveCurveToRelative(82.5f, 30.7f, 93.0f, 72.2f)
                close()
            }
        }
        .build()
