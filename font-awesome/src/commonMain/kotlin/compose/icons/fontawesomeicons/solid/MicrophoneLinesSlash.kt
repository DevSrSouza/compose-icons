...
public val SolidGroup.MicrophoneLinesSlash: ImageVector
    get() {
        if (_microphoneLinesSlash != null) {
            return _microphoneLinesSlash!!
        }
        _microphoneLinesSlash = Builder(name = "MicrophoneLinesSlash", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(358.9f)
                lineToRelative(-34.5f, -27.0f)
                curveToRelative(2.9f, -3.1f, 7.0f, -5.0f, 11.6f, -5.0f)
...
private var _microphoneLinesSlash: ImageVector? = null
