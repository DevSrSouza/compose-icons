...
public val SolidGroup.BottleDroplet: ImageVector
    get() {
        ...
        _bottleDroplet = Builder(name = "BottleDroplet", defaultWidth = 256.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 256.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(64.0f, 0.0f)
                curveTo(50.7f, 0.0f, 40.0f, 10.7f, 40.0f, 24.0f)
                ...
                curveTo(21.7f, 174.1f, 0.0f, 212.5f, 0.0f, 256.0f)
                lineTo(0.0f, 448.0f)
                ...
                curveTo(153.9f, 288.9f, 176.0f, 320.2f, 176.0f, 337.0f)
