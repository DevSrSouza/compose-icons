...
public val SolidGroup.FileCircleMinus: ImageVector
    get() {
        if (_fileCircleMinus != null) {
            return _fileCircleMinus!!
        }
        _fileCircleMinus = Builder(name = "FileCircleMinus", defaultWidth = 576.0.dp, defaultHeight
...
private var _fileCircleMinus: ImageVector? = null
