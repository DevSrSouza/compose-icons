...
public val SolidGroup.ArrowsTurnRight: ImageVector
    get() {
        ...
        _arrowsTurnRight = Builder(name = "ArrowsTurnRight", defaultWidth = 512.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(32.0f, 224.0f)
                curveTo(32.0f, 153.3f, 89.3f, 96.0f, 160.0f, 96.0f)
                lineTo(370.7f, 96.0f)
                lineTo(329.4f, 54.6f)
                curveToRelative(-12.5f, -12.5f, -12.5f, -32.8f, 0.0f, -45.3f)
                close()
