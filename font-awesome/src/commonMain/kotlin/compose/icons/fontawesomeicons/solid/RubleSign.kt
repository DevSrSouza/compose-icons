    ...
    get() {
        ...
        _rubleSign = Builder(name = "RubleSign", defaultWidth = 384.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(324.48f, 320.0f, 384.0f, 260.54f, 384.0f, 175.07f)
                reflectiveCurveTo(324.48f, 32.0f, 239.36f, 32.0f)
                lineTo(76.0f, 32.0f)
                curveToRelative(-6.63f, 0.0f, -12.0f, 5.37f, -12.0f, 12.0f)
                verticalLineToRelative(206.63f)
                lineTo(12.0f, 250.63f)
                curveToRelative(-6.63f, 0.0f, -12.0f, 5.37f, -12.0f, 12.0f)
                lineTo(0.0f, 308.0f)
                ...
                curveToRelative(46.72f, 0.0f, 74.88f, 29.11f, 74.88f, 74.32f)
                curveToRelative(0.0f, 45.83f, -28.16f, 75.56f, -76.16f, 75.56f)
                horizontalLineToRelative(-77.44f)
                lineTo(146.56f, 100.75f)
                close()
            }
        }
        .build()
