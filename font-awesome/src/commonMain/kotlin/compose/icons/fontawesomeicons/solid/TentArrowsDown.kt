...
public val SolidGroup.TentArrowsDown: ImageVector
    get() {
        ...
        _tentArrowsDown = Builder(name = "TentArrowsDown", defaultWidth = 576.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 576.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(209.8f, 111.9f)
                curveToRelative(-8.9f, -9.9f, -24.0f, -10.7f, -33.9f, -1.8f)
                lineToRelative(-39.9f, 36.0f)
                lineTo(136.0f, 24.0f)
                curveToRelative(0.0f, -13.3f, -10.7f, -24.0f, -24.0f, -24.0f)
                reflectiveCurveTo(88.0f, 10.7f, 88.0f, 24.0f)
                ...
                close()
                moveTo(561.8f, 111.9f)
                curveToRelative(-8.9f, -9.9f, -24.0f, -10.7f, -33.9f, -1.8f)
                lineToRelative(-39.9f, 36.0f)
                lineTo(488.0f, 24.0f)
                curveToRelative(0.0f, -13.3f, -10.7f, -24.0f, -24.0f, -24.0f)
                reflectiveCurveToRelative(-24.0f, 10.7f, -24.0f, 24.0f)
                lineTo(440.0f, 146.1f)
                lineToRelative(-39.9f, -36.0f)
                curveToRelative(-9.9f, -8.9f, -25.0f, -8.1f, -33.9f, 1.8f)
                reflectiveCurveToRelative(-8.1f, 25.0f, 1.8f, 33.9f)
                lineToRelative(80.0f, 72.0f)
