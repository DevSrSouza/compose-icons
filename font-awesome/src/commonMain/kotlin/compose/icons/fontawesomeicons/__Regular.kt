...
public val RegularGroup.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(Keyboard, QuestionCircle, Frown, WindowMinimize, Map, User, HandScissors,
        FontAwesomeLogoFull, Heart, Angry, Comment, HandPointUp, ListAlt, Comments, HandRock,
        ThumbsDown, FileExcel, FileCode, GrinStars, Copy, Save, CreditCard, Snowflake, GrinAlt,
        IdCard, Laugh, HandLizard, Circle, Edit, Bookmark, Images, GrinBeam, LifeRing,
        GrinBeamSweat, Star, KissBeam, MinusSquare, HandPointer, Flag, Calendar, AddressCard,
        EyeSlash, TimesCircle, Gem, Sun, ChartBar, FileVideo, Clone, ArrowAltCircleRight, Grin,
        WindowRestore, Newspaper, ArrowAltCircleUp, FileWord, PlusSquare, FileImage, Grimace,
        Clipboard, Registered, CaretSquareRight, UserCircle, Tired, GrinTongueWink, ShareSquare,
        Flushed, ObjectUngroup, Compass, CalendarMinus, FolderOpen, WindowClose, EnvelopeOpen,
        FrownOpen, LaughWink, GrinHearts, SadCry, CalendarTimes, HandSpock, CheckSquare,
        ClosedCaptioning, HandPointLeft, SmileWink, MoneyBillAlt, BellSlash, Futbol, GrinWink,
        Surprise, StopCircle, FilePdf, GrinTears, GrinTongueSquint, Hourglass, Handshake, StarHalf,
        Building, Image, ThumbsUp, CalendarCheck, Eye, PlayCircle, HandPeace, FilePowerpoint,
        PauseCircle, CheckCircle, GrinSquint, ArrowAltCircleDown, Square, StickyNote, ObjectGroup,
        SmileBeam, CaretSquareUp, HandPointRight, ArrowAltCircleLeft, MehRollingEyes, TrashAlt, Meh,
        Dizzy, Hospital, Lemon, Bell, LaughBeam, GrinSquintTears, FileAudio, CommentDots, IdBadge,
        Envelope, Moon, HandPaper, Hdd, FileAlt, CaretSquareDown, CommentAlt, CalendarAlt,
        Copyright, SadTear, Folder, DotCircle, LaughSquint, FileArchive, File, Clock, AddressBook,
        Smile, GrinTongue, MehBlank, CaretSquareLeft, Lightbulb, Kiss, WindowMaximize,
        HandPointDown, CalendarPlus, KissWinkHeart, PaperPlane)
    return __AllIcons!!
  }
