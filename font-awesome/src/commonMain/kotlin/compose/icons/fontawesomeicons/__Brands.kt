...
import compose.icons.fontawesomeicons.brands.Bilibili
...
import compose.icons.fontawesomeicons.brands.Bots
...
import compose.icons.fontawesomeicons.brands.Cmplid
...
import compose.icons.fontawesomeicons.brands.Golang
...
import compose.icons.fontawesomeicons.brands.Hashnode
...
import compose.icons.fontawesomeicons.brands.Meta
...
import compose.icons.fontawesomeicons.brands.NfcDirectional
import compose.icons.fontawesomeicons.brands.NfcSymbol
...
import compose.icons.fontawesomeicons.brands.Padlet
...
import compose.icons.fontawesomeicons.brands.Screenpal
...
import compose.icons.fontawesomeicons.brands.Sitrox
...
import compose.icons.fontawesomeicons.brands.SpaceAwesome
...
import compose.icons.fontawesomeicons.brands.SquareBehance
import compose.icons.fontawesomeicons.brands.SquareDribbble
import compose.icons.fontawesomeicons.brands.SquareFacebook
import compose.icons.fontawesomeicons.brands.SquareFontAwesome
import compose.icons.fontawesomeicons.brands.SquareFontAwesomeStroke
import compose.icons.fontawesomeicons.brands.SquareGit
import compose.icons.fontawesomeicons.brands.SquareGithub
import compose.icons.fontawesomeicons.brands.SquareGitlab
import compose.icons.fontawesomeicons.brands.SquareGooglePlus
import compose.icons.fontawesomeicons.brands.SquareHackerNews
import compose.icons.fontawesomeicons.brands.SquareInstagram
import compose.icons.fontawesomeicons.brands.SquareJs
import compose.icons.fontawesomeicons.brands.SquareLastfm
import compose.icons.fontawesomeicons.brands.SquareOdnoklassniki
import compose.icons.fontawesomeicons.brands.SquarePiedPiper
import compose.icons.fontawesomeicons.brands.SquarePinterest
import compose.icons.fontawesomeicons.brands.SquareReddit
import compose.icons.fontawesomeicons.brands.SquareSnapchat
import compose.icons.fontawesomeicons.brands.SquareSteam
import compose.icons.fontawesomeicons.brands.SquareTumblr
import compose.icons.fontawesomeicons.brands.SquareTwitter
import compose.icons.fontawesomeicons.brands.SquareViadeo
import compose.icons.fontawesomeicons.brands.SquareVimeo
import compose.icons.fontawesomeicons.brands.SquareWhatsapp
import compose.icons.fontawesomeicons.brands.SquareXing
import compose.icons.fontawesomeicons.brands.SquareYoutube
...
import compose.icons.fontawesomeicons.brands.Wirsindhandwerk
...
import compose.icons.fontawesomeicons.brands._42Group
...
public val BrandsGroup.AllIcons: ____KtList<ImageVector>
  get() {
    if (__AllIcons != null) {
      return __AllIcons!!
    }
    __AllIcons= listOf(_42Group, _500px, AccessibleIcon, Accusoft, Adn, Adversal, Affiliatetheme,
        Airbnb, Algolia, Alipay, Amazon, AmazonPay, Amilia, Android, Angellist, Angrycreative,
        Angular, Apper, Apple, ApplePay, AppStore, AppStoreIos, Artstation, Asymmetrik, Atlassian,
        Audible, Autoprefixer, Avianex, Aviato, Aws, Bandcamp, BattleNet, Behance, Bilibili,
        Bimobject, Bitbucket, Bitcoin, Bity, Blackberry, BlackTie, Blogger, BloggerB, Bluetooth,
        BluetoothB, Bootstrap, Bots, Btc, Buffer, Buromobelexperte, Buysellads, BuyNLarge,
        CanadianMapleLeaf, CcAmazonPay, CcAmex, CcApplePay, CcDinersClub, CcDiscover, CcJcb,
        CcMastercard, CcPaypal, CcStripe, CcVisa, Centercode, Centos, Chrome, Chromecast,
        Cloudflare, Cloudscale, Cloudsmith, Cloudversify, Cmplid, Codepen, Codiepie, Confluence,
        ...
        CreativeCommonsZero, CriticalRole, Css3, Css3Alt, Cuttlefish, Dailymotion, Dashcube, Deezer,
        Delicious, Deploydog, Deskpro, Dev, Deviantart, Dhl, Diaspora, Digg, DigitalOcean, Discord,
        Discourse, Dochub, Docker, Draft2digital, Dribbble, Dropbox, Drupal, Dyalog, DAndD,
        DAndDBeyond, Earlybirds, Ebay, Edge, EdgeLegacy, Elementor, Ello, Ember, Empire, Envira,
        Erlang, Ethereum, Etsy, Evernote, Expeditedssl, Facebook, FacebookF, FacebookMessenger,
        FantasyFlightGames, Fedex, Fedora, Figma, Firefox, FirefoxBrowser, Firstdraft, FirstOrder,
        FirstOrderAlt, Flickr, Flipboard, Fly, Fonticons, FonticonsFi, FontAwesome, FortAwesome,
        FortAwesomeAlt, Forumbee, Foursquare, Freebsd, FreeCodeCamp, Fulcrum, GalacticRepublic,
        GalacticSenate, GetPocket, Gg, GgCircle, Git, Github, GithubAlt, Gitkraken, Gitlab, Gitter,
        GitAlt, Glide, GlideG, Gofore, Golang, Goodreads, GoodreadsG, Google, GoogleDrive,
        GooglePay, GooglePlay, GooglePlus, GooglePlusG, GoogleWallet, Gratipay, Grav, Gripfire,
        Grunt, Guilded, Gulp, Hackerrank, HackerNews, Hashnode, Hips, HireAHelper, Hive, Hooli,
        Hornbill, Hotjar, Houzz, Html5, Hubspot, Ideal, Imdb, Instagram, Instalod, Intercom,
        InternetExplorer, Invision, Ioxhost, ItchIo, Itunes, ItunesNote, Java, JediOrder, Jenkins,
        Jira, Joget, Joomla, Js, Jsfiddle, Kaggle, Keybase, Keycdn, Kickstarter, KickstarterK,
        Korvue, Laravel, Lastfm, Leanpub, Less, Line, Linkedin, LinkedinIn, Linode, Linux, Lyft,
        Magento, Mailchimp, Mandalorian, Markdown, Mastodon, Maxcdn, Mdb, Medapps, Medium, Medrt,
        Meetup, Megaport, Mendeley, Meta, Microblog, Microsoft, Mix, Mixcloud, Mixer, Mizuni, Modx,
        Monero, Napster, Neos, NfcDirectional, NfcSymbol, Nimblr, Node, NodeJs, Npm, Ns8,
        Nutritionix, OctopusDeploy, Odnoklassniki, OldRepublic, Opencart, Openid, Opera,
        OptinMonster, Orcid, Osi, Padlet, Page4, Pagelines, Palfed, Patreon, Paypal, Perbyte,
        Periscope, Phabricator, PhoenixFramework, PhoenixSquadron, Php, PiedPiper, PiedPiperAlt,
        PiedPiperHat, PiedPiperPp, Pinterest, PinterestP, Pix, Playstation, ProductHunt, Pushed,
        Python, Qq, Quinscape, Quora, RaspberryPi, Ravelry, React, Reacteurope, Readme, Rebel,
        Reddit, RedditAlien, Redhat, RedRiver, Renren, Replyd, Researchgate, Resolving, Rev,
        Rocketchat, Rockrms, Rust, RProject, Safari, Salesforce, Sass, Schlix, Screenpal, Scribd,
        Searchengin, Sellcast, Sellsy, Servicestack, Shirtsinbulk, Shopify, Shopware, Simplybuilt,
        Sistrix, Sith, Sitrox, Sketch, Skyatlas, Skype, Slack, Slideshare, Snapchat, Soundcloud,
        Sourcetree, SpaceAwesome, Speakap, SpeakerDeck, Spotify, Squarespace, SquareBehance,
        ...
        SquareLastfm, SquareOdnoklassniki, SquarePiedPiper, SquarePinterest, SquareReddit,
        SquareSnapchat, SquareSteam, SquareTumblr, SquareTwitter, SquareViadeo, SquareVimeo,
        SquareWhatsapp, SquareXing, SquareYoutube, Stackpath, StackExchange, StackOverflow,
        Staylinked, Steam, SteamSymbol, StickerMule, Strava, Stripe, StripeS, Studiovinari,
        Stumbleupon, StumbleuponCircle, Superpowers, Supple, Suse, Swift, Symfony, Teamspeak,
        Telegram, TencentWeibo, Themeco, Themeisle, TheRedYeti, ThinkPeaks, Tiktok, TradeFederation,
        Trello, Tumblr, Twitch, Twitter, Typo3, Uber, Ubuntu, Uikit, Umbraco, Uncharted,
        Uniregistry, Unity, Unsplash, Untappd, Ups, Usb, Usps, Ussunnah, Vaadin, Viacoin, Viadeo,
        Viber, Vimeo, VimeoV, Vine, Vk, Vnv, Vuejs, WatchmanMonitoring, Waze, Weebly, Weibo, Weixin,
        Whatsapp, Whmcs, WikipediaW, Windows, Wirsindhandwerk, Wix, WizardsOfTheCoast, Wodu,
        WolfPackBattalion, Wordpress, WordpressSimple, Wpbeginner, Wpexplorer, Wpforms, Wpressr,
        Xbox, Xing, Yahoo, Yammer, Yandex, YandexInternational, Yarn, Yelp, Yoast, Youtube,
        YCombinator, Zhihu)
    return __AllIcons!!
  }
