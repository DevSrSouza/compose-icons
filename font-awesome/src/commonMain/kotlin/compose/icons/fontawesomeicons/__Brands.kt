...
public val BrandsGroup.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(AccessibleIcon, WhatsappSquare, GitAlt, GooglePay, Deviantart, CriticalRole,
        Css3, Blackberry, Cloudflare, Steam, Elementor, CcMastercard, Studiovinari, Trello,
        Cloudsmith, Erlang, Atlassian, Neos, Dyalog, Wpforms, Gitkraken, Drupal, Expeditedssl,
        Bootstrap, Houzz, FontAwesomeLogoFull, Periscope, Amazon, Buromobelexperte, Amilia, Ideal,
        GoogleDrive, Uikit, Ns8, Forumbee, PinterestP, BehanceSquare, GooglePlay, Deploydog, Alipay,
        Bandcamp, VimeoV, HackerNewsSquare, FontAwesomeFlag, Vimeo, TradeFederation, Youtube, Etsy,
        CreativeCommonsNc, Accusoft, GgCircle, Instagram, Sass, TheRedYeti, Rev, Mandalorian,
        FreeCodeCamp, Telegram, StumbleuponCircle, Zhihu, VimeoSquare, TelegramPlane, Dev, Hips,
        Gulp, Invision, Asymmetrik, Buysellads, Osi, AmazonPay, Yammer, FacebookF, Linkedin, Docker,
        Viadeo, Strava, WolfPackBattalion, Opencart, BluetoothB, Vnv, Fly, Facebook, PennyArcade,
        Stackpath, Imdb, SnapchatGhost, Redhat, Magento, Vine, KickstarterK, Dailymotion, Android,
        Typo3, Squarespace, GitSquare, AppStoreIos, FacebookSquare, Wpexplorer, Monero, Hooli,
        Bimobject, Flipboard, Sellsy, FortAwesomeAlt, Wodu, Shopify, Weebly, Ioxhost, SteamSymbol,
        Airbnb, Meetup, GithubAlt, Hotjar, Firstdraft, CcVisa, JsSquare, Ethereum, Mix, JediOrder,
        Discourse, Resolving, Sith, Fedex, StickerMule, Vaadin, Snapchat, CreativeCommonsNcJp,
        GoodreadsG, Mixer, Linux, Behance, Tripadvisor, Artstation, Dropbox, Weibo, Opera,
        Angrycreative, Fonticons, Windows, Node, Pagelines, Java, Grav, Lastfm, Salesforce,
        ViadeoSquare, Tumblr, CreativeCommons, Rockrms, DAndDBeyond, CcPaypal, CreativeCommonsZero,
        Openid, Codiepie, Usps, Ravelry, StackOverflow, _500px, Twitter, PiedPiperHat, Twitch,
        StackExchange, Centercode, Uncharted, Ubuntu, WizardsOfTheCoast, Slideshare, Whatsapp,
        BlackTie, WatchmanMonitoring, GalacticRepublic, Replyd, Paypal, Flickr, Joomla, Confluence,
        OldRepublic, PiedPiperSquare, XingSquare, RaspberryPi, BuyNLarge, Staylinked, Empire,
        FirstOrderAlt, Ebay, FontAwesomeAlt, Teamspeak, CcDinersClub, Foursquare, Markdown,
        Diaspora, PiedPiper, Ember, Vk, Viber, Keybase, Wpbeginner, Firefox, Github, Symfony, Orcid,
        Hive, Freebsd, Fulcrum, CreativeCommonsPd, Renren, TwitterSquare, Jsfiddle, Themeisle,
        GithubSquare, Yelp, Tiktok, Hubspot, WordpressSimple, Blogger, CottonBureau, Glide,
        TencentWeibo, CreativeCommonsSamplingPlus, Line, Chrome, Codepen, Usb, Digg, Mastodon,
        InternetExplorer, Stumbleupon, Mixcloud, Contao, SlackHash, Ello, Bity, Delicious, Yandex,
        Supple, Yoast, Html5, RedRiver, CreativeCommonsPdAlt, Kaggle, RedditSquare, Adversal,
        Hackerrank, OptinMonster, DribbbleSquare, Adn, Apple, Shopware, Themeco, Autoprefixer,
        Chromecast, Jenkins, Wordpress, Itunes, Dribbble, Skyatlas, Css3Alt, Page4, Odnoklassniki,
        Linode, OctopusDeploy, Intercom, CreativeCommonsNcEu, Ups, Umbraco, Git, FantasyFlightGames,
        Quora, Vuejs, PhoenixFramework, YCombinator, CreativeCommonsBy, Yahoo, Xing, GooglePlusG,
        Edge, ProductHunt, Js, Innosoft, ApplePay, Schlix, MediumM, Microblog, Skype, AppStore,
        Pushed, Aws, Yarn, Spotify, Medium, Slack, Algolia, LinkedinIn, Hornbill,
        CreativeCommonsRemix, HackerNews, Searchengin, Unsplash, Quinscape, Reacteurope, Medapps,
        GalacticSenate, Centos, PiedPiperAlt, Mailchimp, Evernote, FirefoxBrowser, Buffer, Bitcoin,
        Dhl, DigitalOcean, Gitter, Speakap, React, Wpressr, Megaport, BattleNet, Apper, Korvue,
        CreativeCommonsNd, Wix, Goodreads, Discord, Reddit, GetPocket, DAndD, Phabricator, Guilded,
        Cloudversify, Modx, Draft2digital, NodeJs, CcStripe, Soundcloud, Instalod, PinterestSquare,
        CcApplePay, FortAwesome, GoogleWallet, Gitlab, Keycdn, YandexInternational, Maxcdn, Rebel,
        Sellcast, CcJcb, Stripe, Rocketchat, Gg, Scribd, StripeS, Shirtsinbulk, Playstation,
        Perbyte, FacebookMessenger, Figma, TumblrSquare, HireAHelper, CanadianMapleLeaf, Npm, Btc,
        WikipediaW, OdnoklassnikiSquare, FontAwesome, BloggerB, Xbox, Grunt, ThinkPeaks,
        FonticonsFi, PhoenixSquadron, Qq, Patreon, Uber, Audible, Leanpub, ItunesNote,
        YoutubeSquare, Servicestack, Viacoin, Untappd, Palfed, Angellist, Nutritionix, CcAmazonPay,
        Aviato, Angular, Unity, SteamSquare, CreativeCommonsSampling, Whmcs, Gratipay, Pinterest,
        Waze, AcquisitionsIncorporated, GlideG, CreativeCommonsShare, Jira, Medrt, Sketch,
        InstagramSquare, RedditAlien, CreativeCommonsSa, GooglePlusSquare, Uniregistry, CcAmex,
        Cuttlefish, Earlybirds, Nimblr, Napster, Python, Safari, Mendeley, Gofore, Joget,
        FirstOrder, Gripfire, Cpanel, Swift, Google, LastfmSquare, RProject, CcDiscover, Bluetooth,
        Fedora, Less, Deskpro, Kickstarter, Envira, Avianex, Deezer, Connectdevelop, Microsoft,
        Lyft, Dashcube, Laravel, Ussunnah, Readme, PiedPiperPp, Bitbucket, SpeakerDeck, Superpowers,
        Sistrix, EdgeLegacy, Mizuni, Cloudscale, ItchIo, Weixin, GooglePlus, Suse, SnapchatSquare,
        Mdb, Sourcetree, Researchgate, Simplybuilt, Affiliatetheme, Rust, Php, Dochub)
    return __AllIcons!!
  }
