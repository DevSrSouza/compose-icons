...
public val BrandsGroup.JsSquare: ImageVector
    get() {
        if (_jsSquare != null) {
            return _jsSquare!!
        }
        _jsSquare = Builder(name = "JsSquare", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
