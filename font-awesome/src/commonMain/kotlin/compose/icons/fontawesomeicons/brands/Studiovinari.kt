...
public val BrandsGroup.Studiovinari: ImageVector
    get() {
        if (_studiovinari != null) {
            return _studiovinari!!
        }
        _studiovinari = Builder(name = "Studiovinari", defaultWidth = 512.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(480.3f, 187.7f)
                lineToRelative(4.2f, 28.0f)
                ...
                lineToRelative(-166.0f, -122.9f)
                lineTo(133.5f, 108.0f)
                lineTo(32.2f, 0.0f)
                lineToRelative(252.9f, 126.6f)
                lineToRelative(-31.5f, -38.0f)
                lineTo(378.0f, 163.0f)
                lineTo(234.7f, 64.0f)
                lineToRelative(18.7f, 38.4f)
                lineToRelative(-49.6f, -18.1f)
                lineTo(158.3f, 0.0f)
                lineToRelative(194.6f, 122.0f)
                lineTo(310.0f, 66.2f)
                lineToRelative(108.0f, 96.4f)
                lineToRelative(12.0f, -8.9f)
                lineToRelative(-21.0f, -16.4f)
                lineToRelative(4.2f, -37.8f)
                lineTo(451.0f, 89.1f)
                lineToRelative(29.2f, 24.7f)
                lineToRelative(11.5f, 4.2f)
                lineToRelative(-7.0f, 6.2f)
                lineToRelative(8.5f, 12.0f)
