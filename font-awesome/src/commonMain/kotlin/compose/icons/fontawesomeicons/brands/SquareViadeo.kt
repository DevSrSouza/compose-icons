...
public val BrandsGroup.SquareViadeo: ImageVector
    get() {
        if (_squareViadeo != null) {
            return _squareViadeo!!
        }
        _squareViadeo = Builder(name = "SquareViadeo", defaultWidth = 448.0.dp, defaultHeight =
...
private var _squareViadeo: ImageVector? = null
