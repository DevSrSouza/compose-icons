...
public val BrandsGroup.Staylinked: ImageVector
    get() {
        if (_staylinked != null) {
            return _staylinked!!
        }
        _staylinked = Builder(name = "Staylinked", defaultWidth = 440.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(4.1f, -3.2f, 10.4f, -3.0f, 14.0f, 0.5f)
                lineToRelative(84.0f, 81.3f)
                ...
                curveToRelative(3.7f, 3.5f, 10.1f, 3.7f, 14.3f, 0.4f)
                lineToRelative(50.2f, -38.8f)
                lineToRelative(-0.3f, -0.3f)
                lineToRelative(7.7f, -6.0f)
                curveToRelative(4.2f, -3.2f, 4.6f, -8.7f, 0.9f, -12.2f)
                lineToRelative(-57.1f, -54.4f)
                ...
                lineToRelative(160.4f, 159.0f)
                curveToRelative(3.7f, 3.5f, 10.0f, 3.7f, 14.1f, 0.5f)
                lineToRelative(45.8f, -35.8f)
                curveToRelative(4.1f, -3.2f, 4.4f, -8.7f, 0.7f, -12.2f)
                close()
            }
        }
        .build()
