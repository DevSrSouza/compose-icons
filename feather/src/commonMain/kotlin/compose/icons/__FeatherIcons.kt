...
public val FeatherIcons.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(MoreHorizontal, Activity, Slash, Frown, LogIn, Database, Volume, Trello, Map,
        Upload, User, ArrowDown, HelpCircle, Underline, Pocket, Heart, ArrowUpLeft, Disc,
        PlusCircle, Maximize2, Octagon, RotateCcw, Move, Wifi, Umbrella, FilePlus, Sliders,
        Thermometer, Youtube, Share, Instagram, XOctagon, Tool, ZapOff, Book, Hexagon, CloudOff,
        Package, Video, UserMinus, PhoneForwarded, Shield, Power, ThumbsDown, ChevronUp, GitBranch,
        CloudSnow, DownloadCloud, Linkedin, CornerUpLeft, ArrowDownCircle, Trash2, Link, Copy, Save,
        Minimize2, ShieldOff, CreditCard, Facebook, Plus, DollarSign, FolderMinus, Trash,
        Navigation, FastForward, ArrowRightCircle, BellOff, Minimize, UserPlus, EyeOff,
        PhoneOutgoing, Circle, Airplay, Edit, Bookmark, Italic, FolderPlus, Star, Unlock, Cast,
        Sunset, ToggleRight, TrendingDown, Maximize, ZoomOut, DivideSquare, Cloud, Filter,
        TrendingUp, MinusSquare, Award, Speaker, Flag, Calendar, VideoOff, Menu, Download,
        ChevronLeft, Feather, Twitter, Link2, Settings, Twitch, FileText, Sun, Mic, Volume2, Anchor,
        ArrowRight, Tv, Grid, Server, BarChart, Monitor, Divide, ChevronsUp, Delete, Rewind,
        PhoneMissed, Sunrise, Zap, PlusSquare, SkipForward, Clipboard, Bold, Github, Volume1, Inbox,
        Scissors, Target, CornerDownLeft, AlignRight, MessageCircle, Paperclip, Compass,
        AlignJustify, RefreshCcw, GitCommit, AlertOctagon, Tablet, PenTool, XSquare, Share2,
        MessageSquare, MapPin, PieChart, Chrome, Codepen, GitPullRequest, Watch, FileMinus, Info,
        CornerDownRight, Users, PhoneCall, ChevronDown, Film, Terminal, GitMerge, Triangle,
        Dribbble, Command, AlignCenter, MinusCircle, Layout, CheckSquare, Rss, ShoppingBag,
        DivideCircle, BarChart2, Pause, Type, Cpu, AlertCircle, CornerLeftUp, Key, Globe,
        StopCircle, ShoppingCart, ArrowUpRight, Repeat, Battery, Slack, ZoomIn, Lock,
        CornerLeftDown, Crop, ChevronsLeft, VolumeX, MicOff, Music, PhoneIncoming, Image, ThumbsUp,
        CameraOff, Loader, WifiOff, CloudLightning, Columns, ArrowLeftCircle, Smartphone, Percent,
        Eye, AtSign, CornerRightDown, RefreshCw, PlayCircle, Phone, PauseCircle, CheckCircle,
        Gitlab, ExternalLink, BatteryCharging, Square, LogOut, ArrowUpCircle, List, Aperture,
        Briefcase, ChevronRight, Figma, UserCheck, Gift, Sidebar, LifeBuoy, Archive, CloudDrizzle,
        RotateCw, Meh, Bell, Code, Tag, ToggleLeft, Camera, AlertTriangle, XCircle, Headphones,
        Moon, Play, AlignLeft, Edit3, ArrowUp, Search, CloudRain, MousePointer, X, Folder, Printer,
        Navigation2, Crosshair, Voicemail, ArrowLeft, BookOpen, File, Shuffle, Clock, Droplet,
        CornerUpRight, ArrowDownLeft, Codesandbox, Smile, Layers, Bluetooth, MoreVertical,
        HardDrive, Check, Minus, ChevronsDown, Truck, UserX, Radio, CornerRightUp, ArrowDownRight,
        Coffee, Wind, UploadCloud, Box, Home, Edit2, Framer, Hash, Send, Mail, ChevronsRight,
        SkipBack, PhoneOff)
    return __AllIcons!!
  }
