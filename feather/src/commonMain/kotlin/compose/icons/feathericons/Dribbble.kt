...
public val FeatherIcons.Dribbble: VectorAsset
    get() {
        if (_dribbble != null) {
            return _dribbble!!
        }
        _dribbble = VectorAssetBuilder(name = "Dribbble", defaultWidth = 24.0.dp, defaultHeight =
...
private var _dribbble: VectorAsset? = null
