...
public val FeatherIcons.PhoneCall: VectorAsset
    get() {
        if (_phoneCall != null) {
            return _phoneCall!!
        }
        _phoneCall = VectorAssetBuilder(name = "PhoneCall", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.05f, 5.0f)
                arcTo(5.0f, 5.0f, 0.0f, false, true, 19.0f, 8.95f)
                moveTo(15.05f, 1.0f)
                arcTo(9.0f, 9.0f, 0.0f, false, true, 23.0f, 8.94f)
                moveToRelative(-1.0f, 7.98f)
...
private var _phoneCall: VectorAsset? = null
