...
public val FeatherIcons.Tablet: VectorAsset
    get() {
        if (_tablet != null) {
            return _tablet!!
        }
        _tablet = VectorAssetBuilder(name = "Tablet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _tablet: VectorAsset? = null
