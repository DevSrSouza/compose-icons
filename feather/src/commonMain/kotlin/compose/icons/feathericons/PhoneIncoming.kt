...
public val FeatherIcons.PhoneIncoming: VectorAsset
    get() {
        if (_phoneIncoming != null) {
            return _phoneIncoming!!
        }
        _phoneIncoming = VectorAssetBuilder(name = "PhoneIncoming", defaultWidth = 24.0.dp,
...
private var _phoneIncoming: VectorAsset? = null
