...
public val FeatherIcons.Calendar: VectorAsset
    get() {
        if (_calendar != null) {
            return _calendar!!
        }
        _calendar = VectorAssetBuilder(name = "Calendar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _calendar: VectorAsset? = null
