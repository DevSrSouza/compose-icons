...
public val FeatherIcons.Package: VectorAsset
    get() {
        if (_package != null) {
            return _package!!
        }
        _package = VectorAssetBuilder(name = "Package", defaultWidth = 24.0.dp, defaultHeight =
...
private var _package: VectorAsset? = null
