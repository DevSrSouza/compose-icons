...
public val FeatherIcons.EyeOff: VectorAsset
    get() {
        if (_eyeOff != null) {
            return _eyeOff!!
        }
        _eyeOff = VectorAssetBuilder(name = "EyeOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _eyeOff: VectorAsset? = null
