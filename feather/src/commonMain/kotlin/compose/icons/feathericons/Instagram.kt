...
public val FeatherIcons.Instagram: VectorAsset
    get() {
        if (_instagram != null) {
            return _instagram!!
        }
        _instagram = VectorAssetBuilder(name = "Instagram", defaultWidth = 24.0.dp, defaultHeight =
...
private var _instagram: VectorAsset? = null
