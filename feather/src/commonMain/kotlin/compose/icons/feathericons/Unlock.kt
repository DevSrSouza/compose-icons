...
public val FeatherIcons.Unlock: VectorAsset
    get() {
        if (_unlock != null) {
            return _unlock!!
        }
        _unlock = VectorAssetBuilder(name = "Unlock", defaultWidth = 24.0.dp, defaultHeight =
...
private var _unlock: VectorAsset? = null
