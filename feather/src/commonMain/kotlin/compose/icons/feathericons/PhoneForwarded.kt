...
public val FeatherIcons.PhoneForwarded: VectorAsset
    get() {
        if (_phoneForwarded != null) {
            return _phoneForwarded!!
        }
        _phoneForwarded = VectorAssetBuilder(name = "PhoneForwarded", defaultWidth = 24.0.dp,
...
private var _phoneForwarded: VectorAsset? = null
