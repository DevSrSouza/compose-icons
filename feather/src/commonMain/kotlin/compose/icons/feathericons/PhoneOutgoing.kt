...
public val FeatherIcons.PhoneOutgoing: VectorAsset
    get() {
        if (_phoneOutgoing != null) {
            return _phoneOutgoing!!
        }
        _phoneOutgoing = VectorAssetBuilder(name = "PhoneOutgoing", defaultWidth = 24.0.dp,
...
private var _phoneOutgoing: VectorAsset? = null
