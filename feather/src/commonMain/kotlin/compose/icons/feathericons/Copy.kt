...
public val FeatherIcons.Copy: VectorAsset
    get() {
        if (_copy != null) {
            return _copy!!
        }
        _copy = VectorAssetBuilder(name = "Copy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _copy: VectorAsset? = null
