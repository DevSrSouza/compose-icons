...
public val FeatherIcons.ThumbsUp: VectorAsset
    get() {
        if (_thumbsUp != null) {
            return _thumbsUp!!
        }
        _thumbsUp = VectorAssetBuilder(name = "ThumbsUp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _thumbsUp: VectorAsset? = null
