...
public val FeatherIcons.ThumbsDown: VectorAsset
    get() {
        if (_thumbsDown != null) {
            return _thumbsDown!!
        }
        _thumbsDown = VectorAssetBuilder(name = "ThumbsDown", defaultWidth = 24.0.dp, defaultHeight
...
private var _thumbsDown: VectorAsset? = null
