...
public val FeatherIcons.Paperclip: VectorAsset
    get() {
        if (_paperclip != null) {
            return _paperclip!!
        }
        _paperclip = VectorAssetBuilder(name = "Paperclip", defaultWidth = 24.0.dp, defaultHeight =
...
private var _paperclip: VectorAsset? = null
