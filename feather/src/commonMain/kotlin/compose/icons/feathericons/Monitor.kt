...
public val FeatherIcons.Monitor: VectorAsset
    get() {
        if (_monitor != null) {
            return _monitor!!
        }
        _monitor = VectorAssetBuilder(name = "Monitor", defaultWidth = 24.0.dp, defaultHeight =
...
private var _monitor: VectorAsset? = null
