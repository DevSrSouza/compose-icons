...
public val FeatherIcons.Hexagon: VectorAsset
    get() {
        if (_hexagon != null) {
            return _hexagon!!
        }
        _hexagon = VectorAssetBuilder(name = "Hexagon", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagon: VectorAsset? = null
