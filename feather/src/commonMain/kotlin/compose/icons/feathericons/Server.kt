...
public val FeatherIcons.Server: VectorAsset
    get() {
        if (_server != null) {
            return _server!!
        }
        _server = VectorAssetBuilder(name = "Server", defaultWidth = 24.0.dp, defaultHeight =
...
private var _server: VectorAsset? = null
