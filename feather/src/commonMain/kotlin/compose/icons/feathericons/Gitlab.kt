...
public val FeatherIcons.Gitlab: VectorAsset
    get() {
        if (_gitlab != null) {
            return _gitlab!!
        }
        _gitlab = VectorAssetBuilder(name = "Gitlab", defaultWidth = 24.0.dp, defaultHeight =
...
private var _gitlab: VectorAsset? = null
