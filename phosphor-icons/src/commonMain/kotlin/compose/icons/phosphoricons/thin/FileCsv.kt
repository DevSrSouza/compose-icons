    ...
    get() {
        ...
        _fileCsv = Builder(name = "FileCsv", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(30.0f, 30.0f, 0.0f, false, false, 127.0f, 163.0f)
                ...
                arcTo(30.0f, 30.0f, 0.0f, false, false, 127.0f, 221.0f)
                curveToRelative(13.3f, 0.0f, 21.0f, -6.2f, 21.0f, -17.0f)
                reflectiveCurveTo(137.3f, 189.9f, 128.6f, 187.7f)
                close()
                moveTo(204.0f, 92.0f)
                lineTo(152.0f, 92.0f)
