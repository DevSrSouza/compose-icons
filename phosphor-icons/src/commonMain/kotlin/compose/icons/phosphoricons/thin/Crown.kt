    ...
    get() {
        ...
        _crown = Builder(name = "Crown", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(164.0f, 162.1f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, 3.6f)
                horizontalLineToRelative(-0.4f)
                arcToRelative(303.4f, 303.4f, 0.0f, false, false, -63.2f, 0.0f)
                arcToRelative(4.1f, 4.1f, 0.0f, false, true, -4.4f, -3.6f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 3.6f, -4.4f)
                arcToRelative(305.1f, 305.1f, 0.0f, false, true, 64.8f, 0.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 164.0f, 162.1f)
                close()
            }
        }
        .build()
