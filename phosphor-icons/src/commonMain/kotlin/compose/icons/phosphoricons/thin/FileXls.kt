    ...
    get() {
        ...
        _fileXls = Builder(name = "FileXls", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 152.0f, 216.0f)
                close()
                moveTo(90.4f, 164.8f)
                ...
                arcTo(4.2f, 4.2f, 0.0f, false, false, 88.0f, 220.0f)
                arcToRelative(4.3f, 4.3f, 0.0f, false, false, 2.4f, -0.8f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.8f, -5.6f)
                lineTo(75.0f, 192.0f)
                lineToRelative(16.2f, -21.6f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 90.4f, 164.8f)
                close()
                moveTo(192.6f, 187.7f)
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.2f, -6.2f)
                arcTo(30.0f, 30.0f, 0.0f, false, false, 191.0f, 163.0f)
                ...
                arcTo(30.0f, 30.0f, 0.0f, false, false, 191.0f, 221.0f)
                curveToRelative(13.3f, 0.0f, 21.0f, -6.2f, 21.0f, -17.0f)
                reflectiveCurveTo(201.3f, 189.9f, 192.6f, 187.7f)
                close()
                moveTo(212.0f, 88.1f)
