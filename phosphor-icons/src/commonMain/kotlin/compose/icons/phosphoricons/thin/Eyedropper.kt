    ...
    get() {
        ...
        _eyedropper = Builder(name = "Eyedropper", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(99.8f, 195.8f)
                arcTo(28.2f, 28.2f, 0.0f, false, true, 72.7f, 203.0f)
                arcToRelative(4.6f, 4.6f, 0.0f, false, false, -2.6f, 0.2f)
                lineTo(46.7f, 213.5f)
                ...
                arcToRelative(28.2f, 28.2f, 0.0f, false, true, 7.2f, -27.1f)
                lineTo(113.4f, 103.0f)
