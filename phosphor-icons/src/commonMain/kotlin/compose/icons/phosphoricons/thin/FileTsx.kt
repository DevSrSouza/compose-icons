    ...
    get() {
        ...
        _fileTsx = Builder(name = "FileTsx", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(211.2f, 170.4f)
                lineTo(195.0f, 192.0f)
                ...
                arcToRelative(4.2f, 4.2f, 0.0f, false, true, -3.2f, -1.6f)
                lineTo(190.0f, 198.7f)
                lineToRelative(-14.8f, 19.7f)
                arcTo(4.2f, 4.2f, 0.0f, false, true, 172.0f, 220.0f)
                arcToRelative(4.3f, 4.3f, 0.0f, false, true, -2.4f, -0.8f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -0.8f, -5.6f)
                lineTo(185.0f, 192.0f)
                lineToRelative(-16.2f, -21.6f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, true, 6.4f, -4.8f)
                lineTo(190.0f, 185.3f)
                lineToRelative(14.8f, -19.7f)
