    ...
    get() {
        ...
        _crown = Builder(name = "Crown", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(166.0f, 162.3f)
                arcToRelative(6.1f, 6.1f, 0.0f, false, true, -6.0f, 5.4f)
                horizontalLineToRelative(-0.6f)
                arcToRelative(313.8f, 313.8f, 0.0f, false, false, -62.8f, 0.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.6f, -5.3f)
                arcToRelative(6.1f, 6.1f, 0.0f, false, true, 5.4f, -6.6f)
                arcToRelative(308.9f, 308.9f, 0.0f, false, true, 65.2f, 0.0f)
                arcTo(6.1f, 6.1f, 0.0f, false, true, 166.0f, 162.3f)
                close()
            }
        }
        .build()
