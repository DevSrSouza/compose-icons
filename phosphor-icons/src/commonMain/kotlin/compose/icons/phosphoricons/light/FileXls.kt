    ...
    get() {
        ...
        _fileXls = Builder(name = "FileXls", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(154.0f, 216.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, 6.0f)
                lineTo(120.0f, 222.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, -6.0f)
                lineTo(114.0f, 168.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 12.0f, 0.0f)
                verticalLineToRelative(42.0f)
                horizontalLineToRelative(22.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 154.0f, 216.0f)
                close()
                moveTo(91.6f, 163.2f)
                arcToRelative(5.9f, 5.9f, 0.0f, false, false, -8.4f, 1.2f)
                lineTo(70.0f, 182.0f)
                lineTo(56.8f, 164.4f)
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, true, false, 9.6f, 7.2f)
                lineTo(70.0f, 202.0f)
                lineToRelative(13.2f, 17.6f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 9.6f, -7.2f)
                lineTo(77.5f, 192.0f)
                lineToRelative(15.3f, -20.4f)
                arcTo(5.9f, 5.9f, 0.0f, false, false, 91.6f, 163.2f)
                close()
                moveTo(193.2f, 185.7f)
                ...
                arcTo(30.0f, 30.0f, 0.0f, false, false, 191.0f, 223.0f)
                curveToRelative(14.4f, 0.0f, 23.0f, -7.1f, 23.0f, -19.0f)
                reflectiveCurveTo(201.5f, 187.9f, 193.2f, 185.7f)
                close()
                moveTo(214.0f, 88.2f)
