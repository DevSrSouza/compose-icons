    ...
    get() {
        ...
        _maskSad = Builder(name = "MaskSad", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, true, 185.9f, 115.5f)
                close()
                moveTo(114.4f, 124.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, true, false, -9.0f, -8.0f)
                ...
                arcToRelative(5.7f, 5.7f, 0.0f, false, false, 5.0f, -2.7f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 157.9f, 179.0f)
                close()
                moveTo(222.0f, 48.3f)
