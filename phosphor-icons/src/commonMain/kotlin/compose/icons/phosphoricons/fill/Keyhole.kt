    ...
    get() {
        ...
        _keyhole = Builder(name = "Keyhole", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(146.4f, 134.2f)
                lineToRelative(12.5f, 29.1f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -11.0f, 16.7f)
                lineTo(108.1f, 180.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -11.0f, -16.7f)
                lineToRelative(12.5f, -29.1f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, -2.9f, -50.1f)
                arcToRelative(32.4f, 32.4f, 0.0f, false, true, 25.0f, -7.9f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, 14.7f, 58.0f)
                close()
