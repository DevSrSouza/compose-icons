    ...
    get() {
        ...
        _angularLogo = Builder(name = "AngularLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-8.4f, 16.9f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.4f, -7.2f)
                lineToRelative(36.0f, -72.0f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, true, 14.4f, 0.0f)
                lineToRelative(36.0f, 72.0f)
                arcTo(8.2f, 8.2f, 0.0f, false, true, 167.6f, 167.2f)
                close()
                moveTo(128.0f, 105.9f)
                lineToRelative(12.4f, 24.8f)
