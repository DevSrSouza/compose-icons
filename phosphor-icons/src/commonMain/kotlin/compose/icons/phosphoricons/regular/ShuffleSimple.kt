    ...
    get() {
        ...
        _shuffleSimple = Builder(name = "ShuffleSimple", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(168.0f, 215.4f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f)
                horizontalLineToRelative(20.7f)
                lineTo(42.3f, 53.7f)
                arcTo(8.1f, 8.1f, 0.0f, false, true, 53.7f, 42.3f)
                lineTo(200.0f, 188.7f)
                ...
                arcTo(7.7f, 7.7f, 0.0f, false, false, 150.6f, 113.4f)
                close()
                moveTo(99.7f, 145.0f)
                lineTo(42.3f, 202.3f)
