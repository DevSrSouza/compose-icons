    ...
    get() {
        ...
        _fileJsx = Builder(name = "FileJsx", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 206.4f, 172.8f)
                close()
                moveTo(72.0f, 160.0f)
