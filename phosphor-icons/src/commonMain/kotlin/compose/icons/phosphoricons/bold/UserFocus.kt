    ...
    get() {
        ...
        _userFocus = Builder(name = "UserFocus", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(166.4f, 175.2f)
                arcToRelative(48.0f, 48.0f, 0.0f, false, false, -76.8f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -16.8f, 2.4f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -2.4f, -16.8f)
                arcToRelative(72.1f, 72.1f, 0.0f, false, true, 23.9f, -20.5f)
                arcToRelative(44.0f, 44.0f, 0.0f, true, true, 67.4f, 0.0f)
                arcToRelative(72.1f, 72.1f, 0.0f, false, true, 23.9f, 20.5f)
                ...
                arcTo(20.1f, 20.1f, 0.0f, false, false, 108.0f, 112.0f)
                close()
            }
        }
        .build()
