    ...
    get() {
        ...
        _numberSquareSix = Builder(name = "NumberSquareSix", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(13.2f, -22.2f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -20.6f, -12.3f)
                lineTo(93.5f, 127.9f)
                lineToRelative(-0.2f, 0.3f)
                arcTo(39.4f, 39.4f, 0.0f, false, false, 88.0f, 148.0f)
                arcTo(40.0f, 40.0f, 0.0f, false, false, 128.0f, 188.0f)
                close()
                moveTo(144.0f, 148.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 144.0f, 148.0f)
                close()
            }
        }
        .build()
