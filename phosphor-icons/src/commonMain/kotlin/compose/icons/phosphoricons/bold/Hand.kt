    ...
    get() {
        ...
        _hand = Builder(name = "Hand", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(180.0f, 36.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, false, -60.8f, -14.0f)
                arcTo(32.1f, 32.1f, 0.0f, false, false, 76.0f, 52.0f)
                verticalLineToRelative(60.5f)
                ...
                lineTo(220.0f, 68.0f)
                arcTo(32.1f, 32.1f, 0.0f, false, false, 188.0f, 36.0f)
                close()
