    ...
    get() {
        ...
        _bezierCurve = Builder(name = "BezierCurve", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(100.7f, 100.7f, 0.0f, false, false, -31.4f, -49.0f)
                lineTo(240.0f, 92.0f)
                ...
                lineTo(63.1f, 92.0f)
                arcToRelative(100.7f, 100.7f, 0.0f, false, false, -31.4f, 49.0f)
                arcTo(35.9f, 35.9f, 0.0f, true, false, 56.0f, 143.7f)
                arcTo(76.7f, 76.7f, 0.0f, false, true, 97.1f, 98.5f)
                arcToRelative(36.0f, 36.0f, 0.0f, false, false, 61.8f, 0.0f)
                arcTo(76.7f, 76.7f, 0.0f, false, true, 200.0f, 143.7f)
                arcToRelative(36.1f, 36.1f, 0.0f, true, false, 24.3f, -2.7f)
                close()
                moveTo(40.0f, 188.0f)
