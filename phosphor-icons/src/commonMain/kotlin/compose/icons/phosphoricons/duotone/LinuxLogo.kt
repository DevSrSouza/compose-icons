    ...
    get() {
        ...
        _linuxLogo = Builder(name = "LinuxLogo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                horizontalLineTo(169.6f)
                arcToRelative(48.1f, 48.1f, 0.0f, false, false, -83.2f, 0.0f)
                horizontalLineTo(32.0f)
                reflectiveCurveTo(64.0f, 160.0f, 64.0f, 96.0f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, true, 128.0f, 0.0f)
                curveTo(192.0f, 160.0f, 224.0f, 216.0f, 224.0f, 216.0f)
                close()
            }
