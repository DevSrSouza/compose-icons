    ...
    get() {
        ...
        _heartStraightBreak = Builder(name = "HeartStraightBreak", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(214.7f, 130.9f)
                lineToRelative(-81.0f, 81.0f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, true, -11.4f, 0.0f)
                lineTo(39.2f, 128.8f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 2.1f, -75.5f)
                curveToRelative(20.9f, -18.8f, 53.6f, -15.9f, 73.6f, 4.0f)
                lineTo(128.0f, 70.5f)
                lineToRelative(15.2f, -15.3f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 75.5f, 2.1f)
                curveTo(237.5f, 78.2f, 234.6f, 110.9f, 214.7f, 130.9f)
                close()
            }
