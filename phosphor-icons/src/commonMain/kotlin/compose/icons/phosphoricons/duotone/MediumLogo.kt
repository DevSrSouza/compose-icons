    ...
    get() {
        ...
        _mediumLogo = Builder(name = "MediumLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 33.1f, -25.1f, 60.0f, -56.0f, 60.0f)
                reflectiveCurveToRelative(-56.0f, -26.9f, -56.0f, -60.0f)
                reflectiveCurveTo(41.1f, 68.0f, 72.0f, 68.0f)
                reflectiveCurveTo(128.0f, 94.9f, 128.0f, 128.0f)
                close()
                moveTo(184.0f, 72.0f)
                curveToRelative(-13.3f, 0.0f, -24.0f, 25.1f, -24.0f, 56.0f)
                reflectiveCurveToRelative(10.7f, 56.0f, 24.0f, 56.0f)
                reflectiveCurveToRelative(24.0f, -25.1f, 24.0f, -56.0f)
                reflectiveCurveTo(197.3f, 72.0f, 184.0f, 72.0f)
                close()
            }
