    ...
    get() {
        ...
        _rainbowCloud = Builder(name = "RainbowCloud", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(-13.3f, 0.0f, -24.0f, -11.1f, -24.0f, -24.9f)
                reflectiveCurveToRelative(10.7f, -24.9f, 24.0f, -24.9f)
                arcToRelative(21.6f, 21.6f, 0.0f, false, true, 8.8f, 1.8f)
                horizontalLineToRelative(0.0f)
                arcTo(40.0f, 40.0f, 0.0f, true, true, 200.0f, 200.0f)
                close()
            }
