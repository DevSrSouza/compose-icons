    ...
    get() {
        ...
        _clockCounterClockwise = Builder(name = "ClockCounterClockwise", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(7.1f, 7.1f, 0.0f, false, false, 4.0f, 1.1f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.0f, -14.9f)
                lineTo(136.0f, 123.4f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(0.3f)
                lineToRelative(0.4f, 0.2f)
                horizontalLineTo(71.8f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f)
                horizontalLineTo(51.1f)
                lineTo(71.4f, 71.4f)
