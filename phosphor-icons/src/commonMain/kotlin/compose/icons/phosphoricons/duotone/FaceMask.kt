    ...
    get() {
        ...
        _faceMask = Builder(name = "FaceMask", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 51.5f, -74.4f, 69.2f, -86.4f, 71.7f)
                arcToRelative(8.6f, 8.6f, 0.0f, false, true, -3.2f, 0.0f)
                curveTo(114.4f, 205.2f, 40.0f, 187.5f, 40.0f, 136.0f)
                verticalLineTo(77.6f)
                arcToRelative(7.9f, 7.9f, 0.0f, false, true, 5.3f, -7.5f)
                lineToRelative(80.0f, -29.1f)
                arcToRelative(8.3f, 8.3f, 0.0f, false, true, 5.4f, 0.0f)
                lineToRelative(80.0f, 29.1f)
                arcToRelative(7.9f, 7.9f, 0.0f, false, true, 5.3f, 7.5f)
                close()
            }
