    ...
    get() {
        ...
        _barbell = Builder(name = "Barbell", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(64.0f, 200.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 56.0f, 192.0f)
                lineTo(56.0f, 64.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 64.0f, 56.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 192.0f, 200.0f)
                lineTo(168.0f, 200.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 192.0f)
                lineTo(160.0f, 64.0f)
