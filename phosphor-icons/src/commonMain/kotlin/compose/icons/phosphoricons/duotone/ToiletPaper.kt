    ...
    get() {
        ...
        _toiletPaper = Builder(name = "ToiletPaper", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 44.2f, -17.9f, 80.0f, -40.0f, 80.0f)
                reflectiveCurveToRelative(-40.0f, -35.8f, -40.0f, -80.0f)
                reflectiveCurveTo(41.9f, 40.0f, 64.0f, 40.0f)
                reflectiveCurveTo(104.0f, 75.8f, 104.0f, 120.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(96.0f, 120.0f)
                curveToRelative(0.0f, -42.4f, -16.9f, -72.0f, -32.0f, -72.0f)
                reflectiveCurveTo(32.0f, 77.6f, 32.0f, 120.0f)
                reflectiveCurveToRelative(16.9f, 72.0f, 32.0f, 72.0f)
                reflectiveCurveTo(96.0f, 162.4f, 96.0f, 120.0f)
                close()
