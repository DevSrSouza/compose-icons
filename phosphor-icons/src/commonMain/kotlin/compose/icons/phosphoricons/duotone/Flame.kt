    ...
    get() {
        ...
        _flame = Builder(name = "Flame", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(128.0f, 24.0f)
                reflectiveCurveTo(48.0f, 72.0f, 48.0f, 144.0f)
                arcToRelative(79.9f, 79.9f, 0.0f, false, false, 77.9f, 79.9f)
                arcTo(39.9f, 39.9f, 0.0f, false, true, 88.0f, 184.0f)
                curveToRelative(0.0f, -40.0f, 40.0f, -64.0f, 40.0f, -64.0f)
                reflectiveCurveToRelative(40.0f, 24.0f, 40.0f, 64.0f)
                arcToRelative(39.9f, 39.9f, 0.0f, false, true, -37.9f, 39.9f)
                arcTo(79.9f, 79.9f, 0.0f, false, false, 208.0f, 144.0f)
                curveTo(208.0f, 72.0f, 128.0f, 24.0f, 128.0f, 24.0f)
                close()
            }
