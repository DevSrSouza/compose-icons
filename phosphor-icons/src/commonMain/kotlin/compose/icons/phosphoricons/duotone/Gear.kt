    ...
    get() {
        ...
        _gear = Builder(name = "Gear", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(211.8f, 133.1f)
                curveToRelative(0.3f, -3.4f, 0.0f, -10.2f, 0.0f, -10.2f)
                lineToRelative(16.6f, -22.1f)
                arcToRelative(103.2f, 103.2f, 0.0f, false, false, -10.2f, -24.6f)
                lineToRelative(-27.3f, -3.9f)
                quadToRelative(-3.5f, -3.7f, -7.2f, -7.2f)
                lineToRelative(-3.9f, -27.3f)
                arcToRelative(102.2f, 102.2f, 0.0f, false, false, -24.6f, -10.2f)
                lineTo(133.1f, 44.2f)
                arcToRelative(57.9f, 57.9f, 0.0f, false, false, -10.2f, 0.0f)
                lineTo(100.8f, 27.6f)
                arcTo(103.2f, 103.2f, 0.0f, false, false, 76.2f, 37.8f)
                lineTo(72.3f, 65.1f)
                quadToRelative(-3.7f, 3.5f, -7.2f, 7.2f)
                lineTo(37.8f, 76.2f)
                arcToRelative(102.2f, 102.2f, 0.0f, false, false, -10.2f, 24.6f)
                lineToRelative(16.6f, 22.1f)
                curveToRelative(-0.3f, 3.4f, 0.0f, 10.2f, 0.0f, 10.2f)
                lineTo(27.6f, 155.2f)
                arcToRelative(103.2f, 103.2f, 0.0f, false, false, 10.2f, 24.6f)
                lineToRelative(27.3f, 3.9f)
                quadToRelative(3.5f, 3.8f, 7.2f, 7.2f)
                lineToRelative(3.9f, 27.3f)
                arcToRelative(102.2f, 102.2f, 0.0f, false, false, 24.6f, 10.2f)
                lineToRelative(22.1f, -16.6f)
                arcToRelative(57.9f, 57.9f, 0.0f, false, false, 10.2f, 0.0f)
                lineToRelative(22.1f, 16.6f)
                arcToRelative(103.2f, 103.2f, 0.0f, false, false, 24.6f, -10.2f)
                lineToRelative(3.9f, -27.3f)
                curveToRelative(2.5f, -2.3f, 7.2f, -7.2f, 7.2f, -7.2f)
                lineToRelative(27.3f, -3.9f)
                arcToRelative(102.2f, 102.2f, 0.0f, false, false, 10.2f, -24.6f)
                close()
