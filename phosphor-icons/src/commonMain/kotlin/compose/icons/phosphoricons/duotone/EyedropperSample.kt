    ...
    get() {
        ...
        _eyedropperSample = Builder(name = "EyedropperSample", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(141.3f, 160.0f)
                lineToRelative(-38.7f, 38.6f)
                arcToRelative(31.7f, 31.7f, 0.0f, false, true, -30.9f, 8.3f)
                lineTo(48.3f, 217.1f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.8f, -1.6f)
                arcToRelative(5.7f, 5.7f, 0.0f, false, true, -1.2f, -6.4f)
                lineToRelative(10.8f, -24.8f)
                arcTo(31.9f, 31.9f, 0.0f, false, true, 52.3f, 160.0f)
                close()
            }
