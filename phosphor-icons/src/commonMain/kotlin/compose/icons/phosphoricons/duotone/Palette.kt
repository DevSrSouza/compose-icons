    ...
    get() {
        ...
        _palette = Builder(name = "Palette", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(224.0f, 127.2f)
                arcToRelative(96.2f, 96.2f, 0.0f, false, true, -2.4f, 22.2f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 198.2f, 168.0f)
                horizontalLineTo(152.0f)
                arcToRelative(23.9f, 23.9f, 0.0f, false, false, -24.0f, 24.0f)
                verticalLineToRelative(3.9f)
                arcToRelative(23.9f, 23.9f, 0.0f, false, true, -32.0f, 22.6f)
                arcTo(96.0f, 96.0f, 0.0f, false, true, 127.0f, 32.0f)
                curveTo(179.8f, 31.5f, 223.6f, 74.3f, 224.0f, 127.2f)
                close()
            }
