    ...
    get() {
        ...
        _books = Builder(name = "Books", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(225.9f, 197.6f)
                lineTo(217.6f, 166.7f)
                lineTo(171.2f, 179.2f)
                lineTo(179.5f, 210.1f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 9.8f, 5.6f)
                lineToRelative(30.9f, -8.3f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 225.9f, 197.6f)
                close()
                moveTo(184.5f, 43.1f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, false, -9.8f, -5.7f)
                lineToRelative(-30.9f, 8.3f)
