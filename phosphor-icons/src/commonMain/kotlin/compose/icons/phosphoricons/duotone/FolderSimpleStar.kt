    ...
    get() {
        ...
        _folderSimpleStar = Builder(name = "FolderSimpleStar", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(209.6f, 183.4f)
                lineToRelative(8.1f, 32.6f)
                lineTo(188.0f, 198.5f)
                lineTo(158.3f, 216.0f)
                lineToRelative(8.1f, -32.6f)
                lineTo(140.0f, 161.6f)
                lineToRelative(34.7f, -2.7f)
                lineTo(188.0f, 128.0f)
                lineToRelative(13.3f, 30.9f)
                lineToRelative(34.7f, 2.7f)
                close()
            }
