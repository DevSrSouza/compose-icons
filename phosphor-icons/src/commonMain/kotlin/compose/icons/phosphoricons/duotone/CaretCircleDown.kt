    ...
    get() {
        ...
        _caretCircleDown = Builder(name = "CaretCircleDown", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(169.4f, 110.1f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.3f, 0.5f)
                lineTo(128.0f, 144.0f)
                lineTo(97.9f, 110.6f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.8f, 10.8f)
                lineToRelative(36.0f, 40.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.8f, 0.0f)
                lineToRelative(36.0f, -40.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 169.4f, 110.1f)
                close()
            }
        }
        .build()
