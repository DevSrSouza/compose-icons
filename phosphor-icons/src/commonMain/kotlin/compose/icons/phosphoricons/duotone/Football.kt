    ...
    get() {
        ...
        _football = Builder(name = "Football", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(219.8f, 107.8f)
                curveToRelative(-2.8f, 25.2f, -12.0f, 53.5f, -35.2f, 76.8f)
                reflectiveCurveTo(133.0f, 217.0f, 107.8f, 219.8f)
                lineTo(36.2f, 148.2f)
                curveTo(39.0f, 123.0f, 48.2f, 94.7f, 71.4f, 71.4f)
                reflectiveCurveTo(123.0f, 39.0f, 148.2f, 36.2f)
