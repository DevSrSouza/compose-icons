    ...
    get() {
        ...
        _eject = Builder(name = "Eject", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(122.1f, 38.4f)
                lineTo(44.4f, 122.6f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 50.3f, 136.0f)
                horizontalLineTo(205.7f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.9f, -13.4f)
                lineTo(133.9f, 38.4f)
                arcTo(7.9f, 7.9f, 0.0f, false, false, 122.1f, 38.4f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
