    ...
    get() {
        ...
        _cloudMoon = Builder(name = "CloudMoon", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(90.3f, 130.4f)
                arcToRelative(67.9f, 67.9f, 0.0f, false, true, 45.5f, -47.3f)
                horizontalLineToRelative(0.1f)
                curveToRelative(0.1f, -1.0f, 0.1f, -2.0f, 0.1f, -3.0f)
                arcTo(64.0f, 64.0f, 0.0f, false, false, 86.4f, 17.6f)
                horizontalLineToRelative(0.0f)
                arcTo(68.3f, 68.3f, 0.0f, false, true, 88.0f, 32.0f)
                arcTo(64.1f, 64.1f, 0.0f, false, true, 24.0f, 96.0f)
                arcTo(68.3f, 68.3f, 0.0f, false, true, 9.6f, 94.4f)
                horizontalLineToRelative(0.0f)
                arcTo(64.1f, 64.1f, 0.0f, false, false, 47.0f, 138.9f)
                horizontalLineToRelative(0.0f)
                arcTo(43.7f, 43.7f, 0.0f, false, true, 76.0f, 128.0f)
                arcToRelative(42.5f, 42.5f, 0.0f, false, true, 14.3f, 2.4f)
                close()
            }
