    ...
    get() {
        ...
        _githubLogo = Builder(name = "GithubLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(48.0f, 48.0f, 0.0f, false, true, -48.0f, -48.0f)
                verticalLineToRelative(-8.0f)
                arcToRelative(49.3f, 49.3f, 0.0f, false, true, 8.5f, -27.3f)
                arcTo(52.0f, 52.0f, 0.0f, false, true, 68.0f, 40.0f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 43.8f, 24.0f)
                horizontalLineToRelative(32.4f)
                arcTo(52.0f, 52.0f, 0.0f, false, true, 188.0f, 40.0f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 3.5f, 44.7f)
                arcTo(49.3f, 49.3f, 0.0f, false, true, 200.0f, 112.0f)
                close()
            }
