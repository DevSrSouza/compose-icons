    ...
    get() {
        ...
        _graduationCap = Builder(name = "GraduationCap", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(220.0f, 110.9f)
                verticalLineToRelative(54.6f)
                arcToRelative(7.8f, 7.8f, 0.0f, false, true, -1.6f, 4.7f)
                curveToRelative(-6.7f, 9.0f, -35.1f, 41.8f, -90.4f, 41.8f)
                reflectiveCurveToRelative(-83.7f, -32.8f, -90.4f, -41.8f)
                arcToRelative(7.8f, 7.8f, 0.0f, false, true, -1.6f, -4.7f)
