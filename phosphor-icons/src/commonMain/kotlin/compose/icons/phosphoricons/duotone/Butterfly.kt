    ...
    get() {
        ...
        _butterfly = Builder(name = "Butterfly", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(-7.8f, 31.1f, -29.0f, 32.8f, -36.9f, 32.4f)
                horizontalLineToRelative(0.0f)
                arcTo(36.0f, 36.0f, 0.0f, true, true, 128.0f, 180.0f)
                arcToRelative(36.0f, 36.0f, 0.0f, true, true, -59.1f, -27.6f)
                horizontalLineToRelative(0.0f)
                curveToRelative(-7.9f, 0.4f, -29.1f, -1.3f, -36.9f, -32.4f)
                reflectiveCurveTo(17.1f, 48.0f, 48.0f, 48.0f)
                reflectiveCurveToRelative(80.0f, 48.0f, 80.0f, 80.0f)
                curveToRelative(0.0f, -32.0f, 49.1f, -80.0f, 80.0f, -80.0f)
                reflectiveCurveTo(232.0f, 88.0f, 224.0f, 120.0f)
                close()
            }
