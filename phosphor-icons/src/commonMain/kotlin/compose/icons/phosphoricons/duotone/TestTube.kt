    ...
    get() {
        ...
        _testTube = Builder(name = "TestTube", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(94.0f, 214.0f)
                arcToRelative(36.7f, 36.7f, 0.0f, false, true, -52.0f, 0.0f)
                horizontalLineToRelative(0.0f)
                arcToRelative(36.7f, 36.7f, 0.0f, false, true, 0.0f, -52.0f)
                lineToRelative(26.0f, -26.0f)
                reflectiveCurveToRelative(20.0f, -16.0f, 52.0f, 0.0f)
                reflectiveCurveTo(172.0f, 136.0f, 172.0f, 136.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(88.3f, 208.3f)
                arcToRelative(28.7f, 28.7f, 0.0f, false, true, -40.6f, -40.6f)
