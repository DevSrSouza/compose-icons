    ...
    get() {
        ...
        _spade = Builder(name = "Spade", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(128.0f, 24.0f)
                reflectiveCurveTo(228.0f, 88.0f, 228.0f, 140.0f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, -85.4f, 39.9f)
                lineTo(160.0f, 232.0f)
                horizontalLineTo(96.0f)
                lineToRelative(17.4f, -52.1f)
                arcTo(52.0f, 52.0f, 0.0f, false, true, 28.0f, 140.0f)
                curveTo(28.0f, 88.0f, 128.0f, 24.0f, 128.0f, 24.0f)
                close()
            }
