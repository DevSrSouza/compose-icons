    ...
    get() {
        ...
        _bug = Builder(name = "Bug", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 143.9f, 92.0f)
                close()
                moveTo(99.9f, 80.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, false, 12.0f, 12.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 99.9f, 80.0f)
                close()
                ...
                close()
                moveTo(120.0f, 215.5f)
                lineTo(120.0f, 136.0f)
                lineTo(56.0f, 136.0f)
                verticalLineToRelative(8.0f)
                arcTo(72.0f, 72.0f, 0.0f, false, false, 120.0f, 215.5f)
                close()
