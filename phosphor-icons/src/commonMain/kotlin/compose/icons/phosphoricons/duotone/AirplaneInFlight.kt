    ...
    get() {
        ...
        _airplaneInFlight = Builder(name = "AirplaneInFlight", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineToRelative(20.0f, 24.0f)
                horizontalLineTo(96.0f)
                lineTo(83.5f, 66.5f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 91.1f, 56.0f)
                horizontalLineTo(108.0f)
                lineToRelative(44.0f, 48.0f)
                horizontalLineToRelative(56.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, 32.0f, 32.0f)
                verticalLineToRelative(24.0f)
                horizontalLineTo(63.8f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, -30.6f, -22.8f)
                lineTo(19.1f, 90.3f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 26.8f, 80.0f)
                close()
            }
