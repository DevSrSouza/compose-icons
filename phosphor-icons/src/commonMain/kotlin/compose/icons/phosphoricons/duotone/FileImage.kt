    ...
    get() {
        ...
        _fileImage = Builder(name = "FileImage", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(107.3f, 157.0f)
                lineTo(152.0f, 224.0f)
                horizontalLineTo(24.0f)
                lineToRelative(32.6f, -50.8f)
                arcToRelative(4.1f, 4.1f, 0.0f, false, true, 6.8f, 0.0f)
                lineToRelative(9.7f, 15.1f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 6.7f, 0.1f)
                lineTo(100.7f, 157.0f)
                arcTo(3.9f, 3.9f, 0.0f, false, true, 107.3f, 157.0f)
                close()
                moveTo(152.0f, 32.0f)
