    ...
    get() {
        ...
        _codesandboxLogo = Builder(name = "CodesandboxLogo", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(128.0f, 75.1f)
                lineTo(79.0f, 47.5f)
                lineToRelative(45.1f, -25.3f)
                arcToRelative(7.8f, 7.8f, 0.0f, false, true, 7.8f, 0.0f)
                close()
                moveTo(176.0f, 153.9f)
                lineTo(176.0f, 209.0f)
                lineToRelative(43.9f, -24.7f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, false, 4.1f, -7.0f)
                lineTo(224.0f, 126.9f)
                close()
                moveTo(32.0f, 177.3f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, false, 4.1f, 7.0f)
                lineTo(80.0f, 209.0f)
