    ...
    get() {
        ...
        _cylinder = Builder(name = "Cylinder", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(192.0f, 58.0f)
                curveToRelative(0.0f, 18.8f, -28.7f, 34.0f, -64.0f, 34.0f)
                reflectiveCurveTo(64.0f, 76.8f, 64.0f, 58.0f)
                reflectiveCurveToRelative(28.7f, -34.0f, 64.0f, -34.0f)
                reflectiveCurveTo(192.0f, 39.2f, 192.0f, 58.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(128.0f, 32.0f)
                curveToRelative(33.0f, 0.0f, 56.0f, 13.7f, 56.0f, 26.0f)
                reflectiveCurveToRelative(-23.0f, 26.0f, -56.0f, 26.0f)
                reflectiveCurveTo(72.0f, 70.3f, 72.0f, 58.0f)
                reflectiveCurveTo(95.0f, 32.0f, 128.0f, 32.0f)
                close()
                ...
                curveTo(184.0f, 210.3f, 161.0f, 224.0f, 128.0f, 224.0f)
                close()
            }
        }
        .build()
