    ...
    get() {
        ...
        _volleyball = Builder(name = "Volleyball", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.2f, 165.8f)
                arcTo(96.1f, 96.1f, 0.0f, false, true, 80.0f, 211.2f)
                horizontalLineToRelative(0.0f)
                arcToRelative(96.3f, 96.3f, 0.0f, false, true, -28.9f, -25.5f)
                horizontalLineToRelative(0.0f)
                arcTo(96.0f, 96.0f, 0.0f, false, true, 105.5f, 89.0f)
                lineTo(80.0f, 44.9f)
                arcToRelative(96.0f, 96.0f, 0.0f, false, true, 36.6f, -12.2f)
                horizontalLineToRelative(0.0f)
                arcTo(96.1f, 96.1f, 0.0f, false, true, 173.1f, 128.0f)
                lineTo(128.0f, 128.0f)
                lineToRelative(-22.5f, 39.0f)
                arcToRelative(95.9f, 95.9f, 0.0f, false, false, 110.7f, -1.2f)
                close()
                moveTo(216.3f, 165.8f)
                horizontalLineToRelative(0.0f)
                close()
            }
