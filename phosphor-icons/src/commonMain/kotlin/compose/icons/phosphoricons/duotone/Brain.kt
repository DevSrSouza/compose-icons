    ...
    get() {
        ...
        _brain = Builder(name = "Brain", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(48.1f, 48.1f, 0.0f, false, true, -32.0f, 45.3f)
                ...
                horizontalLineToRelative(0.0f)
                arcToRelative(48.1f, 48.1f, 0.0f, false, true, 0.0f, -90.6f)
                verticalLineTo(72.0f)
                arcToRelative(40.0f, 40.0f, 0.0f, false, true, 80.0f, 0.0f)
                arcToRelative(40.0f, 40.0f, 0.0f, false, true, 80.0f, 0.0f)
                verticalLineTo(86.7f)
                arcTo(48.1f, 48.1f, 0.0f, false, true, 240.0f, 132.0f)
                close()
            }
