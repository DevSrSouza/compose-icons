    ...
    get() {
        ...
        _magnet = Builder(name = "Magnet", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(166.6f, 202.2f)
                lineToRelative(-32.9f, 32.3f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, true, -11.3f, -0.1f)
                lineTo(93.7f, 205.7f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, true, 0.1f, -11.4f)
                lineToRelative(33.0f, -31.9f)
                close()
                moveTo(54.0f, 89.6f)
                lineTo(21.6f, 122.3f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 11.3f)
                lineToRelative(28.7f, 28.7f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, false, 11.4f, -0.1f)
