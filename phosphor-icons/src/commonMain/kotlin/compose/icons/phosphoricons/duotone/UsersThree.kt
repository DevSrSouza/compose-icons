    ...
    get() {
        ...
        _usersThree = Builder(name = "UsersThree", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, true, 168.0f, 140.0f)
                close()
                moveTo(60.0f, 52.0f)
                arcTo(32.0f, 32.0f, 0.0f, true, false, 92.0f, 84.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 60.0f, 52.0f)
                close()
                moveTo(196.0f, 52.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, 32.0f, 32.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 196.0f, 52.0f)
                close()
            }
