    ...
    get() {
        ...
        _microphoneStage = Builder(name = "MicrophoneStage", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(104.8f, 97.9f)
                close()
                moveTo(158.1f, 151.2f)
                close()
                moveTo(104.8f, 97.9f)
                lineTo(28.1f, 202.5f)
                arcToRelative(7.9f, 7.9f, 0.0f, false, false, 0.8f, 10.4f)
                lineToRelative(14.2f, 14.2f)
                arcToRelative(7.9f, 7.9f, 0.0f, false, false, 10.4f, 0.8f)
                lineToRelative(104.6f, -76.7f)
                arcTo(63.9f, 63.9f, 0.0f, false, true, 104.8f, 97.9f)
                close()
            }
