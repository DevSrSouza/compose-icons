    ...
    get() {
        ...
        _phoneSlash = Builder(name = "PhoneSlash", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(7.9f, 7.9f, 0.0f, false, false, 155.4f, 117.3f)
                close()
            }
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, true, false, 0.9f, 16.0f)
                arcToRelative(128.0f, 128.0f, 0.0f, false, true, 97.5f, 37.3f)
                arcToRelative(40.0f, 40.0f, 0.0f, false, true, 3.4f, 52.7f)
