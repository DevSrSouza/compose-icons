    ...
    get() {
        ...
        _cloudSun = Builder(name = "CloudSun", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(131.8f, 84.4f)
                arcToRelative(48.0f, 48.0f, 0.0f, false, false, -91.1f, 27.9f)
                arcToRelative(49.1f, 49.1f, 0.0f, false, false, 10.9f, 23.1f)
                horizontalLineToRelative(0.0f)
                arcTo(43.6f, 43.6f, 0.0f, false, true, 76.0f, 128.0f)
                arcToRelative(42.5f, 42.5f, 0.0f, false, true, 14.3f, 2.4f)
                horizontalLineToRelative(0.0f)
                arcToRelative(68.3f, 68.3f, 0.0f, false, true, 41.5f, -46.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(39.9f, 39.9f, 0.0f, false, true, 29.1f, 6.2f)
