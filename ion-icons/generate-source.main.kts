...
val githubId = "ionic-team/ionicons"
...
val repoCloneDir = createTempDir(suffix = "ion-icons-git-repo")
...
val srcDir = File("ion-icons/src/commonMain/kotlin").apply { mkdirs() }
...
val resDir = File("ion-icons/src/commonMain/resources").makeDirs()
val licenseInResource = File(resDir, "ion-icons-license.txt")
...
File("ion-icons/DOCUMENTATION.md").apply{
