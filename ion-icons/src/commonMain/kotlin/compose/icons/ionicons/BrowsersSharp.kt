...
public val IonIcons.BrowsersSharp: ImageVector
    get() {
        if (_browsersSharp != null) {
            return _browsersSharp!!
        }
        _browsersSharp = Builder(name = "BrowsersSharp", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 440.0f, 428.0f)
                close()
            }
        }
        .build()
