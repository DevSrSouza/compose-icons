...
public val IonIcons.GlobeSharp: ImageVector
    get() {
        if (_globeSharp != null) {
            return _globeSharp!!
        }
        _globeSharp = Builder(name = "GlobeSharp", defaultWidth = 512.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 44.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
