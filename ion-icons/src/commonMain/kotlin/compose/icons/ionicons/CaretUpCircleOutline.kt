...
public val IonIcons.CaretUpCircleOutline: ImageVector
    get() {
        if (_caretUpCircleOutline != null) {
            return _caretUpCircleOutline!!
        }
        _caretUpCircleOutline = Builder(name = "CaretUpCircleOutline", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, -24.6f, 0.0f)
                lineToRelative(-74.13f, 89.09f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 181.86f, 300.0f)
                horizontalLineTo(330.14f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 342.43f, 273.77f)
                close()
            }
