...
public val IonIcons.MaleFemaleOutline: ImageVector
    get() {
        if (_maleFemaleOutline != null) {
            return _maleFemaleOutline!!
        }
        _maleFemaleOutline = Builder(name = "MaleFemaleOutline", defaultWidth = 512.0.dp,
                defaultHeight = 512.0.dp, viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(216.0f, 200.0f)
                moveToRelative(-136.0f, 0.0f)
                arcToRelative(136.0f, 136.0f, 0.0f, true, true, 272.0f, 0.0f)
                arcToRelative(136.0f, 136.0f, 0.0f, true, true, -272.0f, 0.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
