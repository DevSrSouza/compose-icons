...
public val IonIcons.CartOutline: ImageVector
    get() {
        if (_cartOutline != null) {
            return _cartOutline!!
        }
        _cartOutline = Builder(name = "CartOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 7.85f, -6.43f)
                lineToRelative(28.8f, -144.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.85f, -9.57f)
