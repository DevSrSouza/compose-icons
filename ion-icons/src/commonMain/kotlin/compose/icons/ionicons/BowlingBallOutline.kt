...
public val IonIcons.BowlingBallOutline: ImageVector
    get() {
        if (_bowlingBallOutline != null) {
            return _bowlingBallOutline!!
        }
        _bowlingBallOutline = Builder(name = "BowlingBallOutline", defaultWidth = 512.0.dp,
