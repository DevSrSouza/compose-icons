...
public val IonIcons.GlobeOutline: ImageVector
    get() {
        if (_globeOutline != null) {
            return _globeOutline!!
        }
        _globeOutline = Builder(name = "GlobeOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(256.0f, 48.0f)
                curveToRelative(-58.07f, 0.0f, -112.67f, 93.13f, -112.67f, 208.0f)
                reflectiveCurveTo(197.93f, 464.0f, 256.0f, 464.0f)
                reflectiveCurveToRelative(112.67f, -93.13f, 112.67f, -208.0f)
                reflectiveCurveTo(314.07f, 48.0f, 256.0f, 48.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
