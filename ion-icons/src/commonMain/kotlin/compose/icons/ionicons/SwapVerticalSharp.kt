...
public val IonIcons.SwapVerticalSharp: ImageVector
    get() {
        if (_swapVerticalSharp != null) {
            return _swapVerticalSharp!!
        }
        _swapVerticalSharp = Builder(name = "SwapVerticalSharp", defaultWidth = 512.0.dp,
