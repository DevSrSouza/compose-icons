...
public val IonIcons.KeypadOutline: ImageVector
    get() {
        if (_keypadOutline != null) {
            return _keypadOutline!!
        }
        _keypadOutline = Builder(name = "KeypadOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, true, 288.0f, 192.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
