...
public val IonIcons.DocumentAttachSharp: ImageVector
    get() {
        if (_documentAttachSharp != null) {
            return _documentAttachSharp!!
        }
        _documentAttachSharp = Builder(name = "DocumentAttachSharp", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(2.0f, 2.0f, 0.0f, false, false, 304.0f, 57.69f)
                verticalLineTo(204.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 308.0f, 208.0f)
                close()
            }
        }
        .build()
