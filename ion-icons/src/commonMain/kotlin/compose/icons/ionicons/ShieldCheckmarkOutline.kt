...
public val IonIcons.ShieldCheckmarkOutline: ImageVector
    get() {
        if (_shieldCheckmarkOutline != null) {
            return _shieldCheckmarkOutline!!
        }
        _shieldCheckmarkOutline = Builder(name = "ShieldCheckmarkOutline", defaultWidth = 512.0.dp,
                defaultHeight = 512.0.dp, viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(336.0f, 176.0f)
                lineToRelative(-110.8f, 128.0f)
