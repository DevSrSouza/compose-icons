...
public val IonIcons.DuplicateOutline: ImageVector
    get() {
        if (_duplicateOutline != null) {
            return _duplicateOutline!!
        }
        _duplicateOutline = Builder(name = "DuplicateOutline", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(296.0f, 376.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = StrokeCap.Companion.Round,
                    strokeLineJoin = Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(376.0f, 296.0f)
