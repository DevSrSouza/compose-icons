...
public val IonIcons.GitBranchOutline: ImageVector
    get() {
        if (_gitBranchOutline != null) {
            return _gitBranchOutline!!
        }
        _gitBranchOutline = Builder(name = "GitBranchOutline", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 128.0f, -192.0f, 48.0f, -192.0f, 160.0f)
            }
        }
        .build()
        return _gitBranchOutline!!
