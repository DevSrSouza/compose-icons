...
public val IonIcons.PulseOutline: ImageVector
    get() {
        if (_pulseOutline != null) {
            return _pulseOutline!!
        }
        _pulseOutline = Builder(name = "PulseOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineToRelative(64.0f, -256.0f)
                lineToRelative(64.0f, 384.0f)
                lineToRelative(64.0f, -224.0f)
