...
public val IonIcons.CaretUpCircleSharp: ImageVector
    get() {
        if (_caretUpCircleSharp != null) {
            return _caretUpCircleSharp!!
        }
        _caretUpCircleSharp = Builder(name = "CaretUpCircleSharp", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(147.73f, 300.0f)
                lineTo(256.0f, 169.91f)
                lineTo(364.27f, 300.0f)
                close()
            }
        }
        .build()
