...
public val IonIcons.WifiOutline: ImageVector
    get() {
        if (_wifiOutline != null) {
            return _wifiOutline!!
        }
        _wifiOutline = Builder(name = "WifiOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, true, 256.0f, 416.0f)
                close()
            }
        }
        .build()
