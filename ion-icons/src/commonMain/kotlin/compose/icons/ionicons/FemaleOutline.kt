...
public val IonIcons.FemaleOutline: ImageVector
    get() {
        if (_femaleOutline != null) {
            return _femaleOutline!!
        }
        _femaleOutline = Builder(name = "FemaleOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(314.0f, 416.0f)
                lineTo(198.0f, 416.0f)
            }
        }
        .build()
        return _femaleOutline!!
