...
public val IonIcons.ScanCircle: ImageVector
    get() {
        if (_scanCircle != null) {
            return _scanCircle!!
        }
        _scanCircle = Builder(name = "ScanCircle", defaultWidth = 512.0.dp, defaultHeight =
