...
public val IonIcons.LinkOutline: ImageVector
    get() {
        if (_linkOutline != null) {
            return _linkOutline!!
        }
        _linkOutline = Builder(name = "LinkOutline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 36.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(163.29f, 256.0f)
                lineTo(350.71f, 256.0f)
            }
        }
        .build()
        return _linkOutline!!
