...
public val IonIcons.PlayForwardCircleSharp: ImageVector
    get() {
        if (_playForwardCircleSharp != null) {
            return _playForwardCircleSharp!!
        }
        _playForwardCircleSharp = Builder(name = "PlayForwardCircleSharp", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(264.0f, 343.25f)
                lineTo(264.0f, 271.81f)
                lineTo(144.0f, 344.13f)
                lineTo(144.0f, 167.71f)
                lineToRelative(120.0f, 72.48f)
                lineTo(264.0f, 168.0f)
                lineToRelative(136.53f, 88.0f)
                close()
            }
        }
        .build()
