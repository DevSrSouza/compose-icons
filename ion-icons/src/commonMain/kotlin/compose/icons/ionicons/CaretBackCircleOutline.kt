...
public val IonIcons.CaretBackCircleOutline: ImageVector
    get() {
        if (_caretBackCircleOutline != null) {
            return _caretBackCircleOutline!!
        }
        _caretBackCircleOutline = Builder(name = "CaretBackCircleOutline", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 300.0f, 330.14f)
                verticalLineTo(181.86f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 273.77f, 169.57f)
                close()
            }
