...
public val IonIcons.ShareSharp: ImageVector
    get() {
        if (_shareSharp != null) {
            return _shareSharp!!
        }
        _shareSharp = Builder(name = "ShareSharp", defaultWidth = 512.0.dp, defaultHeight =
