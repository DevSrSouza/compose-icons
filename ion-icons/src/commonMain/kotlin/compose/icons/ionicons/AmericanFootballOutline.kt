...
public val IonIcons.AmericanFootballOutline: ImageVector
    get() {
        if (_americanFootballOutline != null) {
            return _americanFootballOutline!!
        }
        _americanFootballOutline = Builder(name = "AmericanFootballOutline", defaultWidth =
                512.0.dp, defaultHeight = 512.0.dp, viewportWidth = 512.0f, viewportHeight =
                512.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 32.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(66.798f, 445.201f)
                arcToRelative(173.44f, 267.57f, 45.0f, true, false, 378.401f, -378.401f)
                arcToRelative(173.44f, 267.57f, 45.0f, true, false, -378.401f, 378.401f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
