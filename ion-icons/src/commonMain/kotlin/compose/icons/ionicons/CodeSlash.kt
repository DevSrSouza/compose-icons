...
public val IonIcons.CodeSlash: ImageVector
    get() {
        if (_codeSlash != null) {
            return _codeSlash!!
        }
        _codeSlash = Builder(name = "CodeSlash", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(208.0f, 437.0f)
                arcToRelative(21.0f, 21.0f, 0.0f, false, true, -20.12f, -27.0f)
                lineToRelative(96.0f, -320.0f)
                arcTo(21.0f, 21.0f, 0.0f, true, true, 324.11f, 102.0f)
                lineToRelative(-96.0f, 320.0f)
                arcTo(21.0f, 21.0f, 0.0f, false, true, 208.0f, 437.0f)
                close()
            }
        }
        .build()
