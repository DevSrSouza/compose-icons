...
public val IonIcons.AlertCircleOutline: ImageVector
    get() {
        if (_alertCircleOutline != null) {
            return _alertCircleOutline!!
        }
        _alertCircleOutline = Builder(name = "AlertCircleOutline", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcTo(5.74f, 5.74f, 0.0f, false, false, 250.26f, 166.05f)
                close()
            }
