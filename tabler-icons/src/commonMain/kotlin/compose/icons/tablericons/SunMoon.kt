...
public val TablerIcons.SunMoon: ImageVector
    get() {
        if (_sunMoon != null) {
            return _sunMoon!!
        }
        _sunMoon = Builder(name = "SunMoon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(7.5f, 7.5f, 0.0f, false, false, 8.845f, 2.492f)
                arcToRelative(9.0f, 9.0f, 0.0f, false, true, -14.671f, 2.914f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
