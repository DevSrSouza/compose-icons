...
public val TablerIcons.DeviceTablet: VectorAsset
    get() {
        if (_deviceTablet != null) {
            return _deviceTablet!!
        }
        _deviceTablet = VectorAssetBuilder(name = "DeviceTablet", defaultWidth = 24.0.dp,
...
private var _deviceTablet: VectorAsset? = null
