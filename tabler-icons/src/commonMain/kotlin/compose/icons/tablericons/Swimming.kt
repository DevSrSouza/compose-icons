...
public val TablerIcons.Swimming: VectorAsset
    get() {
        if (_swimming != null) {
            return _swimming!!
        }
        _swimming = VectorAssetBuilder(name = "Swimming", defaultWidth = 24.0.dp, defaultHeight =
...
private var _swimming: VectorAsset? = null
