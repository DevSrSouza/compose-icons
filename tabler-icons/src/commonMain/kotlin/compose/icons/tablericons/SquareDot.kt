...
public val TablerIcons.SquareDot: VectorAsset
    get() {
        if (_squareDot != null) {
            return _squareDot!!
        }
        _squareDot = VectorAssetBuilder(name = "SquareDot", defaultWidth = 24.0.dp, defaultHeight =
...
private var _squareDot: VectorAsset? = null
