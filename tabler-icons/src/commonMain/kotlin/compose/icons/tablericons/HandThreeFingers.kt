...
public val TablerIcons.HandThreeFingers: ImageVector
    get() {
        if (_handThreeFingers != null) {
            return _handThreeFingers!!
        }
        _handThreeFingers = Builder(name = "HandThreeFingers", defaultWidth = 24.0.dp, defaultHeight
