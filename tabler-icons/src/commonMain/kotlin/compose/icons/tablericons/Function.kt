    ...
    get() {
        ...
        _function = Builder(name = "Function", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(6.667f, 4.0f)
                lineTo(17.333f, 4.0f)
                arcTo(2.667f, 2.667f, 0.0f, false, true, 20.0f, 6.667f)
                lineTo(20.0f, 17.333f)
                arcTo(2.667f, 2.667f, 0.0f, false, true, 17.333f, 20.0f)
                lineTo(6.667f, 20.0f)
                arcTo(2.667f, 2.667f, 0.0f, false, true, 4.0f, 17.333f)
                lineTo(4.0f, 6.667f)
                arcTo(2.667f, 2.667f, 0.0f, false, true, 6.667f, 4.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
