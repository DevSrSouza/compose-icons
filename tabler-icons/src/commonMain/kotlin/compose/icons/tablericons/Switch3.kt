...
public val TablerIcons.Switch3: VectorAsset
    get() {
        if (_switch3 != null) {
            return _switch3!!
        }
        _switch3 = VectorAssetBuilder(name = "Switch3", defaultWidth = 24.0.dp, defaultHeight =
...
private var _switch3: VectorAsset? = null
