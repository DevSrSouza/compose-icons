...
public val TablerIcons.DeviceTv: VectorAsset
    get() {
        if (_deviceTv != null) {
            return _deviceTv!!
        }
        _deviceTv = VectorAssetBuilder(name = "DeviceTv", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deviceTv: VectorAsset? = null
