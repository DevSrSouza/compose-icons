...
public val TablerIcons.SquareRoundedArrowDown: ImageVector
    get() {
        if (_squareRoundedArrowDown != null) {
            return _squareRoundedArrowDown!!
        }
        _squareRoundedArrowDown = Builder(name = "SquareRoundedArrowDown", defaultWidth = 24.0.dp,
