...
public val TablerIcons.Coin: VectorAsset
    get() {
        if (_coin != null) {
            return _coin!!
        }
        _coin = VectorAssetBuilder(name = "Coin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _coin: VectorAsset? = null
