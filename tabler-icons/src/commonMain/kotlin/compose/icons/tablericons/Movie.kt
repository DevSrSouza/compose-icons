...
public val TablerIcons.Movie: VectorAsset
    get() {
        if (_movie != null) {
            return _movie!!
        }
        _movie = VectorAssetBuilder(name = "Movie", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _movie: VectorAsset? = null
