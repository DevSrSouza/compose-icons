...
public val TablerIcons.BellPin: ImageVector
    get() {
        if (_bellPin != null) {
            return _bellPin!!
        }
        _bellPin = Builder(name = "BellPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 3.64f, 2.931f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
