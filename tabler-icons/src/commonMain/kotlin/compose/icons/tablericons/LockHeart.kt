...
public val TablerIcons.LockHeart: ImageVector
    get() {
        if (_lockHeart != null) {
            return _lockHeart!!
        }
        _lockHeart = Builder(name = "LockHeart", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.38f, 0.0f, 0.734f, 0.106f, 1.037f, 0.29f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
