...
public val TablerIcons.BrandDisqus: VectorAsset
    get() {
        if (_brandDisqus != null) {
            return _brandDisqus!!
        }
        _brandDisqus = VectorAssetBuilder(name = "BrandDisqus", defaultWidth = 24.0.dp,
...
private var _brandDisqus: VectorAsset? = null
