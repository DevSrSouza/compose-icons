...
public val TablerIcons.UfOff: ImageVector
    get() {
        if (_ufOff != null) {
            return _ufOff!!
        }
        _ufOff = Builder(name = "UfOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ufOff: ImageVector? = null
