...
public val TablerIcons.BrandAirbnb: VectorAsset
    get() {
        if (_brandAirbnb != null) {
            return _brandAirbnb!!
        }
        _brandAirbnb = VectorAssetBuilder(name = "BrandAirbnb", defaultWidth = 24.0.dp,
...
private var _brandAirbnb: VectorAsset? = null
