...
public val TablerIcons.Snowboarding: ImageVector
    get() {
        ...
        _snowboarding = Builder(name = "Snowboarding", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(6.0f, 1.464f, 10.772f, 2.262f, 13.5f, 2.927f)
                curveToRelative(1.333f, 0.325f, 2.333f, 0.0f, 3.0f, -0.976f)
            }
        }
        .build()
        return _snowboarding!!
