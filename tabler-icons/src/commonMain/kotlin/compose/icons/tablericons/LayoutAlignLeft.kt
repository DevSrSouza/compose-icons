...
public val TablerIcons.LayoutAlignLeft: VectorAsset
    get() {
        if (_layoutAlignLeft != null) {
            return _layoutAlignLeft!!
        }
        _layoutAlignLeft = VectorAssetBuilder(name = "LayoutAlignLeft", defaultWidth = 24.0.dp,
...
private var _layoutAlignLeft: VectorAsset? = null
