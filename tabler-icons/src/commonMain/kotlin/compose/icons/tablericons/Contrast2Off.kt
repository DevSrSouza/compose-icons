...
public val TablerIcons.Contrast2Off: ImageVector
    get() {
        if (_contrast2Off != null) {
            return _contrast2Off!!
        }
        _contrast2Off = Builder(name = "Contrast2Off", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(5.996f, 5.996f, 0.0f, false, true, 5.122f, -2.874f)
                horizontalLineToRelative(2.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
