...
public val TablerIcons.SquareRoundedArrowUpFilled: ImageVector
    get() {
        if (_squareRoundedArrowUpFilled != null) {
            return _squareRoundedArrowUpFilled!!
        }
        _squareRoundedArrowUpFilled = Builder(name = "SquareRoundedArrowUpFilled", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(4.0f, -4.0f)
                arcToRelative(0.927f, 0.927f, 0.0f, false, true, 0.112f, -0.097f)
...
private var _squareRoundedArrowUpFilled: ImageVector? = null
