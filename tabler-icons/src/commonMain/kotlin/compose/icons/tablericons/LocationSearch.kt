...
public val TablerIcons.LocationSearch: ImageVector
    get() {
        if (_locationSearch != null) {
            return _locationSearch!!
        }
        _locationSearch = Builder(name = "LocationSearch", defaultWidth = 24.0.dp, defaultHeight =
