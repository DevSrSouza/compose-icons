...
public val TablerIcons.SquareRoundedNumber8: ImageVector
    get() {
        if (_squareRoundedNumber8 != null) {
            return _squareRoundedNumber8!!
        }
        _squareRoundedNumber8 = Builder(name = "SquareRoundedNumber8", defaultWidth = 24.0.dp,
