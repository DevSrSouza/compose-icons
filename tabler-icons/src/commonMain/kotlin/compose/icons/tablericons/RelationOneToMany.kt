...
public val TablerIcons.RelationOneToMany: VectorAsset
    get() {
        if (_relationOneToMany != null) {
            return _relationOneToMany!!
        }
        _relationOneToMany = VectorAssetBuilder(name = "RelationOneToMany", defaultWidth = 24.0.dp,
...
private var _relationOneToMany: VectorAsset? = null
