...
public val TablerIcons.HexagonLetterL: ImageVector
    get() {
        if (_hexagonLetterL != null) {
            return _hexagonLetterL!!
        }
        _hexagonLetterL = Builder(name = "HexagonLetterL", defaultWidth = 24.0.dp, defaultHeight =
