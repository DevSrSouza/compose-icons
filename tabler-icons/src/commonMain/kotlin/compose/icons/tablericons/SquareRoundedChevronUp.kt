...
public val TablerIcons.SquareRoundedChevronUp: ImageVector
    get() {
        if (_squareRoundedChevronUp != null) {
            return _squareRoundedChevronUp!!
        }
        _squareRoundedChevronUp = Builder(name = "SquareRoundedChevronUp", defaultWidth = 24.0.dp,
