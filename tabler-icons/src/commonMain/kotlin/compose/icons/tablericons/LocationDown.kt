...
public val TablerIcons.LocationDown: ImageVector
    get() {
        if (_locationDown != null) {
            return _locationDown!!
        }
        _locationDown = Builder(name = "LocationDown", defaultWidth = 24.0.dp, defaultHeight =
