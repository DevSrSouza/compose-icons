...
public val TablerIcons.BrandFilezilla: ImageVector
    get() {
        if (_brandFilezilla != null) {
            return _brandFilezilla!!
        }
        _brandFilezilla = Builder(name = "BrandFilezilla", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.0f, 15.824f)
                arcToRelative(4.062f, 4.062f, 0.0f, false, true, -2.25f, 0.033f)
                curveToRelative(-0.738f, -0.201f, -2.018f, -0.08f, -2.75f, 0.143f)
                lineToRelative(4.583f, -5.0f)
