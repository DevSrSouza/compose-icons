...
public val TablerIcons.InfoSquareFilled: ImageVector
    get() {
        if (_infoSquareFilled != null) {
            return _infoSquareFilled!!
        }
        _infoSquareFilled = Builder(name = "InfoSquareFilled", defaultWidth = 24.0.dp, defaultHeight
...
private var _infoSquareFilled: ImageVector? = null
