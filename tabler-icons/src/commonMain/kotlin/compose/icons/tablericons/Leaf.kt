...
public val TablerIcons.Leaf: VectorAsset
    get() {
        if (_leaf != null) {
            return _leaf!!
        }
        _leaf = VectorAssetBuilder(name = "Leaf", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _leaf: VectorAsset? = null
