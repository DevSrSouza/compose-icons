...
public val TablerIcons.BellExclamation: ImageVector
    get() {
        if (_bellExclamation != null) {
            return _bellExclamation!!
        }
        _bellExclamation = Builder(name = "BellExclamation", defaultWidth = 24.0.dp, defaultHeight =
