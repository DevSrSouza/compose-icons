...
public val TablerIcons.HexagonNumber0: ImageVector
    get() {
        if (_hexagonNumber0 != null) {
            return _hexagonNumber0!!
        }
        _hexagonNumber0 = Builder(name = "HexagonNumber0", defaultWidth = 24.0.dp, defaultHeight =
