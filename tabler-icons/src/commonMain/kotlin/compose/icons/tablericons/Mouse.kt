...
public val TablerIcons.Mouse: VectorAsset
    get() {
        if (_mouse != null) {
            return _mouse!!
        }
        _mouse = VectorAssetBuilder(name = "Mouse", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _mouse: VectorAsset? = null
