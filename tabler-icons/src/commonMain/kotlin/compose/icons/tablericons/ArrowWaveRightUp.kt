...
public val TablerIcons.ArrowWaveRightUp: VectorAsset
    get() {
        if (_arrowWaveRightUp != null) {
            return _arrowWaveRightUp!!
        }
        _arrowWaveRightUp = VectorAssetBuilder(name = "ArrowWaveRightUp", defaultWidth = 24.0.dp,
...
private var _arrowWaveRightUp: VectorAsset? = null
