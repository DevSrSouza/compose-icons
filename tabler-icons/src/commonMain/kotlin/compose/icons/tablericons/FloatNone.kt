...
public val TablerIcons.FloatNone: VectorAsset
    get() {
        if (_floatNone != null) {
            return _floatNone!!
        }
        _floatNone = VectorAssetBuilder(name = "FloatNone", defaultWidth = 24.0.dp, defaultHeight =
...
private var _floatNone: VectorAsset? = null
