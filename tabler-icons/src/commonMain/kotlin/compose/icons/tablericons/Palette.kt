...
public val TablerIcons.Palette: VectorAsset
    get() {
        if (_palette != null) {
            return _palette!!
        }
        _palette = VectorAssetBuilder(name = "Palette", defaultWidth = 24.0.dp, defaultHeight =
...
private var _palette: VectorAsset? = null
