...
public val TablerIcons.FireHydrantOff: ImageVector
    get() {
        ...
        _fireHydrantOff = Builder(name = "FireHydrantOff", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                verticalLineToRelative(-4.0f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, false, -8.533f, -3.538f)
                moveToRelative(-1.387f, 2.638f)
                arcToRelative(5.03f, 5.03f, 0.0f, false, false, -0.08f, 0.9f)
                verticalLineToRelative(4.0f)
                horizontalLineToRelative(-1.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -1.0f, 1.0f)
                verticalLineToRelative(2.0f)
