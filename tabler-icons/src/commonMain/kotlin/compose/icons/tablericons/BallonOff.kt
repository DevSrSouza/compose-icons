...
public val TablerIcons.BallonOff: ImageVector
    get() {
        if (_ballonOff != null) {
            return _ballonOff!!
        }
        _ballonOff = Builder(name = "BallonOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(-0.967f, 1.001f, -2.14f, 1.587f, -3.403f, 1.587f)
...
private var _ballonOff: ImageVector? = null
