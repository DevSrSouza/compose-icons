...
public val TablerIcons.BrandOpenSource: VectorAsset
    get() {
        if (_brandOpenSource != null) {
            return _brandOpenSource!!
        }
        _brandOpenSource = VectorAssetBuilder(name = "BrandOpenSource", defaultWidth = 24.0.dp,
...
private var _brandOpenSource: VectorAsset? = null
