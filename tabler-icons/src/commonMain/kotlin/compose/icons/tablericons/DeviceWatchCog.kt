...
public val TablerIcons.DeviceWatchCog: ImageVector
    get() {
        if (_deviceWatchCog != null) {
            return _deviceWatchCog!!
        }
        _deviceWatchCog = Builder(name = "DeviceWatchCog", defaultWidth = 24.0.dp, defaultHeight =
