...
public val TablerIcons.CircleDashed: VectorAsset
    get() {
        if (_circleDashed != null) {
            return _circleDashed!!
        }
        _circleDashed = VectorAssetBuilder(name = "CircleDashed", defaultWidth = 24.0.dp,
...
private var _circleDashed: VectorAsset? = null
