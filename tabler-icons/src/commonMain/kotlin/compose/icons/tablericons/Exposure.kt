...
public val TablerIcons.Exposure: VectorAsset
    get() {
        if (_exposure != null) {
            return _exposure!!
        }
        _exposure = VectorAssetBuilder(name = "Exposure", defaultWidth = 24.0.dp, defaultHeight =
...
private var _exposure: VectorAsset? = null
