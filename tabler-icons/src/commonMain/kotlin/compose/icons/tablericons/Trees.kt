...
public val TablerIcons.Trees: VectorAsset
    get() {
        if (_trees != null) {
            return _trees!!
        }
        _trees = VectorAssetBuilder(name = "Trees", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _trees: VectorAsset? = null
