...
public val TablerIcons.LayoutCards: VectorAsset
    get() {
        if (_layoutCards != null) {
            return _layoutCards!!
        }
        _layoutCards = VectorAssetBuilder(name = "LayoutCards", defaultWidth = 24.0.dp,
...
private var _layoutCards: VectorAsset? = null
