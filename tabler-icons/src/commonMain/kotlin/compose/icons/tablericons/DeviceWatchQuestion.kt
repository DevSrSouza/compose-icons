...
public val TablerIcons.DeviceWatchQuestion: ImageVector
    get() {
        if (_deviceWatchQuestion != null) {
            return _deviceWatchQuestion!!
        }
        _deviceWatchQuestion = Builder(name = "DeviceWatchQuestion", defaultWidth = 24.0.dp,
