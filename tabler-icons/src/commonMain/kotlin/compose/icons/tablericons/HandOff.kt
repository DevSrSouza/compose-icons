...
public val TablerIcons.HandOff: VectorAsset
    get() {
        if (_handOff != null) {
            return _handOff!!
        }
        _handOff = VectorAssetBuilder(name = "HandOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _handOff: VectorAsset? = null
