...
public val TablerIcons.DeviceTabletStar: ImageVector
    get() {
        if (_deviceTabletStar != null) {
            return _deviceTabletStar!!
        }
        _deviceTabletStar = Builder(name = "DeviceTabletStar", defaultWidth = 24.0.dp, defaultHeight
...
private var _deviceTabletStar: ImageVector? = null
