...
public val TablerIcons.SquareRoundedArrowUp: ImageVector
    get() {
        if (_squareRoundedArrowUp != null) {
            return _squareRoundedArrowUp!!
        }
        _squareRoundedArrowUp = Builder(name = "SquareRoundedArrowUp", defaultWidth = 24.0.dp,
