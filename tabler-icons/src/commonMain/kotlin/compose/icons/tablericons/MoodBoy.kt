...
public val TablerIcons.MoodBoy: VectorAsset
    get() {
        if (_moodBoy != null) {
            return _moodBoy!!
        }
        _moodBoy = VectorAssetBuilder(name = "MoodBoy", defaultWidth = 24.0.dp, defaultHeight =
...
private var _moodBoy: VectorAsset? = null
