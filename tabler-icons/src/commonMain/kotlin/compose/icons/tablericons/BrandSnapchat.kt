...
public val TablerIcons.BrandSnapchat: VectorAsset
    get() {
        if (_brandSnapchat != null) {
            return _brandSnapchat!!
        }
        _brandSnapchat = VectorAssetBuilder(name = "BrandSnapchat", defaultWidth = 24.0.dp,
...
private var _brandSnapchat: VectorAsset? = null
