...
public val TablerIcons.SmartHome: VectorAsset
    get() {
        if (_smartHome != null) {
            return _smartHome!!
        }
        _smartHome = VectorAssetBuilder(name = "SmartHome", defaultWidth = 24.0.dp, defaultHeight =
...
private var _smartHome: VectorAsset? = null
