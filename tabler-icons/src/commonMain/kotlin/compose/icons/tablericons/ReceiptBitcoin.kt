...
public val TablerIcons.ReceiptBitcoin: ImageVector
    get() {
        if (_receiptBitcoin != null) {
            return _receiptBitcoin!!
        }
        _receiptBitcoin = Builder(name = "ReceiptBitcoin", defaultWidth = 24.0.dp, defaultHeight =
