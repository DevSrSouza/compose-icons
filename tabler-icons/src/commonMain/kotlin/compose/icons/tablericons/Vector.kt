...
public val TablerIcons.Vector: VectorAsset
    get() {
        if (_vector != null) {
            return _vector!!
        }
        _vector = VectorAssetBuilder(name = "Vector", defaultWidth = 24.0.dp, defaultHeight =
...
private var _vector: VectorAsset? = null
