...
public val TablerIcons.Artboard: VectorAsset
    get() {
        if (_artboard != null) {
            return _artboard!!
        }
        _artboard = VectorAssetBuilder(name = "Artboard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _artboard: VectorAsset? = null
