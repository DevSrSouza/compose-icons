...
public val TablerIcons.ArrowWaveLeftDown: VectorAsset
    get() {
        if (_arrowWaveLeftDown != null) {
            return _arrowWaveLeftDown!!
        }
        _arrowWaveLeftDown = VectorAssetBuilder(name = "ArrowWaveLeftDown", defaultWidth = 24.0.dp,
...
private var _arrowWaveLeftDown: VectorAsset? = null
