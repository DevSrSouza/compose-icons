...
public val TablerIcons.CircleDashedPercentage: ImageVector
    get() {
        if (_circleDashedPercentage != null) {
            return _circleDashedPercentage!!
        }
        _circleDashedPercentage = Builder(name = "CircleDashedPercentage", defaultWidth = 24.0.dp,
...
private var _circleDashedPercentage: ImageVector? = null
