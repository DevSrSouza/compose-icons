    ...
    get() {
        ...
        _atom = Builder(name = "Atom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(-1.562f, -1.562f, -5.994f, 0.337f, -9.9f, 4.243f)
                curveToRelative(-3.905f, 3.905f, -5.804f, 8.337f, -4.242f, 9.9f)
                curveToRelative(1.562f, 1.561f, 5.994f, -0.338f, 9.9f, -4.244f)
                curveToRelative(3.905f, -3.905f, 5.804f, -8.337f, 4.242f, -9.9f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                ...
                curveToRelative(-1.562f, 1.562f, 0.337f, 5.994f, 4.243f, 9.9f)
                curveToRelative(3.905f, 3.905f, 8.337f, 5.804f, 9.9f, 4.242f)
                curveToRelative(1.561f, -1.562f, -0.338f, -5.994f, -4.244f, -9.9f)
                curveToRelative(-3.905f, -3.905f, -8.337f, -5.804f, -9.9f, -4.242f)
            }
        }
        .build()
