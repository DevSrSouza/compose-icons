...
public val TablerIcons.PhoneCalling: VectorAsset
    get() {
        if (_phoneCalling != null) {
            return _phoneCalling!!
        }
        _phoneCalling = VectorAssetBuilder(name = "PhoneCalling", defaultWidth = 24.0.dp,
...
private var _phoneCalling: VectorAsset? = null
