...
public val TablerIcons.SquareRoundedLetterR: ImageVector
    get() {
        if (_squareRoundedLetterR != null) {
            return _squareRoundedLetterR!!
        }
        _squareRoundedLetterR = Builder(name = "SquareRoundedLetterR", defaultWidth = 24.0.dp,
