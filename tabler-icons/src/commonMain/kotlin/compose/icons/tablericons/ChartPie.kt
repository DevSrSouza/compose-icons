...
public val TablerIcons.ChartPie: VectorAsset
    get() {
        if (_chartPie != null) {
            return _chartPie!!
        }
        _chartPie = VectorAssetBuilder(name = "ChartPie", defaultWidth = 24.0.dp, defaultHeight =
...
private var _chartPie: VectorAsset? = null
