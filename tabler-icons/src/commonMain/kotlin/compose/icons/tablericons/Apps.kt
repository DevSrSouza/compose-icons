...
public val TablerIcons.Apps: VectorAsset
    get() {
        if (_apps != null) {
            return _apps!!
        }
        _apps = VectorAssetBuilder(name = "Apps", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _apps: VectorAsset? = null
