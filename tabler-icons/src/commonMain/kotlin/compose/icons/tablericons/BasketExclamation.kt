...
public val TablerIcons.BasketExclamation: ImageVector
    get() {
        if (_basketExclamation != null) {
            return _basketExclamation!!
        }
        _basketExclamation = Builder(name = "BasketExclamation", defaultWidth = 24.0.dp,
