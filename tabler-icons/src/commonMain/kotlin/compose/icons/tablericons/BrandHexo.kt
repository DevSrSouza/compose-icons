...
public val TablerIcons.BrandHexo: ImageVector
    get() {
        if (_brandHexo != null) {
            return _brandHexo!!
        }
        _brandHexo = Builder(name = "BrandHexo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _brandHexo: ImageVector? = null
