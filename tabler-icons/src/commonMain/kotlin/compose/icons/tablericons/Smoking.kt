...
public val TablerIcons.Smoking: VectorAsset
    get() {
        if (_smoking != null) {
            return _smoking!!
        }
        _smoking = VectorAssetBuilder(name = "Smoking", defaultWidth = 24.0.dp, defaultHeight =
...
private var _smoking: VectorAsset? = null
