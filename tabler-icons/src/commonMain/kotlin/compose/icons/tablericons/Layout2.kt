...
public val TablerIcons.Layout2: VectorAsset
    get() {
        if (_layout2 != null) {
            return _layout2!!
        }
        _layout2 = VectorAssetBuilder(name = "Layout2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _layout2: VectorAsset? = null
