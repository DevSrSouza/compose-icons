...
public val TablerIcons.YinYang: VectorAsset
    get() {
        if (_yinYang != null) {
            return _yinYang!!
        }
        _yinYang = VectorAssetBuilder(name = "YinYang", defaultWidth = 24.0.dp, defaultHeight =
...
private var _yinYang: VectorAsset? = null
