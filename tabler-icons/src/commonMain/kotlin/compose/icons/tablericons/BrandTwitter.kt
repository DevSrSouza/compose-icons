...
public val TablerIcons.BrandTwitter: VectorAsset
    get() {
        if (_brandTwitter != null) {
            return _brandTwitter!!
        }
        _brandTwitter = VectorAssetBuilder(name = "BrandTwitter", defaultWidth = 24.0.dp,
...
private var _brandTwitter: VectorAsset? = null
