...
public val TablerIcons.PhotoPin: ImageVector
    get() {
        if (_photoPin != null) {
            return _photoPin!!
        }
        _photoPin = Builder(name = "PhotoPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _photoPin: ImageVector? = null
