...
public val TablerIcons.BrandStripe: VectorAsset
    get() {
        if (_brandStripe != null) {
            return _brandStripe!!
        }
        _brandStripe = VectorAssetBuilder(name = "BrandStripe", defaultWidth = 24.0.dp,
...
private var _brandStripe: VectorAsset? = null
