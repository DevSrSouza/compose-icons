...
public val TablerIcons.ChartCandle: VectorAsset
    get() {
        if (_chartCandle != null) {
            return _chartCandle!!
        }
        _chartCandle = VectorAssetBuilder(name = "ChartCandle", defaultWidth = 24.0.dp,
...
private var _chartCandle: VectorAsset? = null
