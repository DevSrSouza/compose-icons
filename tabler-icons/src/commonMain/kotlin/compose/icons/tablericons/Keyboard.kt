...
public val TablerIcons.Keyboard: VectorAsset
    get() {
        if (_keyboard != null) {
            return _keyboard!!
        }
        _keyboard = VectorAssetBuilder(name = "Keyboard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _keyboard: VectorAsset? = null
