...
public val TablerIcons.PrismOff: ImageVector
    get() {
        if (_prismOff != null) {
            return _prismOff!!
        }
        _prismOff = Builder(name = "PrismOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                verticalLineToRelative(11.17f)
                curveToRelative(0.0f, 0.25f, -0.037f, 0.495f, -0.109f, 0.729f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.688f, 8.7f)
                arcToRelative(1.7f, 1.7f, 0.0f, false, false, 0.357f, -0.214f)
