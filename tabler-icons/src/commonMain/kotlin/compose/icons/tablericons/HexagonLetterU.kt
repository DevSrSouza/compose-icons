...
public val TablerIcons.HexagonLetterU: ImageVector
    get() {
        if (_hexagonLetterU != null) {
            return _hexagonLetterU!!
        }
        _hexagonLetterU = Builder(name = "HexagonLetterU", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagonLetterU: ImageVector? = null
