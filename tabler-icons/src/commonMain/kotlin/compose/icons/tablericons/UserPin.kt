...
public val TablerIcons.UserPin: ImageVector
    get() {
        if (_userPin != null) {
            return _userPin!!
        }
        _userPin = Builder(name = "UserPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _userPin: ImageVector? = null
