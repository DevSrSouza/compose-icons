...
public val TablerIcons.Subtask: VectorAsset
    get() {
        if (_subtask != null) {
            return _subtask!!
        }
        _subtask = VectorAssetBuilder(name = "Subtask", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineTo(20.0f, 18.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 19.0f, 19.0f)
                lineTo(13.0f, 19.0f)
...
private var _subtask: VectorAsset? = null
