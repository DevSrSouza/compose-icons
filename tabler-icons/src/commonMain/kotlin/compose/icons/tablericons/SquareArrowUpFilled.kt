...
public val TablerIcons.SquareArrowUpFilled: ImageVector
    get() {
        if (_squareArrowUpFilled != null) {
            return _squareArrowUpFilled!!
        }
        _squareArrowUpFilled = Builder(name = "SquareArrowUpFilled", defaultWidth = 24.0.dp,
...
private var _squareArrowUpFilled: ImageVector? = null
