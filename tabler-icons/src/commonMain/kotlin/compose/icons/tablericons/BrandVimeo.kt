...
public val TablerIcons.BrandVimeo: VectorAsset
    get() {
        if (_brandVimeo != null) {
            return _brandVimeo!!
        }
        _brandVimeo = VectorAssetBuilder(name = "BrandVimeo", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(2.05f, -1.254f, 2.551f, 1.003f, 1.5f, 3.0f)
                curveToRelative(-1.052f, 2.005f, -2.0f, 3.0f, -2.5f, 3.0f)
...
private var _brandVimeo: VectorAsset? = null
