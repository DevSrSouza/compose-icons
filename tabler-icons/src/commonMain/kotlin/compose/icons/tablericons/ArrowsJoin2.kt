...
public val TablerIcons.ArrowsJoin2: VectorAsset
    get() {
        if (_arrowsJoin2 != null) {
            return _arrowsJoin2!!
        }
        _arrowsJoin2 = VectorAssetBuilder(name = "ArrowsJoin2", defaultWidth = 24.0.dp,
...
private var _arrowsJoin2: VectorAsset? = null
