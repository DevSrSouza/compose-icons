...
public val TablerIcons.HeartBroken: VectorAsset
    get() {
        if (_heartBroken != null) {
            return _heartBroken!!
        }
        _heartBroken = VectorAssetBuilder(name = "HeartBroken", defaultWidth = 24.0.dp,
...
private var _heartBroken: VectorAsset? = null
