...
public val TablerIcons.LayoutKanban: VectorAsset
    get() {
        if (_layoutKanban != null) {
            return _layoutKanban!!
        }
        _layoutKanban = VectorAssetBuilder(name = "LayoutKanban", defaultWidth = 24.0.dp,
...
private var _layoutKanban: VectorAsset? = null
