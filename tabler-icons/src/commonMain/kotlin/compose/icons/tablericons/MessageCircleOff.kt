...
public val TablerIcons.MessageCircleOff: VectorAsset
    get() {
        if (_messageCircleOff != null) {
            return _messageCircleOff!!
        }
        _messageCircleOff = VectorAssetBuilder(name = "MessageCircleOff", defaultWidth = 24.0.dp,
...
private var _messageCircleOff: VectorAsset? = null
