...
public val TablerIcons.Radioactive: VectorAsset
    get() {
        if (_radioactive != null) {
            return _radioactive!!
        }
        _radioactive = VectorAssetBuilder(name = "Radioactive", defaultWidth = 24.0.dp,
...
private var _radioactive: VectorAsset? = null
