...
public val TablerIcons.KeyboardHide: VectorAsset
    get() {
        if (_keyboardHide != null) {
            return _keyboardHide!!
        }
        _keyboardHide = VectorAssetBuilder(name = "KeyboardHide", defaultWidth = 24.0.dp,
...
private var _keyboardHide: VectorAsset? = null
