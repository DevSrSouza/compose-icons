...
public val TablerIcons.BasketPause: ImageVector
    get() {
        if (_basketPause != null) {
            return _basketPause!!
        }
        _basketPause = Builder(name = "BasketPause", defaultWidth = 24.0.dp, defaultHeight =
