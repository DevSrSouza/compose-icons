    ...
    get() {
        ...
        _brandDrupal = Builder(name = "BrandDrupal", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(12.0f, 2.0f)
                curveToRelative(0.0f, 4.308f, -7.0f, 6.0f, -7.0f, 12.005f)
                arcToRelative(7.0f, 7.0f, 0.0f, false, false, 14.0f, 0.0f)
                curveToRelative(0.0f, -6.005f, -7.0f, -7.697f, -7.0f, -12.005f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                ...
                curveToRelative(-0.996f, 0.957f, -1.988f, 1.967f, -1.988f, 3.647f)
                curveToRelative(0.0f, 2.17f, 1.79f, 3.997f, 4.0f, 3.997f)
                reflectiveCurveToRelative(4.0f, -1.827f, 4.0f, -3.997f)
