...
public val TablerIcons.BrandSketch: VectorAsset
    get() {
        if (_brandSketch != null) {
            return _brandSketch!!
        }
        _brandSketch = VectorAssetBuilder(name = "BrandSketch", defaultWidth = 24.0.dp,
...
private var _brandSketch: VectorAsset? = null
