...
public val TablerIcons.CloudUp: ImageVector
    get() {
        if (_cloudUp != null) {
            return _cloudUp!!
        }
        _cloudUp = Builder(name = "CloudUp", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(1.38f, 0.0f, 2.57f, 0.811f, 3.128f, 1.986f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
