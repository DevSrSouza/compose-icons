...
public val TablerIcons.SquareRoundedLetterI: ImageVector
    get() {
        if (_squareRoundedLetterI != null) {
            return _squareRoundedLetterI!!
        }
        _squareRoundedLetterI = Builder(name = "SquareRoundedLetterI", defaultWidth = 24.0.dp,
