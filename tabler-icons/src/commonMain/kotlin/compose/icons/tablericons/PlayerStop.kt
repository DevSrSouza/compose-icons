...
public val TablerIcons.PlayerStop: VectorAsset
    get() {
        if (_playerStop != null) {
            return _playerStop!!
        }
        _playerStop = VectorAssetBuilder(name = "PlayerStop", defaultWidth = 24.0.dp, defaultHeight
...
private var _playerStop: VectorAsset? = null
