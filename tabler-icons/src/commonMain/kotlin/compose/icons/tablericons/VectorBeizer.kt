...
public val TablerIcons.VectorBeizer: VectorAsset
    get() {
        if (_vectorBeizer != null) {
            return _vectorBeizer!!
        }
        _vectorBeizer = VectorAssetBuilder(name = "VectorBeizer", defaultWidth = 24.0.dp,
...
private var _vectorBeizer: VectorAsset? = null
