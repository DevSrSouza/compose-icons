...
public val TablerIcons.PhoneCheck: VectorAsset
    get() {
        if (_phoneCheck != null) {
            return _phoneCheck!!
        }
        _phoneCheck = VectorAssetBuilder(name = "PhoneCheck", defaultWidth = 24.0.dp, defaultHeight
...
private var _phoneCheck: VectorAsset? = null
