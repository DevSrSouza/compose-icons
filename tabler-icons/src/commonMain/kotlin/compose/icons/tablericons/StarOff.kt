...
public val TablerIcons.StarOff: VectorAsset
    get() {
        if (_starOff != null) {
            return _starOff!!
        }
        _starOff = VectorAssetBuilder(name = "StarOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _starOff: VectorAsset? = null
