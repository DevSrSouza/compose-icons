...
public val TablerIcons.BasketDown: ImageVector
    get() {
        if (_basketDown != null) {
            return _basketDown!!
        }
        _basketDown = Builder(name = "BasketDown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _basketDown: ImageVector? = null
