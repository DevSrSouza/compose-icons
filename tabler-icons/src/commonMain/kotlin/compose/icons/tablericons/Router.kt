...
public val TablerIcons.Router: VectorAsset
    get() {
        if (_router != null) {
            return _router!!
        }
        _router = VectorAssetBuilder(name = "Router", defaultWidth = 24.0.dp, defaultHeight =
...
private var _router: VectorAsset? = null
