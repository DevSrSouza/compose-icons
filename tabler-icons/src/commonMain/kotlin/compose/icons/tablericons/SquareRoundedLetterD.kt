...
public val TablerIcons.SquareRoundedLetterD: ImageVector
    get() {
        if (_squareRoundedLetterD != null) {
            return _squareRoundedLetterD!!
        }
        _squareRoundedLetterD = Builder(name = "SquareRoundedLetterD", defaultWidth = 24.0.dp,
