...
public val TablerIcons.Microphone: VectorAsset
    get() {
        if (_microphone != null) {
            return _microphone!!
        }
        _microphone = VectorAssetBuilder(name = "Microphone", defaultWidth = 24.0.dp, defaultHeight
...
private var _microphone: VectorAsset? = null
