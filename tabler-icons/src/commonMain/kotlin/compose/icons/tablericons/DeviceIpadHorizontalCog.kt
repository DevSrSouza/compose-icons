...
public val TablerIcons.DeviceIpadHorizontalCog: ImageVector
    get() {
        if (_deviceIpadHorizontalCog != null) {
            return _deviceIpadHorizontalCog!!
        }
        _deviceIpadHorizontalCog = Builder(name = "DeviceIpadHorizontalCog", defaultWidth = 24.0.dp,
