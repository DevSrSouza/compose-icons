...
public val TablerIcons.WashTemperature2: ImageVector
    get() {
        if (_washTemperature2 != null) {
            return _washTemperature2!!
        }
        _washTemperature2 = Builder(name = "WashTemperature2", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.79f, -0.007f, 1.539f, 0.18f, 2.0f, 0.5f)
                curveToRelative(0.461f, 0.322f, 1.21f, 0.509f, 2.0f, 0.5f)
                curveToRelative(0.17f, -0.002f, 0.339f, -0.014f, 0.503f, -0.034f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _washTemperature2: ImageVector? = null
