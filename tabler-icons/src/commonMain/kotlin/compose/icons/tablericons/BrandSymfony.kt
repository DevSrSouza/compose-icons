...
public val TablerIcons.BrandSymfony: ImageVector
    get() {
        ...
        _brandSymfony = Builder(name = "BrandSymfony", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, -1.5f, -2.0f, -1.0f, -2.0f, -2.0f)
                curveToRelative(0.0f, -0.625f, 0.516f, -1.5f, 1.5f, -1.5f)
                curveToRelative(2.5f, 0.0f, 1.563f, 2.0f, 5.5f, 2.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.286f, -4.0f, 1.571f, -6.0f, 3.0f, -6.0f)
