...
public val TablerIcons.Devices2: VectorAsset
    get() {
        if (_devices2 != null) {
            return _devices2!!
        }
        _devices2 = VectorAssetBuilder(name = "Devices2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _devices2: VectorAsset? = null
