...
public val TablerIcons.LockPin: ImageVector
    get() {
        if (_lockPin != null) {
            return _lockPin!!
        }
        _lockPin = Builder(name = "LockPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _lockPin: ImageVector? = null
