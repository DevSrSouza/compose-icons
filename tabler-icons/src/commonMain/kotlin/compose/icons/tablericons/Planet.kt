...
public val TablerIcons.Planet: VectorAsset
    get() {
        if (_planet != null) {
            return _planet!!
        }
        _planet = VectorAssetBuilder(name = "Planet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _planet: VectorAsset? = null
