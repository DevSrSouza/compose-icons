    ...
    get() {
        ...
        _brandReact = Builder(name = "BrandReact", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.387f, -0.67f, 0.733f, -1.339f, 1.036f, -1.998f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                curveToRelative(-1.913f, -1.105f, -5.703f, 1.877f, -8.464f, 6.66f)
                curveToRelative(-0.387f, 0.67f, -0.733f, 1.34f, -1.037f, 1.999f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(11.998f, 18.574f)
                curveToRelative(1.926f, 1.893f, 3.821f, 2.768f, 5.002f, 2.086f)
                curveToRelative(1.913f, -1.104f, 1.226f, -5.877f, -1.536f, -10.66f)
