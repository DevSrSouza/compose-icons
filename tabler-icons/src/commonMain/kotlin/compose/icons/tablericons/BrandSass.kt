...
public val TablerIcons.BrandSass: VectorAsset
    get() {
        if (_brandSass != null) {
            return _brandSass!!
        }
        _brandSass = VectorAssetBuilder(name = "BrandSass", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(2.46f, -0.826f, 4.002f, -0.826f, 4.002f, -2.155f)
...
private var _brandSass: VectorAsset? = null
