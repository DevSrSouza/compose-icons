...
public val TablerIcons.BrandElectronicArts: ImageVector
    get() {
        if (_brandElectronicArts != null) {
            return _brandElectronicArts!!
        }
        _brandElectronicArts = Builder(name = "BrandElectronicArts", defaultWidth = 24.0.dp,
