...
public val TablerIcons.MoodTongueWink: ImageVector
    get() {
        if (_moodTongueWink != null) {
            return _moodTongueWink!!
        }
        _moodTongueWink = Builder(name = "MoodTongueWink", defaultWidth = 24.0.dp, defaultHeight =
