...
public val TablerIcons.FileLike: VectorAsset
    get() {
        if (_fileLike != null) {
            return _fileLike!!
        }
        _fileLike = VectorAssetBuilder(name = "FileLike", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.958f, -0.713f)
                ...
                arcToRelative(1.1f, 1.1f, 0.0f, false, false, -2.015f, -0.61f)
...
private var _fileLike: VectorAsset? = null
