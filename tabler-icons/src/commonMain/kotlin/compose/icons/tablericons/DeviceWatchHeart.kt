...
public val TablerIcons.DeviceWatchHeart: ImageVector
    get() {
        if (_deviceWatchHeart != null) {
            return _deviceWatchHeart!!
        }
        _deviceWatchHeart = Builder(name = "DeviceWatchHeart", defaultWidth = 24.0.dp, defaultHeight
...
private var _deviceWatchHeart: ImageVector? = null
