...
public val TablerIcons.CameraRotate: ImageVector
    get() {
        ...
        _cameraRotate = Builder(name = "CameraRotate", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 3.755f, -2.904f)
                moveToRelative(-2.25f, -2.905f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -3.75f, 2.905f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
