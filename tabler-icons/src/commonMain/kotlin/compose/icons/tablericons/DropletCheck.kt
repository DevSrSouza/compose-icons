...
public val TablerIcons.DropletCheck: ImageVector
    get() {
        if (_dropletCheck != null) {
            return _dropletCheck!!
        }
        _dropletCheck = Builder(name = "DropletCheck", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.967f, 13.594f)
                arcToRelative(6.568f, 6.568f, 0.0f, false, false, -0.903f, -2.717f)
                ...
                arcToRelative(7.125f, 7.125f, 0.0f, false, false, 4.04f, 1.565f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
