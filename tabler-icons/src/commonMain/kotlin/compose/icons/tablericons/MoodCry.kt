...
public val TablerIcons.MoodCry: VectorAsset
    get() {
        if (_moodCry != null) {
            return _moodCry!!
        }
        _moodCry = VectorAssetBuilder(name = "MoodCry", defaultWidth = 24.0.dp, defaultHeight =
...
private var _moodCry: VectorAsset? = null
