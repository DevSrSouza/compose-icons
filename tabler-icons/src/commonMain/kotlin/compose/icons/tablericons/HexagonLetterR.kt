...
public val TablerIcons.HexagonLetterR: ImageVector
    get() {
        if (_hexagonLetterR != null) {
            return _hexagonLetterR!!
        }
        _hexagonLetterR = Builder(name = "HexagonLetterR", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagonLetterR: ImageVector? = null
