...
public val TablerIcons.DeviceIpadHeart: ImageVector
    get() {
        if (_deviceIpadHeart != null) {
            return _deviceIpadHeart!!
        }
        _deviceIpadHeart = Builder(name = "DeviceIpadHeart", defaultWidth = 24.0.dp, defaultHeight =
