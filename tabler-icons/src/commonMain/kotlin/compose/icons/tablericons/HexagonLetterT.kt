...
public val TablerIcons.HexagonLetterT: ImageVector
    get() {
        if (_hexagonLetterT != null) {
            return _hexagonLetterT!!
        }
        _hexagonLetterT = Builder(name = "HexagonLetterT", defaultWidth = 24.0.dp, defaultHeight =
