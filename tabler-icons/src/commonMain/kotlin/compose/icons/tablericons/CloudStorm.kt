...
public val TablerIcons.CloudStorm: VectorAsset
    get() {
        if (_cloudStorm != null) {
            return _cloudStorm!!
        }
        _cloudStorm = VectorAssetBuilder(name = "CloudStorm", defaultWidth = 24.0.dp, defaultHeight
...
private var _cloudStorm: VectorAsset? = null
