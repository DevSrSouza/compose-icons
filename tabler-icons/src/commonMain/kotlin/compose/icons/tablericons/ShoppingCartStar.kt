...
public val TablerIcons.ShoppingCartStar: ImageVector
    get() {
        if (_shoppingCartStar != null) {
            return _shoppingCartStar!!
        }
        _shoppingCartStar = Builder(name = "ShoppingCartStar", defaultWidth = 24.0.dp, defaultHeight
