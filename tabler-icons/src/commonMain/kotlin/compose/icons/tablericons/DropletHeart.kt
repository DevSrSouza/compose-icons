...
public val TablerIcons.DropletHeart: ImageVector
    get() {
        if (_dropletHeart != null) {
            return _dropletHeart!!
        }
        _dropletHeart = Builder(name = "DropletHeart", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.288f, 11.282f)
                arcToRelative(6.734f, 6.734f, 0.0f, false, false, -0.224f, -0.405f)
                ...
                arcToRelative(7.117f, 7.117f, 0.0f, false, false, 3.824f, 1.548f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
