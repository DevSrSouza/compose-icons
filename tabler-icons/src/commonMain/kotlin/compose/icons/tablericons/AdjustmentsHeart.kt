...
public val TablerIcons.AdjustmentsHeart: ImageVector
    get() {
        if (_adjustmentsHeart != null) {
            return _adjustmentsHeart!!
        }
        _adjustmentsHeart = Builder(name = "AdjustmentsHeart", defaultWidth = 24.0.dp, defaultHeight
...
private var _adjustmentsHeart: ImageVector? = null
