...
public val TablerIcons.AdjustmentsPin: ImageVector
    get() {
        if (_adjustmentsPin != null) {
            return _adjustmentsPin!!
        }
        _adjustmentsPin = Builder(name = "AdjustmentsPin", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(13.071f, 14.31f)
                arcToRelative(2.0f, 2.0f, 0.0f, true, false, -1.071f, 3.69f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
