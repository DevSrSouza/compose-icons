...
public val TablerIcons.TransactionEuro: ImageVector
    get() {
        if (_transactionEuro != null) {
            return _transactionEuro!!
        }
        _transactionEuro = Builder(name = "TransactionEuro", defaultWidth = 24.0.dp, defaultHeight =
