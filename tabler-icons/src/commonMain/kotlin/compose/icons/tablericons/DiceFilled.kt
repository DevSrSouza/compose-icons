...
public val TablerIcons.DiceFilled: ImageVector
    get() {
        if (_diceFilled != null) {
            return _diceFilled!!
        }
        _diceFilled = Builder(name = "DiceFilled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _diceFilled: ImageVector? = null
