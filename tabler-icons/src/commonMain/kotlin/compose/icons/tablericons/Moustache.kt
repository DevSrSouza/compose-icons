    ...
    get() {
        ...
        _moustache = Builder(name = "Moustache", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineToRelative(0.291f, -0.006f)
                lineToRelative(0.77f, -0.044f)
                lineToRelative(0.213f, -0.006f)
                curveToRelative(-0.963f, 1.926f, -3.163f, 2.925f, -6.6f, 2.996f)
                lineToRelative(-0.4f, 0.004f)
                lineToRelative(-0.165f, -0.005f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 0.165f, -5.995f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                ...
                lineToRelative(0.4f, 0.004f)
                lineToRelative(0.165f, -0.005f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -0.165f, -5.995f)
                close()
            }
        }
        .build()
