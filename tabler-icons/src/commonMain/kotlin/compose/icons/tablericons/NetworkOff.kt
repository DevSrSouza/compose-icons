    ...
    get() {
        ...
        _networkOff = Builder(name = "NetworkOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 7.942f, 7.933f)
                moveToRelative(2.247f, -1.76f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -8.427f, -8.425f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                curveToRelative(0.0f, 0.337f, -0.006f, 0.66f, -0.017f, 0.968f)
