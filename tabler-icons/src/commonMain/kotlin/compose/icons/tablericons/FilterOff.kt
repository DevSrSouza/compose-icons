...
public val TablerIcons.FilterOff: VectorAsset
    get() {
        if (_filterOff != null) {
            return _filterOff!!
        }
        _filterOff = VectorAssetBuilder(name = "FilterOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _filterOff: VectorAsset? = null
