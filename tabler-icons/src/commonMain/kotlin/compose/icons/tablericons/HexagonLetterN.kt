...
public val TablerIcons.HexagonLetterN: ImageVector
    get() {
        if (_hexagonLetterN != null) {
            return _hexagonLetterN!!
        }
        _hexagonLetterN = Builder(name = "HexagonLetterN", defaultWidth = 24.0.dp, defaultHeight =
