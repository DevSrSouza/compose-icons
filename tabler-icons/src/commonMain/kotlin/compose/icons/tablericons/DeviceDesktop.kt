...
public val TablerIcons.DeviceDesktop: VectorAsset
    get() {
        if (_deviceDesktop != null) {
            return _deviceDesktop!!
        }
        _deviceDesktop = VectorAssetBuilder(name = "DeviceDesktop", defaultWidth = 24.0.dp,
...
private var _deviceDesktop: VectorAsset? = null
