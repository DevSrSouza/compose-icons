...
public val TablerIcons.WashTemperature6: ImageVector
    get() {
        if (_washTemperature6 != null) {
            return _washTemperature6!!
        }
        _washTemperature6 = Builder(name = "WashTemperature6", defaultWidth = 24.0.dp, defaultHeight
