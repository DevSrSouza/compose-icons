...
public val TablerIcons.BrandWindows: VectorAsset
    get() {
        if (_brandWindows != null) {
            return _brandWindows!!
        }
        _brandWindows = VectorAssetBuilder(name = "BrandWindows", defaultWidth = 24.0.dp,
...
private var _brandWindows: VectorAsset? = null
