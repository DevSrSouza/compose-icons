...
public val TablerIcons.BrandGithub: VectorAsset
    get() {
        if (_brandGithub != null) {
            return _brandGithub!!
        }
        _brandGithub = VectorAssetBuilder(name = "BrandGithub", defaultWidth = 24.0.dp,
...
private var _brandGithub: VectorAsset? = null
