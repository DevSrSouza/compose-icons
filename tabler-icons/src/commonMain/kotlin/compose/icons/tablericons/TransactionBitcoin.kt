...
public val TablerIcons.TransactionBitcoin: ImageVector
    get() {
        if (_transactionBitcoin != null) {
            return _transactionBitcoin!!
        }
        _transactionBitcoin = Builder(name = "TransactionBitcoin", defaultWidth = 24.0.dp,
