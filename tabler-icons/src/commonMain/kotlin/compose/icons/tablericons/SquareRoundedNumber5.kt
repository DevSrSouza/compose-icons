...
public val TablerIcons.SquareRoundedNumber5: ImageVector
    get() {
        if (_squareRoundedNumber5 != null) {
            return _squareRoundedNumber5!!
        }
        _squareRoundedNumber5 = Builder(name = "SquareRoundedNumber5", defaultWidth = 24.0.dp,
