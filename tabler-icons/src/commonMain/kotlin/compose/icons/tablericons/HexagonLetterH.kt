...
public val TablerIcons.HexagonLetterH: ImageVector
    get() {
        if (_hexagonLetterH != null) {
            return _hexagonLetterH!!
        }
        _hexagonLetterH = Builder(name = "HexagonLetterH", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagonLetterH: ImageVector? = null
