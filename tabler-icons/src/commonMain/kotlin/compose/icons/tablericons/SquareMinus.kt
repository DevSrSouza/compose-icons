...
public val TablerIcons.SquareMinus: VectorAsset
    get() {
        if (_squareMinus != null) {
            return _squareMinus!!
        }
        _squareMinus = VectorAssetBuilder(name = "SquareMinus", defaultWidth = 24.0.dp,
...
private var _squareMinus: VectorAsset? = null
