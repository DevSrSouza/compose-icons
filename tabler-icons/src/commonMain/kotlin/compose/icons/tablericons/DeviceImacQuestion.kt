...
public val TablerIcons.DeviceImacQuestion: ImageVector
    get() {
        if (_deviceImacQuestion != null) {
            return _deviceImacQuestion!!
        }
        _deviceImacQuestion = Builder(name = "DeviceImacQuestion", defaultWidth = 24.0.dp,
