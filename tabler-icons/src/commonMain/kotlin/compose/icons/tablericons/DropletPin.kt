...
public val TablerIcons.DropletPin: ImageVector
    get() {
        if (_dropletPin != null) {
            return _dropletPin!!
        }
        _dropletPin = Builder(name = "DropletPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(7.163f, 7.163f, 0.0f, false, false, 5.102f, 1.554f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
