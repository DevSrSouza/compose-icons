...
public val TablerIcons.LocationCancel: ImageVector
    get() {
        if (_locationCancel != null) {
            return _locationCancel!!
        }
        _locationCancel = Builder(name = "LocationCancel", defaultWidth = 24.0.dp, defaultHeight =
