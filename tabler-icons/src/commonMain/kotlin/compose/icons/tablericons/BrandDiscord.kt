...
public val TablerIcons.BrandDiscord: VectorAsset
    get() {
        if (_brandDiscord != null) {
            return _brandDiscord!!
        }
        _brandDiscord = VectorAssetBuilder(name = "BrandDiscord", defaultWidth = 24.0.dp,
...
private var _brandDiscord: VectorAsset? = null
