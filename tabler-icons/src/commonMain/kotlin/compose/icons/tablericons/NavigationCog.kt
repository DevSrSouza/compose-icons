...
public val TablerIcons.NavigationCog: ImageVector
    get() {
        if (_navigationCog != null) {
            return _navigationCog!!
        }
        _navigationCog = Builder(name = "NavigationCog", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.387f, 12.51f)
                lineToRelative(-4.387f, -9.51f)
...
private var _navigationCog: ImageVector? = null
