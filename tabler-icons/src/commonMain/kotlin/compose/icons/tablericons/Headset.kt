...
public val TablerIcons.Headset: VectorAsset
    get() {
        if (_headset != null) {
            return _headset!!
        }
        _headset = VectorAssetBuilder(name = "Headset", defaultWidth = 24.0.dp, defaultHeight =
...
private var _headset: VectorAsset? = null
