...
public val TablerIcons.HelpOff: ImageVector
    get() {
        if (_helpOff != null) {
            return _helpOff!!
        }
        _helpOff = Builder(name = "HelpOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.0f, 13.5f)
                arcToRelative(1.5f, 1.5f, 0.0f, false, true, 0.394f, -1.1f)
                moveToRelative(2.106f, -1.9f)
                arcToRelative(2.6f, 2.6f, 0.0f, false, false, -3.347f, -3.361f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
