...
public val TablerIcons.Rectangle: VectorAsset
    get() {
        if (_rectangle != null) {
            return _rectangle!!
        }
        _rectangle = VectorAssetBuilder(name = "Rectangle", defaultWidth = 24.0.dp, defaultHeight =
...
private var _rectangle: VectorAsset? = null
