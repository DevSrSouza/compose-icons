...
public val TablerIcons.HexagonLetterJ: ImageVector
    get() {
        if (_hexagonLetterJ != null) {
            return _hexagonLetterJ!!
        }
        _hexagonLetterJ = Builder(name = "HexagonLetterJ", defaultWidth = 24.0.dp, defaultHeight =
