...
public val TablerIcons.ShareOff: ImageVector
    get() {
        if (_shareOff != null) {
            return _shareOff!!
        }
        _shareOff = Builder(name = "ShareOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 4.265f, 4.22f)
                moveToRelative(0.578f, -3.417f)
                arcToRelative(3.012f, 3.012f, 0.0f, false, false, -1.507f, -1.45f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
