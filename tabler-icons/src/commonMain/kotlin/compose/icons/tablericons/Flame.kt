...
public val TablerIcons.Flame: VectorAsset
    get() {
        if (_flame != null) {
            return _flame!!
        }
        _flame = VectorAssetBuilder(name = "Flame", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flame: VectorAsset? = null
