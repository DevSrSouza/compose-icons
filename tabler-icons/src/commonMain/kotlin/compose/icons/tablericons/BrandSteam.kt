...
public val TablerIcons.BrandSteam: VectorAsset
    get() {
        if (_brandSteam != null) {
            return _brandSteam!!
        }
        _brandSteam = VectorAssetBuilder(name = "BrandSteam", defaultWidth = 24.0.dp, defaultHeight
...
private var _brandSteam: VectorAsset? = null
