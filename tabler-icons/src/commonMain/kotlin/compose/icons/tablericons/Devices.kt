...
public val TablerIcons.Devices: VectorAsset
    get() {
        if (_devices != null) {
            return _devices!!
        }
        _devices = VectorAssetBuilder(name = "Devices", defaultWidth = 24.0.dp, defaultHeight =
...
private var _devices: VectorAsset? = null
