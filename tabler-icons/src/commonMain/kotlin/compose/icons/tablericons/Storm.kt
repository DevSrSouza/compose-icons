...
public val TablerIcons.Storm: ImageVector
    get() {
        if (_storm != null) {
            return _storm!!
        }
        _storm = Builder(name = "Storm", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(-1.839f, -3.929f, -1.561f, -7.616f, -0.704f, -11.236f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.63f, 9.76f)
                curveToRelative(1.837f, 3.928f, 1.561f, 7.615f, 0.703f, 11.236f)
            }
        }
        .build()
        return _storm!!
