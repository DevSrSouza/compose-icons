...
public val TablerIcons.MessageCircleStar: ImageVector
    get() {
        if (_messageCircleStar != null) {
            return _messageCircleStar!!
        }
        _messageCircleStar = Builder(name = "MessageCircleStar", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.517f, 19.869f)
                arcToRelative(9.757f, 9.757f, 0.0f, false, true, -2.817f, -0.869f)
                ...
                curveToRelative(1.666f, 1.421f, 2.594f, 3.29f, 2.747f, 5.21f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _messageCircleStar: ImageVector? = null
