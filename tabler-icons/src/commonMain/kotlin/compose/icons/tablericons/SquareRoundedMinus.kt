...
public val TablerIcons.SquareRoundedMinus: ImageVector
    get() {
        if (_squareRoundedMinus != null) {
            return _squareRoundedMinus!!
        }
        _squareRoundedMinus = Builder(name = "SquareRoundedMinus", defaultWidth = 24.0.dp,
