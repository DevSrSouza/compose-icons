...
public val TablerIcons.BrandEdge: VectorAsset
    get() {
        if (_brandEdge != null) {
            return _brandEdge!!
        }
        _brandEdge = VectorAssetBuilder(name = "BrandEdge", defaultWidth = 24.0.dp, defaultHeight =
...
private var _brandEdge: VectorAsset? = null
