...
public val TablerIcons.RotateRectangle: VectorAsset
    get() {
        if (_rotateRectangle != null) {
            return _rotateRectangle!!
        }
        _rotateRectangle = VectorAssetBuilder(name = "RotateRectangle", defaultWidth = 24.0.dp,
...
private var _rotateRectangle: VectorAsset? = null
