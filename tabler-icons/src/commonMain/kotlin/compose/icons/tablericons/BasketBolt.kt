...
public val TablerIcons.BasketBolt: ImageVector
    get() {
        if (_basketBolt != null) {
            return _basketBolt!!
        }
        _basketBolt = Builder(name = "BasketBolt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
