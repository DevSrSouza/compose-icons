...
public val TablerIcons.Snowflake: VectorAsset
    get() {
        if (_snowflake != null) {
            return _snowflake!!
        }
        _snowflake = VectorAssetBuilder(name = "Snowflake", defaultWidth = 24.0.dp, defaultHeight =
...
private var _snowflake: VectorAsset? = null
