...
public val TablerIcons.CrutchesOff: ImageVector
    get() {
        if (_crutchesOff != null) {
            return _crutchesOff!!
        }
        _crutchesOff = Builder(name = "CrutchesOff", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.178f, 4.174f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.822f, -1.174f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 0.097f, -0.155f)
