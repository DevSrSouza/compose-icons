...
public val TablerIcons.BrandApple: VectorAsset
    get() {
        if (_brandApple != null) {
            return _brandApple!!
        }
        _brandApple = VectorAssetBuilder(name = "BrandApple", defaultWidth = 24.0.dp, defaultHeight
...
private var _brandApple: VectorAsset? = null
