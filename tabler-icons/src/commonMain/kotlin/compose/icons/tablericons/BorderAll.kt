...
public val TablerIcons.BorderAll: VectorAsset
    get() {
        if (_borderAll != null) {
            return _borderAll!!
        }
        _borderAll = VectorAssetBuilder(name = "BorderAll", defaultWidth = 24.0.dp, defaultHeight =
...
private var _borderAll: VectorAsset? = null
