...
public val TablerIcons.Qrcode: VectorAsset
    get() {
        if (_qrcode != null) {
            return _qrcode!!
        }
        _qrcode = VectorAssetBuilder(name = "Qrcode", defaultWidth = 24.0.dp, defaultHeight =
...
private var _qrcode: VectorAsset? = null
