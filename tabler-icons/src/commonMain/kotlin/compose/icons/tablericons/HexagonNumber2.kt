...
public val TablerIcons.HexagonNumber2: ImageVector
    get() {
        if (_hexagonNumber2 != null) {
            return _hexagonNumber2!!
        }
        _hexagonNumber2 = Builder(name = "HexagonNumber2", defaultWidth = 24.0.dp, defaultHeight =
