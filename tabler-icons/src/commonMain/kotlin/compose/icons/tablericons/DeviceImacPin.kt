...
public val TablerIcons.DeviceImacPin: ImageVector
    get() {
        if (_deviceImacPin != null) {
            return _deviceImacPin!!
        }
        _deviceImacPin = Builder(name = "DeviceImacPin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deviceImacPin: ImageVector? = null
