...
public val TablerIcons.EyePin: ImageVector
    get() {
        if (_eyePin != null) {
            return _eyePin!!
        }
        _eyePin = Builder(name = "EyePin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(3.362f, 0.0f, 6.202f, 1.745f, 8.517f, 5.234f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _eyePin: ImageVector? = null
