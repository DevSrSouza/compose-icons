...
public val TablerIcons.ShoppingCartQuestion: ImageVector
    get() {
        if (_shoppingCartQuestion != null) {
            return _shoppingCartQuestion!!
        }
        _shoppingCartQuestion = Builder(name = "ShoppingCartQuestion", defaultWidth = 24.0.dp,
