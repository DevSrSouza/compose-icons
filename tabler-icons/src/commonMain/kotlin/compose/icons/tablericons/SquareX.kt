...
public val TablerIcons.SquareX: VectorAsset
    get() {
        if (_squareX != null) {
            return _squareX!!
        }
        _squareX = VectorAssetBuilder(name = "SquareX", defaultWidth = 24.0.dp, defaultHeight =
...
private var _squareX: VectorAsset? = null
