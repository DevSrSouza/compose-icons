...
public val TablerIcons.Outlet: VectorAsset
    get() {
        if (_outlet != null) {
            return _outlet!!
        }
        _outlet = VectorAssetBuilder(name = "Outlet", defaultWidth = 24.0.dp, defaultHeight =
...
private var _outlet: VectorAsset? = null
