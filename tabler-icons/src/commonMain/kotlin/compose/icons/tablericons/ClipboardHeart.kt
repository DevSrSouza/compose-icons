    ...
    get() {
        ...
        _clipboardHeart = Builder(name = "ClipboardHeart", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(1.9f, 1.9f, 0.0f, false, false, 0.005f, -2.632f)
                arcToRelative(1.775f, 1.775f, 0.0f, false, false, -2.56f, -0.005f)
                lineToRelative(-0.183f, 0.188f)
                lineToRelative(-0.183f, -0.189f)
                arcToRelative(1.775f, 1.775f, 0.0f, false, false, -2.56f, -0.004f)
                arcToRelative(1.899f, 1.899f, 0.0f, false, false, -0.004f, 2.632f)
