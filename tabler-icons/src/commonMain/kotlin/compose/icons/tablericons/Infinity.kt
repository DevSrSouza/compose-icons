...
public val TablerIcons.Infinity: VectorAsset
    get() {
        if (_infinity != null) {
            return _infinity!!
        }
        _infinity = VectorAssetBuilder(name = "Infinity", defaultWidth = 24.0.dp, defaultHeight =
...
private var _infinity: VectorAsset? = null
