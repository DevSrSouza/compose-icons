...
public val TablerIcons.PhotoSquareRounded: ImageVector
    get() {
        if (_photoSquareRounded != null) {
            return _photoSquareRounded!!
        }
        _photoSquareRounded = Builder(name = "PhotoSquareRounded", defaultWidth = 24.0.dp,
