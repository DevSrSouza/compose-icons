...
public val TablerIcons.WaveSine: VectorAsset
    get() {
        if (_waveSine != null) {
            return _waveSine!!
        }
        _waveSine = VectorAssetBuilder(name = "WaveSine", defaultWidth = 24.0.dp, defaultHeight =
...
private var _waveSine: VectorAsset? = null
