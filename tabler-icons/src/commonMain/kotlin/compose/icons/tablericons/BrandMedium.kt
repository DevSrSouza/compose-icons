...
public val TablerIcons.BrandMedium: VectorAsset
    get() {
        if (_brandMedium != null) {
            return _brandMedium!!
        }
        _brandMedium = VectorAssetBuilder(name = "BrandMedium", defaultWidth = 24.0.dp,
...
private var _brandMedium: VectorAsset? = null
