...
public val TablerIcons.SquareRoundedChevronRight: ImageVector
    get() {
        if (_squareRoundedChevronRight != null) {
            return _squareRoundedChevronRight!!
        }
        _squareRoundedChevronRight = Builder(name = "SquareRoundedChevronRight", defaultWidth =
