...
public val TablerIcons.BrightnessOff: ImageVector
    get() {
        if (_brightnessOff != null) {
            return _brightnessOff!!
        }
        _brightnessOff = Builder(name = "BrightnessOff", defaultWidth = 24.0.dp, defaultHeight =
