...
public val TablerIcons.SquareRoundedNumber2: ImageVector
    get() {
        if (_squareRoundedNumber2 != null) {
            return _squareRoundedNumber2!!
        }
        _squareRoundedNumber2 = Builder(name = "SquareRoundedNumber2", defaultWidth = 24.0.dp,
