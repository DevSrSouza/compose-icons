...
public val TablerIcons.Speedboat: VectorAsset
    get() {
        if (_speedboat != null) {
            return _speedboat!!
        }
        _speedboat = VectorAssetBuilder(name = "Speedboat", defaultWidth = 24.0.dp, defaultHeight =
...
private var _speedboat: VectorAsset? = null
