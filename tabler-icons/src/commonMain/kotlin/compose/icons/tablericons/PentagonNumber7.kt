...
public val TablerIcons.PentagonNumber7: ImageVector
    get() {
        if (_pentagonNumber7 != null) {
            return _pentagonNumber7!!
        }
        _pentagonNumber7 = Builder(name = "PentagonNumber7", defaultWidth = 24.0.dp, defaultHeight =
