...
public val TablerIcons.PinnedOff: VectorAsset
    get() {
        if (_pinnedOff != null) {
            return _pinnedOff!!
        }
        _pinnedOff = VectorAssetBuilder(name = "PinnedOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pinnedOff: VectorAsset? = null
