...
public val TablerIcons.BorderOuter: VectorAsset
    get() {
        if (_borderOuter != null) {
            return _borderOuter!!
        }
        _borderOuter = VectorAssetBuilder(name = "BorderOuter", defaultWidth = 24.0.dp,
...
private var _borderOuter: VectorAsset? = null
