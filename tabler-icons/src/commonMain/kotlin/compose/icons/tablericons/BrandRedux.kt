    ...
    get() {
        ...
        _brandRedux = Builder(name = "BrandRedux", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 1.956f, 1.582f, 4.727f, 2.512f, 5.996f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(0.997f, 0.997f, 0.0f, false, false, -0.367f, -1.365f)
                arcToRelative(1.007f, 1.007f, 0.0f, false, false, -1.373f, 0.366f)
                arcToRelative(0.997f, 0.997f, 0.0f, false, false, 0.368f, 1.365f)
                close()
            }
        }
        .build()
