...
public val TablerIcons.BrandTabler: VectorAsset
    get() {
        if (_brandTabler != null) {
            return _brandTabler!!
        }
        _brandTabler = VectorAssetBuilder(name = "BrandTabler", defaultWidth = 24.0.dp,
...
private var _brandTabler: VectorAsset? = null
