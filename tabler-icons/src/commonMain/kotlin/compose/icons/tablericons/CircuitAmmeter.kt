...
public val TablerIcons.CircuitAmmeter: ImageVector
    get() {
        if (_circuitAmmeter != null) {
            return _circuitAmmeter!!
        }
        _circuitAmmeter = Builder(name = "CircuitAmmeter", defaultWidth = 24.0.dp, defaultHeight =
