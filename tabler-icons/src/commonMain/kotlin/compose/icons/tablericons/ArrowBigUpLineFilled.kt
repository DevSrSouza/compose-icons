...
public val TablerIcons.ArrowBigUpLineFilled: ImageVector
    get() {
        if (_arrowBigUpLineFilled != null) {
            return _arrowBigUpLineFilled!!
        }
        _arrowBigUpLineFilled = Builder(name = "ArrowBigUpLineFilled", defaultWidth = 24.0.dp,
...
private var _arrowBigUpLineFilled: ImageVector? = null
