...
public val TablerIcons.LayoutNavbar: VectorAsset
    get() {
        if (_layoutNavbar != null) {
            return _layoutNavbar!!
        }
        _layoutNavbar = VectorAssetBuilder(name = "LayoutNavbar", defaultWidth = 24.0.dp,
...
private var _layoutNavbar: VectorAsset? = null
