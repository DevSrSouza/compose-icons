...
public val TablerIcons.SquareRoundedChevronLeft: ImageVector
    get() {
        if (_squareRoundedChevronLeft != null) {
            return _squareRoundedChevronLeft!!
        }
        _squareRoundedChevronLeft = Builder(name = "SquareRoundedChevronLeft", defaultWidth =
