...
public val TablerIcons.SquareRoundedNumber7: ImageVector
    get() {
        if (_squareRoundedNumber7 != null) {
            return _squareRoundedNumber7!!
        }
        _squareRoundedNumber7 = Builder(name = "SquareRoundedNumber7", defaultWidth = 24.0.dp,
