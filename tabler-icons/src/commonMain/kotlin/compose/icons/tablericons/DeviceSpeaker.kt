...
public val TablerIcons.DeviceSpeaker: VectorAsset
    get() {
        if (_deviceSpeaker != null) {
            return _deviceSpeaker!!
        }
        _deviceSpeaker = VectorAssetBuilder(name = "DeviceSpeaker", defaultWidth = 24.0.dp,
...
private var _deviceSpeaker: VectorAsset? = null
