...
public val TablerIcons.BrandFoursquare: VectorAsset
    get() {
        if (_brandFoursquare != null) {
            return _brandFoursquare!!
        }
        _brandFoursquare = VectorAssetBuilder(name = "BrandFoursquare", defaultWidth = 24.0.dp,
...
private var _brandFoursquare: VectorAsset? = null
