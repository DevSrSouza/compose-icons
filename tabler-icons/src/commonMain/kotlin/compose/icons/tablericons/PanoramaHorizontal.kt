...
public val TablerIcons.PanoramaHorizontal: VectorAsset
    get() {
        if (_panoramaHorizontal != null) {
            return _panoramaHorizontal!!
        }
        _panoramaHorizontal = VectorAssetBuilder(name = "PanoramaHorizontal", defaultWidth =
...
private var _panoramaHorizontal: VectorAsset? = null
