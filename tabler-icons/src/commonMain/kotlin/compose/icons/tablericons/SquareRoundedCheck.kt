...
public val TablerIcons.SquareRoundedCheck: ImageVector
    get() {
        if (_squareRoundedCheck != null) {
            return _squareRoundedCheck!!
        }
        _squareRoundedCheck = Builder(name = "SquareRoundedCheck", defaultWidth = 24.0.dp,
