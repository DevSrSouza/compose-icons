...
public val TablerIcons.PhonePlus: VectorAsset
    get() {
        if (_phonePlus != null) {
            return _phonePlus!!
        }
        _phonePlus = VectorAssetBuilder(name = "PhonePlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phonePlus: VectorAsset? = null
