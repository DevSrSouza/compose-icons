...
public val TablerIcons.Parachute: VectorAsset
    get() {
        if (_parachute != null) {
            return _parachute!!
        }
        _parachute = VectorAssetBuilder(name = "Parachute", defaultWidth = 24.0.dp, defaultHeight =
...
private var _parachute: VectorAsset? = null
