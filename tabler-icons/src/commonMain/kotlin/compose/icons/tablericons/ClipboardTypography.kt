...
public val TablerIcons.ClipboardTypography: ImageVector
    get() {
        if (_clipboardTypography != null) {
            return _clipboardTypography!!
        }
        _clipboardTypography = Builder(name = "ClipboardTypography", defaultWidth = 24.0.dp,
