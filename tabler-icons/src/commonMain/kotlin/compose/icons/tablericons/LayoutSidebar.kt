...
public val TablerIcons.LayoutSidebar: VectorAsset
    get() {
        if (_layoutSidebar != null) {
            return _layoutSidebar!!
        }
        _layoutSidebar = VectorAssetBuilder(name = "LayoutSidebar", defaultWidth = 24.0.dp,
...
private var _layoutSidebar: VectorAsset? = null
