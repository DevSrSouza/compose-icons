...
public val TablerIcons.DeviceMobileVibration: VectorAsset
    get() {
        if (_deviceMobileVibration != null) {
            return _deviceMobileVibration!!
        }
        _deviceMobileVibration = VectorAssetBuilder(name = "DeviceMobileVibration", defaultWidth =
...
private var _deviceMobileVibration: VectorAsset? = null
