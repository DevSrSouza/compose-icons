...
public val TablerIcons.LayoutList: VectorAsset
    get() {
        if (_layoutList != null) {
            return _layoutList!!
        }
        _layoutList = VectorAssetBuilder(name = "LayoutList", defaultWidth = 24.0.dp, defaultHeight
...
private var _layoutList: VectorAsset? = null
