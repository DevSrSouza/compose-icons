...
public val TablerIcons.LocationCog: ImageVector
    get() {
        if (_locationCog != null) {
            return _locationCog!!
        }
        _locationCog = Builder(name = "LocationCog", defaultWidth = 24.0.dp, defaultHeight =
