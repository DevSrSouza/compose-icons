...
public val TablerIcons.BrandFirefox: VectorAsset
    get() {
        if (_brandFirefox != null) {
            return _brandFirefox!!
        }
        _brandFirefox = VectorAssetBuilder(name = "BrandFirefox", defaultWidth = 24.0.dp,
...
private var _brandFirefox: VectorAsset? = null
