...
public val TablerIcons.WashTemperature1: ImageVector
    get() {
        if (_washTemperature1 != null) {
            return _washTemperature1!!
        }
        _washTemperature1 = Builder(name = "WashTemperature1", defaultWidth = 24.0.dp, defaultHeight
