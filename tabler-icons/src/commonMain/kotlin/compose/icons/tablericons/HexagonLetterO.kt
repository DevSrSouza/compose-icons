...
public val TablerIcons.HexagonLetterO: ImageVector
    get() {
        if (_hexagonLetterO != null) {
            return _hexagonLetterO!!
        }
        _hexagonLetterO = Builder(name = "HexagonLetterO", defaultWidth = 24.0.dp, defaultHeight =
