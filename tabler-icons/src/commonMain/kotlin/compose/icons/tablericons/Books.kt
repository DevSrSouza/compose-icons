...
public val TablerIcons.Books: ImageVector
    get() {
        if (_books != null) {
            return _books!!
        }
        _books = Builder(name = "Books", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(13.803f, 4.56f)
                lineToRelative(2.184f, -0.53f)
                curveToRelative(0.562f, -0.135f, 1.133f, 0.19f, 1.282f, 0.732f)
                lineToRelative(3.695f, 13.418f)
                arcToRelative(1.02f, 1.02f, 0.0f, false, true, -0.634f, 1.219f)
                lineToRelative(-0.133f, 0.041f)
                lineToRelative(-2.184f, 0.53f)
                curveToRelative(-0.562f, 0.135f, -1.133f, -0.19f, -1.282f, -0.732f)
                lineToRelative(-3.695f, -13.418f)
                arcToRelative(1.02f, 1.02f, 0.0f, false, true, 0.634f, -1.219f)
