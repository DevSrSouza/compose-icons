...
public val TablerIcons.RelationOneToOne: VectorAsset
    get() {
        if (_relationOneToOne != null) {
            return _relationOneToOne!!
        }
        _relationOneToOne = VectorAssetBuilder(name = "RelationOneToOne", defaultWidth = 24.0.dp,
...
private var _relationOneToOne: VectorAsset? = null
