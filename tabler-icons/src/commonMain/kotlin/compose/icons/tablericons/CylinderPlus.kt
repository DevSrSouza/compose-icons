...
public val TablerIcons.CylinderPlus: ImageVector
    get() {
        if (_cylinderPlus != null) {
            return _cylinderPlus!!
        }
        _cylinderPlus = Builder(name = "CylinderPlus", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.173f, 0.0f, 0.345f, -0.003f, 0.515f, -0.008f)
