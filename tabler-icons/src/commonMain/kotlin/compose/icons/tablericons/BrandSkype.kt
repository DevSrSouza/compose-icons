...
public val TablerIcons.BrandSkype: VectorAsset
    get() {
        if (_brandSkype != null) {
            return _brandSkype!!
        }
        _brandSkype = VectorAssetBuilder(name = "BrandSkype", defaultWidth = 24.0.dp, defaultHeight
...
private var _brandSkype: VectorAsset? = null
