...
public val TablerIcons.BrandAppleArcade: VectorAsset
    get() {
        if (_brandAppleArcade != null) {
            return _brandAppleArcade!!
        }
        _brandAppleArcade = VectorAssetBuilder(name = "BrandAppleArcade", defaultWidth = 24.0.dp,
...
private var _brandAppleArcade: VectorAsset? = null
