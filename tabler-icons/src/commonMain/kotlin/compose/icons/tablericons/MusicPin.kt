...
public val TablerIcons.MusicPin: ImageVector
    get() {
        if (_musicPin != null) {
            return _musicPin!!
        }
        _musicPin = Builder(name = "MusicPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _musicPin: ImageVector? = null
