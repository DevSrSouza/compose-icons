...
public val TablerIcons.Recycle: VectorAsset
    get() {
        if (_recycle != null) {
            return _recycle!!
        }
        _recycle = VectorAssetBuilder(name = "Recycle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineToRelative(-4.5f, -7.7942f)
                arcToRelative(2.0f, 2.0f, 115.6701f, false, false, -3.2566f, -0.1405f)
...
private var _recycle: VectorAsset? = null
