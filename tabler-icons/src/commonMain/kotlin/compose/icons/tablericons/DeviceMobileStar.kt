...
public val TablerIcons.DeviceMobileStar: ImageVector
    get() {
        if (_deviceMobileStar != null) {
            return _deviceMobileStar!!
        }
        _deviceMobileStar = Builder(name = "DeviceMobileStar", defaultWidth = 24.0.dp, defaultHeight
...
private var _deviceMobileStar: ImageVector? = null
