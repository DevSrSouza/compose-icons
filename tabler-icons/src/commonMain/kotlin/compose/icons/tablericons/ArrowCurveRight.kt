...
public val TablerIcons.ArrowCurveRight: ImageVector
    get() {
        if (_arrowCurveRight != null) {
            return _arrowCurveRight!!
        }
        _arrowCurveRight = Builder(name = "ArrowCurveRight", defaultWidth = 24.0.dp, defaultHeight =
