...
public val TablerIcons.DeviceWatchPin: ImageVector
    get() {
        if (_deviceWatchPin != null) {
            return _deviceWatchPin!!
        }
        _deviceWatchPin = Builder(name = "DeviceWatchPin", defaultWidth = 24.0.dp, defaultHeight =
