...
public val TablerIcons.BrandInstagram: VectorAsset
    get() {
        if (_brandInstagram != null) {
            return _brandInstagram!!
        }
        _brandInstagram = VectorAssetBuilder(name = "BrandInstagram", defaultWidth = 24.0.dp,
...
private var _brandInstagram: VectorAsset? = null
