...
public val TablerIcons.PhoneX: VectorAsset
    get() {
        if (_phoneX != null) {
            return _phoneX!!
        }
        _phoneX = VectorAssetBuilder(name = "PhoneX", defaultWidth = 24.0.dp, defaultHeight =
...
private var _phoneX: VectorAsset? = null
