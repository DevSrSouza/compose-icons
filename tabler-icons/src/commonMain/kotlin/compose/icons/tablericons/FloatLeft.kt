...
public val TablerIcons.FloatLeft: VectorAsset
    get() {
        if (_floatLeft != null) {
            return _floatLeft!!
        }
        _floatLeft = VectorAssetBuilder(name = "FloatLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _floatLeft: VectorAsset? = null
