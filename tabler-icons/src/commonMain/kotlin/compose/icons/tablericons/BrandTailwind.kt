...
public val TablerIcons.BrandTailwind: VectorAsset
    get() {
        if (_brandTailwind != null) {
            return _brandTailwind!!
        }
        _brandTailwind = VectorAssetBuilder(name = "BrandTailwind", defaultWidth = 24.0.dp,
...
private var _brandTailwind: VectorAsset? = null
