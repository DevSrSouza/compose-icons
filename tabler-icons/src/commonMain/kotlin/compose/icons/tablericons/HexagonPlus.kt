...
public val TablerIcons.HexagonPlus: ImageVector
    get() {
        if (_hexagonPlus != null) {
            return _hexagonPlus!!
        }
        _hexagonPlus = Builder(name = "HexagonPlus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagonPlus: ImageVector? = null
