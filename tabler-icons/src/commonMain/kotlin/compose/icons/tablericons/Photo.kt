...
public val TablerIcons.Photo: VectorAsset
    get() {
        if (_photo != null) {
            return _photo!!
        }
        _photo = VectorAssetBuilder(name = "Photo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _photo: VectorAsset? = null
