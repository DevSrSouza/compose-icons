...
public val TablerIcons.BrandTinder: VectorAsset
    get() {
        if (_brandTinder != null) {
            return _brandTinder!!
        }
        _brandTinder = VectorAssetBuilder(name = "BrandTinder", defaultWidth = 24.0.dp,
...
private var _brandTinder: VectorAsset? = null
