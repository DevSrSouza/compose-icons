...
public val TablerIcons.LayoutGrid: VectorAsset
    get() {
        if (_layoutGrid != null) {
            return _layoutGrid!!
        }
        _layoutGrid = VectorAssetBuilder(name = "LayoutGrid", defaultWidth = 24.0.dp, defaultHeight
...
private var _layoutGrid: VectorAsset? = null
