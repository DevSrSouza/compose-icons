...
public val TablerIcons.Dice: VectorAsset
    get() {
        if (_dice != null) {
            return _dice!!
        }
        _dice = VectorAssetBuilder(name = "Dice", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _dice: VectorAsset? = null
