...
public val TablerIcons.ClipboardList: VectorAsset
    get() {
        if (_clipboardList != null) {
            return _clipboardList!!
        }
        _clipboardList = VectorAssetBuilder(name = "ClipboardList", defaultWidth = 24.0.dp,
...
private var _clipboardList: VectorAsset? = null
