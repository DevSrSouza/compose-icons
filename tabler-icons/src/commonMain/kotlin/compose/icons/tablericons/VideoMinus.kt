...
public val TablerIcons.VideoMinus: VectorAsset
    get() {
        if (_videoMinus != null) {
            return _videoMinus!!
        }
        _videoMinus = VectorAssetBuilder(name = "VideoMinus", defaultWidth = 24.0.dp, defaultHeight
...
private var _videoMinus: VectorAsset? = null
