...
public val TablerIcons.FlagDollar: ImageVector
    get() {
        if (_flagDollar != null) {
            return _flagDollar!!
        }
        _flagDollar = Builder(name = "FlagDollar", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flagDollar: ImageVector? = null
