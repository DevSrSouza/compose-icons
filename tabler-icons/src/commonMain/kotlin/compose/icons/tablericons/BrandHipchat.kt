...
public val TablerIcons.BrandHipchat: VectorAsset
    get() {
        if (_brandHipchat != null) {
            return _brandHipchat!!
        }
        _brandHipchat = VectorAssetBuilder(name = "BrandHipchat", defaultWidth = 24.0.dp,
...
private var _brandHipchat: VectorAsset? = null
