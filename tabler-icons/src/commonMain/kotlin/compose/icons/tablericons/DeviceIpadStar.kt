...
public val TablerIcons.DeviceIpadStar: ImageVector
    get() {
        if (_deviceIpadStar != null) {
            return _deviceIpadStar!!
        }
        _deviceIpadStar = Builder(name = "DeviceIpadStar", defaultWidth = 24.0.dp, defaultHeight =
