...
public val TablerIcons.ShoppingCartPin: ImageVector
    get() {
        if (_shoppingCartPin != null) {
            return _shoppingCartPin!!
        }
        _shoppingCartPin = Builder(name = "ShoppingCartPin", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                lineToRelative(-0.716f, 5.011f)
                moveToRelative(-5.284f, 1.989f)
