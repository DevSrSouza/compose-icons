...
public val TablerIcons.PencilCog: ImageVector
    get() {
        if (_pencilCog != null) {
            return _pencilCog!!
        }
        _pencilCog = Builder(name = "PencilCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _pencilCog: ImageVector? = null
