...
public val TablerIcons.DropletCog: ImageVector
    get() {
        if (_dropletCog != null) {
            return _dropletCog!!
        }
        _dropletCog = Builder(name = "DropletCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.421f, 11.56f)
                arcToRelative(6.702f, 6.702f, 0.0f, false, false, -0.357f, -0.683f)
                ...
                arcToRelative(7.144f, 7.144f, 0.0f, false, false, 4.518f, 1.58f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _dropletCog: ImageVector? = null
