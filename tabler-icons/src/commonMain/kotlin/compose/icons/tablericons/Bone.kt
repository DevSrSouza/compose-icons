...
public val TablerIcons.Bone: VectorAsset
    get() {
        if (_bone != null) {
            return _bone!!
        }
        _bone = VectorAssetBuilder(name = "Bone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _bone: VectorAsset? = null
