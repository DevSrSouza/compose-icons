...
public val TablerIcons.PlaneArrival: VectorAsset
    get() {
        if (_planeArrival != null) {
            return _planeArrival!!
        }
        _planeArrival = VectorAssetBuilder(name = "PlaneArrival", defaultWidth = 24.0.dp,
...
private var _planeArrival: VectorAsset? = null
