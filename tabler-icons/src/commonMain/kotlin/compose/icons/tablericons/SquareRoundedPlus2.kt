...
public val TablerIcons.SquareRoundedPlus2: ImageVector
    get() {
        if (_squareRoundedPlus2 != null) {
            return _squareRoundedPlus2!!
        }
        _squareRoundedPlus2 = Builder(name = "SquareRoundedPlus2", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 0.185f, -0.001f, 0.366f, -0.004f, 0.544f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
