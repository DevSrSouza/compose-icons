...
public val TablerIcons.HospitalCircle: ImageVector
    get() {
        if (_hospitalCircle != null) {
            return _hospitalCircle!!
        }
        _hospitalCircle = Builder(name = "HospitalCircle", defaultWidth = 24.0.dp, defaultHeight =
