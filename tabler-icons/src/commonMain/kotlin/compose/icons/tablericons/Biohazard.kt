...
public val TablerIcons.Biohazard: VectorAsset
    get() {
        if (_biohazard != null) {
            return _biohazard!!
        }
        _biohazard = VectorAssetBuilder(name = "Biohazard", defaultWidth = 24.0.dp, defaultHeight =
...
private var _biohazard: VectorAsset? = null
