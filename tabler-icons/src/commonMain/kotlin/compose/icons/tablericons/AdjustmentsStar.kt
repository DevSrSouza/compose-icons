...
public val TablerIcons.AdjustmentsStar: ImageVector
    get() {
        if (_adjustmentsStar != null) {
            return _adjustmentsStar!!
        }
        _adjustmentsStar = Builder(name = "AdjustmentsStar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _adjustmentsStar: ImageVector? = null
