...
public val TablerIcons.TimeDuration60: ImageVector
    get() {
        if (_timeDuration60 != null) {
            return _timeDuration60!!
        }
        _timeDuration60 = Builder(name = "TimeDuration60", defaultWidth = 24.0.dp, defaultHeight =
