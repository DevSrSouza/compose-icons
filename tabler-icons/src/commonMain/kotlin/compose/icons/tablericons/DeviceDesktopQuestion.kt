...
public val TablerIcons.DeviceDesktopQuestion: ImageVector
    get() {
        if (_deviceDesktopQuestion != null) {
            return _deviceDesktopQuestion!!
        }
        _deviceDesktopQuestion = Builder(name = "DeviceDesktopQuestion", defaultWidth = 24.0.dp,
