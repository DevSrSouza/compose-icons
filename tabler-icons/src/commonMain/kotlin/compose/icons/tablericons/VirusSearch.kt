...
public val TablerIcons.VirusSearch: VectorAsset
    get() {
        if (_virusSearch != null) {
            return _virusSearch!!
        }
        _virusSearch = VectorAssetBuilder(name = "VirusSearch", defaultWidth = 24.0.dp,
...
private var _virusSearch: VectorAsset? = null
