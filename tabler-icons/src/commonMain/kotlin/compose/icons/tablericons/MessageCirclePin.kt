...
public val TablerIcons.MessageCirclePin: ImageVector
    get() {
        if (_messageCirclePin != null) {
            return _messageCirclePin!!
        }
        _messageCirclePin = Builder(name = "MessageCirclePin", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.337f, 19.974f)
                arcToRelative(9.891f, 9.891f, 0.0f, false, true, -4.637f, -0.974f)
                ...
                curveToRelative(1.63f, 1.39f, 2.554f, 3.21f, 2.736f, 5.085f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
