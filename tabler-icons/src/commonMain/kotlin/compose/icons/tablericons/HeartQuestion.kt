...
public val TablerIcons.HeartQuestion: ImageVector
    get() {
        if (_heartQuestion != null) {
            return _heartQuestion!!
        }
        _heartQuestion = Builder(name = "HeartQuestion", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 8.524f, 5.127f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
