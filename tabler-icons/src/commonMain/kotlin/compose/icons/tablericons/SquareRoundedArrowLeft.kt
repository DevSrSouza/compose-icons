...
public val TablerIcons.SquareRoundedArrowLeft: ImageVector
    get() {
        if (_squareRoundedArrowLeft != null) {
            return _squareRoundedArrowLeft!!
        }
        _squareRoundedArrowLeft = Builder(name = "SquareRoundedArrowLeft", defaultWidth = 24.0.dp,
