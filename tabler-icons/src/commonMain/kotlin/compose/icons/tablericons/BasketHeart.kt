...
public val TablerIcons.BasketHeart: ImageVector
    get() {
        if (_basketHeart != null) {
            return _basketHeart!!
        }
        _basketHeart = Builder(name = "BasketHeart", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.977f, 2.304f)
                lineToRelative(-0.143f, 0.817f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.602f, 12.092f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -2.233f, 3.066f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
