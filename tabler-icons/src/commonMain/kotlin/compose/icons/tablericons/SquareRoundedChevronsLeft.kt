...
public val TablerIcons.SquareRoundedChevronsLeft: ImageVector
    get() {
        if (_squareRoundedChevronsLeft != null) {
            return _squareRoundedChevronsLeft!!
        }
        _squareRoundedChevronsLeft = Builder(name = "SquareRoundedChevronsLeft", defaultWidth =
