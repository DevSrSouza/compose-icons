...
public val TablerIcons.Select: VectorAsset
    get() {
        if (_select != null) {
            return _select!!
        }
        _select = VectorAssetBuilder(name = "Select", defaultWidth = 24.0.dp, defaultHeight =
...
private var _select: VectorAsset? = null
