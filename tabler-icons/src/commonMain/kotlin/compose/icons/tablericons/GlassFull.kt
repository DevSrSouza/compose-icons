...
public val TablerIcons.GlassFull: VectorAsset
    get() {
        if (_glassFull != null) {
            return _glassFull!!
        }
        _glassFull = VectorAssetBuilder(name = "GlassFull", defaultWidth = 24.0.dp, defaultHeight =
...
private var _glassFull: VectorAsset? = null
