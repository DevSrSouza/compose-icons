    ...
    get() {
        ...
        _breadOff = Builder(name = "BreadOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(18.415f, 18.414f)
                arcToRelative(1.994f, 1.994f, 0.0f, false, true, -1.415f, 0.586f)
                horizontalLineToRelative(-10.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, -2.0f)
                verticalLineToRelative(-6.764f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 0.435f, -4.795f)
                moveToRelative(3.565f, -0.441f)
