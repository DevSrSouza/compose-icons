...
public val TablerIcons.InfoHexagonFilled: ImageVector
    get() {
        if (_infoHexagonFilled != null) {
            return _infoHexagonFilled!!
        }
        _infoHexagonFilled = Builder(name = "InfoHexagonFilled", defaultWidth = 24.0.dp,
...
private var _infoHexagonFilled: ImageVector? = null
