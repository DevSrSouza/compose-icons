...
public val TablerIcons.SquareRoundedNumber9: ImageVector
    get() {
        if (_squareRoundedNumber9 != null) {
            return _squareRoundedNumber9!!
        }
        _squareRoundedNumber9 = Builder(name = "SquareRoundedNumber9", defaultWidth = 24.0.dp,
