...
public val TablerIcons.BallVolleyball: VectorAsset
    get() {
        if (_ballVolleyball != null) {
            return _ballVolleyball!!
        }
        _ballVolleyball = VectorAssetBuilder(name = "BallVolleyball", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    StrokeJoin.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.0f, 12.0f)
                arcToRelative(8.0f, 8.0f, 107.2543f, false, false, -0.5359f, -8.9282f)
                moveToRelative(4.0849f, 12.0753f)
                arcToRelative(12.0f, 12.0f, 112.843f, false, false, 1.3792f, -10.6112f)
            }
        }
        .build()
        return _ballVolleyball!!
...
private var _ballVolleyball: VectorAsset? = null
