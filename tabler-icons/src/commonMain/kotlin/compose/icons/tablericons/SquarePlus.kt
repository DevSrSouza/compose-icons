...
public val TablerIcons.SquarePlus: VectorAsset
    get() {
        if (_squarePlus != null) {
            return _squarePlus!!
        }
        _squarePlus = VectorAssetBuilder(name = "SquarePlus", defaultWidth = 24.0.dp, defaultHeight
...
private var _squarePlus: VectorAsset? = null
