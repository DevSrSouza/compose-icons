...
public val TablerIcons.ShoppingCartCancel: ImageVector
    get() {
        if (_shoppingCartCancel != null) {
            return _shoppingCartCancel!!
        }
        _shoppingCartCancel = Builder(name = "ShoppingCartCancel", defaultWidth = 24.0.dp,
