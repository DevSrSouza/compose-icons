    ...
    get() {
        ...
        _flipFlops = Builder(name = "FlipFlops", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 0.078f, -0.003f, 0.156f, -0.008f, 0.234f)
                lineToRelative(-0.6f, 9.014f)
                curveToRelative(-0.11f, 1.683f, -1.596f, 2.994f, -3.392f, 2.994f)
                reflectiveCurveToRelative(-3.28f, -1.311f, -3.392f, -2.994f)
                lineToRelative(-0.6f, -9.014f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.084f, -0.005f, 0.167f, -0.007f, 0.25f, -0.007f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
