...
public val TablerIcons.HandMiddleFinger: VectorAsset
    get() {
        if (_handMiddleFinger != null) {
            return _handMiddleFinger!!
        }
        _handMiddleFinger = VectorAssetBuilder(name = "HandMiddleFinger", defaultWidth = 24.0.dp,
...
private var _handMiddleFinger: VectorAsset? = null
