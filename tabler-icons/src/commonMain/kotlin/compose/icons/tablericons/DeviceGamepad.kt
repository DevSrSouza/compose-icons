...
public val TablerIcons.DeviceGamepad: VectorAsset
    get() {
        if (_deviceGamepad != null) {
            return _deviceGamepad!!
        }
        _deviceGamepad = VectorAssetBuilder(name = "DeviceGamepad", defaultWidth = 24.0.dp,
...
private var _deviceGamepad: VectorAsset? = null
