...
public val TablerIcons.Replace: VectorAsset
    get() {
        if (_replace != null) {
            return _replace!!
        }
        _replace = VectorAssetBuilder(name = "Replace", defaultWidth = 24.0.dp, defaultHeight =
...
private var _replace: VectorAsset? = null
