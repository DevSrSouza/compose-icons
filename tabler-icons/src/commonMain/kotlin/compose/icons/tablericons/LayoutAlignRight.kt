...
public val TablerIcons.LayoutAlignRight: VectorAsset
    get() {
        if (_layoutAlignRight != null) {
            return _layoutAlignRight!!
        }
        _layoutAlignRight = VectorAssetBuilder(name = "LayoutAlignRight", defaultWidth = 24.0.dp,
...
private var _layoutAlignRight: VectorAsset? = null
