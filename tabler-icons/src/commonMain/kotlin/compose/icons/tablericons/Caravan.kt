...
public val TablerIcons.Caravan: VectorAsset
    get() {
        if (_caravan != null) {
            return _caravan!!
        }
        _caravan = VectorAssetBuilder(name = "Caravan", defaultWidth = 24.0.dp, defaultHeight =
...
private var _caravan: VectorAsset? = null
