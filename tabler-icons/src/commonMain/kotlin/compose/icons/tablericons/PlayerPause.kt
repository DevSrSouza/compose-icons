...
public val TablerIcons.PlayerPause: VectorAsset
    get() {
        if (_playerPause != null) {
            return _playerPause!!
        }
        _playerPause = VectorAssetBuilder(name = "PlayerPause", defaultWidth = 24.0.dp,
...
private var _playerPause: VectorAsset? = null
