...
public val TablerIcons.Parking: VectorAsset
    get() {
        if (_parking != null) {
            return _parking!!
        }
        _parking = VectorAssetBuilder(name = "Parking", defaultWidth = 24.0.dp, defaultHeight =
...
private var _parking: VectorAsset? = null
