...
public val TablerIcons.HexagonNumber8: ImageVector
    get() {
        if (_hexagonNumber8 != null) {
            return _hexagonNumber8!!
        }
        _hexagonNumber8 = Builder(name = "HexagonNumber8", defaultWidth = 24.0.dp, defaultHeight =
