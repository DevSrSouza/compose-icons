...
public val TablerIcons.BrandBitbucket: VectorAsset
    get() {
        if (_brandBitbucket != null) {
            return _brandBitbucket!!
        }
        _brandBitbucket = VectorAssetBuilder(name = "BrandBitbucket", defaultWidth = 24.0.dp,
...
private var _brandBitbucket: VectorAsset? = null
