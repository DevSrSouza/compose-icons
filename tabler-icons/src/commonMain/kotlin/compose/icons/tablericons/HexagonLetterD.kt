...
public val TablerIcons.HexagonLetterD: ImageVector
    get() {
        if (_hexagonLetterD != null) {
            return _hexagonLetterD!!
        }
        _hexagonLetterD = Builder(name = "HexagonLetterD", defaultWidth = 24.0.dp, defaultHeight =
