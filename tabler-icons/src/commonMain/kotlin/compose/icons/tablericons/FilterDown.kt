...
public val TablerIcons.FilterDown: ImageVector
    get() {
        if (_filterDown != null) {
            return _filterDown!!
        }
        _filterDown = Builder(name = "FilterDown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _filterDown: ImageVector? = null
