...
public val TablerIcons.ClipboardX: VectorAsset
    get() {
        if (_clipboardX != null) {
            return _clipboardX!!
        }
        _clipboardX = VectorAssetBuilder(name = "ClipboardX", defaultWidth = 24.0.dp, defaultHeight
...
private var _clipboardX: VectorAsset? = null
