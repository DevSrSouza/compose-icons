...
public val TablerIcons.SquareRoundedLetterS: ImageVector
    get() {
        if (_squareRoundedLetterS != null) {
            return _squareRoundedLetterS!!
        }
        _squareRoundedLetterS = Builder(name = "SquareRoundedLetterS", defaultWidth = 24.0.dp,
