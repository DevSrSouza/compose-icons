...
public val TablerIcons.HeartSearch: ImageVector
    get() {
        ...
        _heartSearch = Builder(name = "HeartSearch", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(12.0f, 20.0f)
                lineToRelative(-0.975f, -0.966f)
                lineToRelative(-6.525f, -6.462f)
                arcToRelative(5.0f, 5.0f, 0.0f, true, true, 7.5f, -6.566f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 8.37f, 5.428f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
