...
public val TablerIcons.LayersIntersect: VectorAsset
    get() {
        if (_layersIntersect != null) {
            return _layersIntersect!!
        }
        _layersIntersect = VectorAssetBuilder(name = "LayersIntersect", defaultWidth = 24.0.dp,
...
private var _layersIntersect: VectorAsset? = null
