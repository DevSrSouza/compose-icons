...
public val TablerIcons.TrafficConeOff: ImageVector
    get() {
        if (_trafficConeOff != null) {
            return _trafficConeOff!!
        }
        _trafficConeOff = Builder(name = "TrafficConeOff", defaultWidth = 24.0.dp, defaultHeight =
