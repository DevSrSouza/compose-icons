...
public val TablerIcons.HomeQuestion: ImageVector
    get() {
        if (_homeQuestion != null) {
            return _homeQuestion!!
        }
        _homeQuestion = Builder(name = "HomeQuestion", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                horizontalLineToRelative(2.0f)
                curveToRelative(0.467f, 0.0f, 0.896f, 0.16f, 1.236f, 0.428f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
