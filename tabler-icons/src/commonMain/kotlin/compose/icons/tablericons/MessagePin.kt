...
public val TablerIcons.MessagePin: ImageVector
    get() {
        if (_messagePin != null) {
            return _messagePin!!
        }
        _messagePin = Builder(name = "MessagePin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.007f, 18.596f)
                lineToRelative(-4.007f, 2.404f)
