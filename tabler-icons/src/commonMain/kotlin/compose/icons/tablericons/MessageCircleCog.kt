...
public val TablerIcons.MessageCircleCog: ImageVector
    get() {
        if (_messageCircleCog != null) {
            return _messageCircleCog!!
        }
        _messageCircleCog = Builder(name = "MessageCircleCog", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(11.996f, 19.98f)
                arcToRelative(9.868f, 9.868f, 0.0f, false, true, -4.296f, -0.98f)
                ...
                curveToRelative(1.842f, 1.572f, 2.783f, 3.691f, 2.77f, 5.821f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
