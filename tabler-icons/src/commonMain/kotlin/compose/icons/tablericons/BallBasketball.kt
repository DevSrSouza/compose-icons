...
public val TablerIcons.BallBasketball: VectorAsset
    get() {
        if (_ballBasketball != null) {
            return _ballBasketball!!
        }
        _ballBasketball = VectorAssetBuilder(name = "BallBasketball", defaultWidth = 24.0.dp,
...
private var _ballBasketball: VectorAsset? = null
