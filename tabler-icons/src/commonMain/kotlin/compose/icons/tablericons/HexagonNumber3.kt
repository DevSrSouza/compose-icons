...
public val TablerIcons.HexagonNumber3: ImageVector
    get() {
        if (_hexagonNumber3 != null) {
            return _hexagonNumber3!!
        }
        _hexagonNumber3 = Builder(name = "HexagonNumber3", defaultWidth = 24.0.dp, defaultHeight =
