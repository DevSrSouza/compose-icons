...
public val TablerIcons.BrandMinecraft: ImageVector
    get() {
        if (_brandMinecraft != null) {
            return _brandMinecraft!!
        }
        _brandMinecraft = Builder(name = "BrandMinecraft", defaultWidth = 24.0.dp, defaultHeight =
