...
public val TablerIcons.HeadphonesOff: VectorAsset
    get() {
        if (_headphonesOff != null) {
            return _headphonesOff!!
        }
        _headphonesOff = VectorAssetBuilder(name = "HeadphonesOff", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(4.0f, 15.0f)
                verticalLineToRelative(-3.0f)
                curveToRelative(0.0f, -2.21f, 0.896f, -4.21f, 2.344f, -5.658f)
                moveToRelative(2.369f, -1.638f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.287f, 7.296f)
                verticalLineToRelative(3.0f)
            }
        }
        .build()
...
private var _headphonesOff: VectorAsset? = null
