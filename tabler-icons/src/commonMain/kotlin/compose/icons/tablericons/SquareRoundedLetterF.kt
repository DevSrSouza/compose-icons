...
public val TablerIcons.SquareRoundedLetterF: ImageVector
    get() {
        if (_squareRoundedLetterF != null) {
            return _squareRoundedLetterF!!
        }
        _squareRoundedLetterF = Builder(name = "SquareRoundedLetterF", defaultWidth = 24.0.dp,
