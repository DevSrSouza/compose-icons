...
public val TablerIcons.InfoSquare: VectorAsset
    get() {
        if (_infoSquare != null) {
            return _infoSquare!!
        }
        _infoSquare = VectorAssetBuilder(name = "InfoSquare", defaultWidth = 24.0.dp, defaultHeight
...
private var _infoSquare: VectorAsset? = null
