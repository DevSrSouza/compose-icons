...
public val TablerIcons.DeviceMobile: VectorAsset
    get() {
        if (_deviceMobile != null) {
            return _deviceMobile!!
        }
        _deviceMobile = VectorAssetBuilder(name = "DeviceMobile", defaultWidth = 24.0.dp,
...
private var _deviceMobile: VectorAsset? = null
