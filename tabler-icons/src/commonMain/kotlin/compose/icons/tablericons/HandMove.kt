...
public val TablerIcons.HandMove: ImageVector
    get() {
        if (_handMove != null) {
            return _handMove!!
        }
        _handMove = Builder(name = "HandMove", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(13.487f, 13.487f, 0.0f, false, true, 2.46f, -1.427f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
