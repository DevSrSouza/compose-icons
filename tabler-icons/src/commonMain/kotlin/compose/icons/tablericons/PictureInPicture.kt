...
public val TablerIcons.PictureInPicture: VectorAsset
    get() {
        if (_pictureInPicture != null) {
            return _pictureInPicture!!
        }
        _pictureInPicture = VectorAssetBuilder(name = "PictureInPicture", defaultWidth = 24.0.dp,
...
private var _pictureInPicture: VectorAsset? = null
