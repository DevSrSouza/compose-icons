...
public val TablerIcons.SquareRoundedArrowDownFilled: ImageVector
    get() {
        if (_squareRoundedArrowDownFilled != null) {
            return _squareRoundedArrowDownFilled!!
        }
        _squareRoundedArrowDownFilled = Builder(name = "SquareRoundedArrowDownFilled", defaultWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.008f, 1.008f, 0.0f, false, true, -0.112f, 0.097f)
...
private var _squareRoundedArrowDownFilled: ImageVector? = null
