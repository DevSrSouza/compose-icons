...
public val TablerIcons.SquareRoundedNumber3: ImageVector
    get() {
        if (_squareRoundedNumber3 != null) {
            return _squareRoundedNumber3!!
        }
        _squareRoundedNumber3 = Builder(name = "SquareRoundedNumber3", defaultWidth = 24.0.dp,
