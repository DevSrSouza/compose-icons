...
public val TablerIcons.ChartBar: VectorAsset
    get() {
        if (_chartBar != null) {
            return _chartBar!!
        }
        _chartBar = VectorAssetBuilder(name = "ChartBar", defaultWidth = 24.0.dp, defaultHeight =
...
private var _chartBar: VectorAsset? = null
