...
public val TablerIcons.PhonePause: VectorAsset
    get() {
        if (_phonePause != null) {
            return _phonePause!!
        }
        _phonePause = VectorAssetBuilder(name = "PhonePause", defaultWidth = 24.0.dp, defaultHeight
...
private var _phonePause: VectorAsset? = null
