...
public val TablerIcons.RadioOff: ImageVector
    get() {
        if (_radioOff != null) {
            return _radioOff!!
        }
        _radioOff = Builder(name = "RadioOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(14.0f, 3.0f)
                lineToRelative(-4.986f, 1.995f)
                moveToRelative(-2.875f, 1.15f)
                lineToRelative(-1.51f, 0.604f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -0.629f, 0.928f)
                verticalLineToRelative(11.323f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 1.0f, 1.0f)
                horizontalLineToRelative(14.0f)
                arcToRelative(0.997f, 0.997f, 0.0f, false, false, 0.708f, -0.294f)
