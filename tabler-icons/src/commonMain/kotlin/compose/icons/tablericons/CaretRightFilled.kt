...
public val TablerIcons.CaretRightFilled: ImageVector
    get() {
        if (_caretRightFilled != null) {
            return _caretRightFilled!!
        }
        _caretRightFilled = Builder(name = "CaretRightFilled", defaultWidth = 24.0.dp, defaultHeight
...
private var _caretRightFilled: ImageVector? = null
