...
public val TablerIcons.BrandDeliveroo: ImageVector
    get() {
        if (_brandDeliveroo != null) {
            return _brandDeliveroo!!
        }
        _brandDeliveroo = Builder(name = "BrandDeliveroo", defaultWidth = 24.0.dp, defaultHeight =
