...
public val TablerIcons.ShieldCog: ImageVector
    get() {
        if (_shieldCog != null) {
            return _shieldCog!!
        }
        _shieldCog = Builder(name = "ShieldCog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 8.5f, 3.0f)
                curveToRelative(0.568f, 1.933f, 0.635f, 3.957f, 0.223f, 5.89f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
