...
public val TablerIcons.SquareRoundedLetterG: ImageVector
    get() {
        if (_squareRoundedLetterG != null) {
            return _squareRoundedLetterG!!
        }
        _squareRoundedLetterG = Builder(name = "SquareRoundedLetterG", defaultWidth = 24.0.dp,
