...
public val TablerIcons.AlertSquareRounded: ImageVector
    get() {
        if (_alertSquareRounded != null) {
            return _alertSquareRounded!!
        }
        _alertSquareRounded = Builder(name = "AlertSquareRounded", defaultWidth = 24.0.dp,
