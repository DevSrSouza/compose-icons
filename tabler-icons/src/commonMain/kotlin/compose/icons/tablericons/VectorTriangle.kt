...
public val TablerIcons.VectorTriangle: VectorAsset
    get() {
        if (_vectorTriangle != null) {
            return _vectorTriangle!!
        }
        _vectorTriangle = VectorAssetBuilder(name = "VectorTriangle", defaultWidth = 24.0.dp,
...
private var _vectorTriangle: VectorAsset? = null
