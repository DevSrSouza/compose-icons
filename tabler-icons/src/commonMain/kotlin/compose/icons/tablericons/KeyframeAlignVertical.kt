...
public val TablerIcons.KeyframeAlignVertical: ImageVector
    get() {
        if (_keyframeAlignVertical != null) {
            return _keyframeAlignVertical!!
        }
        _keyframeAlignVertical = Builder(name = "KeyframeAlignVertical", defaultWidth = 24.0.dp,
