...
public val TablerIcons.TrafficLightsOff: ImageVector
    get() {
        if (_trafficLightsOff != null) {
            return _trafficLightsOff!!
        }
        _trafficLightsOff = Builder(name = "TrafficLightsOff", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.0f, 4.0f)
                curveToRelative(0.912f, -1.219f, 2.36f, -2.0f, 4.0f, -2.0f)
