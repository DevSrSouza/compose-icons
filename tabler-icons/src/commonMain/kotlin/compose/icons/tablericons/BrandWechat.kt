    ...
    get() {
        ...
        _brandWechat = Builder(name = "BrandWechat", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.0f, 1.397f, -0.778f, 2.645f, -1.999f, 3.47f)
                lineToRelative(-0.001f, 2.03f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(3.782f, 0.0f, 6.863f, 2.57f, 6.996f, 5.785f)
                lineToRelative(0.004f, 0.233f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
