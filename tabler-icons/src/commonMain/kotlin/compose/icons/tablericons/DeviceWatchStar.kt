...
public val TablerIcons.DeviceWatchStar: ImageVector
    get() {
        if (_deviceWatchStar != null) {
            return _deviceWatchStar!!
        }
        _deviceWatchStar = Builder(name = "DeviceWatchStar", defaultWidth = 24.0.dp, defaultHeight =
