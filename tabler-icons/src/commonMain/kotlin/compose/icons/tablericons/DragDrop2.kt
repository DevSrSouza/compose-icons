...
public val TablerIcons.DragDrop2: VectorAsset
    get() {
        if (_dragDrop2 != null) {
            return _dragDrop2!!
        }
        _dragDrop2 = VectorAssetBuilder(name = "DragDrop2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _dragDrop2: VectorAsset? = null
