...
public val TablerIcons.Location: VectorAsset
    get() {
        if (_location != null) {
            return _location!!
        }
        _location = VectorAssetBuilder(name = "Location", defaultWidth = 24.0.dp, defaultHeight =
...
private var _location: VectorAsset? = null
