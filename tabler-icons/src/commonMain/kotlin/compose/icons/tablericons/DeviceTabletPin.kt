...
public val TablerIcons.DeviceTabletPin: ImageVector
    get() {
        if (_deviceTabletPin != null) {
            return _deviceTabletPin!!
        }
        _deviceTabletPin = Builder(name = "DeviceTabletPin", defaultWidth = 24.0.dp, defaultHeight =
