...
public val TablerIcons.Template: VectorAsset
    get() {
        if (_template != null) {
            return _template!!
        }
        _template = VectorAssetBuilder(name = "Template", defaultWidth = 24.0.dp, defaultHeight =
...
private var _template: VectorAsset? = null
