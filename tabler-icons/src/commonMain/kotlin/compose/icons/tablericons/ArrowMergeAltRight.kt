...
public val TablerIcons.ArrowMergeAltRight: ImageVector
    get() {
        if (_arrowMergeAltRight != null) {
            return _arrowMergeAltRight!!
        }
        _arrowMergeAltRight = Builder(name = "ArrowMergeAltRight", defaultWidth = 24.0.dp,
