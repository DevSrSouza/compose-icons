...
public val TablerIcons.HeartRateMonitor: ImageVector
    get() {
        if (_heartRateMonitor != null) {
            return _heartRateMonitor!!
        }
        _heartRateMonitor = Builder(name = "HeartRateMonitor", defaultWidth = 24.0.dp, defaultHeight
...
private var _heartRateMonitor: ImageVector? = null
