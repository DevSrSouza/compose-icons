...
public val TablerIcons.RosetteNumber7: ImageVector
    get() {
        if (_rosetteNumber7 != null) {
            return _rosetteNumber7!!
        }
        _rosetteNumber7 = Builder(name = "RosetteNumber7", defaultWidth = 24.0.dp, defaultHeight =
