...
public val TablerIcons.BedFilled: ImageVector
    get() {
        if (_bedFilled != null) {
            return _bedFilled!!
        }
        _bedFilled = Builder(name = "BedFilled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.0f, 8.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, true, true, -1.995f, 2.15f)
...
private var _bedFilled: ImageVector? = null
