...
public val TablerIcons.DropletStar: ImageVector
    get() {
        if (_dropletStar != null) {
            return _dropletStar!!
        }
        _dropletStar = Builder(name = "DropletStar", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.496f, 10.034f)
                lineToRelative(-4.321f, -6.417f)
                ...
                arcToRelative(7.106f, 7.106f, 0.0f, false, false, 3.547f, 1.517f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
