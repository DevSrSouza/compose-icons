...
public val TablerIcons.NavigationDollar: ImageVector
    get() {
        if (_navigationDollar != null) {
            return _navigationDollar!!
        }
        _navigationDollar = Builder(name = "NavigationDollar", defaultWidth = 24.0.dp, defaultHeight
