...
public val TablerIcons.BasketStar: ImageVector
    get() {
        if (_basketStar != null) {
            return _basketStar!!
        }
        _basketStar = Builder(name = "BasketStar", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -3.377f, 2.116f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
