...
public val TablerIcons.HexagonMinus: ImageVector
    get() {
        if (_hexagonMinus != null) {
            return _hexagonMinus!!
        }
        _hexagonMinus = Builder(name = "HexagonMinus", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hexagonMinus: ImageVector? = null
