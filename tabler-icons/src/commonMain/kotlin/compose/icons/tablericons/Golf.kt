...
public val TablerIcons.Golf: VectorAsset
    get() {
        if (_golf != null) {
            return _golf!!
        }
        _golf = VectorAssetBuilder(name = "Golf", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _golf: VectorAsset? = null
