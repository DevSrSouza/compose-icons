    ...
    get() {
        ...
        _basketOff = Builder(name = "BasketOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.0f, 10.0f)
                lineToRelative(0.75f, -2.252f)
                moveToRelative(1.001f, -3.002f)
                lineToRelative(0.249f, -0.746f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                ...
                curveToRelative(-0.442f, 2.516f, -0.756f, 4.438f, -0.977f, 5.696f)
                moveToRelative(-1.01f, 3.003f)
                arcToRelative(2.997f, 2.997f, 0.0f, false, true, -2.234f, 0.997f)
