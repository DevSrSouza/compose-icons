...
public val TablerIcons.DeviceIpadHorizontalQuestion: ImageVector
    get() {
        if (_deviceIpadHorizontalQuestion != null) {
            return _deviceIpadHorizontalQuestion!!
        }
        _deviceIpadHorizontalQuestion = Builder(name = "DeviceIpadHorizontalQuestion", defaultWidth
