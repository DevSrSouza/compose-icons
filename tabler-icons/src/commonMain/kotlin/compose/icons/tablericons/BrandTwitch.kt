...
public val TablerIcons.BrandTwitch: VectorAsset
    get() {
        if (_brandTwitch != null) {
            return _brandTwitch!!
        }
        _brandTwitch = VectorAssetBuilder(name = "BrandTwitch", defaultWidth = 24.0.dp,
...
private var _brandTwitch: VectorAsset? = null
