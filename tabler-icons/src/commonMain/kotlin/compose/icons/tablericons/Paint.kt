...
public val TablerIcons.Paint: VectorAsset
    get() {
        if (_paint != null) {
            return _paint!!
        }
        _paint = VectorAssetBuilder(name = "Paint", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _paint: VectorAsset? = null
