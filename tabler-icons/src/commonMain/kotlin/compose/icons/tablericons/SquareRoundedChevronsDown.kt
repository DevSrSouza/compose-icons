...
public val TablerIcons.SquareRoundedChevronsDown: ImageVector
    get() {
        if (_squareRoundedChevronsDown != null) {
            return _squareRoundedChevronsDown!!
        }
        _squareRoundedChevronsDown = Builder(name = "SquareRoundedChevronsDown", defaultWidth =
