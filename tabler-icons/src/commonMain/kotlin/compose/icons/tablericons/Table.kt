...
public val TablerIcons.Table: VectorAsset
    get() {
        if (_table != null) {
            return _table!!
        }
        _table = VectorAssetBuilder(name = "Table", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _table: VectorAsset? = null
