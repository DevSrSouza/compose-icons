...
public val TablerIcons.ShoppingBagCheck: ImageVector
    get() {
        if (_shoppingBagCheck != null) {
            return _shoppingBagCheck!!
        }
        _shoppingBagCheck = Builder(name = "ShoppingBagCheck", defaultWidth = 24.0.dp, defaultHeight
