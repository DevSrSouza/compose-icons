...
public val TablerIcons.SquareRoundedNumber4: ImageVector
    get() {
        if (_squareRoundedNumber4 != null) {
            return _squareRoundedNumber4!!
        }
        _squareRoundedNumber4 = Builder(name = "SquareRoundedNumber4", defaultWidth = 24.0.dp,
