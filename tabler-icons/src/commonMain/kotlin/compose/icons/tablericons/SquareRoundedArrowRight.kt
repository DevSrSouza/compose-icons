...
public val TablerIcons.SquareRoundedArrowRight: ImageVector
    get() {
        if (_squareRoundedArrowRight != null) {
            return _squareRoundedArrowRight!!
        }
        _squareRoundedArrowRight = Builder(name = "SquareRoundedArrowRight", defaultWidth = 24.0.dp,
