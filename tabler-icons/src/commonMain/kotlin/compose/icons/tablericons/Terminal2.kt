...
public val TablerIcons.Terminal2: VectorAsset
    get() {
        if (_terminal2 != null) {
            return _terminal2!!
        }
        _terminal2 = VectorAssetBuilder(name = "Terminal2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _terminal2: VectorAsset? = null
