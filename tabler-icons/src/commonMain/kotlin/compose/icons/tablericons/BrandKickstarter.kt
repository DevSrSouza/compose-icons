...
public val TablerIcons.BrandKickstarter: VectorAsset
    get() {
        if (_brandKickstarter != null) {
            return _brandKickstarter!!
        }
        _brandKickstarter = VectorAssetBuilder(name = "BrandKickstarter", defaultWidth = 24.0.dp,
...
private var _brandKickstarter: VectorAsset? = null
