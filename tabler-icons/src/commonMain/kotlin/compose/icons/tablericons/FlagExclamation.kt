...
public val TablerIcons.FlagExclamation: ImageVector
    get() {
        if (_flagExclamation != null) {
            return _flagExclamation!!
        }
        _flagExclamation = Builder(name = "FlagExclamation", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.035f, 15.408f)
                arcToRelative(4.98f, 4.98f, 0.0f, false, true, -3.035f, -1.408f)
