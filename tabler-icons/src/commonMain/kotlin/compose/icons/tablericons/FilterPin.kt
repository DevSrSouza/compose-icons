...
public val TablerIcons.FilterPin: ImageVector
    get() {
        if (_filterPin != null) {
            return _filterPin!!
        }
        _filterPin = Builder(name = "FilterPin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _filterPin: ImageVector? = null
