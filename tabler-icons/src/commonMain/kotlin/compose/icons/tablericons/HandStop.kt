...
public val TablerIcons.HandStop: VectorAsset
    get() {
        if (_handStop != null) {
            return _handStop!!
        }
        _handStop = VectorAssetBuilder(name = "HandStop", defaultWidth = 24.0.dp, defaultHeight =
...
private var _handStop: VectorAsset? = null
