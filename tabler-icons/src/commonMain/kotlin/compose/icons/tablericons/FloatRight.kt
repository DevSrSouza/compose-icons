...
public val TablerIcons.FloatRight: VectorAsset
    get() {
        if (_floatRight != null) {
            return _floatRight!!
        }
        _floatRight = VectorAssetBuilder(name = "FloatRight", defaultWidth = 24.0.dp, defaultHeight
...
private var _floatRight: VectorAsset? = null
