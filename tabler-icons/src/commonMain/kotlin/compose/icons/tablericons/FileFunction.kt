...
public val TablerIcons.FileFunction: ImageVector
    get() {
        if (_fileFunction != null) {
            return _fileFunction!!
        }
        _fileFunction = Builder(name = "FileFunction", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.474f, 0.0f, 0.87f, -0.323f, 0.916f, -0.746f)
