...
public val TablerIcons.ConePlus: ImageVector
    get() {
        if (_conePlus != null) {
            return _conePlus!!
        }
        _conePlus = Builder(name = "ConePlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveToRelative(0.17f, 0.0f, 0.34f, -0.002f, 0.508f, -0.005f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
