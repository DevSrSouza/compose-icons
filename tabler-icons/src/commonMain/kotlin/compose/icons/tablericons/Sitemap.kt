...
public val TablerIcons.Sitemap: VectorAsset
    get() {
        if (_sitemap != null) {
            return _sitemap!!
        }
        _sitemap = VectorAssetBuilder(name = "Sitemap", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(17.0f, 15.0f)
                lineTo(19.0f, 15.0f)
                arcTo(2.0f, 2.0f, 0.0f, false, true, 21.0f, 17.0f)
                lineTo(21.0f, 19.0f)
...
private var _sitemap: VectorAsset? = null
