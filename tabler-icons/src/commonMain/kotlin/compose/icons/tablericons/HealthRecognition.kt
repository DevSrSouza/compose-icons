...
public val TablerIcons.HealthRecognition: ImageVector
    get() {
        if (_healthRecognition != null) {
            return _healthRecognition!!
        }
        _healthRecognition = Builder(name = "HealthRecognition", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(2.035f, 2.035f, 0.0f, false, true, 2.897f, 0.007f)
                arcToRelative(2.104f, 2.104f, 0.0f, false, true, 0.0f, 2.949f)
