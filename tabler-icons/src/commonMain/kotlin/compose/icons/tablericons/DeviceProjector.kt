...
public val TablerIcons.DeviceProjector: ImageVector
    get() {
        if (_deviceProjector != null) {
            return _deviceProjector!!
        }
        _deviceProjector = Builder(name = "DeviceProjector", defaultWidth = 24.0.dp, defaultHeight =
