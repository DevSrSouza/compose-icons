...
public val TablerIcons.Cash: VectorAsset
    get() {
        if (_cash != null) {
            return _cash!!
        }
        _cash = VectorAssetBuilder(name = "Cash", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cash: VectorAsset? = null
