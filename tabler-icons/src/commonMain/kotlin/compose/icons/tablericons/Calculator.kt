...
public val TablerIcons.Calculator: VectorAsset
    get() {
        if (_calculator != null) {
            return _calculator!!
        }
        _calculator = VectorAssetBuilder(name = "Calculator", defaultWidth = 24.0.dp, defaultHeight
...
private var _calculator: VectorAsset? = null
