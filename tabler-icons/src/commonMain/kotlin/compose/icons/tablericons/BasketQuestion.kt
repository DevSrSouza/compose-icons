...
public val TablerIcons.BasketQuestion: ImageVector
    get() {
        if (_basketQuestion != null) {
            return _basketQuestion!!
        }
        _basketQuestion = Builder(name = "BasketQuestion", defaultWidth = 24.0.dp, defaultHeight =
...
private var _basketQuestion: ImageVector? = null
