...
public val TablerIcons.DeviceIpadQuestion: ImageVector
    get() {
        if (_deviceIpadQuestion != null) {
            return _deviceIpadQuestion!!
        }
        _deviceIpadQuestion = Builder(name = "DeviceIpadQuestion", defaultWidth = 24.0.dp,
