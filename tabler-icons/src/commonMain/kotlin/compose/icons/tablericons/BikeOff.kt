...
public val TablerIcons.BikeOff: ImageVector
    get() {
        if (_bikeOff != null) {
            return _bikeOff!!
        }
        _bikeOff = Builder(name = "BikeOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, 4.123f, 4.123f)
