...
public val TablerIcons.PlaneDeparture: VectorAsset
    get() {
        if (_planeDeparture != null) {
            return _planeDeparture!!
        }
        _planeDeparture = VectorAssetBuilder(name = "PlaneDeparture", defaultWidth = 24.0.dp,
...
private var _planeDeparture: VectorAsset? = null
