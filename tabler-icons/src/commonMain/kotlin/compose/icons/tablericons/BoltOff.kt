...
public val TablerIcons.BoltOff: VectorAsset
    get() {
        if (_boltOff != null) {
            return _boltOff!!
        }
        _boltOff = VectorAssetBuilder(name = "BoltOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _boltOff: VectorAsset? = null
