...
public val TablerIcons.Ship: VectorAsset
    get() {
        if (_ship != null) {
            return _ship!!
        }
        _ship = VectorAssetBuilder(name = "Ship", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _ship: VectorAsset? = null
