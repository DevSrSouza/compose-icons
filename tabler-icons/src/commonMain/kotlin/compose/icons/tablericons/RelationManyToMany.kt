...
public val TablerIcons.RelationManyToMany: VectorAsset
    get() {
        if (_relationManyToMany != null) {
            return _relationManyToMany!!
        }
        _relationManyToMany = VectorAssetBuilder(name = "RelationManyToMany", defaultWidth =
...
private var _relationManyToMany: VectorAsset? = null
