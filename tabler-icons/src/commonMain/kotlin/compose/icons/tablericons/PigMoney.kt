...
public val TablerIcons.PigMoney: ImageVector
    get() {
        if (_pigMoney != null) {
            return _pigMoney!!
        }
        _pigMoney = Builder(name = "PigMoney", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 3.999f, -10.473f)
