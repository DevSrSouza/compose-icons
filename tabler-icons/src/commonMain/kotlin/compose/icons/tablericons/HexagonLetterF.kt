...
public val TablerIcons.HexagonLetterF: ImageVector
    get() {
        if (_hexagonLetterF != null) {
            return _hexagonLetterF!!
        }
        _hexagonLetterF = Builder(name = "HexagonLetterF", defaultWidth = 24.0.dp, defaultHeight =
