...
public val TablerIcons.Notes: VectorAsset
    get() {
        if (_notes != null) {
            return _notes!!
        }
        _notes = VectorAssetBuilder(name = "Notes", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _notes: VectorAsset? = null
