...
public val TablerIcons.SunOff: VectorAsset
    get() {
        if (_sunOff != null) {
            return _sunOff!!
        }
        _sunOff = VectorAssetBuilder(name = "SunOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _sunOff: VectorAsset? = null
