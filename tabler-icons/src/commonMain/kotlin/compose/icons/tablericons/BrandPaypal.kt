...
public val TablerIcons.BrandPaypal: VectorAsset
    get() {
        if (_brandPaypal != null) {
            return _brandPaypal!!
        }
        _brandPaypal = VectorAssetBuilder(name = "BrandPaypal", defaultWidth = 24.0.dp,
...
private var _brandPaypal: VectorAsset? = null
