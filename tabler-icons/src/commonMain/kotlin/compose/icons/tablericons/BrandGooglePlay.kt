...
public val TablerIcons.BrandGooglePlay: VectorAsset
    get() {
        if (_brandGooglePlay != null) {
            return _brandGooglePlay!!
        }
        _brandGooglePlay = VectorAssetBuilder(name = "BrandGooglePlay", defaultWidth = 24.0.dp,
...
private var _brandGooglePlay: VectorAsset? = null
