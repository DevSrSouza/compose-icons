...
public val TablerIcons.CalendarMinus: VectorAsset
    get() {
        if (_calendarMinus != null) {
            return _calendarMinus!!
        }
        _calendarMinus = VectorAssetBuilder(name = "CalendarMinus", defaultWidth = 24.0.dp,
...
private var _calendarMinus: VectorAsset? = null
