...
public val FilledGroup.ReceiptAdd: ImageVector
    get() {
        if (_receiptAdd != null) {
            return _receiptAdd!!
        }
        _receiptAdd = Builder(name = "ReceiptAdd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.9739f, 18.174f, 13.0f, 17.8401f, 13.0f, 17.5001f)
                curveTo(13.0f, 15.9915f, 12.4861f, 14.603f, 11.6238f, 13.5f)
                horizontalLineTo(14.25f)
                curveTo(14.6642f, 13.5f, 15.0f, 13.1642f, 15.0f, 12.75f)
                curveTo(15.0f, 12.3358f, 14.6642f, 12.0f, 14.25f, 12.0f)
                horizontalLineTo(9.9656f)
                curveTo(8.9625f, 11.3666f, 7.774f, 11.0001f, 6.5f, 11.0001f)
                curveTo(5.9837f, 11.0001f, 5.4815f, 11.0603f, 5.0f, 11.174f)
