...
public val FilledGroup.TrayItemRemove: ImageVector
    get() {
        if (_trayItemRemove != null) {
            return _trayItemRemove!!
        }
        _trayItemRemove = Builder(name = "TrayItemRemove", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.2803f, 8.7197f)
                curveTo(15.9874f, 8.4268f, 15.5126f, 8.4268f, 15.2197f, 8.7197f)
                lineTo(12.7197f, 11.2197f)
                curveTo(12.4268f, 11.5126f, 12.4268f, 11.9874f, 12.7197f, 12.2803f)
                curveTo(13.0126f, 12.5732f, 13.4874f, 12.5732f, 13.7803f, 12.2803f)
                lineTo(15.0f, 11.0607f)
                verticalLineTo(17.75f)
                curveTo(15.0f, 18.1642f, 15.3358f, 18.5f, 15.75f, 18.5f)
                curveTo(16.1642f, 18.5f, 16.5f, 18.1642f, 16.5f, 17.75f)
                verticalLineTo(11.0607f)
                lineTo(17.7197f, 12.2803f)
                curveTo(18.0126f, 12.5732f, 18.4874f, 12.5732f, 18.7803f, 12.2803f)
                curveTo(19.0732f, 11.9874f, 19.0732f, 11.5126f, 18.7803f, 11.2197f)
                lineTo(16.2803f, 8.7197f)
                close()
                moveTo(6.25f, 13.5f)
