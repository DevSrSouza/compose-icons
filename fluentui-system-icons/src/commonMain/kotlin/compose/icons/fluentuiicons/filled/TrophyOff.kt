...
public val FilledGroup.TrophyOff: ImageVector
    get() {
        if (_trophyOff != null) {
            return _trophyOff!!
        }
        _trophyOff = Builder(name = "TrophyOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.2318f, 12.0007f)
                curveTo(17.0735f, 12.4962f, 16.8499f, 12.9624f, 16.5711f, 13.3893f)
                lineTo(6.3035f, 3.1216f)
                curveTo(6.6931f, 2.4509f, 7.4191f, 2.0f, 8.2506f, 2.0f)
