...
public val FilledGroup.SearchSquare: ImageVector
    get() {
        ...
        _searchSquare = Builder(name = "SearchSquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.0f, 14.0f)
                curveTo(12.6569f, 14.0f, 14.0f, 12.6569f, 14.0f, 11.0f)
                curveTo(14.0f, 9.3432f, 12.6569f, 8.0f, 11.0f, 8.0f)
                curveTo(9.3432f, 8.0f, 8.0f, 9.3432f, 8.0f, 11.0f)
                curveTo(8.0f, 12.6569f, 9.3432f, 14.0f, 11.0f, 14.0f)
                close()
                moveTo(3.0f, 6.25f)
