...
public val FilledGroup.ArrowSyncCheckmark: ImageVector
    get() {
        if (_arrowSyncCheckmark != null) {
            return _arrowSyncCheckmark!!
        }
        _arrowSyncCheckmark = Builder(name = "ArrowSyncCheckmark", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.7983f, 19.2021f)
                curveTo(12.5362f, 19.2309f, 12.2699f, 19.2456f, 12.0002f, 19.2456f)
                curveTo(11.5711f, 19.2456f, 11.1506f, 19.2083f, 10.742f, 19.1367f)
                ...
                lineTo(11.2002f, 4.7986f)
                curveTo(11.4629f, 4.7697f, 11.7298f, 4.7549f, 12.0002f, 4.7549f)
                curveTo(12.4291f, 4.7549f, 12.8493f, 4.7922f, 13.2577f, 4.8636f)
                ...
                close()
                moveTo(15.0303f, 9.9697f)
                curveTo(14.7374f, 9.6768f, 14.2626f, 9.6768f, 13.9697f, 9.9697f)
                lineTo(11.0f, 12.9393f)
                lineTo(10.0303f, 11.9697f)
                curveTo(9.7374f, 11.6768f, 9.2626f, 11.6768f, 8.9697f, 11.9697f)
                curveTo(8.6768f, 12.2626f, 8.6768f, 12.7374f, 8.9697f, 13.0303f)
                lineTo(10.4697f, 14.5303f)
                curveTo(10.7626f, 14.8232f, 11.2374f, 14.8232f, 11.5303f, 14.5303f)
                lineTo(15.0303f, 11.0303f)
                curveTo(15.3232f, 10.7374f, 15.3232f, 10.2626f, 15.0303f, 9.9697f)
                close()
            }
        }
        .build()
