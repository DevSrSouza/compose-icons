...
public val FilledGroup.Storage: ImageVector
    get() {
        if (_storage != null) {
            return _storage!!
        }
        _storage = Builder(name = "Storage", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.0f, 11.5523f, 17.4477f, 12.0f, 18.0f, 12.0f)
                curveTo(18.5523f, 12.0f, 19.0f, 11.5523f, 19.0f, 11.0f)
                curveTo(19.0f, 10.4477f, 18.5523f, 10.0f, 18.0f, 10.0f)
                close()
                moveTo(14.0f, 10.0f)
                curveTo(13.4477f, 10.0f, 13.0f, 10.4477f, 13.0f, 11.0f)
                curveTo(13.0f, 11.5523f, 13.4477f, 12.0f, 14.0f, 12.0f)
                curveTo(14.5523f, 12.0f, 15.0f, 11.5523f, 15.0f, 11.0f)
