...
public val FilledGroup.ShareCloseTray: ImageVector
    get() {
        ...
        _shareCloseTray = Builder(name = "ShareCloseTray", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(9.2807f, 12.22f)
                curveTo(8.988f, 11.9269f, 8.5131f, 11.9266f, 8.22f, 12.2193f)
                curveTo(7.9269f, 12.512f, 7.9266f, 12.9869f, 8.2193f, 13.28f)
                lineTo(11.4693f, 16.5345f)
                curveTo(11.6099f, 16.6753f, 11.8007f, 16.7544f, 11.9997f, 16.7545f)
                curveTo(12.1987f, 16.7546f, 12.3896f, 16.6756f, 12.5303f, 16.5348f)
                close()
            }
        }
        .build()
