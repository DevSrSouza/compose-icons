...
public val FilledGroup.Hd: ImageVector
    get() {
        if (_hd != null) {
            return _hd!!
        }
        _hd = Builder(name = "Hd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.75f, 8.0f)
                horizontalLineTo(14.75f)
                curveTo(16.5449f, 8.0f, 18.0f, 9.4551f, 18.0f, 11.25f)
                verticalLineTo(12.75f)
                curveTo(18.0f, 14.5449f, 16.5449f, 16.0f, 14.75f, 16.0f)
                horizontalLineTo(13.75f)
                curveTo(13.3358f, 16.0f, 13.0f, 15.6642f, 13.0f, 15.25f)
                verticalLineTo(8.75f)
                curveTo(13.0f, 8.3358f, 13.3358f, 8.0f, 13.75f, 8.0f)
                close()
            }
        }
        .build()
