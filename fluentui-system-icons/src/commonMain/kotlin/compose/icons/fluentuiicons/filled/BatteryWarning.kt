...
public val FilledGroup.BatteryWarning: ImageVector
    get() {
        ...
        _batteryWarning = Builder(name = "BatteryWarning", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(9.6676f, 11.2589f)
                curveTo(9.4466f, 10.8732f, 9.1268f, 10.5534f, 8.7411f, 10.3324f)
                curveTo(7.543f, 9.646f, 6.0155f, 10.0608f, 5.3291f, 11.2589f)
                ...
                curveTo(7.2222f, 13.0f, 6.9984f, 13.2239f, 6.9984f, 13.5f)
                verticalLineTo(16.5f)
                lineTo(7.0064f, 16.5899f)
                curveTo(7.0487f, 16.8231f, 7.2529f, 17.0f, 7.4984f, 17.0f)
                curveTo(7.7745f, 17.0f, 7.9984f, 16.7761f, 7.9984f, 16.5f)
