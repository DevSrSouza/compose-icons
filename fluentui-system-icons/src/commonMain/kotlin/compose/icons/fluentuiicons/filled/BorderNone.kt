...
public val FilledGroup.BorderNone: ImageVector
    get() {
        if (_borderNone != null) {
            return _borderNone!!
        }
        _borderNone = Builder(name = "BorderNone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0f, 21.0f)
                curveTo(13.5523f, 21.0f, 14.0f, 20.5523f, 14.0f, 20.0f)
                curveTo(14.0f, 19.4477f, 13.5523f, 19.0f, 13.0f, 19.0f)
                horizontalLineTo(11.0f)
                curveTo(10.4477f, 19.0f, 10.0f, 19.4477f, 10.0f, 20.0f)
                curveTo(10.0f, 20.5523f, 10.4477f, 21.0f, 11.0f, 21.0f)
                horizontalLineTo(13.0f)
                close()
                moveTo(7.0f, 4.0f)
                ...
                curveTo(6.5523f, 5.0f, 7.0f, 4.5523f, 7.0f, 4.0f)
                close()
                moveTo(18.0f, 3.0f)
                curveTo(17.4477f, 3.0f, 17.0f, 3.4477f, 17.0f, 4.0f)
                curveTo(17.0f, 4.5523f, 17.4477f, 5.0f, 18.0f, 5.0f)
