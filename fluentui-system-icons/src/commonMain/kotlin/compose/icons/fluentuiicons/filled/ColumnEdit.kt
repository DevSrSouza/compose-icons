...
public val FilledGroup.ColumnEdit: ImageVector
    get() {
        if (_columnEdit != null) {
            return _columnEdit!!
        }
        _columnEdit = Builder(name = "ColumnEdit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.75f, 3.0f)
                curveTo(9.2312f, 3.0f, 8.0f, 4.2312f, 8.0f, 5.75f)
                verticalLineTo(18.25f)
                curveTo(8.0f, 19.7688f, 9.2312f, 21.0f, 10.75f, 21.0f)
                horizontalLineTo(11.1651f)
                lineTo(11.5209f, 19.5768f)
                curveTo(11.6829f, 18.9288f, 12.018f, 18.3371f, 12.4903f, 17.8648f)
                lineTo(16.0f, 14.355f)
                verticalLineTo(5.75f)
                curveTo(16.0f, 4.2312f, 14.7688f, 3.0f, 13.25f, 3.0f)
