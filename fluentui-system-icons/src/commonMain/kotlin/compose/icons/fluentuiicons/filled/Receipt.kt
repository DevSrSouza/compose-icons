    ...
    get() {
        ...
        _receipt = Builder(name = "Receipt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.0074f, 20.5f, 4.0f, 19.4926f, 4.0f, 18.25f)
                ...
                curveTo(7.0f, 9.1642f, 7.3358f, 9.5f, 7.75f, 9.5f)
                ...
                horizontalLineTo(13.25f)
                curveTo(13.6642f, 13.0f, 14.0f, 12.6642f, 14.0f, 12.25f)
                curveTo(14.0f, 11.8358f, 13.6642f, 11.5f, 13.25f, 11.5f)
                horizontalLineTo(7.75f)
                close()
                moveTo(7.75f, 15.0f)
                curveTo(7.3358f, 15.0f, 7.0f, 15.3358f, 7.0f, 15.75f)
                curveTo(7.0f, 16.1642f, 7.3358f, 16.5f, 7.75f, 16.5f)
                horizontalLineTo(10.25f)
                curveTo(10.6642f, 16.5f, 11.0f, 16.1642f, 11.0f, 15.75f)
                curveTo(11.0f, 15.3358f, 10.6642f, 15.0f, 10.25f, 15.0f)
                horizontalLineTo(7.75f)
                close()
            }
        }
