...
public val FilledGroup.BoxCheckmark: ImageVector
    get() {
        ...
        _boxCheckmark = Builder(name = "BoxCheckmark", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(13.0641f)
                curveTo(13.9361f, 11.7946f, 15.6254f, 11.001f, 17.5f, 11.001f)
                curveTo(19.2465f, 11.001f, 20.8321f, 11.6898f, 22.0f, 12.8105f)
                verticalLineTo(7.1912f)
                close()
                moveTo(11.2498f, 10.7651f)
                verticalLineTo(15.7103f)
                curveTo(11.0871f, 16.2791f, 11.0f, 16.8799f, 11.0f, 17.501f)
                curveTo(11.0f, 18.1221f, 11.0871f, 18.7228f, 11.2498f, 19.2917f)
