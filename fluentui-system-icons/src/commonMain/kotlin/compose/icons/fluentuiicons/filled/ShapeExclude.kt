...
public val FilledGroup.ShapeExclude: ImageVector
    get() {
        if (_shapeExclude != null) {
            return _shapeExclude!!
        }
        _shapeExclude = Builder(name = "ShapeExclude", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.5f, 7.5f)
                verticalLineTo(13.25f)
                curveTo(16.5f, 15.0449f, 15.0449f, 16.5f, 13.25f, 16.5f)
                horizontalLineTo(7.5f)
                verticalLineTo(10.75f)
