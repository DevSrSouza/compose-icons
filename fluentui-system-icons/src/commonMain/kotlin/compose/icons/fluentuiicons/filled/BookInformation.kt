...
public val FilledGroup.BookInformation: ImageVector
    get() {
        ...
        _bookInformation = Builder(name = "BookInformation", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.25f, 8.0f)
                curveTo(12.8023f, 8.0f, 13.25f, 7.5523f, 13.25f, 7.0f)
                curveTo(13.25f, 6.4477f, 12.8023f, 6.0f, 12.25f, 6.0f)
                curveTo(11.6977f, 6.0f, 11.25f, 6.4477f, 11.25f, 7.0f)
                curveTo(11.25f, 7.5523f, 11.6977f, 8.0f, 12.25f, 8.0f)
                close()
                moveTo(11.5f, 9.75f)
                lineTo(11.5f, 14.75f)
