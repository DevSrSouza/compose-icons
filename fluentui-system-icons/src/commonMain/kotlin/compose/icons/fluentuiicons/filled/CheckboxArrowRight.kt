...
public val FilledGroup.CheckboxArrowRight: ImageVector
    get() {
        ...
        _checkboxArrowRight = Builder(name = "CheckboxArrowRight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(9.5263f, 15.0266f)
                curveTo(9.2333f, 15.3192f, 8.7587f, 15.319f, 8.4659f, 15.0262f)
                lineTo(5.7201f, 12.2803f)
                curveTo(5.4273f, 11.9874f, 5.4273f, 11.5125f, 5.7202f, 11.2196f)
                curveTo(6.0131f, 10.9268f, 6.4879f, 10.9268f, 6.7808f, 11.2197f)
                lineTo(8.9966f, 13.4356f)
                lineTo(15.22f, 7.2194f)
                curveTo(15.513f, 6.9266f, 15.9879f, 6.9269f, 16.2806f, 7.22f)
                curveTo(16.5734f, 7.513f, 16.5731f, 7.9879f, 16.28f, 8.2806f)
                close()
                moveTo(17.5f, 12.0f)
