...
public val FilledGroup.TextColumnTwo: ImageVector
    get() {
        ...
        _textColumnTwo = Builder(name = "TextColumnTwo", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(3.0f, 10.0f)
                curveTo(3.0f, 9.4477f, 3.4477f, 9.0f, 4.0f, 9.0f)
                horizontalLineTo(10.0f)
                ...
                horizontalLineTo(10.0f)
                curveTo(10.5523f, 17.0f, 11.0f, 17.4477f, 11.0f, 18.0f)
                ...
                close()
                moveTo(13.0f, 18.0f)
                curveTo(13.0f, 17.4477f, 13.4477f, 17.0f, 14.0f, 17.0f)
                horizontalLineTo(20.0f)
                curveTo(20.5523f, 17.0f, 21.0f, 17.4477f, 21.0f, 18.0f)
                curveTo(21.0f, 18.5523f, 20.5523f, 19.0f, 20.0f, 19.0f)
                horizontalLineTo(14.0f)
                curveTo(13.4477f, 19.0f, 13.0f, 18.5523f, 13.0f, 18.0f)
                close()
            }
        }
        .build()
