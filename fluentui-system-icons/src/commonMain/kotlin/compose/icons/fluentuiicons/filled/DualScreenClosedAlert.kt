...
public val FilledGroup.DualScreenClosedAlert: ImageVector
    get() {
        ...
        _dualScreenClosedAlert = Builder(name = "DualScreenClosedAlert", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(8.1569f)
                lineTo(10.3477f, 9.5397f)
                curveTo(9.9751f, 9.9869f, 9.8948f, 10.6092f, 10.1416f, 11.1363f)
                curveTo(10.3885f, 11.6633f, 10.918f, 12.0f, 11.5f, 12.0f)
                horizontalLineTo(13.6707f)
                curveTo(14.0826f, 13.1652f, 15.1938f, 14.0f, 16.5f, 14.0f)
