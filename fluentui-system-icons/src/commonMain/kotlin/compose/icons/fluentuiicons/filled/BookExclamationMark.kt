...
public val FilledGroup.BookExclamationMark: ImageVector
    get() {
        ...
        _bookExclamationMark = Builder(name = "BookExclamationMark", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.5f, 11.75f)
                lineTo(11.5f, 6.75f)
                curveTo(11.5f, 6.3358f, 11.8358f, 6.0f, 12.25f, 6.0f)
                curveTo(12.6642f, 6.0f, 13.0f, 6.3358f, 13.0f, 6.75f)
                verticalLineTo(11.75f)
                curveTo(13.0f, 12.1642f, 12.6642f, 12.5f, 12.25f, 12.5f)
                curveTo(11.8358f, 12.5f, 11.5f, 12.1642f, 11.5f, 11.75f)
                close()
                moveTo(13.25f, 14.5f)
