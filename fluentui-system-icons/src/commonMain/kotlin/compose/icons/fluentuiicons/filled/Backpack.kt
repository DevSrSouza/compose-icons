...
public val FilledGroup.Backpack: ImageVector
    get() {
        if (_backpack != null) {
            return _backpack!!
        }
        _backpack = Builder(name = "Backpack", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.0f, 15.7143f)
                horizontalLineTo(9.5f)
                verticalLineTo(17.25f)
                curveTo(9.5f, 17.6642f, 9.1642f, 18.0f, 8.75f, 18.0f)
                curveTo(8.3358f, 18.0f, 8.0f, 17.6642f, 8.0f, 17.25f)
                ...
                close()
                moveTo(8.0f, 10.4167f)
                curveTo(8.0f, 9.082f, 9.082f, 8.0f, 10.4167f, 8.0f)
                horizontalLineTo(13.5833f)
                curveTo(14.918f, 8.0f, 16.0f, 9.082f, 16.0f, 10.4167f)
                curveTo(16.0f, 11.2911f, 15.2911f, 12.0f, 14.4167f, 12.0f)
                horizontalLineTo(9.5833f)
                curveTo(8.7089f, 12.0f, 8.0f, 11.2911f, 8.0f, 10.4167f)
                close()
                moveTo(10.4167f, 9.5f)
                curveTo(9.9104f, 9.5f, 9.5f, 9.9104f, 9.5f, 10.4167f)
                curveTo(9.5f, 10.4627f, 9.5373f, 10.5f, 9.5833f, 10.5f)
                horizontalLineTo(14.4167f)
                curveTo(14.4627f, 10.5f, 14.5f, 10.4627f, 14.5f, 10.4167f)
                curveTo(14.5f, 9.9104f, 14.0896f, 9.5f, 13.5833f, 9.5f)
