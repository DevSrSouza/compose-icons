...
public val FilledGroup.ExpandUpLeft: ImageVector
    get() {
        ...
        _expandUpLeft = Builder(name = "ExpandUpLeft", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.2312f, 12.0f, 12.0f, 13.2312f, 12.0f, 14.75f)
                verticalLineTo(19.5f)
                horizontalLineTo(6.25f)
                curveTo(5.2835f, 19.5f, 4.5f, 18.7165f, 4.5f, 17.75f)
                verticalLineTo(13.75f)
                curveTo(4.5f, 13.3358f, 4.1642f, 13.0f, 3.75f, 13.0f)
                curveTo(3.3358f, 13.0f, 3.0f, 13.3358f, 3.0f, 13.75f)
                verticalLineTo(17.75f)
                curveTo(3.0f, 19.5449f, 4.455f, 21.0f, 6.25f, 21.0f)
                lineTo(17.25f, 21.0002f)
                lineTo(17.2839f, 21.0f)
                horizontalLineTo(17.75f)
                curveTo(19.5449f, 21.0f, 21.0f, 19.5449f, 21.0f, 17.75f)
                verticalLineTo(6.25f)
                curveTo(21.0f, 4.4551f, 19.5449f, 3.0f, 17.75f, 3.0f)
                horizontalLineTo(13.75f)
                curveTo(13.3357f, 3.0f, 13.0f, 3.3358f, 13.0f, 3.75f)
                curveTo(13.0f, 4.1642f, 13.3357f, 4.5f, 13.75f, 4.5f)
                horizontalLineTo(17.75f)
                close()
            }
        }
