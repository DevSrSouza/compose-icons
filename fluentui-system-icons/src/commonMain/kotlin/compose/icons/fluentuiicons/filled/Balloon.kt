...
public val FilledGroup.Balloon: ImageVector
    get() {
        if (_balloon != null) {
            return _balloon!!
        }
        _balloon = Builder(name = "Balloon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.9196f, 5.1064f)
                curveTo(12.5165f, 5.0114f, 12.1126f, 5.2613f, 12.0177f, 5.6645f)
                curveTo(11.9228f, 6.0677f, 12.1726f, 6.4715f, 12.5758f, 6.5664f)
                curveTo(13.4916f, 6.7821f, 14.2146f, 7.5037f, 14.4322f, 8.4187f)
                curveTo(14.528f, 8.8217f, 14.9324f, 9.0707f, 15.3353f, 8.9748f)
                curveTo(15.7383f, 8.879f, 15.9873f, 8.4746f, 15.8915f, 8.0717f)
                curveTo(15.5426f, 6.6046f, 14.388f, 5.4521f, 12.9196f, 5.1064f)
                close()
            }
        }
        .build()
