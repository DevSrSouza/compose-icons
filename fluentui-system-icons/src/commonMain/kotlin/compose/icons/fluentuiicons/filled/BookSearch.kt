...
public val FilledGroup.BookSearch: ImageVector
    get() {
        if (_bookSearch != null) {
            return _bookSearch!!
        }
        _bookSearch = Builder(name = "BookSearch", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.4665f, 7.4474f, 9.4474f, 8.4665f, 9.4474f, 9.7237f)
                curveTo(9.4474f, 10.9809f, 10.4665f, 12.0f, 11.7237f, 12.0f)
                curveTo(12.9809f, 12.0f, 14.0f, 10.9809f, 14.0f, 9.7237f)
                curveTo(14.0f, 8.4665f, 12.9809f, 7.4474f, 11.7237f, 7.4474f)
                close()
                moveTo(4.0f, 4.5f)
