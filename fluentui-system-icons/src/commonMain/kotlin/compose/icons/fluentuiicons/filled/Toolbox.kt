...
public val FilledGroup.Toolbox: ImageVector
    get() {
        if (_toolbox != null) {
            return _toolbox!!
        }
        _toolbox = Builder(name = "Toolbox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.5f, 10.3361f, 6.8358f, 10.0003f, 7.25f, 10.0003f)
                curveTo(7.6642f, 10.0003f, 8.0f, 10.3361f, 8.0f, 10.7503f)
                verticalLineTo(11.5003f)
                horizontalLineTo(16.0f)
                verticalLineTo(10.7503f)
                curveTo(16.0f, 10.3361f, 16.3358f, 10.0003f, 16.75f, 10.0003f)
                curveTo(17.1642f, 10.0003f, 17.5f, 10.3361f, 17.5f, 10.7503f)
                verticalLineTo(11.5003f)
                ...
                curveTo(17.5f, 14.6645f, 17.1642f, 15.0003f, 16.75f, 15.0003f)
                curveTo(16.3358f, 15.0003f, 16.0f, 14.6645f, 16.0f, 14.2503f)
                verticalLineTo(13.0003f)
                horizontalLineTo(8.0f)
                verticalLineTo(14.2503f)
                curveTo(8.0f, 14.6645f, 7.6642f, 15.0003f, 7.25f, 15.0003f)
                curveTo(6.8358f, 15.0003f, 6.5f, 14.6645f, 6.5f, 14.2503f)
                verticalLineTo(13.0003f)
