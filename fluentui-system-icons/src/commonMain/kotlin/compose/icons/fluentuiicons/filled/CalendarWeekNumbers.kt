...
public val FilledGroup.CalendarWeekNumbers: ImageVector
    get() {
        ...
        _calendarWeekNumbers = Builder(name = "CalendarWeekNumbers", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.4931f, 7.6482f)
                curveTo(8.4435f, 7.2821f, 8.1297f, 7.0f, 7.75f, 7.0f)
                curveTo(7.3358f, 7.0f, 7.0f, 7.3358f, 7.0f, 7.75f)
                verticalLineTo(8.75f)
                lineTo(7.0068f, 8.8518f)
                curveTo(7.0565f, 9.2178f, 7.3703f, 9.5f, 7.75f, 9.5f)
                curveTo(8.1642f, 9.5f, 8.5f, 9.1642f, 8.5f, 8.75f)
                verticalLineTo(7.75f)
                lineTo(8.4931f, 7.6482f)
                close()
