...
public val FilledGroup.SignOut: ImageVector
    get() {
        if (_signOut != null) {
            return _signOut!!
        }
        _signOut = Builder(name = "SignOut", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.9487f, 11.4995f, 7.5f, 11.9482f, 7.5f, 12.5017f)
                curveTo(7.5f, 13.0552f, 7.9487f, 13.5038f, 8.5021f, 13.5038f)
                curveTo(9.0556f, 13.5038f, 9.5043f, 13.0552f, 9.5043f, 12.5017f)
                curveTo(9.5043f, 11.9482f, 9.0556f, 11.4995f, 8.5021f, 11.4995f)
                close()
