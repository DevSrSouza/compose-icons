...
public val FilledGroup.PhoneLock: ImageVector
    get() {
        if (_phoneLock != null) {
            return _phoneLock!!
        }
        _phoneLock = Builder(name = "PhoneLock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.8175f, 11.3985f, 14.0f, 12.6038f, 14.0f, 14.0f)
                verticalLineTo(14.05f)
                curveTo(12.8589f, 14.2816f, 12.0f, 15.2905f, 12.0f, 16.5f)
                verticalLineTo(18.75f)
                curveTo(12.0f, 18.3358f, 11.6642f, 18.0f, 11.25f, 18.0f)
                horizontalLineTo(8.75f)
                curveTo(8.3358f, 18.0f, 8.0f, 18.3358f, 8.0f, 18.75f)
                curveTo(8.0f, 19.1642f, 8.3358f, 19.5f, 8.75f, 19.5f)
                horizontalLineTo(11.25f)
                curveTo(11.6642f, 19.5f, 12.0f, 19.1642f, 12.0f, 18.75f)
                ...
                verticalLineTo(21.5f)
                curveTo(13.0f, 21.6753f, 13.0301f, 21.8436f, 13.0854f, 22.0f)
                curveTo(13.2913f, 22.5826f, 13.8469f, 23.0f, 14.5f, 23.0f)
                ...
                curveTo(16.9372f, 11.5f, 16.4178f, 11.686f, 16.0f, 11.9998f)
                curveTo(15.3928f, 12.4559f, 15.0f, 13.1821f, 15.0f, 14.0f)
                close()
                moveTo(16.5f, 14.0f)
