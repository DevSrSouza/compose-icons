...
public val FilledGroup.PeopleTeamAdd: ImageVector
    get() {
        if (_peopleTeamAdd != null) {
            return _peopleTeamAdd!!
        }
        _peopleTeamAdd = Builder(name = "PeopleTeamAdd", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.254f, 10.0f)
                curveTo(15.0886f, 10.0f, 15.817f, 10.4543f, 16.2054f, 11.1292f)
                curveTo(13.2353f, 11.7297f, 11.0f, 14.3538f, 11.0f, 17.5f)
                ...
                curveTo(7.5019f, 11.0074f, 8.5093f, 10.0f, 9.7519f, 10.0f)
                horizontalLineTo(14.254f)
                close()
                moveTo(7.4064f, 10.0003f)
                curveTo(6.8929f, 10.5355f, 6.5608f, 11.2462f, 6.509f, 12.0335f)
                lineTo(6.5019f, 12.25f)
                ...
                verticalLineTo(12.25f)
                curveTo(2.0f, 11.0591f, 2.9252f, 10.0844f, 4.096f, 10.0052f)
                lineTo(4.25f, 10.0f)
                lineTo(7.4064f, 10.0003f)
                close()
                moveTo(19.75f, 10.0f)
                curveTo(20.9926f, 10.0f, 22.0f, 11.0074f, 22.0f, 12.25f)
                lineTo(22.0008f, 12.8104f)
                curveTo(20.8328f, 11.6891f, 19.2469f, 11.0f, 17.5f, 11.0f)
                lineTo(17.2568f, 11.0045f)
                curveTo(17.1013f, 10.6296f, 16.8769f, 10.2894f, 16.5995f, 10.0003f)
                lineTo(19.75f, 10.0f)
                close()
                moveTo(18.5f, 4.0f)
