...
public val FilledGroup.SlideLink: ImageVector
    get() {
        if (_slideLink != null) {
            return _slideLink!!
        }
        _slideLink = Builder(name = "SlideLink", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.2239f, 12.8246f, 20.2749f, 12.5f, 19.25f, 12.5f)
                horizontalLineTo(15.75f)
                curveTo(13.1266f, 12.5f, 11.0f, 14.6266f, 11.0f, 17.25f)
                curveTo(11.0f, 18.2749f, 11.3246f, 19.2239f, 11.8766f, 20.0f)
