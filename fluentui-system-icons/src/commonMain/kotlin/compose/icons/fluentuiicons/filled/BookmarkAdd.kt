...
public val FilledGroup.BookmarkAdd: ImageVector
    get() {
        ...
        _bookmarkAdd = Builder(name = "BookmarkAdd", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.4995f, 13.0f)
                curveTo(18.0161f, 13.0f, 18.5186f, 12.9397f, 19.0003f, 12.8259f)
                ...
                curveTo(11.3747f, 4.0096f, 10.9995f, 5.211f, 10.9995f, 6.5f)
                curveTo(10.9995f, 10.0899f, 13.9097f, 13.0f, 17.4995f, 13.0f)
                close()
            }
        }
        .build()
