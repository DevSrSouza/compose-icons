...
public val RegularGroup.SurfaceHub: ImageVector
    get() {
        if (_surfaceHub != null) {
            return _surfaceHub!!
        }
        _surfaceHub = Builder(name = "SurfaceHub", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.4168f, 3.5f)
                horizontalLineTo(6.4238f)
                lineTo(5.5818f, 11.5f)
                horizontalLineTo(17.5748f)
                lineTo(18.4168f, 3.5f)
                close()
            }
        }
        .build()
