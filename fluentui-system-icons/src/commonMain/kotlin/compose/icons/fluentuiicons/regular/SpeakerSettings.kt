...
public val RegularGroup.SpeakerSettings: ImageVector
    get() {
        ...
        _speakerSettings = Builder(name = "SpeakerSettings", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.4591f, 11.7252f, 13.9552f, 12.0217f, 13.5f, 12.3776f)
                verticalLineTo(4.7891f)
                lineTo(8.5248f, 8.9999f)
                horizontalLineTo(4.25f)
                curveTo(3.8358f, 8.9999f, 3.5f, 9.3356f, 3.5f, 9.7499f)
                verticalLineTo(14.2499f)
                curveTo(3.5f, 14.6641f, 3.8358f, 14.9999f, 4.25f, 14.9999f)
                horizontalLineTo(8.5249f)
                lineTo(11.0119f, 17.1056f)
                curveTo(11.004f, 17.2366f, 11.0f, 17.3686f, 11.0f, 17.5015f)
