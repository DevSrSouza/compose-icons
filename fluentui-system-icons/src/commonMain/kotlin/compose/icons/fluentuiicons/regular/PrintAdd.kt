...
public val RegularGroup.PrintAdd: ImageVector
    get() {
        if (_printAdd != null) {
            return _printAdd!!
        }
        _printAdd = Builder(name = "PrintAdd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.5071f, 16.2512f)
                lineTo(20.5049f, 12.2652f)
                curveTo(21.0558f, 11.9775f, 21.5604f, 11.6131f, 22.0043f, 11.1863f)
                ...
                curveTo(11.0589f, 7.5227f, 11.1598f, 8.0253f, 11.3147f, 8.5036f)
                horizontalLineTo(5.25f)
                curveTo(4.2835f, 8.5036f, 3.5f, 9.2871f, 3.5f, 10.2536f)
                verticalLineTo(16.2501f)
                curveTo(3.5f, 16.6643f, 3.8358f, 17.0001f, 4.25f, 17.0001f)
                lineTo(6.0f, 17.0f)
                verticalLineTo(15.25f)
                curveTo(6.0f, 14.0074f, 7.0074f, 13.0f, 8.25f, 13.0f)
                horizontalLineTo(15.75f)
                curveTo(16.9926f, 13.0f, 18.0f, 14.0074f, 18.0f, 15.25f)
                lineTo(18.0009f, 17.0001f)
                lineTo(19.7827f, 17.0005f)
                curveTo(20.1855f, 16.9874f, 20.5077f, 16.6567f, 20.5071f, 16.2512f)
                close()
                moveTo(16.5f, 15.25f)
