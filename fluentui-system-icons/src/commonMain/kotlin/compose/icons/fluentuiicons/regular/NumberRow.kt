...
public val RegularGroup.NumberRow: ImageVector
    get() {
        if (_numberRow != null) {
            return _numberRow!!
        }
        _numberRow = Builder(name = "NumberRow", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(8.75f)
                curveTo(9.4404f, 18.5f, 10.0f, 17.9404f, 10.0f, 17.25f)
                verticalLineTo(6.75f)
                curveTo(10.0f, 6.0596f, 9.4404f, 5.5f, 8.75f, 5.5f)
                close()
                moveTo(19.25f, 4.0f)
                ...
                moveTo(19.25f, 5.5f)
                horizontalLineTo(15.25f)
                curveTo(14.5596f, 5.5f, 14.0f, 6.0596f, 14.0f, 6.75f)
                verticalLineTo(17.25f)
                curveTo(14.0f, 17.9404f, 14.5596f, 18.5f, 15.25f, 18.5f)
                horizontalLineTo(19.25f)
