...
public val RegularGroup.ResizeSmall: ImageVector
    get() {
        ...
        _resizeSmall = Builder(name = "ResizeSmall", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.95f, 10.25f)
                curveTo(7.95f, 9.0074f, 8.9574f, 8.0f, 10.2f, 8.0f)
                horizontalLineTo(13.7f)
                curveTo(14.9427f, 8.0f, 15.95f, 9.0074f, 15.95f, 10.25f)
                verticalLineTo(13.75f)
                curveTo(15.95f, 14.9926f, 14.9427f, 16.0f, 13.7f, 16.0f)
                horizontalLineTo(10.2f)
                curveTo(8.9574f, 16.0f, 7.95f, 14.9926f, 7.95f, 13.75f)
                verticalLineTo(10.25f)
                close()
                moveTo(10.2f, 9.5f)
                curveTo(9.7858f, 9.5f, 9.45f, 9.8358f, 9.45f, 10.25f)
                verticalLineTo(13.75f)
                curveTo(9.45f, 14.1642f, 9.7858f, 14.5f, 10.2f, 14.5f)
                horizontalLineTo(13.7f)
                curveTo(14.1142f, 14.5f, 14.45f, 14.1642f, 14.45f, 13.75f)
                verticalLineTo(10.25f)
                curveTo(14.45f, 9.8358f, 14.1142f, 9.5f, 13.7f, 9.5f)
                horizontalLineTo(10.2f)
                close()
                moveTo(17.75f, 4.5f)
