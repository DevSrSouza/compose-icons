...
public val RegularGroup.BookTheta: ImageVector
    get() {
        if (_bookTheta != null) {
            return _bookTheta!!
        }
        _bookTheta = Builder(name = "BookTheta", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.5961f, 14.7207f, 13.0064f, 15.0f, 12.5f, 15.0f)
                curveTo(11.9936f, 15.0f, 11.4039f, 14.7207f, 10.8847f, 14.0068f)
                curveTo(10.5127f, 13.4954f, 10.2189f, 12.8058f, 10.0827f, 12.0f)
                horizontalLineTo(14.9173f)
                curveTo(14.7811f, 12.8058f, 14.4873f, 13.4954f, 14.1153f, 14.0068f)
                close()
