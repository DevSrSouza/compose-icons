...
public val RegularGroup.TvUsb: ImageVector
    get() {
        if (_tvUsb != null) {
            return _tvUsb!!
        }
        _tvUsb = Builder(name = "TvUsb", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.0596f, 15.5f, 3.5f, 14.9404f, 3.5f, 14.25f)
                verticalLineTo(5.75f)
                curveTo(3.5f, 5.0596f, 4.0596f, 4.5f, 4.75f, 4.5f)
                horizontalLineTo(19.25f)
                curveTo(19.9404f, 4.5f, 20.5f, 5.0596f, 20.5f, 5.75f)
                verticalLineTo(8.5f)
