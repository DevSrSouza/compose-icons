...
public val RegularGroup.GlassesOff: ImageVector
    get() {
        if (_glassesOff != null) {
            return _glassesOff!!
        }
        _glassesOff = Builder(name = "GlassesOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(4.25f, 10.4996f)
                horizontalLineTo(8.7488f)
                curveTo(9.163f, 10.4996f, 9.4988f, 10.8354f, 9.4988f, 11.2496f)
                verticalLineTo(14.7461f)
                curveTo(9.4988f, 15.7126f, 8.7153f, 16.4961f, 7.7488f, 16.4961f)
                horizontalLineTo(5.25f)
                curveTo(4.2835f, 16.4961f, 3.5f, 15.7126f, 3.5f, 14.7461f)
                verticalLineTo(11.2496f)
                curveTo(3.5f, 10.8354f, 3.8358f, 10.4996f, 4.25f, 10.4996f)
                close()
                moveTo(13.303f, 10.1212f)
                lineTo(14.5f, 11.3182f)
                verticalLineTo(11.2496f)
                curveTo(14.5f, 10.8354f, 14.8358f, 10.4996f, 15.25f, 10.4996f)
                horizontalLineTo(19.7488f)
                curveTo(20.163f, 10.4996f, 20.4988f, 10.8354f, 20.4988f, 11.2496f)
                verticalLineTo(14.7461f)
                curveTo(20.4988f, 15.4414f, 20.0934f, 16.042f, 19.506f, 16.3243f)
                ...
                horizontalLineTo(14.7467f)
                lineTo(14.645f, 5.0069f)
                curveTo(14.2789f, 5.0565f, 13.9967f, 5.3703f, 13.9967f, 5.75f)
                curveTo(13.9967f, 6.1642f, 14.3325f, 6.5f, 14.7467f, 6.5f)
