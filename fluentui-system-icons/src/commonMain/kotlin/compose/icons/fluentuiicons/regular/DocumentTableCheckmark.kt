...
public val RegularGroup.DocumentTableCheckmark: ImageVector
    get() {
        ...
        _documentTableCheckmark = Builder(name = "DocumentTableCheckmark", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.9806f, 21.051f, 11.6168f, 21.5557f, 11.1904f, 22.0f)
                ...
                curveTo(4.4742f, 11.3004f, 4.9768f, 11.1572f, 5.5f, 11.0764f)
                verticalLineTo(4.0f)
