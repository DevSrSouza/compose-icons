    ...
    get() {
        ...
        _calculator = Builder(name = "Calculator", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.0f, 17.25f)
                curveTo(17.0f, 17.9404f, 16.4404f, 18.5f, 15.75f, 18.5f)
                curveTo(15.0596f, 18.5f, 14.5f, 17.9404f, 14.5f, 17.25f)
                curveTo(14.5f, 16.5596f, 15.0596f, 16.0f, 15.75f, 16.0f)
                curveTo(16.4404f, 16.0f, 17.0f, 16.5596f, 17.0f, 17.25f)
                close()
                moveTo(12.0f, 14.5f)
                ...
                curveTo(13.25f, 17.9404f, 12.6904f, 18.5f, 12.0f, 18.5f)
                curveTo(11.3096f, 18.5f, 10.75f, 17.9404f, 10.75f, 17.25f)
                curveTo(10.75f, 16.5596f, 11.3096f, 16.0f, 12.0f, 16.0f)
                curveTo(12.6904f, 16.0f, 13.25f, 16.5596f, 13.25f, 17.25f)
                close()
                moveTo(7.25f, 2.0f)
