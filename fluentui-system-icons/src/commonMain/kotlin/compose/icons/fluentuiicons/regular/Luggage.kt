...
public val RegularGroup.Luggage: ImageVector
    get() {
        if (_luggage != null) {
            return _luggage!!
        }
        _luggage = Builder(name = "Luggage", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.7165f, 6.5f, 17.5f, 7.2835f, 17.5f, 8.25f)
                verticalLineTo(17.25f)
                curveTo(17.5f, 18.2165f, 16.7165f, 19.0f, 15.75f, 19.0f)
                horizontalLineTo(8.25f)
                curveTo(7.2835f, 19.0f, 6.5f, 18.2165f, 6.5f, 17.25f)
                verticalLineTo(8.25f)
                curveTo(6.5f, 7.2835f, 7.2835f, 6.5f, 8.25f, 6.5f)
                close()
                moveTo(8.0f, 9.75f)
