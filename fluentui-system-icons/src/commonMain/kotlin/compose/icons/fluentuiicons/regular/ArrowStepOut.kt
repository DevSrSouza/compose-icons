...
public val RegularGroup.ArrowStepOut: ImageVector
    get() {
        ...
        _arrowStepOut = Builder(name = "ArrowStepOut", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.5f, 19.0f)
                curveTo(10.5f, 19.8284f, 11.1716f, 20.5f, 12.0f, 20.5f)
                curveTo(12.8284f, 20.5f, 13.5f, 19.8284f, 13.5f, 19.0f)
                curveTo(13.5f, 18.1716f, 12.8284f, 17.5f, 12.0f, 17.5f)
                curveTo(11.1716f, 17.5f, 10.5f, 18.1716f, 10.5f, 19.0f)
                close()
            }
        }
        .build()
