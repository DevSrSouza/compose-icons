...
public val RegularGroup.BranchCompare: ImageVector
    get() {
        ...
        _branchCompare = Builder(name = "BranchCompare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.5f, 5.5f)
                curveTo(7.5f, 4.3954f, 6.6046f, 3.5f, 5.5f, 3.5f)
                curveTo(4.3954f, 3.5f, 3.5f, 4.3954f, 3.5f, 5.5f)
                curveTo(3.5f, 6.6046f, 4.3954f, 7.5f, 5.5f, 7.5f)
                curveTo(6.6046f, 7.5f, 7.5f, 6.6046f, 7.5f, 5.5f)
                close()
                moveTo(22.0f, 18.5f)
                ...
                close()
                moveTo(20.5f, 18.5f)
                curveTo(20.5f, 17.3954f, 19.6046f, 16.5f, 18.5f, 16.5f)
                curveTo(17.3954f, 16.5f, 16.5f, 17.3954f, 16.5f, 18.5f)
                curveTo(16.5f, 19.6046f, 17.3954f, 20.5f, 18.5f, 20.5f)
                curveTo(19.6046f, 20.5f, 20.5f, 19.6046f, 20.5f, 18.5f)
                close()
            }
        }
        .build()
