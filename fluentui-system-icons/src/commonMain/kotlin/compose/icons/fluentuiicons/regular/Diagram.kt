...
public val RegularGroup.Diagram: ImageVector
    get() {
        if (_diagram != null) {
            return _diagram!!
        }
        _diagram = Builder(name = "Diagram", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.301f, 12.0f, 18.7908f, 12.2279f, 19.1234f, 12.6228f)
                lineTo(22.8237f, 17.0169f)
                curveTo(23.0588f, 17.2961f, 23.0588f, 17.7039f, 22.8237f, 17.9831f)
                lineTo(19.1234f, 22.3772f)
                curveTo(18.7908f, 22.7721f, 18.301f, 23.0f, 17.7848f, 23.0f)
                ...
                close()
                moveTo(9.3621f, 13.5f)
                lineTo(12.3237f, 17.0169f)
                curveTo(12.5588f, 17.2961f, 12.5588f, 17.7039f, 12.3237f, 17.9831f)
                lineTo(9.3621f, 21.5f)
                horizontalLineTo(17.7848f)
                curveTo(17.8585f, 21.5f, 17.9285f, 21.4674f, 17.976f, 21.411f)
                lineTo(21.2695f, 17.5f)
                lineTo(17.976f, 13.589f)
                curveTo(17.9285f, 13.5326f, 17.8585f, 13.5f, 17.7848f, 13.5f)
                horizontalLineTo(9.3621f)
                close()
                moveTo(6.75f, 9.0f)
