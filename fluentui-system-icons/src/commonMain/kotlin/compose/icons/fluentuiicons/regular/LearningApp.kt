...
public val RegularGroup.LearningApp: ImageVector
    get() {
        ...
        _learningApp = Builder(name = "LearningApp", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.159f, 19.0218f, 11.0585f, 18.5195f, 11.0189f, 18.0f)
                horizontalLineTo(4.5f)
                verticalLineTo(4.5f)
                curveTo(4.5f, 3.9477f, 4.9477f, 3.5f, 5.5f, 3.5f)
                horizontalLineTo(17.0f)
                curveTo(17.5523f, 3.5f, 18.0f, 3.9477f, 18.0f, 4.5f)
                verticalLineTo(11.0189f)
                curveTo(18.5195f, 11.0585f, 19.0218f, 11.159f, 19.5f, 11.3135f)
                verticalLineTo(4.5f)
