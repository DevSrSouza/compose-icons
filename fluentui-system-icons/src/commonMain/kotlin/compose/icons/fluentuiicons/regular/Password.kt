    ...
    get() {
        ...
        _password = Builder(name = "Password", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.4872f, 9.9267f, 11.0124f, 9.9268f, 10.7195f, 10.2198f)
                curveTo(10.4267f, 10.5128f, 10.4268f, 10.9876f, 10.7198f, 11.2805f)
                lineTo(11.4395f, 11.9998f)
                lineTo(10.7197f, 12.7197f)
                curveTo(10.4268f, 13.0126f, 10.4268f, 13.4874f, 10.7197f, 13.7803f)
                curveTo(11.0126f, 14.0732f, 11.4874f, 14.0732f, 11.7803f, 13.7803f)
                lineTo(12.5004f, 13.0602f)
                lineTo(13.2198f, 13.7793f)
                curveTo(13.5128f, 14.0721f, 13.9876f, 14.072f, 14.2805f, 13.779f)
                curveTo(14.5733f, 13.4861f, 14.5732f, 13.0112f, 14.2802f, 12.7184f)
                lineTo(13.5611f, 11.9996f)
                lineTo(14.2803f, 11.2803f)
                curveTo(14.5732f, 10.9874f, 14.5732f, 10.5126f, 14.2803f, 10.2197f)
                curveTo(13.9874f, 9.9268f, 13.5126f, 9.9268f, 13.2197f, 10.2197f)
                lineTo(12.5002f, 10.9392f)
                lineTo(11.7802f, 10.2195f)
                close()
                moveTo(5.2195f, 10.2198f)
                ...
                close()
                moveTo(16.5f, 13.5f)
                curveTo(16.0858f, 13.5f, 15.75f, 13.8358f, 15.75f, 14.25f)
                curveTo(15.75f, 14.6642f, 16.0858f, 15.0f, 16.5f, 15.0f)
                ...
                close()
                moveTo(3.5f, 8.25f)
                curveTo(3.5f, 7.2832f, 4.283f, 6.5f, 5.2492f, 6.5f)
                horizontalLineTo(18.7508f)
                curveTo(19.717f, 6.5f, 20.5f, 7.2832f, 20.5f, 8.25f)
                verticalLineTo(15.75f)
                curveTo(20.5f, 16.7165f, 19.7165f, 17.5f, 18.75f, 17.5f)
