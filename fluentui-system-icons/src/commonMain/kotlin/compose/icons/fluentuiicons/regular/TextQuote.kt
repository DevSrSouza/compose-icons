...
public val RegularGroup.TextQuote: ImageVector
    get() {
        if (_textQuote != null) {
            return _textQuote!!
        }
        _textQuote = Builder(name = "TextQuote", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.5f, 7.5f)
                curveTo(6.9477f, 7.5f, 6.5f, 7.9477f, 6.5f, 8.5f)
                curveTo(6.5f, 9.0523f, 6.9477f, 9.5f, 7.5f, 9.5f)
                curveTo(8.0128f, 9.5f, 8.4355f, 9.114f, 8.4933f, 8.6166f)
                lineTo(8.5f, 8.4928f)
                curveTo(8.4956f, 7.9433f, 8.0496f, 7.5f, 7.5f, 7.5f)
                close()
                moveTo(16.5f, 7.5f)
                curveTo(15.9477f, 7.5f, 15.5f, 7.9477f, 15.5f, 8.5f)
                curveTo(15.5f, 9.0523f, 15.9477f, 9.5f, 16.5f, 9.5f)
                curveTo(17.0128f, 9.5f, 17.4355f, 9.114f, 17.4933f, 8.6166f)
                lineTo(17.5f, 8.4928f)
                curveTo(17.4956f, 7.9433f, 17.0496f, 7.5f, 16.5f, 7.5f)
                close()
            }
        }
        .build()
