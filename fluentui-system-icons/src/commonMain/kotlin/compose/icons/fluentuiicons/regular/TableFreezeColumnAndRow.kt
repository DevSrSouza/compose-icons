...
public val RegularGroup.TableFreezeColumnAndRow: ImageVector
    get() {
        if (_tableFreezeColumnAndRow != null) {
            return _tableFreezeColumnAndRow!!
        }
        _tableFreezeColumnAndRow = Builder(name = "TableFreezeColumnAndRow", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.8358f, 8.5f, 8.5f, 8.8358f, 8.5f, 9.25f)
