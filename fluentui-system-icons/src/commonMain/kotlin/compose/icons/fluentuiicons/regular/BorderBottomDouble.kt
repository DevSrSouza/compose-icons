...
public val RegularGroup.BorderBottomDouble: ImageVector
    get() {
        if (_borderBottomDouble != null) {
            return _borderBottomDouble!!
        }
        _borderBottomDouble = Builder(name = "BorderBottomDouble", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.0f, 3.75f)
                curveTo(7.0f, 3.3358f, 6.6642f, 3.0f, 6.25f, 3.0f)
                ...
                curveTo(6.6642f, 4.5f, 7.0f, 4.1642f, 7.0f, 3.75f)
                close()
                moveTo(17.75f, 3.0f)
