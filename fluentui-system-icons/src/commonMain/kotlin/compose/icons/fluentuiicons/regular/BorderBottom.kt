...
public val RegularGroup.BorderBottom: ImageVector
    get() {
        ...
        _borderBottom = Builder(name = "BorderBottom", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.75f, 3.0f)
                curveTo(17.3358f, 3.0f, 17.0f, 3.3358f, 17.0f, 3.75f)
                curveTo(17.0f, 4.1642f, 17.3358f, 4.5f, 17.75f, 4.5f)
                ...
                close()
                moveTo(14.0f, 3.75f)
                curveTo(14.0f, 4.1642f, 13.6642f, 4.5f, 13.25f, 4.5f)
                lineTo(10.75f, 4.5f)
                curveTo(10.3358f, 4.5f, 10.0f, 4.1642f, 10.0f, 3.75f)
                curveTo(10.0f, 3.3358f, 10.3358f, 3.0f, 10.75f, 3.0f)
                horizontalLineTo(13.25f)
                curveTo(13.6642f, 3.0f, 14.0f, 3.3358f, 14.0f, 3.75f)
                close()
                moveTo(3.0f, 17.75f)
                curveTo(3.0f, 17.3358f, 3.3358f, 17.0f, 3.75f, 17.0f)
                curveTo(4.1642f, 17.0f, 4.5f, 17.3358f, 4.5f, 17.75f)
                verticalLineTo(18.25f)
                curveTo(4.5f, 18.9404f, 5.0596f, 19.5f, 5.75f, 19.5f)
                horizontalLineTo(18.25f)
                curveTo(18.9404f, 19.5f, 19.5f, 18.9404f, 19.5f, 18.25f)
                verticalLineTo(17.75f)
                curveTo(19.5f, 17.3358f, 19.8358f, 17.0f, 20.25f, 17.0f)
