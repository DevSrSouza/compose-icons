    ...
    get() {
        ...
        _splitVertical = Builder(name = "SplitVertical", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.4926f, 20.0f, 21.5f, 18.9926f, 21.5f, 17.75f)
                verticalLineTo(6.25f)
                curveTo(21.5f, 5.0074f, 20.4926f, 4.0f, 19.25f, 4.0f)
                horizontalLineTo(13.5f)
                verticalLineTo(5.5f)
                horizontalLineTo(19.25f)
                curveTo(19.6642f, 5.5f, 20.0f, 5.8358f, 20.0f, 6.25f)
                verticalLineTo(17.75f)
                curveTo(20.0f, 18.1642f, 19.6642f, 18.5f, 19.25f, 18.5f)
                close()
            }
        }
        .build()
