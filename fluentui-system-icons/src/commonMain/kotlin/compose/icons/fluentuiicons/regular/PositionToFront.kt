...
public val RegularGroup.PositionToFront: ImageVector
    get() {
        ...
        _positionToFront = Builder(name = "PositionToFront", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.25f, 6.0f)
                curveTo(7.4551f, 6.0f, 6.0f, 7.4551f, 6.0f, 9.25f)
                verticalLineTo(14.75f)
                curveTo(6.0f, 16.5449f, 7.4551f, 18.0f, 9.25f, 18.0f)
                horizontalLineTo(14.75f)
                curveTo(16.5449f, 18.0f, 18.0f, 16.5449f, 18.0f, 14.75f)
                verticalLineTo(9.25f)
                curveTo(18.0f, 7.4551f, 16.5449f, 6.0f, 14.75f, 6.0f)
                horizontalLineTo(9.25f)
                close()
                moveTo(11.5625f, 7.5f)
                lineTo(7.5f, 11.5625f)
                verticalLineTo(9.6838f)
                lineTo(9.6838f, 7.5f)
                horizontalLineTo(11.5625f)
                close()
                moveTo(7.5f, 13.6838f)
                lineTo(13.6838f, 7.5f)
                horizontalLineTo(14.75f)
                curveTo(14.9899f, 7.5f, 15.2186f, 7.5483f, 15.4268f, 7.6357f)
                lineTo(7.6357f, 15.4268f)
                curveTo(7.5483f, 15.2186f, 7.5f, 14.9899f, 7.5f, 14.75f)
                verticalLineTo(13.6838f)
                close()
                moveTo(8.7549f, 16.429f)
                lineTo(16.429f, 8.7549f)
                curveTo(16.4752f, 8.9118f, 16.5f, 9.078f, 16.5f, 9.25f)
                verticalLineTo(10.5625f)
                lineTo(10.5625f, 16.5f)
                horizontalLineTo(9.25f)
                curveTo(9.078f, 16.5f, 8.9118f, 16.4752f, 8.7549f, 16.429f)
                close()
                moveTo(14.6875f, 16.5f)
                horizontalLineTo(12.6838f)
                lineTo(16.5f, 12.6838f)
                verticalLineTo(14.75f)
                lineTo(16.4668f, 14.7168f)
                lineTo(14.6855f, 16.498f)
                lineTo(14.6875f, 16.5f)
                close()
            }
        }
        .build()
