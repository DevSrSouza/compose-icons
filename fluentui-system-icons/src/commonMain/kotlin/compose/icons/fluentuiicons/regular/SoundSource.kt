...
public val RegularGroup.SoundSource: ImageVector
    get() {
        ...
        _soundSource = Builder(name = "SoundSource", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.5644f, 12.7561f)
                curveTo(12.422f, 12.5934f, 12.2163f, 12.5f, 12.0f, 12.5f)
                curveTo(11.7837f, 12.5f, 11.578f, 12.5934f, 11.4356f, 12.7561f)
                lineTo(4.4356f, 20.7561f)
                curveTo(4.2418f, 20.9776f, 4.1954f, 21.2919f, 4.317f, 21.5599f)
                curveTo(4.4386f, 21.8279f, 4.7057f, 22.0f, 5.0f, 22.0f)
                horizontalLineTo(19.0f)
                curveTo(19.2943f, 22.0f, 19.5614f, 21.8279f, 19.683f, 21.5599f)
                curveTo(19.8046f, 21.2919f, 19.7582f, 20.9776f, 19.5644f, 20.7561f)
                lineTo(12.5644f, 12.7561f)
                close()
                moveTo(17.3472f, 20.5f)
                horizontalLineTo(6.6528f)
                lineTo(12.0f, 14.3889f)
                lineTo(17.3472f, 20.5f)
                close()
            }
        }
        .build()
