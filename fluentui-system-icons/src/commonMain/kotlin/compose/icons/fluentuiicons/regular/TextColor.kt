...
public val RegularGroup.TextColor: ImageVector
    get() {
        if (_textColor != null) {
            return _textColor!!
        }
        _textColor = Builder(name = "TextColor", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.75f, 16.0005f)
                horizontalLineTo(5.25f)
                curveTo(4.8358f, 16.0005f, 4.5f, 16.3363f, 4.5f, 16.7505f)
                verticalLineTo(19.7504f)
                curveTo(4.5f, 20.1646f, 4.8358f, 20.5004f, 5.25f, 20.5004f)
                horizontalLineTo(17.75f)
                curveTo(18.1642f, 20.5004f, 18.5f, 20.1646f, 18.5f, 19.7504f)
                verticalLineTo(16.7505f)
                curveTo(18.5f, 16.3363f, 18.1642f, 16.0005f, 17.75f, 16.0005f)
                close()
