...
public val RegularGroup.TagDismiss: ImageVector
    get() {
        if (_tagDismiss != null) {
            return _tagDismiss!!
        }
        _tagDismiss = Builder(name = "TagDismiss", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.5795f, 11.7502f, 20.1002f, 11.5167f, 19.5926f, 11.3442f)
                ...
                curveTo(9.648f, 20.0878f, 10.6534f, 20.1309f, 11.3407f, 19.5824f)
                curveTo(11.5051f, 20.0688f, 11.7255f, 20.5294f, 11.9942f, 20.9565f)
                curveTo(10.7372f, 21.7569f, 9.0505f, 21.6098f, 7.9508f, 20.5143f)
                ...
                close()
                moveTo(15.1464f, 15.1464f)
                curveTo(15.3417f, 14.9512f, 15.6583f, 14.9512f, 15.8536f, 15.1464f)
                lineTo(17.5f, 16.7929f)
                lineTo(19.1464f, 15.1464f)
                curveTo(19.3417f, 14.9512f, 19.6583f, 14.9512f, 19.8536f, 15.1464f)
                curveTo(20.0488f, 15.3417f, 20.0488f, 15.6583f, 19.8536f, 15.8536f)
                lineTo(18.2071f, 17.5f)
                lineTo(19.8536f, 19.1464f)
                curveTo(20.0488f, 19.3417f, 20.0488f, 19.6583f, 19.8536f, 19.8536f)
                curveTo(19.6583f, 20.0488f, 19.3417f, 20.0488f, 19.1464f, 19.8536f)
                lineTo(17.5f, 18.2071f)
                lineTo(15.8536f, 19.8536f)
                curveTo(15.6583f, 20.0488f, 15.3417f, 20.0488f, 15.1464f, 19.8536f)
                curveTo(14.9512f, 19.6583f, 14.9512f, 19.3417f, 15.1464f, 19.1464f)
                lineTo(16.7929f, 17.5f)
                lineTo(15.1464f, 15.8536f)
                curveTo(14.9512f, 15.6583f, 14.9512f, 15.3417f, 15.1464f, 15.1464f)
                close()
            }
        }
        .build()
