...
public val RegularGroup.ChannelArrowLeft: ImageVector
    get() {
        if (_channelArrowLeft != null) {
            return _channelArrowLeft!!
        }
        _channelArrowLeft = Builder(name = "ChannelArrowLeft", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.5001f, 12.0f)
                curveTo(20.5377f, 12.0f, 23.0001f, 14.4624f, 23.0001f, 17.5f)
                curveTo(23.0001f, 20.5376f, 20.5377f, 23.0f, 17.5001f, 23.0f)
                curveTo(14.4625f, 23.0f, 12.0001f, 20.5376f, 12.0001f, 17.5f)
                curveTo(12.0001f, 14.4624f, 14.4625f, 12.0f, 17.5001f, 12.0f)
                close()
                moveTo(4.5003f, 9.3721f)
                lineTo(4.5001f, 17.75f)
                curveTo(4.5001f, 18.6682f, 5.2072f, 19.4212f, 6.1066f, 19.4942f)
                lineTo(6.2501f, 19.5f)
                lineTo(11.3137f, 19.5004f)
                curveTo(11.4862f, 20.0342f, 11.7259f, 20.5378f, 12.0227f, 21.0012f)
                lineTo(6.2501f, 21.0f)
                ...
                close()
                moveTo(16.7193f, 14.5886f)
                lineTo(16.6501f, 14.6464f)
                lineTo(14.1345f, 17.1628f)
                lineTo(14.0938f, 17.2134f)
                lineTo(14.0497f, 17.2901f)
                lineTo(14.0269f, 17.3488f)
                lineTo(14.008f, 17.4341f)
                lineTo(14.0056f, 17.5443f)
                lineTo(14.0206f, 17.6296f)
                lineTo(14.0496f, 17.7098f)
                lineTo(14.0835f, 17.7711f)
                lineTo(14.1344f, 17.8371f)
                lineTo(16.6501f, 20.3536f)
                curveTo(16.8453f, 20.5488f, 17.1619f, 20.5488f, 17.3572f, 20.3536f)
                curveTo(17.5307f, 20.18f, 17.55f, 19.9106f, 17.415f, 19.7157f)
                lineTo(17.3572f, 19.6464f)
                lineTo(15.7111f, 18.0f)
                horizontalLineTo(20.5001f)
                curveTo(20.7456f, 18.0f, 20.9497f, 17.8231f, 20.992f, 17.5899f)
                lineTo(21.0001f, 17.5f)
                curveTo(21.0001f, 17.2545f, 20.8232f, 17.0504f, 20.59f, 17.0081f)
                lineTo(20.5001f, 17.0f)
                horizontalLineTo(15.7111f)
                lineTo(17.3572f, 15.3536f)
                curveTo(17.5307f, 15.18f, 17.55f, 14.9106f, 17.415f, 14.7157f)
                lineTo(17.3572f, 14.6464f)
                curveTo(17.1836f, 14.4729f, 16.9142f, 14.4536f, 16.7193f, 14.5886f)
                close()
                moveTo(12.8066f, 13.0032f)
                curveTo(12.3808f, 13.4475f, 12.0175f, 13.9521f, 11.7308f, 14.5029f)
                ...
                lineTo(12.8066f, 13.0032f)
                close()
                moveTo(17.7501f, 3.0f)
                curveTo(19.4831f, 3.0f, 20.8993f, 4.3565f, 20.995f, 6.0656f)
                lineTo(21.0001f, 6.25f)
                lineTo(21.0008f, 12.0223f)
                curveTo(20.5375f, 11.7256f, 20.0341f, 11.486f, 19.5005f, 11.3136f)
                lineTo(19.5001f, 6.25f)
