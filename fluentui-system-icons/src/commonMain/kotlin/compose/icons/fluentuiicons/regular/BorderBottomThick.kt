...
public val RegularGroup.BorderBottomThick: ImageVector
    get() {
        if (_borderBottomThick != null) {
            return _borderBottomThick!!
        }
        _borderBottomThick = Builder(name = "BorderBottomThick", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(6.25f)
                curveTo(21.0f, 6.6642f, 20.6642f, 7.0f, 20.25f, 7.0f)
                curveTo(19.8358f, 7.0f, 19.5f, 6.6642f, 19.5f, 6.25f)
                verticalLineTo(5.75f)
