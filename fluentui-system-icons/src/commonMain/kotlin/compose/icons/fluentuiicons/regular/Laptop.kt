    ...
    get() {
        ...
        _laptop = Builder(name = "Laptop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.25f, 6.5f)
                horizontalLineTo(5.75f)
                curveTo(5.6119f, 6.5f, 5.5f, 6.6119f, 5.5f, 6.75f)
                verticalLineTo(14.2503f)
                curveTo(5.5f, 14.3884f, 5.6119f, 14.5003f, 5.75f, 14.5003f)
                horizontalLineTo(18.25f)
                curveTo(18.3881f, 14.5003f, 18.5f, 14.3884f, 18.5f, 14.2503f)
                verticalLineTo(6.75f)
                curveTo(18.5f, 6.6119f, 18.3881f, 6.5f, 18.25f, 6.5f)
                close()
            }
        }
        .build()
