...
public val RegularGroup.CalligraphyPen: ImageVector
    get() {
        ...
        _calligraphyPen = Builder(name = "CalligraphyPen", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.9193f, 21.6524f, 11.4386f, 22.0f, 12.0f, 22.0f)
                curveTo(12.5614f, 22.0f, 13.0807f, 21.6524f, 13.3646f, 21.0866f)
                ...
                verticalLineTo(2.75f)
                close()
                moveTo(14.8432f, 7.5f)
                lineTo(16.0826f, 10.5566f)
                curveTo(16.3302f, 11.1672f, 16.2997f, 11.8929f, 16.0138f, 12.4628f)
                lineTo(12.75f, 18.9669f)
                verticalLineTo(12.2993f)
                curveTo(13.1984f, 12.04f, 13.5f, 11.5552f, 13.5f, 11.0f)
                curveTo(13.5f, 10.1716f, 12.8284f, 9.5f, 12.0f, 9.5f)
                curveTo(11.1716f, 9.5f, 10.5f, 10.1716f, 10.5f, 11.0f)
                curveTo(10.5f, 11.5552f, 10.8016f, 12.04f, 11.25f, 12.2993f)
                verticalLineTo(18.9669f)
                lineTo(7.9862f, 12.4628f)
                curveTo(7.7003f, 11.8929f, 7.6698f, 11.1672f, 7.9174f, 10.5566f)
                lineTo(9.1568f, 7.5f)
                horizontalLineTo(14.8432f)
                close()
            }
        }
        .build()
