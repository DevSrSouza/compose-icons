...
public val RegularGroup.PreviewLink: ImageVector
    get() {
        ...
        _previewLink = Builder(name = "PreviewLink", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.5239f, 5.8358f, 4.8597f, 5.5f, 5.2739f, 5.5f)
                horizontalLineTo(18.7297f)
                curveTo(19.1439f, 5.5f, 19.4797f, 5.8358f, 19.4797f, 6.25f)
                verticalLineTo(9.75f)
                curveTo(19.4797f, 10.1642f, 19.1439f, 10.5f, 18.7297f, 10.5f)
                horizontalLineTo(5.2739f)
                curveTo(4.8597f, 10.5f, 4.5239f, 10.1642f, 4.5239f, 9.75f)
                ...
                close()
                moveTo(14.9797f, 16.479f)
                verticalLineTo(13.479f)
                horizontalLineTo(17.9797f)
                verticalLineTo(16.479f)
                horizontalLineTo(14.9797f)
                close()
                moveTo(4.5239f, 13.25f)
                curveTo(4.5239f, 12.8358f, 4.8597f, 12.5f, 5.2739f, 12.5f)
                horizontalLineTo(11.25f)
                curveTo(11.6642f, 12.5f, 12.0f, 12.8358f, 12.0f, 13.25f)
                curveTo(12.0f, 13.6642f, 11.6642f, 14.0f, 11.25f, 14.0f)
                horizontalLineTo(5.2739f)
                curveTo(4.8597f, 14.0f, 4.5239f, 13.6642f, 4.5239f, 13.25f)
                close()
                moveTo(5.2739f, 16.0f)
