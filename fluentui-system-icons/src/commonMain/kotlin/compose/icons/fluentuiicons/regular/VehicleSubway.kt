...
public val RegularGroup.VehicleSubway: ImageVector
    get() {
        ...
        _vehicleSubway = Builder(name = "VehicleSubway", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.4999f, 14.0f)
                horizontalLineTo(5.4999f)
                lineTo(5.5001f, 15.75f)
                curveTo(5.5001f, 16.9926f, 6.5074f, 18.0f, 7.7501f, 18.0f)
                horizontalLineTo(16.2501f)
                curveTo(17.4927f, 18.0f, 18.5001f, 16.9926f, 18.5001f, 15.75f)
                lineTo(18.4999f, 14.0f)
                close()
                moveTo(8.0f, 15.0f)
                curveTo(8.5523f, 15.0f, 9.0f, 15.4477f, 9.0f, 16.0f)
                curveTo(9.0f, 16.5523f, 8.5523f, 17.0f, 8.0f, 17.0f)
                curveTo(7.4478f, 17.0f, 7.0001f, 16.5523f, 7.0001f, 16.0f)
                curveTo(7.0001f, 15.4477f, 7.4478f, 15.0f, 8.0f, 15.0f)
                close()
                moveTo(16.0001f, 15.0f)
                curveTo(16.5523f, 15.0f, 17.0001f, 15.4477f, 17.0001f, 16.0f)
                curveTo(17.0001f, 16.5523f, 16.5523f, 17.0f, 16.0001f, 17.0f)
                curveTo(15.4478f, 17.0f, 15.0001f, 16.5523f, 15.0001f, 16.0f)
                curveTo(15.0001f, 15.4477f, 15.4478f, 15.0f, 16.0001f, 15.0f)
                close()
