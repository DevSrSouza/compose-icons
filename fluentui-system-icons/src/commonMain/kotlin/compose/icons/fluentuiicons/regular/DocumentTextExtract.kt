...
public val RegularGroup.DocumentTextExtract: ImageVector
    get() {
        ...
        _documentTextExtract = Builder(name = "DocumentTextExtract", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(2.75f, 14.25f)
                curveTo(2.3358f, 14.25f, 2.0f, 14.5858f, 2.0f, 15.0f)
                curveTo(2.0f, 15.4142f, 2.3358f, 15.75f, 2.75f, 15.75f)
                horizontalLineTo(9.25f)
                curveTo(9.6642f, 15.75f, 10.0f, 15.4142f, 10.0f, 15.0f)
                curveTo(10.0f, 14.5858f, 9.6642f, 14.25f, 9.25f, 14.25f)
