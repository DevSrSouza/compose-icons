...
public val RegularGroup.EyeOff: ImageVector
    get() {
        if (_eyeOff != null) {
            return _eyeOff!!
        }
        _eyeOff = Builder(name = "EyeOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(14.4679f, 13.4061f)
                lineTo(11.598f, 10.5368f)
                lineTo(11.6f, 10.536f)
                ...
                close()
                moveTo(10.2041f, 11.2655f)
                lineTo(13.7392f, 14.8006f)
                curveTo(13.2892f, 15.2364f, 12.6759f, 15.5046f, 12.0f, 15.5046f)
                curveTo(10.6193f, 15.5046f, 9.5f, 14.3853f, 9.5f, 13.0046f)
                curveTo(9.5f, 12.3287f, 9.7682f, 11.7154f, 10.2041f, 11.2655f)
                close()
                moveTo(12.0f, 5.5f)
