...
public val RegularGroup.Layer: ImageVector
    get() {
        if (_layer != null) {
            return _layer!!
        }
        _layer = Builder(name = "Layer", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.5608f, 4.6065f)
                lineTo(11.4453f, 4.6728f)
                lineTo(5.705f, 8.5003f)
                lineTo(11.4453f, 12.3277f)
                curveTo(11.7439f, 12.5267f, 12.1228f, 12.5488f, 12.4392f, 12.394f)
                lineTo(12.5547f, 12.3277f)
                lineTo(18.294f, 8.5003f)
                lineTo(12.5547f, 4.6728f)
                curveTo(12.2561f, 4.4738f, 11.8772f, 4.4517f, 11.5608f, 4.6065f)
                close()
            }
        }
        .build()
