    ...
    get() {
        ...
        _trophy = Builder(name = "Trophy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.2536f, 3.5f)
                horizontalLineTo(8.2506f)
                curveTo(7.8363f, 3.5f, 7.5006f, 3.8358f, 7.5006f, 4.25f)
                verticalLineTo(10.2485f)
                curveTo(7.5006f, 12.5965f, 9.404f, 14.5f, 11.7521f, 14.5f)
                curveTo(14.1001f, 14.5f, 16.0036f, 12.5965f, 16.0036f, 10.2485f)
                verticalLineTo(4.25f)
                curveTo(16.0036f, 3.8358f, 15.6678f, 3.5f, 15.2536f, 3.5f)
                close()
