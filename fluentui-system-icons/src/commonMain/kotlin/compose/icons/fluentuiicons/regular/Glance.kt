...
public val RegularGroup.Glance: ImageVector
    get() {
        if (_glance != null) {
            return _glance!!
        }
        _glance = Builder(name = "Glance", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.2501f, 12.5017f)
                horizontalLineTo(14.7501f)
                curveTo(14.612f, 12.5017f, 14.5001f, 12.6136f, 14.5001f, 12.7517f)
                verticalLineTo(19.2517f)
                curveTo(14.5001f, 19.3898f, 14.612f, 19.5017f, 14.7501f, 19.5017f)
                horizontalLineTo(19.2501f)
                curveTo(19.3882f, 19.5017f, 19.5001f, 19.3898f, 19.5001f, 19.2517f)
                verticalLineTo(12.7517f)
                curveTo(19.5001f, 12.6136f, 19.3882f, 12.5017f, 19.2501f, 12.5017f)
                close()
                moveTo(9.2683f, 16.5141f)
                horizontalLineTo(4.7539f)
                curveTo(4.6158f, 16.5141f, 4.5039f, 16.626f, 4.5039f, 16.7641f)
                verticalLineTo(19.2517f)
                curveTo(4.5039f, 19.3898f, 4.6158f, 19.5017f, 4.7539f, 19.5017f)
                horizontalLineTo(9.2683f)
                curveTo(9.4064f, 19.5017f, 9.5183f, 19.3898f, 9.5183f, 19.2517f)
                verticalLineTo(16.7641f)
                curveTo(9.5183f, 16.626f, 9.4064f, 16.5141f, 9.2683f, 16.5141f)
                close()
                moveTo(9.2539f, 3.0f)
                ...
                moveTo(9.2539f, 4.5f)
                horizontalLineTo(4.7539f)
                curveTo(4.6158f, 4.5f, 4.5039f, 4.6119f, 4.5039f, 4.75f)
                verticalLineTo(11.25f)
                curveTo(4.5039f, 11.3881f, 4.6158f, 11.5f, 4.7539f, 11.5f)
                horizontalLineTo(9.2539f)
                lineTo(9.3112f, 11.4934f)
                curveTo(9.4217f, 11.4675f, 9.5039f, 11.3683f, 9.5039f, 11.25f)
                verticalLineTo(4.75f)
                curveTo(9.5039f, 4.6119f, 9.392f, 4.5f, 9.2539f, 4.5f)
                close()
                ...
                horizontalLineTo(19.2501f)
                close()
                moveTo(14.7501f, 4.5f)
                curveTo(14.612f, 4.5f, 14.5001f, 4.6119f, 14.5001f, 4.75f)
                verticalLineTo(7.25f)
                curveTo(14.5001f, 7.3881f, 14.612f, 7.5f, 14.7501f, 7.5f)
                horizontalLineTo(19.2501f)
                curveTo(19.3882f, 7.5f, 19.5001f, 7.3881f, 19.5001f, 7.25f)
                verticalLineTo(4.75f)
                curveTo(19.5001f, 4.6119f, 19.3882f, 4.5f, 19.2501f, 4.5f)
                horizontalLineTo(14.7501f)
                close()
            }
        }
