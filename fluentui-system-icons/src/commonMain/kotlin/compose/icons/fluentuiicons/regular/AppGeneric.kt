...
public val RegularGroup.AppGeneric: ImageVector
    get() {
        if (_appGeneric != null) {
            return _appGeneric!!
        }
        _appGeneric = Builder(name = "AppGeneric", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.75f, 12.5f)
                curveTo(12.3358f, 12.5f, 12.0f, 12.8358f, 12.0f, 13.25f)
                curveTo(12.0f, 13.6642f, 12.3358f, 14.0f, 12.75f, 14.0f)
                horizontalLineTo(16.25f)
                curveTo(16.6642f, 14.0f, 17.0f, 13.6642f, 17.0f, 13.25f)
                curveTo(17.0f, 12.8358f, 16.6642f, 12.5f, 16.25f, 12.5f)
                horizontalLineTo(12.75f)
                close()
            }
        }
