...
public val RegularGroup.SaveCopy: ImageVector
    get() {
        if (_saveCopy != null) {
            return _saveCopy!!
        }
        _saveCopy = Builder(name = "SaveCopy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.75f, 6.75f)
                curveTo(11.1642f, 6.75f, 11.5f, 7.0858f, 11.5f, 7.5f)
                verticalLineTo(10.0f)
                horizontalLineTo(14.0f)
                curveTo(14.4142f, 10.0f, 14.75f, 10.3358f, 14.75f, 10.75f)
                curveTo(14.75f, 11.1642f, 14.4142f, 11.5f, 14.0f, 11.5f)
                horizontalLineTo(11.5f)
                verticalLineTo(14.0f)
                curveTo(11.5f, 14.4142f, 11.1642f, 14.75f, 10.75f, 14.75f)
                curveTo(10.3358f, 14.75f, 10.0f, 14.4142f, 10.0f, 14.0f)
                verticalLineTo(11.5f)
                horizontalLineTo(7.5f)
                curveTo(7.0858f, 11.5f, 6.75f, 11.1642f, 6.75f, 10.75f)
                curveTo(6.75f, 10.3358f, 7.0858f, 10.0f, 7.5f, 10.0f)
                horizontalLineTo(10.0f)
                verticalLineTo(7.5f)
                curveTo(10.0f, 7.0858f, 10.3358f, 6.75f, 10.75f, 6.75f)
                close()
            }
        }
        .build()
