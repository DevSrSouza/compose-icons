    ...
    get() {
        ...
        _eye = Builder(name = "Eye", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.9999f, 10.5046f)
                curveTo(10.6192f, 10.5046f, 9.4999f, 11.6239f, 9.4999f, 13.0046f)
                curveTo(9.4999f, 14.3853f, 10.6192f, 15.5046f, 11.9999f, 15.5046f)
                curveTo(13.3806f, 15.5046f, 14.4999f, 14.3853f, 14.4999f, 13.0046f)
                curveTo(14.4999f, 11.6239f, 13.3806f, 10.5046f, 11.9999f, 10.5046f)
                close()
