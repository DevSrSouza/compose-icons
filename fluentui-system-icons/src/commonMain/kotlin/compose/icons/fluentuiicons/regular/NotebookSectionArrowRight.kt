...
public val RegularGroup.NotebookSectionArrowRight: ImageVector
    get() {
        ...
        _notebookSectionArrowRight = Builder(name = "NotebookSectionArrowRight", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(16.5f, 2.75f)
                verticalLineTo(11.0767f)
                curveTo(15.9768f, 11.1575f, 15.4742f, 11.3007f, 15.0f, 11.4985f)
                verticalLineTo(5.4999f)
                horizontalLineTo(9.25f)
                curveTo(8.8358f, 5.4999f, 8.5f, 5.8356f, 8.5f, 6.2499f)
                verticalLineTo(17.7464f)
                curveTo(8.5f, 18.1606f, 8.8358f, 18.4964f, 9.25f, 18.4964f)
                horizontalLineTo(11.0758f)
                curveTo(11.1563f, 19.0195f, 11.2991f, 19.5221f, 11.4965f, 19.9962f)
