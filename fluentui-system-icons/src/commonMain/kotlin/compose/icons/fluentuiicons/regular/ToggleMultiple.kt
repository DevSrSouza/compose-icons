...
public val RegularGroup.ToggleMultiple: ImageVector
    get() {
        ...
        _toggleMultiple = Builder(name = "ToggleMultiple", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.5f, 3.5f)
                horizontalLineTo(6.5f)
                curveTo(4.8432f, 3.5f, 3.5f, 4.8432f, 3.5f, 6.5f)
                curveTo(3.5f, 8.1568f, 4.8432f, 9.5f, 6.5f, 9.5f)
                horizontalLineTo(17.5f)
                curveTo(19.1569f, 9.5f, 20.5f, 8.1568f, 20.5f, 6.5f)
                curveTo(20.5f, 4.8432f, 19.1569f, 3.5f, 17.5f, 3.5f)
                close()
                moveTo(17.5f, 19.5f)
                ...
                close()
                moveTo(6.5f, 14.5f)
                curveTo(4.8432f, 14.5f, 3.5f, 15.8431f, 3.5f, 17.5f)
                curveTo(3.5f, 19.1569f, 4.8432f, 20.5f, 6.5f, 20.5f)
                horizontalLineTo(17.5f)
                curveTo(19.1569f, 20.5f, 20.5f, 19.1569f, 20.5f, 17.5f)
                curveTo(20.5f, 15.8431f, 19.1569f, 14.5f, 17.5f, 14.5f)
                horizontalLineTo(6.5f)
                close()
            }
        }
