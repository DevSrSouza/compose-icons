...
public val RegularGroup.FoodToast: ImageVector
    get() {
        if (_foodToast != null) {
            return _foodToast!!
        }
        _foodToast = Builder(name = "FoodToast", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.5f, 7.75f)
                curveTo(19.5f, 9.2363f, 18.8168f, 10.5628f, 17.75f, 11.4329f)
                verticalLineTo(18.75f)
                curveTo(17.75f, 19.013f, 17.7049f, 19.2654f, 17.622f, 19.5f)
                horizontalLineTo(18.5001f)
                curveTo(18.9143f, 19.5f, 19.2501f, 19.1642f, 19.2501f, 18.75f)
                verticalLineTo(10.6548f)
                curveTo(19.2501f, 10.4488f, 19.3348f, 10.2518f, 19.4844f, 10.1102f)
                curveTo(20.1108f, 9.5169f, 20.5001f, 8.6795f, 20.5001f, 7.75f)
                curveTo(20.5001f, 6.3596f, 19.6269f, 5.1731f, 18.399f, 4.7089f)
                curveTo(19.0864f, 5.5328f, 19.5f, 6.5931f, 19.5f, 7.75f)
                close()
            }
        }
        .build()
