...
public val RegularGroup.ClipboardPaste: ImageVector
    get() {
        ...
        _clipboardPaste = Builder(name = "ClipboardPaste", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(18.75f, 9.5f)
                horizontalLineTo(12.25f)
                curveTo(11.8703f, 9.5f, 11.5565f, 9.7822f, 11.5068f, 10.1482f)
                lineTo(11.5f, 10.25f)
                verticalLineTo(19.75f)
                curveTo(11.5f, 20.1297f, 11.7822f, 20.4435f, 12.1482f, 20.4932f)
                lineTo(12.25f, 20.5f)
                horizontalLineTo(18.75f)
                curveTo(19.1297f, 20.5f, 19.4435f, 20.2178f, 19.4932f, 19.8518f)
                lineTo(19.5f, 19.75f)
                verticalLineTo(10.25f)
                curveTo(19.5f, 9.8703f, 19.2178f, 9.5565f, 18.8518f, 9.5069f)
                lineTo(18.75f, 9.5f)
                close()
