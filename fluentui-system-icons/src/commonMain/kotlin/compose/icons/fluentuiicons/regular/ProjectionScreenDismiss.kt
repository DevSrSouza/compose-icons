...
public val RegularGroup.ProjectionScreenDismiss: ImageVector
    get() {
        ...
        _projectionScreenDismiss = Builder(name = "ProjectionScreenDismiss", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(19.5f, 13.25f)
                verticalLineTo(12.6865f)
                curveTo(20.0335f, 12.5142f, 20.5368f, 12.2747f, 21.0f, 11.9782f)
                ...
                curveTo(11.4594f, 3.8784f, 11.1025f, 4.901f, 11.0189f, 6.0f)
                horizontalLineTo(4.5f)
                verticalLineTo(13.25f)
                curveTo(4.5f, 14.4926f, 5.5074f, 15.5f, 6.75f, 15.5f)
                horizontalLineTo(17.25f)
                curveTo(18.4926f, 15.5f, 19.5f, 14.4926f, 19.5f, 13.25f)
                close()
            }
        }
        .build()
