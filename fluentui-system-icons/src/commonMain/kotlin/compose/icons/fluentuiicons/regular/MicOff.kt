...
public val RegularGroup.MicOff: ImageVector
    get() {
        if (_micOff != null) {
            return _micOff!!
        }
        _micOff = Builder(name = "MicOff", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.1562f, 14.2171f)
                curveTo(12.8105f, 14.3978f, 12.4172f, 14.5f, 12.0f, 14.5f)
                curveTo(10.6193f, 14.5f, 9.5f, 13.3807f, 9.5f, 12.0f)
                verticalLineTo(10.5608f)
                lineTo(13.1562f, 14.2171f)
                close()
                moveTo(14.5f, 6.0f)
                ...
                lineTo(9.5f, 6.3181f)
                verticalLineTo(6.0f)
                curveTo(9.5f, 4.6193f, 10.6193f, 3.5f, 12.0f, 3.5f)
                curveTo(13.3807f, 3.5f, 14.5f, 4.6193f, 14.5f, 6.0f)
                close()
