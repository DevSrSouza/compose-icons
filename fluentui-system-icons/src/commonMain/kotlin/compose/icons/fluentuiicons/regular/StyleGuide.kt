...
public val RegularGroup.StyleGuide: ImageVector
    get() {
        if (_styleGuide != null) {
            return _styleGuide!!
        }
        _styleGuide = Builder(name = "StyleGuide", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.4243f, 4.2269f)
                lineTo(8.1457f, 5.9092f)
                curveTo(7.4789f, 6.0879f, 7.0832f, 6.7733f, 7.2619f, 7.4401f)
                lineTo(9.9795f, 17.5823f)
                curveTo(10.1581f, 18.2492f, 10.8436f, 18.6449f, 11.5104f, 18.4662f)
                lineTo(17.7889f, 16.7839f)
                curveTo(18.4557f, 16.6052f, 18.8515f, 15.9198f, 18.6728f, 15.253f)
                lineTo(15.9552f, 5.1108f)
                curveTo(15.7765f, 4.4439f, 15.0911f, 4.0482f, 14.4243f, 4.2269f)
                close()
                ...
                close()
                moveTo(9.7414f, 7.0346f)
                curveTo(10.2748f, 6.8916f, 10.8232f, 7.2082f, 10.9661f, 7.7417f)
                curveTo(11.1091f, 8.2751f, 10.7925f, 8.8235f, 10.259f, 8.9664f)
                curveTo(9.7255f, 9.1094f, 9.1772f, 8.7928f, 9.0343f, 8.2593f)
                curveTo(8.8913f, 7.7258f, 9.2079f, 7.1775f, 9.7414f, 7.0346f)
                close()
            }
        }
        .build()
