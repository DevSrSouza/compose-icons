...
public val RegularGroup.BookStar: ImageVector
    get() {
        if (_bookStar != null) {
            return _bookStar!!
        }
        _bookStar = Builder(name = "BookStar", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.8907f, 5.874f, 12.6094f, 5.874f, 12.8581f, 6.378f)
                lineTo(13.9585f, 8.6076f)
                lineTo(16.419f, 8.9651f)
                curveTo(16.9752f, 9.0459f, 17.1972f, 9.7294f, 16.7948f, 10.1217f)
                lineTo(15.0143f, 11.8572f)
                lineTo(15.4347f, 14.3078f)
                curveTo(15.5297f, 14.8617f, 14.9482f, 15.2842f, 14.4508f, 15.0226f)
                lineTo(12.25f, 13.8656f)
                lineTo(10.0493f, 15.0226f)
                curveTo(9.5518f, 15.2842f, 8.9704f, 14.8617f, 9.0654f, 14.3078f)
                lineTo(9.4857f, 11.8572f)
                lineTo(7.7053f, 10.1217f)
                curveTo(7.3028f, 9.7294f, 7.5249f, 9.0459f, 8.0811f, 8.9651f)
