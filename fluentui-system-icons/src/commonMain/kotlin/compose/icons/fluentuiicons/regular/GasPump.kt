    ...
    get() {
        ...
        _gasPump = Builder(name = "GasPump", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.7501f, 6.0f)
                curveTo(7.3358f, 6.0f, 7.0001f, 6.3358f, 7.0001f, 6.75f)
                verticalLineTo(11.25f)
                curveTo(7.0001f, 11.6642f, 7.3358f, 12.0f, 7.7501f, 12.0f)
                horizontalLineTo(13.2501f)
                curveTo(13.6644f, 12.0f, 14.0001f, 11.6642f, 14.0001f, 11.25f)
                verticalLineTo(6.75f)
                curveTo(14.0001f, 6.3358f, 13.6644f, 6.0f, 13.2501f, 6.0f)
                horizontalLineTo(7.7501f)
                close()
                moveTo(8.5001f, 10.5f)
                verticalLineTo(7.5f)
                ...
                close()
                moveTo(15.5002f, 20.5f)
                horizontalLineTo(5.5f)
                verticalLineTo(5.75f)
                curveTo(5.5f, 5.0596f, 6.0597f, 4.5f, 6.7501f, 4.5f)
                horizontalLineTo(14.2502f)
                curveTo(14.9405f, 4.5f, 15.5002f, 5.0596f, 15.5002f, 5.75f)
                verticalLineTo(20.5f)
                close()
            }
        }
