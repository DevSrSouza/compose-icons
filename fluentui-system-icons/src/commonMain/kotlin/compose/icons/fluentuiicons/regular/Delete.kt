...
public val RegularGroup.Delete: ImageVector
    get() {
        if (_delete != null) {
            return _delete!!
        }
        _delete = Builder(name = "Delete", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(17.25f)
                curveTo(15.0f, 17.6642f, 14.6642f, 18.0f, 14.25f, 18.0f)
                curveTo(13.8358f, 18.0f, 13.5f, 17.6642f, 13.5f, 17.25f)
                verticalLineTo(9.75f)
                curveTo(13.5f, 9.3358f, 13.8358f, 9.0f, 14.25f, 9.0f)
                close()
                moveTo(6.7342f, 18.4667f)
