...
public val RegularGroup.Bot: ImageVector
    get() {
        if (_bot != null) {
            return _bot!!
        }
        _bot = Builder(name = "Bot", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.7534f, 15.4994f)
                horizontalLineTo(6.2539f)
                curveTo(5.8397f, 15.4994f, 5.5039f, 15.8352f, 5.5039f, 16.2494f)
                verticalLineTo(17.1567f)
                curveTo(5.5039f, 17.8124f, 5.7899f, 18.4354f, 6.2871f, 18.8629f)
                curveTo(7.5452f, 19.9445f, 9.4412f, 20.5006f, 12.0004f, 20.5006f)
                curveTo(14.5603f, 20.5006f, 16.4582f, 19.9442f, 17.7191f, 18.8617f)
                curveTo(18.2169f, 18.4342f, 18.5034f, 17.8107f, 18.5034f, 17.1545f)
                verticalLineTo(16.2494f)
                curveTo(18.5034f, 15.8352f, 18.1676f, 15.4994f, 17.7534f, 15.4994f)
                close()
                ...
                close()
                moveTo(16.2504f, 4.9995f)
                horizontalLineTo(7.7504f)
                curveTo(7.3362f, 4.9995f, 7.0004f, 5.3353f, 7.0004f, 5.7495f)
                verticalLineTo(10.2541f)
                curveTo(7.0004f, 10.6683f, 7.3362f, 11.0041f, 7.7504f, 11.0041f)
                horizontalLineTo(16.2504f)
                curveTo(16.6646f, 11.0041f, 17.0004f, 10.6683f, 17.0004f, 10.2541f)
                verticalLineTo(5.7495f)
                curveTo(17.0004f, 5.3353f, 16.6646f, 4.9995f, 16.2504f, 4.9995f)
                close()
                moveTo(9.7497f, 6.4995f)
                curveTo(10.4396f, 6.4995f, 10.9989f, 7.0588f, 10.9989f, 7.7488f)
                curveTo(10.9989f, 8.4388f, 10.4396f, 8.9981f, 9.7497f, 8.9981f)
                curveTo(9.0597f, 8.9981f, 8.5004f, 8.4388f, 8.5004f, 7.7488f)
                curveTo(8.5004f, 7.0588f, 9.0597f, 6.4995f, 9.7497f, 6.4995f)
                close()
                moveTo(14.2424f, 6.4995f)
                curveTo(14.9324f, 6.4995f, 15.4917f, 7.0588f, 15.4917f, 7.7488f)
                curveTo(15.4917f, 8.4388f, 14.9324f, 8.9981f, 14.2424f, 8.9981f)
                curveTo(13.5524f, 8.9981f, 12.9931f, 8.4388f, 12.9931f, 7.7488f)
                curveTo(12.9931f, 7.0588f, 13.5524f, 6.4995f, 14.2424f, 6.4995f)
                close()
            }
        }
        .build()
