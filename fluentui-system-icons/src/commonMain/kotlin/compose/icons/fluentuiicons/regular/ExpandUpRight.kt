...
public val RegularGroup.ExpandUpRight: ImageVector
    get() {
        ...
        _expandUpRight = Builder(name = "ExpandUpRight", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(19.8358f, 13.0f, 19.5f, 13.3358f, 19.5f, 13.75f)
                verticalLineTo(17.75f)
                curveTo(19.5f, 18.7165f, 18.7165f, 19.5f, 17.75f, 19.5f)
                horizontalLineTo(12.0f)
                verticalLineTo(14.75f)
                curveTo(12.0f, 13.2312f, 10.7688f, 12.0f, 9.25f, 12.0f)
                horizontalLineTo(4.5f)
                verticalLineTo(6.25f)
                close()
                moveTo(4.5f, 13.5f)
                horizontalLineTo(9.25f)
                curveTo(9.9404f, 13.5f, 10.5f, 14.0596f, 10.5f, 14.75f)
