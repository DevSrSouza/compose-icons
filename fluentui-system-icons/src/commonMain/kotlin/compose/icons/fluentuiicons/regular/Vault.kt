    ...
    get() {
        ...
        _vault = Builder(name = "Vault", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.0f, 13.5f)
                curveTo(13.1716f, 13.5f, 12.5f, 12.8284f, 12.5f, 12.0f)
                curveTo(12.5f, 11.1716f, 13.1716f, 10.5f, 14.0f, 10.5f)
                curveTo(14.8284f, 10.5f, 15.5f, 11.1716f, 15.5f, 12.0f)
                curveTo(15.5f, 12.8284f, 14.8284f, 13.5f, 14.0f, 13.5f)
                close()
                moveTo(6.5f, 7.75f)
                ...
                close()
                moveTo(5.75f, 5.5f)
                curveTo(4.5074f, 5.5f, 3.5f, 6.5074f, 3.5f, 7.75f)
                verticalLineTo(16.25f)
                curveTo(3.5f, 17.4926f, 4.5074f, 18.5f, 5.75f, 18.5f)
                horizontalLineTo(18.25f)
                curveTo(19.4926f, 18.5f, 20.5f, 17.4926f, 20.5f, 16.25f)
                verticalLineTo(7.75f)
                curveTo(20.5f, 6.5074f, 19.4926f, 5.5f, 18.25f, 5.5f)
                horizontalLineTo(5.75f)
                close()
            }
        }
