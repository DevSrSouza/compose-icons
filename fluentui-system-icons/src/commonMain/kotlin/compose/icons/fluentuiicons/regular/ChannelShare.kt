...
public val RegularGroup.ChannelShare: ImageVector
    get() {
        ...
        _channelShare = Builder(name = "ChannelShare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.5f, 14.75f)
                curveTo(13.5f, 15.4404f, 14.0596f, 16.0f, 14.75f, 16.0f)
                curveTo(15.4404f, 16.0f, 16.0f, 15.4404f, 16.0f, 14.75f)
                curveTo(16.0f, 14.0596f, 15.4404f, 13.5f, 14.75f, 13.5f)
                ...
                close()
                moveTo(9.25f, 8.0f)
                curveTo(9.9404f, 8.0f, 10.5f, 8.5596f, 10.5f, 9.25f)
                curveTo(10.5f, 9.9404f, 9.9404f, 10.5f, 9.25f, 10.5f)
                curveTo(8.5596f, 10.5f, 8.0f, 9.9404f, 8.0f, 9.25f)
                curveTo(8.0f, 8.5596f, 8.5596f, 8.0f, 9.25f, 8.0f)
                close()
            }
        }
        .build()
