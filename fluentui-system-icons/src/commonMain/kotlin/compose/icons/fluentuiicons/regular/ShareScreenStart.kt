...
public val RegularGroup.ShareScreenStart: ImageVector
    get() {
        ...
        _shareScreenStart = Builder(name = "ShareScreenStart", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.75f, 16.667f, 12.4142f, 17.0028f, 12.0f, 17.0028f)
                curveTo(11.5858f, 17.0028f, 11.25f, 16.667f, 11.25f, 16.2528f)
                verticalLineTo(9.8079f)
                lineTo(9.2807f, 11.7799f)
                curveTo(8.988f, 12.073f, 8.5131f, 12.0734f, 8.22f, 11.7807f)
                curveTo(7.9269f, 11.488f, 7.9266f, 11.0131f, 8.2193f, 10.72f)
                lineTo(11.4693f, 7.4655f)
                curveTo(11.6099f, 7.3247f, 11.8007f, 7.2455f, 11.9997f, 7.2455f)
                close()
            }
        }
        .build()
