...
public val RegularGroup.ImageArrowForward: ImageVector
    get() {
        if (_imageArrowForward != null) {
            return _imageArrowForward!!
        }
        _imageArrowForward = Builder(name = "ImageArrowForward", defaultWidth = 24.0.dp,
                defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 6.5f)
                curveTo(12.0f, 9.5376f, 9.5376f, 12.0f, 6.5f, 12.0f)
                curveTo(3.4624f, 12.0f, 1.0f, 9.5376f, 1.0f, 6.5f)
                curveTo(1.0f, 3.4624f, 3.4624f, 1.0f, 6.5f, 1.0f)
                curveTo(9.5376f, 1.0f, 12.0f, 3.4624f, 12.0f, 6.5f)
                close()
                moveTo(5.3535f, 4.3535f)
                curveTo(5.5488f, 4.1583f, 5.5488f, 3.8417f, 5.3535f, 3.6465f)
                curveTo(5.1583f, 3.4512f, 4.8417f, 3.4512f, 4.6465f, 3.6465f)
                lineTo(3.1465f, 5.1465f)
                curveTo(2.9512f, 5.3417f, 2.9512f, 5.6583f, 3.1465f, 5.8535f)
                lineTo(4.6465f, 7.3535f)
                curveTo(4.8417f, 7.5488f, 5.1583f, 7.5488f, 5.3535f, 7.3535f)
                curveTo(5.5488f, 7.1583f, 5.5488f, 6.8417f, 5.3535f, 6.6465f)
                lineTo(4.7071f, 6.0f)
                horizontalLineTo(6.75f)
                curveTo(7.9926f, 6.0f, 9.0f, 7.0074f, 9.0f, 8.25f)
                verticalLineTo(8.5f)
                curveTo(9.0f, 8.7761f, 9.2239f, 9.0f, 9.5f, 9.0f)
                curveTo(9.7761f, 9.0f, 10.0f, 8.7761f, 10.0f, 8.5f)
                verticalLineTo(8.25f)
                curveTo(10.0f, 6.4551f, 8.5449f, 5.0f, 6.75f, 5.0f)
                horizontalLineTo(4.7071f)
                lineTo(5.3535f, 4.3535f)
                close()
                moveTo(3.0f, 11.9782f)
