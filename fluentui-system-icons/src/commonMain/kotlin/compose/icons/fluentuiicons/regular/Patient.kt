...
public val RegularGroup.Patient: ImageVector
    get() {
        if (_patient != null) {
            return _patient!!
        }
        _patient = Builder(name = "Patient", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.5f, 12.4955f)
                horizontalLineTo(9.5f)
                verticalLineTo(14.5f)
                horizontalLineTo(14.5f)
                verticalLineTo(12.4955f)
                close()
                ...
                close()
                moveTo(12.0f, 6.4955f)
                curveTo(11.4477f, 6.4955f, 11.0f, 6.9432f, 11.0f, 7.4955f)
                curveTo(11.0f, 8.0478f, 11.4477f, 8.4955f, 12.0f, 8.4955f)
                curveTo(12.5523f, 8.4955f, 13.0f, 8.0478f, 13.0f, 7.4955f)
                curveTo(13.0f, 6.9432f, 12.5523f, 6.4955f, 12.0f, 6.4955f)
                close()
            }
        }
        .build()
