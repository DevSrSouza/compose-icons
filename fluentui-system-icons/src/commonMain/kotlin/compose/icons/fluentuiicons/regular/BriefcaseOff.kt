...
public val RegularGroup.BriefcaseOff: ImageVector
    get() {
        ...
        _briefcaseOff = Builder(name = "BriefcaseOff", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.4392f, 18.4999f)
                horizontalLineTo(6.2501f)
                curveTo(5.2835f, 18.4999f, 4.5f, 17.7164f, 4.5f, 16.7499f)
                verticalLineTo(10.2499f)
                curveTo(4.5f, 9.2835f, 5.2835f, 8.5f, 6.2501f, 8.5f)
                horizontalLineTo(7.4393f)
                lineTo(17.4392f, 18.4999f)
                close()
                moveTo(19.5002f, 10.2499f)
                verticalLineTo(16.3181f)
                lineTo(20.8645f, 17.6823f)
                curveTo(20.9528f, 17.387f, 21.0002f, 17.074f, 21.0002f, 16.7499f)
                verticalLineTo(10.2499f)
                curveTo(21.0002f, 8.455f, 19.5451f, 7.0f, 17.7502f, 7.0f)
                horizontalLineTo(16.0002f)
                verticalLineTo(3.75f)
                lineTo(15.9933f, 3.6482f)
                curveTo(15.9436f, 3.2822f, 15.6298f, 3.0f, 15.2501f, 3.0f)
                horizontalLineTo(8.7501f)
                lineTo(8.6483f, 3.0069f)
                curveTo(8.2822f, 3.0565f, 8.0001f, 3.3703f, 8.0001f, 3.75f)
                verticalLineTo(4.8179f)
                lineTo(9.5001f, 6.3179f)
                verticalLineTo(4.5f)
                horizontalLineTo(14.5001f)
                verticalLineTo(7.0f)
                horizontalLineTo(10.1821f)
                lineTo(11.6821f, 8.5f)
                horizontalLineTo(17.7502f)
                curveTo(18.7167f, 8.5f, 19.5002f, 9.2835f, 19.5002f, 10.2499f)
                close()
            }
        }
        .build()
