...
public val RegularGroup.TextIndentDecreaseLtr: ImageVector
    get() {
        if (_textIndentDecreaseLtr != null) {
            return _textIndentDecreaseLtr!!
        }
        _textIndentDecreaseLtr = Builder(name = "TextIndentDecreaseLtr", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(2.7197f, 11.2197f)
                lineTo(4.7197f, 9.2197f)
                curveTo(5.0126f, 8.9268f, 5.4874f, 8.9268f, 5.7803f, 9.2197f)
                curveTo(6.0466f, 9.4859f, 6.0708f, 9.9026f, 5.853f, 10.1962f)
                lineTo(5.7803f, 10.2803f)
                lineTo(4.3107f, 11.75f)
                lineTo(5.7803f, 13.2197f)
                curveTo(6.0732f, 13.5126f, 6.0732f, 13.9874f, 5.7803f, 14.2803f)
                curveTo(5.5141f, 14.5466f, 5.0974f, 14.5708f, 4.8038f, 14.3529f)
                lineTo(4.7197f, 14.2803f)
                lineTo(2.7197f, 12.2803f)
                curveTo(2.4534f, 12.0141f, 2.4292f, 11.5974f, 2.647f, 11.3038f)
                lineTo(2.7197f, 11.2197f)
                lineTo(4.7197f, 9.2197f)
                lineTo(2.7197f, 11.2197f)
                close()
                moveTo(20.75f, 11.0f)
