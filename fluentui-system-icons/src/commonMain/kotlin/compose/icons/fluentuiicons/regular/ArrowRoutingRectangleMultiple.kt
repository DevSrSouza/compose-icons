...
public val RegularGroup.ArrowRoutingRectangleMultiple: ImageVector
    get() {
        if (_arrowRoutingRectangleMultiple != null) {
            return _arrowRoutingRectangleMultiple!!
        }
        _arrowRoutingRectangleMultiple = Builder(name = "ArrowRoutingRectangleMultiple",
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(23.0f, 17.5f)
                curveTo(23.0f, 17.2239f, 22.7761f, 17.0f, 22.5f, 17.0f)
                curveTo(22.2239f, 17.0f, 22.0f, 17.2239f, 22.0f, 17.5f)
                verticalLineTo(20.5f)
                curveTo(22.0f, 21.3284f, 21.3284f, 22.0f, 20.5f, 22.0f)
                horizontalLineTo(16.5f)
                curveTo(16.2239f, 22.0f, 16.0f, 22.2239f, 16.0f, 22.5f)
                curveTo(16.0f, 22.7761f, 16.2239f, 23.0f, 16.5f, 23.0f)
                horizontalLineTo(20.5f)
                curveTo(21.8807f, 23.0f, 23.0f, 21.8807f, 23.0f, 20.5f)
