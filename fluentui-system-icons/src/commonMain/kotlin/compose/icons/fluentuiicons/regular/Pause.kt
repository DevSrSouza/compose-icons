    ...
    get() {
        ...
        _pause = Builder(name = "Pause", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(18.75f)
                curveTo(9.5f, 19.1642f, 9.1642f, 19.5f, 8.75f, 19.5f)
                horizontalLineTo(6.25f)
                curveTo(5.8358f, 19.5f, 5.5f, 19.1642f, 5.5f, 18.75f)
                verticalLineTo(5.25f)
                close()
                moveTo(15.25f, 3.0f)
                ...
                close()
                moveTo(14.5f, 5.25f)
                curveTo(14.5f, 4.8358f, 14.8358f, 4.5f, 15.25f, 4.5f)
                horizontalLineTo(17.75f)
                curveTo(18.1642f, 4.5f, 18.5f, 4.8358f, 18.5f, 5.25f)
                verticalLineTo(18.75f)
                curveTo(18.5f, 19.1642f, 18.1642f, 19.5f, 17.75f, 19.5f)
                horizontalLineTo(15.25f)
