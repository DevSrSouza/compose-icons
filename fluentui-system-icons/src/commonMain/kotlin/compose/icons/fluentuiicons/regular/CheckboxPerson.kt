...
public val RegularGroup.CheckboxPerson: ImageVector
    get() {
        ...
        _checkboxPerson = Builder(name = "CheckboxPerson", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF212121)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.0f, 19.6802f, 13.0045f, 19.5895f, 13.0132f, 19.5f)
                ...
                verticalLineTo(11.1449f)
                curveTo(20.0762f, 11.3164f, 20.5901f, 11.6323f, 21.0f, 12.0505f)
                verticalLineTo(6.25f)
                curveTo(21.0f, 4.4551f, 19.5449f, 3.0f, 17.75f, 3.0f)
                horizontalLineTo(6.25f)
                close()
                moveTo(17.28f, 9.2806f)
                curveTo(17.5731f, 8.9879f, 17.5734f, 8.513f, 17.2806f, 8.22f)
                curveTo(16.9879f, 7.9269f, 16.513f, 7.9266f, 16.22f, 8.2194f)
                lineTo(9.9966f, 14.4356f)
                lineTo(7.7808f, 12.2197f)
                curveTo(7.4879f, 11.9268f, 7.0131f, 11.9268f, 6.7202f, 12.2196f)
                curveTo(6.4273f, 12.5125f, 6.4273f, 12.9874f, 6.7201f, 13.2803f)
                lineTo(9.4659f, 16.0262f)
                curveTo(9.7587f, 16.319f, 10.2333f, 16.3192f, 10.5263f, 16.0266f)
                lineTo(17.28f, 9.2806f)
                close()
                moveTo(21.0f, 14.5f)
