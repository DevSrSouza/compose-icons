...
val srcDir = File("eva-icons/src/commonMain/kotlin").apply { mkdirs() }
...
val resDir = File("eva-icons/src/commonMain/resources").makeDirs()
...
File("eva-icons/EvaIconsMap.kt").apply {
...
File("eva-icons/DOCUMENTATION.md").apply{
    if(exists().not()) createNewFile()
}.writeText(
    header + "\n" + license + "\n" + documentationGroups
)
