...
public val OutlineGroup.ArrowBack: VectorAsset
    get() {
        if (_arrowBack != null) {
            return _arrowBack!!
        }
        _arrowBack = VectorAssetBuilder(name = "ArrowBack", defaultWidth = 24.0.dp, defaultHeight =
...
private var _arrowBack: VectorAsset? = null
