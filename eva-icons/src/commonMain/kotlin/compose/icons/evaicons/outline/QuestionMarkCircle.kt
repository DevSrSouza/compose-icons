...
public val OutlineGroup.QuestionMarkCircle: VectorAsset
    get() {
        if (_questionMarkCircle != null) {
            return _questionMarkCircle!!
        }
        _questionMarkCircle = VectorAssetBuilder(name = "QuestionMarkCircle", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(3.49f, 3.49f, 0.0f, false, false, 12.0f, 6.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var _questionMarkCircle: VectorAsset? = null
