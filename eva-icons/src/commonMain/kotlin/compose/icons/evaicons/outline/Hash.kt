...
public val OutlineGroup.Hash: VectorAsset
    get() {
        if (_hash != null) {
            return _hash!!
        }
        _hash = VectorAssetBuilder(name = "Hash", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _hash: VectorAsset? = null
