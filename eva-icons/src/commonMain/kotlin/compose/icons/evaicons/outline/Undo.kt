...
public val OutlineGroup.Undo: VectorAsset
    get() {
        if (_undo != null) {
            return _undo!!
        }
        _undo = VectorAssetBuilder(name = "Undo", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.45f, 11.5f)
                arcToRelative(11.07f, 11.07f, 0.0f, false, true, 8.81f, 4.26f)
                arcTo(9.0f, 9.0f, 0.0f, false, false, 10.45f, 9.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -1.0f, -1.0f)
                lineTo(9.45f, 6.08f)
                lineTo(4.63f, 10.25f)
                lineToRelative(4.82f, 4.21f)
                verticalLineToRelative(-2.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 10.45f, 11.5f)
                close()
            }
        }
        .build()
...
private var _undo: VectorAsset? = null
