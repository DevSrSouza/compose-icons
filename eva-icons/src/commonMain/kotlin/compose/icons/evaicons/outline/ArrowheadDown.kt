...
public val OutlineGroup.ArrowheadDown: VectorAsset
    get() {
        if (_arrowheadDown != null) {
            return _arrowheadDown!!
        }
        _arrowheadDown = VectorAssetBuilder(name = "ArrowheadDown", defaultWidth = 24.0.dp,
...
private var _arrowheadDown: VectorAsset? = null
