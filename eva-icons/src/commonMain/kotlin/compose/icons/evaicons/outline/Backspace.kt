...
public val OutlineGroup.Backspace: VectorAsset
    get() {
        if (_backspace != null) {
            return _backspace!!
        }
        _backspace = VectorAssetBuilder(name = "Backspace", defaultWidth = 24.0.dp, defaultHeight =
...
private var _backspace: VectorAsset? = null
