...
public val OutlineGroup.PersonRemove: VectorAsset
    get() {
        if (_personRemove != null) {
            return _personRemove!!
        }
        _personRemove = VectorAssetBuilder(name = "PersonRemove", defaultWidth = 24.0.dp,
...
private var _personRemove: VectorAsset? = null
