...
public val OutlineGroup.CheckmarkSquare2: VectorAsset
    get() {
        if (_checkmarkSquare2 != null) {
            return _checkmarkSquare2!!
        }
        _checkmarkSquare2 = VectorAssetBuilder(name = "CheckmarkSquare2", defaultWidth = 24.0.dp,
...
private var _checkmarkSquare2: VectorAsset? = null
