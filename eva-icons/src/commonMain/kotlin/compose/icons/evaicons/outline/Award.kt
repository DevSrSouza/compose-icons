...
public val OutlineGroup.Award: VectorAsset
    get() {
        if (_award != null) {
            return _award!!
        }
        _award = VectorAssetBuilder(name = "Award", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.31f, 16.71f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -1.0f, 0.0f)
                lineToRelative(-3.75f, 2.2f)
                lineTo(9.0f, 13.21f)
                arcToRelative(5.94f, 5.94f, 0.0f, false, false, 5.92f, 0.0f)
                lineTo(16.45f, 19.0f)
                close()
            }
        }
...
private var _award: VectorAsset? = null
