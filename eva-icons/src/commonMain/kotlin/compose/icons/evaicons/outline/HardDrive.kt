...
public val OutlineGroup.HardDrive: VectorAsset
    get() {
        if (_hardDrive != null) {
            return _hardDrive!!
        }
        _hardDrive = VectorAssetBuilder(name = "HardDrive", defaultWidth = 24.0.dp, defaultHeight =
...
private var _hardDrive: VectorAsset? = null
