...
public val OutlineGroup.ArrowheadRight: VectorAsset
    get() {
        if (_arrowheadRight != null) {
            return _arrowheadRight!!
        }
        _arrowheadRight = VectorAssetBuilder(name = "ArrowheadRight", defaultWidth = 24.0.dp,
...
private var _arrowheadRight: VectorAsset? = null
