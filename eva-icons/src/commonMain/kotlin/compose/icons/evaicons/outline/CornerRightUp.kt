...
public val OutlineGroup.CornerRightUp: VectorAsset
    get() {
        if (_cornerRightUp != null) {
            return _cornerRightUp!!
        }
        _cornerRightUp = VectorAssetBuilder(name = "CornerRightUp", defaultWidth = 24.0.dp,
...
private var _cornerRightUp: VectorAsset? = null
