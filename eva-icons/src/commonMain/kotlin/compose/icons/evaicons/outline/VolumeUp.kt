...
public val OutlineGroup.VolumeUp: VectorAsset
    get() {
        if (_volumeUp != null) {
            return _volumeUp!!
        }
        _volumeUp = VectorAssetBuilder(name = "VolumeUp", defaultWidth = 24.0.dp, defaultHeight =
...
private var _volumeUp: VectorAsset? = null
