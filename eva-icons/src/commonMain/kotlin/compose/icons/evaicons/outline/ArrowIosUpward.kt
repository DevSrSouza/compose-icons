...
public val OutlineGroup.ArrowIosUpward: VectorAsset
    get() {
        if (_arrowIosUpward != null) {
            return _arrowIosUpward!!
        }
        _arrowIosUpward = VectorAssetBuilder(name = "ArrowIosUpward", defaultWidth = 24.0.dp,
...
private var _arrowIosUpward: VectorAsset? = null
