...
public val OutlineGroup.DoneAll: VectorAsset
    get() {
        if (_doneAll != null) {
            return _doneAll!!
        }
        _doneAll = VectorAssetBuilder(name = "DoneAll", defaultWidth = 24.0.dp, defaultHeight =
...
private var _doneAll: VectorAsset? = null
