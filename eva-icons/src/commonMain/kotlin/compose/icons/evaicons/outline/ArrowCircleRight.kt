...
public val OutlineGroup.ArrowCircleRight: VectorAsset
    get() {
        if (_arrowCircleRight != null) {
            return _arrowCircleRight!!
        }
        _arrowCircleRight = VectorAssetBuilder(name = "ArrowCircleRight", defaultWidth = 24.0.dp,
...
private var _arrowCircleRight: VectorAsset? = null
