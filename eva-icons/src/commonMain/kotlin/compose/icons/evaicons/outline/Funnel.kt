...
public val OutlineGroup.Funnel: VectorAsset
    get() {
        if (_funnel != null) {
            return _funnel!!
        }
        _funnel = VectorAssetBuilder(name = "Funnel", defaultWidth = 24.0.dp, defaultHeight =
...
private var _funnel: VectorAsset? = null
