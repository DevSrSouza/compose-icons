...
public val OutlineGroup.MenuArrow: VectorAsset
    get() {
        if (_menuArrow != null) {
            return _menuArrow!!
        }
        _menuArrow = VectorAssetBuilder(name = "MenuArrow", defaultWidth = 24.0.dp, defaultHeight =
...
private var _menuArrow: VectorAsset? = null
