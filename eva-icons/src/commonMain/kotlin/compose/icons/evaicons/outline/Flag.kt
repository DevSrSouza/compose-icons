...
public val OutlineGroup.Flag: VectorAsset
    get() {
        if (_flag != null) {
            return _flag!!
        }
        _flag = VectorAssetBuilder(name = "Flag", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flag: VectorAsset? = null
