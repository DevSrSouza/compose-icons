...
public val OutlineGroup.Pricetags: VectorAsset
    get() {
        if (_pricetags != null) {
            return _pricetags!!
        }
        _pricetags = VectorAssetBuilder(name = "Pricetags", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pricetags: VectorAsset? = null
