...
public val OutlineGroup.VolumeOff: VectorAsset
    get() {
        if (_volumeOff != null) {
            return _volumeOff!!
        }
        _volumeOff = VectorAssetBuilder(name = "VolumeOff", defaultWidth = 24.0.dp, defaultHeight =
...
private var _volumeOff: VectorAsset? = null
