...
public val OutlineGroup.Flash: VectorAsset
    get() {
        if (_flash != null) {
            return _flash!!
        }
        _flash = VectorAssetBuilder(name = "Flash", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flash: VectorAsset? = null
