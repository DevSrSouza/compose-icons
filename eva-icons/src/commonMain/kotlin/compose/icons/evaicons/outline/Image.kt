...
public val OutlineGroup.Image: VectorAsset
    get() {
        if (_image != null) {
            return _image!!
        }
        _image = VectorAssetBuilder(name = "Image", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-3.2f, -2.73f)
                arcToRelative(2.77f, 2.77f, 0.0f, false, false, -3.52f, 0.0f)
                lineTo(5.0f, 17.7f)
                verticalLineTo(6.0f)
                ...
                lineToRelative(7.0f, -5.84f)
                arcToRelative(0.78f, 0.78f, 0.0f, false, true, 0.93f, 0.0f)
                lineTo(19.0f, 17.0f)
