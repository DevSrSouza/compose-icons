...
public val OutlineGroup.FileText: VectorAsset
    get() {
        if (_fileText != null) {
            return _fileText!!
        }
        _fileText = VectorAssetBuilder(name = "FileText", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fileText: VectorAsset? = null
