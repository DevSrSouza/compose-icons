...
public val OutlineGroup.CodeDownload: VectorAsset
    get() {
        if (_codeDownload != null) {
            return _codeDownload!!
        }
        _codeDownload = VectorAssetBuilder(name = "CodeDownload", defaultWidth = 24.0.dp,
...
private var _codeDownload: VectorAsset? = null
