...
public val OutlineGroup.Refresh: VectorAsset
    get() {
        if (_refresh != null) {
            return _refresh!!
        }
        _refresh = VectorAssetBuilder(name = "Refresh", defaultWidth = 24.0.dp, defaultHeight =
...
private var _refresh: VectorAsset? = null
