...
public val OutlineGroup.Music: VectorAsset
    get() {
        if (_music != null) {
            return _music!!
        }
        _music = VectorAssetBuilder(name = "Music", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _music: VectorAsset? = null
