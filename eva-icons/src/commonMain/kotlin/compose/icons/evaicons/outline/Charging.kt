...
public val OutlineGroup.Charging: VectorAsset
    get() {
        if (_charging != null) {
            return _charging!!
        }
        _charging = VectorAssetBuilder(name = "Charging", defaultWidth = 24.0.dp, defaultHeight =
...
private var _charging: VectorAsset? = null
