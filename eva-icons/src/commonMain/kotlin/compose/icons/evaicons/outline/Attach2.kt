...
public val OutlineGroup.Attach2: VectorAsset
    get() {
        if (_attach2 != null) {
            return _attach2!!
        }
        _attach2 = VectorAssetBuilder(name = "Attach2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _attach2: VectorAsset? = null
