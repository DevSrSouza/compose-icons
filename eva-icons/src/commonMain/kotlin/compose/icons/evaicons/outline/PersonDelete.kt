...
public val OutlineGroup.PersonDelete: VectorAsset
    get() {
        if (_personDelete != null) {
            return _personDelete!!
        }
        _personDelete = VectorAssetBuilder(name = "PersonDelete", defaultWidth = 24.0.dp,
...
private var _personDelete: VectorAsset? = null
