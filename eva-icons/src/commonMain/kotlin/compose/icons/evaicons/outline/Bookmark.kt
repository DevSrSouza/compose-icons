...
public val OutlineGroup.Bookmark: VectorAsset
    get() {
        if (_bookmark != null) {
            return _bookmark!!
        }
        _bookmark = VectorAssetBuilder(name = "Bookmark", defaultWidth = 24.0.dp, defaultHeight =
...
private var _bookmark: VectorAsset? = null
