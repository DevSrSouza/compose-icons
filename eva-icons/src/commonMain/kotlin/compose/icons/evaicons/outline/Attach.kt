...
public val OutlineGroup.Attach: VectorAsset
    get() {
        if (_attach != null) {
            return _attach!!
        }
        _attach = VectorAssetBuilder(name = "Attach", defaultWidth = 24.0.dp, defaultHeight =
...
private var _attach: VectorAsset? = null
