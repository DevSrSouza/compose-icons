...
public val OutlineGroup.Swap: VectorAsset
    get() {
        if (_swap != null) {
            return _swap!!
        }
        _swap = VectorAssetBuilder(name = "Swap", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _swap: VectorAsset? = null
