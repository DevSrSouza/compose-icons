...
public val OutlineGroup.Repeat: VectorAsset
    get() {
        if (_repeat != null) {
            return _repeat!!
        }
        _repeat = VectorAssetBuilder(name = "Repeat", defaultWidth = 24.0.dp, defaultHeight =
...
private var _repeat: VectorAsset? = null
