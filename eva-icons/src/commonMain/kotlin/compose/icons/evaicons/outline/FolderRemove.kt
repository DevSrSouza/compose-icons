...
public val OutlineGroup.FolderRemove: VectorAsset
    get() {
        if (_folderRemove != null) {
            return _folderRemove!!
        }
        _folderRemove = VectorAssetBuilder(name = "FolderRemove", defaultWidth = 24.0.dp,
...
private var _folderRemove: VectorAsset? = null
