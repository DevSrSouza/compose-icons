...
public val OutlineGroup.ArrowDownward: VectorAsset
    get() {
        if (_arrowDownward != null) {
            return _arrowDownward!!
        }
        _arrowDownward = VectorAssetBuilder(name = "ArrowDownward", defaultWidth = 24.0.dp,
...
private var _arrowDownward: VectorAsset? = null
