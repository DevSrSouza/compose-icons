...
public val OutlineGroup.CheckmarkCircle: VectorAsset
    get() {
        if (_checkmarkCircle != null) {
            return _checkmarkCircle!!
        }
        _checkmarkCircle = VectorAssetBuilder(name = "CheckmarkCircle", defaultWidth = 24.0.dp,
...
private var _checkmarkCircle: VectorAsset? = null
