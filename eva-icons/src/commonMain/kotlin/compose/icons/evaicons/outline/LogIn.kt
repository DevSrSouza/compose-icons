...
public val OutlineGroup.LogIn: VectorAsset
    get() {
        if (_logIn != null) {
            return _logIn!!
        }
        _logIn = VectorAssetBuilder(name = "LogIn", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _logIn: VectorAsset? = null
