...
public val OutlineGroup.CornerDownRight: VectorAsset
    get() {
        if (_cornerDownRight != null) {
            return _cornerDownRight!!
        }
        _cornerDownRight = VectorAssetBuilder(name = "CornerDownRight", defaultWidth = 24.0.dp,
...
private var _cornerDownRight: VectorAsset? = null
