...
public val OutlineGroup.Linkedin: VectorAsset
    get() {
        if (_linkedin != null) {
            return _linkedin!!
        }
        _linkedin = VectorAssetBuilder(name = "Linkedin", defaultWidth = 24.0.dp, defaultHeight =
...
private var _linkedin: VectorAsset? = null
