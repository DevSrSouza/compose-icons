...
public val OutlineGroup.Settings2: VectorAsset
    get() {
        if (_settings2 != null) {
            return _settings2!!
        }
        _settings2 = VectorAssetBuilder(name = "Settings2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _settings2: VectorAsset? = null
