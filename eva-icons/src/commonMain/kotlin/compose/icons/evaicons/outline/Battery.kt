...
public val OutlineGroup.Battery: VectorAsset
    get() {
        if (_battery != null) {
            return _battery!!
        }
        _battery = VectorAssetBuilder(name = "Battery", defaultWidth = 24.0.dp, defaultHeight =
...
private var _battery: VectorAsset? = null
