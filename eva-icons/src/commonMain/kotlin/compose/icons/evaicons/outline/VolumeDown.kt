...
public val OutlineGroup.VolumeDown: VectorAsset
    get() {
        if (_volumeDown != null) {
            return _volumeDown!!
        }
        _volumeDown = VectorAssetBuilder(name = "VolumeDown", defaultWidth = 24.0.dp, defaultHeight
...
private var _volumeDown: VectorAsset? = null
