...
public val OutlineGroup.ColorPalette: VectorAsset
    get() {
        if (_colorPalette != null) {
            return _colorPalette!!
        }
        _colorPalette = VectorAssetBuilder(name = "ColorPalette", defaultWidth = 24.0.dp,
...
private var _colorPalette: VectorAsset? = null
