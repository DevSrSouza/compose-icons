...
public val OutlineGroup.Maximize: VectorAsset
    get() {
        if (_maximize != null) {
            return _maximize!!
        }
        _maximize = VectorAssetBuilder(name = "Maximize", defaultWidth = 24.0.dp, defaultHeight =
...
private var _maximize: VectorAsset? = null
