...
public val OutlineGroup.ArrowheadUp: VectorAsset
    get() {
        if (_arrowheadUp != null) {
            return _arrowheadUp!!
        }
        _arrowheadUp = VectorAssetBuilder(name = "ArrowheadUp", defaultWidth = 24.0.dp,
...
private var _arrowheadUp: VectorAsset? = null
