...
public val OutlineGroup.SkipForward: VectorAsset
    get() {
        if (_skipForward != null) {
            return _skipForward!!
        }
        _skipForward = VectorAssetBuilder(name = "SkipForward", defaultWidth = 24.0.dp,
...
private var _skipForward: VectorAsset? = null
