...
public val OutlineGroup.Options: VectorAsset
    get() {
        if (_options != null) {
            return _options!!
        }
        _options = VectorAssetBuilder(name = "Options", defaultWidth = 24.0.dp, defaultHeight =
...
private var _options: VectorAsset? = null
