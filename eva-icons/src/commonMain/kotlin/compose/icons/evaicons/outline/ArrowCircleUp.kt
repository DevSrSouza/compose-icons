...
public val OutlineGroup.ArrowCircleUp: VectorAsset
    get() {
        if (_arrowCircleUp != null) {
            return _arrowCircleUp!!
        }
        _arrowCircleUp = VectorAssetBuilder(name = "ArrowCircleUp", defaultWidth = 24.0.dp,
...
private var _arrowCircleUp: VectorAsset? = null
