...
public val OutlineGroup.DropletOff: VectorAsset
    get() {
        if (_dropletOff != null) {
            return _dropletOff!!
        }
        _dropletOff = VectorAssetBuilder(name = "DropletOff", defaultWidth = 24.0.dp, defaultHeight
...
private var _dropletOff: VectorAsset? = null
