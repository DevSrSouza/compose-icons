...
public val OutlineGroup.File: VectorAsset
    get() {
        if (_file != null) {
            return _file!!
        }
        _file = VectorAssetBuilder(name = "File", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _file: VectorAsset? = null
