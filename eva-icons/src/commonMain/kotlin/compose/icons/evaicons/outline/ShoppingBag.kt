...
public val OutlineGroup.ShoppingBag: VectorAsset
    get() {
        if (_shoppingBag != null) {
            return _shoppingBag!!
        }
        _shoppingBag = VectorAssetBuilder(name = "ShoppingBag", defaultWidth = 24.0.dp,
...
private var _shoppingBag: VectorAsset? = null
