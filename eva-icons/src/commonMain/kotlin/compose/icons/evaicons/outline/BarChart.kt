...
public val OutlineGroup.BarChart: VectorAsset
    get() {
        if (_barChart != null) {
            return _barChart!!
        }
        _barChart = VectorAssetBuilder(name = "BarChart", defaultWidth = 24.0.dp, defaultHeight =
...
private var _barChart: VectorAsset? = null
