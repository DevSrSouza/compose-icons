...
public val OutlineGroup.ArrowIosBack: VectorAsset
    get() {
        if (_arrowIosBack != null) {
            return _arrowIosBack!!
        }
        _arrowIosBack = VectorAssetBuilder(name = "ArrowIosBack", defaultWidth = 24.0.dp,
...
private var _arrowIosBack: VectorAsset? = null
