...
public val OutlineGroup.Sync: VectorAsset
    get() {
        if (_sync != null) {
            return _sync!!
        }
        _sync = VectorAssetBuilder(name = "Sync", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _sync: VectorAsset? = null
