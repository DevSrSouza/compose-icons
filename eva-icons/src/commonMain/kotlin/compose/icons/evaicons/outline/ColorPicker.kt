...
public val OutlineGroup.ColorPicker: VectorAsset
    get() {
        if (_colorPicker != null) {
            return _colorPicker!!
        }
        _colorPicker = VectorAssetBuilder(name = "ColorPicker", defaultWidth = 24.0.dp,
...
private var _colorPicker: VectorAsset? = null
