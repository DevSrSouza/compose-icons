...
public val OutlineGroup.SmilingFace: VectorAsset
    get() {
        if (_smilingFace != null) {
            return _smilingFace!!
        }
        _smilingFace = VectorAssetBuilder(name = "SmilingFace", defaultWidth = 24.0.dp,
...
private var _smilingFace: VectorAsset? = null
