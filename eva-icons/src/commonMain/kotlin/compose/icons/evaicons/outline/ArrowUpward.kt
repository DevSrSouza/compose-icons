...
public val OutlineGroup.ArrowUpward: VectorAsset
    get() {
        if (_arrowUpward != null) {
            return _arrowUpward!!
        }
        _arrowUpward = VectorAssetBuilder(name = "ArrowUpward", defaultWidth = 24.0.dp,
...
private var _arrowUpward: VectorAsset? = null
