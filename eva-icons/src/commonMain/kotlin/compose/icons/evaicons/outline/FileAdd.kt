...
public val OutlineGroup.FileAdd: VectorAsset
    get() {
        if (_fileAdd != null) {
            return _fileAdd!!
        }
        _fileAdd = VectorAssetBuilder(name = "FileAdd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _fileAdd: VectorAsset? = null
