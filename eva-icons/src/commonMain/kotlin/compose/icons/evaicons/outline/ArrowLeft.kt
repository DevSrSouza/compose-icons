...
public val OutlineGroup.ArrowLeft: VectorAsset
    get() {
        if (_arrowLeft != null) {
            return _arrowLeft!!
        }
        _arrowLeft = VectorAssetBuilder(name = "ArrowLeft", defaultWidth = 24.0.dp, defaultHeight =
...
private var _arrowLeft: VectorAsset? = null
