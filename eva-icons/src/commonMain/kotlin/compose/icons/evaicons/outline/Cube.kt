...
public val OutlineGroup.Cube: VectorAsset
    get() {
        if (_cube != null) {
            return _cube!!
        }
        _cube = VectorAssetBuilder(name = "Cube", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _cube: VectorAsset? = null
