...
public val OutlineGroup.Options2: VectorAsset
    get() {
        if (_options2 != null) {
            return _options2!!
        }
        _options2 = VectorAssetBuilder(name = "Options2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.0f, 5.0f)
                arcTo(1.0f, 1.0f, 0.0f, true, true, 6.0f, 6.0f)
...
private var _options2: VectorAsset? = null
