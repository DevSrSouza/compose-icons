...
public val OutlineGroup.CornerDownLeft: VectorAsset
    get() {
        if (_cornerDownLeft != null) {
            return _cornerDownLeft!!
        }
        _cornerDownLeft = VectorAssetBuilder(name = "CornerDownLeft", defaultWidth = 24.1.dp,
                defaultHeight = 24.1.dp, viewportWidth = 24.1f, viewportHeight = 24.1f).apply {
...
private var _cornerDownLeft: VectorAsset? = null
