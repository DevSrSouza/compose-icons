...
public val OutlineGroup.Expand: VectorAsset
    get() {
        if (_expand != null) {
            return _expand!!
        }
        _expand = VectorAssetBuilder(name = "Expand", defaultWidth = 24.0.dp, defaultHeight =
...
private var _expand: VectorAsset? = null
