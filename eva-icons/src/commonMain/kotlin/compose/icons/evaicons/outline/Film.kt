...
public val OutlineGroup.Film: VectorAsset
    get() {
        if (_film != null) {
            return _film!!
        }
        _film = VectorAssetBuilder(name = "Film", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _film: VectorAsset? = null
