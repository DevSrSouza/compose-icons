...
public val OutlineGroup.Navigation: VectorAsset
    get() {
        if (_navigation != null) {
            return _navigation!!
        }
        _navigation = VectorAssetBuilder(name = "Navigation", defaultWidth = 24.0.dp, defaultHeight
...
private var _navigation: VectorAsset? = null
