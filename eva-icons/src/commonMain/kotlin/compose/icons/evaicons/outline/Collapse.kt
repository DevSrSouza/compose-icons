...
public val OutlineGroup.Collapse: VectorAsset
    get() {
        if (_collapse != null) {
            return _collapse!!
        }
        _collapse = VectorAssetBuilder(name = "Collapse", defaultWidth = 24.0.dp, defaultHeight =
...
private var _collapse: VectorAsset? = null
