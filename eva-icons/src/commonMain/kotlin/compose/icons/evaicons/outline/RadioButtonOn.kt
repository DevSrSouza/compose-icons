...
public val OutlineGroup.RadioButtonOn: VectorAsset
    get() {
        if (_radioButtonOn != null) {
            return _radioButtonOn!!
        }
        _radioButtonOn = VectorAssetBuilder(name = "RadioButtonOn", defaultWidth = 24.0.dp,
...
private var _radioButtonOn: VectorAsset? = null
