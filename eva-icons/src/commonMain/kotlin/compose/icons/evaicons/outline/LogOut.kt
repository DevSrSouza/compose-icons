...
public val OutlineGroup.LogOut: VectorAsset
    get() {
        if (_logOut != null) {
            return _logOut!!
        }
        _logOut = VectorAssetBuilder(name = "LogOut", defaultWidth = 24.0.dp, defaultHeight =
...
private var _logOut: VectorAsset? = null
