...
public val OutlineGroup.RewindRight: VectorAsset
    get() {
        if (_rewindRight != null) {
            return _rewindRight!!
        }
        _rewindRight = VectorAssetBuilder(name = "RewindRight", defaultWidth = 24.0.dp,
...
private var _rewindRight: VectorAsset? = null
