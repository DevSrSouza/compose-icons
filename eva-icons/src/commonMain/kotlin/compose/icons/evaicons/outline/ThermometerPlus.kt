...
public val OutlineGroup.ThermometerPlus: VectorAsset
    get() {
        if (_thermometerPlus != null) {
            return _thermometerPlus!!
        }
        _thermometerPlus = VectorAssetBuilder(name = "ThermometerPlus", defaultWidth = 24.0.dp,
...
private var _thermometerPlus: VectorAsset? = null
