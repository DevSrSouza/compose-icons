...
public val OutlineGroup.Scissors: VectorAsset
    get() {
        if (_scissors != null) {
            return _scissors!!
        }
        _scissors = VectorAssetBuilder(name = "Scissors", defaultWidth = 24.0.dp, defaultHeight =
...
private var _scissors: VectorAsset? = null
