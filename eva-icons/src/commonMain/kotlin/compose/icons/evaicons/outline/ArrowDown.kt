...
public val OutlineGroup.ArrowDown: VectorAsset
    get() {
        if (_arrowDown != null) {
            return _arrowDown!!
        }
        _arrowDown = VectorAssetBuilder(name = "ArrowDown", defaultWidth = 24.0.dp, defaultHeight =
...
private var _arrowDown: VectorAsset? = null
