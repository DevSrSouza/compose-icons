...
public val OutlineGroup.Flip: VectorAsset
    get() {
        if (_flip != null) {
            return _flip!!
        }
        _flip = VectorAssetBuilder(name = "Flip", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _flip: VectorAsset? = null
