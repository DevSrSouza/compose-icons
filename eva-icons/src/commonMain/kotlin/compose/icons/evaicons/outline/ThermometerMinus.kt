...
public val OutlineGroup.ThermometerMinus: VectorAsset
    get() {
        if (_thermometerMinus != null) {
            return _thermometerMinus!!
        }
        _thermometerMinus = VectorAssetBuilder(name = "ThermometerMinus", defaultWidth = 24.0.dp,
...
private var _thermometerMinus: VectorAsset? = null
