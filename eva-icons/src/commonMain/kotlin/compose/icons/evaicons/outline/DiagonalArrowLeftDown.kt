...
public val OutlineGroup.DiagonalArrowLeftDown: VectorAsset
    get() {
        if (_diagonalArrowLeftDown != null) {
            return _diagonalArrowLeftDown!!
        }
        _diagonalArrowLeftDown = VectorAssetBuilder(name = "DiagonalArrowLeftDown", defaultWidth =
...
private var _diagonalArrowLeftDown: VectorAsset? = null
