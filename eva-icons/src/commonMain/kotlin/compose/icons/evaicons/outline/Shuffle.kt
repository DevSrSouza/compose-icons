...
public val OutlineGroup.Shuffle: VectorAsset
    get() {
        if (_shuffle != null) {
            return _shuffle!!
        }
        _shuffle = VectorAssetBuilder(name = "Shuffle", defaultWidth = 24.0.dp, defaultHeight =
...
private var _shuffle: VectorAsset? = null
