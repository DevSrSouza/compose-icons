...
public val OutlineGroup.PieChart: VectorAsset
    get() {
        if (_pieChart != null) {
            return _pieChart!!
        }
        _pieChart = VectorAssetBuilder(name = "PieChart", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pieChart: VectorAsset? = null
