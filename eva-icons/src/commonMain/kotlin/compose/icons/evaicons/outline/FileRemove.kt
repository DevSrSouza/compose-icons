...
public val OutlineGroup.FileRemove: VectorAsset
    get() {
        if (_fileRemove != null) {
            return _fileRemove!!
        }
        _fileRemove = VectorAssetBuilder(name = "FileRemove", defaultWidth = 24.0.dp, defaultHeight
...
private var _fileRemove: VectorAsset? = null
