...
public val OutlineGroup.Checkmark: VectorAsset
    get() {
        if (_checkmark != null) {
            return _checkmark!!
        }
        _checkmark = VectorAssetBuilder(name = "Checkmark", defaultWidth = 24.0.dp, defaultHeight =
...
private var _checkmark: VectorAsset? = null
