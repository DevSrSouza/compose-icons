...
public val OutlineGroup.FlashOff: VectorAsset
    get() {
        if (_flashOff != null) {
            return _flashOff!!
        }
        _flashOff = VectorAssetBuilder(name = "FlashOff", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.54f, 18.06f)
                lineToRelative(0.27f, -2.42f)
                lineTo(10.0f, 12.8f)
...
private var _flashOff: VectorAsset? = null
