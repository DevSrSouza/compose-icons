...
public val OutlineGroup.Speaker: VectorAsset
    get() {
        if (_speaker != null) {
            return _speaker!!
        }
        _speaker = VectorAssetBuilder(name = "Speaker", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 11.0f)
                arcTo(3.0f, 3.0f, 0.0f, true, false, 9.0f, 8.0f)
...
private var _speaker: VectorAsset? = null
