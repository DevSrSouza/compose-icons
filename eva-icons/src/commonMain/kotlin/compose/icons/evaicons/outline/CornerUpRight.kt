...
public val OutlineGroup.CornerUpRight: VectorAsset
    get() {
        if (_cornerUpRight != null) {
            return _cornerUpRight!!
        }
        _cornerUpRight = VectorAssetBuilder(name = "CornerUpRight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(4.0f, -5.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 19.78f, 10.38f)
                close()
            }
        }
        .build()
...
private var _cornerUpRight: VectorAsset? = null
