...
public val OutlineGroup.ArrowIosForward: VectorAsset
    get() {
        if (_arrowIosForward != null) {
            return _arrowIosForward!!
        }
        _arrowIosForward = VectorAssetBuilder(name = "ArrowIosForward", defaultWidth = 24.0.dp,
...
private var _arrowIosForward: VectorAsset? = null
