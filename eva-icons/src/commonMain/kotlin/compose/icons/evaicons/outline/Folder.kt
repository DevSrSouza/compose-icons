...
public val OutlineGroup.Folder: VectorAsset
    get() {
        if (_folder != null) {
            return _folder!!
        }
        _folder = VectorAssetBuilder(name = "Folder", defaultWidth = 24.0.dp, defaultHeight =
...
private var _folder: VectorAsset? = null
