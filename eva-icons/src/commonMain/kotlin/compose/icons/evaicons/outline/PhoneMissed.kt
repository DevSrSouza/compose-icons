...
public val OutlineGroup.PhoneMissed: VectorAsset
    get() {
        if (_phoneMissed != null) {
            return _phoneMissed!!
        }
        _phoneMissed = VectorAssetBuilder(name = "PhoneMissed", defaultWidth = 24.0.dp,
...
private var _phoneMissed: VectorAsset? = null
