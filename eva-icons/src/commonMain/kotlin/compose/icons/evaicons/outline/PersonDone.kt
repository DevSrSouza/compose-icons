...
public val OutlineGroup.PersonDone: VectorAsset
    get() {
        if (_personDone != null) {
            return _personDone!!
        }
        _personDone = VectorAssetBuilder(name = "PersonDone", defaultWidth = 24.0.dp, defaultHeight
...
private var _personDone: VectorAsset? = null
