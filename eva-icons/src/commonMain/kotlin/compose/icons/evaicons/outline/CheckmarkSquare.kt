...
public val OutlineGroup.CheckmarkSquare: VectorAsset
    get() {
        if (_checkmarkSquare != null) {
            return _checkmarkSquare!!
        }
        _checkmarkSquare = VectorAssetBuilder(name = "CheckmarkSquare", defaultWidth = 24.0.dp,
...
private var _checkmarkSquare: VectorAsset? = null
