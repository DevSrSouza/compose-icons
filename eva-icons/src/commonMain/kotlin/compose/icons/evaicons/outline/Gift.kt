...
public val OutlineGroup.Gift: VectorAsset
    get() {
        if (_gift != null) {
            return _gift!!
        }
        _gift = VectorAssetBuilder(name = "Gift", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _gift: VectorAsset? = null
