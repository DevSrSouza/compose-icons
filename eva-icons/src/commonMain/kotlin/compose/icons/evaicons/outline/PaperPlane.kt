...
public val OutlineGroup.PaperPlane: VectorAsset
    get() {
        if (_paperPlane != null) {
            return _paperPlane!!
        }
        _paperPlane = VectorAssetBuilder(name = "PaperPlane", defaultWidth = 24.0.dp, defaultHeight
...
private var _paperPlane: VectorAsset? = null
