...
public val OutlineGroup.FolderAdd: VectorAsset
    get() {
        if (_folderAdd != null) {
            return _folderAdd!!
        }
        _folderAdd = VectorAssetBuilder(name = "FolderAdd", defaultWidth = 24.0.dp, defaultHeight =
...
private var _folderAdd: VectorAsset? = null
