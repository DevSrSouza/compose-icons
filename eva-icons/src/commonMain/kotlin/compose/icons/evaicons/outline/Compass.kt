...
public val OutlineGroup.Compass: VectorAsset
    get() {
        if (_compass != null) {
            return _compass!!
        }
        _compass = VectorAssetBuilder(name = "Compass", defaultWidth = 24.0.dp, defaultHeight =
...
private var _compass: VectorAsset? = null
