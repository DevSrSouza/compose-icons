...
public val OutlineGroup.Trash2: VectorAsset
    get() {
        if (_trash2 != null) {
            return _trash2!!
        }
        _trash2 = VectorAssetBuilder(name = "Trash2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _trash2: VectorAsset? = null
