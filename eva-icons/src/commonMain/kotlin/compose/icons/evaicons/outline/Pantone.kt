...
public val OutlineGroup.Pantone: VectorAsset
    get() {
        if (_pantone != null) {
            return _pantone!!
        }
        _pantone = VectorAssetBuilder(name = "Pantone", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pantone: VectorAsset? = null
