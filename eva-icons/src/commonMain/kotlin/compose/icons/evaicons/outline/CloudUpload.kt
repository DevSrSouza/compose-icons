...
public val OutlineGroup.CloudUpload: VectorAsset
    get() {
        if (_cloudUpload != null) {
            return _cloudUpload!!
        }
        _cloudUpload = VectorAssetBuilder(name = "CloudUpload", defaultWidth = 24.0.dp,
...
private var _cloudUpload: VectorAsset? = null
