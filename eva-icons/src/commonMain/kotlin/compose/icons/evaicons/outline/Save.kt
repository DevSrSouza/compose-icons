...
public val OutlineGroup.Save: VectorAsset
    get() {
        if (_save != null) {
            return _save!!
        }
        _save = VectorAssetBuilder(name = "Save", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _save: VectorAsset? = null
