...
public val OutlineGroup.ArrowIosDownward: VectorAsset
    get() {
        if (_arrowIosDownward != null) {
            return _arrowIosDownward!!
        }
        _arrowIosDownward = VectorAssetBuilder(name = "ArrowIosDownward", defaultWidth = 24.0.dp,
...
private var _arrowIosDownward: VectorAsset? = null
