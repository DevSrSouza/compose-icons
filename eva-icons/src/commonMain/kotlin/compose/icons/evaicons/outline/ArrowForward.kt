...
public val OutlineGroup.ArrowForward: VectorAsset
    get() {
        if (_arrowForward != null) {
            return _arrowForward!!
        }
        _arrowForward = VectorAssetBuilder(name = "ArrowForward", defaultWidth = 24.0.dp,
...
private var _arrowForward: VectorAsset? = null
