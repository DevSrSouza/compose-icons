...
public val OutlineGroup.Code: VectorAsset
    get() {
        if (_code != null) {
            return _code!!
        }
        _code = VectorAssetBuilder(name = "Code", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _code: VectorAsset? = null
