...
public val OutlineGroup.Percent: VectorAsset
    get() {
        if (_percent != null) {
            return _percent!!
        }
        _percent = VectorAssetBuilder(name = "Percent", defaultWidth = 24.0.dp, defaultHeight =
...
private var _percent: VectorAsset? = null
