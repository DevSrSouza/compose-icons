...
public val OutlineGroup.QuestionMark: VectorAsset
    get() {
        if (_questionMark != null) {
            return _questionMark!!
        }
        _questionMark = VectorAssetBuilder(name = "QuestionMark", defaultWidth = 24.0.dp,
...
private var _questionMark: VectorAsset? = null
