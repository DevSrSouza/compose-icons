...
public val OutlineGroup.CloseSquare: VectorAsset
    get() {
        if (_closeSquare != null) {
            return _closeSquare!!
        }
        _closeSquare = VectorAssetBuilder(name = "CloseSquare", defaultWidth = 24.0.dp,
...
private var _closeSquare: VectorAsset? = null
