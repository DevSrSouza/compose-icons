...
public val OutlineGroup.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(Activity, AlertCircle, AlertTriangle, Archive, ArrowheadDown, ArrowheadLeft,
        ...
        ArrowCircleUp, ArrowDownward, ArrowDown, ArrowForward, ArrowIosBack, ArrowIosDownward,
        ArrowIosForward, ArrowIosUpward, ArrowLeft, ArrowRight, ArrowUpward, ArrowUp, Attach2,
        Attach, At, Award, Backspace, BarChart2, BarChart, Battery, Behance, BellOff, Bell,
        Bluetooth, Bookmark, BookOpen, Book, Briefcase, Browser, Brush, Bulb, Calendar, Camera, Car,
        Cast, Charging, CheckmarkCircle2, CheckmarkCircle, Checkmark, CheckmarkSquare2,
        CheckmarkSquare, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Clipboard, Clock,
        CloseCircle, Close, CloseSquare, CloudDownload, CloudUpload, CodeDownload, Code, Collapse,
        ColorPalette, ColorPicker, Compass, Copy, CornerDownLeft, CornerDownRight, CornerLeftDown,
        CornerLeftUp, CornerRightDown, CornerRightUp, CornerUpLeft, CornerUpRight, CreditCard, Crop,
        Cube, DiagonalArrowLeftDown, DiagonalArrowLeftUp, DiagonalArrowRightDown,
        DiagonalArrowRightUp, DoneAll, Download, DropletOff, Droplet, Edit2, Edit, Email, Expand,
        ExternalLink, EyeOff2, EyeOff, Eye, Facebook, FileAdd, File, FileRemove, FileText, Film,
        Flag, FlashOff, Flash, Flip2, Flip, FolderAdd, Folder, FolderRemove, Funnel, Gift, Github,
        Globe2, Globe, Google, Grid, HardDrive, Hash, Headphones, Heart, Home, Image, Inbox, Info,
        Keypad, Layers, Layout, Linkedin, Link2, Link, List, Loader, Lock, LogIn, LogOut, Map,
        Maximize, Menu2, MenuArrow, Menu, MessageCircle, MessageSquare, MicOff, Mic, Minimize,
        MinusCircle, Minus, MinusSquare, Monitor, Moon, MoreHorizontal, MoreVertical, Move, Music,
        Navigation2, Navigation, Npm, Options2, Options, Pantone, PaperPlane, PauseCircle, People,
        Percent, PersonAdd, PersonDelete, PersonDone, Person, PersonRemove, PhoneCall, PhoneMissed,
        PhoneOff, Phone, PieChart, Pin, PlayCircle, PlusCircle, Plus, PlusSquare, Power, Pricetags,
        Printer, QuestionMarkCircle, QuestionMark, RadioButtonOff, RadioButtonOn, Radio, Recording,
        Refresh, Repeat, RewindLeft, RewindRight, Save, Scissors, Search, Settings2, Settings,
        Shake, Share, ShieldOff, Shield, ShoppingBag, ShoppingCart, Shuffle2, Shuffle, SkipBack,
        SkipForward, Slash, Smartphone, SmilingFace, Speaker, Square, Star, StopCircle, Sun, Swap,
        Sync, Text, ThermometerMinus, Thermometer, ThermometerPlus, ToggleLeft, ToggleRight, Trash2,
        Trash, TrendingDown, TrendingUp, Tv, Twitter, Umbrella, Undo, Unlock, Upload, VideoOff,
        Video, VolumeDown, VolumeMute, VolumeOff, VolumeUp, WifiOff, Wifi)
    return __AllIcons!!
  }
