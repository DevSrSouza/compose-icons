...
public val FillGroup.ArrowCircleDown: VectorAsset
    get() {
        if (_arrowCircleDown != null) {
            return _arrowCircleDown!!
        }
        _arrowCircleDown = VectorAssetBuilder(name = "ArrowCircleDown", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.69f, 13.86f)
                lineTo(12.69f, 16.72f)
...
private var _arrowCircleDown: VectorAsset? = null
