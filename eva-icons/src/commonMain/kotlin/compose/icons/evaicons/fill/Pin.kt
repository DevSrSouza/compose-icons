...
public val FillGroup.Pin: VectorAsset
    get() {
        if (_pin != null) {
            return _pin!!
        }
        _pin = VectorAssetBuilder(name = "Pin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF231f20)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(3.5f, 3.5f, 0.0f, false, true, 12.0f, 13.0f)
                close()
            }
        }
        .build()
...
private var _pin: VectorAsset? = null
