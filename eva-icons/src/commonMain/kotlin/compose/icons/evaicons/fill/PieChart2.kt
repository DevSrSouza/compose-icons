...
public val FillGroup.PieChart2: VectorAsset
    get() {
        if (_pieChart2 != null) {
            return _pieChart2!!
        }
        _pieChart2 = VectorAssetBuilder(name = "PieChart2", defaultWidth = 24.0.dp, defaultHeight =
...
private var _pieChart2: VectorAsset? = null
