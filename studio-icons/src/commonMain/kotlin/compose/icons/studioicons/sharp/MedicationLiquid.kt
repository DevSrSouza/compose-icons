...
public val SharpGroup.MedicationLiquid: ImageVector
    get() {
        ...
        _medicationLiquid = Builder(name = "MedicationLiquid", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.0f, 12.0f)
                curveToRelative(-0.41f, 0.0f, -1.0f, -0.78f, -1.0f, -2.0f)
                reflectiveCurveToRelative(0.59f, -2.0f, 1.0f, -2.0f)
                reflectiveCurveToRelative(1.0f, 0.78f, 1.0f, 2.0f)
                reflectiveCurveTo(20.41f, 12.0f, 20.0f, 12.0f)
                close()
            }
        }
        .build()
