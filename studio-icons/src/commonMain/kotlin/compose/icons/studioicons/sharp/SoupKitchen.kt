...
public val SharpGroup.SoupKitchen: ImageVector
    get() {
        if (_soupKitchen != null) {
            return _soupKitchen!!
        }
        _soupKitchen = Builder(name = "SoupKitchen", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.02f, 3.87f, 3.09f, 7.0f, 6.82f, 7.0f)
