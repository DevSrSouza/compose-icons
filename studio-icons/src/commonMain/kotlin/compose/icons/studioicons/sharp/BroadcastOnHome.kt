...
public val SharpGroup.BroadcastOnHome: ImageVector
    get() {
        if (_broadcastOnHome != null) {
            return _broadcastOnHome!!
        }
        _broadcastOnHome = Builder(name = "BroadcastOnHome", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.73f, 8.88f, 21.4f, 9.28f, 22.0f, 9.76f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
