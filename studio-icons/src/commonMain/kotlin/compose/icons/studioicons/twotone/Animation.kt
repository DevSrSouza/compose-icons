...
public val TwotoneGroup.Animation: ImageVector
    get() {
        if (_animation != null) {
            return _animation!!
        }
        _animation = Builder(name = "Animation", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveToRelative(1.12f, 0.0f, 2.16f, -0.37f, 3.0f, -1.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.0f, 4.0f)
                curveToRelative(-1.13f, 0.0f, -2.16f, 0.37f, -3.0f, 1.0f)
                curveToRelative(3.87f, 0.01f, 7.0f, 3.14f, 7.0f, 7.0f)
                curveToRelative(0.63f, -0.84f, 1.0f, -1.88f, 1.0f, -3.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.0f, 7.0f)
                curveToRelative(-0.6f, 0.0f, -1.17f, 0.11f, -1.7f, 0.3f)
                curveTo(10.11f, 7.83f, 10.0f, 8.4f, 10.0f, 9.0f)
                curveToRelative(0.0f, 2.76f, 2.24f, 5.0f, 5.0f, 5.0f)
                curveToRelative(0.6f, 0.0f, 1.17f, -0.11f, 1.7f, -0.3f)
                curveToRelative(0.19f, -0.53f, 0.3f, -1.1f, 0.3f, -1.7f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveToRelative(0.0f, 2.76f, 2.24f, 5.0f, 5.0f, 5.0f)
                curveToRelative(1.12f, 0.0f, 2.16f, -0.37f, 3.0f, -1.0f)
                curveTo(11.13f, 15.99f, 8.0f, 12.86f, 8.0f, 9.0f)
                close()
            }
