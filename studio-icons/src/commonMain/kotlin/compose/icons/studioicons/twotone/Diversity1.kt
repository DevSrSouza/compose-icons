...
public val TwotoneGroup.Diversity1: ImageVector
    get() {
        if (_diversity1 != null) {
            return _diversity1!!
        }
        _diversity1 = Builder(name = "Diversity1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                moveTo(17.4f, 4.0f)
                curveToRelative(-2.68f, 0.0f, -3.82f, 1.74f, -5.4f, 3.59f)
                curveTo(10.44f, 5.75f, 9.3f, 4.0f, 6.6f, 4.0f)
                curveTo(4.02f, 4.0f, 2.0f, 6.02f, 2.0f, 8.6f)
                curveToRelative(0.0f, 0.76f, 0.17f, 1.5f, 0.48f, 2.26f)
                curveTo(2.94f, 10.64f, 3.45f, 10.5f, 4.0f, 10.5f)
                curveToRelative(1.93f, 0.0f, 3.5f, 1.57f, 3.5f, 3.5f)
                curveToRelative(0.0f, 0.45f, -0.09f, 0.87f, -0.24f, 1.26f)
                curveToRelative(0.97f, -0.42f, 1.96f, -0.69f, 2.98f, -0.84f)
                curveTo(9.49f, 13.87f, 9.0f, 13.0f, 9.0f, 12.0f)
                curveToRelative(0.0f, -1.66f, 1.34f, -3.0f, 3.0f, -3.0f)
                curveToRelative(1.66f, 0.0f, 3.0f, 1.34f, 3.0f, 3.0f)
                curveToRelative(0.0f, 1.0f, -0.49f, 1.87f, -1.24f, 2.42f)
                curveToRelative(1.02f, 0.15f, 2.02f, 0.43f, 2.98f, 0.85f)
                curveToRelative(-0.15f, -0.39f, -0.24f, -0.82f, -0.24f, -1.26f)
                curveToRelative(0.0f, -1.93f, 1.57f, -3.5f, 3.5f, -3.5f)
                curveToRelative(0.55f, 0.0f, 1.06f, 0.14f, 1.52f, 0.36f)
                curveTo(21.83f, 10.1f, 22.0f, 9.36f, 22.0f, 8.6f)
                curveTo(22.0f, 6.02f, 19.98f, 4.0f, 17.4f, 4.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveToRelative(-1.1f, -0.49f, -2.26f, -0.73f, -3.43f, -0.73f)
                curveToRelative(-1.18f, 0.0f, -2.33f, 0.25f, -3.43f, 0.73f)
                curveTo(8.34f, 18.6f, 8.17f, 18.79f, 8.07f, 19.02f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
