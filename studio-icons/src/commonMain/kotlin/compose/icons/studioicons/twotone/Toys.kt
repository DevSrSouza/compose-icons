...
public val TwotoneGroup.Toys: ImageVector
    get() {
        if (_toys != null) {
            return _toys!!
        }
        _toys = Builder(name = "Toys", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveToRelative(0.0f, 0.51f, 0.2f, 0.97f, 0.51f, 1.32f)
                curveTo(5.05f, 14.53f, 5.97f, 14.0f, 7.0f, 14.0f)
                ...
                curveTo(19.8f, 14.97f, 20.0f, 14.51f, 20.0f, 14.0f)
                curveTo(20.0f, 12.9f, 19.1f, 12.0f, 18.0f, 12.0f)
                close()
            }
