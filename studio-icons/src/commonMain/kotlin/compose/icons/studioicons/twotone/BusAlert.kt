...
public val TwotoneGroup.BusAlert: ImageVector
    get() {
        if (_busAlert != null) {
            return _busAlert!!
        }
        _busAlert = Builder(name = "BusAlert", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                reflectiveCurveTo(14.33f, 17.0f, 13.5f, 17.0f)
                reflectiveCurveTo(12.0f, 16.33f, 12.0f, 15.5f)
                reflectiveCurveTo(12.67f, 14.0f, 13.5f, 14.0f)
                close()
                moveTo(6.5f, 14.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveToRelative(0.0f, -0.33f, 0.03f, -0.66f, 0.08f, -0.98f)
                curveTo(7.4f, 4.91f, 5.25f, 5.29f, 4.43f, 6.0f)
                close()
            }
