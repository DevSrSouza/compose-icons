...
public val TwotoneGroup.AutoStories: ImageVector
    get() {
        ...
        _autoStories = Builder(name = "AutoStories", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(4.14f, 16.21f, 5.31f, 16.0f, 6.5f, 16.0f)
                curveToRelative(1.19f, 0.0f, 2.36f, 0.21f, 3.5f, 0.62f)
                verticalLineTo(6.72f)
                curveTo(8.89f, 6.25f, 7.7f, 6.0f, 6.5f, 6.0f)
                curveTo(5.28f, 6.0f, 4.11f, 6.24f, 3.0f, 6.71f)
                close()
            }
