...
public val TwotoneGroup.CrueltyFree: ImageVector
    get() {
        if (_crueltyFree != null) {
            return _crueltyFree!!
        }
        _crueltyFree = Builder(name = "CrueltyFree", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(13.94f, 13.45f, 13.61f, 13.0f, 12.0f, 13.0f)
                ...
                curveTo(7.0f, 18.88f, 8.12f, 20.0f, 9.5f, 20.0f)
                curveToRelative(1.0f, 0.0f, 1.8f, -0.33f, 2.22f, -0.56f)
                curveTo(11.3f, 19.26f, 11.0f, 18.73f, 11.0f, 18.5f)
                ...
                curveTo(12.7f, 19.67f, 13.5f, 20.0f, 14.5f, 20.0f)
                curveToRelative(1.38f, 0.0f, 2.5f, -1.12f, 2.5f, -2.5f)
                curveTo(17.0f, 16.8f, 16.57f, 16.26f, 16.0f, 15.77f)
                close()
                moveTo(10.5f, 16.75f)
