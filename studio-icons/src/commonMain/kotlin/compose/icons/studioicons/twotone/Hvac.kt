...
public val TwotoneGroup.Hvac: ImageVector
    get() {
        if (_hvac != null) {
            return _hvac!!
        }
        _hvac = Builder(name = "Hvac", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.91f, 15.61f, 13.01f, 16.0f, 12.0f, 16.0f)
                close()
                moveTo(12.0f, 8.0f)
                curveToRelative(1.01f, 0.0f, 1.91f, 0.39f, 2.62f, 1.0f)
                horizontalLineTo(9.38f)
                curveTo(10.09f, 8.39f, 10.99f, 8.0f, 12.0f, 8.0f)
                close()
                moveTo(8.56f, 10.0f)
                horizontalLineToRelative(6.89f)
                curveToRelative(0.26f, 0.45f, 0.44f, 0.96f, 0.51f, 1.5f)
                horizontalLineToRelative(-7.9f)
                curveTo(8.12f, 10.96f, 8.29f, 10.45f, 8.56f, 10.0f)
                close()
                moveTo(15.95f, 12.5f)
