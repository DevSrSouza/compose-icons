...
public val TwotoneGroup.ExtensionOff: ImageVector
    get() {
        ...
        _extensionOff = Builder(name = "ExtensionOff", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                reflectiveCurveTo(20.28f, 13.0f, 20.0f, 13.0f)
                ...
                curveToRelative(0.8f, -2.17f, 2.87f, -3.0f, 4.37f, -3.0f)
                curveToRelative(0.69f, 0.0f, 1.5f, 0.18f, 2.25f, 0.58f)
                lineToRelative(-6.33f, -6.33f)
                curveTo(7.82f, 11.0f, 8.0f, 11.81f, 8.0f, 12.5f)
                close()
            }
