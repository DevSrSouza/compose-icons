...
public val TwotoneGroup.DonutSmall: ImageVector
    get() {
        if (_donutSmall != null) {
            return _donutSmall!!
        }
        _donutSmall = Builder(name = "DonutSmall", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(18.6f, 7.0f, 17.0f, 5.4f, 15.0f, 4.58f)
                ...
                curveToRelative(-1.23f, -0.93f, -2.0f, -2.4f, -2.0f, -3.99f)
                curveTo(7.0f, 10.4f, 7.77f, 8.93f, 9.0f, 8.0f)
                lineTo(9.0f, 4.58f)
                curveTo(6.04f, 5.76f, 4.0f, 8.65f, 4.0f, 12.0f)
                close()
                moveTo(15.0f, 15.99f)
                verticalLineToRelative(3.43f)
                curveToRelative(2.0f, -0.82f, 3.6f, -2.42f, 4.42f, -4.42f)
                horizontalLineToRelative(-3.43f)
