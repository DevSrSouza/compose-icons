...
public val TwotoneGroup.Timer10: ImageVector
    get() {
        if (_timer10 != null) {
            return _timer10!!
        }
        _timer10 = Builder(name = "Timer10", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.94f, 0.09f, 1.74f, 0.28f, 2.39f)
                ...
                curveToRelative(0.59f, 0.0f, 1.12f, -0.09f, 1.59f, -0.28f)
                ...
                reflectiveCurveToRelative(-0.75f, -0.7f, -1.23f, -0.88f)
                close()
                moveTo(12.9f, 13.22f)
                horizontalLineToRelative(-0.01f)
                curveToRelative(0.0f, 0.6f, -0.04f, 1.11f, -0.12f, 1.53f)
                curveToRelative(-0.08f, 0.42f, -0.2f, 0.76f, -0.36f, 1.02f)
                curveToRelative(-0.16f, 0.26f, -0.36f, 0.45f, -0.59f, 0.57f)
                reflectiveCurveToRelative(-0.51f, 0.18f, -0.82f, 0.18f)
                curveToRelative(-0.3f, 0.0f, -0.58f, -0.06f, -0.82f, -0.18f)
                ...
                curveToRelative(0.0f, -0.6f, 0.04f, -1.11f, 0.13f, -1.52f)
                curveToRelative(0.09f, -0.41f, 0.21f, -0.74f, 0.38f, -1.0f)
                curveToRelative(0.16f, -0.25f, 0.36f, -0.43f, 0.6f, -0.55f)
                curveToRelative(0.24f, -0.11f, 0.51f, -0.17f, 0.81f, -0.17f)
                curveToRelative(0.31f, 0.0f, 0.58f, 0.06f, 0.81f, 0.17f)
                ...
                curveToRelative(-0.14f, -0.09f, -0.23f, -0.19f, -0.28f, -0.3f)
                curveToRelative(-0.05f, -0.11f, -0.08f, -0.24f, -0.08f, -0.39f)
                curveToRelative(0.0f, -0.14f, 0.03f, -0.28f, 0.09f, -0.41f)
                curveToRelative(0.06f, -0.13f, 0.15f, -0.25f, 0.27f, -0.34f)
                ...
                curveToRelative(0.19f, 0.07f, 0.35f, 0.17f, 0.48f, 0.29f)
                curveToRelative(0.13f, 0.12f, 0.22f, 0.26f, 0.29f, 0.42f)
                ...
                curveToRelative(-0.16f, -0.34f, -0.39f, -0.63f, -0.69f, -0.88f)
                reflectiveCurveToRelative(-0.66f, -0.44f, -1.09f, -0.59f)
                curveToRelative(-0.43f, -0.15f, -0.92f, -0.22f, -1.46f, -0.22f)
                curveToRelative(-0.51f, 0.0f, -0.98f, 0.07f, -1.39f, 0.21f)
                curveToRelative(-0.41f, 0.14f, -0.77f, 0.33f, -1.06f, 0.57f)
                reflectiveCurveToRelative(-0.51f, 0.52f, -0.67f, 0.84f)
                ...
                reflectiveCurveToRelative(0.07f, 0.25f, 0.07f, 0.39f)
                curveToRelative(0.0f, 0.32f, -0.13f, 0.57f, -0.4f, 0.77f)
                curveToRelative(-0.27f, 0.2f, -0.66f, 0.29f, -1.17f, 0.29f)
                ...
                curveToRelative(0.16f, 0.34f, 0.39f, 0.65f, 0.7f, 0.93f)
                ...
                reflectiveCurveToRelative(0.8f, -0.31f, 1.11f, -0.54f)
