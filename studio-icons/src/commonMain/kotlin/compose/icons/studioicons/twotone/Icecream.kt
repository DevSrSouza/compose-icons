...
public val TwotoneGroup.Icecream: ImageVector
    get() {
        if (_icecream != null) {
            return _icecream!!
        }
        _icecream = Builder(name = "Icecream", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(13.88f, 13.79f, 12.95f, 14.0f, 12.0f, 14.0f)
                curveTo(11.06f, 14.0f, 10.15f, 13.79f, 9.32f, 13.42f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(16.29f, 4.8f, 14.34f, 3.0f, 12.0f, 3.0f)
                reflectiveCurveTo(7.71f, 4.8f, 7.51f, 7.12f)
                lineTo(7.45f, 7.9f)
                lineTo(6.68f, 8.03f)
                curveTo(5.72f, 8.18f, 5.0f, 9.02f, 5.0f, 10.0f)
                curveToRelative(0.0f, 1.11f, 0.9f, 2.0f, 2.0f, 2.0f)
                curveToRelative(0.52f, 0.0f, 1.01f, -0.21f, 1.39f, -0.56f)
                lineToRelative(0.56f, -0.54f)
                lineToRelative(0.66f, 0.41f)
                curveTo(10.32f, 11.76f, 11.14f, 12.0f, 12.0f, 12.0f)
                reflectiveCurveToRelative(1.68f, -0.24f, 2.39f, -0.68f)
                lineToRelative(0.66f, -0.42f)
                lineToRelative(0.56f, 0.54f)
                curveTo(15.99f, 11.8f, 16.48f, 12.0f, 17.0f, 12.0f)
                curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f)
                curveTo(19.0f, 9.01f, 18.28f, 8.18f, 17.31f, 8.02f)
                close()
            }
