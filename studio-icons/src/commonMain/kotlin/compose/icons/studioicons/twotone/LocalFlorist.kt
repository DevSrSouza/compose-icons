...
public val TwotoneGroup.LocalFlorist: ImageVector
    get() {
        ...
        _localFlorist = Builder(name = "LocalFlorist", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveToRelative(-0.24f, 0.0f, -0.46f, 0.07f, -0.65f, 0.2f)
                lineToRelative(-0.81f, 0.55f)
                curveToRelative(0.55f, 0.46f, 0.94f, 1.1f, 1.06f, 1.84f)
                close()
                moveTo(12.0f, 5.0f)
                curveToRelative(0.36f, 0.0f, 0.71f, 0.07f, 1.03f, 0.19f)
                lineToRelative(0.11f, -1.09f)
                curveTo(13.12f, 3.49f, 12.62f, 3.0f, 12.0f, 3.0f)
                reflectiveCurveToRelative(-1.12f, 0.49f, -1.14f, 1.1f)
                lineToRelative(0.12f, 1.09f)
                curveTo(11.3f, 5.07f, 11.64f, 5.0f, 12.0f, 5.0f)
                close()
                moveTo(8.66f, 11.07f)
                curveToRelative(0.24f, 0.0f, 0.46f, -0.07f, 0.65f, -0.2f)
                lineToRelative(0.81f, -0.55f)
