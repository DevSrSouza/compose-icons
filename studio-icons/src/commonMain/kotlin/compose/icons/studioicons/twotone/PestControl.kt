...
public val TwotoneGroup.PestControl: ImageVector
    get() {
        ...
        _pestControl = Builder(name = "PestControl", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                reflectiveCurveTo(14.21f, 9.0f, 12.0f, 9.0f)
                close()
                moveTo(13.0f, 17.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(13.88f, 7.36f)
                curveTo(13.62f, 6.57f, 12.88f, 6.0f, 12.0f, 6.0f)
                reflectiveCurveToRelative(-1.62f, 0.57f, -1.88f, 1.36f)
                curveTo(10.71f, 7.13f, 11.34f, 7.0f, 12.0f, 7.0f)
                reflectiveCurveTo(13.29f, 7.13f, 13.88f, 7.36f)
                close()
            }
