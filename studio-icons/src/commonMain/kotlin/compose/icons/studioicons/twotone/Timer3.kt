...
public val TwotoneGroup.Timer3: ImageVector
    get() {
        if (_timer3 != null) {
            return _timer3!!
        }
        _timer3 = Builder(name = "Timer3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.15f, 0.28f, 0.37f, 0.52f, 0.64f, 0.73f)
                ...
                reflectiveCurveToRelative(-0.17f, -0.41f, -0.18f, -0.67f)
                ...
                reflectiveCurveToRelative(-0.41f, -0.16f, -0.55f, -0.25f)
                ...
                curveToRelative(-0.17f, -0.16f, -0.3f, -0.34f, -0.39f, -0.56f)
                ...
                curveToRelative(0.49f, -0.15f, 0.91f, -0.38f, 1.26f, -0.68f)
                ...
                curveToRelative(0.22f, -0.08f, 0.46f, -0.12f, 0.73f, -0.12f)
                ...
                curveToRelative(-0.17f, 0.16f, -0.38f, 0.28f, -0.63f, 0.37f)
                curveToRelative(-0.25f, 0.09f, -0.55f, 0.13f, -0.89f, 0.13f)
                lineTo(6.72f, 11.09f)
