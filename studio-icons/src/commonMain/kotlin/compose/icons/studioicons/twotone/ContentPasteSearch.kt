...
public val TwotoneGroup.ContentPasteSearch: ImageVector
    get() {
        ...
        _contentPasteSearch = Builder(name = "ContentPasteSearch", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(10.18f, 18.23f, 10.0f, 17.39f, 10.0f, 16.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.75f, 0.31f, 1.42f, 0.76f, 2.0f, 1.32f)
                verticalLineTo(5.0f)
                ...
                curveTo(11.27f, 20.42f, 10.81f, 19.75f, 10.5f, 19.0f)
                close()
                moveTo(12.0f, 3.0f)
