...
public val TwotoneGroup.Groups2: ImageVector
    get() {
        if (_groups2 != null) {
            return _groups2!!
        }
        _groups2 = Builder(name = "Groups2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(15.43f, 15.48f)
                ...
                curveTo(15.83f, 15.77f, 15.66f, 15.58f, 15.43f, 15.48f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.94f, 8.79f)
                curveTo(12.86f, 8.33f, 12.47f, 8.0f, 12.0f, 8.0f)
                reflectiveCurveToRelative(-0.86f, 0.33f, -0.94f, 0.79f)
                lineTo(10.86f, 10.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.06f, 8.79f)
                curveTo(11.14f, 8.33f, 11.53f, 8.0f, 12.0f, 8.0f)
                reflectiveCurveToRelative(0.86f, 0.33f, 0.94f, 0.79f)
                lineToRelative(0.2f, 1.21f)
                horizontalLineToRelative(-2.28f)
                lineTo(11.06f, 8.79f)
                close()
            }
