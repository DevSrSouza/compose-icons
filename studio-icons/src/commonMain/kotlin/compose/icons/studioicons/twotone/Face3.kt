...
public val TwotoneGroup.Face3: ImageVector
    get() {
        if (_face3 != null) {
            return _face3!!
        }
        _face3 = Builder(name = "Face3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                moveTo(16.5f, 8.0f)
                curveToRelative(0.73f, 0.0f, 1.41f, -0.25f, 1.99f, -0.65f)
                curveTo(17.22f, 5.58f, 15.26f, 4.35f, 13.0f, 4.07f)
                verticalLineTo(4.5f)
                curveTo(13.0f, 6.43f, 14.57f, 8.0f, 16.5f, 8.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(8.74f, 4.35f, 6.78f, 5.58f, 5.51f, 7.35f)
                curveTo(6.09f, 7.75f, 6.77f, 8.0f, 7.5f, 8.0f)
                curveTo(9.43f, 8.0f, 11.0f, 6.43f, 11.0f, 4.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(7.82f, 22.0f, 4.25f, 19.44f, 2.75f, 15.8f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                    = 0.3f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(19.75f, 19.44f, 16.18f, 22.0f, 12.0f, 22.0f)
                close()
            }
