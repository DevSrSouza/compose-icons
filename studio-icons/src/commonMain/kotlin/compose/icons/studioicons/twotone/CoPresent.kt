...
public val TwotoneGroup.CoPresent: ImageVector
    get() {
        if (_coPresent != null) {
            return _coPresent!!
        }
        _coPresent = Builder(name = "CoPresent", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.3f, strokeAlpha
                ...
                curveTo(13.29f, 17.73f, 11.37f, 17.0f, 9.0f, 17.0f)
                curveToRelative(-2.37f, 0.0f, -4.29f, 0.73f, -5.48f, 1.34f)
                curveTo(2.9f, 18.66f, 3.0f, 19.28f, 3.0f, 20.0f)
                horizontalLineToRelative(12.0f)
                curveTo(15.0f, 19.29f, 15.11f, 18.66f, 14.48f, 18.34f)
                close()
            }
