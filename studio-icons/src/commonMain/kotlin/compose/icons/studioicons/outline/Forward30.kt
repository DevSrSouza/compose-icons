...
public val OutlineGroup.Forward30: ImageVector
    get() {
        if (_forward30 != null) {
            return _forward30!!
        }
        _forward30 = Builder(name = "Forward30", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.09f, 0.0f, -0.17f, -0.01f, -0.25f, -0.04f)
                ...
                curveToRelative(0.0f, 0.21f, 0.04f, 0.39f, 0.12f, 0.55f)
                ...
                curveToRelative(0.21f, 0.0f, 0.41f, -0.03f, 0.6f, -0.08f)
                ...
                curveToRelative(0.0f, -0.23f, -0.06f, -0.44f, -0.18f, -0.61f)
                ...
                curveToRelative(0.0f, -0.2f, -0.04f, -0.37f, -0.11f, -0.53f)
                ...
                curveToRelative(-0.19f, 0.0f, -0.38f, 0.03f, -0.54f, 0.08f)
                ...
                horizontalLineToRelative(0.85f)
                curveToRelative(0.0f, -0.07f, 0.02f, -0.14f, 0.05f, -0.2f)
                ...
                curveToRelative(0.1f, 0.0f, 0.18f, 0.01f, 0.25f, 0.04f)
                ...
                curveToRelative(0.0f, 0.18f, -0.05f, 0.32f, -0.16f, 0.43f)
                ...
                curveToRelative(0.11f, 0.0f, 0.2f, 0.01f, 0.29f, 0.04f)
                ...
                curveToRelative(0.0f, 0.09f, -0.01f, 0.17f, -0.04f, 0.24f)
