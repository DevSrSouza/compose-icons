...
public val OutlineGroup.FireHydrantAlt: ImageVector
    get() {
        ...
        _fireHydrantAlt = Builder(name = "FireHydrantAlt", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(13.93f, 10.5f, 12.0f, 10.5f)
                close()
                moveTo(12.0f, 15.5f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 4.0f)
                curveToRelative(1.47f, 0.0f, 2.75f, 0.81f, 3.44f, 2.0f)
                horizontalLineTo(8.56f)
                curveTo(9.25f, 4.81f, 10.53f, 4.0f, 12.0f, 4.0f)
                close()
                moveTo(19.0f, 15.0f)
