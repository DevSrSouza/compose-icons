...
public val OutlineGroup.Masks: ImageVector
    get() {
        if (_masks != null) {
            return _masks!!
        }
        _masks = Builder(name = "Masks", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.12f, -0.23f, 1.95f, -0.69f, 2.66f, -1.08f)
                curveTo(10.48f, 8.33f, 11.07f, 8.0f, 12.0f, 8.0f)
                curveToRelative(0.93f, 0.0f, 1.52f, 0.33f, 2.34f, 0.78f)
                curveToRelative(0.71f, 0.39f, 1.54f, 0.84f, 2.66f, 1.08f)
                verticalLineToRelative(1.65f)
                curveToRelative(0.0f, 2.76f, -2.24f, 5.0f, -5.0f, 5.0f)
                reflectiveCurveTo(7.0f, 14.26f, 7.0f, 11.5f)
                close()
                moveTo(20.5f, 9.0f)
