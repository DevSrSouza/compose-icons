...
public val OutlineGroup.DoNotDisturb: ImageVector
    get() {
        if (_doNotDisturb != null) {
            return _doNotDisturb!!
        }
        _doNotDisturb = Builder(name = "DoNotDisturb", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(4.42f, 0.0f, 8.0f, 3.58f, 8.0f, 8.0f)
                curveTo(20.0f, 13.85f, 19.37f, 15.55f, 18.31f, 16.9f)
                close()
            }
        }
        .build()
