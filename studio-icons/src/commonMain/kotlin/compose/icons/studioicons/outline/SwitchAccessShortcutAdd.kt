...
public val OutlineGroup.SwitchAccessShortcutAdd: ImageVector
    get() {
        if (_switchAccessShortcutAdd != null) {
            return _switchAccessShortcutAdd!!
        }
        _switchAccessShortcutAdd = Builder(name = "SwitchAccessShortcutAdd", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 12.0f)
                curveToRelative(0.0f, -3.09f, 1.38f, -5.94f, 3.44f, -8.0f)
                lineTo(12.0f, 4.0f)
                verticalLineTo(2.0f)
                ...
                curveToRelative(-1.8f, 1.74f, -3.0f, 4.2f, -3.0f, 6.72f)
