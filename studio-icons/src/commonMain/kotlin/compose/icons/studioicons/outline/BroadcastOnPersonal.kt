...
public val OutlineGroup.BroadcastOnPersonal: ImageVector
    get() {
        ...
        _broadcastOnPersonal = Builder(name = "BroadcastOnPersonal", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(4.08f, 3.06f)
                curveToRelative(0.81f, -0.32f, 1.69f, -0.51f, 2.61f, -0.54f)
                lineTo(10.0f, 3.0f)
                lineTo(2.0f, 9.0f)
                verticalLineToRelative(12.0f)
                horizontalLineToRelative(8.76f)
                curveToRelative(-0.48f, -0.6f, -0.88f, -1.27f, -1.17f, -2.0f)
