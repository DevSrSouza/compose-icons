...
public val BaselineGroup.SentimentVerySatisfied: ImageVector
    get() {
        ...
        _sentimentVerySatisfied = Builder(name = "SentimentVerySatisfied", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.0f, 14.0f)
                curveToRelative(0.78f, 2.34f, 2.72f, 4.0f, 5.0f, 4.0f)
                reflectiveCurveToRelative(4.22f, -1.66f, 5.0f, -4.0f)
                lineTo(7.0f, 14.0f)
                close()
            }
        }
