...
public val BaselineGroup.ExposurePlus2: ImageVector
    get() {
        if (_exposurePlus2 != null) {
            return _exposurePlus2!!
        }
        _exposurePlus2 = Builder(name = "ExposurePlus2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.18f, -0.44f, -0.44f, -0.81f, -0.78f, -1.11f)
                ...
                curveToRelative(0.23f, 0.1f, 0.43f, 0.25f, 0.59f, 0.43f)
