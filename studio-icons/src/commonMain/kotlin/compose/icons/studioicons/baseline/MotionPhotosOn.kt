...
public val BaselineGroup.MotionPhotosOn: ImageVector
    get() {
        if (_motionPhotosOn != null) {
            return _motionPhotosOn!!
        }
        _motionPhotosOn = Builder(name = "MotionPhotosOn", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(6.0f, 15.31f, 6.0f, 12.0f)
                close()
                moveTo(7.0f, 5.5f)
...
private var _motionPhotosOn: ImageVector? = null
