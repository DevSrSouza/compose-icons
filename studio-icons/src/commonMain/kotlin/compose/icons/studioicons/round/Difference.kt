...
public val RoundGroup.Difference: ImageVector
    get() {
        if (_difference != null) {
            return _difference!!
        }
        _difference = Builder(name = "Difference", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.59f, 1.59f)
                curveTo(15.21f, 1.21f, 14.7f, 1.0f, 14.17f, 1.0f)
                ...
                curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f)
                verticalLineToRelative(0.0f)
                curveTo(16.5f, 14.55f, 16.05f, 15.0f, 15.5f, 15.0f)
                close()
                moveTo(15.5f, 9.0f)
                ...
                curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f)
                verticalLineToRelative(0.0f)
                curveTo(16.5f, 8.55f, 16.05f, 9.0f, 15.5f, 9.0f)
                close()
            }
        }
        .build()
