...
public val RoundGroup._6kPlus: ImageVector
    get() {
        if (__6kPlus != null) {
            return __6kPlus!!
        }
        __6kPlus = Builder(name = "_6kPlus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0f, 10.16f, 9.66f, 10.5f, 9.25f, 10.5f)
                close()
                moveTo(14.59f, 15.0f)
                lineTo(14.59f, 15.0f)
