...
public val RoundGroup.ReduceCapacity: ImageVector
    get() {
        if (_reduceCapacity != null) {
            return _reduceCapacity!!
        }
        _reduceCapacity = Builder(name = "ReduceCapacity", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(1.79f, -1.79f)
                curveTo(14.46f, 13.54f, 14.24f, 13.0f, 13.79f, 13.0f)
                close()
            }
        }
        .build()
