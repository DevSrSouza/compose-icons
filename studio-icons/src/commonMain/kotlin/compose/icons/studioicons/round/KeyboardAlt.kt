...
public val RoundGroup.KeyboardAlt: ImageVector
    get() {
        ...
        _keyboardAlt = Builder(name = "KeyboardAlt", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.22f, 17.0f, 8.0f, 16.78f, 8.0f, 16.5f)
                lineToRelative(0.0f, 0.0f)
                curveTo(8.0f, 16.22f, 8.22f, 16.0f, 8.5f, 16.0f)
                horizontalLineToRelative(7.0f)
                curveTo(15.78f, 16.0f, 16.0f, 16.22f, 16.0f, 16.5f)
                close()
                moveTo(15.0f, 12.0f)
                verticalLineToRelative(2.0f)
                horizontalLineToRelative(-2.0f)
