...
public val RoundGroup.SettingsInputSvideo: ImageVector
    get() {
        ...
        _settingsInputSvideo = Builder(name = "SettingsInputSvideo", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(15.0f, 7.5f)
                curveTo(15.0f, 6.67f, 14.33f, 6.0f, 13.5f, 6.0f)
                horizontalLineToRelative(-3.0f)
                curveTo(9.67f, 6.0f, 9.0f, 6.67f, 9.0f, 7.5f)
                reflectiveCurveTo(9.67f, 9.0f, 10.5f, 9.0f)
                horizontalLineToRelative(3.0f)
